...
$ResPersonal = $InsPersonal->MtdObtenerPersonales($GET_campo,"contiene",$q,$GET_campo,"ASC",NULL,NULL,1,NULL,NULL,NULL,NULL);
...
$PersonalesTotal = $ResPersonal['Total'];
	...
	if(empty($ArrPersonales)){
		...
		foreach($ArrPersonales as $DatPersonal){	
			if(!empty($DatPersonal->PerEmail)){
				echo $DatPersonal->PerEmail."|".
