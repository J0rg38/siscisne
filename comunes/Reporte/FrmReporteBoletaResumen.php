...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteBoletaResumen.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">RESUMEN DE BOLETAS</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteBoletaResumen.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteBoletaResumen.php" target="IfrReporteBoletaResumen" method="post" name="FrmReporteBoletaResumen" id="FrmReporteBoletaResumen" >
...
<tr>
  ...
  <iframe class="autoHeight" target="IfrReporteBoletaResumen" id="IfrReporteBoletaResumen" name="IfrReporteBoletaResumen" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
