...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE CUADRO DE ORDENES DE TRABAJO X MODELO X AÑO (MANTENIMIENTO)</span></td>
...
<tr>
  ...
  <td align="left">&nbsp;</td>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteFichaIngresoMantenimientoCuadroImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteFichaIngresoMantenimientoCuadroGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
-->
<iframe class="autoHeight"  src="" target="IfrReporteFichaIngresoMantenimientoCuadro" id="IfrReporteFichaIngresoMantenimientoCuadro" name="IfrReporteFichaIngresoMantenimientoCuadro" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
