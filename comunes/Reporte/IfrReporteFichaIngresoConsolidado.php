...
//MtdObtenerReporteFichaIngresoConsolidados($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden="Total",$oSentido="ASC",$oFechaInicio=NULL,$oFechaFin=NULL,$oAgrupar=NULL,$oModalidadIngreso=NULL,$oMarca=NULL,$oModelo=NULL,$oFichaIngresoTipo=NULL)

$ResReporteFichaIngresoConsolidado = $InsReporteFichaIngresoConsolidado->MtdObtenerReporteFichaIngresoConsolidados(NULL,NULL,NULL,$POST_ord,$POST_sen,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$Agrupar,$POST_ModalidadIngreso,$POST_VehiculoMarca,$POST_VehiculoModelo,$POST_FichaIngresoTipo);
