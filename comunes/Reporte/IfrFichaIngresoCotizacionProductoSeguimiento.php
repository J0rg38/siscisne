...
$ResFichaIngresoCotizacionProductoSeguimiento = $InsFichaIngresoCotizacionProductoSeguimiento->MtdObtenerFichaIngresoCotizacionProductoSeguimientos(NULL,NULL,$POST_ord,$POST_sen,NULL,NULL,NULL,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,NULL,NULL,"PcoFecha",false,false);
...
<?php }?>
        ...
        <tr   >
          ...
          <td  class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  align="right" valign="middle"   >
			 ...
			 <?php echo $DatFichaIngresoCotizacionProductoSeguimiento->CprId;  ?>   
