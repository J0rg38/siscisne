...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteAlmacenMovimientoSalidaResumen.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">RESUMEN DE SALIDAS DE REPUESTO</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteAlmacenMovimientoSalidaResumen.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteAlmacenMovimientoSalidaResumen.php" target="IfrReporteAlmacenMovimientoSalidaResumen" method="post" name="FrmReporteAlmacenMovimientoSalidaResumen" id="FrmReporteAlmacenMovimientoSalidaResumen" onsubmit="FncReporteAlmacenMovimientoSalidaResumenVer();">
      ...
      <table class="EstFormulario" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteAlmacenMovimientoSalidaResumenImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteAlmacenMovimientoSalidaResumenGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  <td colspan="2" align="center">
   <!--class="autoHeight"-->
  <iframe class="autoHeight"  src="" target="IfrReporteAlmacenMovimientoSalidaResumen" id="IfrReporteAlmacenMovimientoSalidaResumen" name="IfrReporteAlmacenMovimientoSalidaResumen" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
