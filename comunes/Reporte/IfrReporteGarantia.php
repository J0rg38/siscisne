...
<?php }?>
        ...
        <tr   >
          ...
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" align="right" ><?php echo $DatReporteGarantia->FinId;  ?></td>
...
if(!empty($ArrGarantiaDetalles)){
	foreach($ArrGarantiaDetalles as $DatGarantiaDetalle){
?>
<?php echo $DatGarantiaDetalle->ProNombre;?>
