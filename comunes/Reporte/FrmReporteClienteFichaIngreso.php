...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteClienteFichaIngreso.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE LISTADO DE ORDENES DE TRABAJO X CLIENTE (MANTENIMIENTOS)</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteClienteFichaIngreso.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteClienteFichaIngreso.php" target="IfrReporteClienteFichaIngreso" method="post" name="FrmReporteClienteFichaIngreso" id="FrmReporteClienteFichaIngreso">
      ...
      <table class="EstFormulario" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            ...
            <table border="0" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td><table>
                  <tr>
                    <td><a href="javascript:FncClienteNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                    <td><input tabindex="2" class="EstFormularioCaja" name="CmpClienteNombre" type="text" id="CmpClienteNombre" size="45" maxlength="255"  />                      <a href="comunes/Cliente/FrmClienteBuscar.php?height=440&amp;width=850" class="thickbox" title=""></a></td>
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      ...
                      <option value="FinFecha" >Fecha Atencion</option>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteClienteFichaIngresoImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteClienteFichaIngresoGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteClienteFichaIngreso.php" target="IfrReporteClienteFichaIngreso" id="IfrReporteClienteFichaIngreso" name="IfrReporteClienteFichaIngreso" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
