...
<tr>
  ...
  <td width="54%" align="center" valign="top"><span class="EstReporteTitulo">REPORTE CUADRO DE ORDENES DE TRABAJO X REPARACION X AÑO </span></td>
      ...
      <tbody class="EstTablaReporteBody">
        ...
        <tr>
         <td align="right" class="Total" >
         	TOTAL REPARACIONES (1,2 y 3)<?php //echo strtoupper($InsModalidadIngreso->MinNombre);?>:
         </td>
        ...
        ?>
           ...
           <tr>
             <td align="right" class="Total" >PROM. MENSUAL REPARACIONES (1,2 y 3) <?php //echo strtoupper($InsModalidadIngreso->MinNombre);?>:</td>.
             <?php
        foreach($ArrVehiculoModelos as $DatVehiculoModelo){
        ?>
