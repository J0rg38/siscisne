...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReportePDSPlanchadoPintado.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">RESUMEN  DE PDI/PLANCHADO Y PINTADO</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReportePDSPlanchadoPintado.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReportePDSPlanchadoPintado.php" target="IfrReportePDSPlanchadoPintado" method="post" name="FrmReportePDSPlanchadoPintado" id="FrmReportePDSPlanchadoPintado" onsubmit="FncReportePDSPlanchadoPintadoVer();">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      <option value="FinId" selected="selected">PDS</option>
                      <option value="FinFecha" >Fecha</option>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReportePDSPlanchadoPintadoImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReportePDSPlanchadoPintadoGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  <td colspan="2" align="center">
   <!--class="autoHeight"-->
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReportePDSPlanchadoPintado.php" target="IfrReportePDSPlanchadoPintado" id="IfrReportePDSPlanchadoPintado" name="IfrReportePDSPlanchadoPintado" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
