...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteOrdenVentaVehiculoResumen.js"></script>
...
<tr>
  ...
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteOrdenVentaVehiculoResumen.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteOrdenVentaVehiculoResumen.php" target="IfrReporteOrdenVentaVehiculoResumen" method="post" name="FrmReporteOrdenVentaVehiculoResumen" id="FrmReporteOrdenVentaVehiculoResumen" onsubmit="FncReporteOrdenVentaVehiculoResumenVer();">
  ...
  <tr>
    <td colspan="2"><table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
      <tr>
        <td>Con Cotizacion:</td>
        <td><select name="CmpConCotizacion" id="CmpConCotizacion" class="EstFormularioCombo">
    ...
    <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      <option value="OvvId" selected="selected">Ord. Ven. Veh.</option>
                      <option value="OvvFecha" >Fecha / Ord. Ven. Veh.</option>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteOrdenVentaVehiculoResumenImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteOrdenVentaVehiculoResumenGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  <td colspan="2" align="center">
   <!--class="autoHeight"-->
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteOrdenVentaVehiculoResumen.php" target="IfrReporteOrdenVentaVehiculoResumen" id="IfrReporteOrdenVentaVehiculoResumen" name="IfrReporteOrdenVentaVehiculoResumen" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
