...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteVentaDirectaClientePendiente.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE  DE ORDENES DE VENTA DE CLIENTES PENDIENTES</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteVentaDirectaClientePendiente.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteVentaDirectaClientePendiente.php" target="IfrReporteVentaDirectaClientePendiente" method="post" name="FrmReporteVentaDirectaClientePendiente" id="FrmReporteVentaDirectaClientePendiente" onsubmit="FncReporteVentaDirectaClientePendienteVer();">
      ...
      <table class="EstFormulario" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      ...
                      <option value="VdiOrdenCompraNumero">O.C. Ref.</option>
                       <option value="vdi.CprId">Cotizacion</option>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteVentaDirectaClientePendienteImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteVentaDirectaClientePendienteGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  <td colspan="2" align="center">
   <!--class="autoHeight"-->
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteVentaDirectaClientePendiente.php" target="IfrReporteVentaDirectaClientePendiente" id="IfrReporteVentaDirectaClientePendiente" name="IfrReporteVentaDirectaClientePendiente" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
