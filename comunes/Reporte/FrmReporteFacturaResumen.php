...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteFacturaResumen.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">RESUMEN DE FACTURAS</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteFacturaResumen.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFacturaResumen.php" target="IfrReporteFacturaResumen" method="post" name="FrmReporteFacturaResumen" id="FrmReporteFacturaResumen" >
...
<tr>
  ...
  <iframe class="autoHeight" target="IfrReporteFacturaResumen" id="IfrReporteFacturaResumen" name="IfrReporteFacturaResumen" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
