...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteOrdenCompraPorLlegar.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE ORDENES DE COMPRA POR LLEGAR (DESPACHO)</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteOrdenCompraPorLlegar.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteOrdenCompraPorLlegar.php" target="IfrReporteOrdenCompraPorLlegar" method="post" name="FrmReporteOrdenCompraPorLlegar" id="FrmReporteOrdenCompraPorLlegar">
      
      
      <table class="EstFormulario" cellpadding="2" cellspacing="2" border="0">

        <tr>
          <td width="285" align="left" valign="top"><fieldset class="EstFormularioContenedor">
  ...
  <tr>
    ...
    <td><input class="EstFormularioCaja" name="CmpClienteNombre" type="text" id="CmpClienteNombre" size="35" maxlength="255"  /></td>
    <td>&nbsp;</td>
  </tr>
  </table>
            </fieldset>                  </td>
          
          <td width="121" align="left" valign="top"><fieldset  class="EstFormularioContenedor">
...
<fieldset  class="EstFormularioContenedor">
                  ...
                  <table>
                    <tr>
                      ...
                      <td>
                        ...
                        <input name="CmpOrdenCompra" type="text" class="EstFormularioCaja" id="CmpOrdenCompra" size="15" maxlength="50" />
                        </td>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      ...
                      <option value="OcoFecha" >Fecha / Ord. Compra</option>
                       ...
                       <option value="cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno"   >Cliente</option>
          ...
          <td width="110" align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteOrdenCompraPorLlegarImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteOrdenCompraPorLlegarGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteOrdenCompraPorLlegar.php" target="IfrReporteOrdenCompraPorLlegar" id="IfrReporteOrdenCompraPorLlegar" name="IfrReporteOrdenCompraPorLlegar" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
