...
$objPHPExcel->setActiveSheetIndex(0)
	...
	$objPHPExcel->setActiveSheetIndex(1)
        ...
        $objWriter->save("../../generados/reportes/COR_".$InsVehiculoMarca->VmaNombre."_".$POST_Ano."_".$POST_Mes.".xls");
        
        //$objWriter->save(str_replace('.php', '.xls', __FILE__));
        /*
        <a href="<?php echo $InsOrdenCompra->OcoId;?>.xls">DESCARGAR: <?php echo $InsOrdenCompra->OcoId;?>.xls</a>
        */
        header("Location: ../../generados/reportes/COR_".$InsVehiculoMarca->VmaNombre."_".$POST_Ano."_".$POST_Mes.".xls");
