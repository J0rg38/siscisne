...
//ww$GET_AnoFabricacion = FncLimpiarVariable($_GET['AnoFabricacion']);
...
$ResProducto = $InsProducto->MtdObtenerProductos($GET_Cbu,"contiene",($q),$GET_Cbu,"ASC","10",1,$GET_ProductoTipoId,NULL,$GET_MarcaId,$GET_ModeloId,$GET_VersionId,$GET_AnoFabricacion,false,NULL,NULL,0,NULL,$Estricto);
...
//$DatProducto->UmeNombre." [".$DatProducto->UmeAbreviacion."]|".
		...
		foreach($ArrProductos as $DatProducto){			
			...
			if(!empty($ArrAlmacenes)){
				...
				$ResAlmacenStock = $InsAlmacenStock->MtdObtenerAlmacenStocks(NULL,NULL,NULL,"ProId","ASC",1,"1",1,date("Y")."-01-01",date("Y-m-d"),NULL,NULL,NULL,$DatProducto->ProId,NULL,$DatAlmacen->AlmId,false,$_SESSION['SesionSucursal'],date("Y"));
			...
			////MtdObtenerAlmacenStocks($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'AstNombre',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oProductoTipo=NULL,$oVehiculoMarca=NULL,$oReferencia=NULL,$oProducto=NULL,$oProductoCategoria=NULL,$oAlmacen=NULL,$oTieneMovimiento=false,$oSucursal=NULL,$oAno) {	
			//$ResAlmacenStock = $InsAlmacenStock->MtdObtenerAlmacenStocks(NULL,NULL,NULL,"ProId","DESC",1,"1",NULL,date("Y-m-d"),NULL,NULL,NULL,NULL,$DatProducto->ProId,NULL,NULL,false,$_SESSION['SesionSucursal'],date("Y"));
//			$ArrAlmacenStocks = $ResAlmacenStock['Datos'];
//			
//			$AstPedidoPorLLegar = "";
//			$AstPedidoUltimaFecha = "";
