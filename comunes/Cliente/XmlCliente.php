...
if($GET_campo == "CliNombreCompleto"){
	$GET_campo = $GET_campo.",CliNombre,CliApellidoPaterno,CliApellidoMaterno";
}
...
$ResCliente = $InsCliente->MtdObtenerClientes($GET_campo,"contiene",$q,$GET_campo,"ASC",1,NULL,$GET_Estado,NULL);
