...
<div class="EstNuevoFormularioContenedor">
	<div class="EstNuevoFormularioEtiqueta">
        ...
        ?>
        <option value="<?php echo $DatTecnico->PerId;?>"><?php echo $DatTecnico->PerNombre ?> <?php echo $DatTecnico->PerApellidoPaterno; ?> <?php echo $DatTecnico->PerApellidoMaterno; ?></option>
        <?php
        }
        ?>
        </select>
