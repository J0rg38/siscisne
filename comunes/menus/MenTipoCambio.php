...
?>	
	...
	<tr>
      <td align="right" valign="middle"><?php echo $InsTipoCambio->MonSimbolo;?></td>
      <td align="right" valign="middle"><span class="EstTipoCambioEtiqueta">Compra:</span></td>
      <td colspan="4" align="right" valign="middle"><?php echo $InsTipoCambio->TcaMontoCompra;?></td>
	</tr>
	<tr>
      <td width="27%" align="right" valign="middle"><?php echo $InsTipoCambio->MonSimbolo;?></td>
      <td width="14%" align="right" valign="middle"><span class="EstTipoCambioEtiqueta">Venta:</span></td>
      <td width="23%" align="right" valign="middle"><?php echo $InsTipoCambio->TcaMontoVenta;?></td>
      <td width="5%" align="right" valign="middle">&nbsp;</td>
      <td width="13%" align="right" valign="middle"><span class="EstTipoCambioEtiqueta">Comercial:</span></td>
      <td width="18%" align="right" valign="middle"><?php echo $InsTipoCambio->TcaMontoComercial;?></td>
	</tr>
	</table>
