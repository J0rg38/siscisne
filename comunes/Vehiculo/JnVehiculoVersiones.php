...
$GET_VehiculoVersionVigencia = $_GET['VehiculoVersionVigencia'];
...
$RepVehiculoVersion = $InsVehiculoVersion->MtdObtenerVehiculoVersiones(NULL,NULL,"VveNombre","ASC",NULL,NULL,$GET_VehiculoModeloId,$GET_VehiculoVersionVigencia);
$ArrVehiculoVersiones = $RepVehiculoVersion['Datos'];

$json = new JSON;
$var = $json->serialize( $ArrVehiculoVersiones );
