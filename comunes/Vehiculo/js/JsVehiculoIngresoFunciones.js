...
function FncVehiculoIngresoNuevo(){
	...
	*/			
	...
	FncVehiculoIngresoNuevoFuncion();
...
function FncVehiculoIngresoMarcaNuevo(){
...
function FncVehiculoIngresoModeloNuevo(){
...
function FncVehiculoIngresoBuscar(oCampo){
...
//		data: 'Campo='+oCampo+'&Dato='+Dato+'&'+VehiculoIngresoBuscarVariables,
		...
		success: function(InsVehiculoIngreso){
				if(InsVehiculoIngreso.EinId!=null){		
					...
					FncVehiculoIngresoEscoger(InsVehiculoIngreso);
...
//	$("#CmpColor").val(InsVehiculoIngreso.EinColor);
	...
	*/	
	...
	FncVehiculoIngresoFuncion(InsVehiculoIngreso);
...
function FncVehiculoIngresoGuardarSimple(){
		...
		$.ajax({
			...
			success: function(oRespuesto){
				...
				if(oRespuesto!="2"){
					...
					FncVehiculoIngresoGuardarSimpleFuncion();
				}
...
function FncVehiculoIngresoCargarFormulario(oForm){
...
function FncVehiculoIngresoFiltrar(e){
	...
	if (keyCode==13){	
		FncVehiculoIngresoFiltrar2();	
	}

}

function FncVehiculoIngresoFiltrar2(){
...
function FncVehiculoIngresoListadorEscoger(oVehiculoIngresoId){
