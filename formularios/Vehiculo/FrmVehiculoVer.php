        ...
        <!--Content-->
         ...
         <table border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td valign="top"><input  name="CmpCodigoIdentificador" type="text"  class="EstFormularioCaja" id="CmpCodigoIdentificador" value="<?php echo $InsVehiculo->VehCodigoIdentificador;?>" size="50" maxlength="255" readonly="readonly" /></td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td valign="top"><input  name="CmpNombre" type="text"  class="EstFormularioCaja" id="CmpNombre" value="<?php echo $InsVehiculo->VehNombre;?>" size="50" maxlength="255" readonly="readonly" /></td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
          </tr>
...
<div class="EstFormularioCajaObservacion">
                                      <?php echo stripslashes($InsVehiculo->VehInformacion);?>
                                    </div>
