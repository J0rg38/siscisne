...
if(isset($_POST['BtnGuardar_x']) or $_POST['Guardar']=="1"){	
	...
	$InsVehiculo->UmeId = $_POST['CmpUnidadMedida'];
	
	$InsVehiculo->VehCodigoIdentificador = $_POST['CmpCodigoIdentificador'];
	$InsVehiculo->VehNombre = $_POST['CmpNombre'];
