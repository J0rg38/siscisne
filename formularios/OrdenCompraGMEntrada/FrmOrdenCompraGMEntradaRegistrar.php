...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCompraGMEntradaRegistrar.php');
...
*/
var OrdenCompraGMEntradaPedidoEditar = 1;
var OrdenCompraGMEntradaPedidoEliminar = 1;
</script>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        ENTRADA A ALMACEN c/ ORDEN COMPRA GM</span></td>
      </tr>
      <tr>
        <td colspan="2">
         ...
         <td valign="top"><div class="EstFormularioArea">
           ...
           <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
			...
			?>
                 ...
                 <input type="hidden" name="CmpOrdenCompraTipo" id="CmpOrdenCompraTipo" value="<?php echo $InsOrdenCompraEntrada->OcoTipo;?>" />
               </td>
...
//			 deb($InsOrdenCompraEntrada->OceFecha);
			 ?>
               <label>
                 <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if(empty($InsOrdenCompraEntrada->OceFecha)){ echo date("d/m/Y");}else{ echo $InsOrdenCompraEntrada->OceFecha; }?>" size="15" maxlength="10" />
                 </label>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="2%"><input type="hidden" name="CmpOrdenCompraEntradaPedidoAccion" id="CmpOrdenCompraEntradaPedidoAccion" value="AccOrdenCompraGMEntradaDetalleRegistrar.php" /></td>
               <td width="48%"><div class="EstFormularioAccion" id="CapProductoAccion">Listo
                 para registrar elementos</div></td>
               <td width="50%" align="right"><a href="javascript:FncOrdenCompraGMEntradaPedidoListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a><a href="javascript:FncOrdenCompraGMEntradaPedidoEliminarTodo();"></a></td>
               <td width="0%"><div id="CapOrdenCompraEntradaPedidosResultado"> </div></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
