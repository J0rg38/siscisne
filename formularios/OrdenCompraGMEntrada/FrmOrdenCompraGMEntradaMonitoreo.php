...
$ResOrdenCompra = $InsOrdenCompra->MtdObtenerOrdenCompras($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,"ZGAR,ZVOR,YRUSH,ZTOOL,STK",1);
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ENTRADAS A ALMACEN c/ ORDEN COMPRA GM PENDIENTES</span></td>
</tr>
<tr>
  <td width="47%">
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle" width="12%"   ><?php echo $dat->OcoId;  ?></td>

                <td  width="7%" align="right" ><?php echo $dat->OcoTipo;  ?></td>
                <td  width="25%" align="right" ><?php echo $dat->OcoCodigoDealer;  ?></td>
                <td  width="6%" align="right" ><?php echo $dat->OcoFecha;  ?></td>
                <td  width="6%" align="right" ><?php echo $dat->OcoHora;  ?></td>
                <td  width="10%" align="right" ><?php echo $dat->MonSimbolo;  ?></td>
                <td  width="6%" align="right" ><?php echo $dat->OcoTipoCambio;  ?></td>
                ...
                <td  width="10%" align="right" ><?php echo ($dat->OcoTiempoModificacion);?></td>
