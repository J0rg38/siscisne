...
//		echo "<br>";
//		echo $InsOrdenCompraEntradaDetalle1->OedPrecio." ::: ".$InsOrdenCompraEntradaDetalle1->OedCantidad." ::: ".$InsOrdenCompraEntradaDetalle1->OedImporte;
//		echo "<br>";
//		echo "<br>";		
