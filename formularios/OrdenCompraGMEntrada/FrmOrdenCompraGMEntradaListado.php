...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsOrdenCompraGMEntrada.js" ></script>
<?php
/* 
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCompraGMEntrada.php');

////MtdObtenerOrdenCompraEntradas($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'OceId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oOrigen=NULL,$oMoneda=NULL,$oEstadoOrdenCompra=NULL,$oOrdenCompraTipo=NULL)
$ResOrdenCompraEntrada = $InsOrdenCompraEntrada->MtdObtenerOrdenCompraEntradas($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,"3,4","ZGAR,ZVOR,YRUSH,ZTOOL,STK");
$ArrOrdenCompraEntradas = $ResOrdenCompraEntrada['Datos'];
$OrdenCompraEntradasTotal = $ResOrdenCompraEntrada['Total'];
$OrdenCompraEntradasTotalSeleccionado = $ResOrdenCompraEntrada['TotalSeleccionado'];

//deb($ArrOrdenCompraEntradas);
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ENTRADAS A ALMACEN c/ ORDEN COMPRA GM</span></td>
</tr>
<tr>
  <td width="47%">
    Mostrando <b><?php echo $OrdenCompraEntradasTotalSeleccionado;?></b> de <b><?php echo $OrdenCompraEntradasTotal;?></b> elementos.</td>
...
<table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0" >
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?></th>
                <th width="7%" ><?php
				if($POST_ord == "OceTotal"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OceTotal','ASC');"> Total <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OceTotal','DESC');"> Total <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('OceTotal','ASC');"> Total  </a>
                  <?php
				}
				?></th>
                <th width="5%" ><?php
				if($POST_ord == "OceEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OceEstado','ASC');"> Est. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OceEstado','DESC');"> Est. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('OceEstado','ASC');"> Est. </a>
                  <?php
				}
				?></th>
                <th width="10%" >
                  <?php
				if($POST_ord == "OceTiempoModificacion"){
					if($POST_sen == "DESC"){
				?>
                  
                  <a href="javascript:FncOrdenar('OceTiempoModificacion','ASC');">
                  U.A.
                  <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" />				</a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OceTiempoModificacion','DESC');">
            ...
            <tfoot class="EstTablaListadoFoot">
              ...
              <tr>
				...
				<select class="EstFormularioOcobo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
				  ...
				  <option <?php if($POST_num==$OrdenCompraEntradasTotal){ echo 'selected="selected"';}?> value="<?php echo $OrdenCompraEntradasTotal;?>">Todos</option>
                </select>
				...
				<?php
					...
					//if(empty($POST_fil)){
						$tregistros = $OrdenCompraEntradasTotal;
					//}else{
					//	$tregistros = ($OrdenCompraEntradasTotalSeleccionado);
					//}
 ...
 <tbody class="EstTablaListadoBody">
            <?php
					...
					$Impuesto = 0;
					$Total = 0;
								foreach($ArrOrdenCompraEntradas as $dat){
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle" width="3%"   ><?php echo $dat->OceId;  ?></td>
                <td  width="5%" align="right" ><?php echo $dat->OceFecha;  ?></td>
                <td  width="5%" align="right" ><?php echo $dat->MonSimbolo;  ?></td>
                <td  width="3%" align="right" ><?php echo $dat->OceTipoCambio;  ?></td>
                <td  width="6%" align="right" ><?php echo $dat->OcoTipo;  ?></td>
                <td width="24%" align="right" valign="middle"   ><?php echo $dat->OcoId;  ?></td>
                <td  width="22%" align="right" ><?php echo $dat->OcoCodigoDealer;  ?></td>
                <td  width="7%" align="right" ><?php echo number_format($dat->OceTotal,2);?>
                <?php
					$Total += $dat->OcoTotal ;
			
				?></td>
                <td  width="5%" align="right" ><?php echo ($dat->OceEstadoDescripcion);?></td>
                <td  width="10%" align="right" ><?php echo ($dat->OceTiempoModificacion);?></td>
            <td align="center">

<?php
if($PrivilegioEliminar and $dat->OceEstado == 1){
?>
<a href="javascript:FncEliminarSeleccionado('<?php echo $dat->OceId;?>');"> <img  src="imagenes/eliminar.gif" alt="[Eliminar]" width="19" height="19" border="0" title="Eliminar Ocopletamente"   /></a>
<?php
}
?>   

<?php
if($PrivilegioEditar and $dat->OceEstado == 1){
?>
	<a href="principal.php?Mod=<?php echo $GET_mod;?>&amp;Form=Editar&amp;Id=<?php echo $dat->OceId;?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>
<?php
}
?>
...
if($PrivilegioVer){
?>
	<a href="principal.php?Mod=<?php echo $GET_mod;?>&amp;Form=Ver&amp;Id=<?php echo $dat->OceId;?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
<?php
}
?>
