...
<tr>
  ...
  <span class="EstPlantillaTitulo">CONVERSION DE PRODUCTOS</span><br />
...
<tr>
    ...
    <tr>
      <td colspan="6" align="left" valign="top"><span class="EstProduccionProductoImprimirCabecera">Datos de Transferencia</span></td>
    ...
    <tr>
      <td align="left" valign="top" class="EstProduccionProductoImprimirEtiquetaFondo"><span class="EstProduccionProductoImprimirEtiqueta">Fecha salida</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirContenido"><?php echo $InsProduccionProducto->PprFecha;?></span></td>
      <td align="left" valign="top" class="EstProduccionProductoImprimirEtiquetaFondo"><span class="EstProduccionProductoImprimirEtiqueta">Fecha llegada</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirContenido"><?php echo $InsProduccionProducto->PprFecha;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td align="left" valign="top" class="EstProduccionProductoImprimirEtiquetaFondo"><span class="EstProduccionProductoImprimirEtiqueta">ALMACEN ORIGEN</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirContenido"><?php echo $InsProduccionProducto->PprFecha;?></span></td>
      <td align="left" valign="top" class="EstProduccionProductoImprimirEtiquetaFondo"><span class="EstProduccionProductoImprimirEtiqueta">ALMACEN DESTINO</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstProduccionProductoImprimirContenido"><?php echo $InsProduccionProducto->PprFecha;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
...
?>
    ...
    <td colspan="5" align="center"><table class="EstTablaTotal" width="100%" cellpadding="3" cellspacing="2" border="0">
      <tbody class="EstTablaTotalBody">
        <tr>
          ...
          <td width="20%" align="right" valign="top" class="EstProduccionProductoImprimirEtiquetaFondo">&nbsp;</td>
  ...
  <tr>
    <td colspan="5" align="left"><p><strong>Nota:</strong></p></td>
  </tr>
  <tr>
    <td colspan="5" align="center"></td>
  </tr>
