...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccProduccionProductoRegistrar.php');
//DATOS
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">
                        <span class="EstFormularioSubTitulo">Datos del Conversion de Productos
...
<input type="hidden" name="CmpAlmacenMovimientoIdSalida" id="CmpAlmacenMovimientoIdSalida"  value="<?php echo $InsProduccionProducto->AmoIdSalida; ?>" />
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><span id="sprytextfield1">
                        <label>
                          <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php echo $InsProduccionProducto->PprFecha;?>" size="10" maxlength="10" />
                          </label>
			  ...
			  ?>
					...
					?>
                        ...
                        <!-- <input type="hidden" name="CmpEstado" id="CmpEstado" value="<?php echo $InsProduccionProducto->PprEstado;?>" />
                       --></td>
                      <td align="left" valign="top">&nbsp;</td>
                      <td align="left" valign="top">&nbsp;</td>
                      <td align="left" valign="top">&nbsp;</td>
              ...
              <td valign="top">
                ...
                <div class="EstFormularioArea">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="13"><span class="EstFormularioSubTitulo">
...
<input type="hidden" name="CmpProduccionProductoDetalleEstadoEntrada" id="CmpProduccionProductoDetalleEstadoEntrada" value="3" />
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="javascript:FncProduccionProductoDetalleEntradaNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                            ...
                            <td>
                              ...
                              <a href="javascript:FncProductoBuscarEntrada('CodigoOriginal');"><img src="imagenes/acciones/buscar.png" width="25" height="25" alt="[Buscar]" align="absmiddle" title="Buscar" border="0" /></a>
  ...
  <a id="BtnProductoRegistrarEntrada" onclick="FncProductoCargarFormularioEntrada('Registrar');"  href="javascript:void(0)" title=""> <img src="imagenes/acciones/registrar.png" alt="[Registrar]" width="25" height="25" border="0" align="absmiddle" title="Registrar" /></a>
                              <a id="BtnProductoEditarEntrada" onclick="FncProductoCargarFormularioEntrada('Editar');" href="javascript:void(0)"   title=""> <img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" /></a>
                            ...
                            <td><input name="CmpProductoCostoEntrada" type="text"  class="EstFormularioCaja" id="CmpProductoCostoEntrada" size="7" maxlength="10"  /></td>
                            <td>
                              
                              <input name="CmpProductoCantidadEntrada" type="text"  class="EstFormularioCaja" id="CmpProductoCantidadEntrada" size="7" maxlength="10"  />                            </td>
                            <td><input name="CmpProductoImporteEntrada" type="text"  class="EstFormularioCaja" id="CmpProductoImporteEntrada" size="7" maxlength="10"  /></td>
...
<input type="hidden" name="CmpProduccionProductoDetalleEstadoSalida" id="CmpProduccionProductoDetalleEstadoSalida" value="3" />
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="javascript:FncProduccionProductoDetalleSalidaNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                            ...
                            <td>
                              ...
                              <a href="javascript:FncProductoBuscarSalida('CodigoOriginal');"><img src="imagenes/acciones/buscar.png" width="25" height="25" alt="[Buscar]" align="absmiddle" title="Buscar" border="0" /></a>
  ...
  <a id="BtnProductoRegistrarSalida" onclick="FncProductoCargarFormularioSalida('Registrar');"  href="javascript:void(0)" title=""> <img src="imagenes/acciones/registrar.png" alt="[Registrar]" width="25" height="25" border="0" align="absmiddle" title="Registrar" /></a>
                              <a id="BtnProductoEditarSalida" onclick="FncProductoCargarFormularioSalida('Editar');" href="javascript:void(0)"   title=""> <img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" /></a>
                              
                              
                            </td>
                            <td><select  class="EstFormularioCombo" name="CmpProductoUnidadMedidaConvertirSalida" id="CmpProductoUnidadMedidaConvertirSalida">
                            </select></td>
                            <td><input name="CmpProductoPrecioSalida" type="text"  class="EstFormularioCaja" id="CmpProductoPrecioSalida" size="7" maxlength="10"  /></td>
                            <td>
                              
                              <input name="CmpProductoCantidadSalida" type="text"  class="EstFormularioCaja" id="CmpProductoCantidadSalida" size="7" maxlength="10"  />                            </td>
                            <td><input name="CmpProductoImporteSalida" type="text"  class="EstFormularioCaja" id="CmpProductoImporteSalida" size="7" maxlength="10"  /></td>
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <td width="49%" align="right"><a href="javascript:FncProduccionProductoDetalleSalidaListar();">
                      ...
                      <img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncProduccionProductoDetalleSalidaEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>
