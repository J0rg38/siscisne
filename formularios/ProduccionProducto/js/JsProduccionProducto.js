...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/ProduccionProducto/acc/AccProduccionProductoGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/ProduccionProducto/acc/AccProduccionProductoGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	...
	document.getElementById("FrmListado").action = "formularios/ProduccionProducto/FrmProduccionProductoListadoImprimir.php"
...
//
//			if(actualizar){
//				$("#Acc").val("EnviarProduccionProductoContabilidad");
//				$("#FrmListado").submit();	
//			}else{
		...
		if(confirm("¿Realmente desea GENERAR la ORDEN DE COMPRA con los elementos seleccionados?")){
			...
			if(actualizar){
				...
				if(actualizar2){
					...
					$("#FrmListado").attr("action","principal.php?Mod=OrdenCompra&Form=Registrar&Ori=ProduccionProducto");
					$("#FrmListado").submit();	
