...
*/
	...
	$InsProduccionProductoDetalleEntrada1 = array();
	$InsProduccionProductoDetalleEntrada1 = $_SESSION['InsProduccionProductoDetalleEntrada'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
	...
	$_SESSION['InsProduccionProductoDetalleEntrada'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
	$InsProduccionProductoDetalleEntrada1->Parametro1,
	$InsProduccionProductoDetalleEntrada1->Parametro2,
	$InsProduccionProductoDetalleEntrada1->Parametro3,
	$Costo ,
	$Cantidad,
	$CantidadReal,
	$InsProduccionProductoDetalleEntrada1->Parametro7,
	date("d/m/Y H:i:s"),
	$InsUnidadMedida->UmeNombre,
	$InsUnidadMedida->UmeId,
	$InsProduccionProductoDetalleEntrada1->Parametro11,
	NULL,
	$InsProduccionProductoDetalleEntrada1->Parametro13,
	$InsProduccionProductoDetalleEntrada1->Parametro14,
	$InsProduccionProductoDetalleEntrada1->Parametro15,
	3,
	$Importe
	//$_POST['ProduccionProductoDetalleEstado']
	);
