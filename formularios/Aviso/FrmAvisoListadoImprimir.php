...
require_once('../../paquetes/PaqContabilidad/Clases/ClsAviso.php');

$InsAviso = new ClsAviso();

$ResAviso = $InsAviso->MtdObtenerAvisos($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est);
...
<link href="css/CssAviso.css" rel="stylesheet" type="text/css" />
...
<span class="EstReporteTitulo">LISTADO DE NOTAS
      ...
      <thead class="EstTablaListadoHead">
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle"   ><?php echo $dat->AviNumero; ?></td>
                <td align="right" ><?php echo $dat->AviBanco; ?></td>
                <td align="right" ><?php
			switch($dat->AviMoneda){
				case "S":
			?>
Nuevos Soles
  <?php
...
<?php
			...
			?></td>
                <td align="right" ><?php echo $dat->AviIngresos; ?></td>
                <td align="right" ><?php echo $dat->AviSalidas; ?></td>
                <td align="right" ><?php echo $dat->AviSaldo; ?></td>
                <td align="right" >
