...
$ResPagoProveedor = $InsPagoProveedor->MtdObtenerPagoProveedors("cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,per.PerNombre,per.PerApellidoPaterno,per.PerApellidoMaterno,prv.PrvNombre,PrvApellidoPaterno,prv.PrvApellidoMaterno",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"DesFecha",$POST_Cuenta,$POST_Moneda,$POST_TipoDestino,$POST_Area);
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE PAGO A PROVEEDORS</span></td>
</tr>
<tr>
  <td>
	...
	<a class="EstPaginacion"  href="javascript:FncPaginar('<?php echo $num?>,<?php echo $numxpag;?>','<?php echo $i?>');" ><?php echo $i?></a>                        
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" ><?php echo $dat->PovConcepto; ?></td>
...
?>        
	...
	<a href="javascript:FncImprmir('<?php echo $dat->PovId;?>');"><img src="imagenes/acciones/imprimir.gif" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
<?php
}
?>
