...
function FncFichaAccionFotoMantenimientoListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/PDIFichaAccion/FrmPDIFichaAccionFotoMantenimientoListado.php',
...
function FncFichaAccionFotoMantenimientoEliminar(){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/PDIFichaAccion/acc/AccPDIFichaAccionFotoMantenimientoEliminar.php',
