...
function FncFichaAccionProductoAdicionalListar(oModalidadIngreso){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/PDIFichaAccion/FrmPDIFichaAccionProductoAdicionalListado.php',
...
function FncFichaAccionProductoAdicionalListar2(oModalidadIngreso){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/PDIFichaAccion/FrmPDIFichaAccionProductoAdicionalListado2.php',
		data: 'Identificador='+Identificador+'&ModalidadIngreso='+oModalidadIngreso+'&Editar='+FichaAccionProductoAdicionalEditar+'&Eliminar='+FichaAccionProductoAdicionalEliminar,
...
function FncFichaAccionProductoAdicionalEscoger(oItem,oModalidadIngreso){
	...
	$('#CmpFichaAccion'+oModalidadIngreso+'ProductoAccion').val("AccPDIFichaAccionProductoAdicionalEditar.php");
	
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/PDIFichaAccion/acc/AccPDIFichaAccionProductoAdicionalEscoger.php',
...
function FncFichaAccionProductoAdicionalEliminar(oItem,oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/PDIFichaAccion/acc/AccPDIFichaAccionProductoAdicionalEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem+'&ModalidadIngreso='+oModalidadIngreso,
			success: function(){
...
function FncFichaAccionProductoAdicionalEliminarTodo(oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/PDIFichaAccion/acc/AccPDIFichaAccionProductoAdicionalEliminarTodo.php',
