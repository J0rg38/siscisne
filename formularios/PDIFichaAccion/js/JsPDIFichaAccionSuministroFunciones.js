...
function FncFichaAccionSuministroNuevo(oModalidadIngreso){
	...
	$('#CmpFichaAccion'+oModalidadIngreso+'SuministroAccion').val("AccPDIFichaAccionSuministroRegistrar.php");
...
function FncFichaAccionSuministroListar(oModalidadIngreso){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/PDIFichaAccion/FrmPDIFichaAccionSuministroListado.php',
...
function FncFichaAccionSuministroListar2(oModalidadIngreso){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/PDIFichaAccion/FrmPDIFichaAccionSuministroListado2.php',
...
function FncFichaAccionSuministroEscoger(oItem,oModalidadIngreso){
	...
	$('#CmpFichaAccion'+oModalidadIngreso+'SuministroAccion').val("AccPDIFichaAccionSuministroEditar.php");
	
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/PDIFichaAccion/acc/AccPDIFichaAccionSuministroEscoger.php',
...
function FncFichaAccionSuministroEliminar(oItem,oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/PDIFichaAccion/acc/AccPDIFichaAccionSuministroEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem+'&ModalidadIngreso='+oModalidadIngreso,
			success: function(){
...
function FncFichaAccionSuministroEliminarTodo(oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/PDIFichaAccion/acc/AccPDIFichaAccionSuministroEliminarTodo.php',
