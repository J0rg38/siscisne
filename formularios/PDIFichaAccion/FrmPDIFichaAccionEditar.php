...
if($InsFichaIngreso->FinEstado==2 or $InsFichaIngreso->FinEstado==3){
	...
	include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPDIFichaAccionEditar.php');
...
//var FichaAccionProductoEditar = <?php echo (($InsFichaIngreso->FinEstado==7 or $InsFichaIngreso->FinEstado==71)?2:1);?>;
//var FichaAccionProductoEliminar = <?php echo (($InsFichaIngreso->FinEstado==7 or $InsFichaIngreso->FinEstado==71)?2:1);?>;
//
//var FichaAccionSuministroEditar = <?php echo (($InsFichaIngreso->FinEstado==7 or $InsFichaIngreso->FinEstado==71)?2:1);?>;
//var FichaAccionSuministroEliminar = <?php echo (($InsFichaIngreso->FinEstado==7 or $InsFichaIngreso->FinEstado==71)?2:1);?>;
//
//var FichaAccionMantenimientoEditar = <?php echo (($InsFichaIngreso->FinEstado==7 or $InsFichaIngreso->FinEstado==71)?2:1);?>;
//var FichaAccionMantenimientoEliminar = <?php echo (($InsFichaIngreso->FinEstado==7 or $InsFichaIngreso->FinEstado==71)?2:1);?>;
...
?>
							...
							<td colspan="3" align="left"><div class="EstFormularioArea">
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top"><a href="javascript:FncFichaAccionTemparioNuevo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  ...
                                  <td align="left" valign="top"><a href="javascript:FncFichaAccionTemparioEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');">
                                    <input type="hidden" name="CmpFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla?>TemparioAccion" id="CmpFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla?>TemparioAccion" value="AccPDIFichaAccionTemparioRegistrar.php" />
                                    </a>
                                  ...
                                  <td align="left" valign="top"><a href="javascript:FncFichaAccionTemparioGuardar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                                </tr>
                              </table>
                            </div></td>
                          </tr>
                            ...
                            <td colspan="3" align="left"><div class="EstFormularioArea" >
                              <table width="30%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="49%" align="right" valign="top"><a href="javascript:FncFichaAccionTemparioListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a><a href="javascript:FncFichaAccionTemparioEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/></a></td>
...
<input type="hidden" name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>TareaEspecificacion" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>TareaEspecificacion" />
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top"><a href="javascript:FncFichaAccionTareaNuevo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  ...
                                  <td align="left" valign="top"><a href="javascript:FncFichaAccionTareaGuardar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                                </tr>
                              </table>
                            </div></td>
 ...
 <input type="hidden" name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoCodigoOriginal" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoCodigoOriginal" value="" />
  ...
  <input type="hidden" name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoCodigoAlternativo" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoCodigoAlternativo" value="" />
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><input type="hidden" name="CmpFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoAccion" id="CmpFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoAccion" value="AccPDIFichaAccionProductoRegistrar.php" /></td>
                                  <td>Nombre : </td>
                                  <td>U.M. </td>
                                  <td>Cantidad:</td>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><a href="javascript:FncFichaAccionProductoNuevo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  ...
                                  <td><a href="javascript:FncFichaAccionProductoGuardar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                                  <td><a href="comunes/Producto/FrmProductoBuscar.php?height=440&amp;width=850&amp;Modalidad=<?php echo $DatFichaIngresoModalidad->MinSigla?>" class="thickbox" title="">[...]</a></td>
                                </tr>
                              </table>
                            </div>
                              ...
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                  ...
                                  <td><span class="EstFormularioAccion">
                                    <input type="hidden" name="CmpFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla?>SuministroAccion" id="CmpFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla?>SuministroAccion" value="AccPDIFichaAccionSuministroRegistrar.php" />
                                  </span></td>
                                  <td>Nombre : </td>
                                  <td>U.M. </td>
                                  <td>Cantidad:</td>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><a href="javascript:FncFichaAccionSuministroNuevo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  ...
                                  <td><a href="javascript:FncFichaAccionSuministroGuardar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                                  <td><a href="comunes/Producto/FrmProductoBuscar.php?height=440&amp;width=850&amp;Modalidad=<?php echo $DatFichaIngresoModalidad->MinSigla?>" class="thickbox" title="">[...]</a></td>
                                </tr>
                              </table>
                            </div>
                            ...
                            <td align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="49%" align="left" valign="top"><div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla?>TareaAccion2"> Listo
                                    para registrar elementos</div></td>
                                  <td width="48%" align="right" valign="top"><a href="javascript:FncFichaAccionTareaListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a><a href="javascript:FncFichaAccionTareaEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/></a></td>
                                  <td width="1%" align="left" valign="top"><div id="CapFichaAccionTareasResultado2"> </div></td>
                                </tr>
                                <?php
								/*
								?>
                              ...
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="50%"><div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoAccion">Listo
                                    para registrar elementos </div></td>
                                  <td width="46%" align="right"><a href="javascript:FncFichaAccionProductoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a><a href="javascript:FncFichaAccionProductoEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/></a></td>
                              ...
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="50%"><div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla?>SuministroAccion">Listo
                                    para registrar elementos </div></td>
                                  <td width="47%" align="right"><a href="javascript:FncFichaAccionSuministroListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a><a href="javascript:FncFichaAccionSuministroEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/></a></td>
...
tinymce.init({
	...
	height : 80
                                ...
                                <tr>
                                  ...
                                  <span class="EstFormularioNota">* Pedidos adicionales a almacen </span>
          ...
          <textarea name="CmpFichaAccionCausa_<?php echo $DatFichaIngresoModalidad->MinSigla?>" cols="60" rows="2" class="EstFormularioCaja" id="CmpFichaAccionCausa_<?php echo $DatFichaIngresoModalidad->MinSigla?>"><?php echo stripslashes($FichaAccionCausa);?></textarea>
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top">
                                     ...
                                     <span class="EstFormularioNota">* En caso de una Garantia, Campaña o Politica, rellene este espacio.</span>
                            ...
                            <div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="137" align="right" valign="top"><a href="javascript:FncFichaAccionFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
		...
		$(document).ready(function()
{
	...
	url:"formularios/FichaAccion/acc/AccPDIFichaAccionSubirFoto2.php",
	...
	onSuccess:function(files,data,xhr){
		FncFichaAccionFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla;?>');
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td>&nbsp;</td>
                            <td width="11%">Kilometraje/Plan Mant.:</td>
                            <td width="36%"><?php
            ...
            ?>
							...
							?>
								<img src="imagenes/acciones/obsequio.jpg" alt="Obsequio" width="20" height="20" border="0" title="Obsequio" /> <span class="EstFormularioResaltar"> Este SERVICIO es GRATUITO </span>                           <?php	
							}
							?>
...
?>
                       ...
                       <div class="EstFormularioArea" >
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            <td width="33%" align="center"><span class="EstFormularioSubTitulo">Tareas y Productos: <?php echo strtoupper($DatFichaIngresoModalidad->MinNombre);?></span></td>
                          </tr>
                          <tr>
                            <td align="left" valign="top"><div class="EstFormularioArea">
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                              ...
                              <div class="EstFormularioArea">
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="javascript:FncProductoBuscar('CodigoOriginal','<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/buscar2.gif" width="25" height="25" alt="[Buscar]" align="absmiddle" title="Buscar" border="0" /></a></td>
                                    ...
                                    <td><a href="javascript:FncProductoBuscar('CodigoAlternativo','<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/buscar2.gif" width="25" height="25" alt="[Buscar]" align="absmiddle" title="Buscar" border="0" /></a></td>
                                    <td><input name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoNombre" type="text" class="EstFormularioCaja" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoNombre" size="40" /></td>
                                    <td><select  class="EstFormularioCombo" name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoUnidadMedidaConvertir" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoUnidadMedidaConvertir">
                                    </select></td>
                                    <td><input name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoCantidad" type="text" class="EstFormularioCaja" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoCantidad" size="10" maxlength="10"  /></td>
...
<a href="javascript:FncFichaAccionProductoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a><a href="javascript:FncFichaAccionProductoEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/></a>
                                        ...
                                        <td align="left" valign="top"><table>
                                          <tr>
                                            ...
                                            <td><span id="sprytextfield5">
                                              ...
                                              <span class="textfieldRequiredMsg"><img src="imagenes/advertencia.png" width="20" height="20" border="0" align="absmiddle" title="Debe completar este campo" alt="[A]"  /></span></span> <a href="comunes/Proveedor/FrmProveedorBuscar.php?height=440&amp;width=850" class="thickbox" title="">[...]</a></td>
			...
			?>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left" valign="top"><span id="sprytextfield7">
                                          ...
                                          <span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" alt=""  border="0" align="absmiddle" title="Formato no valido"  /></span></span><img src="imagenes/calendar.gif" alt="[Calendario]" id="BtnSalidaExternaFechaSalida" name="BtnSalidaExternaFechaSalida" width="18" height="18" align="absmiddle"  style="cursor:pointer;" /></td>
                                        ...
                                        <td align="left" valign="top"><span id="sprytextfield7">
                                          ...
                                          <span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" alt=""  border="0" align="absmiddle" title="Formato no valido"  /></span></span><img src="imagenes/calendar.gif" alt="[Calendario]" id="BtnSalidaExternaFechaFinalizacion" name="BtnSalidaExternaFechaFinalizacion" width="18" height="18" align="absmiddle"  style="cursor:pointer;" /></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                      </tr>
...
<div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="139" align="right" valign="top"><a href="javascript:FncFichaAccionFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
							...
							<input type="hidden" name="CmpHerramientaId"    id="CmpHerramientaId" value=""   />
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><span class="EstFormularioAccion">
                                    <input type="hidden" name="CmpFichaAccionHerramientaAccion" id="CmpFichaAccionHerramientaAccion" value="AccPDIFichaAccionHerramientaRegistrar.php" />
                                  </span></td>
                                  <td>Nombre : </td>
                                  <td>U.M. </td>
                                  <td>Cantidad:</td>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><a href="javascript:FncFichaAccionHerramientaNuevo();"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  ...
                                  <td><a href="javascript:FncFichaAccionHerramientaGuardar();"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                                  <td><a href="comunes/Producto/FrmProductoBuscar.php?height=440&amp;width=850&amp;Modalidad=HE" class="thickbox" title="">[...]</a></td>
                                </tr>
                              </table>
                            </div></td>
                          </tr>
...
<textarea name="CmpObservacionSalida" cols="60" rows="2" class="EstFormularioCaja" id="CmpObservacionSalida"><?php echo stripslashes($InsFichaIngreso->FinSalidaObservacion);?></textarea>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            ...
                            <td width="47%"><div class="EstFormularioAccion" id="CapFichaAccionHistorialAccion">Listo
                              para registrar elementos</div></td>
                            <td width="49%" align="right"><a href="javascript:FncFichaAccionHistorialListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a></td>
                      ...
                      <div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="right" valign="top"><a href="javascript:FncFichaAccionFotoVINListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		allowedTypes:"png,gif,jpg,jpeg",
		url:"formularios/FichaAccion/acc/AccPDIFichaAccionSubirFotoVIN.php",
			...
			FncFichaAccionFotoVINListar();
                      ...
                      <!--<div class="EstFormularioArea" >
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="3%">&nbsp;</td>
                            <td width="96%" colspan="2"><iframe src="formularios/FichaAccion/acc/AccPDIFichaAccionSubirFotoVIN.php?Identificador=<?php echo $Identificador;?>" id="IfrFichaAccionSubirFotoVin" name="IfrFichaAccionSubirFotoVin" scrolling="Auto"  frameborder="0" width="600" height="140"></iframe></td>
                            <td width="1%">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                      ...
                      <div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="right" valign="top"><a href="javascript:FncFichaAccionFotoDelanteraListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		allowedTypes:"png,gif,jpg,jpeg",
		url:"formularios/FichaAccion/acc/AccPDIFichaAccionSubirFotoDelantera.php",
		formData: {"Identificador":"<?php echo $Identificador;?>"},
		multiple:false,
		autoSubmit:true,
			...
			FncFichaAccionFotoDelanteraListar();
                      ...
                      <!--<div class="EstFormularioArea" >
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="3%">&nbsp;</td>
                            <td width="96%" colspan="2"><iframe src="formularios/FichaAccion/acc/AccPDIFichaAccionSubirFotoDelantera.php?Identificador=<?php echo $Identificador;?>" id="IfrFichaAccionSubirFotoDelantera" name="IfrFichaAccionSubirFotoDelantera" scrolling="Auto"  frameborder="0" width="600" height="140"></iframe></td>
                            <td width="1%">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                              ...
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="136" align="right" valign="top">
									...
									<a href="javascript:FncFichaAccionFotoCuponListar();"></a>
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="right" valign="top"><a href="javascript:FncFichaAccionFotoCuponListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		allowedTypes:"png,gif,jpg,jpeg",
		url:"formularios/FichaAccion/acc/AccPDIFichaAccionSubirFotoCupon.php",
		formData: {"Identificador":"<?php echo $Identificador;?>"},
		multiple:false,
		autoSubmit:true,
                              ...
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="136" align="right" valign="top">
									...
									<a href="javascript:FncFichaAccionFotoMantenimientoListar();"></a>
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="right" valign="top"><a href="javascript:FncFichaAccionFotoMantenimientoListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		allowedTypes:"png,gif,jpg,jpeg",
		url:"formularios/FichaAccion/acc/AccPDIFichaAccionSubirFotoMantenimiento.php",
		formData: {"Identificador":"<?php echo $Identificador;?>"},
		multiple:false,
		autoSubmit:true,
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                              <tr>
                                ...
                                <td width="47%"><div class="EstFormularioAccion" id="CapPreEntregaPDSDetallelAccion">Listo
                                  para registrar elementos</div></td>
                                <td width="49%" align="right"><a href="javascript:FncPreEntregaPDSDetalleListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a></td>
