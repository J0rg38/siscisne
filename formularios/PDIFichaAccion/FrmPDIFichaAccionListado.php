<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"FichaAccion","Listado") and empty($GET_dia)){
?>

<?php $PrivilegioAuditoriaVer = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"Auditoria","Ver"))?true:false;?>
<?php $PrivilegioRegistrar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"FichaAccion","Registrar"))?true:false;?>
<?php $PrivilegioEditar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"FichaAccion","Editar"))?true:false;?>
<?php $PrivilegioVer = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"FichaAccion","Ver"))?true:false;?>

<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsPDIFichaAccion.js" ></script>
...
$PrivilegioAccesoTotal = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"General","AccesoTotal"))?true:false;
	...
	$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,FinConductor,VmaNombre,VmoNombre,VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"11,2,3,4,5,6,7,71,72,73,74,75,8,9",$POST_Prioridad,"MIN-10014",NULL,NULL,NULL,0,NULL,NULL,$POST_Tipo,0,$POST_ConCampana);
...
-->
 ...
 <!--
<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoRecepcionSeleccionados2();"><img src="imagenes/iconos/enviar_recepcion_anular.png" alt="[Anular Recepcion de OT]" title="Anular Recepcion de OT" /> Anular </a></div>


	<div class="EstSubMenuSeparacion"></div>

<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoAlmacenSeleccionados();"><img src="imagenes/iconos/enviar_almacen2.png" alt="[Enviar OT a Almacen]" title="Enviar OT a Almacen" /> Almacen</a></div>

<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTallerSeleccionados();"><img src="imagenes/iconos/enviar_almacen_cancelar2.png" alt="[Cancelar envio de OT a Almacen]" title="Cancelar envio de OT a Almacen" /> Cancelar </a></div>
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO [PDI]</span>  </td>
...
<table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0" >
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?></th>
                <th width="3%" ><?php
				if($POST_ord == "FinFichaAccionSalidaExternaFechaSalida"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionSalidaExternaFechaSalida','ASC');"> Fec. Salida <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionSalidaExternaFechaSalida','DESC');"> Fec. Salida <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionSalidaExternaFechaSalida','ASC');"> Fec. Salida </a>
                  <?php
				}
				?></th>
                <th width="3%" ><?php
				if($POST_ord == "FinFichaAccionComprobanteNumero"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionComprobanteNumero','ASC');"> Num. Comprobante <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionComprobanteNumero','DESC');"> Num. Comprobante <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionComprobanteNumero','ASC');"> Num. Comprobante </a>
                <?php
				}
				?></th>
                <th width="3%" ><?php
				if($POST_ord == "FinFichaAccionComprobanteFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionComprobanteFecha','ASC');"> Fec. Comprobante <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionComprobanteFecha','DESC');"> Fec. Comprobante <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionComprobanteFecha','ASC');"> Fec. Comprobante </a>
                <?php
				}
				?></th>
                <th width="3%" ><?php
				if($POST_ord == "FinFichaAccionSalidaExternaFechaFinalizacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionSalidaExternaFechaFinalizacion','ASC');"> Fec. Finalizacion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionSalidaExternaFechaFinalizacion','DESC');"> Fec. Finalizacion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('FinFichaAccionSalidaExternaFechaFinalizacion','ASC');"> Fec. Finalizacion </a>
                <?php
				}
				?></th>
                <th width="3%" ><?php
...
<?php echo ($dat->CliNombre);?>     
    ...
    <?php echo ($dat->EinVIN);?>       
                ...
                <td  width="10%" align="right" ><?php echo ($dat->PerNombre);?> <?php echo ($dat->PerApellidoPaterno);?> <?php echo ($dat->PerApellidoMaterno);?></td>
                <td  width="5%" align="right" ><?php echo ($dat->FinTiempoCreacion);?></td>
                <td  width="3%" align="right" ><?php echo ($dat->FinFichaAccionSalidaExternaFechaSalida);?></td>
                <td  width="3%" align="right" ><?php echo ($dat->FinFichaAccionComprobanteNumero);?></td>
                <td  width="3%" align="right" ><?php echo ($dat->FinFichaAccionComprobanteFecha);?></td>
                <td  width="3%" align="right" ><?php echo ($dat->FinFichaAccionSalidaExternaFechaFinalizacion);?></td>
...
if($PrivilegioEditar and ($dat->FinEstado==2  or $dat->FinEstado==3 or $dat->FinEstado==4 or $dat->FinEstado==5 or $dat->FinEstado==6 or $dat->FinEstado == 72 or $dat->FinEstado==71 or $dat->FinEstado==7 or $dat->FinEstado == 73 or $dat->FinEstado == 74 or $dat->FinEstado == 75  or $dat->FinEstado == 9)){
//if($PrivilegioEditar){
?>             
...
?>             
<a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Adicionar&Id=<?php echo $dat->FinId;?>"><img src="imagenes/editar2.gif" width="19" height="19" border="0" title="Adicionar" alt="[Adicionar]"   /></a>                 
<?php
}
?>		
