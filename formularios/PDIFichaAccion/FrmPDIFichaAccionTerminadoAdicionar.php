...
if($InsFichaIngreso->FinEstado==4  || $InsFichaIngreso->FinEstado==5 || $InsFichaIngreso->FinEstado==6 || $InsFichaIngreso->FinEstado == 72 ){
	...
	include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPDIFichaAccionAdicionar.php');
                            ...
                            <td width="50%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="49%" align="right"><a href="javascript:FncFichaAccionHerramientaListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a></td>
