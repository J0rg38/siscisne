...
<select  class="<?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'EstFormularioCajaDeshabilitada':(($PlanMantenimientoDetalleAccion=="C" and (empty($ProductoUnidadMedida)) and !empty($ProductoId) )?'EstFormularioCajaRevisar':'EstFormularioCaja')?>" name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir" id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir" 
 <?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'disabled="disabled"':'';?> >
...
<input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId;?>ProductoCantidad" type="text" class="<?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'EstFormularioCajaDeshabilitada':(($PlanMantenimientoDetalleAccion=="C" and (empty($ProductoCantidad) or $ProductoCantidad == "0.00" ) and !empty($ProductoId) )?'EstFormularioCajaRevisar':'EstFormularioCaja')?>" <?php echo ($PlanMantenimientoDetalleAccion<>"C"or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'readonly="readonly"':'';?>  id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoCantidad" size="10" maxlength="10" value="<?php echo number_format($ProductoCantidad,2);?>"  />
...
$ArrProductoTipoUnidadMedidas = $ResProductoTipoUnidadMedida['Datos'];
?>
<select  class="<?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'EstFormularioCajaDeshabilitada':(($PlanMantenimientoDetalleAccion=="C" and (empty($ProductoUnidadMedida)) and !empty($ProductoId) )?'EstFormularioCajaRevisar':'EstFormularioCaja')?>" name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir" id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir"  <?php echo ($PlanMantenimientoDetalleAccion<>"R" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'disabled="disabled"':'';?> >
  <option value="">Escoja una opcion</option>
  <?php
if(!empty($ProductoTipoId) || !empty($ProductoUnidadMedida)){
?>
