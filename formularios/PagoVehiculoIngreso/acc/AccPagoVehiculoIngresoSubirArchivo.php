...
<tr>
  ...
  <?php
	if($POST_Borrar=="1"){
	?>
    <?php $_SESSION['SesCveFoto'.$Identificador] = ""; ?>
    <?php	
	}
?>
...
if (!empty($_FILES)) {
	...
	$targetPath = '../../../subidos/pago_vehiculo_ingreso_fotos/';
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg"  || $extension == "pdf"){
		...
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesCveFoto'.$Identificador] = $file_name;
			
			if($extension <> "pdf"){
				
				$mythumb = new thumb();
				$mythumb->loadImage('../../../subidos/pago_vehiculo_ingreso_fotos/'.$file_name);
				$mythumb->crop(250, 250,'bottom');
				$mythumb->save('../../../subidos/pago_vehiculo_ingreso_fotos/'.$nombre_base.'_thumb.'.$extension, 100);	
...
Vista Previa:<br />
	...
	if($extension <> "pdf"){
	?>
        <a target="_blank" href="../../../subidos/pago_vehiculo_ingreso_fotos/<?php echo $nombre_base.".".$extension;?>">
        <img  src="../../../subidos/pago_vehiculo_ingreso_fotos/<?php echo $nombre_base.".".$extension;?>" width="97" height="107" border="0" title="<?php echo $nombre_base.".".$extension;?>" />
        </a>   
    <?php
	}else{
	?>
...
}elseif(!empty($_SESSION['SesCveFoto'.$Identificador])){
...
Vista Previa:<br />
	...
	?>
        <a target="_blank" href="../../../subidos/pago_vehiculo_ingreso_fotos/<?php echo $nombre_base.".".$extension;?>">
        <img  src="../../../subidos/pago_vehiculo_ingreso_fotos/<?php echo $nombre_base.".".$extension;?>" width="95" height="113" border="0" title="<?php echo $nombre_base."_thumb.".$extension;?>" /></a>   
    <?php
	}else{
	?>
     <a target="_blank" href="../../../subidos/pago_vehiculo_ingreso_fotos/<?php echo $nombre_base.".".$extension;?>">
