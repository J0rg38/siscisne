...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPagoVehiculoIngresoRegistrar.php');
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">
                        <span class="EstFormularioSubTitulo">Datos del Pago de Vehiculos
                          <input type="hidden" name="Guardar" id="Guardar"   />
                          <input type="hidden" name="Identificador" id="Identificador"  value="<?php echo $Identificador; ?>" />
                          <input type="hidden" name="CmpTiempoRegistroInicio" id="CmpTiempoRegistroInicio"  value="<?php echo $InsPagoVehiculoIngreso->PviTiempoRegistroInicio; ?>" />
                          </span></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td align="left" valign="top">Fecha de Registro: <br><span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span> </td>
			...
			?>
                          ...
                          <td><input class="EstFormularioCaja" name="CmpProveedorNombreCompleto" type="text" id="CmpProveedorNombreCompleto" value="<?php echo $InsPagoVehiculoIngreso->PrvNombreCompleto;?>" size="45" maxlength="255"  />
                            ...
                            <input name="CmpProveedorApellidoMaterno" type="hidden" id="CmpProveedorApellidoMaterno" value="<?php echo $InsPagoVehiculoIngreso->PrvApellidoMaterno;?>" size="3" />
			  ...
			  ?>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><textarea name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsPagoVehiculoIngreso->PviObservacion;?></textarea></td>
...
<input name="CmpVehiculoUnidadMedidaEquivalente"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoUnidadMedidaEquivalente" size="3" maxlength="20"  />
  ...
  <input name="CmpPagoVehiculoIngresoDetalleCostoIngreso"  type="hidden" class="EstFormularioCaja" id="CmpPagoVehiculoIngresoDetalleCostoIngreso" size="3" maxlength="20"  />                             
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td valign="middle"><a href="javascript:FncPagoVehiculoIngresoDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                            ...
                            <td valign="middle"><a href="javascript:FncPagoVehiculoIngresoDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                            <td valign="middle">
              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <!--<a href="javascript:FncPagoVehiculoIngresoDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>--></td>
