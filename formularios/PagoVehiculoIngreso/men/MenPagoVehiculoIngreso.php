...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"PagoVehiculoIngreso","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"PagoVehiculoIngreso","Listado") and empty($GET_dia)){
?>  
