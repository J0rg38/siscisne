...
$().ready(function() {
	...
	$("input,select,textarea").keypress(function (event) {  
		 if (event.keyCode == '13' && this.type !== "hidden") {
			FncClientePagoFacturaNavegar(this.id);
		 }
	}); 
...
*/
	...
	$("select#CmpMonedaId").change(function(){
		FncClientePagoFacturaEstablecerMoneda();
	});
	
	$("select#CmpCuentaId").change(function(){
		FncClientePagoFacturaEstablecerCuenta();
	});
...
function FncClientePagoFacturaNavegar(oCampo){
...
function FncClientePagoFacturaEstablecerMoneda(){
...
function FncClientePagoFacturaEstablecerCuenta(){
