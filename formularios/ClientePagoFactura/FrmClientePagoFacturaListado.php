...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsClientePagoFactura.js"></script>
<?php
/* 
...
$ResClientePago = $InsClientePago->MtdObtenerClientePagos("CpaId,CpaTransaccionNumero,CueNumero,BanNombre","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_FormaPago,$POST_Moneda,NULL,$GET_FacId,$GET_FtaId);
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "FacId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacId','ASC');"> Factura <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacId','DESC');"> Factura <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
...
?>
    ...
    <a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $dat->CpaId;?><?php echo (!empty($GET_dia)?'&Dia=1':'');?>&FacId=<?php echo $GET_FacId;?>&FtaId=<?php echo $GET_FtaId;?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>
...
?>
    ...
    <a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->CpaId;?><?php echo (!empty($GET_dia)?'&Dia=1':'');?>&FacId=<?php echo $GET_FacId;?>&FtaId=<?php echo $GET_FtaId;?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
