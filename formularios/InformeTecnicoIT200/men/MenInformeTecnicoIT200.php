...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"InformeTecnico","Listado")){
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=InformeTecnico&Form=Listado"><img src="imagenes/iconos/listado.png" alt="[Listado]"  title="Ir a formulario de listado" />Listado</a></div>
<?php
}
?>
