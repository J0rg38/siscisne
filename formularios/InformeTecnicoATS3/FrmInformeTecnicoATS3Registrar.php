...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccInformeTecnicoATS3Registrar.php');
//DATOS
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">REGISTRAR INFORME TECNICO ATS3</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<div class="EstFormularioArea">
                   <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                     ...
                     <tr>
                       ...
                       <td align="left" valign="top"><input readonly="readonly" name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsInformeTecnico->IteId;?>" size="15" maxlength="20" /></td>
                     ...
                     <tr>
                       ...
                       <td align="left" valign="top">Fecha de Venta:<br />
                         <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
                       <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFechaVenta" type="text" id="CmpFechaVenta" value="<?php echo $InsInformeTecnico->IteFechaVenta;?>" size="15" maxlength="10" />                         <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaVenta" name="BtnFechaVenta" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
                       <td>&nbsp;</td>
                     </tr>
                     <tr>
                       <td>&nbsp;</td>
                     ...
                     <tr>
                       ...
                       <td align="left"><input name="CmpMonedaId" type="hidden" id="CmpMonedaId" value="<?php echo $InsInformeTecnico->MonId;?>" size="3" />
                         <input name="CmpTipoCambio" type="TEXT" id="CmpTipoCambio" value="<?php echo $InsInformeTecnico->IteTipoCambio;?>" size="3" /></td>
                       <td align="left">&nbsp;</td>
                       <td>&nbsp;</td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                       ...
                       <td colspan="3" align="left"><select name="CmpPersonal" id="CmpPersonal" class="EstFormularioCombo" >
...
Calendar.setup({ 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnFechaVenta"// el id del bot�n que  
	});
