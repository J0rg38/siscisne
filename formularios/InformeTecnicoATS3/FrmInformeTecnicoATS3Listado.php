...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsInformeTecnicoATS3.js" ></script>
...
$ResInformeTecnico = $InsInformeTecnico->MtdObtenerInformeTecnicos($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_estado,"VMA-10017");
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE FICHAS TECNIAS ATS3</span>  </td>
</tr>
<tr>
  <td width="47%">
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "IteId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('IteId','ASC');"> Id. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('IteId','DESC');"> Id. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "IteFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('IteFecha','ASC');"> Fecha <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('IteFecha','DESC');"> Fecha <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "ItePropietario"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('ItePropietario','ASC');"> Propietario <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('ItePropietario','DESC');"> Propietario <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				?></th>
                <th width="21%" ><?php
				if($POST_ord == "ItePlaca"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('ItePlaca','ASC');"> Placa/Serie <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('ItePlaca','DESC');"> Placa/Serie <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('ItePlaca','ASC');"> Placa/Serie </a>
                <?php
				}
				?></th>
                <th width="21%" ><?php
				if($POST_ord == "IteModelo"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('IteModelo','ASC');"> Modelo <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('IteModelo','DESC');"> Modelo <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('IteModelo','ASC');"> Modelo </a>
                <?php
				}
				?></th>
                <th width="6%" ><?php
				...
				if($POST_ord == "IteTiempoCreacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('IteTiempoCreacion','ASC');"> Fecha de Registro <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('IteTiempoCreacion','DESC');"> Fecha de Registro <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->IteId; ?>" />				</td>

                <td align="right" valign="middle" width="9%"   ><?php echo $dat->IteId;  ?></td>
                <td  width="4%" align="right" ><?php echo $dat->IteFecha;  ?></td>
                <td  width="12%" align="right" ><?php echo ($dat->ItePropietario);?></td>
                <td  width="4%" align="right" ><?php echo ($dat->EinVIN);?></td>
                <td  width="21%" align="right" ><?php echo ($dat->ItePlaca);?></td>
                <td  width="21%" align="right" ><?php echo ($dat->IteModelo);?></td>
                <td  width="6%" align="right" ><?php echo ($dat->FinVehiculoKilometraje);?></td>
                <td  width="10%" align="right" ><?php echo ($dat->IteTiempoCreacion);?></td>
