          ...
          <tr>
            ...
            <td align="center">
              ...
              ?>
                ...
                <a class="EstSesionObjetosItem" href="javascript:FncAlmacenMovimientoEntradaDetalleEscoger('<?php echo $DatSesionObjeto->Item; ?>');"><img border="0" align="absmiddle" src="imagenes/editar.gif" alt="[Editar]" title="Editar" width="15" height="15" /></a>
          ...
          ?>
            ...
            ?>
              ...
              <tr id="Fila_<?php echo $fila; ?>">
                ...
                <td align="right" class="<?php //echo ($c%2==0)?"EstTablaListadoActivo":"EstTablaListadoInactivo";
                                          ?>"><?php echo $DatAlmacenMovimientoEntradaDetalle->Parametro2; ?></td>
                <td align="right" class="<?php //echo ($c%2==0)?"EstTablaListadoActivo":"EstTablaListadoInactivo";
                                          ?>">
                ...
                <td align="right" class="<?php //echo ($c%2==0)?"EstTablaListadoActivo":"EstTablaListadoInactivo";
                                          ?>"><?php echo $DatAlmacenMovimientoEntradaDetalle->Parametro18; ?></td>
                <td align="right" class="<?php //echo ($c%2==0)?"EstTablaListadoActivo":"EstTablaListadoInactivo";
                                          ?>">
                  <?php echo $DatAlmacenMovimientoEntradaDetalle->Parametro3; ?></td>
                <td align="right" class="<?php //echo ($c%2==0)?"EstTablaListadoActivo":"EstTablaListadoInactivo";
                                          ?>"><?php echo $DatAlmacenMovimientoEntradaDetalle->Parametro9; ?>
                ...
                <td align="center" class="<?php //echo ($c%2==0)?"EstTablaListadoActivo":"EstTablaListadoInactivo";
                  ...
                  if ($_POST['Editar'] == 1) {
                  ?>
                    <a class="EstSesionObjetosItem" href="javascript:FncAlmacenMovimientoEntradaDetalleEscoger('<?php echo $DatAlmacenMovimientoEntradaDetalle->Item; ?>');"><img border="0" align="absmiddle" src="imagenes/editar.gif" alt="[Editar]" title="Editar" width="15" height="15" /></a>
                  <?php
                  }
                  ?>
