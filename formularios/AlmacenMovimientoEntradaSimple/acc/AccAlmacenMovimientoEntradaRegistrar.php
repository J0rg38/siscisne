	...
	if($Guardar){
		...
		if($InsAlmacenMovimientoEntrada->MtdRegistrarAlmacenMovimientoEntrada()){
			...
			if(!empty($InsAlmacenMovimientoEntrada->OcoId)){
				...
				//$InsAlmacenMovimientoEntrada->MtdNotificarAlmacennMovimientoEntradaOrdenCompra($InsAlmacenMovimientoEntrada->AmoId,"jblanco@cyc.com.pe,lmoreano@cyc.com.pe,aliendo@cyc.com.pe,iquezada@cyc.com.pe,scanepam@cyc.com.pe,cchoque@cyc.com.pe");
				$InsAlmacenMovimientoEntrada->MtdNotificarAlmacennMovimientoEntradaOrdenCompra($InsAlmacenMovimientoEntrada->AmoId,$CorreosNotificacionAlmacenMovimientoEntrada);
...
function FncNuevo(){
	...
	$InsAlmacenMovimientoEntrada->AlmId = "ALM-10000";
