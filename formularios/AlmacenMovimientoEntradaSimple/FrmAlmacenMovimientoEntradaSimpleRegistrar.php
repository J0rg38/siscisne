...
?>
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccAlmacenMovimientoEntradaSimpleRegistrar.php');
  ...
  //MtdObtenerAlmacenes($oCampo=NULL,$oFiltro=NULL,$oOrden = 'AlmId',$oSentido = 'Desc',$oPaginacion = '0,10',$oSucursal=NULL)
...
*/
    ...
    */
    ...
    var AlmacenMovimientoEntradaSimpleDetalleEliminar = 1;
  </script>
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                              ...
                              <table>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <a id="BtnProveedorRegistrar" onclick="FncProveedorCargarFormulario('Registrar','','');" href="javascript:void(0)" title=""> <img src="imagenes/acciones/registrar.png" alt="[Registrar]" width="25" height="25" border="0" align="absmiddle" title="Registrar" /></a>



                                    <a id="BtnProveedorEditar" onclick="FncProveedorCargarFormulario('Editar','','');" href="javascript:void(0)" title=""> <img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" /></a>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpComprobanteFecha" type="text" id="CmpComprobanteFecha" value="<?php echo $InsAlmacenMovimientoEntrada->AmoComprobanteFecha; ?>" size="10" maxlength="10" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              <table>
                                <tr>
                                  <td><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncAlmacenMovimientoEntradaSimpleDetalleListar();" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoTipoCambio)) {
                                                                                                                                                                                                              echo "";
                                                                                                                                                                                                            } else {
                                                                                                                                                                                                              echo $InsAlmacenMovimientoEntrada->AmoTipoCambio;
                                                                                                                                                                                                            } ?>" size="10" maxlength="10" readonly="readonly" /></td>
                                  <td><a href="javascript:FncAlmacenMovimientoEntradaSimpleEstablecerMoneda();"><img src="imagenes/acciones/recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /></a></td>
                                </tr>
                              </table>
                            </td>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><iframe src="formularios/AlmacenMovimientoEntrada/acc/AccAlmacenMovimientoEntradaSubirArchivo.php?Identificador=<?php echo $Identificador; ?>" id="IfrAlmacenMovimientoEntradaSubirArchivo" name="IfrAlmacenMovimientoEntradaSubirArchivo" scrolling="Auto" frameborder="0" width="400" height="200"></iframe></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                            ...
                            <td width="98%">
                              ...
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                  ...
                                  <td><a href="javascript:FncAlmacenMovimientoEntradaSimpleDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            ...
                            <td width="1%">
                              <div id="CapAlmacenMovimientoEntradaSimpleDetallesResultado"> </div>
                            </td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapAlmacenMovimientoEntradaSimpleDetalles" class="EstCapAlmacenMovimientoEntradaSimpleDetalles"> </div>
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                        </table>
