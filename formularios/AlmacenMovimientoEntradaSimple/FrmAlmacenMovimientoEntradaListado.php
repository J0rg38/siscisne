...
?>
	...
	<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsAlmacenMovimientoEntrada.js"></script>
	<?php
	/* 
...
*/
	...
	<form id="FrmListado" name="FrmListado" enctype="multipart/form-data" method="POST" action="#">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE ENTRADAS A ALMACEN</span>
					</td>
				</tr>
				<tr>
					<td width="47%">
        ...
        <td width="14%" align="center"><div id="CapListadoTotal" ></div></td>
						...
						<table width="100%" border="0" cellpadding="2" cellspacing="4" class="EstTablaTotales">
							<tr>
								...
								<td width="17%" align="right" class="EstTablaTotalesContenido">
									<div id="CapListadoSubTotal"></div>
								</td>
								<td width="19%" align="right" class="EstTablaTotalesEtiqueta">IMPUESTO: <span class="EstMonedaSimbolo">
										<?php echo $InsMoneda->MonSimbolo; ?></span></td>
								<td width="16%" align="right" class="EstTablaTotalesContenido">
									<div id="CapListadoImpuesto"></div>
								</td>
								...
								<td width="13%" align="right" class="EstTablaTotalesContenido">
      ...
      <option value="AmoId" <?php if ($POST_cam == "AmoId") {
								echo 'selected="selected"';
							} ?>>Id</option>
      <option value="PrvNombre" <?php if ($POST_cam == "PrvNombre") {
									echo 'selected="selected"';
								} ?>>Proveedor</option>      
      <option value="AmoComprobanteNumero" <?php if ($POST_cam == "AmoComprobanteNumero") {
												echo 'selected="selected"';
											} ?>>Num. Comprobante</option>      
      <option value="AmoGuiaRemisionNumero" <?php if ($POST_cam == "AmoGuiaRemisionNumero") {
												echo 'selected="selected"';
											} ?>>Num. G. Remision</option>      
						...
						<select class="EstFormularioCombo" name="Moneda" id="Moneda">
							...
							?>
								<option value="<?php echo $DatMoneda->MonId ?>" <?php if ($POST_Moneda == $DatMoneda->MonId) {
																					echo 'selected="selected"';
						...
						<select class="EstFormularioCombo" name="TipoFecha" id="TipoFecha">
							<option value="AmoFecha" <?php if ($POST_TipoFecha == "AmoFecha") {
															echo 'selected="selected"';
														} ?>>Fecha Ingreso</option>
							<option value="AmoComprobanteFecha" <?php if ($POST_TipoFecha == "AmoComprobanteFecha") {
																	echo 'selected="selected"';
																} ?>>Fecha Comprobante</option>
						</select>
								...
								<tr>
									...
									<th width="1%">
										...
										if ($POST_ord == "AmoId") {
											if ($POST_sen == "DESC") {
										?>
												<a href="javascript:FncOrdenar('AmoId','ASC');"> Id. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
											<?php
											} else {
											?>
												<a href="javascript:FncOrdenar('AmoId','DESC');"> Id. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /> </a>
											<?php
											}
										} else {
									...
									<th width="3%"><?php
													if ($POST_ord == "AmoFecha") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoFecha','ASC');"> Fec. Ingreso <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoFecha','DESC');"> Fec. Ingreso <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
									...
									<th width="4%"><?php
													if ($POST_ord == "CtiNombre") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('CtiNombre','ASC');"> Comprob. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('CtiNombre','DESC');"> Comprob. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
									...
									<th width="4%"> <?php
													if ($POST_ord == "AmoComprobanteNumero") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoComprobanteNumero','ASC');"> Num. Comprob. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoComprobanteNumero','DESC');"> Num. Comprob. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
									...
									<th width="4%"> <?php
													if ($POST_ord == "AmoComprobanteFecha") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoComprobanteFecha','ASC');"> Fec. Comprob. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoComprobanteFecha','DESC');"> Fec. Comprob. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
									...
									<th width="3%">
										...
										if ($POST_ord == "AmoGuiaRemisionFecha") {
											if ($POST_sen == "DESC") {
										?>
												<a href="javascript:FncOrdenar('AmoGuiaRemisionFecha','ASC');"> G. Rem. Fec.<img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
											<?php
											} else {
											?>
												<a href="javascript:FncOrdenar('AmoGuiaRemisionFecha','DESC');">G. Rem. Fec.<img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /> </a>
											<?php
											}
										} else {
									...
									<th width="5%"><?php
													if ($POST_ord == "AmoSubTotal") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoSubTotal','ASC');"> Sub Total<img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoSubTotal','DESC');"> Sub Total <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /> </a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('AmoSubTotal','ASC');"> Sub Total </a>
										<?php
													}
										?>
									</th>
									<th width="4%"><?php
													if ($POST_ord == "AmoImpuesto") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoImpuesto','ASC');"> Impuesto <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoImpuesto','DESC');"> Impuesto <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /> </a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('AmoImpuesto','ASC');"> Impuesto </a>
										<?php
													}
										?>
									</th>
									<th width="5%"><?php
													if ($POST_ord == "AmoTotal") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoTotal','ASC');"> Total <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoTotal','DESC');"> Total <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /> </a>
											<?php
														}
													} else {
									...
									<th width="2%"><?php
													if ($POST_ord == "AmoCancelado") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoCancelado','ASC');">Abonado <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoCancelado','DESC');"> Abonado <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('AmoCancelado','ASC');"> Abonado </a>
										<?php
													}
										?>
									</th>
									<th width="2%"><?php
													if ($POST_ord == "AmoEstado") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoEstado','ASC');">Est. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoEstado','DESC');"> Est. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
									...
									<th width="2%"><?php
													if ($POST_ord == "AmoTotalItems") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoTotalItems','ASC');"> <span title="Items">It.</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoTotalItems','DESC');"> <span title="Items">It.</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
									...
									<th width="6%"> <?php
													if ($POST_ord == "AmoTiempoCreacion") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('AmoTiempoCreacion','ASC');"> Fecha Creacion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('AmoTiempoCreacion','DESC');"> Fecha Creacion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" /></a>
											<?php
														}
													} else {
								...
								<tr>
									...
									<td colspan="24" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $AlmacenMovimientoEntradasTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $AlmacenMovimientoEntradasTotal; ?>">Todos</option>
										</select>
								...
								?>
									...
									<tr id="Fila_<?php echo $f; ?>">
										...
										<td width="1%" align="center">
											...
											<input indice="<?php echo $f; ?>" onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->AmoId; ?>" nota_credito_compra="<?php echo $dat->AmoNotaCreditoCompra; ?>" />
										</td>
										...
										<td width="4%" align="right"><?php echo $dat->AmoComprobanteNumero;  ?> <br /></td>
										...
										<td width="3%" align="right"><?php echo $dat->AmoGuiaRemisionFecha;  ?></td>
										...
										<td width="5%" align="right">
											...
											<?php $dat->AmoSubTotal = (($EmpresaMonedaId == $POST_Moneda or empty($POST_Moneda)) ? $dat->AmoSubTotal : ($dat->AmoSubTotal / $dat->AmoTipoCambio)); ?>
											<?php echo number_format($dat->AmoSubTotal, 2); ?>
											<?php
											$SubTotal += $dat->AmoSubTotal;

											?>
										</td>
										<td width="4%" align="right">

											<?php $dat->AmoImpuesto = (($EmpresaMonedaId == $POST_Moneda or empty($POST_Moneda)) ? $dat->AmoImpuesto : ($dat->AmoImpuesto / $dat->AmoTipoCambio)); ?>
											<?php echo number_format($dat->AmoImpuesto, 2); ?>
											<?php
											$Impuesto += $dat->AmoImpuesto;
        ...
        -->
										...
										<td width="12%" align="center">
											...
											<?php
											if ($PrivilegioEliminar and $dat->AmoNotaCreditoCompra == "No") {
											?>
											...
											<?php
											if ($PrivilegioEditar  and $dat->AmoNotaCreditoCompra == "No") {
											?>
											...
											?>
												<a href="principal.php?Mod=Reclamo&Form=Registrar&Origen=AlmacenMovimientoEntrada&AmoId=<?php echo $dat->AmoId; ?>"><img src="imagenes/iconos/reclamo.png" width="19" height="19" border="0" title="Reclamo" alt="[Reclamo]" /></a>
