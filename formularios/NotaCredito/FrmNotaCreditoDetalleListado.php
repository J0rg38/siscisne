...
$RepSesionObjetos = $_SESSION['InsNotaCreditoDetalle'.$Identificador]->MtdObtenerSesionObjetos(true);
...
if($_POST['Editar']==1){
?>
<!--<a class="EstSesionObjetosItem" href="javascript:FncNotaCreditoDetalleEscoger('<?php echo $DatSesionObjeto->Parametro2;?>','<?php echo $DatSesionObjeto->Parametro5;?>','<?php echo $DatSesionObjeto->Parametro6;?>','<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>-->

<a class="EstSesionObjetosItem" href="javascript:FncNotaCreditoDetalleEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
<?php
}
?>
...
if($_POST['Eliminar']==1){
?>
<a href="javascript:FncNotaCreditoDetalleEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
...
?>
    ...
    <tr>
      ...
      <td width="1%">:</td>
      <td width="36%"><?php echo $_SESSION['InsNotaCreditoDatoAdicional1'.$Identificador]?></td>
      <td width="15%">Tracción</td>
      <td width="1%">:</td>
      <td width="34%"><?php echo $_SESSION['InsNotaCreditoDatoAdicional2'.$Identificador]?></td>
    </tr>
    <tr>
      <td>Modelo</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional3'.$Identificador]?></td>
      <td>Carroceria</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional4'.$Identificador]?></td>
    </tr>
    <tr>
      <td>Año Mod.</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional27'.$Identificador]?></td>
      <td>No. Puertas</td>
      <td>&nbsp;</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional6'.$Identificador]?></td>
    </tr>
    <tr>
      <td height="23">No. Motor</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional7'.$Identificador]?></td>
      <td>Combustible</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional8'.$Identificador]?></td>
    </tr>
    <tr>
      <td>No. Cilindros</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional9'.$Identificador]?></td>
      <td>Peso Bruto</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional10'.$Identificador]?></td>
    </tr>
    <tr>
      <td>No. Ejes</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional11'.$Identificador]?></td>
      <td>Carga Util</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional12'.$Identificador]?></td>
    </tr>
    <tr>
      <td>No. Chasis</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional13'.$Identificador]?></td>
      <td>Peso Seco</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional14'.$Identificador]?></td>
    </tr>
    <tr>
      <td>Color</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional15'.$Identificador]?></td>
      <td>Alto</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional16'.$Identificador]?></td>
    </tr>
    <tr>
      <td>Cilindrada</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional17'.$Identificador]?></td>
      <td>Largo</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional18'.$Identificador]?></td>
    </tr>
    <tr>
      <td>No. Asientos</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional19'.$Identificador]?></td>
      <td>Ancho</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional20'.$Identificador]?></td>
    </tr>
    <tr>
      <td>Cap. Pasajeros</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional21'.$Identificador]?></td>
      <td>Dist. Ejes</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsNotaCreditoDatoAdicional22'.$Identificador]?></td>
    </tr>
    <tr>
      <td>No. Poliza</td>
      <td>:</td>
      <td colspan="4"><?php echo $_SESSION['InsNotaCreditoDatoAdicional23'.$Identificador]?></td>
      </tr>
    </table>
