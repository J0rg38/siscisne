...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccNotaCreditoEditar.php');
...
<tr>
  <td>Serie:</td>
  <td><input type="hidden" value="<?php echo $InsNotaCredito->NctId; ?>" name="CmpTalonario" id="CmpTalonario" />
...
<td><input name="CmpId" type="text" class="EstFormularioCaja" id="CmpId" value="<?php echo $InsNotaCredito->NcrId;?>" size="20" maxlength="20" readonly="readonly"  />
			...
			//}
			  ?>       
                                                                ...
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  <td>Direccion:</td>
                                                                  <td><input name="CmpClienteDireccion" type="text" class="EstFormularioCaja" id="CmpClienteDireccion" tabindex="5" value="<?php echo $InsNotaCredito->NcrDireccion;?>" size="45" maxlength="255" readonly="readonly"  /></td>
                                                                  <td>&nbsp;</td>
                                                                  <td>Fecha de Emisi&oacute;n:<br />
                                                                  <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
                                                                  <td><span id="sprytextfield1">
                                                                    <label>
                                                                    <input tabindex="6" class="EstFormularioCajaFecha" name="CmpFechaEmision" type="text" id="CmpFechaEmision" value="<?php if(empty($InsNotaCredito->NcrFechaEmision)){ echo date("d/m/Y");}else{ echo $InsNotaCredito->NcrFechaEmision; }?>" size="15" maxlength="10" <?php echo (($PrivilegioEditarEspecial)?'':'readonly="readonly"');?>  />
                                                                    </label>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td><textarea tabindex="7" name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo stripslashes($InsNotaCredito->NcrObservacion);?></textarea></td>
                                                                  <td>&nbsp;</td>
                                                                  <td valign="top">Observaci&oacute;n Impresa:</td>
                                                                  <td><textarea tabindex="8" name="CmpObservacionImpresa" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionImpresa"><?php echo stripslashes($InsNotaCredito->NcrObservacionImpresa);?></textarea></td>
                                                                  <td>&nbsp;</td>
                                                                </tr>
			  ...
			  ?>
																  ...
																  <td valign="top"><textarea tabindex="8" name="CmpMotivo" cols="45" rows="2" class="EstFormularioCaja" id="CmpMotivo"><?php echo stripslashes($InsNotaCredito->NcrMotivo);?></textarea></td>
																  <td>&nbsp;</td>
															    </tr>
																<tr>
																  <td>&nbsp;</td>
...
?>
																...
																<tr>
																  ...
																  <td align="left" valign="top">ISC:<br />
																    (%)</td>
																  <td valign="top"><input onchange="FncNotaCreditoDetalleListar();" name="CmpPorcentajeImpuestoSelectivo" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoSelectivo" value="<?php echo $InsNotaCredito->NcrPorcentajeImpuestoSelectivo;?>" size="10" maxlength="10" /></td>
																  <td>&nbsp;</td>
															    </tr>
																<tr>
																  <td>&nbsp;</td>
			  ...
			  ?>
																  ...
																  <td valign="top"><table>
																    <tr>
																      <td><input  class="EstFormularioCaja" name="CmpTipoCambio" type="text" id="CmpTipoCambio" value="<?php if (empty($InsNotaCredito->NcrTipoCambio)){ echo "";}else{ echo $InsNotaCredito->NcrTipoCambio; } ?>" size="10" maxlength="10" onchange="FncNotaCreditoDetalleListar();" <?php echo (($PrivilegioEditarEspecial)?'':'readonly="readonly"');?>  /></td>
            ...
            <input name="CmpDocumento" type="text" class="EstFormularioCaja" id="CmpDocumento" value="<?php if(!empty($InsNotaCredito->DtaNumero) and !empty($InsNotaCredito->DocId)){ echo $InsNotaCredito->DtaNumero." - ".$InsNotaCredito->DocId; }?>" size="20" maxlength="20" readonly="readonly" <?php echo ((empty($InsNotaCredito->DocId) and empty($InsNotaCredito->DtaId))?'readonly="readonly"':'');?>    />
																...
																<tr>
																  ...
																  <td><input name="CmpOrdenVentaVehiculoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculoId"  tabindex="3" value="<?php  echo $InsNotaCredito->OvvId;?>" size="20" maxlength="20" readonly="readonly" /></td>
																  <td>&nbsp;</td>
																  <td align="left" valign="top">&nbsp;</td>
																  <td align="left" valign="top">&nbsp;</td>
																  <td>&nbsp;</td>
																...
																<tr>
                                                                  <td>&nbsp;</td>
                                                                  <td colspan="2" valign="top"><!--<input <?php echo (($InsNotaCredito->NcrNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpNotificar" id="CmpNotificar" />
...
<!--  <input <?php echo (($InsNotaCredito->NcrEnviarSUNAT==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpEnviarSUNAT" id="CmpEnviarSUNAT" disabled="disabled" />
                 ...
                 -->
                                                                    ...
                                                                    <tr>
                                                                      ...
                                                                      <td><input name="CmpNotaCreditoDetalleDescuento" type="text" class="EstFormularioCajaDeshabilitada" id="CmpNotaCreditoDetalleDescuento" tabindex="12" size="5" maxlength="10" readonly="readonly"  /></td>
                                                                    ...
                                                                    <tr>
                                                                      <td>&nbsp;</td>
                                                                      <td colspan="8" align="right"><input type="checkbox" name="CmpNotaCreditoDetalleGratuito" id="CmpNotaCreditoDetalleGratuito" value="1" />
                                                                        Transf. Grat.
                                                                ...
                                                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td width="47%" align="right"> 
                                                                        <a href="javascript:FncNotaCreditoDetalleListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncNotaCreditoDetalleEliminarTodo();"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eliminar Todo]" align="absmiddle"/> Eliminar Todo</a>
...
<?php
}elseif(!empty($InsNotaCredito->NcrCierre)){
echo ERR_NCR_401;
}
?>
<?php
