...
function FncNotaCreditoImprimir(){
...
//alert(jsPrintSetup.getPaperSizeList());
	...
	for(i=0;i<ArrImpresoras.length;i++){
		...
		if(ArrImpresoras[i]=="NOTA DE CREDITO"){
			Imprimir = true;			
		}
	}
...
//	alert(jsPrintSetup.getPaperMeasure ());
	...
	if(Imprimir==true){
		...
		//jsPrintSetup.setPrinter("NOTA DE CREDITO");	
		...
		alert("No se pudo encontrar la impresora prederminada para la impresion de NotaCreditos.");	
	}*/
