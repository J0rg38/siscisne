...
$NOMBRE = 'R-'.$EmpresaCodigo.'-01-'.$InsNotaCredito->NctNumero.'-'.$InsNotaCredito->NcrId;
$ARCHIVO = $NOMBRE.'.zip';
?>
...
$().ready(function() {
	...
	$('#CapNotaCreditoAccion').html('Conectando con SERVIDOR para descargar archivo cdr...');	
	
	setTimeout("FncNotaCreditoDescargarCDR('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncNotaCreditoDescargarCDR(oArchivo,oUrl){
