...
<title>CONSULTAR ESTADO DE CDR</title>
...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccNotaCreditoConsultarEstadoCDR.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "D101":
					...
					$('#CapNotaCreditoAccion').html('Consulta cdr solicitada correctamente. '+respuesta['MensajeRespuesta']);								
				...
				default:
					...
					$('#CapNotaCreditoAccion').html('Ha ocurrido un error procesando el archivo xml, proceso cancelado. RESPUESTA: '+respuesta['MensajeRespuesta']);
		...
		error: function(respuesta){
			$('#CapNotaCreditoAccion').html('Ha ocurrido un error procesando el archivo xml, proceso cancelado. RESPUESTA: '+respuesta);
