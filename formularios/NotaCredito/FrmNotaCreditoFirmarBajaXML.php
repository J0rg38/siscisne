...
$().ready(function() {
	...
	$.ajax({
		...
		complete: function(response) {
			...
			window.setTimeout("FncNotaCreditoFirmarBajaXML();",5000);
...
function FncNotaCreditoFirmarBajaXML(){
...
function FncNotaCreditoProcesarBajaXML(){
	...
	FncPopUp('FrmNotaCreditoProcesarBajaXML.php?Nombre=<?php echo $GET_Nombre;?>&Id=<?php echo $InsNotaCredito->NcrId;?>&Ta=<?php echo $InsNotaCredito->NctId;?>&Procesar=<?php echo $GET_Procesar;?>&EnviarSUNAT=<?php echo $GET_EnviarSUNAT;?>&P=1',0,0,1,0,0,1,0,350,150);
