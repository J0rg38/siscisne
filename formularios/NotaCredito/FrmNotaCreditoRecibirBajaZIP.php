...
$().ready(function() {
	...
	$('#CapNotaCreditoAccion').html('Recibiendo archivo zip de respuesta...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccNotaCreditoRecibirBajaZIP.php',
		data: 'Nombre=<?php echo $NOMBRE ;?>&Id=<?php echo $InsNotaCredito->NcrId;?>&Ta=<?php echo $InsNotaCredito->FtaId;?>',
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case 1:
					...
					$('#CapNotaCreditoAccion').html('Archivo zip recibido correctamente...');
				...
				case 2:
					...
					$('#CapNotaCreditoAccion').html('Ha ocurrido un error recibiendo el archivo zip de respuesta, intente nuevamente...');					
				...
				default:
					...
					$('#CapNotaCreditoAccion').html('Ha ocurrido un error enviando el archivo zip de respuesta, proceso cancelado...');
					//window.setTimeout("window.close();",5000);
