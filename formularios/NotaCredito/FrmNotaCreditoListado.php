...
*/
	...
	$InsNotaCreditoTalonario = new ClsNotaCreditoTalonario($InsMysql);
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE NOTAS DE CREDITO</span>
					</td>
				</tr>
				<tr>
					<td width="46%">
	...
	<option value="NcrId" <?php if ($POST_cam == "NcrId") {
								echo 'selected="selected"';
							} ?>>Id</option>
    ...
    <option value="NcrOrdenNumero" <?php if ($POST_cam == "NcrOrdenNumero") {
										echo 'selected="selected"';
									} ?>>Num. Orden</option>
    <option value="NcrSIAFNumero" <?php if ($POST_cam == "NcrSIAFNumero") {
										echo 'selected="selected"';
									} ?>>Num. SIAF</option>
     </select>-->
						Fecha Inicio
						...
						<select class="EstFormularioCombo" name="Talonario" id="Talonario">
							...
							?>
								<option <?php if ($POST_tal == $DatNotaCreditoTalonario->NctId) {
											echo 'selected="selected"';
										} ?> value="<?php echo $DatNotaCreditoTalonario->NctId; ?>"><?php echo $DatNotaCreditoTalonario->NctNumero; ?></option>
							<?php
							}
							?>
						</select>
								...
								<tr>
									...
									<td colspan="20" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $NotaCreditosTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $NotaCreditosTotal; ?>">Todos</option>
										</select>
