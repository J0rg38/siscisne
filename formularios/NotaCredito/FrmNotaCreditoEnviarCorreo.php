...
$().ready(function() {
	...
	$('#CapNotaCreditoAccion').html('Conectando con GMAIL para enviar correo electronico...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccNotaCreditoEnviarCorreo.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "1":
					...
					$('#CapNotaCreditoAccion').html('Correo electronico enviado correctamente. '+respuesta['MensajeRespuesta']);	
				...
				case "2":
					...
					$('#CapNotaCreditoAccion').html('No se encontro direccion de correo electronico a enviar. '+respuesta['MensajeRespuesta']);						
				
				break;
				
				case "3":
				
					$('#CapNotaCreditoAccion').html('No se encontro archivo PDF para enviar. '+respuesta['MensajeRespuesta']);						
				
				break;
				
				case "4":
				
					$('#CapNotaCreditoAccion').html('No se encontro archivo XML a enviar. '+respuesta['MensajeRespuesta']);						
				
				break;
				
				case "5":
				
					$('#CapNotaCreditoAccion').html('No se encontro archivo CDR a enviar. '+respuesta['MensajeRespuesta']);						
				
				break;
				
				default:
				
					$('#CapNotaCreditoAccion').html('Ha ocurrido un error enviando el correo electronico, proceso cancelado.');
		...
		error: function(respuesta){
			...
			$('#CapNotaCreditoAccion').html('Ha ocurrido un error interno.');
