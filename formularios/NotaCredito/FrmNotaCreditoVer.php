...
include($InsProyecto->MtdFormulariosMsj("NotaCredito").'MsjNotaCredito.php');
...
include($InsProyecto->MtdRutFormularios().'NotaCredito/acc/AccNotaCreditoEditar.php');
...
*/
var NotaCreditoDetalleEditar = 2;
var NotaCreditoDetalleEliminar = 2;
...
<div class="EstCapMenu">
  <?php
           ...
           <!-- <div class="EstSubMenuBoton"><a href="javascript:FncPopUp('<?php echo $InsProyecto->MtdRutFormularios();?>NotaCredito/FrmNotaCreditoImprimir.php?Id=<?php echo $InsNotaCredito->NcrId;?>&Ta=<?php echo $InsNotaCredito->NctId;?>',0,0,1,0,0,1,0,screen.height,screen.width);"><img src="imagenes/iconos/preliminar.png" alt="[Vista Preliminar]" title="Vista preliminar" />V.P.</a></div>-->
  ...
  <?php
			...
			?>
           <!-- <div class="EstSubMenuBoton"><a href="javascript:FncPopUp('<?php echo $InsProyecto->MtdRutFormularios();?>NotaCredito/FrmNotaCreditoImprimir.php?Id=<?php echo $InsNotaCredito->NcrId;?>&Ta=<?php echo $InsNotaCredito->NctId;?>&P=1',0,0,1,0,1,1,0,screen.height,screen.width);"><img src="imagenes/iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" />Imprimir</a></div>-->
  ...
  <?php
			...
			?>           
             ...
             <div class="EstSubMenuBoton"><a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=<?php echo $GET_mod;?>&Form=Editar<?php echo (!empty($GET_dia)?'&Dia=1':'');?>&Id=<?php echo $InsNotaCredito->NcrId;?>&Ta=<?php echo $InsNotaCredito->NctId;?>"><img src="imagenes/iconos/editar.png" alt="[Editar]" title="Editar" />Editar</a></div>
             <?php
			}
			?>   
...
<div class="tab_container">
    <div id="tab1" class="tab_content">
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td>Creado el:</td>
            <td><span class="EstFormularioDatoRegistro"><?php echo $InsNotaCredito->NcrTiempoCreacion;?></span></td>
            <td>Modificado el</td>
            <td><span class="EstFormularioDatoRegistro"><?php echo $InsNotaCredito->NcrTiempoModificacion;?></span></td>
          </tr>
        </table>
       ...
       <tr>
         <td colspan="2" valign="top"><div class="EstFormularioArea" >
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             <tr>
               <td width="4">&nbsp;</td>
               <td colspan="5"><span class="EstFormularioSubTitulo">Datos de la Nota de Credito 
             ...
             <tr>
			  ...
			  ?>
                     <option <?php if($InsNotaCredito->NctId == $DatNotaCreditoTalonario->NctId){ echo 'selected="selected"';}?> value="<?php echo $DatNotaCreditoTalonario->NctId;?>" ><?php echo $DatNotaCreditoTalonario->NctNumero;?> (<?php echo $DatNotaCreditoTalonario->NctDescripcion;?>)</option>
                     <?php
			  }
			  ?>
                   </select></td>
                   <td align="center">Numero:</td>
                 <td align="left"><input readonly="readonly" class="EstFormularioCaja" name="CmpId" type="text" id="CmpId" value="<?php echo $InsNotaCredito->NcrId;?>" size="20" maxlength="20" /></td>
                 </tr>
                 </table></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
               ...
               <td width="377" align="left" valign="top"><input readonly="readonly" class="EstFormularioCaja" name="CmpClienteNombre" type="text" id="CmpClienteNombre" size="45" maxlength="255" value="<?php echo $InsNotaCredito->CliNombre;?>" />
                 <!--       <br /><br />
        <a href="javascript:void(0);" onclick="popupCssShow('default.php?page=pagina-2', 460);" title="Abrir PopUp 1">Abrir PopUp 2</a>-->               </td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><label>
                 <input readonly="readonly" class="EstFormularioCaja" name="CmpClienteNumeroDocumento" type="text" id="CmpClienteNumeroDocumento" size="20" maxlength="50" value="<?php echo $InsNotaCredito->CliNumeroDocumento;?>" />
               </label></td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><label>
                 <input readonly="readonly" class="EstFormularioCaja" name="CmpClienteDireccion" type="text" id="CmpClienteDireccion" size="45" maxlength="255" value="<?php echo $InsNotaCredito->NcrDireccion;?>" />
                 </label></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">Fecha de Emisi&oacute;n:<br />
                 <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
               <td align="left" valign="top"><input readonly="readonly" class="EstFormularioCajaFecha" name="CmpFechaEmision" type="text" id="CmpFechaEmision" value="<?php if(empty($InsNotaCredito->NcrFechaEmision)){ echo date("d/m/Y");}else{ echo $InsNotaCredito->NcrFechaEmision; }?>" size="15" maxlength="10" /></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td align="left" valign="top">Observac&oacute;n Interna:</td>
               <td align="left" valign="top"><textarea readonly="readonly" name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo stripslashes($InsNotaCredito->NcrObservacion);?></textarea></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">Observac&oacute;n Impresa:</td>
               <td align="left" valign="top"><textarea readonly="readonly" name="CmpObservacionImpresa" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionImpresa"><?php echo stripslashes($InsNotaCredito->NcrObservacionImpresa);?></textarea></td>
               <td>&nbsp;</td>
             </tr>
			 ...
			 <tr>
			  ...
			  ?>
			   ...
			   <td align="left" valign="top"><textarea name="CmpMotivo" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpMotivo"><?php echo $InsNotaCredito->NcrMotivo;?></textarea></td>
			   <td>&nbsp;</td>
			   </tr>
			 <tr>
			   <td>&nbsp;</td>
...
?>
			 ...
			 <tr>
			   ...
			   <td align="left" valign="top">ISC:<br />
			     (%)</td>
			   <td valign="top"><input name="CmpPorcentajeImpuestoSelectivo" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoSelectivo" onchange="FncNotaCreditoDetalleListar();" value="<?php echo $InsNotaCredito->NcrPorcentajeImpuestoSelectivo;?>" size="10" maxlength="10" readonly="readonly" /></td>
			   <td>&nbsp;</td>
			   </tr>
			 <tr>
			   <td>&nbsp;</td>
			  ...
			  ?>
			   ...
			   <td valign="top"><table>
			     <tr>
			       <td><input name="CmpTipoCambio" type="text"  class="EstFormularioCaja" id="CmpTipoCambio" onchange="FncNotaCreditoDetalleListar();" value="<?php if (empty($InsNotaCredito->NcrTipoCambio)){ echo "";}else{ echo $InsNotaCredito->NcrTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
			       <td><a href="javascript:FncNotaCreditoEstablecerMoneda();"></a></td>
			       </tr>
			     <tr> </tr>
			     </table></td>
			   <td>&nbsp;</td>
			 ...
			 <tr>
			   ...
			   <td align="left" valign="top"><input name="CmpOrdenVentaVehiculoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculoId"  tabindex="3" value="<?php  echo $InsNotaCredito->OvvId;?>" size="20" maxlength="20" readonly="readonly" /></td>
			   <td align="left" valign="top">&nbsp;</td>
			...
			?>
                 <select disabled="disabled" onchange="FncDocumentoAutocompletarCargar(this.value);" class="EstFormularioCombo" name="CmpTipo" id="CmpTipo">
               ...
               <td align="left" valign="top"><input name="CmpDocumentoId" type="hidden" id="CmpDocumentoId" value="<?php echo $InsNotaCredito->DocId;?>" />
                 ...
                 <input name="CmpDocumento" type="text" class="EstFormularioCaja" id="CmpDocumento" value="<?php if(!empty($InsNotaCredito->DtaNumero) and !empty($InsNotaCredito->DocId)){ echo $InsNotaCredito->DtaNumero." - ".$InsNotaCredito->DocId; }?>" size="20" maxlength="20" readonly="readonly"  /></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="2" align="left" valign="top"><!--<input <?php echo (($InsNotaCredito->NcrNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpNotificar" id="CmpNotificar" disabled="disabled"/>
                 Notificar via email<br /> -->
  <input <?php echo (($InsNotaCredito->NcrProcesar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpProcesar" id="CmpProcesar" disabled="disabled" />
                 Procesar comprobante <br />
  <!--<input <?php echo (($InsNotaCredito->NcrEnviarSUNAT==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpEnviarSUNAT" id="CmpEnviarSUNAT" disabled="disabled" />
                 Enviar a SUNAT --></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
       ...
       <tr>
         <td colspan="2" valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="1%">&nbsp;</td>
               <td colspan="2"><div class="EstFormularioAccion" id="CapNotaCreditoDetalleAccion">Listo
                 para registrar elementos</div></td>
               <td width="1%">&nbsp;</td>
               </tr>
             <tr>
               <td>&nbsp;</td>
               <td width="67%"><span class="EstFormularioSubTitulo"> Items
                 que componen la nota de credito</span> </td>
               <td width="31%" align="right"> 
                 <a href="javascript:FncNotaCreditoDetalleListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a>
