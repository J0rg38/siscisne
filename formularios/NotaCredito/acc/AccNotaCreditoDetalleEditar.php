...
$InsNotaCreditoDetalle1 = array();
$InsNotaCreditoDetalle1 = $_SESSION['InsNotaCreditoDetalle'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
...
$_SESSION['InsNotaCreditoDetalle'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsNotaCreditoDetalle1->Parametro1,
addslashes($_POST['Descripcion']),
NULL,
$Precio,
$Cantidad,
$Importe,
$InsNotaCreditoDetalle1->Parametro7,
date("d/m/Y H:i:s"),
$InsNotaCreditoDetalle1->Parametro9,
$InsNotaCreditoDetalle1->Parametro10,
NULL,
$_POST['NotaCreditoDetalleTipo'],
$_POST['UnidadMedida'],
$InsNotaCreditoDetalle1->Parametro14,
$InsNotaCreditoDetalle1->Parametro15,
$InsNotaCreditoDetalle1->Parametro16,
$InsNotaCreditoDetalle1->Parametro17,
$_POST['Codigo'],
$ValorVenta,
$Impuesto,
$Descuento,
//$InsNotaCreditoDetalle1->Parametro21,
$POST_Gratuito,
$POST_Exonerado,
