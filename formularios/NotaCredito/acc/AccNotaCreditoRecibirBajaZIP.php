...
$InsNotaCredito->MtdEditarNotaCreditoDato("NcrSunatUltimaAccion","BAJA",$InsNotaCredito->NcrId,$InsNotaCredito->NctId);
// upload a file
...
//deb($xml_values);
			...
			*/
			...
			$InsNotaCredito->MtdEditarNotaCreditoDato("NcrSunatRespuestaBajaTicket",$TicketRespuesta,$InsNotaCredito->NcrId,$InsNotaCredito->NctId);
			$InsNotaCredito->MtdEditarNotaCreditoDato("NcrSunatRespuestaBajaFecha",$FechaRespuesta,$InsNotaCredito->NcrId,$InsNotaCredito->NctId);
			$InsNotaCredito->MtdEditarNotaCreditoDato("NcrSunatRespuestaBajaHora",$HoraRespuesta,$InsNotaCredito->NcrId,$InsNotaCredito->NctId);
			
			$InsNotaCredito->MtdEditarNotaCreditoDato("NcrSunatRespuestaBajaCodigo",$CodigoRespueta,$InsNotaCredito->NcrId,$InsNotaCredito->NctId);
			$InsNotaCredito->MtdEditarNotaCreditoDato("NcrSunatRespuestaBajaContenido",$MensajeRespuesta,$InsNotaCredito->NcrId,$InsNotaCredito->NctId);
			$InsNotaCredito->MtdEditarNotaCreditoDato("NcrSunatRespuestaBajaTiempoCreacion",date("Y-m-d H:i:s"),$InsNotaCredito->NcrId,$InsNotaCredito->NctId);
