...
//deb($InsNotaCredito->NcrSunatRespuestaTicket);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>NotaCredito No.  <?php echo $InsNotaCredito->NctNumero;?> - <?php echo $InsNotaCredito->NcrId;?></title>
...
$().ready(function() {
	...
	$('#CapNotaCreditoAccion').html('Conectando con SUNAT para consultar estado de ticket...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccNotaCreditoConsultarEstadoTicket.php',
		data: 'Id=<?php echo $InsNotaCredito->NcrId;?>&Ta=<?php echo $InsNotaCredito->NctId;?>&Ticket=<?php echo $InsNotaCredito->NcrSunatRespuestaTicket;?>',
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "C101":
					...
					$('#CapNotaCreditoAccion').html('Consulta de estado de ticket procesado correctamente. RESPUESTA: '+respuesta['MensajeRespuesta']);				
				...
				default:
					$('#CapNotaCreditoAccion').html('Ha ocurrido un error consultando el estado del ticket, proceso cancelado.');
