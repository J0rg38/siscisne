...
$().ready(function() {
	...
	$('#CapNotaCreditoAccion').html('Conectando con SERVIDOR para descargar archivo xml...');	
	
	setTimeout("FncNotaCreditoDescargarXML('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncNotaCreditoDescargarXML(oArchivo,oUrl){
