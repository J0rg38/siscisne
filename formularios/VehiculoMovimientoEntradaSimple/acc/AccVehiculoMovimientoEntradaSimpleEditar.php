...
//			$InsVehiculoMovimientoEntradaDetalle1->VmdCostoIngreso = $DatSesionObjeto->Parametro29;
	...
	if(!empty($InsVehiculoMovimientoEntrada->VehiculoMovimientoEntradaDetalle)){
		foreach($InsVehiculoMovimientoEntrada->VehiculoMovimientoEntradaDetalle as $DatVehiculoMovimientoEntradaDetalle){
			...
			if($InsVehiculoMovimientoEntrada->MonId<>$EmpresaMonedaId and (!empty($InsVehiculoMovimientoEntrada->VmvTipoCambio) )){
				...
				$DatVehiculoMovimientoEntradaDetalle->VmdCostoIngreso = round($DatVehiculoMovimientoEntradaDetalle->VmdCostoIngreso  / $InsVehiculoMovimientoEntrada->VmvTipoCambio,3);
...
//Parametro28 = UmeNombre
			...
			$DatVehiculoMovimientoEntradaDetalle->VmdObservacion,
			...
			$DatVehiculoMovimientoEntradaDetalle->VmdCostoIngreso);
