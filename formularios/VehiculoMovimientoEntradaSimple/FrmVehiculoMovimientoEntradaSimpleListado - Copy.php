...
<?php $PrivilegioVer = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","Ver"))?true:false;?>
<?php $PrivilegioEditar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","Editar"))?true:false;?>
<?php $PrivilegioEliminar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","Eliminar"))?true:false;?>
<?php $PrivilegioGenerarExcel = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","GenerarExcel"))?true:false;?>
<?php $PrivilegioVistaPreliminar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","VistaPreliminar"))?true:false;?>
<?php $PrivilegioImprimir = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","Imprimir"))?true:false;?>
...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoEntradaSimple.js" ></script>
<?php
/* 
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoMovimientoEntradaSimple.php');
...
$ResVehiculoMovimientoEntrada = $InsVehiculoMovimientoEntrada->MtdObtenerVehiculoMovimientoEntradas("VmvId,prv.PrvNombre,prv.PrvApellidoPaterno,prv.PrvApellidoMaterno,VmvComprobanteNumero,VmvGuiaRemisionNumero",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_estado,$POST_Moneda,NULL,"VmvFecha",0,NULL,NULL,$POST_Sucursal,$POST_Almacen,2);
$ArrVehiculoMovimientoEntradas = $ResVehiculoMovimientoEntrada['Datos'];
$VehiculoMovimientoEntradasTotal = $ResVehiculoMovimientoEntrada['Total'];
$VehiculoMovimientoEntradasTotalSeleccionado = $ResVehiculoMovimientoEntrada['TotalSeleccionado'];
...
<tr>
  <td width="47%">
    Mostrando <b><?php echo $VehiculoMovimientoEntradasTotalSeleccionado;?></b> de <b><?php echo $VehiculoMovimientoEntradasTotal;?></b> registros.</td>
...
<!--    <select class="EstFormularioCombo" name="Cam" id="Cam">
    ...
    <option value="VmvFecha" <?php if($POST_TipoFecha=="VmvFecha"){ echo 'selected="selected"';}?>>Fecha de Ingreso</option>
    <option value="VmvComprobanteFecha" <?php if($POST_TipoFecha=="VmvComprobanteFecha"){ echo 'selected="selected"';}?>>Fecha Comprobante</option>  
    </select>
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "VmvFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VmvFecha','ASC');"> Fec. Ingreso <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VmvFecha','DESC');"> Fec. Ingreso <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('VmvFecha','ASC');"> Fec. Ingreso </a>
                  <?php
				}
				?></th>
                <th width="7%" ><?php
				...
				if($POST_ord == "VmvComprobanteNumero"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteNumero','ASC');"> Num. Comprob. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteNumero','DESC');"> Num. Comprob. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteNumero','ASC');"> Num. Comprob. </a>
                  <?php
				}
				?></th>
                <th width="7%" > <?php
				if($POST_ord == "VmvComprobanteFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteFecha','ASC');"> Fec. Comprob. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteFecha','DESC');"> Fec. Comprob. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteFecha','ASC');"> Fec. Comprob. </a>
                  <?php
				}
				?></th>
                <th width="6%" ><?php
                ...
                <th width="4%" >
                  ...
                  <?php
				if($POST_ord == "VmvNotaCreditoCompra"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VmvNotaCreditoCompra','ASC');">  N. Cre. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VmvNotaCreditoCompra','DESC');">  N. Cre. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('VmvNotaCreditoCompra','ASC');">  N. Cre.  </a>
                  <?php
				}
				?>
...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
				  ...
				  <option <?php if($POST_num==$VehiculoMovimientoEntradasTotal){ echo 'selected="selected"';}?> value="<?php echo $VehiculoMovimientoEntradasTotal;?>">Todos</option>
                </select>
				...
				<?php
					...
					//if(empty($POST_fil)){
						$tregistros = $VehiculoMovimientoEntradasTotal;
					//}else{
					//	$tregistros = ($VehiculoMovimientoEntradasTotalSeleccionado);
					//}
 ...
 <tbody class="EstTablaListadoBody">
            <?php
					...
					$Impuesto = 0;
					$Total = 0;
								foreach($ArrVehiculoMovimientoEntradas as $dat){
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle" width="2%"   >
                  <a href="principal.php?Mod=VehiculoMovimientoEntrada&Form=Ver&Id=<?php echo $dat->VmvId;  ?>">
                  <?php echo $dat->VmvId;  ?>
                ...
                <td  width="5%" align="right" ><?php echo ($dat->VmvFecha);?></td>
                <td  width="7%" align="right" ><?php echo $dat->CtiNombre;  ?></td>
                <td  width="7%" align="right" >
				
				<?php echo $dat->VmvComprobanteNumero;  ?></td>
                <td  width="7%" align="right" ><?php echo $dat->VmvComprobanteFecha;  ?></td>
...
?>
                ...
                <td  width="4%" align="right" >
                  ...
                  <?php
if($dat->VmvNotaCreditoCompra == "Si"){
?>
                  <!-- class="thickbox"-->
                  <a href="javascript:FncNotaCreditoCompraListado('<?php echo $dat->VmvId?>');" title="">Tiene N. Cred.</a>    
...
?>    
                ...
                <td  width="3%" align="right" ><?php echo $dat->VmvEstadoIcono;?> <?php echo $dat->VmvEstadoDescripcion;?>
                  <?php
...
?>
                  <a  class="thickbox" href="subidos/vehiculo_movimiento_fotos/<?php echo $dat->VmvFoto;?>"  title=""><img  src="imagenes/documento.gif" width="20" height="20" border="0"  /></a>
                <?php	
}
?></td>
...
?>
			...
			?>        
                  <a href="principal.php?Mod=NotaCreditoCompra&Form=Registrar&Origen=VehiculoMovimientoEntrada&VmvId=<?php echo $dat->VmvId; ?>"><img src="imagenes/iconos/nota_credito_compra.png" width="19" height="19" border="0" title="Nota de Credito" alt="[Nota de Credito]"   /></a>
			...
			?>        
                  <a href="principal.php?Mod=Reclamo&Form=Registrar&Origen=VehiculoMovimientoEntrada&VmvId=<?php echo $dat->VmvId; ?>"><img src="imagenes/iconos/reclamo.png" width="19" height="19" border="0" title="Reclamo" alt="[Reclamo]"   /></a>
