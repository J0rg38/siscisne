...
$RepVehiculoMovimientoEntradaDetalle = $_SESSION['InsVehiculoMovimientoEntradaDetalle'.$Identificador]->MtdObtenerSesionObjetos(true);
$ArrVehiculoMovimientoEntradaDetalles = $RepVehiculoMovimientoEntradaDetalle['Datos'];
...
?>
        ...
        ?>
            ...
            //$CantidadTotal = 0;
            //$TotalItems = 0;
            foreach($ArrVehiculoMovimientoEntradaDetalles as $DatSesionObjeto){
            ?>
       ...
       <!--     
 <a href="javascript:FncVehiculoMovimientoEntradaSimpleDetalleReemplazorCargar('<?php echo  $Identificador;?>','<?php echo trim($DatSesionObjeto->Item);?>');"><?php echo $DatSesionObjeto->Parametro17;?></a>-->
...
-->
            ...
            <td align="right"><?php echo (($DatSesionObjeto->Parametro28));?></td>
            <td align="right">
            ...
            <td align="right"><!--<select  class="EstFormularioCombo" name="CmpVehiculoMovimientoEntradaSimpleDetalleEstado_<?php echo $DatSesionObjeto->Item;?>" id="CmpVehiculoMovimientoEntradaSimpleDetalleEstado_<?php echo $DatSesionObjeto->Item;?>" <?php echo ($POST_Editar==2 or  $VehiculoMovimientoEntradaDetalleFacturado == "1" or $VehiculoMovimientoEntradaDetalleCierre == "1")?'disabled="disabled"':'';?>>
              <option value="">-</option>
              <option <?php echo (($DatSesionObjeto->Parametro25=="1")?'selected="selected"':'');?> value="1">No Llego</option>
              <option <?php echo (($DatSesionObjeto->Parametro25=="2")?'selected="selected"':'');?> value="1">Dañado</option>
              <option <?php echo (($DatSesionObjeto->Parametro25=="3")?'selected="selected"':'');?> value="3">Conforme</option>
            </select>-->
            
            
            <select  class="EstFormularioCombo" name="CmpVehiculoMovimientoEntradaSimpleDetalleEstado_<?php echo $DatSesionObjeto->Item;?>" id="CmpVehiculoMovimientoEntradaSimpleDetalleEstado_<?php echo $DatSesionObjeto->Item;?>" <?php echo ($POST_Editar==2 or  $VehiculoMovimientoEntradaDetalleFacturado == "1" or $VehiculoMovimientoEntradaDetalleCierre == "1")?'disabled="disabled"':'';?>>
              <option value="">-</option>
            ...
            <a class="EstSesionObjetosItem" href="javascript:FncVehiculoMovimientoEntradaSimpleDetalleEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
            ...
            if($_POST['Eliminar']==1){
            ?>
            <a href="javascript:FncVehiculoMovimientoEntradaSimpleDetalleEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
