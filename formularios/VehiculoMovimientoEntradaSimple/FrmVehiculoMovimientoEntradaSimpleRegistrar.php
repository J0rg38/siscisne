...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoMovimientoEntradaSimpleRegistrar.php');
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
			...
			?>
                          ...
                          <td><input class="EstFormularioCaja" name="CmpProveedorNombreCompleto" type="text" id="CmpProveedorNombreCompleto" value="<?php echo $InsVehiculoMovimientoEntrada->PrvNombreCompleto;?>" size="45" maxlength="255"  />
                            ...
                            <input name="CmpProveedorApellidoMaterno" type="hidden" id="CmpProveedorApellidoMaterno" value="<?php echo $InsVehiculoMovimientoEntrada->PrvApellidoMaterno;?>" size="3" />
...
<input name="CmpVehiculoUnidadMedidaEquivalente"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoUnidadMedidaEquivalente" size="3" maxlength="20"  />
  ...
  <input name="CmpVehiculoMovimientoEntradaSimpleDetalleCostoIngreso"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoMovimientoEntradaSimpleDetalleCostoIngreso" size="3" maxlength="20"  />                             
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td valign="middle"><a href="javascript:FncVehiculoMovimientoEntradaSimpleDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                            ...
                            <td valign="middle">
                              ...
                              <input name="CmpVehiculoMovimientoEntradaSimpleDetalleCantidad" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoMovimientoEntradaSimpleDetalleCantidad" value="1" size="8" maxlength="10" readonly="readonly" />                            </td>
			...
			?>
                            ...
                            <td valign="middle">
                              ...
                              <input name="CmpVehiculoMovimientoEntradaSimpleDetalleImporte" type="text" class="EstFormularioCaja" id="CmpVehiculoMovimientoEntradaSimpleDetalleImporte" size="8" maxlength="10" />                            </td>
                            ...
                            <td valign="middle"><a href="javascript:FncVehiculoMovimientoEntradaSimpleDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                            <td valign="middle">
              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <!--<a href="javascript:FncVehiculoMovimientoEntradaSimpleDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>--></td>
