            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "VmvComprobanteNumero"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteNumero','ASC');"> Num. Doc. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteNumero','DESC');"> Num. Doc. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteNumero','ASC');"> Num. Doc. </a>
                  <?php
				}
				?></th>
                <th width="7%" > <?php
				if($POST_ord == "VmvComprobanteFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteFecha','ASC');"> Fec. Doc. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteFecha','DESC');"> Fec. Doc. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('VmvComprobanteFecha','ASC');"> Fec. Doc. </a>
                  <?php
				}
				?></th>
                <th width="6%" ><?php
...
?>
				...
				<?php //echo $dat->VmvEstadoIcono;?> 
				<?php echo $dat->VmvEstadoDescripcion;?>
                  <?php
				/*switch($dat->VmvEstado){
...
?>
                  ...
                  <a   href="javascript:FncVisualizarArchivo('subidos/vehiculo_movimiento_fotos/<?php echo $dat->VmvFoto;?>')"> <img  src="imagenes/documento.gif" width="20" height="20" border="0"  /></a>
                <?php	
}
?></td>
