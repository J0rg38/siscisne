<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","Listado")){
?>
...
<?php $PrivilegioGenerarVehiculoMovimientoEntrada = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoMovimientoEntrada","Registrar"))?true:false;?>

<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoEntradaSimpleMonitoreo.js" ></script>
<?php
/* 
...
$ResVehiculoMovimientoSalida = $InsVehiculoMovimientoSalida->MtdObtenerVehiculoMovimientoSalidas("VmvId,prv.CliNombre,prv.CliApellidoPaterno,prv.CliApellidoMaterno,VmvComprobanteNumero,VmvGuiaRemisionNumero",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),1,NULL,NULL,"VmvFecha",0,NULL,NULL,$POST_Sucursal,$POST_Almacen,2,NULL,$_SESSION['SesionSucursal']);
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE TRANSFERENCIAS VEHICULARES EN TRANSITO</span>  </td>
</tr>
<tr>
  <td width="47%">
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td  width="7%" align="right" ><?php echo ($dat->SucNombre);?></td>
...
?>
                ...
                <td  width="3%" align="right" ><?php // echo $dat->VmvEstadoIcono;?> 
                  <?php
...
?>
	 ...
	 <?php
//	if($PrivilegioGenerarVehiculoMovimientoEntrada and $dat->AmoGuiaRemision="No"){
	if($PrivilegioGenerarVehiculoMovimientoEntrada ){
    ?>
                  <a href="principal.php?Mod=VehiculoMovimientoEntradaSimple&Form=Registrar&Origen=VehiculoMovimientoSalida&VmvId=<?php echo $dat->VmvId;?>"><img src="imagenes/acciones/generar.png" width="19" height="19" border="0" title="Generar Ingreso" alt="[Generar Ingreso]"   /></a>
	<?php
	}
	?>
