...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/InformeTecnico/acc/AccInformeTecnicoGenerarExcel.php";
//					break;
					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/InformeTecnico/acc/AccInformeTecnicoGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	document.getElementById("FrmListado").action = "formularios/InformeTecnico/FrmInformeTecnicoListadoImprimir.php"
...
function FncImprmir(oId,oFormato){
	FncPopUp('formularios/InformeTecnico'+oFormato+'/FrmInformeTecnico'+oFormato+'Imprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
}


function FncVistaPreliminar(oId,oFormato){
	FncPopUp('formularios/InformeTecnico'+oFormato+'/FrmInformeTecnico'+oFormato+'Imprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
}
