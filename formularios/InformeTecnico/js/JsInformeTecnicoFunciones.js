...
function FncImprmir(oId){
	...
	FncPopUp('formularios/InformeTecnico/FrmInformeTecnicoImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
...
FncPopUp('formularios/InformeTecnico/FrmInformeTecnicoImprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
