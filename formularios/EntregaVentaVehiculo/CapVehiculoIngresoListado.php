...
<!--Se encontraron <?php echo $SesionObjetosTotalSeleccionado;?> elemento(s)-->
    ...
    <tr>
        ...
        <th width="5%">Año Fab. </th>
        <th width="5%">Año Mod.</th>
        <th width="6%">Num. Motor</th>
        <th width="6%"> Color
        </th>
        <th width="8%">Dias Inmov.</th>
    ...
    <td align="center">
      ...
      <input type="radio" name="RbuVehiculoIngreso" id="RbuVehiculoIngreso_<?php echo $c;?>" value="<?php echo $c;?>" onclick="FncVehiculoIngresoListadoEscoger('<?php echo $c;?>','<?php echo $DatVehiculoIngreso->VveId;?>','<?php echo $VehiculoListaPrecioDetallePrecioLista;?>','<?php echo $VehiculoListaPrecioDetallePrecioCierre;?>','<?php echo $DatVehiculoIngreso->EinColor;?>','<?php echo $DatVehiculoIngreso->EinId;?>','<?php echo $DatVehiculoIngreso->EinAnoModelo;?>','<?php echo $DatVehiculoIngreso->EinVIN;?>','<?php echo $DatVehiculoIngreso->EinDescuentoGerencia;?>','<?php echo $DatVehiculoIngreso->EinAnoFabricacion;?>','<?php echo $DatVehiculoIngreso->EinNumeroMotor;?>');"> 
