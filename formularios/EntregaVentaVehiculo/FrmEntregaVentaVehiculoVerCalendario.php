...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsEntregaVentaVehiculoVerCalendarioFunciones.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">VER CONTROL DE ENTREGA DE VEHICULOS</span></td>
...
<tr>
  ...
  <div id="CapEntregaVentaVehiculoVerCalendario"></div>
