...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccEntregaVentaVehiculoRegistrar.php');
...
<?php
if($InsCotizacionVehiculo->CveGenerarEntregaVentaVehiculo<>"No"){
?>
              ...
              <td width="97%" valign="top">
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4"><span class="EstFormularioSubTitulo">Datos de la Entrega de Vehiculo Programada
        ...
        <p>Some extra select boxes to show to it works under IE.<br/>
			...
			?>
                    ...
                    <tr>
                      ...
                      <input <?php echo (($InsEntregaVentaVehiculo->EvvNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpNotificar" id="CmpNotificar" />
            ...
            <tr>
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  ...
                  <tr>
                    <td width="1%">&nbsp;</td>
                    <td width="49%"><div class="EstFormularioAccion" id="CapEntregaVentaVehiculoPropietarioAccion">Listo
                      para registrar elementos</div></td>
                    <td width="49%" align="right"><a href="javascript:FncEntregaVentaVehiculoPropietarioListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncEntregaVentaVehiculoPropietarioEliminarTodo();"></a></td>
...
Calendar.setup({ 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnFechaProgramada"// el id del bot�n que  
	});
