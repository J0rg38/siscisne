...
function FncValidar(){
	...
	var HoraProgramada = $("#CmpHoraProgramada").val();
		...
		}else if(HoraProgramada == "" || HoraProgramada == "00:00"){			
		
				dhtmlx.alert({
					title:"Aviso",
					type:"alert-error",
					text:"Debes ingresar una hora estimada",
					callback: function(result){
...
//	}); 
	...
	$("#CmpOrdenVentaVehiculoDescuento").keyup(function () {  
		FncEntregaVentaVehiculoDetalleCalcularTotal();
	}); 
	...
	$("#CmpOrdenVentaVehiculoTotal").keyup(function () {  
		FncEntregaVentaVehiculoDetalleCalcularDescuento();
	}); 
		...
		if(VehiculoMarca==""){
			...
			if(result==true){		
				...
				$.ajax({
					dataType: 'json',
					type: 'POST',
					url: 'formularios/EntregaVentaVehiculo/AccEntregaVentaVehiculoBuscarVIN.php',
...
function FncEntregaVentaVehiculoNavegar(oCampo){
	...
	if("CmpProductoImporte"==oCampo){
		...
		FncEntregaVentaVehiculoDetalleGuardar();
	}
...
*/
function FncEntregaVentaVehiculoEstablecerMoneda(){
...
function FncClienteBuscar(){
	...
	FncEntregaVentaVehiculoPropietarioGuardar();
...
function FncVehiculoIngresoListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/EntregaVentaVehiculo/CapVehiculoIngresoListado.php',
		data: 'VehiculoMarca='+VehiculoMarca+'&VehiculoModelo='+VehiculoModelo+'&VehiculoVersion='+VehiculoVersion+'&AnoModelo='+AnoModelo+'&Color='+Color,
