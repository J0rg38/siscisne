...
var EntregaVentaVehiculoDetalleEditar = 2;
...
var EntregaVentaVehiculoPropietarioEditar = 2;
var EntregaVentaVehiculoPropietarioEliminar = 2;
    ...
    <div id="tab1" class="tab_content">
       ...
       <tr>
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top">Fecha Programada:<br />
                 <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
               <td align="left" valign="top"><input name="CmpFechaProgramada" type="text" class="EstFormularioCajaFecha" id="CmpFechaProgramada" value="<?php if(empty($InsEntregaVentaVehiculo->EvvFechaProgramada)){ echo date("d/m/Y");}else{ echo $InsEntregaVentaVehiculo->EvvFechaProgramada; }?>" size="15" maxlength="10" readonly="readonly" /></td>
               <td align="left" valign="top">Hora Programada:<br />
                 <span class="EstFormularioSubEtiqueta">(00:00)</span></td>
               <td align="left" valign="top"><input name="CmpHoraProgramada" type="text" class="EstFormularioCajaHora" id="CmpHoraProgramada" value="<?php  echo $InsEntregaVentaVehiculo->EvvHoraProgramada;?>" size="15" maxlength="10" readonly="readonly" />
        ...
        <p>Some extra select boxes to show to it works under IE.<br/>
			...
			?>
                 <select disabled="disabled"  class="EstFormularioCombo" id="CmpDuracion" name="CmpDuracion">
             ...
             <tr>
               <td>&nbsp;</td>
               <td align="left" valign="top">Proforma de Venta:</td>
               <td align="left" valign="top"><input name="CmpOrdenVentaVehiculoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculoId"  tabindex="3" value="<?php  echo $InsEntregaVentaVehiculo->CveId;?>" size="25" maxlength="25" readonly="readonly" /></td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               <td align="left" valign="top"><a href="javascript:FncEntregaVentaVehiculoDetalleNuevo();"></a></td>
			...
			?>
               ...
               <td align="left" valign="top"><input name="VehiculoIngresoColor" type="text" class="EstFormularioCaja" id="VehiculoIngresoColor" value="<?php echo ($InsEntregaVentaVehiculo->EvvColor);?>" size="10" maxlength="30" readonly="readonly" /></td>
