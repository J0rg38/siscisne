...
<link rel="stylesheet" type="text/css" href="css/CssEntregaVentaVeehiculoAtender.css">
...
<div class="EstFormularioArea"> 
      ...
      <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td align="left" valign="top"><input readonly="readonly" name="CmpEntregaVentaVehiculoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpEntregaVentaVehiculoId" value="<?php echo $InsEntregaVentaVehiculo->EvvId;?>" size="20" maxlength="20" /></td>
                <td align="left" valign="top">Fecha de Registro:<br />
                  <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
                <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaDeshabilitada" id="CmpFecha" value="<?php if(empty($InsEntregaVentaVehiculo->EvvFecha)){ echo date("d/m/Y");}else{ echo $InsEntregaVentaVehiculo->EvvFecha; }?>" size="15" maxlength="10" readonly="readonly" /></td>
                <td>&nbsp;</td>
               </tr>
              <tr>
                <td>&nbsp;</td>
                <td align="left" valign="top">Fecha Programada:<br />
                  <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
                <td align="left" valign="top"><input name="CmpFechaProgramada" type="text" class="EstFormularioCajaDeshabilitada" id="CmpFechaProgramada" value="<?php if(empty($InsEntregaVentaVehiculo->EvvFechaProgramada)){ echo date("d/m/Y");}else{ echo $InsEntregaVentaVehiculo->EvvFechaProgramada; }?>" size="15" maxlength="10" readonly="readonly" /></td>
                <td align="left" valign="top">Hora Programada:<br />
                  <span class="EstFormularioSubEtiqueta">(00:00)</span></td>
                <td align="left" valign="top"><input name="CmpHoraProgramada" type="text" class="EstFormularioCajaDeshabilitada" id="CmpHoraProgramada" value="<?php  echo $InsEntregaVentaVehiculo->EvvHoraProgramada;?>" size="15" maxlength="10" readonly="readonly" />
        ...
        <p>Some extra select boxes to show to it works under IE.<br/>
			...
			?>
              ...
              <tr>
                ...
                <td align="left" valign="top"><textarea name="CmpObservacion" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsEntregaVentaVehiculo->EvvObservacion;?></textarea></td>
                <td align="left" valign="top">Observaciones:</td>
                <td align="left" valign="top"><textarea name="CmpObservacionSalida" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionSalida"><?php echo $InsEntregaVentaVehiculo->EvvObservacionSalida;?></textarea></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
  ...
  <?php	
              ...
              <tr>
                ...
                <input class="EstFormularioBotonAnulado" name="BtnEntregaVentaVehiculoAnulado" type="submit"  id="BtnEntregaVentaVehiculoAnulado" value="Anulado" /></td>
                <td>&nbsp;</td>
               </tr>
            </table>
