...
//var TrasladoVehiculoDetalleEliminar = <?php echo (empty($InsTrasladoVehiculo->OcoId)?1:2);?>;
			...
			?>
             ...
             <tr>
               ...
               <td align="left" valign="top"><span class="EstFormularioSubTitulo">
                 ...
                 <input type="hidden" name="CmpPorcentajeImpuestoVenta" id="CmpPorcentajeImpuestoVenta"  value="<?php echo $InsTrasladoVehiculo->TvePorentajeImpuestoVenta;?>" />
                 </span></td>
