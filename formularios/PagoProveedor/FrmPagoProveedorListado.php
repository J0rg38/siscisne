...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsPagoProveedor.js" ></script>
...
include($InsProyecto->MtdFormulariosMsj($GET_mod).'MsjPagoProveedor.php');
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPagoProveedor.php');

//MtdObtenerPagoProveedores($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'PovId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$,$oMoneda=NULL,$oCuenta=NULL) {
		
$ResPagoProveedor = $InsPagoProveedor->MtdObtenerPagoProveedores("prv.PrvNombre,PrvApellidoPaterno,prv.PrvApellidoMaterno",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_Moneda,$POST_Cuenta);
...
/*
 * interface FrmPagoProveedorListado {
    //put your code here  
}
*/
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE PAGO A PROVEEDORES</span></td>
</tr>
<tr>
  <td>
    Mostrando <b><?php echo $PagoProveedorsTotalSeleccionado;?></b> de <b><?php echo $PagoProveedorsTotal;?></b> registros.</td>
</tr>
<tr>
<td align="right">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstTablaListado" >
      ...
      <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?></th>
                <th width="5%" ><?php
				if($POST_ord == "PovFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PovFecha','ASC');"> Fecha <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PovFecha','DESC');"> Fecha <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('PovFecha','ASC');"> Fecha </a>
                  <?php
				}
				?></th>
                <th width="6%" ><?php
				if($POST_ord == "PovNumeroOperacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PovNumeroOperacion','ASC');"> Num. Ope. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PovNumeroOperacion','DESC');"> Num. Ope. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('PovNumeroOperacion','ASC');"> Num. Ope. </a>
                  <?php
				}
				?></th>
                <th width="5%" ><?php
				...
				?></th>
                <th width="7%" ><?php
				if($POST_ord == "PovMonto"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PovMonto','ASC');"> Monto <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PovMonto','DESC');"> Monto <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('PovMonto','ASC');"> Monto </a>
                  <?php
				}
				?></th>
                <th width="4%" >Adj.</th>
                <th width="3%" >
                  ...
                  <?php
				if($POST_ord == "PovEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PovEstado','ASC');"> Est. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PovEstado','DESC');"> Est. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('PovEstado','ASC');"> Est.  </a>
                  <?php
				}
				?>                </th>
                <th width="10%" > <?php
				if($POST_ord == "PovTiempoCreacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PovTiempoCreacion','ASC');"> Fecha Creacion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PovTiempoCreacion','DESC');"> Fecha Creacion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('PovTiempoCreacion','ASC');"> Fecha Creacion </a>
                  <?php
				}
				?></th>
...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
				  ...
				  <option <?php if($POST_num==$PagoProveedorsTotal){ echo 'selected="selected"';}?> value="<?php echo $PagoProveedorsTotal;?>">Todos</option>
                </select>
				...
				<?php
					...
					//if(empty($POST_fil)){
						$tregistros = $PagoProveedorsTotal;
					//}else{
					//	$tregistros = ($PagoProveedorsTotalSeleccionado);
					//}
	...
	<a class="EstPaginacion"  href="javascript:FncPaginar('<?php echo $num?>,<?php echo $numxpag;?>','<?php echo $i?>');" ><?php echo $i?></a>                        
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input onclick="javascript:FncAgregarSeleccionado();" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->PovId; ?>" estado="<?php echo $dat->PovEstado; ?>" />				</td>
...
if(!empty($dat->PovFoto)){
	
	$extension = strtolower(pathinfo($dat->PovFoto, PATHINFO_EXTENSION));
	$nombre_base = basename($dat->PovFoto, '.'.$extension);  
?>
                  <a href="subidos/pago_proveedor_fotos/<?php echo $dat->PovFoto;?>" target="_blank" title=""><img  src="imagenes/documento.gif" alt="" border="0"  /></a>
                  <?php	
}
?></td>
                <td align="right" >
...
?>
  <a href="formularios/Auditoria/FrmAuditoriaListado.php?Id=<?php echo $dat->PovId;?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=440&width=850&modal=true" class="thickbox"  ><img src="imagenes/auditoria.png" alt="[Auditar]" width="19" height="19" border="0" title="Auditar" /></a>
<?php
}
?>
...
if($PrivilegioEliminar){
?>
                  <a href="javascript:FncEliminarSeleccionado('<?php echo $dat->PovId;?>');"> <img  src="imagenes/eliminar.gif" alt="[Eliminar]" width="19" height="19" border="0" title="Eliminar completamente"   /></a>
                  <?php
}
?>
                  <?php
/*if($PrivilegioEliminar){
?>
<a href="javascript:FncBorrarSeleccionado('<?php echo $dat->PovId;?>');"><img src="imagenes/borrar.gif" width="19" height="19" border="0" title="Borrar" alt="[Borrar]"   /></a>
<?php
}*/
?>
...
if($PrivilegioEditar){
?>
                  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $dat->PovId;?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>
                  <?php
}
?>
...
if($PrivilegioVer){
?>
                  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->PovId;?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
                  <?php
}
?>
...
?>
	<a href="javascript:FncVistaPreliminar('<?php echo $dat->PovId;?>');"><img src="imagenes/acciones/preliminar.gif" alt="[Vista Preliminar]" title="Vista preliminar" width="19" height="19" border="0" /></a>
<?php
}
?>
...
?>        
	...
	<a href="javascript:FncImprmir('<?php echo $dat->PovId;?>');"><img src="imagenes/acciones/imprimir.png" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
<?php
}
?>
