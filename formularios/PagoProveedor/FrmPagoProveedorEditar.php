...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsPagoProveedorArchivoFunciones.js" ></script>

<style type="text/css">
@import url('<?php echo $InsProyecto->MtdFormulariosCss($GET_mod);?>CssPagoProveedor.css');
</style>
...
var PagoProveedorArchivoEditar = 1;
var PagoProveedorArchivoEliminar = 1;
</script>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
          ...
          <td>
            ...
            <div class="EstFormularioArea">
              ...
              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                ...
                ?>
                        <option <?php echo $DatTipoDocumento->TdoId;?> <?php echo ($DatTipoDocumento->TdoId==$InsPagoProveedor->TdoId)?'selected="selected"':"";?> value="<?php echo $DatTipoDocumento->TdoId?>"><?php echo $DatTipoDocumento->TdoCodigo?> - <?php echo $DatTipoDocumento->TdoNombre?></option>
                        <?php
                }
                ?>
                      </select></td>
                  ...
                  <td colspan="3" align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                    <tr>
                      <td width="275" colspan="2" align="left" valign="top">
                        <div id="fileUploadArchivo">Escoger Archivos</div>
		...
		$(document).ready(function(){
				...
				$("#fileUploadArchivo").uploadFile({
					
				allowedTypes:"png,gif,jpg,jpeg,pdf",
				url:"formularios/PagoProveedor/acc/AccPagoProveedorSubirArchivo.php",
				...
				onSuccess:function(files,data,xhr){
                    ...
                    <tr>
                      <td colspan="2" align="left" valign="top"><div class="EstCapPagoProveedorArchivos" id="CapPagoProveedorArchivos"></div></td>
                      <td align="left" valign="top">&nbsp;</td>
                    </tr>
                    </table></td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="2"><input <?php echo (($InsPagoProveedor->PovNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="ChkNotificar" id="ChkNotificar" />
Notificar via email <br />
<input  <?php echo (($InsPagoProveedor->PovActualizarLineaCredito==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="ChkActualizarLineaCredito" id="ChkActualizarLineaCredito" />
Actualizar linea de credito de proveedor </td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
