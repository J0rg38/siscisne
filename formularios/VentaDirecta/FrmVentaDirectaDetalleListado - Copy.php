...
<select <?php echo (($_POST['Editar']==2)?'disabled="disabled"':'')?> class="EstFormularioCombo" name="CmpVentaDirectaDetalleEstado_<?php echo $DatSesionObjeto->Item;?>" id="CmpVentaDirectaDetalleEstado_<?php echo $DatSesionObjeto->Item;?>">
          ...
          <option <?php echo (($DatSesionObjeto->Parametro26=="2")?'selected="selected"':'');?> value="2" >Anulao</option>
...
<td align="right"  bgcolor="<?php echo $fondo;?>">
		...
		<span title="<?php echo number_format($DatSesionObjeto->Parametro12,3);?>"><?php echo number_format($DatSesionObjeto->Parametro5,2);?></span>
...
<span title="<?php echo number_format(($DatSesionObjeto->Parametro46),2);?>">
<?php echo number_format(($DatSesionObjeto->Parametro38),2);?>
</span>
</td>
