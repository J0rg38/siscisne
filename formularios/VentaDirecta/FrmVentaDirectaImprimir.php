...
<tr>
  ...
  <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="2" class="EstVentaDirectaImprimirTabla">
    ...
    <tr>
      <td align="left" valign="top" class="EstVentaDirectaImprimirEtiquetaFondo"><?php
if(!empty($InsVentaDirecta->CliIdSeguro)){
?>
        <span class="EstVentaDirectaImprimirEtiqueta">Seguro:</span>
        <?php
}
?></td>
      <td align="left" valign="top" class="EstVentaDirectaImprimirTabla" ><?php
if(!empty($InsVentaDirecta->CliIdSeguro)){
?>
...
?></td>
      <td align="left" valign="top" class="EstVentaDirectaImprimirTabla" >
	  
<?php
if(!empty($InsVentaDirecta->CliIdSeguro)){
?>
        <span class="EstVentaDirectaImprimirContenido"><?php echo $InsVentaDirecta->CliNombreSeguro;?> <?php echo $InsVentaDirecta->CliApellidoPaternoSeguro;?> <?php echo $InsVentaDirecta->CliApellidoMaternoSeguro;?> </span>
        <?php
}
?></td>
...
<tr>
  ...
  <?php
//  deb($InsVentaDirecta->VdiDescuento);
    ...
    <thead class="EstVentaDirectaImprimirTablaHead">
      <tr>
       ...
       <?php
		...
		?>
        <th width="9%" align="center" >Cod. Original</th>
		<?php
		}
		?>
        <th width="9%" align="center" >CANTIDAD</th>
        <th width="9%" align="center" >UND.</th>
      
  <th width="36%" align="center" > DESCRIPCION </th>
        <th width="7%" align="center" >P/UNIT</th>
        <th width="8%" align="center" >P/TOTAL</th>
        <th width="7%" align="center" >DSCTO. </th>
	...
	if(!empty($InsVentaDirecta->VentaDirectaDetalle)){
		...
		<?php
				...
				<td align="right" class="EstVentaDirectaDetalleImprimirContenido" ><?php echo ($DatVentaDirectaDetalle->UmeNombre);?></td>
				...
				<td align="right" class="EstVentaDirectaDetalleImprimirContenido" ><?php echo number_format(($DatVentaDirectaDetalle->VddPrecioBruto),2);?></td>
				<td align="right" class="EstVentaDirectaDetalleImprimirContenido" ><?php echo number_format($DatVentaDirectaDetalle->VddImporteBruto,2);?></td>
				<td align="right" class="EstVentaDirectaDetalleImprimirContenido" ><?php echo number_format($DatVentaDirectaDetalle->VddDescuento,2);?></td>
				<td align="right" class="EstVentaDirectaDetalleImprimirContenido" ><?php echo number_format($DatVentaDirectaDetalle->VddImporte,2);?></td>
		  </tr>
			  <?php	
					...
					$TotalRepuesto += $DatVentaDirectaDetalle->VddImporte;
					$TotalDescuento += $DatVentaDirectaDetalle->VddDescuento;
    ...
    <thead class="EstVentaDirectaImprimirTablaHead">
      <tr>
       ...
       <?php
		...
		?>
        <th width="9%" align="center" >Cantidad</th>
        <th width="8%" align="center" >UND.</th>
      
  <th width="44%" align="center" > Nombre </th>
        <th width="11%" align="center" >P/UNIT</th>
...
?>
  ...
  <tr>
    ...
    <tr>
      <td >&nbsp;</td>
      <td align="left">&nbsp;</td>
      <td align="center"><span class="EstVentaDirectaImprimirFirma"><?php echo $InsVentaDirecta->PerNombre;?> <?php echo $InsVentaDirecta->PerApellidoPaterno;?> <?php echo $InsVentaDirecta->PerApellidoMaterno;?></span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td >&nbsp; </td>
      ...
      <td width="49%" align="center"><span class="EstVentaDirectaImprimirNota3">Almacen - Ventas<br />
Telefono: <?php echo $InsVentaDirecta->PerTelefono;?><br />
Celular: <?php echo $InsVentaDirecta->PerCelular;?><br />
Email: <?php echo $InsVentaDirecta->PerEmail;?></span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
<div class="EstVentaDirectaPie">
  ...
  Inscritos en los Registros P&uacute;blicos de Tacna Ficha 2986 -->
