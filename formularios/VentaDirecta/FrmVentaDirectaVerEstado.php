...
var VentaDirectaDetalleVerEstado = 1;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER ESTADO ORDEN DE VENTA DE REPUESTOS Y SERVICIOS</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<div class="tab_container">
	...
	?>
                   ...
                   <td><input  tabindex="2" class="EstFormularioCaja" name="CmpClienteNombreCompleto" type="text" id="CmpClienteNombreCompleto" size="45" maxlength="255" value="<?php echo $InsVentaDirecta->CliNombre;?> <?php echo $InsVentaDirecta->CliApellidoPaterno;?> <?php echo $InsVentaDirecta->CliApellidoMaterno;?>"  /></td>
                   <td>&nbsp;</td>
                   </tr>
                 </table></td>
               <td align="left" valign="top">&nbsp;</td>
			...
			?>
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpClienteCelular" type="text" class="EstFormularioCaja" id="CmpClienteCelular" tabindex="5" value="<?php echo $InsVentaDirecta->CliCelular;?>" size="45" maxlength="255" readonly="readonly"  /></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             ...
             <tr>
               ...
               <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td><a href="javascript:FncVehiculoIngresoSimpleNuevo();"></a></td>
                   ...
                   <td><a href="javascript:FncVehiculoIngresoSimpleBuscar('VIN');"></a></td>
                   <td>&nbsp;</td>
                 </tr>
                 <tr> </tr>
               </table></td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpClienteMargenUtilidad" type="text" class="EstFormularioCajaDeshabilitada" id="CmpClienteMargenUtilidad" value="<?php echo number_format($InsVentaDirecta->VdiPorcentajeMargenUtilidad,2);?>" size="10" maxlength="10" /></td>
               <td align="left" valign="top">Otros Costos: <br />
                 <span class="EstFormularioSubEtiqueta">(%)</span></td>
               <td align="left" valign="top"><input name="CmpPorcentajeOtroCosto" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPorcentajeOtroCosto" value="<?php echo number_format($InsVentaDirecta->VdiPorcentajeOtroCosto,2);?>" size="10" maxlength="10" /></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><?php
					...
					?>
                 <select disabled="disabled"  class="EstFormularioCombo" name="CmpTipoFinal" id="CmpTipoFinal" >
                   <option value="">Escoja una opcion</option>
		  ...
		  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
		    ...
		    <tr>
		      ...
		      <td colspan="4">
                ...
                <div class="EstCapVentaDirectaFotos"><?php              
		      ...
		      <td colspan="4"><div class="EstFormularioArea" >
		        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
		          <tr>
		            ...
		            <td width="136" align="right" valign="top"><a href="javascript:FncVentaDirectaFotoListar('A');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
		            <td width="4" align="left" valign="top">&nbsp;</td>
		            </tr>
		          <tr>
		            <td align="left" valign="top">&nbsp;</td>
		          ...
		          <tr>
		            <td align="left" valign="top">&nbsp;</td>
		            <td colspan="2" align="left" valign="top"><div id="CapVentaDirectaFotosAccionA"></div></td>
		            <td align="left" valign="top">&nbsp;</td>
		            </tr>
		          </table>
		        </div></td>
		      ...
		      <td colspan="4"><div class="EstFormularioArea" >
		        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
		          <tr>
		            <td width="4" align="left" valign="top">&nbsp;</td>
		            <td width="139" align="left" valign="top">&nbsp;</td>
		            <td width="136" align="right" valign="top"><a href="javascript:FncVentaDirectaFotoListar('G');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
		            <td width="4" align="left" valign="top">&nbsp;</td>
		            </tr>
		          <tr>
		            <td align="left" valign="top">&nbsp;</td>
		          ...
		          <tr>
		            <td align="left" valign="top">&nbsp;</td>
		            <td colspan="2" align="left" valign="top"><div id="CapVentaDirectaFotosAccionG"></div></td>
		            <td align="left" valign="top">&nbsp;</td>
		            </tr>
		          </table>
		        </div></td>
