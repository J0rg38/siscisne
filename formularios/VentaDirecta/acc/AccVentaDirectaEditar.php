...
*/
	...
	if (!empty($ResVentaDirectaDetalle['Datos'])) {
		$item = 1;
		foreach ($ResVentaDirectaDetalle['Datos'] as $DatVentaDirectaDetalle) {
			...
			$InsVentaDirectaDetalle1->VddCantidadPedir = $DatVentaDirectaDetalle->Parametro20;
			$InsVentaDirectaDetalle1->VddCantidadPedirFecha = FncCambiaFechaAMysql($DatVentaDirectaDetalle->Parametro21, true);
			...
			$InsVentaDirectaDetalle1->VddPorcentajeUtilidad = empty($DatVentaDirectaDetalle->Parametro39) ? 0 : $DatVentaDirectaDetalle->Parametro39;
			$InsVentaDirectaDetalle1->VddPorcentajeOtroCosto = empty($DatVentaDirectaDetalle->Parametro40) ? 0 : $DatVentaDirectaDetalle->Parametro40;
			$InsVentaDirectaDetalle1->VddPorcentajeManoObra = empty($DatVentaDirectaDetalle->Parametro41) ? 0 : $DatVentaDirectaDetalle->Parametro41;
			$InsVentaDirectaDetalle1->VddPorcentajePedido = empty($DatVentaDirectaDetalle->Parametro42) ? 0 : $DatVentaDirectaDetalle->Parametro42;

			$InsVentaDirectaDetalle1->VddPorcentajeAdicional = empty($DatVentaDirectaDetalle->Parametro43) ? 0 : $DatVentaDirectaDetalle->Parametro43;
			$InsVentaDirectaDetalle1->VddPorcentajeDescuento = empty($DatVentaDirectaDetalle->Parametro44) ? 0 : $DatVentaDirectaDetalle->Parametro44;
			...
			$InsVentaDirectaDetalle1->VddAdicional = empty($DatVentaDirectaDetalle->Parametro45) ? 0 : $DatVentaDirectaDetalle->Parametro45; //*
			...
			$InsVentaDirectaDetalle1->VddTipoPedido = empty($DatVentaDirectaDetalle->Parametro35) ? 0 : $DatVentaDirectaDetalle->Parametro35;
			...
			if ($InsVentaDirectaDetalle1->VddEliminado == 1 and ($DatVentaDirectaDetalle->Parametro26 == 1 or $DatVentaDirectaDetalle->Parametro26 == 7)) {
				...
				$InsVentaDirecta->VdiDescuento += $InsVentaDirectaDetalle1->VddDescuento;
			}
...
*/
	...
	/*	if($InsVentaDirecta->VdiIncluyeImpuesto==1){
		...
		$InsVentaDirecta->VdiSubTotal = round($InsVentaDirecta->VdiProductoTotal - $InsVentaDirecta->VdiDescuento  + $InsVentaDirecta->VdiManoObra + $InsVentaDirecta->VdiPlanchadoTotal + $InsVentaDirecta->VdiPintadoTotal + $InsVentaDirecta->VdiCentradoTotal + $InsVentaDirecta->VdiTareaTotal,6);
		//$InsVentaDirecta->VdiSubTotal = round($InsVentaDirecta->VdiProductoTotal,6);
		$InsVentaDirecta->VdiImpuesto = round(($InsVentaDirecta->VdiSubTotal * ($InsVentaDirecta->VdiPorcentajeImpuestoVenta/100)),6);
		$InsVentaDirecta->VdiTotal = round($InsVentaDirecta->VdiSubTotal + $InsVentaDirecta->VdiImpuesto,6);
...
*/		//deb( $InsVentaDirecta->VdiTotal . " - ". $InsVentaDirecta->VdiManoObra);
	...
	if ($Guardar) {
		...
		if ($InsVentaDirecta->VdiOrdenCompraFecha == "0000-00-00") {
		...
		if ($InsVentaDirecta->MtdEditarVentaDirecta()) {
			...
			if ($InsVentaDirecta->VdiNotificar == 1) {
				...
				$InsVentaDirecta->MtdNotificarVentaDirectaRegistro($InsVentaDirecta->VdiId, $Destinatarios, false);
				...
				//$InsCorreo->MtdEnviarCorreo("jonathan.blanco.upt@gmail.com,jblanco@cyc.com.pe,lcoaquira@cyc.com.pe,aliendo@cyc.com.pe,iquezada@cyc.com.pe,avillanueva@cyc.com.pe".$Destinatarios,"sistema.automotriz.cisne@gmail.com","C&C S.A.C.","NOTIFICACION: ORD. VEN. Nro.: ".$InsVentaDirecta->VdiId.(!empty($InsVentaDirecta->VdiOrdenCompraNumero)?" - O.C. REF: ".$InsVentaDirecta->VdiOrdenCompraNumero." ":"")." - CLIENTE: ".$InsVentaDirecta->CliNombre,"NOTIFICACION DE REGISTRO: <br><br> Orden de Venta Nro.: <b>".$InsVentaDirecta->VdiId."</b> <br> Fecha de Registro: <b>".FncCambiaFechaANormal($InsVentaDirecta->VdiFecha)."</b> <br> Cliente: <b>".$InsVentaDirecta->CliNombre."</b> <br> O.C.: Referencia: <b>".$InsVentaDirecta->VdiOrdenCompraNumero."</b> <br><br> Mensaje autogenerado por sistema siscyc a las ".date("d/m/Y H:i:s"));

				//"jonathan.blanco.upt@gmail.com,jblanco@cyc.com.pe,lcoaquira@cyc.com.pe,aliendo@cyc.com.pe,iquezada@cyc.com.pe".$Destinatarios,"sistema.automotriz.cisne@gmail.com","C&C S.A.C.","NOTIFICACION: ORD. VEN. Nro.: ".$InsVentaDirecta->VdiId.(!empty($InsVentaDirecta->VdiOrdenCompraNumero)?" - O.C. REF: ".$InsVentaDirecta->VdiOrdenCompraNumero." ":"")." - CLIENTE: ".$InsVentaDirecta->CliNombre,"NOTIFICACION DE REGISTRO: <br><br> Orden de Venta Nro.: <b>".$InsVentaDirecta->VdiId."</b> <br> Fecha de Registro: <b>".FncCambiaFechaANormal($InsVentaDirecta->VdiFecha)."</b> <br> Cliente: <b>".$InsVentaDirecta->CliNombre."</b> <br> O.C.: Referencia: <b>".$InsVentaDirecta->VdiOrdenCompraNumero."</b> <br><br> Mensaje autogenerado por sistema siscyc a las ".date("d/m/Y H:i:s"));
...
function FncCargarDatos()
{
	...
	if ($InsVentaDirecta->MonId <> $EmpresaMonedaId) {
		$InsVentaDirecta->VdiManoObra = round($InsVentaDirecta->VdiManoObra / $InsVentaDirecta->VdiTipoCambio, 2);
	}
	...
	if (!empty($InsVentaDirecta->VentaDirectaDetalle)) {
		foreach ($InsVentaDirecta->VentaDirectaDetalle as $DatVentaDirectaDetalle) {
			...
			//if(empty($DatVentaDirectaDetalle->VddPrecioBruto)){
			//				$DatVentaDirectaDetalle->VddPrecioBruto = $DatVentaDirectaDetalle->VddPrecioVenta;
			//			}
			//			
			if ($InsVentaDirecta->MonId <> $EmpresaMonedaId) {
				...
				$DatVentaDirectaDetalle->VddPrecio = ($DatVentaDirectaDetalle->VddPrecio / $InsVentaDirecta->VdiTipoCambio);
				...
				$DatVentaDirectaDetalle->VddAdicional = round($DatVentaDirectaDetalle->VddAdicional / $InsVentaDirecta->VdiTipoCambio, 6);
				$DatVentaDirectaDetalle->VddAdicionalUnitario = round($DatVentaDirectaDetalle->VddAdicionalUnitario  / $InsVentaDirecta->VdiTipoCambio, 6);

				$DatVentaDirectaDetalle->VddDescuento = round($DatVentaDirectaDetalle->VddDescuento  / $InsVentaDirecta->VdiTipoCambio, 6);
				$DatVentaDirectaDetalle->VddDescuentoUnitario = round($DatVentaDirectaDetalle->VddDescuentoUnitario  / $InsVentaDirecta->VdiTipoCambio, 6);
			}
...
*/
			...
			//deb($DatVentaDirectaDetalle->VddAdicional);

			//			deb($DatVentaDirectaDetalle->VddCantidadPedir);
			$_SESSION['InsVentaDirectaDetalle' . $Identificador]->MtdAgregarSesionObjeto(
				1,
				...
				$DatVentaDirectaDetalle->VddTipoPedido,

				$DatVentaDirectaDetalle->VddPrecioBruto,

				$DatVentaDirectaDetalle->VddValorTotal,
				$DatVentaDirectaDetalle->VddDescuento,
				$DatVentaDirectaDetalle->VddPorcentajeUtilidad,
				$DatVentaDirectaDetalle->VddPorcentajeOtroCosto,
				$DatVentaDirectaDetalle->VddPorcentajeManoObra,
				$DatVentaDirectaDetalle->VddPorcentajePedido,

				$DatVentaDirectaDetalle->VddPorcentajeAdicional,
				$DatVentaDirectaDetalle->VddPorcentajeDescuento,

				$DatVentaDirectaDetalle->VddAdicional,
				$DatVentaDirectaDetalle->VddDescuentoUnitario,
				$DatVentaDirectaDetalle->VddImporteBruto,
				$DatVentaDirectaDetalle->VddAdicionalUnitario
	...
	*/
			$_SESSION['InsVentaDirectaPlanchado' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	Parametro7 = VdtTiempoModificacion
	*/
			$_SESSION['InsVentaDirectaPintado' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsVentaDirecta->VentaDirectaCentrado)) {
		...
		*/
			...
			$_SESSION['InsVentaDirectaCentrado' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsVentaDirecta->VentaDirectaTarea)) {
		foreach ($InsVentaDirecta->VentaDirectaTarea as $DatVentaDirectaTarea) {
			...
			$_SESSION['InsVentaDirectaTarea' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsVentaDirecta->VentaDirectaFoto)) {
		foreach ($InsVentaDirecta->VentaDirectaFoto as $DatVentaDirectaFoto) {
			...
			$_SESSION['InsVentaDirectaFoto' . $Identificador]->MtdAgregarSesionObjeto(
				1,
