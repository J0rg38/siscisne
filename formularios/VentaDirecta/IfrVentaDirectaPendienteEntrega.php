...
$POST_Sucursal = isset($_POST['CmpSucursal'])?$_POST['CmpSucursal']:"";
...
$ResAlmacenStock = $InsAlmacenStock->MtdObtenerAlmacenStocks(NULL,NULL,NULL,"AstStock","DESC",NULL,"1",NULL,$GET_Ano."-01-01",date("Y-m-d"),NULL,NULL,NULL,$DatProductoVenta->ProId,NULL,NULL,false,$POST_Sucursal,$GET_Ano);
...
?>
        ...
        <tr  >
          ...
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>"   ><?php echo ($DatProductoVenta->SucNombre);?></td>
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>"   >
		  
          
          <a href="javascript:FncVentaDirectaVistaPreliminar('<?php echo $DatProductoVenta->VdiId;?>');" >  
           <?php echo ($DatProductoVenta->VdiId);?>
          </a>
          <br>
          <a href="javascript:FncVentaDirectaCargarFormulario('VerEstado','<?php echo $DatProductoVenta->VdiId;?>');" >          
          <img src="imagenes/acciones/ver_estado.png" alt="[O.V. Estado]" title="O.V. Estado" width="15" height="15" border="0" />		  
          </a>
...
<a href="javascript:FncPedidoCompraVistaPreliminar('<?php echo $DatProductoVenta->PcoId;?>');" >  
           <?php echo ($DatProductoVenta->PcoId);?>
          </a>
          <br>
          <a href="javascript:FncPedidoCompraCargarFormulario('VerEstado','<?php echo $DatProductoVenta->PcoId;?>');" >          
          <img src="imagenes/acciones/ver_estado.png" alt="[P.C. Estado]" title="P.C. Estado" width="15" height="15" border="0" />	  
          </a>
		  ...
		  <h2>
		  <?php echo ($DatProductoVenta->ProCodigoOriginal);?>
          </h2>
          </td>
          ...
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>"   >
		  <h2>
		  <?php echo number_format($DatProductoVenta->VddCantidad,2);?>
          </h2>
          </td>
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" >
          ...
          <h2 class="<?php echo (($StockReal>=$DatProductoVenta->VddCantidadPendiente2)?'EstTablaReporteNormal':'EstTablaReporteImportante');?>">
         <?php echo number_format($DatProductoVenta->VddCantidadPendiente2,2);?>
          </h2>
          </td>
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" >
		  
		  <h2>
		  <a  class="<?php echo (($StockReal>0)?'EstTablaReporteNormal':'EstTablaReporteImportante');?>" href="javascript:FncAlmacenStockConsultarCargar('<?php echo trim($DatProductoVenta->ProId);?>');">
          ...
          <td align="center" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" >
           ...
           <a href="javascript:FncPagoVentaDirectaCargarFormulario('Listado','<?php echo $DatProductoVenta->VdiId;?>');" >Ver Abonos</a>
