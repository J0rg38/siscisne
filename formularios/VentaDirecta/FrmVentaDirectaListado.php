...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ORDENES DE VENTA DE REPUESTOS Y SERVICIOS</span>  </td>
</tr>
<tr>
  <td width="47%">
...
<!--    Pedido
    <select class="EstFormularioCombo" name="PedidoCompra" id="PedidoCompra">
      <option value="" >Todos</option>
      <option value="Si" <?php if($POST_PedidoCompra=="Si"){ echo 'selected="selected"';}?>>Si</option>
      <option value="No" <?php if($POST_PedidoCompra=="No"){ echo 'selected="selected"';}?>>No</option>  
      </select>
      
    Concretada
    <select class="EstFormularioCombo" name="VentaConcretada" id="VentaConcretada">
      <option value="" >Todos</option>
      <option value="Si" <?php if($POST_VentaConcretada=="Si"){ echo 'selected="selected"';}?>>Si</option>
      <option value="No" <?php if($POST_VentaConcretada=="No"){ echo 'selected="selected"';}?>>No</option>  
      </select>-->
