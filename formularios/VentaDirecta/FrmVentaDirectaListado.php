...
<?php
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE ORDENES DE VENTA DE REPUESTOS Y SERVICIOS</span>
					</td>
				</tr>
				<tr>
					<td width="47%">
      ...
      <option value="VdiId" <?php if ($POST_cam == "VdiId") {
								echo 'selected="selected"';
							} ?>>Id</option>
      ...
      <option value="CliNumeroDocumento" <?php if ($POST_cam == "CliNumeroDocumento") {
												echo 'selected="selected"';
											} ?>>Num. Doc. Cliente</option>
       <option value="amo.CprId" <?php if ($POST_cam == "amo.CprId") {
										echo 'selected="selected"';
									} ?>>Cot. Repuesto</option>
      </select>-->
						Fecha Inicio
						...
						<select class="EstFormularioCombo" name="Moneda" id="Moneda">
							...
							?>
								<option value="<?php echo $DatMoneda->MonId ?>" <?php if ($POST_Moneda == $DatMoneda->MonId) {
																					echo 'selected="selected"';
																				} ?>><?php echo $DatMoneda->MonAbreviacion ?> ( <?php echo $DatMoneda->MonSimbolo; ?>)</option>
							<?php
							}
							?>
						</select>
						...
						<select class="EstFormularioCombo" name="Estado" id="Estado">
							...
							<option value="6" <?php if ($POST_estado == 6) {
													echo 'selected="selected"';
												} ?>>Anulado</option>
						</select>
						...
						<!--    Pedido
    <select class="EstFormularioCombo" name="PedidoCompra" id="PedidoCompra">
      <option value="" >Todos</option>
      <option value="Si" <?php if ($POST_PedidoCompra == "Si") {
								echo 'selected="selected"';
							} ?>>Si</option>
      <option value="No" <?php if ($POST_PedidoCompra == "No") {
								echo 'selected="selected"';
							} ?>>No</option>  
      </select>
      
    Concretada
    <select class="EstFormularioCombo" name="VentaConcretada" id="VentaConcretada">
      <option value="" >Todos</option>
      <option value="Si" <?php if ($POST_VentaConcretada == "Si") {
								echo 'selected="selected"';
							} ?>>Si</option>
      <option value="No" <?php if ($POST_VentaConcretada == "No") {
								echo 'selected="selected"';
							} ?>>No</option>  
      </select>-->
								...
								<tr>
									...
									<th width="4%"><?php
													if ($POST_ord == "VdiFecha") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('VdiFecha','ASC');"> Fecha <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('VdiFecha','DESC');"> Fecha <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /> </a>
											<?php
														}
													} else {

											?>
											<a href="javascript:FncOrdenar('VdiFecha','ASC');"> Fecha </a>
										<?php
													}
										?>
									</th>
									...
									<th width="7%"><?php
													if ($POST_ord == "VdiTipo") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('VdiTipo','ASC');"> Tipo Venta <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('VdiTipo','DESC');"> Tipo Venta <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {

											?>
											<a href="javascript:FncOrdenar('VdiTipo','ASC');"> Tipo Venta </a>
										<?php
													}
										?>
									</th>
									<th width="7%"><?php
													if ($POST_ord == "VdiTipoPedido") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('VdiTipoPedido','ASC');"> Tipo Pedido <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('VdiTipoPedido','DESC');"> Tipo Pedido <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {

											?>
											<a href="javascript:FncOrdenar('VdiTipoPedido','ASC');"> Tipo Pedido </a>
										<?php
													}
										?>
									</th>
									<th width="5%"><?php
													if ($POST_ord == "VdiVentaConcretada") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('VdiVentaConcretada','ASC');"> V. C. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('VdiVentaConcretada','DESC');"> V. C. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('VdiVentaConcretada','ASC');"> V. C. </a>
										<?php
													}
										?>
									</th>
									<th width="7%"><?php
													if ($POST_ord == "VdiFichaIngreso") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('VdiFichaIngreso','ASC');"> O.T. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('VdiFichaIngreso','DESC');"> O.T. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('VdiFichaIngreso','ASC');"> O.T. </a>
										<?php
													}
										?>
									</th>
									...
									<th width="7%"><?php
													if ($POST_ord == "NpaNombre") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('NpaNombre','ASC');"> Cond. Pago <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('NpaNombre','DESC');"> Cond. Pago <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {
									...
									<th width="8%">
										<?php
										if ($POST_ord == "VdiTiempoCreacion") {
											if ($POST_sen == "DESC") {
										?>

												<a href="javascript:FncOrdenar('VdiTiempoCreacion','ASC');">
													Fecha Creacion
													<img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
											<?php
											} else {
											?>
												<a href="javascript:FncOrdenar('VdiTiempoCreacion','DESC');">
								...
								<tr>
									...
									<td colspan="29" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $VentaDirectasTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $VentaDirectasTotal; ?>">Todos</option>
										</select>
									...
									<tr id="Fila_<?php echo $f; ?>">
										...
										<td align="right" valign="middle" width="5%">
											<a href="principal.php?Mod=<?php echo $GET_mod; ?>&Form=Ver&Id=<?php echo $dat->VdiId; ?>">
												<?php echo $dat->VdiId;  ?></a>
										</td>
										<td width="4%" align="right"><?php echo ($dat->VdiFecha); ?></td>
										<td width="3%" align="right"><?php echo (empty($dat->LtiAbreviatura) ? $dat->LtiNombre : $dat->LtiAbreviatura) //FncCortarTexto($dat->LtiNombre,15);
																		?></td>
										...
										<td width="7%" align="right">
											...
											?>
												...
												<a href="formularios/VentaDirecta/DiaFichaIngresoListado.php?height=440&width=850&VdiId=<?php echo $dat->VdiId ?>" class="thickbox" title="">Tiene O.T.</a>
...
<?php	
											...
											?>
												...
												?>
													<a href="javascript:FncPagoVentaDirectaCargarFormulario('Listado','<?php echo $dat->VdiId; ?>');">Tiene Abonos</a>
												<?php
												} else {
												?>
													Tiene Abonos
										...
										<td width="8%" align="center">
											...
											if ($PrivilegioEliminar and $dat->VdiPedidoCompra == "No" and $dat->VdiVentaConcretada == "No") {
											...
											if ($PrivilegioGenerarPedidoCompra and $dat->VdiGenerarPedidoCompra == "Si" and $dat->VdiEstado <> 1 and $dat->VdiEstado <> 6) {
											?>
...
-->
												<a href="javascript:FncGenerarPedidoCompra('<?php echo $dat->VdiId; ?>');"><img src="imagenes/generar_pedido.png" width="19" height="19" border="0" title="Generar Pedido de Compra" alt="[Generar Pedido de Compra]" /></a>
											...
											if ($PrivilegioGenerarVentaConcretada and $dat->VdiGenerarVentaConcretada == "Si" and $dat->VdiEstado <> 1 and $dat->VdiEstado <> 6) {
											?>
											...
											?>
												...
												<!--<a href="javascript:FncPagoCargarFormulario('Registrar','<?php echo $dat->VdiId; ?>');" ><img src="imagenes/acciones/orden_cobro.png" alt="[Orden Cobro]" title="Registrar Orden de Cobro"  width="19" height="19" border="0" /></a>-->
												<a href="javascript:FncGenerarPago('<?php echo $dat->VdiId; ?>');"><img src="imagenes/acciones/orden_cobro.png" alt="[Orden Cobro]" title="Registrar Orden de Cobro" width="19" height="19" border="0" /></a>
											...
											if ($PrivilegioEditar) {
											?>
												<a href="javascript:FncVentaDirectaEnviarMensajeTexto('<?php echo $dat->VdiId; ?>');"><img src="imagenes/acciones/icon_enviar_sms50.png" alt="[Enviar SMS]" title="Enviar SMS" width="19" height="19" border="0" /></a>
											<?php
											}
											?>
			...
			<table class="EstPanelTablaListado">
				<tbody class="EstPanelTablaListadoBody">
					...
					<tr>
						...
						<td align="left" valign="middle"><span class="EstPanelTablaListadoEtiqueta">Fecha Creacion: </span></td>
						...
						<td width="15" bgcolor="#FF9933">&nbsp;</td>
						<td> Pedido Observado</td>
