...
function FncVentaDirectaPendienteEntregaCargarListado(){
	...
	var CmpSucursal = $("#CmpSucursal").val();
	var CmpPersonal = $("#CmpPersonal").val();	
	...
	$("#CapVentaDirectaPendienteEntrega").html("Cargando...");
		...
		$.ajax({
			...
			data: 'CmpFechaInicio='+CmpFechaInicio+'&CmpFechaFin='+CmpFechaFin+'&CmpOrden='+CmpOrden+'&CmpSentido='+CmpSentido+'&CmpPersonal='+CmpPersonal+'&CmpSucursal='+CmpSucursal,
...
function FncPedidoCompraCargarFormulario(oForm,oPedidoCompraId){
	...
	tb_show(this.title,'principal2.php?Mod=PedidoCompra&Form='+oForm+'&Dia=1&Id='+oPedidoCompraId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
