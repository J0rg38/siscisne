                        ...
                        <div class="EstFormularioArea">
                          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if (empty($InsVentaDirecta->VdiFecha)) {
                                                                                                                                                      echo date("d/m/Y");
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsVentaDirecta->VdiFecha;
                                ...
                                <table>
                                  <tr>
                                    <td><input type="hidden" name="CmpClienteId" id="CmpClienteId" value="<?php echo $InsVentaDirecta->CliId; ?>" size="3" />
                                      ...
                                      <input name="CmpClienteNombre2" type="hidden" id="CmpClienteNombre2" value="<?php echo $InsVentaDirecta->CliNombre; ?>" size="3" />
                                      ...
                                      <input name="CmpClienteApellidoMaterno" type="hidden" id="CmpClienteApellidoMaterno" value="<?php echo $InsVentaDirecta->CliApellidoMaterno; ?>" size="3" />
                                    </td>
                                    ...
                                    <td><input <?php if (!empty($InsVentaDirecta->CliId)) {
                                                  echo 'readonly="readonly"';
                                                } ?> tabindex="4" class="EstFormularioCaja" name="CmpClienteNumeroDocumento" type="text" id="CmpClienteNumeroDocumento" size="20" maxlength="50" value="<?php echo $InsVentaDirecta->CliNumeroDocumento; ?>" /></td>
                                    ...
                                    <td><input <?php if (!empty($InsVentaDirecta->CliId)) {
                                                  echo 'readonly="readonly"';
                                                } ?> tabindex="2" class="EstFormularioCaja" name="CmpClienteNombreCompleto" type="text" id="CmpClienteNombreCompleto" size="45" maxlength="255" value="<?php echo $InsVentaDirecta->CliNombre; ?> <?php echo $InsVentaDirecta->CliApellidoPaterno; ?> <?php echo $InsVentaDirecta->CliApellidoMaterno; ?>" /> <label></label>
                    ...
                    -->
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><select class="EstFormularioCombo" name="CmpClienteTipo" id="CmpClienteTipo">
                                  ...
                                  ?>
                                    <option value="<?php echo $DatClienteTipo->LtiId ?>" <?php if ($InsVentaDirecta->LtiId == $DatClienteTipo->LtiId) {
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><input tabindex="5" class="EstFormularioCaja" name="CmpClienteCelular" type="text" id="CmpClienteCelular" size="45" maxlength="255" value="<?php echo $InsVentaDirecta->CliCelular; ?>" /></td>
                              <td align="left" valign="top">&nbsp;</td>
                              <td align="left" valign="top">&nbsp;</td>
                              <td align="left" valign="top">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top">VIN:
                                ...
                                <input name="CmpVehiculoIngresoClienteId" type="hidden" id="CmpVehiculoIngresoClienteId" value="<?php echo $InsVentaDirecta->CliId; ?>" size="3" />
                              </td>
                              ...
                              <td align="left" valign="top">Marca:
                                <input name="CmpVehiculoIngresoMarcaId" type="hidden" id="CmpVehiculoIngresoMarcaId" value="<?php echo $InsVentaDirecta->VmaId; ?>" size="3" />
                              </td>
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top">Modelo:
                                <input name="CmpVehiculoIngresoModeloId" type="hidden" id="CmpVehiculoIngresoModeloId" value="<?php echo $InsVentaDirecta->VmoId; ?>" size="3" />
                              </td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td><select <?php echo ($InsVentaDirecta->VdiOrigen == "CPR") ? 'disabled="disabled"' : ''; ?> class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                                        ...
                                        ?>
                                          <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsVentaDirecta->MonId == $DatMoneda->MonId) {
                                                                                            echo 'selected="selected"';
                                ...
                                <table>
                                  <tr>
                                    <td>
                                      ...
                                      <input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncVentaDirectaDetalleListar();" value="<?php if (empty($InsVentaDirecta->VdiTipoCambio)) {
                                                                                                                                                                                            echo "";
                                                                                                                                                                                          } else {
                                                                                                                                                                                            echo $InsVentaDirecta->VdiTipoCambio;
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpOrdenCompraFecha2" type="text" id="CmpOrdenCompraFecha2" value="<?php echo $InsVentaDirecta->VdiOrdenCompraFecha; ?>" size="15" maxlength="10" /></td>
                              <td align="left" valign="top">&nbsp;</td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                                ...
                                <table>
                                  <tr>
                                    ...
                                    <td><input name="CmpFichaIngresoId" id="CmpFichaIngresoId" type="hidden" value="<?php echo $InsVentaDirecta->FinId; ?>" size="20" maxlength="20" />
                                      <input name="CmpFichaIngreso" type="text" class="EstFormularioCaja" id="CmpFichaIngreso" tabindex="3" value="<?php echo $InsVentaDirecta->FinId; ?>" size="25" maxlength="25" <?php echo (!empty($InsVentaDirecta->FinId) ? 'readonly="readonly"' : '') ?> />
                                    </td>
                                    <td></td>
                            ...
                            <tr>
                              ...
                              <td colspan="2" align="left" valign="top"><input <?php echo (($InsVentaDirecta->VdiNotificar == 1) ? 'checked="checked"' : ''); ?> value="1" type="checkbox" name="CmpNotificar" id="CmpNotificar" />
                                ...
                                <span class="EstFormularioOpcion"> Generar Venta Concretada (Salida)</span>
                              </td>
                                ...
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  <tr>
                                    ...
                                    <td colspan="15"><span class="EstFormularioSubTitulo">PRODUCTOS
                                        ...
                                        <input type="hidden" name="CmpVentaDirectaDetalleId" id="CmpVentaDirectaDetalleId" />
                                        <input type="hidden" name="CmpVentaDirectaDetalleDescuento" id="CmpVentaDirectaDetalleDescuento" />
                                        <input type="hidden" name="CmpVentaDirectaDetalleAdicional" id="CmpVentaDirectaDetalleAdicional" />
                        ...
                        <div class="EstFormularioArea">
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              ...
                              <td width="0%">
                                <div id="CapVentaDirectaDetallesResultado"> </div>
                              </td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td colspan="2">
                                <div id="CapVentaDirectaDetalles" class="EstCapVentaDirectaDetalles"> </div>
                              </td>
                              <td>&nbsp;</td>
                            </tr>
                          </table>
                        ...
                        <div class="EstFormularioArea">
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              <td width="1%">&nbsp;</td>
                              <td width="48%">
                                <div class="EstFormularioAccion" id="CapVentaDirectaPlanchadoAccion">Listo
                                  para registrar elementos</div>
                              </td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td colspan="2">
                                <div id="CapVentaDirectaPlanchados" class="EstCapVentaDirectaPlanchados"> </div>
                              </td>
                              <td>
                                <div id="CapVentaDirectaPlanchadosResultado"> </div>
                              </td>
                            </tr>
                          </table>
                        </div>
                        ...
                        <div class="EstFormularioArea">
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              <td width="1%">&nbsp;</td>
                              <td width="48%">
                                <div class="EstFormularioAccion" id="CapVentaDirectaPintadoAccion">Listo
                                  para registrar elementos</div>
                              </td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td colspan="2">
                                <div id="CapVentaDirectaPintados" class="EstCapVentaDirectaPintados"> </div>
                              </td>
                              <td>
                                <div id="CapVentaDirectaPintadosResultado"> </div>
                              </td>
                            </tr>
                          </table>
                        </div>
                        ...
                        <div class="EstFormularioArea">
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              <td width="1%">&nbsp;</td>
                              <td width="48%">
                                <div class="EstFormularioAccion" id="CapVentaDirectaCentradoAccion">Listo
                                  para registrar elementos</div>
                              </td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td colspan="2">
                                <div id="CapVentaDirectaCentrados" class="EstCapVentaDirectaCentrados"> </div>
                              </td>
                              <td>
                                <div id="CapVentaDirectaCentradosResultado"> </div>
                              </td>
                            </tr>
                          </table>
                        </div>
                        ...
                        <div class="EstFormularioArea">
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              <td width="1%">&nbsp;</td>
                              <td width="48%">
                                <div class="EstFormularioAccion" id="CapVentaDirectaTareaAccion">Listo
                                  para registrar elementos</div>
                              </td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td colspan="2">
                                <div id="CapVentaDirectaTareas" class="EstCapVentaDirectaTareas"> </div>
                              </td>
                              <td>
                                <div id="CapVentaDirectaTareasResultado"> </div>
                              </td>
                            </tr>
                          </table>
                        </div>
                          ...
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              ...
                              <td width="98%" colspan="2">
                                <div id="CapVentaDirectaTotals" class="EstCapVentaDirectaTotals"> </div>
                              </td>
                              <td width="1%"></td>
                            </tr>
                          </table>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td colspan="2" align="left" valign="top">
                                        <div class="EstCapVentaDirectaFotos" id="CapVentaDirectaFotosA"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td colspan="2" align="left" valign="top">
                                        <div class="EstCapVentaDirectaFotos" id="CapVentaDirectaFotosG"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
