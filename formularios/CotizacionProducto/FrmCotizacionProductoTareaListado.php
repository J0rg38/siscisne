...
<td align="right"><?php echo $DatCotizacionProductoTarea->Parametro1;?></td>
<td align="right">
  <?php echo $DatCotizacionProductoTarea->Parametro2;?> 
</td>
<td align="right">
<?php echo number_format($DatCotizacionProductoTarea->Parametro5,2);?>
</td>
<td align="center">

<?php
switch($DatCotizacionProductoTarea->Parametro6){
	case 1:
?>
Si
<?php
...
if($POST_Editar==1){
?>
	<a class="EstSesionObjetosItem" href="javascript:FncCotizacionProductoTareaEscoger('<?php echo $DatCotizacionProductoTarea->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
<?php
}
?>
...
if($POST_Eliminar==1){
?>
	<a href="javascript:FncCotizacionProductoTareaEliminar('<?php echo $DatCotizacionProductoTarea->Item;?>');" >
...
<?php
	$TotalBruto = $TotalBruto + $DatCotizacionProductoTarea->Parametro5;
