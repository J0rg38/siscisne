...
if (isset($_POST['BtnGuardar_x']) or (isset($_POST['Guardar']) && $_POST['Guardar'] == "1")) {
	...
	if (!empty($ArrCotizacionProductoDetalles)) {
		foreach ($ArrCotizacionProductoDetalles as $DatCotizacionProductoDetalle) {
			...
			$InsCotizacionProductoDetalle1->CrdAdicionalUnitario = $DatCotizacionProductoDetalle->Parametro34;
			...
			//	deb("ELI: ".$InsCotizacionProductoDetalle1->CrdEliminado);
			//		deb("EST: ".$InsCotizacionProductoDetalle1->CrdEstado);
			//		deb("IMP: ".$InsCotizacionProductoDetalle1->CrdImporte);
			//		
...
function FncCargarDatos()
{
	...
	if (!empty($InsCotizacionProducto->CotizacionProductoDetalle)) {
		...
		foreach ($InsCotizacionProducto->CotizacionProductoDetalle as $DatCotizacionProductoDetalle) {
			...
			if ($InsCotizacionProducto->MonId <> $EmpresaMonedaId) {
				...
				$DatCotizacionProductoDetalle->CrdImporteBruto = round($DatCotizacionProductoDetalle->CrdImporteBruto  / $InsCotizacionProducto->CprTipoCambio, 6);


				$DatCotizacionProductoDetalle->CrdAdicional = round($DatCotizacionProductoDetalle->CrdAdicional / $InsCotizacionProducto->CprTipoCambio, 6);
				$DatCotizacionProductoDetalle->CrdAdicionalUnitario = round($DatCotizacionProductoDetalle->CrdAdicionalUnitario  / $InsCotizacionProducto->CprTipoCambio, 6);

				$DatCotizacionProductoDetalle->CrdDescuento = round($DatCotizacionProductoDetalle->CrdDescuento  / $InsCotizacionProducto->CprTipoCambio, 6);
				$DatCotizacionProductoDetalle->CrdDescuentoUnitario = round($DatCotizacionProductoDetalle->CrdDescuentoUnitario  / $InsCotizacionProducto->CprTipoCambio, 6);
			}
			...
			$_SESSION['InsCotizacionProductoDetalle' . $Identificador]->MtdAgregarSesionObjeto(
				...
				0,
				$DatCotizacionProductoDetalle->CrdObservacion
			);
			//		deb($DatCotizacionProductoDetalle->CrdObservacion);
	...
	if (!empty($InsCotizacionProducto->CotizacionProductoPlanchado)) {
		foreach ($InsCotizacionProducto->CotizacionProductoPlanchado as $DatCotizacionProductoPlanchado) {
			...
			$_SESSION['InsCotizacionProductoPlanchado' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsCotizacionProducto->CotizacionProductoPintado)) {
		foreach ($InsCotizacionProducto->CotizacionProductoPintado as $DatCotizacionProductoPintado) {
			...
			$_SESSION['InsCotizacionProductoPintado' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsCotizacionProducto->CotizacionProductoCentrado)) {
		foreach ($InsCotizacionProducto->CotizacionProductoCentrado as $DatCotizacionProductoCentrado) {
			...
			$_SESSION['InsCotizacionProductoCentrado' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsCotizacionProducto->CotizacionProductoTarea)) {
		foreach ($InsCotizacionProducto->CotizacionProductoTarea as $DatCotizacionProductoTarea) {
			...
			$_SESSION['InsCotizacionProductoTarea' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsCotizacionProducto->CotizacionProductoFoto)) {
		foreach ($InsCotizacionProducto->CotizacionProductoFoto as $DatCotizacionProductoFoto) {
			...
			$_SESSION['InsCotizacionProductoFoto' . $Identificador]->MtdAgregarSesionObjeto(
				1,
