...
$InsCotizacionProductoPintado1 = $_SESSION['InsCotizacionProductoCentrado'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);

$json = new JSON;
$var = $json->serialize( $InsCotizacionProductoPintado1 );
