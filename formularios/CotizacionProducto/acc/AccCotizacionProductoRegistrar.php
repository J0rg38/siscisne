...
function FncNuevo()
{
	...
	list($aux, $InsCotizacionProducto->CprAno, $InsCotizacionProducto->CprMes) = explode("/", $InsCotizacionProducto->CprFecha);
	...
	$InsCotizacionProducto->CprTipoCambio = $_SESSION['SesionTipoCambioComercial'] ?? 0;
}
?>