...
$TotalPlanchado = 0;
    ...
    foreach($ArrCotizacionProductoPlanchados as $DatSesionObjeto){
		$TotalPlanchado = $TotalPlanchado + $DatSesionObjeto->Parametro5;
	}
	
$TotalPintado = 0;

    foreach($ArrCotizacionProductoPintados as $DatSesionObjeto){
		$TotalPintado = $TotalPintado + $DatSesionObjeto->Parametro5;
	}
	
$TotalCentrado = 0;

    foreach($ArrCotizacionProductoCentrados as $DatSesionObjeto){
		$TotalCentrado = $TotalCentrado + $DatSesionObjeto->Parametro5;
	}
	
$TotalTarea = 0;

    foreach($ArrCotizacionProductoTareas as $DatSesionObjeto){
