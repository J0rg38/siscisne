...
//								Costo = (k.LprCosto);
//								Precio = (k.LprPrecio);
//								ValorVenta = (k.LprValorVenta);
//							}else{
//								Costo = k.LprCosto / TipoCambio;
//								Precio = k.LprPrecio / TipoCambio;
//								ValorVenta = k.LprValorVenta / TipoCambio;
//							}
//							
//						});
//
...
//			});
			...
			$.getJSON("comunes/Producto/JnListaPrecio.php?ProductoId="+InsProducto.ProId+"&ClienteTipoId="+ClienteTipoId+"&UnidadMedidaId="+InsProducto.UmeId,{}, 
			function(j){
				
				console.log("JnListaPrecio: "+j.LprCosto);
				console.log("JnListaPrecio: "+j.LprPrecio);
				console.log("JnListaPrecio: "+j.LprValorVenta);
