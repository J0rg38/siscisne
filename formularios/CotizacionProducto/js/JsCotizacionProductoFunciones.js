...
function FncValidar(){
	...
	var VehiculoIngresoPlaca = $("#CmpVehiculoIngresoPlaca").val();
	var TipoCambio = $("#CmpTipoCambio").val();
		...
		}else if(VehiculoIngresoPlaca == ""){			
		
			dhtmlx.alert({
				title:"Aviso",
				type:"alert-error",
				text:"Debes una placa de vehiculo",
				callback: function(result){
					$("#CmpVehiculoIngresoPlaca").focus();
				}
			});
...
function FncProductoEscoger(InsProducto){	
	...
	$('#CmpCotizacionProductoDetallePorcentajeManoObra').val(MantenimientoPorcentaje);
			...
			if(ListaPrecio=="LOCAL"){
				...
				*/
				...
				if(InsProducto.ProListaPrecioCostoReal>0 && InsProducto.ProListaPrecioCostoReal!= "" && InsProducto.ProListaPrecioCostoReal!= "0.00" && InsProducto.ProListaPrecioCostoReal!= null){
					...
					//PrecioFinal = FncCalcularPrecioFinal(PorcentajeImpuestoVentaAux,IncluyeImpuesto,Costo,MargenPorcentajeAux,0,0,CotizacionProductoDetallePorcentajePedido,0,0);
...
//	*/
//	
//	ValorVentaFinal = FncCalcularValorVentaFinal(ProductoCosto,CotizacionProductoDetallePorcentajeUtilidad,CotizacionProductoDetallePorcentajeOtroCosto,CotizacionProductoDetallePorcentajeManoObra,CotizacionProductoDetallePorcentajePedido,0,0);
//
//	$("#CmpCotizacionProductoDetalleValorVenta").val(ValorVentaFinal);
//
//	DescuentoFinal = FncCalcularDescuentoFinal(ValorVentaFinal,CotizacionProductoDetallePorcentajeDescuento);	
