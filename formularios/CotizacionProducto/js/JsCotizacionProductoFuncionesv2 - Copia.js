...
/*	}else if(MargenPorcentaje == "" || MargenPorcentaje == "0.00"){
		...
		$('#CmpClienteMargenUtilidad').focus();
			*/
			...
			$("select#CmpProductoUnidadMedidaConvertir").change(function(){
				...
				function(j){
						...
						/*$.getJSON("comunes/Producto/JnListaPrecio.php?ProductoId="+InsProducto.ProId+"&ClienteTipoId="+ClienteTipoId+"&UnidadMedidaId="+UnidadMedidaConvertir,{}, 
							function(j){
								*/
								FncMostrarPrecios(ProductoId,ClienteTipoId,UnidadMedidaIdSalida,EmpresaMonedaId,MonedaId,Seguro,Incrementar,TipoCambio);						
			...
			FncMostrarPrecios(InsProducto.ProId,ClienteTipoId,InsProducto.UmeIdSalida,EmpresaMonedaId,MonedaId,Seguro,Incrementar,TipoCambio);						
			
			
			/*$.ajax({
				type: 'POST',
				dataType: 'json',
				url: 'comunes/Producto/acc/AccProductoProcesarListaPrecioGM.php',
				...
				success: function(respuesta){*/
					...
					/*switch(respuesta['CodigoRespuesta']){
						...
						case 1:	
					*/					
					//FncMostrarPrecios(InsProducto.ProId,ClienteTipoId,InsProducto.UmeIdSalida,EmpresaMonedaId,MonedaId,Seguro,Incrementar);						
					/*	break;
		
						case 2:
							FncMostrarPrecios(InsProducto.ProId,ClienteTipoId,InsProducto.UmeIdSalida,EmpresaMonedaId,MonedaId,Seguro);
						break;
...
function FncMostrarPrecios(oProductoId,oClienteTipoId,oUmeIdSalida,EmpresaMonedaId,MonedaId,oSeguro,oIncrementar,oTipoCambio){
	
	console.log("oSeguro: "+oSeguro);	
	...
	$.getJSON("comunes/Producto/JnListaPrecio.php?ProductoId="+oProductoId+"&ClienteTipoId="+oClienteTipoId+"&UnidadMedidaId="+oUmeIdSalida+"&PorcentajeAdicional="+PorcentajeAdicional,{}, 
	function(j){
		...
		if(EmpresaMonedaId == MonedaId){
			...
			Costo = j.LprCosto / oTipoCambio;
			ValorVenta = j.LprValorVenta / oTipoCambio;
			Precio = j.LprPrecio / oTipoCambio;
		}
...
function FncCalcularMostrarImporteFinal(){
	...
	DescuentoFinal = FncCalcularDescuentoFinal(ValorVentaFinal,CotizacionProductoDetallePorcentajeDescuento);	
	
	$("#CmpCotizacionProductoDetalleDescuento").val(DescuentoFinal);
