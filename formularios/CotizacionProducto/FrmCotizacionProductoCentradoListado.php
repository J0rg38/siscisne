...
if($POST_Editar==1){
?>
<a class="EstSesionObjetosItem" href="javascript:FncCotizacionProductoCentradoEscoger('<?php echo $DatCotizacionProductoCentrado->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
<?php
}
?>
...
<tr>
  ...
  <td width="66%" align="right" class="Total">Total Centrado:</td>
