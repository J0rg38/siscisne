...
<td align="right"><?php echo $DatCotizacionProductoPintado->Parametro1;?></td>
<td align="right"><?php echo $DatCotizacionProductoPintado->Parametro2;?></td>
<td align="right"><?php echo number_format($DatCotizacionProductoPintado->Parametro5,2);?></td>
<td align="center"><?php
switch($DatCotizacionProductoPintado->Parametro6){
	case 1:
?>
  Si
  <?php
...
if($POST_Editar==1){
?>
  <a class="EstSesionObjetosItem" href="javascript:FncCotizacionProductoPintadoEscoger('<?php echo $DatCotizacionProductoPintado->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
  <?php
}
?>
...
if($POST_Eliminar==1){
?>
  <a href="javascript:FncCotizacionProductoPintadoEliminar('<?php echo $DatCotizacionProductoPintado->Item;?>');" >
...
<?php
	...
	$TotalBruto = $TotalBruto + $DatCotizacionProductoPintado->Parametro5;
...
<tr>
  ...
  <td width="66%" align="right" class="Total">Total Pintado:</td>
