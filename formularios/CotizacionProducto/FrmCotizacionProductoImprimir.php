...
?>
        ...
        <th width="79" align="center" valign="middle" >IMPORTE</th>
        <?php
//}
  ?>
        </tr>
...
deb($DatCotizacionProductoDetalle->CrdEstado );
			if( $DatCotizacionProductoDetalle->CrdEstado == 3 ){
...
?>
  ...
  <?php
        ...
        <td align="right" class="EstCotizacionProductoDetalleImprimirContenido" >
          ...
          <?php echo number_format(($DatCotizacionProductoDetalle->CrdPrecioBruto),2);?>       
        </td>
        <td align="right" class="EstCotizacionProductoDetalleImprimirContenido" ><?php echo number_format(($DatCotizacionProductoDetalle->CrdImporteBruto),2);?></td>
        <?php
//if(!empty($InsCotizacionProducto->CprPorcentajeDescuento ) and $InsCotizacionProducto->CprPorcentajeDescuento <> 0.00 and $InsCotizacionProducto->CprPorcentajeDescuento <> "0.00"){
?>
        <td align="right" class="EstCotizacionProductoDetalleImprimirContenido" ><?php echo number_format($DatCotizacionProductoDetalle->CrdDescuento,2);?></td>
        <td align="right" class="EstCotizacionProductoDetalleImprimirContenido" ><?php echo number_format($DatCotizacionProductoDetalle->CrdImporte,2);?></td>
        <?php
...
?>
  <table width="100%"  border="0" cellpadding="1" cellspacing="0" class="EstCotizacionProductoImprimirTabla">
    <thead class="EstCotizacionProductoImprimirTablaHead">
      <tr>
        <th width="37" align="center" valign="middle" >Item</th>
        <?php
		if($GET_ImprimirPedido==1){
		?>
        <th width="59" align="center" valign="middle" >TIPO</th>
        <?php
		}
		?>
		...
		if($GET_ImprimirCodigo==1){
		?>
        <th width="59" align="center" valign="middle" >CODIGO</th>
        <?php
		}
		?>
        <th width="76" align="center" valign="middle" >CANT.</th>
        <th width="60" align="center" valign="middle" >UND.</th>
        <th width="485" align="center" valign="middle" >DESCRIPCION </th>
        <th width="85" align="center" valign="middle" >P/UNIT</th>
        <?php
//if(!empty($InsCotizacionProducto->CprPorcentajeDescuento ) and $InsCotizacionProducto->CprPorcentajeDescuento <> 0.00 and $InsCotizacionProducto->CprPorcentajeDescuento <> "0.00"){
?>
        
        <th width="101" align="center" valign="middle" >IMPORTE</th>
        <?php
//}
  ?>
        </tr>
...
?>
  ...
  <?php
        ...
        <td align="right" class="EstCotizacionProductoDetalleImprimirContenido" >
          ...
          <?php echo number_format(($DatCotizacionProductoDetalle->CrdPrecio),2);?>       
        </td>
        <?php
//if(!empty($InsCotizacionProducto->CprPorcentajeDescuento ) and $InsCotizacionProducto->CprPorcentajeDescuento <> 0.00 and $InsCotizacionProducto->CprPorcentajeDescuento <> "0.00"){
?>
...
?>
			...
			/*	if(!empty($InsCotizacionProducto->CprTipoCambio)){
               ...
               <!-- <li>Repuestos       originales.</li>-->
                ...
                <li>En caso desista de la compra, se retendrá el 50% del valor total por gastos operativos generados.</li>
                <li>Para importaciones de repuestos la demora es de 90 días a más, esto sujeto a disposición de nuestro proveedor General Motors Peru S.A.</li>
