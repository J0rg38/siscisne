...
$ResAlmacenStock = $InsAlmacenStock->MtdObtenerAlmacenStocks("ProCodigoOriginal","esigual",$DatReemplazo,"ProId","ASC",1,"1",NULL,date("Y")."-01-01",date("Y-m-d"),NULL,NULL,NULL,NULL,NULL,NULL,false,$_SESSION['SesionSucursal'],date("Y"));
