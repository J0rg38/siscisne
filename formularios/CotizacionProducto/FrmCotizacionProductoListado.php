...
*/
	...
	$ResCotizacionProducto = $InsCotizacionProducto->MtdObtenerCotizacionProductos(
		"cpr.CprId,cli.CliNombreCompleto,cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,seg.CliNombre,seg.CliApellidoPaterno,seg.CliApellidoMaterno,cli.CliNumeroDocumento,EinVIN,EinPlaca,FinId,VmaNombre,VmoNombre,VveNombre,CprMarca,CprModelo,CprPlaca,cli.CliDepartamento,cli.CliDistrito,cli.CliProvincia",
		$POST_con,
		$POST_fil,
		$POST_ord,
		$POST_sen,
...
<?php
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE COTIZACIONES DE REPUESTOS Y SERVICIOS</span>
					</td>
				</tr>
				<tr>
					<td width="50%">
      ...
      <option value="CprId" <?php if ($POST_cam == "CprId") {
								echo 'selected="selected"';
							} ?>>Id</option>
								...
								<tr>
									...
									<td colspan="21" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $CotizacionProductosTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $CotizacionProductosTotal; ?>">Todos</option>
										</select>
								...
								?>
									...
									<tr id="Fila_<?php echo $f; ?>">
										...
										<td width="2%" align="center">
											...
											<input onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->CprId; ?>" estado="<?php echo $dat->CprEstado; ?>" />
										</td>
