                 ...
                 <td align="left" valign="top"><table>
                   <tr>
                     ...
                     <td><input name="CmpFichaIngresoId" id="CmpFichaIngresoId" type="hidden"    value="<?php  echo $InsCotizacionProducto->FinId;?>" size="20" maxlength="20" />
                       <input name="CmpFichaIngreso" type="text" class="EstFormularioCaja" id="CmpFichaIngreso"  value="<?php  echo $InsCotizacionProducto->FinId;?>" size="15" maxlength="25" <?php echo (!empty($InsCotizacionProducto->FinId)?'readonly="readonly"':'')?>  /></td>
...
<img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncCotizacionProductoDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a></td>
               <td width="2%"><div id="CapCotizacionProductoDetallesResultado"> </div></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
