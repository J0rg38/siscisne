...
<?php	
  ...
  $InsCotizacionProductoDetalle = new ClsCotizacionProductoDetalle($InsMysql);
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">EDITAR
              COTIZACION DE REPUESTOS Y SERVICIOS</span></td>
        </tr>
        <tr>
          <td colspan="2">
                    ...
                    <td valign="top">
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="5"><span class="EstFormularioSubTitulo">Datos de la Cotizacion
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if (empty($InsCotizacionProducto->CprFecha)) {
                                                                                                                                                    echo date("d/m/Y");
                                                                                                                                                  } else {
                                                                                                                                                    echo $InsCotizacionProducto->CprFecha;
                                                                                                                                                  } ?>" size="15" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFecha" name="BtnFecha" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            ...
                            <td align="left" valign="top">Hora:<br />
                              <span class="EstFormularioSubEtiqueta">(HH:mm)</span>
                            </td>
                          ...
                          <tr>
                            ...
                            <td colspan="3">
                              <table>
                                <tr>
                                  <td><input name="CmpClienteId" type="hidden" id="CmpClienteId" value="<?php echo $InsCotizacionProducto->CliId; ?>" size="3" />
                                    <input name="CmpClienteVehiculoIngresoId" type="hidden" id="CmpClienteVehiculoIngresoId" value="<?php echo $InsCotizacionProducto->EinId; ?>" size="3" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">VIN:
                              ...
                              <input name="CmpVehiculoIngresoClienteId" type="hidden" id="CmpVehiculoIngresoClienteId" value="<?php echo $InsCotizacionProducto->CliId; ?>" size="3" />
                            </td>
                            <td>
                            ...
                            <td align="left" valign="top">Marca:
                              <input name="CmpVehiculoIngresoMarcaId" type="hidden" id="CmpVehiculoIngresoMarcaId" value="<?php echo $InsCotizacionProducto->VmaId; ?>" size="3" />
                            </td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Modelo:
                              <input name="CmpVehiculoIngresoModeloId" type="hidden" id="CmpVehiculoIngresoModeloId" value="<?php echo $InsCotizacionProducto->VmoId; ?>" size="3" />
                            </td>
                          ...
                          <tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                                      ...
                                      ?>
                                        <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsCotizacionProducto->MonId == $DatMoneda->MonId) {
                                                                                          echo 'selected="selected"';
                            ...
                            <td align="left" valign="top">
                              <table>
                                <tr>
                                  <td><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncCotizacionProductoDetalleListar();" value="<?php if (empty($InsCotizacionProducto->CprTipoCambio)) {
                                                                                                                                                                                                  echo "";
                                                                                                                                                                                                } else {
                                                                                                                                                                                                  echo $InsCotizacionProducto->CprTipoCambio;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Impuesto:<br />
                              <span class="EstFormularioSubEtiqueta">(%)</span>
                            </td>
                            <td align="left" valign="top"><input name="CmpPorcentajeImpuestoVenta" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPorcentajeImpuestoVenta" onchange="FncCotizacionProductoDetalleListar();" value="<?php if (empty($InsCotizacionProducto->CprPorcentajeImpuestoVenta)) {
                                                                                                                                                                                                                                                echo $EmpresaImpuestoVenta;
                                                                                                                                                                                                                                              } else {
                                                                                                                                                                                                                                                echo $InsCotizacionProducto->CprPorcentajeImpuestoVenta;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              ...
                              <input name="CmpPorcentajeManoObra" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPorcentajeManoObra" value="<?php echo number_format($InsCotizacionProducto->CprPorcentajeManoObra, 2); ?>" size="10" maxlength="10" readonly="readonly" />
                            </td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Vigencia: <br />
                              <span class="EstFormularioSubEtiqueta"> (dias)</span>
                            </td>
...
*/
                              ...
                              <textarea name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo stripslashes($InsCotizacionProducto->CprObservacion); ?></textarea>
                            </td>
	...
	height : 80
                              ...
                              <textarea name="CmpObservacionImpresa" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionImpresa"><?php echo $InsCotizacionProducto->CprObservacionImpresa; ?></textarea>
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top">
                              <table>
                                <tr>
                                  ...
                                  <td><input name="CmpFichaIngresoId" id="CmpFichaIngresoId" type="hidden" value="<?php echo $InsCotizacionProducto->FinId; ?>" size="20" maxlength="20" />
                                    <input name="CmpFichaIngreso" type="text" class="EstFormularioCaja" id="CmpFichaIngreso" value="<?php echo $InsCotizacionProducto->FinId; ?>" size="15" maxlength="25" <?php echo (!empty($InsCotizacionProducto->FinId) ? 'readonly="readonly"' : '') ?> />
                                  </td>
                              ...
                              <!--<input name="CmpFichaIngresoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpFichaIngresoId"  tabindex="3" value="<?php echo $InsCotizacionProducto->FinId; ?>" size="20" maxlength="20" readonly="readonly" />-->
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="4" align="left" valign="top"><!--<input <?php echo (($InsCotizacionProducto->CprVerificar == 1) ? 'checked="checked"' : ''); ?>  type="checkbox" name="CmpVerificar2" id="CmpVerificar2" value="1" />
                   ...
                   Incluir Centrado <br />-->
                              ...
                              <input value="1" checked="checked" type="checkbox" name="CmpIncrementar" id="CmpIncrementar" />
                              Venta por mostrador
                          ...
                          <tr>
                            <td width="98%">
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><a href="javascript:FncCotizacionProductoDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  ...
                                  <td><a href="comunes/Producto/FrmProductoBuscar.php?height=440&amp;width=850" class="thickbox" title=""><img src="imagenes/acciones/buscador.png" width="25" height="25" border="0" align="absmiddle"></a><a href="javascript:FncCotizacionProductoDetalleGuardar();"></a></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td colspan="13" align="left">
                                    <table>
                                      <tr>
                                        ...
                                        <td align="left" valign="top" class="EstFormulario"><input name="CmpProductoCosto" type="text" class="EstFormularioCajaDeshabilitada" id="CmpProductoCosto" size="5" maxlength="10" readonly="readonly" /></td>
                                        <td align="left" valign="top" class="EstFormulario">Margen:<br />
                                          <span class="EstFormularioSubEtiqueta">(%)</span>
                                        </td>
                                        <td align="left" valign="top" class="EstFormulario"><input name="CmpCotizacionProductoDetallePorcentajeUtilidad" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCotizacionProductoDetallePorcentajeUtilidad" size="5" maxlength="10" readonly="readonly" /></td>
                                        <td align="left" valign="top" class="EstFormulario">Otros Costos:<br />
                                          <span class="EstFormularioSubEtiqueta">(%)</span>
                                        </td>
                                        <td align="left" valign="top" class="EstFormulario"><input name="CmpCotizacionProductoDetallePorcentajeOtroCosto" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCotizacionProductoDetallePorcentajeOtroCosto" size="5" maxlength="10" readonly="readonly" /></td>
                                        <td align="left" valign="top" class="EstFormulario">Mano de Obra:<br />
                                          <span class="EstFormularioSubEtiqueta">(%)</span>
                                        </td>
                                        <td align="left" valign="top" class="EstFormulario"><input name="CmpCotizacionProductoDetallePorcentajeManoObra" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCotizacionProductoDetallePorcentajeManoObra" size="5" maxlength="10" readonly="readonly" /></td>
                                        <td align="left" valign="top" class="EstFormulario">Adicional:<br />
                                          <span class="EstFormularioSubEtiqueta">(%)</span>
                                        </td>
                                        <td align="left" valign="top" class="EstFormulario"><input name="CmpCotizacionProductoDetallePorcentajeAdicional" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCotizacionProductoDetallePorcentajeAdicional" size="5" maxlength="10" readonly="readonly" /></td>
                                        <td align="left" valign="top" class="EstFormulario">Descuento:<br />
                                          <span class="EstFormularioSubEtiqueta">(%)</span>
                                        </td>
                                        <td align="left" valign="top" class="EstFormulario">
                                          <input name="CmpCotizacionProductoDetallePorcentajeDescuento" type="text" class="EstFormularioCaja" id="CmpCotizacionProductoDetallePorcentajeDescuento" size="5" maxlength="10" />
                                        </td>
                                        <td align="left" valign="top" class="EstFormulario">Pedido:<br />
                                          <span class="EstFormularioSubEtiqueta">(%)</span>
                                        </td>
                                        <td align="left" valign="top" class="EstFormulario"><input name="CmpCotizacionProductoDetallePorcentajePedido" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCotizacionProductoDetallePorcentajePedido" size="5" maxlength="10" readonly="readonly" /></td>
                                        <td align="left" valign="top" class="EstFormulario">Valor:</td>
                                        <td align="left" valign="top" class="EstFormulario"><input name="CmpCotizacionProductoDetalleValorVenta" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCotizacionProductoDetalleValorVenta" size="5" maxlength="10" readonly="readonly" /></td>
                                      </tr>
                                    </table>
                                  </td>
                                  <td>&nbsp;</td>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            ...
                            <td width="2%">
                              <div id="CapCotizacionProductoDetallesResultado"> </div>
                            </td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="3">
                              <div id="CapCotizacionProductoDetalles" class="EstCapCotizacionProductoDetalles"> </div>
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                        </table>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="48%">
                              <div class="EstFormularioAccion" id="CapCotizacionProductoPlanchadoAccion">Listo
                                para registrar elementos</div>
                            </td>
                            <td width="50%" align="right"><a href="javascript:FncCotizacionProductoPlanchadoListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncCotizacionProductoPlanchadoEliminarTodo();"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a></td>
                            <td width="1%">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapCotizacionProductoPlanchados" class="EstCapCotizacionProductoPlanchados"> </div>
                            </td>
                            <td>
                              <div id="CapCotizacionProductoPlanchadosResultado"> </div>
                            </td>
                          </tr>
                        </table>
                      </div>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="48%">
                              <div class="EstFormularioAccion" id="CapCotizacionProductoPintadoAccion">Listo
                                para registrar elementos</div>
                            </td>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapCotizacionProductoPintados" class="EstCapCotizacionProductoPintados"> </div>
                            </td>
                            <td>
                              <div id="CapCotizacionProductoPintadosResultado"> </div>
                            </td>
                          </tr>
                        </table>
                      </div>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="48%">
                              <div class="EstFormularioAccion" id="CapCotizacionProductoCentradoAccion">Listo
                                para registrar elementos</div>
                            </td>
                            <td width="50%" align="right"><a href="javascript:FncCotizacionProductoCentradoListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncCotizacionProductoCentradoEliminarTodo();"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a></td>
                            <td width="1%">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapCotizacionProductoCentrados" class="EstCapCotizacionProductoCentrados"> </div>
                            </td>
                            <td>
                              <div id="CapCotizacionProductoCentradosResultado"> </div>
                            </td>
                          </tr>
                        </table>
                      </div>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="48%">
                              <div class="EstFormularioAccion" id="CapCotizacionProductoTareaAccion">Listo
                                para registrar elementos</div>
                            </td>
                            <td width="50%" align="right"><a href="javascript:FncCotizacionProductoTareaListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncCotizacionProductoTareaEliminarTodo();"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a></td>
                            <td width="1%">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapCotizacionProductoTareas" class="EstCapCotizacionProductoTareas"> </div>
                            </td>
                            <td>
                              <div id="CapCotizacionProductoTareasResultado"> </div>
                            </td>
                          </tr>
                        </table>
                      </div>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            ...
                            <td width="98%" colspan="2">
                              <div id="CapCotizacionProductoTotals" class="EstCapCotizacionProductoTotals"> </div>
                            </td>
                            <td width="1%">&nbsp;</td>
                          </tr>
                        </table>
                              ...
                              <div class="EstFormularioArea">
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  ...
                                  <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstCapCotizacionProductoFotos" id="CapCotizacionProductoFotosA"></div>
                                    </td>
                                    <td align="left" valign="top">&nbsp;</td>
                                  </tr>
                                  <tr>
