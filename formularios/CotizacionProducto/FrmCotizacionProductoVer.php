...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdComunesJs("Cliente"); ?>JsClienteNotaFuncionesv2.js"></script>
...
*/
  ...
  <div class="EstCapContenido">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER COTIZACION DE REPUESTOS Y SERVICIOS</span></td>
      </tr>
      <tr>
        <td colspan="2">
              ...
              <table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                      ...
                      <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if (empty($InsCotizacionProducto->CprFecha)) {
                                                                                                                                                ...
                                                                                                                                                } ?>" size="15" maxlength="10" readonly="readonly" /></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          ...
                          <td><input name="CmpHora" type="text" class="EstFormularioCajaHora" id="CmpHora" value="<?php echo $InsCotizacionProducto->CprHora; ?>" size="15" maxlength="10" readonly="readonly" /></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td colspan="3" align="left" valign="top">
                            ...
                            <table>
                              <tr>
                                <td><input name="CmpClienteNombre" type="hidden" id="CmpClienteNombre" value="<?php echo $InsCotizacionProducto->CliNombre; ?>" size="3" />
                                ...
                                <td><input name="CmpClienteNombre" type="text" class="EstFormularioCaja" id="CmpClienteNombre" value="<?php echo $InsCotizacionProducto->CliNombre; ?> <?php echo $InsCotizacionProducto->CliApellidoPaterno; ?> <?php echo $InsCotizacionProducto->CliApellidoMaterno; ?>" size="45" maxlength="255" readonly="readonly" /></td>
                        ...
                        <tr>
                          ...
                          <td><input name="CmpClienteEmail" type="text" class="EstFormularioCaja" id="CmpClienteEmail" value="<?php echo $InsCotizacionProducto->CprEmail; ?>" size="45" maxlength="255" readonly="readonly" /></td>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td>Seguro:</td>
                          <td><select class="EstFormularioCombo" name="CmpSeguro" id="CmpSeguro" disabled="disabled">
                              <option value="">Escoja una opcion</option>
                              <?php
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncCotizacionProductoDetalleListar();" value="<?php if (empty($InsCotizacionProducto->CprTipoCambio)) {
                                                                                                                                                                                                                    echo "";
                                                                                                                                                                                                                  } else {
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><input class="EstFormularioCajaDeshabilitada" name="CmpPorcentajeImpuestoVenta" type="text" id="CmpPorcentajeImpuestoVenta" value="<?php if (empty($InsCotizacionProducto->CprPorcentajeImpuestoVenta)) {
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><input name="CmpClienteMargenUtilidad" type="text" class="EstFormularioCaja" id="CmpClienteMargenUtilidad" value="<?php echo number_format($InsCotizacionProducto->CprPorcentajeMargenUtilidad, 2); ?>" size="10" maxlength="10" readonly="readonly" /></td>
                 ...
                 <div class="EstFormularioCajaObservacion">
                            ...
                            <textarea name="CmpObservacion" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsCotizacionProducto->CprObservacion; ?></textarea>
                          </td>
	...
	height : 80
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td colspan="4" align="left" valign="top"><!--<input disabled="disabled" <?php echo (($InsCotizacionProducto->CprVerificar == 1) ? 'checked="checked"' : ''); ?>  type="checkbox" name="CmpVerificar" id="CmpVerificar" value="1" />
