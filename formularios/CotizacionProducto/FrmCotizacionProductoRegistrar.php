...
<?php
	...
	height : 80
                              ...
                              <textarea name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsCotizacionProducto->CprObservacion; ?></textarea>
                            </td>
	...
	height : 80
                      ...
                      <input type="hidden" name="CmpEstado" id="CmpEstado" value="1" />-->
                            </td>
                              ...
                              <table>
                                <tr>
                                  ...
                                  <td><input name="CmpFichaIngresoId" id="CmpFichaIngresoId" type="hidden" value="<?php echo $InsCotizacionProducto->FinId; ?>" size="20" maxlength="20" />
                                    <input name="CmpFichaIngreso" type="text" class="EstFormularioCaja" id="CmpFichaIngreso" tabindex="3" value="<?php echo $InsCotizacionProducto->FinId; ?>" size="15" maxlength="25" <?php echo (!empty($InsCotizacionProducto->FinId) ? 'readonly="readonly"' : '') ?> />
                                  </td>
