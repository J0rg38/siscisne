            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "OvvTiempoSolicitudEnvio"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OvvTiempoSolicitudEnvio','ASC');"> Fecha Envio <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OvvTiempoSolicitudEnvio','DESC');"> Fecha Envio <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('OvvTiempoSolicitudEnvio','ASC');"> Fecha Envio </a>
                  <?php
				}
				?></th>
                <th width="3%" ><?php
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->OvvId; ?>" estado = "<?php echo $dat->OvvEstado; ?>" factura_estado="<?php echo $dat->OvvFacturaEstado; ?>" boleta_estado="<?php echo $dat->OvvBoletaEstado; ?>" />				</td>
...
<?php //echo ($dat->EinVIN);?></td>
                ...
                <td  width="3%" align="right" ><?php echo ($dat->OvvAnoFabricacion);?></td>
                <td  width="3%" align="right" ><?php echo ($dat->OvvAnoModelo);?></td>
...
?>
                ...
                <td  width="6%" align="right" ><?php echo $dat->PerNombre;?> <?php echo $dat->PerApellidoPaterno;?> <?php echo $dat->PerApellidoMaterno;?></td>
                <td  width="10%" align="center" >


<input name="CmpOrdenVentaVehiculoObservacionAsignacion_<?php echo $dat->OvvId;?>" type="text" class="EstFormularioCaja" id="CmpOrdenVentaVehiculoObservacionAsignacion_<?php echo $dat->OvvId;?>" value="<?php echo $dat->OvvObservacionAsignacion?>" size="25" maxlength="255" />
