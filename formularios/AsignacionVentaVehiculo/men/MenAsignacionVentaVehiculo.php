...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"Ver") and empty($GET_dia)){
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Informe"><img src="imagenes/submenu/reportes.png" alt="[Informes]"  title="Ir a formulario de informes" />Informes</a></div>
<?php
}
?>