<?php
 ...
 header("Content-Disposition:  filename=\"APROBACIONES_ORDEN_VENTA_VEHICULO_GENERAL_".date('d-m-Y').".xls\";");
...
?>
  ...
  <?php		 
                ...
                <td  width="4%" align="right" ><?php echo ($dat->FacDatoAdicional15);?></td>
