            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "OvvFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OvvFecha','ASC');"> Fecha Orden <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OvvFecha','DESC');"> Fecha Orden  <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('OvvFecha','ASC');"> Fecha Orden  </a>
                <?php
				}
				?></th>
                <th width="3%" ><?php
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->AvvId; ?>" estado = "<?php echo $dat->AvvEstado; ?>" factura_estado="<?php echo $dat->AvvFacturaEstado; ?>" boleta_estado="<?php echo $dat->AvvBoletaEstado; ?>" />				</td>
                ...
                <td  width="3%" align="right" ><?php echo $dat->OvvFecha;  ?></td>
