...
<tr>
	...
	<?php $InsOrdenVentaVehiculo->OvvTotal = (($InsOrdenVentaVehiculo->OvvTotal/(empty($InsOrdenVentaVehiculo->OvvTipoCambio)?1:$InsOrdenVentaVehiculo->OvvTipoCambio)));?>
    <?php echo number_format($InsOrdenVentaVehiculo->OvvTotal,2); ?>
    
	
	<?php //echo $DolaresFormato; ?></td>
