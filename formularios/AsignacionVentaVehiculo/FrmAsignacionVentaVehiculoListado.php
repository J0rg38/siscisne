			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE ASIGNACIONES DE VEHICULOS</span>
					</td>
				</tr>
				<tr>
					<td width="50%">
								...
								<tr>
									...
									<th width="4%"><?php
													if ($POST_ord == "EinCancelado") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('EinCancelado','ASC');"> C. Prv. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('EinCancelado','DESC');"> C. Prv. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('EinCancelado','ASC');"> C. Prv. </a>
										<?php
													}
										?>
									</th>
								...
								<tr>
									...
									<td colspan="25" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $AsignacionVentaVehiculosTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $AsignacionVentaVehiculosTotal; ?>">Todos</option>
										</select>
								...
								?>
									...
									<tr id="Fila_<?php echo $f; ?>">
										...
										<td width="2%" align="center">
											...
											<input indice="<?php echo $f; ?>" onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->AvvId; ?>" estado="<?php echo $dat->AvvEstado; ?>" factura_estado="<?php echo $dat->AvvFacturaEstado; ?>" boleta_estado="<?php echo $dat->AvvBoletaEstado; ?>" />
										</td>
                  ...
                  <?php
												...
												?>
													...
													<?php
																				...
																				switch ($dat->AvvCancelado2) {
																					...
																					case "Si":
													?>
															<img width="25" height="25" alt="[Si]" title="Si" src="imagenes/estado/pagado_sino.png" />
														<?php
										...
										<td width="4%" align="right"><?php
																		switch ($dat->EinCancelado) {
																			case 1:
																		?>
													<img src="imagenes/estado/cancelado_proveedor_si.png" alt="[Cancelado]" title="Cancelado" width="25" height="25" />
												<?php
																				break;

																			case 2:
												?>
													<img src="imagenes/estado/cancelado_proveedor_no.png" alt="[Sin Cancelar]" title="Sin Cancelar" width="25" height="25" />
											<?php
																				break;
																		}
											?>
