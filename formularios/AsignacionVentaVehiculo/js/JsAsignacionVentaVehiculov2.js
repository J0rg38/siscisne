...
function FncAsignacionVentaVehiculoActualizarPendienteSeleccionados(){
	...
	if(seleccionados==""){
		...
		if(confirm("¿Realmente desea marcar como Pendiente la(s) asignaciones de vin?")){
			...
			if(actualizar){
				$("#Acc").val("AsignacionVentaVehiculoActualizarPendiente");
				$("#FrmListado").submit();	
			}else{
...
function FncAsignacionVentaVehiculoActualizarEmitidoSeleccionados(){
	...
	if(seleccionados==""){
		...
		if(confirm("¿Realmente desea marcar como Aprobado la(s) asignaciones de vin?")){
...
function FncAsignacionVentaVehiculoActualizarAnuladoSeleccionados(){
	...
	if(seleccionados==""){
		...
		if(confirm("¿Realmente desea marcar como Anulado la(s) asignaciones de vin?")){
...
/*function FncGenerarExcel(){
	document.getElementById("FrmListado").action = "formularios/AsignacionVentaVehiculo/acc/AccAsignacionVentaVehiculoGenerarExcel.php"
	document.getElementById("FrmListado").submit();
	document.getElementById("FrmListado").action = "#";
}*/
...
////			
////			case "1":
////				document.getElementById("FrmListado").action = "formularios/CotizacionVehiculo/acc/AccAsignacionVentaVehiculoGenerarExcel.php";
////			break;
////			
////			case "2":
//				document.getElementById("FrmListado").action = "formularios/AsignacionVentaVehiculo/acc/AccAprobacionVentaVehiculoGenerarExcel.php";
////			break;
////			
////
////		}
...
function FncGenerarExcel(){
	...
	var Tipo = prompt("Escoja el tipo de reporte \n 1 = General \n 2 = Reporte Fechas de Entrega \n 3 = Formato Call Center \n 4 = General Solo Aprobados", "1");
	...
	if(Tipo !== null){
		switch(Tipo.toUpperCase()){
			...
			case "2":
				document.getElementById("FrmListado").action = "formularios/AsignacionVentaVehiculo/acc/AccAsignacionVentaVehiculoGenerarExcelFechaEntrega.php";
			break;
			
			case "3":
				document.getElementById("FrmListado").action = "formularios/AsignacionVentaVehiculo/acc/AccAsignacionVentaVehiculoGenerarExcelCallCenter.php";
			break;
			
			case "4":
				document.getElementById("FrmListado").action = "formularios/AsignacionVentaVehiculo/acc/AccAsignacionVentaVehiculoAprobadosGenerarExcel.php";
			break;
