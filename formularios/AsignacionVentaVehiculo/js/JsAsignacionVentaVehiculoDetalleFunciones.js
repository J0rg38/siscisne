...
function FncAsignacionVentaVehiculoDetalleNuevo(){
	...
	$("#CmpOrdenVentaVehiculoAnoFabricacion").val("");
	$("#CmpOrdenVentaVehiculoAnoModelo").val("");
...
//	$("#CmpOrdenVentaVehiculoTotal").val("");
	...
	$("#CmpVehiculoIngresoNumeroMotor").attr('readonly', false);
	$("#CmpVehiculoIngresoColor").attr('readonly', false);
	
	$("#CmpOrdenVentaVehiculoAnoFabricacion").attr('readonly', false);
...
function FncAsignacionVentaVehiculoDetalleCalcularTotal(){
...
function FncAsignacionVentaVehiculoDetalleCalcularDescuento(){
