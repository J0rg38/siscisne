...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"ClientePago","Registrar")){
?>
	...
	<!--Content-->  		
       ...
       <tr>
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="1">&nbsp;</td>
            <td colspan="4"><span class="EstFormularioTitulo">REGISTRAR PAGO DE CLIENTE - BOLETA</span></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td width="193"><input type="hidden" name="Identificador" id="Identificador"  value="<?php echo $Identificador; ?>" /></td>
            <td colspan="2"><input name="CmpDocumentoId" type="hidden" id="CmpDocumentoId" value="<?php echo $InsBoleta->BolId;?>" />
              <input name="CmpDocumentoTalonario" type="hidden" id="CmpDocumentoTalonario" value="<?php echo $InsBoleta->BtaId;?>" />
              <input name="CmpDocumentoTalonarioNumero" type="hidden" id="CmpDocumentoTalonarioNumero" value="<?php echo $InsBoleta->BtaNumero;?>" />
          ...
          <tr>
            ...
            <td>Documento:</td>
            <td colspan="2">
				<?php echo $InsBoleta->BtaNumero;?> - <?php echo $InsBoleta->BolId;?>            </td>
            <td>&nbsp;</td>
            </tr>
          ...
          <tr>
            ...
            <td colspan="2"><textarea class="EstFormularioCaja" name="CmpDescripcion" id="CmpDescripcion" cols="40" rows="3" ><?php echo  $InsClientePago->CpaDescripcion;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>Forma de Pago:</td>
            <td colspan="2"><select name="CmpFormaPago" id="CmpFormaPago" class="EstFormularioCombo" >
        ...
        <div class="EstFormularioArea">
           ...
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               ...
               <tr>
               <td>&nbsp;</td>
               <td><iframe src="../ClientePago/acc/AccClientePagoSubirArchivo.php?Identificador=<?php echo $Identificador;?>" id="IfrClientePagoSubirArchivo" name="IfrClientePagoSubirArchivo" scrolling="Auto"  frameborder="0" width="100%" height="500"></iframe></td>
               <td>&nbsp;</td>
             </tr>           
             </table>
