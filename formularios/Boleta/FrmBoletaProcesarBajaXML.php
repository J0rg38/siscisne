...
$().ready(function() {
	...
	$('#CapBoletaAccion').html('Procesando archivo xml...');	
...
function FncBoletaProcesarBajaXML(){
	...
	$.ajax({
		...
		//data: 'hddNumRuc=<?php echo $EmpresaCodigo;?>&hddTipDoc=03&hddNumDoc=<?php echo $InsBoleta->BtaNumero;?>-<?php echo $InsBoleta->BolId;?>&hddNomArc=<?php echo $EmpresaCodigo;?>-03-<?php echo $InsBoleta->BtaNumero;?>-<?php echo $InsBoleta->BolId;?>&hddEstArc=02',
		...
		complete: function(response) {
			...
			$('#CapBoletaAccion').html('Archivo xml procesado correctamente...');	
			window.setTimeout("window.close();",2500);
			//window.setTimeout("FncBoletaRecibirZIP();",5000);
...
//function FncBoletaRecibirZIP(){
//	
//	FncPopUp('FrmBoletaRecibirZIP.php?Nombre=<?php echo $GET_Nombre;?>&Id=<?php echo $InsBoleta->BolId;?>&Ta=<?php echo $InsBoleta->BtaId;?>&P=1',0,0,1,0,0,1,0,350,150);
//	
//}
</script>
