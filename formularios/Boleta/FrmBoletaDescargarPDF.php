...
$().ready(function() {
	...
	$('#CapBoletaAccion').html('Conectando con SERVIDOR para descargar archivo pdf...');	
	
	setTimeout("FncBoletaDescargarPDF('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncBoletaDescargarPDF(oArchivo,oUrl){
