...
$().ready(function() {
	...
	$('#CapBoletaAccion').html('Conectando con SERVIDOR para descargar archivo cdr...');	
	
	setTimeout("FncBoletaDescargarCDR('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncBoletaDescargarCDR(oArchivo,oUrl){
