...
//include("ImpBoletaImprimir.php");

if(file_exists("ImpBoletaImprimir".$InsBoleta->BtaNumero."F.php")){
	
	include("ImpBoletaImprimir".$InsBoleta->BtaNumero."F.php");	
	
}else{

	echo "No existe version con formato para esta serie de boleta.";
