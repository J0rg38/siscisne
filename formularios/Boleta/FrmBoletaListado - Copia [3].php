	...
	$Color = "#FF0000";
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="center"  >
                  ...
                  <input   onclick="javascript:FncAgregarSeleccionado();" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->BolId."%".$dat->BtaId; ?>" ticket="<?php echo $dat->BolSunatRespuestaTicket;?>" respuesta="<?php echo $dat->BolSunatRespuestaEnvioCodigo;?>" />				
...
<?php
if($PrivilegioEliminar and $dat->BolCierre==1 and $dat->BolSunatRespuestaEnvioCodigo==0 and $dat->BolSunatUltimaAccion != "ALTA" and $dat->BolSunatUltimaRespuesta != "APROBADO"){
?> 
