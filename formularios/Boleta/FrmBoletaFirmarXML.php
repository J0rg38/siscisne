...
$().ready(function() {
	...
	$.ajax({
		...
		complete: function(response) {
			...
			window.setTimeout("FncBoletaFirmarXML();",5000);
...
function FncBoletaFirmarXML(){
	...
	$.ajax({
		...
		data: 'hddNumRuc=<?php echo $EmpresaCodigo;?>&hddTipDoc=03&hddNumDoc=<?php echo $InsBoleta->BtaNumero;?>-<?php echo $InsBoleta->BolId;?>&hddNomArc=<?php echo $EmpresaCodigo;?>-03-<?php echo $InsBoleta->BtaNumero;?>-<?php echo $InsBoleta->BolId;?>&hddEstArc=07',
		...
		complete: function(response) {
			...
			?>
				...
				window.setTimeout("FncBoletaRecibirFirmaXML();",5000);
...
function FncBoletaRecibirFirmaXML(){
	
	FncPopUp('FrmBoletaRecibirFirmaXML.php?Nombre=<?php echo $GET_Nombre;?>&Id=<?php echo $InsBoleta->BolId;?>&Ta=<?php echo $InsBoleta->BtaId;?>&Procesar=<?php echo $GET_Procesar;?>&EnviarSUNAT=<?php echo $GET_EnviarSUNAT;?>&P=1',0,0,1,0,0,1,0,350,150);
