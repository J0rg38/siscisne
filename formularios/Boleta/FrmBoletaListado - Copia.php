...
$InsBoleta->SucId = $_SESSION['SisSucId'];
	
include($InsProyecto->MtdFormulariosAcc("Boleta").'AccBoleta.php');

//MtdObtenerBoletas($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'BolId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oTalonario=NULL,$oRegimen=NULL,$oCondicionPago=NULL,$oMoneda=NULL)
...
?>                  
				...
				?>
                  <a href="javascript:FncFacturaNotaCreditoCargar('<?php echo $dat->FacId;?>','<?php echo $dat->FtaId;?>');"> <?php echo ($dat->FacNotaCredito); ?> </a>
                  <?php	
				}else{
				?>
...
<a href="javascript:FncFacturarProcesarXML('<?php echo $dat->FacId;?>','<?php echo $dat->FtaId;?>','<?php echo $dat->FacSunatRespuestaTicket;?>');"><img src="imagenes/acciones/sunat_procesar.png" alt="[Procesar]" title="Procesar" width="19" height="19" border="0" /></a>
-->
