...
//deb($InsBoleta->BolSunatRespuestaTicket);
?>
...
$().ready(function() {
	...
	$('#CapBoletaAccion').html('Conectando con SUNAT para consultar estado de ticket...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccBoletaConsultarEstadoTicket.php',
		data: 'Id=<?php echo $InsBoleta->BolId;?>&Ta=<?php echo $InsBoleta->BtaId;?>&Ticket=<?php echo $InsBoleta->BolSunatRespuestaTicket;?>',
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "C101":
					...
					$('#CapBoletaAccion').html('Consulta de estado de ticket procesado correctamente. RESPUESTA: '+respuesta['MensajeRespuesta']);				
				...
				default:
					$('#CapBoletaAccion').html('Ha ocurrido un error consultando el estado del ticket, proceso cancelado.');
