...
*/
	...
	$InsBoletaTalonario = new ClsBoletaTalonario($InsMysql);
...
<?php
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE BOLETAS</span>
					</td>
				</tr>
				<tr>
					<td width="49%">
     ...
     <option value="BolId" <?php if ($POST_cam == "BolId") {
								echo 'selected="selected"';
							} ?>>Id</option>
        ...
        <option value="CliNumeroDocumento" <?php if ($POST_cam == "CliNumeroDocumento") {
												echo 'selected="selected"';
											} ?>>Num. de Documento</option>
        <option value="BolTotal" <?php if ($POST_cam == "BolTotal") {
										echo 'selected="selected"';
									} ?>>Total</option>
     </select>-->
						...
						<select class="EstFormularioCombo" name="Talonario" id="Talonario">
							...
							?>
								<option
									...
									<?php if ($POST_tal == $DatBoletaTalonario->BtaId) {
										echo 'selected="selected"';
									} ?> value="<?php echo $DatBoletaTalonario->BtaId; ?>"><?php echo $DatBoletaTalonario->BtaNumero; ?></option>
							<?php
							}
							?>
						</select>
									...
									<tr>
										...
										<td colspan="26" align="center">
											...
											<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
												...
												<option <?php if ($POST_num == $BoletasTotal) {
															echo 'selected="selected"';
														} ?> value="<?php echo $BoletasTotal; ?>">Todos</option>
											</select>
									...
									?>
										...
										<tr id="Fila_<?php echo $f; ?>">
											...
											<td align="center">
												...
												<!--<input   onclick="javascript:FncAgregarSeleccionado();" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->BolId . "%" . $dat->BtaId; ?>" ticket="<?php echo $dat->BolSunatRespuestaTicket; ?>" respuesta="<?php echo $dat->BolSunatRespuestaEnvioCodigo; ?>" sunat_ultima_accion="<?php echo $dat->BolSunatUltimaAccion; ?>" sunat_ultima_respuesta="<?php echo $dat->BolSunatUltimaRespuesta; ?>" />-->


												<input indice="<?php echo $f; ?>" onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->BolId . "%" . $dat->BtaId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->BolId . "%" . $dat->BtaId; ?>" cliente="<?php echo $dat->CliId; ?>" estado="<?php echo $dat->BolEstado; ?>" nota_credito="<?php echo $dat->BolNotaCredito; ?>" respuesta="<?php echo $dat->BolSunatRespuestaEnvioCodigo; ?>" sunat_ultima_accion="<?php echo $dat->BolSunatUltimaAccion; ?>" sunat_ultima_respuesta="<?php echo $dat->BolSunatUltimaRespuesta; ?>" cierre="<?php echo $dat->BolCierre; ?>" />
                ...
                <?php	
                  ...
                  <a href="javascript:FncFichaIngresoCargarFormulario('Ver','<?php echo $dat->FinId; ?>');"> <?php echo $dat->FinId; ?></a>-->
											...
											<td align="right">
												...
												?> <?php echo number_format($dat->BolTotalDescuento, 2); ?></td>
											<td align="right">
											...
											<td align="right">
												...
												<?php echo ($dat->BolDiaTranscurrido); ?> d
											...
											<td align="center">
												...
												<?php
												if ($PrivilegioEliminar & $dat->BolCierre == 2 & $dat->BolNotaCredito == "No"  and $dat->BolSunatUltimaAccion != "ALTA" and $dat->BolSunatUltimaRespuesta != "APROBADO") {
												?>
												...
												<?php
												if ($PrivilegioEditar & $dat->BolCierre == 2 & $dat->BolNotaCredito == "No"  and $dat->BolSunatUltimaAccion != "ALTA" and $dat->BolSunatUltimaRespuesta != "APROBADO") {
												?>
												...
												?>
													...
													<a href="principal.php?Mod=<?php echo $GET_mod; ?>&Form=Editar&Id=<?php echo $dat->BolId; ?>&Ta=<?php echo $dat->BtaId; ?>"><img src="imagenes/acciones/acc_editar_especial.png" width="19" height="19" border="0" title="Editar" alt="[Editar]" /></a>
												...
												<?php
												/*if($PrivilegioEditarId & $dat->BolCierre==2){
?>
...
<?php
												...
												<?php
												if ($PrivilegioPagoRegistrar and $dat->BolEstado <> 6 and $dat->BolMontoPendiente > 0) {
												?>
