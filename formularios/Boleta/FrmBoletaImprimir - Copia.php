...
if(file_exists("ImpBoletaImprimir".$InsBoleta->BtaNumero.".php")){
	
	include("ImpBoletaImprimir".$InsBoleta->BtaNumero.".php");
	...
	if(substr($InsBoletaTalonario->BtaNumero,0,1)=="B"){
		...
		header("Location: FrmBoletaGenerarPDF.php?Id=".$InsBoleta->BolId."&Ta=".$InsBoleta->BtaId."&ImprimirCodigo=1");
		die();
/*?>
