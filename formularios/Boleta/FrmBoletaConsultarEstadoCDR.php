...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccBoletaConsultarEstadoCDR.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "D101":
					...
					$('#CapBoletaAccion').html('Consulta cdr solicitada correctamente. '+respuesta['MensajeRespuesta']);								
		...
		error: function(respuesta){
			$('#CapBoletaAccion').html('Ha ocurrido un error procesando el archivo xml, proceso cancelado. RESPUESTA: '+respuesta);
