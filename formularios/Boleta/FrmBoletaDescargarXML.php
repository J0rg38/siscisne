...
$().ready(function() {
	...
	$('#CapBoletaAccion').html('Conectando con SERVIDOR para descargar archivo xml...');	
	
	setTimeout("FncBoletaDescargarXML('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncBoletaDescargarXML(oArchivo,oUrl){
