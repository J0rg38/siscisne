...
<tr>
  <td>Ultima Accion</td>
  <td>:</td>
  <td><?php echo $InsBoleta->BolSunatUltimaAccion;?></td>
</tr>
<tr>
  <td>Ultima Respuesta</td>
  <td>:</td>
  <td><?php echo $InsBoleta->BolSunatUltimaRespuesta ?></td>
</tr>
<tr>
...
<tr>
  <td>Ticket Envio</td>
  <td>:</td>
  <td><?php echo $InsBoleta->BolSunatRespuestaEnvioTicket ?></td>
</tr>
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsBoleta->BolSunatRespuestaEnvioCodigo ?> - <?php echo $InsBoleta->BolSunatRespuestaEnvioContenido ?></td>
</tr>
<tr>
...
<tr>
  ...
  <td>:</td>
  <td><?php echo $InsBoleta->BolSunatRespuestaBajaTicket ?></td>
</tr>
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsBoleta->BolSunatRespuestaBajaCodigo; ?> - <?php echo $InsBoleta->BolSunatRespuestaBajaContenido; ?></td>
</tr>
<tr>
...
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsBoleta->BolSunatRespuestaConsultaCodigo; ?> - <?php echo $InsBoleta->BolSunatRespuestaConsultaContenido; ?></td>
</tr>
<tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
