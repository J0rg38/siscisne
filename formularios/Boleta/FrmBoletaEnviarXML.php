...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccBoletaEnviarXML.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case 1:
					...
					$('#CapBoletaAccion').html('Archivo xml enviado correctamente...');					
					window.setTimeout("FncBoletaFirmarXML('"+respuesta['Nombre']+"');",3000);
...
function FncBoletaFirmarXML(oNombre){
	...
	FncPopUp('FrmBoletaFirmarXML.php?Nombre='+oNombre+'&Id=<?php echo $InsBoleta->BolId;?>&Ta=<?php echo $InsBoleta->BtaId;?>&Procesar=<?php echo $GET_Procesar;?>&EnviarSUNAT=<?php echo $GET_EnviarSUNAT;?>&P=1',0,0,1,0,0,1,0,350,150);					
