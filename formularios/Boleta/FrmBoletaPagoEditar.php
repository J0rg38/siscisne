...
//$InsClientePago = $InsClientePago->MtdObtenerClientePago();		
...
<a href="javascript:self.parent.tb_remove();" ><img src="../../imagenes/iconos/salir.png" alt="[Salir]" title="Salir"  />Salir</a></div>
	...
	<!--Content-->  		
       ...
       <tr>
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="1">&nbsp;</td>
            <td colspan="4"><span class="EstFormularioTitulo">EDITAR PAGO DE CLIENTE - BOLETA</span></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
