...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccBoletaRegistrar.php');
		...
		dhtmlx.confirm("Desea imprimir ahora?", function(result){
			if(result==true){
			 ...
			 FncImprmir("<?php echo $InsBoleta->BolId;?>","<?php echo $InsBoleta->BtaId;?>","<?php echo ($InsBoleta->BtaNumero=="200")?'2':'1';?>");
			   ...
			   dhtmlx.confirm("¿Desea registrar el pago?", function(result){
					if(result==true){
						
						window.location.href = 'principal.php?Mod=PagoBoleta&Form=Registrar&BolId=<?php echo $InsBoleta->BolId;?>&BtaId=<?php echo $InsBoleta->BtaId;?>';
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo"> REGISTRAR BOLETA</span></td>
      </tr>
      <tr>
        <td>		
             ...
             <tr>
                 ...
                 <table border="0" cellpadding="0" cellspacing="0">
                   <tr>
                     <td>
                       ...
                       <span id="spryselect1"><span class="selectRequiredMsg"><img src="imagenes/advertencia.png" width="20" height="20" border="0" align="absmiddle" title="Debe seleccionar un elemento" alt="[A]"  /></span>
                         <label>
                           <select  onchange="FncGenerarBoletaId(this.value);" class="EstFormularioCombo" name="CmpTalonario" id="CmpTalonario">
                             <option value="">-</option>
                             <?php
			  ...
			  ?>
                     ...
                     <td>
                       ...
                       Nº<span id="sprytextfield3">
                         <label>
                           <input name="CmpId" type="text" class="EstFormularioCaja" id="CmpId" tabindex="1" value="<?php echo $InsBoleta->BolId;?>" size="20" maxlength="20" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?>   />
                           </label>
                     ...
                     <td>
                       ...
                       <a href="javascript:FncGenerarBoletaId(document.getElementById('CmpTalonario').value);"><img border="0" src="imagenes/recargar.jpg" alt="[Recargar]" title="Recargar" width="18" height="18" align="absmiddle"  /></a>
                       
                       </td>
                     <td>
                       <div id="CapBoleta"></div>
                       </td>
                     </tr>
                   </table>
...
?>
             ...
             <tr>
               ...
               <td colspan="2" align="left" valign="top"><input name="CmpFechaEmision" type="text" class="EstFormularioCajaFecha" id="CmpFechaEmision" tabindex="5" value="<?php if(empty($InsBoleta->BolFechaEmision)){ echo date("d/m/Y");}else{ echo $InsBoleta->BolFechaEmision; }?>" size="15" maxlength="10" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?>/>                 <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaEmision" name="BtnFechaEmision" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
             ...
             <tr>
               ...
               <td colspan="2" align="left" valign="top">
               	<textarea tabindex="7" name="CmpObservacionImpresa" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionImpresa">
               		<?php
			...
			?>
             ...
             <tr>
              ...
              <span class="EstFormularioSubEtiqueta">(Transf. Grat., Descts, etc.)</span></td>
               ...
               <td colspan="2" align="left" valign="top"><span id="sprytextfield4">
                 <label>
                   <input  name="CmpPorcentajeImpuestoVenta" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoVenta" value="<?php if(empty($InsBoleta->BolPorcentajeImpuestoVenta)){ echo $EmpresaImpuestoVenta; }else{echo $InsBoleta->BolPorcentajeImpuestoVenta;}?>" size="10" maxlength="10" />
                   </label>
                 <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
               <td align="left" valign="top">&nbsp;</td>
               </tr>
             ...
             <tr>
               ...
               <td align="left" valign="top">ISC:<br />
                 (%)</td>
               <td colspan="2" align="left" valign="top"><input onchange="FncBoletaDetalleListar();" name="CmpPorcentajeImpuestoSelectivo" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoSelectivo" value="<?php echo $InsBoleta->BolPorcentajeImpuestoSelectivo;?>" size="10" maxlength="10" /></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
			  ...
			  ?>
                       <option value="<?php echo $DatMoneda->MonId?>" <?php if($InsBoleta->MonId==$DatMoneda->MonId){ echo 'selected="selected"';}elseif($EmpresaMonedaId==$DatMoneda->MonId){  echo 'selected="selected"';}?> ><?php echo $DatMoneda->MonNombre?> ( <?php echo $DatMoneda->MonSimbolo;?>)</option>
                       <?php
			  }
			  ?>
                     </select>
               ...
               <td colspan="2" align="left" valign="top"><table>
                 <tr>
                   <td><span id="sprytextfield6">
                     ...
                     <input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncBoletaDetalleListar();" value="<?php if (empty($InsBoleta->BolTipoCambio)){ echo "";}else{ echo $InsBoleta->BolTipoCambio; } ?>" size="10" maxlength="10" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?> />
                   </span></td>
                   <td><a href="javascript:FncBoletaEstablecerMoneda();"><img src="imagenes/acciones/recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /></a></td>
                 </tr>
                 <tr> </tr>
               </table></td>
               <td align="left" valign="top">&nbsp;</td>
...
?>
			...
			?>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="6" align="left" valign="top"><span class="EstFormularioSubTitulo">CONDICIONES DE VENTA</span></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               ...
               <td colspan="2" align="left" valign="top"><span id="sprytextfield11">
             ...
             <tr>
               ...
               <td colspan="2" align="left" valign="top"><input class="EstFormularioCaja" name="CmpTotalDescuento" type="text" id="CmpTotalDescuento" size="10" maxlength="10" value="<?php echo number_format($InsBoleta->BolTotalDescuento,2);?>" /></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="6" align="left" valign="top">Almacen/Taller<span class="EstFormularioSubTitulo">
               ...
               <input name="CmpVehiculoMovimientoSalidaIdAux" type="hidden" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoMovimientoSalidaIdAux"  tabindex="3" value="<?php  echo $InsBoleta->VmvId;?>" size="20" maxlength="20" readonly="readonly" />
               </span></td>
               <td align="left" valign="top">&nbsp;</td>
               </tr>
             <tr>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="6" align="left" valign="top">Vehiculos</td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
...
<!--<?php
//echo $InsBoleta->BolProcesar;
?>
<input <?php echo (($InsBoleta->BolProcesar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpProcesar" id="CmpProcesar" />
Procesar comprobante <br />
<input <?php echo (($InsBoleta->BolEnviarSUNAT==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpEnviarSUNAT" id="CmpEnviarSUNAT" />
Enviar a SUNAT &nbsp;
-->
...
Enviar a SUNAT <br />   -->
               ...
               <td colspan="2" align="left" valign="top"><input name="CmpAbono" type="text" class="EstFormularioCaja" id="CmpAbono" value="<?php echo number_format($InsBoleta->BolAbono,2);?>" size="10" maxlength="10" /></td>
               <td align="left" valign="top">&nbsp;</td>
               </tr>
             </table>
           </div></td>
         ...
         <td width="853" valign="top">
           ...
           <div class="EstFormularioArea"> 
             ...
             <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
               <tr>
                 <td>&nbsp;</td>
                 <td colspan="10"><span class="EstFormularioSubTitulo">Items</span>
               ...
               <tr>
                 ...
                 <input type="checkbox" name="CmpBoletaDetalleGratuito" id="CmpBoletaDetalleGratuito" value="1" />
                   Transf. Grat.
...
Inc. Select.</td>
         ...
         <td width="263" valign="top"><div id="CapBoletaDetalle" class="EstFormularioArea">
       ...
       <tr>
         <td rowspan="3" valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="1%">&nbsp;</td>
               <td width="49%"><div class="EstFormularioAccion" id="CapBoletaDetalleAccion">Listo
       ...
       <tr>
         ...
         <div id="CapBoletaDetalle" class="EstFormularioArea">
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="2">
              ...
              <td width="97%" valign="top"><div class="EstFormularioArea">
                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    ...
                    <td colspan="3"><input tabindex="5" class="EstFormularioCaja" name="CmpRegimenComprobanteNumero" type="text" id="CmpRegimenComprobanteNumero" size="20" maxlength="50" value="<?php echo $InsBoleta->BolRegimenComprobanteNumero;?>"  /></td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>Regimen:</td>
                    <td colspan="3"><select class="EstFormularioCombo" name="CmpRegimenId" id="CmpRegimenId">
                      <option value="">Escoja una opcion</option>
                      <?php
			...
			?>
                  ...
                  <tr>
                    ...
                    <td colspan="3"><input  class="EstFormularioCaja" name="CmpRegimenMonto" type="text" id="CmpRegimenMonto" size="15" maxlength="10" value="<?php if (empty($InsBoleta->BolRegimenMonto)){ echo "";}else{ echo number_format($InsBoleta->BolRegimenMonto,2); } ?>" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td align="center"></td>
                    <td>&nbsp;</td>
