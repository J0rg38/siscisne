...
//$InsBoleta->MtdEditarBoletaDato("BolSunatUltimaAccion","BAJA",$InsBoleta->BolId,$InsBoleta->BtaId);
...
//deb($xml_values);
			...
			*/
			...
			$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaTicket",$TicketRespuesta,$InsBoleta->BolId,$InsBoleta->BtaId);
			$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaFecha",$FechaRespuesta,$InsBoleta->BolId,$InsBoleta->BtaId);
			$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaHora",$HoraRespuesta,$InsBoleta->BolId,$InsBoleta->BtaId);
			
			$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaCodigo",$CodigoRespueta,$InsBoleta->BolId,$InsBoleta->BtaId);
			$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaContenido",$MensajeRespuesta,$InsBoleta->BolId,$InsBoleta->BtaId);
			$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaTiempoCreacion",date("Y-m-d H:i:s"),$InsBoleta->BolId,$InsBoleta->BtaId);
