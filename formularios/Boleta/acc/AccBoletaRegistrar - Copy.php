...
//					}
		...
		?>
          <script type="text/javascript">
				...
				*/			
					...
					FncPopUp('formularios/Boleta/FrmBoletaGenerarXML.php?Id=<?php echo $InsBoleta->BolId;?>&Ta=<?php echo $InsBoleta->BtaId;?>&Procesar=<?php echo $InsBoleta->BolProcesar;?>&EnviarSUNAT=<?php echo $InsBoleta->BolEnviarSUNAT;?>&P=1',0,0,1,0,0,1,0,350,150);
	...
	$InsBoleta->BolNotificar = 1;
	$InsBoleta->BolProcesar = 0;
