...
//					$Codigo = $DatoAdicional->appendChild($Codigo);
//					
//					$Valor = $domtree->createElement("Valor",$InsBoleta->BolFechaVencimiento."*".$InsBoleta->EinVIN."*".$InsBoleta->EinPlaca."*".$InsBoleta->VmaNombre."*".$InsBoleta->VmoNombre."*".$InsBoleta->VveNombre."*".$InsBoleta->FinId."*".($InsBoleta->FinVehiculoKilometraje." ".(!empty($InsBoleta->FinVehiculoKilometraje)?'KM':''))."*".$InsBoleta->AmoId);
//					$Valor = $DatoAdicional->appendChild($Valor);
//				
//			}
//			
...
//	if(!empty($InsBoleta->CliNumeroDocumento)){
		...
		//cbc:AdditionalAccountID
		//$AdditionalAccountID = $domtree->createElement("cbc:AdditionalAccountID","1");
...
if(!empty($InsBoleta->BoletaDetalle)){
	foreach($InsBoleta->BoletaDetalle as $DatBoletaDetalle){
		...
		if($InsBoleta->MonId<>$EmpresaMonedaId){
			...
			$DatBoletaDetalle->BdeImpuesto = round($DatBoletaDetalle->BdeValorVenta/$InsBoleta->BolTipoCambio,2);
			...
			$Item = $InvoiceLine->appendChild($Item);	
					...
					$Description->appendChild($domtree->createCDATASection($DatBoletaDetalle->BdeDescripcion )); 
						...
						if(!empty($InsBoleta->BolDatoAdicional1)){
							...
							$Description->appendChild($domtree->createCDATASection("MARCA: ".$InsBoleta->BolDatoAdicional1 )); 
						...
						if(!empty($InsBoleta->BolDatoAdicional2)){	
							...
							$Description->appendChild($domtree->createCDATASection("TRACCION: ".$InsBoleta->BolDatoAdicional2 )); 
						...
						if(!empty($InsBoleta->BolDatoAdicional3)){	
							...
							$Description->appendChild($domtree->createCDATASection("MODELO: ".$InsBoleta->BolDatoAdicional3 )); 
						...
						if(!empty($InsBoleta->BolDatoAdicional4)){	
							...
							$Description->appendChild($domtree->createCDATASection("CARROCERIA: ".$InsBoleta->BolDatoAdicional4 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional5)){	
							...
							$Description->appendChild($domtree->createCDATASection("AÑO FABRIC.: ".$InsBoleta->BolDatoAdicional5 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional6)){	
							...
							$Description->appendChild($domtree->createCDATASection("NO. PUERTAS: ".$InsBoleta->BolDatoAdicional6 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional7)){	
							...
							$Description->appendChild($domtree->createCDATASection("NO. MOTOR: ".$InsBoleta->BolDatoAdicional7 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional8)){	
							...
							$Description->appendChild($domtree->createCDATASection("COMBUSTIBLE: ".$InsBoleta->BolDatoAdicional8 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional9)){	
							...
							$Description->appendChild($domtree->createCDATASection("NO. CILINDROS: ".$InsBoleta->BolDatoAdicional9 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional10)){	
							...
							$Description->appendChild($domtree->createCDATASection("PESO BRUTO: ".$InsBoleta->BolDatoAdicional10 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional11)){	
							...
							$Description->appendChild($domtree->createCDATASection("NO. EJES: ".$InsBoleta->BolDatoAdicional11 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional12)){	
							...
							$Description->appendChild($domtree->createCDATASection("CARGA UTIL: ".$InsBoleta->BolDatoAdicional12 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional13)){	
							...
							$Description->appendChild($domtree->createCDATASection("NO. CHASIS: ".$InsBoleta->BolDatoAdicional13 ));
						...
						//cbc:Description
							...
							$Description->appendChild($domtree->createCDATASection("PESO SECO: ".$InsBoleta->BolDatoAdicional14 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional15)){	
							...
							$Description->appendChild($domtree->createCDATASection("COLOR: ".$InsBoleta->BolDatoAdicional15 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional16)){	
							...
							$Description->appendChild($domtree->createCDATASection("ALTO: ".$InsBoleta->BolDatoAdicional16 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional17)){	
							...
							$Description->appendChild($domtree->createCDATASection("CILINDRADA: ".$InsBoleta->BolDatoAdicional17 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional18)){	
							...
							$Description->appendChild($domtree->createCDATASection("LARGO: ".$InsBoleta->BolDatoAdicional18 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional19)){	
							...
							$Description->appendChild($domtree->createCDATASection("NO. ASIENTOS: ".$InsBoleta->BolDatoAdicional19 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional20)){	
							...
							$Description->appendChild($domtree->createCDATASection("ANCHO: ".$InsBoleta->BolDatoAdicional20 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional21)){	
							...
							$Description->appendChild($domtree->createCDATASection("CAP. PASAJEROS: ".$InsBoleta->BolDatoAdicional21 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional122)){	
							...
							$Description->appendChild($domtree->createCDATASection("DIST. EJES: ".$InsBoleta->BolDatoAdicional122 ));
						...
						if(!empty($InsBoleta->BolDatoAdicional23)){	
							...
							$Description->appendChild($domtree->createCDATASection("NO. POLIZA: ".$InsBoleta->BolDatoAdicional23 ));
