...
$InsResumenBaja = new ClsResumenBaja();
$InsResumenBaja->BolId = $InsBoleta->BolId;
$InsResumenBaja->BtaId = $InsBoleta->BtaId;
...
//$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaId",$BajaNumeracion,$InsBoleta->BolId,$InsBoleta->BtaId);
