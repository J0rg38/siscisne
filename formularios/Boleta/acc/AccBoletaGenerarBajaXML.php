...
$InsBoleta->MtdGenerarBoletaBajaId();

$NOMBRE = $EmpresaCodigo."-RA-".date("Ymd")."-".$InsBoleta->BolSunatRespuestaBajaId;
$ARCHIVO = $NOMBRE.".xml";
$NOMBRE_INTERNO = "RA-".date("Ymd")."-".$InsBoleta->BolSunatRespuestaBajaId;
...
//cbc:ReferenceDate
$ReferenceDate = $domtree->createElement("cbc:ReferenceDate",FncCambiaFechaAMysql($InsBoleta->BolFechaEmision));
...
$AccountingSupplierParty = $xmlRoot->appendChild($AccountingSupplierParty);
	...
	$Party = $AccountingSupplierParty->appendChild($Party);
		...
		$VoidedDocumentsLine = $xmlRoot->appendChild($VoidedDocumentsLine);	
			...
			$DocumentSerialID = $domtree->createElement("sac:DocumentSerialID",$InsBoleta->BtaNumero);
			$DocumentSerialID = $VoidedDocumentsLine->appendChild($DocumentSerialID);	
			
			//cbc:DocumentNumberID
			$DocumentNumberID = $domtree->createElement("sac:DocumentNumberID",$InsBoleta->BolId);
...
$InsBoleta->MtdEditarBoletaDato("BolSunatRespuestaBajaId",$InsBoleta->BolSunatRespuestaBajaId,$InsBoleta->BolId,$InsBoleta->BtaId);
