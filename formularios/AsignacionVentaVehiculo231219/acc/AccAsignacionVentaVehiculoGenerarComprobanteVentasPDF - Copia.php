...
require_once($InsProyecto->MtdRutLibrerias().'FPDI-1.5.1/fpdi.php');
...
$ResAsignacionVentaVehiculo = $InsAsignacionVentaVehiculo->MtdObtenerAsignacionVentaVehiculos(NULL,NULL,NULL,"AvvFecha","ASC",NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),3,NULL);
$ArrAsignacionVentaVehiculos = $ResAsignacionVentaVehiculo['Datos'];

//
//
//$ResFactura = $InsFactura->MtdObtenerFacturas(NULL,NULL,NULL,$POST_ord,$POST_sen,$POST_pag,$_SESSION['SesionSucursal'],$POST_estado,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_tal,NULL,NULL,$POST_npago,NULL,$POST_Moneda,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,$POST_Sucursal);
...
//$ResBoleta = $InsBoleta->MtdObtenerBoletas(NULL,NULL,NULL,$POST_ord,$POST_sen,$POST_pag,$POST_estado,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_tal,NULL,$POST_npago,$POST_Moneda,NULL,NULL,NULL,NULL,NULL,$POST_Sucursal);
//$ArrBoletas = $ResBoleta['Datos'];

$NOMBRE_GENERAL = 'PDF_COMPROBATES_VENTA_'.FncCambiaFechaAMysql($POST_FechaInicio).'_al_'.FncCambiaFechaAMysql($POST_FechaFin);
...
//		
////		echo "BolId:".$DatAsignacionVentaVehiculo->BolId;;
////		echo "<br>";
////		echo "BtaId:".$DatAsignacionVentaVehiculo->BtaId;;
////		echo "<br>";
////		echo "<br>";
//		
...
//				$pdf->Cell(60,3,"Sistema de Facturacion Electrónica",$lineas,1,'C',0,0);
//				
//				$pdf->Ln(2);
//				$pdf->SetLeftMargin(10);
//				
...
//				$pdf->Cell(170,3,"Esta es una representación impresa de la Factura electrónica, Puede verificarlo utilizando su clave SOL en www.sunat.gob.pe",0,1,'C',0,0);
//					
...
if(!empty($ArrAsignacionVentaVehiculos)){
	foreach($ArrAsignacionVentaVehiculos as $DatAsignacionVentaVehiculo){
		...
		if($DatAsignacionVentaVehiculo->AvvCancelado == "Si" || $POST_C == "1"){
			...
			if(!empty($DatAsignacionVentaVehiculo->BolId) and !empty($DatAsignacionVentaVehiculo->BtaId)){
				...
				$pdfi->addPage();
				$pdfi->setSourceFile('../../../generados/comprobantes_pdf/'. $NOMBRE.'.pdf');
				$pageid = $pdfi->importPage(1);
				$pdfi->useTemplate($pageid, 0, 0);	
...
$pdfi->SetDisplayMode('fullpage', 'single');
$pdfi->Output("");
