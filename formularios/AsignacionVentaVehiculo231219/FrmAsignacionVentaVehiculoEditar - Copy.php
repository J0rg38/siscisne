...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
			...
			?>
               ...
               <td align="left" valign="top"><input class="EstFormularioCaja" name="VehiculoIngresoColor" type="text" id="VehiculoIngresoColor" value="<?php echo ($InsAsignacionVentaVehiculo->EinColor);?>" size="8" maxlength="30" /></td>
               <td align="left" valign="top"><input name="CmpVehiculoIngresoAnoFabricacion" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoAnoFabricacion" value="<?php echo ($InsAsignacionVentaVehiculo->EinAnoFabricacion);?>" size="8" maxlength="4" readonly="readonly" /></td>
