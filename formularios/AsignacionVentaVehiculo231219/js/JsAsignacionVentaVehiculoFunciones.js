...
function FncCargarVehiculoInstalar(){
	...
	if(VehiculoIngresoId!=""){
		...
		tb_show("INSTALACIONES DE ACCESORIOS",'formularios/VehiculoIngreso/DiaVehiculoIngresoVehiculoInstalar.php?EinId='+VehiculoIngresoId+'&placeValuesBeforeTB_=savedValues&width='+Ancho+'&heigth='+Alto+'',this.rel);	
				
	}else{
		
		alert("No ha ingresado un VIN");
	}
...
function FncCargarVehiculoIngresoEvento(){
	...
	if(VehiculoIngresoId!=""){
		...
		tb_show("INCIDENTES",'formularios/VehiculoIngreso/DiaVehiculoIngresoVehiculoEvento.php?EinId='+VehiculoIngresoId+'&placeValuesBeforeTB_=savedValues&width='+Ancho+'&heigth='+Alto+'',this.rel);	
