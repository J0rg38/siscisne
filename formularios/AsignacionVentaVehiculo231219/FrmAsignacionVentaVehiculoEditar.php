           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             <tr>
               ...
               <td colspan="11"><span class="EstFormularioSubTitulo">Datos del Vehiculo 
                 ...
                 <input name="CmpVehiculoIngresoIdAnterior" type="hidden" id="CmpVehiculoIngresoIdAnterior" value="<?php echo $InsAsignacionVentaVehiculo->EinIdAnterior;?>" size="3" />
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
			...
			?>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="7" align="left"><a id="BtnVehiculoInstalar" href="javascript:FncCargarVehiculoInstalar();"><img src="imagenes/iconos/vehiculo_instalar.png" width="25" height="25" border="0" align="absmiddle"  /> Accesorios</a> <!--<span>(0)</span>
-->
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea">
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="1%">&nbsp;</td>
               <td width="49%"><span class="EstFormularioSubTitulo">Disponibilidad/Lista de Precios</span></td>
