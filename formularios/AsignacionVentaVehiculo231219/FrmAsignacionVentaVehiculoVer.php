...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccAsignacionVentaVehiculoEditar.php');
...
var AsignacionVentaVehiculoDetalleEditar = 2;
...
var AsignacionVentaVehiculoPropietarioEditar = 2;
var AsignacionVentaVehiculoPropietarioEliminar = 2;
 ...
 <div class="tab_container">
    <div id="tab1" class="tab_content">
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td>Creado el:</td>
            <td><span class="EstFormularioDatoRegistro"><?php echo $InsAsignacionVentaVehiculo->AvvTiempoCreacion;?></span></td>
            <td>&nbsp;</td>
            <td>Modificado el</td>
            <td><span class="EstFormularioDatoRegistro"><?php echo $InsAsignacionVentaVehiculo->AvvTiempoModificacion;?></span></td>
          </tr>
        </table>
         ...
         <td valign="top"><div class="EstFormularioArea">
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if(empty($InsAsignacionVentaVehiculo->AvvFecha)){ echo date("d/m/Y");}else{ echo $InsAsignacionVentaVehiculo->AvvFecha; }?>" size="15" maxlength="10" readonly="readonly" /></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><textarea name="CmpObservacion" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsAsignacionVentaVehiculo->AvvObservacion;?></textarea></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
               <td>&nbsp;</td>
               </tr>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td>&nbsp;</td>
               <td colspan="2"><span class="EstFormularioSubTitulo">PROPIETARIOS 
             ...
             <tr>
               <td width="1%">&nbsp;</td>
               <td width="48%"><div class="EstFormularioAccion" id="CapAsignacionVentaVehiculoPropietarioAccion">Listo
                 para registrar elementos</div></td>
               <td width="50%" align="right"><a href="javascript:FncAsignacionVentaVehiculoPropietarioListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncAsignacionVentaVehiculoPropietarioEliminarTodo();"></a></td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               <td align="left" valign="top"><a href="javascript:FncAsignacionVentaVehiculoDetalleNuevo();"></a></td>
               <td align="left" valign="top"><input name="CmpVehiculoIngresoVIN" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoVIN" value="<?php echo ($InsAsignacionVentaVehiculo->EinVIN);?>" size="20" maxlength="30" readonly="readonly" /></td>
			...
			?>
               ...
               <td align="left" valign="top"><input name="CmpVehiculoIngresoColor" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoColor" value="<?php echo ($InsAsignacionVentaVehiculo->EinColor);?>" size="8" maxlength="30" readonly="readonly" /></td>
               <td align="left" valign="top"><input name="CmpOrdenVentaVehiculoAnoFabricacion" type="text" class="EstFormularioCaja" id="CmpOrdenVentaVehiculoAnoFabricacion" value="<?php echo ($InsAsignacionVentaVehiculo->EinAnoFabricacion);?>" size="8" maxlength="4" readonly="readonly" /></td>
               <td align="left" valign="top"><input name="CmpOrdenVentaVehiculoAnoModelo" type="text" class="EstFormularioCaja" id="CmpOrdenVentaVehiculoAnoModelo" value="<?php echo ($InsAsignacionVentaVehiculo->EinAnoModelo);?>" size="8" maxlength="4" readonly="readonly" /></td>
               <td align="left" valign="top">&nbsp;</td>
               </tr>
             <tr>
               <td>&nbsp;</td>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="4" align="left"><a id="BtnVehiculoInstalar" href="javascript:FncCargarVehiculoInstalar();"><img src="imagenes/iconos/vehiculo_instalar.png" alt="" width="25" height="25" border="0"  align="absmiddle" /> Accesorios</a>
                 <!--<span>(0)</span>
-->
                 <a id="BtnVehiculoIngresoEvento" href="javascript:FncCargarVehiculoIngresoEvento();"><img src="imagenes/iconos/vehiculo_eventos.png" alt="" width="25" height="25" border="0" align="absmiddle"  /> Incidentes</a>
                 <!--<span>(0)</span>--></td>
               <td align="left" valign="top"><input name="CmpPrecio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPrecio" value="<?php echo number_format($InsAsignacionVentaVehiculo->OvvPrecio,2);?>" size="8" maxlength="10" readonly="readonly" /></td>
