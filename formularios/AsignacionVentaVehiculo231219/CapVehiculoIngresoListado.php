...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos(NULL,NULL,NULL,"EinAnoFabricacion","ASC",NULL,NULL,NULL,NULL,"STOCK",$POST_VehiculoMarca,$POST_VehiculoModelo,$POST_VehiculoVersion,$POST_AnoModelo,NULL,$POST_Color,NULL,"EinFechaRecepcion",NULL,NULL,$POST_Sucursal);
...
<table class="EstTablaListado" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <th width="1%">#</th>
        <th width="4%">Id</th>
        <th width="5%">Num. Proforma</th>
        <th width="5%">Año/Mes Proforma</th>
        <th width="4%">VIN</th>
        <th width="4%">Marca</th>
        <th width="6%">Modelo</th>
        <th width="4%">Version</th>
        <th width="4%">Año Fab. </th>
        <th width="4%">Año Mod.</th>
      <th width="4%">Num. Motor</th>
        <th width="6%"> Color </th>
      <th width="6%">Dias Inmov.</th>
    ...
    <td align="right">-</td>
    <td align="center"><?php echo $DatVehiculoListaPrecioDetalle->VldAnoModelo;?></td>
    <td colspan="5" align="center">A PEDIDO</td>
  ...
  <input type="radio" name="RbuVehiculoIngreso" id="RbuVehiculoIngreso_<?php echo $c;?>" value="<?php echo $c;?>" onclick="FncVehiculoIngresoListadoEscoger('<?php echo $c;?>','<?php echo $DatVehiculoListaPrecioDetalle->VveId;?>','<?php echo $DatVehiculoListaPrecioDetalle->VldPrecioLista;?>','<?php echo $DatVehiculoListaPrecioDetalle->VldPrecioCierre;?>','','','');"> Seleccionar 
...
<!--Se encontraron <?php echo $SesionObjetosTotalSeleccionado;?> elemento(s)-->
    ...
    <tr>
        ...
        <th width="4%">Año Fab. </th>
        <th width="4%">Año Mod.</th>
        <th width="5%">Num. Motor</th>
        <th width="6%"> Color
        </th>
        <th width="6%">Dias Inmov.</th>
        <th width="7%">Estado</th>
        <th width="7%">Ubicacion</th>
        <th width="8%">Precio Lista</th>
        <th width="5%">Precio Cierre</th>
        <th width="6%">Descuento Gerencia</th>
        <th width="10%"> Acc.</th>
    </tr>
    </thead>
    <tbody class="EstTablaListadoBody">
  ...
  <?php
			switch($DatVehiculoIngreso->EinObservado){
				case 1:
			?>
    ...
    <td align="right"><?php echo $DatVehiculoIngreso->EinNumeroMotor;?></td>
    <td align="right">
    
      <?php echo $DatVehiculoIngreso->EinColor;?>
    
    </td>
    <td align="right"><?php echo $DatVehiculoIngreso->EinDiasInmovilizados;?></td>
    <td align="right"><?php echo $DatVehiculoIngreso->EinEstadoVehicular;?></td>  
    <td align="right">
    ...
    <td align="center">
      ...
      <input type="radio" name="RbuVehiculoIngreso" id="RbuVehiculoIngreso_<?php echo $c;?>" value="<?php echo $c;?>" onclick="FncVehiculoIngresoListadoEscoger('<?php echo $c;?>','<?php echo $DatVehiculoIngreso->VveId;?>','<?php echo $VehiculoListaPrecioDetallePrecioLista;?>','<?php echo $VehiculoListaPrecioDetallePrecioCierre;?>','<?php echo $DatVehiculoIngreso->EinColor;?>','<?php echo $DatVehiculoIngreso->EinId;?>','<?php echo $DatVehiculoIngreso->EinAnoModelo;?>','<?php echo $DatVehiculoIngreso->EinVIN;?>','<?php echo $DatVehiculoIngreso->EinDescuentoGerencia;?>','<?php echo $DatVehiculoIngreso->EinAnoFabricacion;?>','<?php echo $DatVehiculoIngreso->EinNumeroMotor;?>');"> Seleccionar 
