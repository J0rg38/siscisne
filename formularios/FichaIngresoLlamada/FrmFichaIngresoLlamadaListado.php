...
$ResCliente = $InsCliente->MtdObtenerClientes("CliNombreCompleto,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,CliId",$POST_con,$POST_fil,$POST_ord,$POST_sen,1,$POST_pag,$POST_est,NULL,NULL,$POST_Clasificacion);
      ...
      <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "CliTiempoModificacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CliTiempoModificacion','ASC');"> U.A. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CliTiempoModificacion','DESC');"> U.A. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
