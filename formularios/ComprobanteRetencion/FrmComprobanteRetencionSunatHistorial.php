...
<tr>
  <td>Ultima Accion</td>
  <td>:</td>
  <td><?php echo $InsComprobanteRetencion->CrnSunatUltimaAccion;?></td>
</tr>
<tr>
  <td>Ultima Respuesta</td>
  <td>:</td>
  <td><?php echo $InsComprobanteRetencion->CrnSunatUltimaRespuesta ?></td>
</tr>
<tr>
...
<tr>
  <td>Ticket Envio</td>
  <td>:</td>
  <td><?php echo $InsComprobanteRetencion->CrnSunatRespuestaEnvioTicket ?></td>
</tr>
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsComprobanteRetencion->CrnSunatRespuestaEnvioCodigo ?> - <?php echo $InsComprobanteRetencion->CrnSunatRespuestaEnvioContenido ?></td>
</tr>
<tr>
...
<tr>
  ...
  <td>:</td>
  <td><?php echo $InsComprobanteRetencion->CrnSunatRespuestaBajaTicket ?></td>
</tr>
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsComprobanteRetencion->CrnSunatRespuestaBajaCodigo; ?> - <?php echo $InsComprobanteRetencion->CrnSunatRespuestaBajaContenido; ?></td>
</tr>
<tr>
...
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsComprobanteRetencion->CrnSunatRespuestaConsultaCodigo; ?> - <?php echo $InsComprobanteRetencion->CrnSunatRespuestaConsultaContenido; ?></td>
</tr>
<tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
