...
if(empty($POST_ord)){
	$POST_ord = 'CrnTiempoModificacion';
}
...
$ResComprobanteRetencion = $InsComprobanteRetencion->MtdObtenerComprobanteRetenciones($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,1,$POST_pag,$_SESSION['SisSucId'],$POST_estado,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_tal,NULL,NULL,$POST_npago,NULL,$POST_Moneda);
...
<link href="css/CssComprobanteRetencion<?php echo $EmpresaAlias;?>.css" rel="stylesheet" type="text/css" />
...
<tr>
  ...
  <td width="54%" align="center" valign="top"><span class="EstReporteTitulo">LISTADO DE COMPROBANTE DE RETENCIONES
    <?php
            ...
            <?php
              ...
              Anulado           
                ...
                <td  width="9%" align="right" >
                  ...
                  <?php echo ($dat->CrnVenta); ?>                 </td>
                <td  width="9%" align="right" >
                
                  <?php echo ($dat->CrnNotaEntrega); ?>              </td>
                <td  width="9%" align="right" ><?php echo ($dat->CrnNotaCredito); ?></td>
...
<?php	
				...
				?></td>
                <td  width="9%" align="right" ><?php echo number_format($dat->CrnSubTotal,2)  ; ?>                </td>
                <td  width="9%" align="right" ><?php echo number_format($dat->CrnImpuesto,2)  ; ?>				</td>
                <td  width="8%" align="right" ><?php echo number_format($dat->CrnTotal,2)  ; ?></td>
                <td  width="8%" align="right" ><?php echo ($dat->RegNombre);?></td>
                <td  width="8%" align="right" ><?php echo number_format($dat->CrnRegimenMonto,2);?></td>
                <td  width="8%" align="right" ><?php
				switch($dat->CrnOrdenTipo){
					case 1:
				?>
Orden de Servicio
  <?php	
...
<?php
				...
				?></td>
                <td  width="8%" align="right" ><?php echo ($dat->CrnOrdenNumero);?></td>
                <td  width="8%" align="right" ><?php echo ($dat->CrnOrdenFecha);?></td>
                <td  width="8%" align="right" ><?php echo ($dat->CrnSIAFNumero);?></td>
              </tr>
