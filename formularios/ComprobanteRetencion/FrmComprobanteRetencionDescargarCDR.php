...
<title>DESCARGAR ARCHIVO CDR</title>
...
$().ready(function() {
	...
	$('#CapComprobanteRetencionAccion').html('Conectando con SERVIDOR para descargar archivo cdr...');	
	
	setTimeout("FncComprobanteRetencionDescargarCDR('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncComprobanteRetencionDescargarCDR(oArchivo,oUrl){
	
	document.location.href = '../../modulos/descarga/ForzarDescargaCDR.php?Nombre='+oArchivo+'&Ruta='+oUrl;
