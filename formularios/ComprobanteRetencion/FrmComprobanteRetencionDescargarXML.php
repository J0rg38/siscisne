...
<title>DESCARGAR ARCHIVO XML</title>
...
$().ready(function() {
	...
	$('#CapComprobanteRetencionAccion').html('Conectando con SERVIDOR para descargar archivo xml...');	
	
	setTimeout("FncComprobanteRetencionDescargarXML('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncComprobanteRetencionDescargarXML(oArchivo,oUrl){
	
	document.location.href = '../../modulos/descarga/ForzarDescargaXML.php?Nombre='+oArchivo+'&Ruta='+oUrl;
