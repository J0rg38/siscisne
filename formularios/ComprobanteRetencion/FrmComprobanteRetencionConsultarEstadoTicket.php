...
//deb($InsComprobanteRetencion->CrnSunatRespuestaTicket);
?>
...
$().ready(function() {
	...
	$('#CapComprobanteRetencionAccion').html('Conectando con SUNAT para consultar estado de ticket...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccComprobanteRetencionConsultarEstadoTicket.php',
		data: 'Id=<?php echo $InsComprobanteRetencion->CrnId;?>&Ta=<?php echo $InsComprobanteRetencion->CrtId;?>&Ticket=<?php echo $InsComprobanteRetencion->CrnSunatRespuestaTicket;?>',
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "C101":
					...
					$('#CapComprobanteRetencionAccion').html('Consulta de estado de ticket procesado correctamente. '+respuesta['MensajeRespuesta']);				
				...
				default:
					$('#CapComprobanteRetencionAccion').html('Ha ocurrido un error consultando el estado del ticket, proceso cancelado.');
