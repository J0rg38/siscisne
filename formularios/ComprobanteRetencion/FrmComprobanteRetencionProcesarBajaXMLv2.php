...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccComprobanteRetencionProcesarBajaXMLv2.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "B101":
					...
					$('#CapComprobanteRetencionAccion').html('Archivo xml de baja procesado correctamente. '+respuesta['MensajeRespuesta']);				
				...
				default:
					...
					$('#CapComprobanteRetencionAccion').html('Ha ocurrido un error procesando el archivo xml de baja, proceso cancelado.');
					//setTimeout("window.close();",2500);
