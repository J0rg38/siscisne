...
$_SESSION['InsComprobanteRetencionDetalle'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsComprobanteRetencionDetalle1->Parametro1,
$POST_TipoDocumento ,
NULL,
$POST_Retenido,
$POST_Pagado,
$POST_Total,
$InsComprobanteRetencionDetalle1->Parametro7,
date("d/m/Y H:i:s"),
$POST_Serie,
$POST_Numero,
