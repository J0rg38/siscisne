...
if (!empty($_FILES)) {
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg"){
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesCrnOrdenFoto'.$Identificador] = $file_name;
...
}elseif(!empty($_SESSION['SesCrnOrdenFoto'.$Identificador])){
	
	$extension = strtolower(pathinfo($_SESSION['SesCrnOrdenFoto'.$Identificador], PATHINFO_EXTENSION));
	$nombre_base = basename($_SESSION['SesCrnOrdenFoto'.$Identificador], '.'.$extension);  
?>
