...
$InsComprobanteRetencion->MtdObtenerComprobanteRetencion(false);

//deb($InsComprobanteRetencion);

$NOMBRE = 'R-'.$EmpresaCodigo.'-01-'.$InsComprobanteRetencion->CrtNumero.'-'.$InsComprobanteRetencion->CrnId;
//$ARCHIVO = $NOMBRE.'.xml';
?>
...
$().ready(function() {
	...
	$('#CapComprobanteRetencionAccion').html('Conectando con GMAIL para enviar correo electronico...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccComprobanteRetencionEnviarCorreo.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "1":
					...
					$('#CapComprobanteRetencionAccion').html('Correo electronico enviado correctamente. '+respuesta['MensajeRespuesta']);	
				...
				case "2":
					...
					$('#CapComprobanteRetencionAccion').html('No se encontro direccion de correo electronico a enviar. '+respuesta['MensajeRespuesta']);						
				
				break;
				
				default:
				
					$('#CapComprobanteRetencionAccion').html('Ha ocurrido un error enviando el correo electronico, proceso cancelado.');
		...
		error: function(respuesta){
			...
			$('#CapComprobanteRetencionAccion').html('Ha ocurrido un error interno.');
...
<div id="CapComprobanteRetencionRespuesta"></div>
</body>
</html>
