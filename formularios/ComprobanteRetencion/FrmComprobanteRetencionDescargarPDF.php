...
$().ready(function() {
	...
	$('#CapComprobanteRetencionAccion').html('Conectando con SERVIDOR para descargar archivo pdf...');	
	
	setTimeout("FncComprobanteRetencionDescargarPDF('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncComprobanteRetencionDescargarPDF(oArchivo,oUrl){
