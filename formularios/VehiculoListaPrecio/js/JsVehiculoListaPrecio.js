...
function FncBuscar(){
	...
	$("#Ord").val("");
	$("#Sen").val("");
	tree.saveOpenStates("CooVehiculoListaPrecioCategoria");
	$("#FrmListado").submit();
}
...
function FncGenerarExcel(){
	...
	document.getElementById("FrmListado").action = "formularios/VehiculoListaPrecio/acc/AccVehiculoListaPrecioGenerarExcel.php"
...
function FncImprmir(oId){
	...
	FncPopUp('formularios/VehiculoListaPrecio/FrmVehiculoListaPrecioImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
...
function FncVistaPreliminar(oId){
	...
	FncPopUp('formularios/VehiculoListaPrecio/FrmVehiculoListaPrecioImprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
