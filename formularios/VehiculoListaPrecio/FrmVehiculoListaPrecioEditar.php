...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">EDITAR LISTA DE PRECIO DE VEHICULO</span></td>
      </tr>
      <tr>
        <td>
             ...
             <tr>
               <td width="98%"><table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                 <tr>
                   ...
                   <td width="20"><span class="EstFormularioSubTitulo">
                 ...
                 <tr>
                   <td height="26"><a href="javascript:FncVehiculoListaPrecioDetalleNuevo();"> <img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /> </a></td>
                   ...
                   <td><input name="CmpVehiculoListaPrecioDetalleFuente" type="text" class="EstFormularioCaja" id="CmpVehiculoListaPrecioDetalleFuente" size="15" maxlength="45"  /></td>
                   <td><input name="CmpVehiculoListaPrecioDetalleCosto" type="text" class="EstFormularioCaja" id="CmpVehiculoListaPrecioDetalleCosto" size="10" maxlength="45"  /></td>
                   <td><input name="CmpVehiculoListaPrecioDetallePrecioCierre" type="text" class="EstFormularioCaja" id="CmpVehiculoListaPrecioDetallePrecioCierre" size="10" maxlength="45"  /></td>
                   <td><input name="CmpVehiculoListaPrecioDetallePrecioLista" type="text" class="EstFormularioCaja" id="CmpVehiculoListaPrecioDetallePrecioLista" size="10" maxlength="45"  /></td>
         ...
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               ...
               <td width="49%" align="right"><a href="javascript:FncVehiculoListaPrecioDetalleListar();"> <img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncVehiculoListaPrecioDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a></td>
