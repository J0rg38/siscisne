...
$InsVehiculoVersion->MtdObtenerVehiculoVersion(false);
	...
	$InsVehiculoListaPrecioDetalle1 = array();
	$InsVehiculoListaPrecioDetalle1 = $_SESSION['InsVehiculoListaPrecioDetalle'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
	
	
	$_SESSION['InsVehiculoListaPrecioDetalle'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
	$InsVehiculoListaPrecioDetalle1->Parametro1,
	NULL,
	...
	$InsVehiculoListaPrecioDetalle1->Parametro7,
	date("d/m/Y H:i:s"),
