...
if(empty($POST_ord)){
	...
	$POST_ord = ' IFNULL(ovv.OvvActaEntregaFecha,ovv.OvvActaEntregaFechaPDS) ';
...
require_once($InsPoo->MtdPaqReporte().'ClsReporteAsignacionVentaVehiculo.php');
...
//$ResAsignacionVentaVehiculo = $InsAsignacionVentaVehiculo->MtdObtenerAsignacionVentaVehiculos("AvvId,EinVIN,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNombreCompleto,vma.VmaNombre,vmo.VmoNombre,vve.VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_estado,NULL,true,"ovv.OvvActaEntregaFecha");

///MtdObtenerAsignacionVentaVehiculoEntregas($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'AvvId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oOrdenVentaVehiculo=NULL,$oSucursal=NULL)
//$ResAsignacionVentaVehiculo = $InsReporteAsignacionVentaVehiculo->MtdObtenerAsignacionVentaVehiculoEntregas("AvvId,EinVIN,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNombreCompleto,vma.VmaNombre,vmo.VmoNombre,vve.VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),3,NULL,$POST_Sucursal);
$ResAsignacionVentaVehiculo = $InsReporteAsignacionVentaVehiculo->MtdObtenerAsignacionVentaVehiculoEntregas(NULL,NULL,NULL,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),3,NULL,$POST_Sucursal);
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <?php
				if(($dat->OvvActaEntregaFechaDirecto==1)){
				?>
				*
				<?php	
				}
