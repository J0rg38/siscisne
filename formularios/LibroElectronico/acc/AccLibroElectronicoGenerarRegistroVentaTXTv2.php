...
foreach ($ArrFacturas as $DatFactura) {
	...
	$libro .= $POST_Ano . $POST_Mes . "00" .
		"|02" .
		"|M" . $c .
		"|" . $DatFactura->FacFechaEmision .
		"|" . (($DatFactura->FacFechaVencimiento)) .

		"|01" .
		"|" . $DatFactura->FtaNumero .
		"|" . $DatFactura->FacId .
		"|" .
		"|" . $DatFactura->TdoCodigo .

		"|" . $DatFactura->CliNumeroDocumento .
		"|" . $Cliente .
		"|0.00" .
		"|" . ($DatFactura->FacSubTotal) .
		"|" . ($DatFactura->FacTotalDescuento) .

		"|" . ($DatFactura->FacImpuesto) .
		"|0.00" .
		"|" . ($DatFactura->FacTotalExonerado) .
		"|0.00" .
		"|0.00" .
...
foreach ($ArrBoletas as $DatBoleta) {
	...
	$libro .= $POST_Ano . $POST_Mes . "00" .
		"|02" .
		"|M" . $c .
		"|" . $DatBoleta->BolFechaEmision .
		"|" . (($DatBoleta->BolFechaVencimiento)) .
		...
		"|" . $DatBoleta->CliNumeroDocumento .
		"|" . $Cliente .
		"|0.00" .
		"|" . ($DatBoleta->BolSubTotal) .
		"|" . ($DatBoleta->BolTotalDescuento) .

		"|" . ($DatBoleta->BolImpuesto) .
		"|0.00" .
		"|" . ($DatBoleta->BolTotalExonerado) .
		"|0.00" .
		"|0.00" .
		...
		"|0.00" .
		"|0.00" .
		"|" . $DatBoleta->BolTotalPagar .

		"|" . $DatBoleta->MonSigla .
		"|" . $DatBoleta->BolTipoCambio .
		"|01/01/0001" .
		"|00" .
		"|-" .
...
foreach ($ArrNotaCreditos as $DatNotaCredito) {
	...
	$libro .= $POST_Ano . $POST_Mes . "00" . "|" .
		"02" .
		"|M" . $c .
		"|" . $DatNotaCredito->NcrFechaEmision .
		"|" . $DatNotaCredito->NcrFechaVencimiento .

		"|07" .
		"|" . $DatNotaCredito->NctNumero .
		"|" . $DatNotaCredito->NcrId .
		"|" .
		"|" . $DatNotaCredito->TdoCodigo .

		"|" . $DatNotaCredito->CliNumeroDocumento .
		"|" . $Cliente .
		"|0.00" .
		"|" . ($DatNotaCredito->NcrSubTotal) .
		"|" . ($DatNotaCredito->NcrTotalDescuento) .

		"|" . ($DatNotaCredito->NcrImpuesto) .
		"|0.00" .
		"|" . ($DatNotaCredito->NcrTotalExonerado) .
		"|0.00" .
		"|0.00" .
		...
		"|0.00" .
		"|0.00" .
		"|" . $DatNotaCredito->NcrTotalPagar .

		"|" . $DatNotaCredito->MonSigla .
		"|" . $DatNotaCredito->NcrTipoCambio .
		"|" . $DatNotaCredito->DocFechaEmision .
		"|" . $DatNotaCredito->DocTipoDocumentoCodigo .
		"|" . $DatNotaCredito->DtaNumero .

		"|" . $DatNotaCredito->DocId . "|" .
		"|" .
		"|" .
		"|1" .
		"|1" .
...
foreach ($ArrNotaDebitos as $DatNotaDebito) {
	...
	$libro .= $POST_Ano . $POST_Mes . "00" .
		"|02" .
		"|M" . $c .
		"|" . $DatNotaDebito->NdbFechaEmision .
		"|" . $DatNotaDebito->NdbFechaVencimiento .

		"|08" .
		"|" . $DatNotaDebito->NctNumero .
		"|" . $DatNotaDebito->NdbId .
		"|" .
		"|" . $DatNotaDebito->TdoCodigo .

		"|" . $DatNotaDebito->CliNumeroDocumento .
		"|" . $Cliente .
		"|0.00" .
		"|" . ($DatNotaDebito->NdbSubTotal) .
		"|" . ($DatNotaDebito->NdbTotalDescuento) .

		"|" . ($DatNotaDebito->NdbImpuesto) .
		"|0.00" .
		"|" . ($DatNotaDebito->NdbTotalExonerado) .
		"|0.00" .
		"|0.00" .
		...
		"|0.00" .
		"|0.00" .
		"|" . $DatNotaDebito->NdbTotalPagar .

		"|" . $DatNotaDebito->MonSigla .
		"|" . $DatNotaDebito->NdbTipoCambio .
		"|" . $DatNotaDebito->DocFechaEmision .
		"|" . $DatNotaDebito->DocTipoDocumentoCodigo .
		"|" . $DatNotaDebito->DtaNumero .
