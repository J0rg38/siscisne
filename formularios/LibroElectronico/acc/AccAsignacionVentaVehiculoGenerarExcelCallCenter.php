...
?>
  ...
  <?php		 
				 ...
				 ?></td>
                <td  width="2%" align="right" ><?php echo ($dat->CliTelefono);?></td>
                <td  width="2%" align="right" ><?php echo ($dat->CliCelular);?></td>
                <td  width="2%" align="right" ><?php echo ($dat->CliEmail);?></td>
