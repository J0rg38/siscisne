                      ...
                      <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          ...
                          <td><span id="sprytextfield7">
                            ...
                            <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                          <td>&nbsp;</td>
                          <td rowspan="20" align="left" valign="top"><iframe src="formularios/Socio/acc/AccSocioSubirArchivo.php" id="IfrSocioSubirArchivo" name="IfrSocioSubirArchivo" scrolling="Auto"  frameborder="0" width="400" height="500"></iframe></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
