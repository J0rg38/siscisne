...
if (!empty($_FILES)) {
	...
	$targetPath = '../../../subidos/socio_fotos/';
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg"){
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesSocFoto'] = $file_name;
			
			$mythumb = new thumb();
			$mythumb->loadImage('../../../subidos/socio_fotos/'.$file_name);
			$mythumb->crop(100, 100,'bottom');
			$mythumb->save('../../../subidos/socio_fotos/'.$nombre_base.'_thumb.'.$extension, 100);
			
			$mythumb = new thumb();
			$mythumb->loadImage('../../../subidos/socio_fotos/'.$file_name);
			$mythumb->crop(20, 20,'bottom');
			$mythumb->save('../../../subidos/socio_fotos/'.$nombre_base.'_thumb2.'.$extension, 20);
...
}elseif(!empty($_SESSION['SesSocFoto'])){
