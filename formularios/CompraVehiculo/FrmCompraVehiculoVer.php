         ...
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               ...
               <td align="right"><a href="javascript:FncCompraVehiculoDetalleListar();">
		  ...
		  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top">Moneda:
		        <input name="CmpTipoCambio" type="hidden"  class="EstFormularioCaja" id="CmpTipoCambio" onchange="FncCompraVehiculoDetalleListar();" value="<?php if (empty($InsCompraVehiculo->CvhTipoCambio)){ echo "";}else{ echo $InsCompraVehiculo->CvhTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
		      <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
		        <tr>
		      ...
		      <td align="left" valign="top"><input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncCompraVehiculoDetalleListar();" value="<?php if (empty($InsCompraVehiculo->CvhTipoCambio)){ echo "";}else{ echo $InsCompraVehiculo->CvhTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" />
