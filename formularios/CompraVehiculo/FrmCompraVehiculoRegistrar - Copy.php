...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccCompraVehiculoRegistrar.php');
...
<input name="CmpVehiculoUnidadMedidaEquivalente"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoUnidadMedidaEquivalente" size="3" maxlength="20"  />
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td valign="middle"><a href="javascript:FncVehiculoIngresoNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                            ...
                            <td align="left" valign="middle"><select class="EstFormularioCombo" name="CmpVehiculoMarca" id="CmpVehiculoMarca" disabled="disabled" >
                              <option value="">Escoja una opcion</option>
                              <?php
			...
			?>
                            ...
                            <td align="left" valign="middle"><select class="EstFormularioCombo" name="CmpVehiculoModelo" id="CmpVehiculoModelo"  disabled="disabled">
                            </select></td>
                            <td align="left" valign="middle"><select class="EstFormularioCombo" name="CmpVehiculoVersion" id="CmpVehiculoVersion"  disabled="disabled">
                            </select></td>
                            <td valign="middle"><input class="EstFormularioCajaDeshabilitada" name="CmpVehiculoColor" type="text" id="CmpVehiculoColor" size="8" maxlength="30" /></td>
                            <td valign="middle"><input class="EstFormularioCajaDeshabilitada" name="CmpVehiculoColorInterior" type="text" id="CmpVehiculoColorInterior" size="8" maxlength="30" /></td>
                            <td align="left" valign="middle"><input class="EstFormularioCajaDeshabilitada" name="CmpAnoFabricacion" type="text" id="CmpAnoFabricacion" size="7" maxlength="4" /></td>
                            <td align="left" valign="middle"><input class="EstFormularioCajaDeshabilitada" name="CmpAnoModelo" type="text" id="CmpAnoModelo" size="7" maxlength="4" /></td>
                            <td valign="middle"><select  class="EstFormularioCombo" name="CmpVehiculoUnidadMedidaConvertir" id="CmpVehiculoUnidadMedidaConvertir" disabled="disabled">
                            </select></td>
                            <td valign="middle">
                              
                              <input name="CmpVehiculoCantidad" type="text" class="EstFormularioCaja" id="CmpVehiculoCantidad" size="10" maxlength="10" />                            </td>
                            <td valign="middle"><input name="CmpVehiculoCostoIngresoNeto" type="text" class="EstFormularioCaja" id="CmpVehiculoCostoIngresoNeto" size="10" maxlength="10" readonly="readonly" />                            </td>
                            <td valign="middle">
                              
                              <input name="CmpVehiculoImporte" type="text" class="EstFormularioCaja" id="CmpVehiculoImporte" size="10" maxlength="10" />                            </td>
                            ...
                            <td valign="middle"><a href="javascript:FncCompraVehiculoDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                            <td valign="middle">
              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <!--<a href="javascript:FncCompraVehiculoDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>--></td>
...
<input name="CmpProveedorId" type="hidden" id="CmpProveedorId" value="<?php echo $InsCompraVehiculo->PrvId;?>" size="3" /></td>
                    ...
                    <td align="left" valign="top">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><a href="javascript:FncProveedorNuevo('','');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></a></td>
                          <td><input class="EstFormularioCaja" name="CmpProveedorNombre" type="text" id="CmpProveedorNombre" value="<?php echo $InsCompraVehiculo->PrvNombreCompleto;?>" size="45" maxlength="255"  />                            <a href="formularios/CompraVehiculo/FrmProveedorBuscar.php?height=440&width=850" class="thickbox" title="">
