...
<input name="CmpVehiculoUnidadMedidaEquivalente"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoUnidadMedidaEquivalente" size="3" maxlength="20"  />
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td valign="middle"><a href="javascript:FncCompraVehiculoDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
...
<input name="CmpProveedorId" type="hidden" id="CmpProveedorId" value="<?php echo $InsCompraVehiculo->PrvId;?>" size="3" /></td>
                    ...
                    <td align="left" valign="top">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><a href="javascript:FncProveedorNuevo('','');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></a></td>
                          <td><input class="EstFormularioCaja" name="CmpProveedorNombreCompleto" type="text" id="CmpProveedorNombreCompleto" value="<?php echo $InsCompraVehiculo->PrvNombreCompleto;?>" size="45" maxlength="255"  />                            <a href="formularios/CompraVehiculo/FrmProveedorBuscar.php?height=440&width=850" class="thickbox" title="">
