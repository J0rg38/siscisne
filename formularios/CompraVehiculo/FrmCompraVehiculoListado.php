...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsCompraVehiculo.js" ></script>
<?php
/* 
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccCompraVehiculo.php');
...
?>
                  <a target="_blank" href="subidos/almacen_movimiento_entrada_fotos/<?php echo $dat->CvhFoto;?>"  title=""><img  src="imagenes/documento.gif" width="20" height="20" border="0"  /></a>
                <?php	
}
?></td>
                <td  width="2%" align="right" ><?php            
...
?>
                  <a target="_blank" href="subidos/almacen_movimiento_entrada_fotos/<?php echo $dat->CvhGuiaRemisionFoto;?>"  title=""><img  src="imagenes/documento.gif" width="20" height="20" border="0"  /></a>
                <?php	
}
?></td>
