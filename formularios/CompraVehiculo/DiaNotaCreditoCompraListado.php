...
// MtdObtenerNotaCreditoCompras($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'NccId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oMoneda=NULL,$oCompraVehiculo=NULL,$oProveedor=NULL)
