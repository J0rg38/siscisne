                          ...
                          <td align="left" valign="top">
                            ...
                            <fieldset class="EstFormularioContenedor">
                              <legend>
                                ...
                                <input disabled="disabled" onclick="javascript:FncPrivilegioSeleccionarZona('<?php echo $DatZona->ZonId; ?>');" type="checkbox" name="CmpPrivilegioSeleccionarZona_<?php echo $DatZona->ZonId; ?>" id="CmpPrivilegioSeleccionarZona_<?php echo $DatZona->ZonId; ?>" /> <!--Privilegios de  <?php echo $DatZona->ZonAlias; ?>-->
                              </legend>
                                ...
                                <tr>
                                  ...
                                  ?>
                                    <td align="left" valign="top" width="150">
                                      ...
                                      <?php echo $DatZonaPrivilegio->PriAlias; ?>
                                    </td>
