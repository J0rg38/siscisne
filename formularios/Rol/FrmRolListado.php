 ...
 */
	...
	include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccRol.php');
				...
				<tr>
					<td align="right">
						...
						<select class="EstFormularioCombo" name="Cam" id="Cam">
							<option value="RolId" <?php if ($POST_cam == "RolId") {
														echo 'selected="selected"';
													} ?>>Id</option>
							<option value="RolNombre" <?php if ($POST_cam == "RolNombre") {
															echo 'selected="selected"';
														} ?>>Nombre</option>
						</select>
								...
								<tr>
									...
									<td colspan="6" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $RolesTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $RolesTotal; ?>">Todos</option>
										</select>
