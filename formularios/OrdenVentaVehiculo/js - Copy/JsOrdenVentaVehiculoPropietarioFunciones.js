...
function FncOrdenVentaVehiculoPropietarioListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/OrdenVentaVehiculo/FrmOrdenVentaVehiculoPropietarioListado.php',
...
//Parametro12 = CliEmail
	...
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/OrdenVentaVehiculo/acc/AccOrdenVentaVehiculoPropietarioEscoger.php',
...
//						
			...
			tb_show(this.title,'principal2.php?Mod=Cliente&Form=Editar&Dia=1&Id='+InsOrdenVentaVehiculoPropietario.Parametro6+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
...
function FncOrdenVentaVehiculoPropietarioEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/OrdenVentaVehiculo/acc/AccOrdenVentaVehiculoPropietarioEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem,
			success: function(){
...
function FncOrdenVentaVehiculoPropietarioEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/OrdenVentaVehiculo/acc/AccOrdenVentaVehiculoPropietarioEliminarTodo.php',
			data: 'Identificador='+Identificador,
			success: function(){
				$('#CapOrdenVentaVehiculoPropietarioAccion').html('Eliminado');	
				FncOrdenVentaVehiculoPropietarioListar();
