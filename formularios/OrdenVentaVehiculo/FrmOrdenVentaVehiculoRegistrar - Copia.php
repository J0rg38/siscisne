...
?>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="4" align="left" valign="top"><input disabled="disabled" <?php echo (($InsOrdenVentaVehiculo->OvvNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpNotificar" id="CmpNotificar" />
