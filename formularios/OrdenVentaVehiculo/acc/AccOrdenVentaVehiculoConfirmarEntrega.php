...
//	if(FncConvetirTimestamp(FncCambiaFechaANormal($this->SucFechaInventario))<=FncConvetirTimestamp(FncCambiaFechaANormal($InsVentaVariacion->VvaFecha))){
	
	//echo  FncConvetirTimestamp(FncCambiaFechaANormal($InsOrdenVentaVehiculo->OvvActaEntregaFecha));
//	
//	echo "<br>";
//	
//		echo FncConvetirTimestamp($InsOrdenVentaVehiculo->OvvActaEntregaFecha);
	
	if(FncConvetirTimestamp(FncCambiaFechaANormal($InsOrdenVentaVehiculo->OvvActaEntregaFecha))>FncConvetirTimestamp(date("d/m/Y"))){
		$Guardar = false;	
		$Resultado.='#ERR_OVV_128';	
	}
...
//		
//		$InsOrdenVentaVehiculo->OvvDestinatarios .= ",".$PersonalEmail;
//		
//	}
	...
	$InsOrdenVentaVehiculo->OvvDestinatarios =  $EmailPersonal.$CorreosNotificacionOrdenVentaVehiculoConfirmarEntrega;
	...
	if(empty($InsOrdenVentaVehiculo->OvvActaEntregaFecha) or $InsOrdenVentaVehiculo->OvvActaEntregaFecha == "0000-00-00" or $InsOrdenVentaVehiculo->OvvActaEntregaFecha == "00/00/0000"){
		...
		//$InsOrdenVentaVehiculo->OvvActaEntregaHora = date("H").":00";
