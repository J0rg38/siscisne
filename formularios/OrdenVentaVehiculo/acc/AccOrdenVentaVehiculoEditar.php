...
if (isset($_POST['BtnGuardar_x']) or (isset($_POST['Guardar']) && $_POST['Guardar'] == "1")) {
	...
	$InsOrdenVentaVehiculo->OvvPrecio = preg_replace("/,/", "", empty($_POST['CmpPrecio']) ? 0 : $_POST['CmpPrecio']);
	$InsOrdenVentaVehiculo->OvvDescuento = preg_replace("/,/", "", empty($_POST['CmpDescuento']) ? 0 : $_POST['CmpDescuento']);
	$InsOrdenVentaVehiculo->OvvDescuento = (empty($InsOrdenVentaVehiculo->OvvDescuento) ? 0 : $InsOrdenVentaVehiculo->OvvDescuento);

	$InsOrdenVentaVehiculo->OvvBonoGM = preg_replace("/,/", "", empty($_POST['CmpBonoGM']) ? 0 : $_POST['CmpBonoGM']);
	$InsOrdenVentaVehiculo->OvvBonoDealer = preg_replace("/,/", "", empty($_POST['CmpBonoDealer']) ? 0 : $_POST['CmpBonoDealer']);
	$InsOrdenVentaVehiculo->OvvDescuentoGerencia = preg_replace("/,/", "", empty($_POST['CmpDescuentoGerencia']) ? 0 : $_POST['CmpDescuentoGerencia']);
	...
	$InsOrdenVentaVehiculo->OvvTotal = preg_replace("/,/", "", empty($_POST['CmpTotal']) ? 0 : $_POST['CmpTotal']);
	...
	$InsOrdenVentaVehiculo->CveTotal = preg_replace("/,/", "", empty($_POST['CmpCotizacionVehiculoTotal']) ? 0 : $_POST['CmpCotizacionVehiculoTotal']);
...
function FncCargarDatos()
{
	...
	if (!empty($InsOrdenVentaVehiculo->OrdenVentaVehiculoPropietario)) {
		foreach ($InsOrdenVentaVehiculo->OrdenVentaVehiculoPropietario as $DatOrdenVentaVehiculoPropietario) {
			...
			$_SESSION['InsOrdenVentaVehiculoPropietario' . $Identificador]->MtdAgregarSesionObjeto(
				1,
