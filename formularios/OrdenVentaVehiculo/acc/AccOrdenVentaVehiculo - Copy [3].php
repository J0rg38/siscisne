			...
			$Id = "";
				...
				//	deb($POST_seleccionados);
					...
					if(!empty($Id)){
						...
						$InsVehiculoMovimientoSalida->OvvId = $InsOrdenVentaVehiculo->OvvId;
...
//						}
						...
						if(!empty($InsOrdenVentaVehiculo->EinTipoCambioIngreso)){
							
							$CostoIngresoReal = $InsOrdenVentaVehiculo->EinCostoIngreso/ $InsOrdenVentaVehiculo->EinTipoCambioIngreso;
						...
						if($InsOrdenVentaVehiculo->MonId == $InsOrdenVentaVehiculo->MonIdIngreso){
							//echo "ccc";
							
							//deb($CostoIngresoReal);
							//deb($InsOrdenVentaVehiculo->OvvTipoCambio);
							
							$CostoIngreso = $CostoIngresoReal * $InsOrdenVentaVehiculo->OvvTipoCambio;
							
							//deb($CostoIngreso);
							
						}else if($InsOrdenVentaVehiculo->MonId == $EmpresaMonedaId and $InsOrdenVentaVehiculo->MonIdIngreso == $EmpresaMonedaId){
							//echo "ddd";
							$CostoIngreso = $InsOrdenVentaVehiculo->EinCostoIngreso;
