...
<title>Carta de Responsabilidad No. <?php echo $InsOrdenVentaVehiculo->OvvId;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $InsProyecto->MtdRutEstilos();?>CssImprimir.css">
<link href="css/CssOrdenVentaVehiculoImprimir.css" rel="stylesheet" type="text/css" />
<link href="css/CssOrdenVentaVehiculoImprimirCR.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="js/JsOrdenVentaVehiculoImprimir.js"></script>
<!--<script type="text/javascript" src="<?php echo $InsProyecto->MtdRutLibrerias();?>jquery-1.4.3.min.js"></script>-->
<script type="text/javascript" src="<?php echo $InsProyecto->MtdRutLibrerias();?>jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="js/JsOrdenVentaVehiculoImprimirCR.js" ></script>
<!--
Nombre: JS Calendar
...
FncOrdenVentaVehiculoCRImprimir(); 
<?php }?>
...
<?php }?>
	...
	?>    
            ...
            <td width="177" align="left" valign="top"><span class="EstOrdenVentaVehiculoImprimirEtiqueta">
              <?php
	foreach($ArrOrdenVentaVehiculoPropietarios as $DatOrdenVentaVehiculoPropietario){
	?>
              <?php
	if($DatOrdenVentaVehiculoPropietario->OvpFirmaDJ=="1"){
	?>
             Identificado(a) con <?php echo $DatOrdenVentaVehiculoPropietario->TdoNombre;?>: <?php echo $DatOrdenVentaVehiculoPropietario->CliNumeroDocumento;?><br />
              <?php	 
	}
	?>
              <?php
    ...
    <tr class="EstOrdenVentaVehiculoImprimirTabla">
        ...
        <table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="left" valign="middle"><span class="EstOrdenVentaVehiculoImprimirContenido">
              ...
              <?php //echo $InsOrdenVentaVehiculo->EinPlaca;?>
          ...
          <tr>
            ...
            <?php
			if(empty($InsOrdenVentaVehiculo->OvvTarjeta)){
			?>
            PENDIENTE
            <?php	
			}else{
			...
			?>
             <?php echo $InsOrdenVentaVehiculo->OvvTarjeta;?>
            <?php	
			}
			?>
          ...
          <tr>
            ...
            <?php echo $InsOrdenVentaVehiculo->OvvActaEntregaFecha;?>
          ...
          <tr>
            ...
            <td align="center" valign="middle">:</td>
            <td align="left" valign="middle"><span class="EstOrdenVentaVehiculoImprimirContenido"> <?php echo $InsOrdenVentaVehiculo->PerNombre;?> <?php echo $InsOrdenVentaVehiculo->PerApellidoPaterno;?> <?php echo $InsOrdenVentaVehiculo->PerApellidoMaterno;?> </span></td>
          </tr>
          <tr>
	  ...
	  if(file_exists("cnf/CRPiePagina".$InsCotizacionVehiculo->SucSiglas.".php")){
		  include("cnf/CRPiePagina".$InsCotizacionVehiculo->SucSiglas.".php");
	  }
	  ...
	  ?>
              ...
              <p align="justify">
                <span class="EstOrdenVentaVehiculoImprimirContenido">En señal de conformidad,  y estando de mutuo acuerdo firmo la presente</span>
                </p>
              </td>
          </tr>
          <tr>
            <td height="140" colspan="2" align="left" valign="top">&nbsp;</td>
          </tr>
          <tr>
	...
	?>  
            ...
            <td width="50%" height="140" align="left" valign="top">
              ...
              <span class="EstOrdenVentaVehiculoImprimirFirma">
                ...
                REP.  LEGAL AUTOMOTRIZ CISNE S.R.L.
                </span>    
