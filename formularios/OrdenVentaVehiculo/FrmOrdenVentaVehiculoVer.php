...
?>
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpReferencia" type="text" class="EstFormularioCaja" id="CmpReferencia"  value="<?php echo $InsOrdenVentaVehiculo->OvvReferencia;?>" size="40" maxlength="500" readonly="readonly" /></td>
               <td>&nbsp;</td>
               </tr>
             <tr>
               <td>&nbsp;</td>
               <td colspan="4" align="left" valign="top">
                 ...
                 <table width="100%">
                   <tr>
                     <td width="32%" align="left" valign="top"><span class="EstFormularioSubTitulo">Obsequios:</span></td>
                     <td width="33%" align="left" valign="top"><span class="EstFormularioSubTitulo">Accesorios:</span></td>
...
//			if($DatOrdenVentaVehiculoObsequio->ObsId==$DatObsequio->ObsId){
	...
	?>
                       <input disabled="disabled" <?php echo $aux;?> type="checkbox" value="<?php echo $DatObsequio->ObsId;?>" name="CmpObsequio_<?php echo $DatObsequio->ObsId;?>" id="CmpObsequio_<?php echo $DatObsequio->ObsId;?>" />
...
?>
                       <input name="CmpObsequioOtro" type="text" class="EstFormularioCaja" id="CmpObsequioOtro" value="<?php echo $InsOrdenVentaVehiculo->OvvObsequioOtro;?>" size="20" maxlength="255" readonly="readonly"  />
...
?>
	...
	?>
                       <input disabled="disabled" <?php echo $aux;?> type="checkbox" value="<?php echo $DatAccesorio->ObsId;?>" name="CmpObsequio_<?php echo $DatAccesorio->ObsId;?>" id="CmpObsequio_<?php echo $DatAccesorio->ObsId;?>" />
...
<input disabled="disabled" <?php echo $aux;?> type="checkbox" value="<?php echo $DatKilometro['km'];?>" name="CmpMantenimientoChevrolet_<?php echo $DatKilometro['km'];?>" id="CmpMantenimientoChevrolet_<?php echo $DatKilometro['km'];?>" /> <?php echo $DatKilometroEtiqueta;?> km <br />
...
<input disabled="disabled" <?php echo $aux;?> type="checkbox" value="<?php echo $DatKilometro['km'];?>" name="CmpMantenimientoIsuzu_<?php echo $DatKilometro['km'];?>" id="CmpMantenimientoIsuzu_<?php echo $DatKilometro['km'];?>" /> <?php echo $DatKilometroEtiqueta;?> km
<br />
<?php	
}
?>
             ...
             <tr>
               ...
               <td>Firmante:</td>
               <td><select  disabled="disabled" class="EstFormularioCombo" name="CmpPersonalFirmante" id="CmpPersonalFirmante" >
                 <option value="">Escoja una opcion</option>
                 <?php
             ...
             <tr>
               ...
               <td align="left" valign="top"><?php
					...
					?>
                 <select disabled="disabled"  class="EstFormularioCombo" name="CmpTipoPlaca" id="CmpTipoPlaca">
                   <option  value="">Escoja una opcion</option>
             ...
             <tr>
               ...
               <td align="left" valign="top"><?php
                 ...
                 <input name="CmpSucursal" type="hidden" id="CmpSucursal" value="<?php  echo $InsOrdenVentaVehiculo->SucId;?>" />
                 </span></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
               <td>&nbsp;</td>
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
			...
			?>
               ...
               <td align="left" valign="top"><?php
					...
					?>
                 <select disabled="disabled"  class="EstFormularioCombo" name="CmpGLPModeloTanque" id="CmpGLPModeloTanque">
                   <option  value="">Escoja una opcion</option>
               ...
               <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpVehiculoMotor" type="text" id="CmpVehiculoMotor" value="<?php echo ($InsOrdenVentaVehiculo->EinNumeroMotor);?>" size="8" maxlength="30" /></td>
               <td align="left" valign="top"><input name="CmpVehiculoColor" type="text" class="EstFormularioCaja" id="CmpVehiculoColor" value="<?php echo (!empty($InsOrdenVentaVehiculo->EinColor)?$InsOrdenVentaVehiculo->EinColor:$InsOrdenVentaVehiculo->OvvColor);?>" size="8" maxlength="30" readonly="readonly" /></td>
               <td align="left" valign="top"><input name="CmpVehiculoAnoFabricacion" type="text" class="EstFormularioCaja" id="CmpVehiculoAnoFabricacion" value="<?php echo (!empty($InsOrdenVentaVehiculo->EinAnoFabricacion)?$InsOrdenVentaVehiculo->EinAnoFabricacion:$InsOrdenVentaVehiculo->OvvAnoFabricacion);?>" size="8" maxlength="4" readonly="readonly" /></td>
               <td align="left" valign="top"><input name="CmpVehiculoAnoModelo" type="text" class="EstFormularioCaja" id="CmpVehiculoAnoModelo" value="<?php echo (!empty($InsOrdenVentaVehiculo->EinAnoModelo)?$InsOrdenVentaVehiculo->EinAnoModelo:$InsOrdenVentaVehiculo->OvvAnoModelo);?>" size="8" maxlength="4" readonly="readonly" /></td>
               <td align="left" valign="top">&nbsp;</td>
               </tr>
             <tr>
               <td>&nbsp;</td>
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
         ...
         <div class="EstFormularioCajaObservacion">
          <?php echo stripslashes($InsOrdenVentaVehiculo->OvvNota);?>
          </div>
          <input type="hidden" name="CmpNota" id="CmpNota" value="<?php echo stripslashes($InsOrdenVentaVehiculo->OvvNota);?>" />
...
/*tinymce.init({
	...
	height : 180
                            ...
                            <textarea name="CmpActaEntregaDescripcion" cols="45" rows="4" readonly="readonly" class="EstFormularioCajaDeshabilitada" id="CmpActaEntregaDescripcion"><?php echo stripslashes($InsOrdenVentaVehiculo->OvvActaEntregaDescripcion);?></textarea></td>
                          <td align="right">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td colspan="2"><span class="EstFormularioSubTitulo">Documentaci&oacute;n y Tramites</span></td>
                          <td align="right">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td>Numero de Placa:</td>
                          <td><input name="CmpPlaca" type="text" class="EstFormularioCaja" id="CmpPlaca"  value="<?php echo $InsOrdenVentaVehiculo->OvvPlaca;?>" size="20" maxlength="20" readonly="readonly" /></td>
                          <td align="right">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td>Tarjeta:</td>
                          <td><input name="CmpTarjeta" type="text" class="EstFormularioCaja" id="CmpTarjeta"  value="<?php echo $InsOrdenVentaVehiculo->OvvTarjeta;?>" size="20" maxlength="20" readonly="readonly" /></td>
                          <td align="right">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
