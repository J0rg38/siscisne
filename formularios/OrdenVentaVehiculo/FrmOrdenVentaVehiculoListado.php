...
?>
	...
	<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsOrdenVentaVehiculov3.js"></script>
...
<div class="EstSubMenuBoton"><a href="javascript:FncOrdenVentaVehiculoSolicitarAprobacionAsignacionVINSeleccionados();"><img src="imagenes/submenu/solicitar_aprobacion.png" alt="[Solicitar Aprobacion]" title="Solicitar Aprobacion" /> Solic. Aprob.</a></div>-->
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE ORDENES DE VENTA DE VEHICULOS</span>
					</td>
				</tr>
				<tr>
					<td width="50%">
      ...
      <option value="OvvId" <?php if ($POST_cam == "OvvId") {
								echo 'selected="selected"';
							} ?>>Id</option>
      <option value="PrvNombre" <?php if ($POST_cam == "PrvNombre") {
						...
						<select class="EstFormularioCombo" name="Estado" id="Estado">
							...
							<option value="4" <?php if ($POST_estado == 4) {
													echo 'selected="selected"';
												} ?>>Por Facturar</option>
							<option value="5" <?php if ($POST_estado == 5) {
													echo 'selected="selected"';
												} ?>>Facturado</option>
        ...
        <option value="0" <?php if ($POST_ActaEntrega == 0) {
								echo 'selected="selected"';
							} ?>>Todos</option>
        <option value="1" <?php if ($POST_ActaEntrega == 1) {
								echo 'selected="selected"';
							} ?>>Entregados</option>
        <option value="2" <?php if ($POST_ActaEntrega == 2) {
								echo 'selected="selected"';
							} ?>>Por Entregar</option>        
        </select>
        -->
								...
								<tr>
									...
									<th width="7%"><?php
													if ($POST_ord == "EinNumeroMotor") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('EinNumeroMotor','ASC');"> Nro. Motor <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('EinNumeroMotor','DESC');"> Nro. Motor <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {

											?>
											<a href="javascript:FncOrdenar('EinNumeroMotor','ASC');"> Nro. Motor </a>
										<?php
													}
										?>
									</th>
									...
									<th width="5%"><?php
													if ($POST_ord == "OvvActaEntregaFecha") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('OvvActaEntregaFecha','ASC');"> Fecha Entrega <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('OvvActaEntregaFecha','DESC');"> Fecha Entrega <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {

											?>
											<a href="javascript:FncOrdenar('OvvActaEntregaFecha','ASC');"> Fecha Entrega </a>
										<?php
													}
										?>
									</th>
									...
									<th width="5%"><?php
													if ($POST_ord == "OvvCancelado") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('OvvCancelado','ASC');"> Cancelado <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('OvvCancelado','DESC');"> Cancelado <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('OvvCancelado','ASC');"> Cancelado </a>
										<?php
													}
										?>
									</th>
								...
								<tr>
									...
									<td colspan="27" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $OrdenVentaVehiculosTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $OrdenVentaVehiculosTotal; ?>">Todos</option>
										</select>
								...
								?>
									...
									<tr id="Fila_<?php echo $f; ?>">
										...
										<td width="6%" align="right">
											...
											<?php echo (!empty($dat->EinColor) ? $dat->EinColor : $dat->OvvColor); ?>
										...
										<td width="5%" align="right">
											...
											<?php
											if (empty($dat->OvvActaEntregaFecha) and (!empty($dat->FacId) or !empty($dat->BolId))) {
											?>
												<span class="EstTablaListadoImportante">SIN FECHA DE ENTREGA</span>
											<?php
											} else {
											?>
												<span class="EstTablaListadoNormal"><?php echo $dat->OvvActaEntregaFecha;  ?></span>
											<?php
											}
											?>
  ...
  <?php
	...
	?>
										...
										<td width="5%" align="center">
											...
											switch ($dat->OvvCancelado) {

												case "Si":
											?>
													<img width="25" height="25" alt="[Si]" title="Orden cancelada " src="imagenes/estado/pagado_si.png" />
												<?php
												...
												case "No":
												?>
													<!--   <img width="25" height="25" alt="[No]" title="Orden sin cancelar" src="imagenes/estado/pagado_no.png" />-->

													<?php

													switch ($dat->OvvCancelado2) {

														case "Si":
													?>
															<img width="25" height="25" alt="[Si]" title="Orden cancelada " src="imagenes/estado/pagado_sino.png" />
														<?php
						...
						break;	
										...
										<td width="10%" align="center">
											...
											?>
												...
												<a href="principal.php?Mod=<?php echo $GET_mod; ?>&Form=Trabajar&Id=<?php echo $dat->OvvId; ?>"><img src="imagenes/acciones/trabajar.gif" width="19" height="19" border="0" title="Editar" alt="[Editar]" /></a>
...
<?php
											...
											?>
												...
												<a href="javascript:FncGenerarPago('<?php echo $dat->OvvId; ?>');"><img src="imagenes/acciones/orden_cobro.png" alt="[Registrar Pago]" title="Registrar Pago" width="19" height="19" border="0" /></a>
...
?>	
  ...
  <?php
											...
											<?php
											if ($PrivilegioEditar and ($dat->OvvAprobacion1 == 1 or $dat->OvvAprobacion2 == 1  or  $dat->OvvEstado == 5  or $dat->OvvEstado == 4)) {
											?>
												<a href="javascript:FncEntregaVentaVehiculoCargarFormulario('EntregaVentaVehiculo','Registrar','<?php echo $dat->OvvId; ?>','');"><img src="imagenes/acciones/entrega.png" alt="[Programar Entrega]" title="Programar Entrega" width="19" height="19" border="0" /></a>
											<?php
											}
											?>
											...
											if ($PrivilegioEditar  and ($dat->OvvAprobacion1 == 1 or $dat->OvvAprobacion2 == 1 or $dat->OvvEstado == 5  or $dat->OvvEstado == 4)) {
											?>
												<a href="javascript:FncEntregaVentaVehiculoCargarFormulario('OrdenVentaVehiculo','ConfirmarEntrega','<?php echo $dat->OvvId; ?>','<?php echo $dat->OvvActaEntregaFecha; ?>');"><img src="imagenes/acciones/confirmar_entrega.png" alt="[Confirmar Entrega]" title="Confirmar Entrega" width="19" height="19" border="0" /></a>
											<?php
											}
											?>
