...
$(document).ready(function (){
	...
	if($("CmpPersonalFirmante").val()==""){
					
		$("#CmpPersonalFirmante").prop("selectedIndex", 2);
...
?>
	...
	?>
                            <input  etiqueta="obsequio"  <?php echo $aux;?> type="checkbox" value="<?php echo $DatObsequio->ObsId;?>" name="CmpObsequio_<?php echo $DatObsequio->ObsId;?>" id="CmpObsequio_<?php echo $DatObsequio->ObsId;?>" />
...
?>
            ...
            <tr>
              <td valign="top"><div class="EstFormularioArea">
                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="13"><span class="EstFormularioSubTitulo">Datos del Vehiculo 
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><select <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'disabled="disabled"':'';?> class="EstFormularioCombo" name="CmpVehiculoMarca" id="CmpVehiculoMarca" >
                      <option value="">Escoja una opcion</option>
                      <?php
			...
			?>
                    ...
                    <td align="left" valign="top"><select <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'disabled="disabled"':'';?> class="EstFormularioCombo" name="CmpVehiculoModelo" id="CmpVehiculoModelo">
                    </select></td>
                    <td align="left" valign="top"><select <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'disabled="disabled"':'';?> class="EstFormularioCombo" name="CmpVehiculoVersion" id="CmpVehiculoVersion">
                    </select></td>
                    ...
                    <td align="left" valign="top"><input <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'readonly="readonly"':'';?> name="CmpVehiculoIngresoVIN" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoVIN" value="<?php echo ($InsOrdenVentaVehiculo->EinVIN);?>" size="20" maxlength="30" /></td>
                    ...
                    <td align="left" valign="top"><input <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'readonly="readonly"':'';?> class="EstFormularioCaja" name="CmpVehiculoColor" type="text" id="CmpVehiculoColor" value="<?php echo (!empty($InsOrdenVentaVehiculo->EinColor)?$InsOrdenVentaVehiculo->EinColor:$InsOrdenVentaVehiculo->OvvColor);?>" size="8" maxlength="30" /></td>
                    <td align="left" valign="top"><input  <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'readonly="readonly"':'';?> class="EstFormularioCaja" name="CmpVehiculoAnoFabricacion" type="text" id="CmpVehiculoAnoFabricacion" value="<?php echo (!empty($InsOrdenVentaVehiculo->EinAnoFabricacion)?$InsOrdenVentaVehiculo->EinAnoFabricacion:$InsOrdenVentaVehiculo->OvvAnoFabricacion);?>" size="8" maxlength="4" /></td>
                    <td align="left" valign="top"><input <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'readonly="readonly"':'';?> class="EstFormularioCaja" name="CmpVehiculoAnoModelo" type="text" id="CmpVehiculoAnoModelo" value="<?php echo (!empty($InsOrdenVentaVehiculo->EinAnoModelo)?$InsOrdenVentaVehiculo->EinAnoModelo:$InsOrdenVentaVehiculo->OvvAnoModelo);?>" size="8" maxlength="4" /></td>
                    <td align="left" valign="top">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
            ...
            <tr>
              ...
              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><input name="CmpHora" type="text" class="EstFormularioCajaDeshabilitada" id="CmpHora" value="<?php  echo $InsOrdenVentaVehiculo->OvvActaEntregaHora;?>" size="15" maxlength="10" readonly="readonly" /></td>
                          <td align="right">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
...
tinymce.init({
	...
	height : 180
                        ...
                        <tr>
                          ...
                          <td><input name="CmpPlaca" type="text" class="EstFormularioCaja" id="CmpPlaca"  value="<?php echo $InsOrdenVentaVehiculo->OvvPlaca;?>" size="20" maxlength="20" /></td>
                          <td align="right">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td>Tarjeta:</td>
                          <td><input name="CmpTarjeta" type="text" class="EstFormularioCaja" id="CmpTarjeta"  value="<?php echo $InsOrdenVentaVehiculo->OvvTarjeta;?>" size="20" maxlength="20" /></td>
                          <td align="right">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
...
if(empty($GET_dia)){
	...
	if(!$_SESSION['MysqlDeb']){
		$InsMensaje->MtdRedireccionar("principal.php?Mod=".(!empty($GET_mod)?$GET_mod:$GET_NMod)."&Form=Listado",$Registro,1500);
	}
