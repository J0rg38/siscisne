...
if(empty($POST_VehiculoVersion)){
	die("No ha escogido una version");
}

if(empty($POST_VehiculoModelo)){
	die("No ha escogido un modelo");
}


if(empty($POST_VehiculoModelo)){
	die("No ha escogido una marca");
}

if(empty($POST_AnoModelo)){
	die("No ha ingresado un año de modelo");
}
...
//if(!empty($POST_VehiculoVersion)){
	...
	$ResVehiculoListaPrecioDetalle = $InsVehiculoListaPrecioDetalle->MtdObtenerVehiculoListaPrecioDetalles(NULL,NULL,"VlpFecha","DESC",NULL,NULL,$POST_VehiculoVersion,NULL,false,$POST_VehiculoModelo,$POST_VehiculoMarca);
...
<table class="EstTablaListado" width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<?php $DatVehiculoListaPrecioDetalle->VldPrecioLista = (($EmpresaMonedaId==$DatVehiculoListaPrecioDetalle->MonId or empty($DatVehiculoListaPrecioDetalle->MonId))?$DatVehiculoListaPrecioDetalle->VldPrecioLista:($DatVehiculoListaPrecioDetalle->VldPrecioLista/$DatVehiculoListaPrecioDetalle->VlpTipoCambio));?>
      <?php echo number_format($DatVehiculoListaPrecioDetalle->VldPrecioLista,2);?>
      
      </td>
    <td align="right">
      
      <?php $DatVehiculoListaPrecioDetalle->VldPrecioCierre = (($EmpresaMonedaId==$DatVehiculoListaPrecioDetalle->MonId or empty($DatVehiculoListaPrecioDetalle->MonId))?$DatVehiculoListaPrecioDetalle->VldPrecioCierre:($DatVehiculoListaPrecioDetalle->VldPrecioCierre/$DatVehiculoListaPrecioDetalle->VlpTipoCambio));?>
...
<!--Se encontraron <?php echo $SesionObjetosTotalSeleccionado;?> elemento(s)-->
	...
	<a href="javascript:FncVehiculoIngresoCargarFormularioListado('Ver','<?php echo $DatVehiculoIngreso->EinId;?>')">
	
	<?php echo $DatVehiculoIngreso->EinVIN;?></a>
