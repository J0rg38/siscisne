...
<style type="text/css">
@import url('<?php echo $InsProyecto->MtdFormulariosCss($GET_mod);?>CssOrdenVentaVehiculoSeguimientoCliente.css');
</style>
...
<?php
//if(!empty($InsOrdenVentaVehiculo->OvvFechaEntrega)){
//	list($Fecha,$Hora) = explode(" ",$InsOrdenVentaVehiculo->OvvFechaEntrega);
//	
//	if(empty($Fecha)){
//		$Fecha = date("d/m/Y");
//	}
                            ...
                            <td align="left"><div class="EstFormularioArea" >
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top"><input name="CmpClienteTelefono" type="text" class="EstFormularioCaja" id="CmpClienteTelefono"  tabindex="2" value="<?php echo $InsOrdenVentaVehiculo->CliTelefono;?>" size="25" maxlength="255" readonly="readonly"  /></td>
                                  <td align="left" valign="top">Celular:</td>
                                  <td align="left" valign="top"><input name="CmpClienteCelular" type="text" class="EstFormularioCaja" id="CmpClienteCelular"  tabindex="2" value="<?php echo $InsOrdenVentaVehiculo->CliCelular;?>" size="25" maxlength="255" readonly="readonly"  /></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                            ...
                            <td width="398" align="left" valign="top"><div class="EstFormularioArea">
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                  ...
                                  <td><input name="CmpOrdenVentaVehiculoLlamadaFecha" type="text" class="EstFormularioCajaFecha" id="CmpOrdenVentaVehiculoLlamadaFecha" value="<?php echo $Fecha;?>" size="9" maxlength="10" />
...
Calendar.setup({ 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnOrdenVentaVehiculoLlamadaFecha"// el id del bot�n que  
	});
