...
function FncOrdenVentaVehiculoConfirmarEntregaImprimir(oId){

	FncPopUp('formularios/OrdenVentaVehiculo/FrmOrdenVentaVehiculoImprimirAE.php?M=1&Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
	
}


function FncOrdenVentaVehiculoConfirmarEntregaVistaPreliminar(oId){
