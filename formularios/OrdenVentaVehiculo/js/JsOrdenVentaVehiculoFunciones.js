...
function FncValidar(){
	...
	var VehiculoColor = $("#CmpVehiculoColor").val();
	...
	var CondicionPago = $("#CmpCondicionPago").val();
		...
		}else if(VehiculoColor == ""){			
		
				dhtmlx.alert({
					title:"Aviso",
					type:"alert-error",
					text:"Debes ingresar color",
					callback: function(result){
		...
		}else if(Total == "" || Total == "0.00" || Total == "0"){			
		...
		}else if(FncValidarObsequios() == false){			
		
				dhtmlx.alert({
					title:"Aviso",
					type:"alert-error",
					text:"No puedes escoger mas de 7 obsequios",
					callback: function(result){
...
function FncValidarObsequios(){

	var total_accesorios = 0;
	var respuesta = true;
		
	$('input[type=checkbox]').each(function () {
		if($(this).attr('etiqueta')=="obsequio"){
...
//					dataType: 'json',
//					type: 'POST',
//					url: 'formularios/OrdenVentaVehiculo/AccOrdenVentaVehiculoBuscarVIN.php',
		...
		/*}else if(Color==""){
			...
			if(result==true){		
				...
				$.ajax({
					dataType: 'json',
					type: 'POST',
					url: 'formularios/OrdenVentaVehiculo/acc/AccOrdenVentaVehiculoBuscarVIN.php',
					data: 'VehiculoMarca='+VehiculoMarca+
					'&VehiculoModelo='+VehiculoModelo+
					'&VehiculoVersion='+VehiculoVersion+
					'&AnoModelo='+AnoModelo+
...
console.log("FncVerificarVIN");
		...
		if(VehiculoIngresoVIN!=""){
				...
				$.ajax({
					dataType: 'json',
					type: 'POST',
					url: 'formularios/OrdenVentaVehiculo/acc/AccOrdenVentaVehiculoVerificarVIN.php',
...
/*	$("#CmpVehiculoMarca").attr('disabled', true);
	...
	$("#CmpVehiculoMotor").attr('readonly', true);
	
	$("#CmpVehiculoAnoModelo").attr('readonly', true);
	$("#CmpVehiculoAnoFabricacion").attr('readonly', true);
...
function FncImprmir(oId){
	FncPopUp('formularios/OrdenVentaVehiculo/FrmOrdenVentaVehiculoImprimir.php?Id='+oId+
...
function FncVehiculoIngresoListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/OrdenVentaVehiculo/CapVehiculoIngresoListado.php',
		data: 'VehiculoMarca='+VehiculoMarca+
		'&VehiculoModelo='+VehiculoModelo+
		'&VehiculoVersion='+VehiculoVersion+
