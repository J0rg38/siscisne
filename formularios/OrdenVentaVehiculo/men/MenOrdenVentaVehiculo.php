...
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"Listado") and empty($GET_dia)){
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=ConfirmarEntregaListado"><img src="imagenes/submenu/pendiente_entrega.png" alt="[Pendientes Entrega]"  title="Pendientes Entrega" />Pendientes Entrega</a></div>
<?php
}
?>
