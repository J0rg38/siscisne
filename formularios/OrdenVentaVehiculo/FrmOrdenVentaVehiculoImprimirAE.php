...
?>
      ...
      <td colspan="2" align="center" valign="top"  >
        ...
        <thead class="EstOrdenVentaVehiculoImprimirHead">
          ...
          <tr>
            ...
            <td align="center" valign="middle">:</td>
            <td align="left" valign="middle"><span class="EstOrdenVentaVehiculoImprimirContenido"><?php echo $InsOrdenVentaVehiculo->OvvPlaca;?></span></td>
          </tr>
          <tr>
            <td align="left" valign="middle"><span class="EstOrdenVentaVehiculoImprimirEtiqueta">Tarjetas</span></td>
            <td align="center" valign="middle">:</td>
            <td align="left" valign="middle"><span class="EstOrdenVentaVehiculoImprimirContenido"><?php echo $InsOrdenVentaVehiculo->OvvTarjeta;?></span></td>
          </tr>
          </tbody>
          </table>
 ...
 <!-- <span class="EstOrdenVentaVehiculoImprimirContenido"> Otros accesorios instalados: </span>--><br />
    ...
    <tr class="EstOrdenVentaVehiculoImprimirTabla">
      <td height="100" align="left" valign="top" class="EstOrdenVentaVehiculoImprimirEtiquetaFondo">&nbsp;</td>
      <td height="100" colspan="2" align="left" valign="top" ><span class="EstOrdenVentaVehiculoImprimirAccesorios">
...
<?php
    ...
    <tr class="EstOrdenVentaVehiculoImprimirTabla">
      <td align="left" valign="top" class="EstOrdenVentaVehiculoImprimirEtiquetaFondo">&nbsp;</td>
      <td colspan="2" align="left" valign="top" ><span class="EstOrdenVentaVehiculoImprimirEtiqueta">Observaciones:</span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr class="EstOrdenVentaVehiculoImprimirTabla">
      <td align="left" valign="top" class="EstOrdenVentaVehiculoImprimirEtiquetaFondo">&nbsp;</td>
