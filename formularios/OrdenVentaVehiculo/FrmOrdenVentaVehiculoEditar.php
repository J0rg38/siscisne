         ...
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
			...
			?>
               ...
               <td align="left" valign="top"><input <?php echo ($InsOrdenVentaVehiculo->OvvAprobacion1==1)?'readonly="readonly"':'';?>  class="EstFormularioCaja" name="CmpVehiculoIngresoVIN" type="text" id="CmpVehiculoIngresoVIN" value="<?php echo ($InsOrdenVentaVehiculo->EinVIN);?>" size="20" maxlength="30" /></td>
               <td align="left" valign="top"><a href="javascript:FncVehiculoIngresoSimpleBuscar('VIN');"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
               ...
               <td align="left" valign="top"><input name="CmpVehiculoMotor" type="text" class="EstFormularioCaja" id="CmpVehiculoMotor" value="<?php echo ($InsOrdenVentaVehiculo->EinNumeroMotor);?>" size="8" maxlength="30" readonly="readonly" /></td>
