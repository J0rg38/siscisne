...
?>
	...
	?>
            ...
            <?php $DatPago->PagMonto = (($EmpresaMonedaId==$DatPago->MonId or empty($InsOrdenVentaVehiculo->MonId))?$DatPago->PagMonto:($DatPago->PagMonto/$DatPago->PagTipoCambio));?>
            ...
            <tr>
              ...
              <td align="center"><?php echo $DatPago->FpaCodigo;?></td>
              </tr>
    ...
    <tr class="EstOrdenVentaVehiculoImprimirTabla">
      <td height="398" colspan="2" align="left" valign="top" ><table width="100%" align="center">
          <tr>
            <td width="50%" height="140" align="left" valign="bottom">
