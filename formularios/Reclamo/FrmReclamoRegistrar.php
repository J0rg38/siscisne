...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccReclamoRegistrar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">REGISTRAR RECLAMO</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<img src="imagenes/calendar.gif" alt="[Calendario]" id="BtnFecha" name="BtnFecha" width="18" height="18" align="absmiddle"  style="cursor:pointer;" /> 
			...
			?>
                                ...
                                <tr>
                                  ...
                                  <label>
                                    <input  tabindex="2" class="EstFormularioCaja" name="CmpProveedorNombre" type="text" id="CmpProveedorNombre" size="45" maxlength="255" value="<?php echo $InsReclamo->PrvNombre;?> <?php echo $InsReclamo->PrvApellidoPaterno;?> <?php echo $InsReclamo->PrvApellidoMaterno;?>"  />
                                  </label>
                                  <span class="textfieldRequiredMsg">Se necesita un valor.</span></span>
                                  
                                  
                                  <a href="comunes/Proveedor/FrmProveedorBuscar.php?height=440&width=850" class="thickbox" title="">[...]</a>
                                  ...
                                  <td align="left" valign="top">Tipo Doc.:
                                    <input type="hidden" name="CmpProveedorId" id="CmpProveedorId" value="<?php echo $InsReclamo->PrvId;?>" size="3" />
                                  </td>
                                  <td align="left" valign="top">
                                  ...
                                  <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td><span id="sprytextfield5">
                                        <input tabindex="4" class="EstFormularioCaja" name="CmpProveedorNumeroDocumento" type="text" id="CmpProveedorNumeroDocumento" size="20" maxlength="50" value="<?php echo $InsReclamo->PrvNumeroDocumento;?>"   />
                                      ...
                                      <td><a href="javascript:FncProveedorBuscar('NumeroDocumento');"><img src="imagenes/buscar2.gif" width="25" height="25" alt="[Buscar]" align="absmiddle" title="Buscar" border="0"  /></a>
					...
					?>
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top">
                                    ...
                                    <input name="CmpTipoCambio" type="hidden" id="CmpTipoCambio" value="<?php echo $InsReclamo->RecTipoCambio;?>" size="3" />
                                    <input name="CmpPorcentajeImpuestoVenta" type="hidden" id="CmpPorcentajeImpuestoVenta" value="<?php echo $InsReclamo->RecPorcentajeImpuestoVenta;?>" size="3" />
                                  <input name="CmpFichaAccionId" type="hidden" id="CmpFichaAccionId" value="<?php echo $InsReclamo->FccId;?>" size="3" /></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
                            <td width="34%" align="left" valign="top"><div class="EstFormularioArea">
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="1%">&nbsp;</td>
                                  <td width="13%"><div id="CapReclamoFotoAccion"></div>                                    <a href="javascript:FncReclamoFotoListar();"></a></td>
...
ifFormat   : "%d/%m/%Y",  //  
button     : "BtnRespuestaFecha"// el id del bot�n que  
});
</script>
