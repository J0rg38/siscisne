...
session_start();
if (!isset($_SESSION['InsReclamoTarea'.$ModalidadIngreso.$Identificador])){
	$_SESSION['InsReclamoTarea'.$ModalidadIngreso.$Identificador] = new ClsSesionObjeto();	
}
...
$RepSesionObjetos = $_SESSION['InsReclamoTarea'.$ModalidadIngreso.$Identificador]->MtdObtenerSesionObjetos(true);
