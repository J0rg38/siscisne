...
$objPHPExcel = $objReader->load("../../plantilla/TemReclamo.xls");
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('H21', $InsReclamo->RecCodigoReclamo);
$objPHPExcel->getActiveSheet()->getStyle('H21')->getFont()->setBold(true)->setSize(14);
				   
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('C27', $InsReclamo->RecFechaEmision);
$objPHPExcel->getActiveSheet()->getStyle('C27')->getFont()->setBold(true)->setSize(14);		
							   
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('C30', $InsReclamo->RecCliente);
$objPHPExcel->getActiveSheet()->getStyle('C30')->getFont()->setBold(true)->setSize(14);		

$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('G30', $InsReclamo->RecSucursal);
$objPHPExcel->getActiveSheet()->getStyle('G30')->getFont()->setBold(true)->setSize(14);		

$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('J30', $InsReclamo->RecPais);
$objPHPExcel->getActiveSheet()->getStyle('J30')->getFont()->setBold(true)->setSize(14);		
