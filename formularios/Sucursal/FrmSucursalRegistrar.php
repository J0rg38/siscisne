...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccSucursalRegistrar.php');
//ALERTAS
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25" colspan="2"><span class="EstFormularioTitulo">REGISTRAR SUCURSAL</span></td>
      </tr>
      <tr>
        <td colspan="2">
