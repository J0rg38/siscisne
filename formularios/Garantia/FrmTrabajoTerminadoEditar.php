                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            <td width="33%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="2%" align="left" valign="top"><a href="javascript:FncGarantiaTareaEliminarTodo('<?php echo $DatFichaAccion->MinSigla?>');"></a></td>
                            ...
                            <td width="33%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="2%"><div id="CapFichaAccion<?php echo $DatFichaAccion->MinSigla?>ProductosResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                            ...
                            <td width="34%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="2%"><div id="CapFichaAccion<?php echo $DatFichaAccion->MinSigla?>SuministrosResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
