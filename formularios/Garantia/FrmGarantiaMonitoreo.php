...
$ResFichaAccion = $InsFichaAccion->MtdObtenerFichaAcciones("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FinConductor,VmaNombre,VmoNombre,VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,false,true,"MIN-10000,MIN-10008,MIN-10010");//73,74,75,8,9
...
<tr>
  ...
  <span class="EstFormularioTitulo">MONITOREO DE ORDENES DE TRABAJO TERMINADAS CON GARANTIA</span></td>
</tr>
<tr>
  <td width="47%">
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "FinConductor"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinConductor','ASC');"> Conductor <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinConductor','DESC');"> Conductor <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
...
?>		                
	<a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Registrar&FccId=<?php echo $dat->FccId;?>"><img src="imagenes/generar.jpg" width="19" height="19" border="0" title="Generar Hoja de Garantia" alt="[Generar Garantia]"   /></a>                
<?php
}
?>
