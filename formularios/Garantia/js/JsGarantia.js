...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/Garantia/acc/AccGarantiaGenerarExcel.php";
//					break;
					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/Garantia/acc/AccGarantiaGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	document.getElementById("FrmListado").action = "formularios/Garantia/FrmGarantiaListadoImprimir.php"
...
function FncGarantiaSeguimientoClienteCargarFormulario(oGarantiaId){
	
	//tb_show(this.title,'principal2.php?Mod=Garantia&Form=SeguimientoCliente&Dia=1&Id='+oGarantiaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&modal=true',this.rel);	
	FncCargarVentana("Garantia","SeguimientoCliente",oGarantiaId);
}
