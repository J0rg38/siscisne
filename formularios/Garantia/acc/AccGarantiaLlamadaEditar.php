...
$InsGarantiaLlamada1 = array();
$InsGarantiaLlamada1 = $_SESSION['InsGarantiaLlamada'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
...
$_SESSION['InsGarantiaLlamada'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsGarantiaLlamada1->Parametro1,
$GarantiaLlamadaNumero,
$GarantiaLlamadaFecha,
$GarantiaLlamadaValor,
$GarantiaLlamadaObservacion,
3,
$InsGarantiaLlamada1->Parametro7,
date("d/m/Y H:i:s")
);
