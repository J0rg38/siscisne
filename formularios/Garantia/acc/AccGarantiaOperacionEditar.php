...
$InsGarantiaOperacion1 = array();
$InsGarantiaOperacion1 = $_SESSION['InsGarantiaOperacion'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
...
$_SESSION['InsGarantiaOperacion'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsGarantiaOperacion1->Parametro1,
$GarantiaOperacionNumero,
$GarantiaOperacionTiempo,
$GarantiaOperacionValor,
$GarantiaOperacionCosto,
$GarantiaOperacionEstado ,
$InsGarantiaOperacion1->Parametro7,
date("d/m/Y H:i:s"),
