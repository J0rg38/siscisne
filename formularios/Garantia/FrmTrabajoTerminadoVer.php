...
if(!empty($ArrModalidadIngresos)){
	foreach($ArrModalidadIngresos as $DatModalidadIngreso){
		...
		if (!isset($_SESSION['InsGarantiaTarea'.$DatModalidadIngreso->MinSigla.$Identificador])){	
			$_SESSION['InsGarantiaTarea'.$DatModalidadIngreso->MinSigla.$Identificador] = new ClsSesionObjeto();
		}else{	
			$_SESSION['InsGarantiaTarea'.$DatModalidadIngreso->MinSigla.$Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsGarantiaTarea'.$DatModalidadIngreso->MinSigla.$Identificador]);
		}		

		if (!isset($_SESSION['InsGarantiaProducto'.$DatModalidadIngreso->MinSigla.$Identificador])){	
			$_SESSION['InsGarantiaProducto'.$DatModalidadIngreso->MinSigla.$Identificador] = new ClsSesionObjeto();
		}else{	
			$_SESSION['InsGarantiaProducto'.$DatModalidadIngreso->MinSigla.$Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsGarantiaProducto'.$DatModalidadIngreso->MinSigla.$Identificador]);
		}
		
		if (!isset($_SESSION['InsGarantiaMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador])){	
			$_SESSION['InsGarantiaMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador] = new ClsSesionObjeto();
		}else{	
			$_SESSION['InsGarantiaMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsGarantiaMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador]);
		}
...
if (!isset($_SESSION['InsGarantiaHerramienta'.$Identificador])){	
	...
	$_SESSION['InsGarantiaHerramienta'.$Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsGarantiaMantenimiento'.$Identificador]);
}
...
<div class="EstCapMenu">
    ...
    ?>
			...
			?>           
             ...
             <div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $InsFichaIngreso->FinId;?>"><img src="imagenes/iconos/editar.png" alt="[Editar]" title="Editar" />Editar</a></div>
             <?php
			}
			?>   
	...
	<div id="tab<?php echo $c;?>" class="tab_content">
                    ...
                    <tr>
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td width="96" align="left" valign="top"><input style="visibility:hidden;" etiqueta="modalidad" checked="checked"  type="checkbox" value="<?php echo $DatFichaAccion->MinId?>" name="CmpModalidadId_<?php echo $DatFichaAccion->MinSigla?>" id="CmpModalidadId_<?php echo $DatFichaAccion->MinSigla?>" sigla="<?php echo $DatFichaAccion->MinSigla?>" /></td>
                            <td width="184" align="left" valign="top"><input name="CmpFecha_<?php echo $DatFichaAccion->MinSigla?>" type="hidden" id="CmpFecha_<?php echo $DatFichaAccion->MinSigla?>" value="<?php echo $DatFichaAccion->FccFecha;?>" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpFichaAccionManoObra_<?php echo $DatFichaAccion->MinSigla?>" type="text" class="EstFormularioCaja" id="CmpFichaAccionManoObra_<?php echo $DatFichaAccion->MinSigla?>" value="<?php echo number_format($DatFichaAccion->FccManoObra,2);?>" size="10" maxlength="10" readonly="readonly" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
					...
					?>
                     ...
                     <div class="EstFormularioArea" id="CapModalidad">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            <td width="32%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="4%" align="left" valign="top"><a href="javascript:FncGarantiaTareaEliminarTodo('<?php echo $DatFichaAccion->MinSigla?>');">
                                    <input type="hidden" name="CmpFichaAccion<?php echo $DatFichaAccion->MinSigla?>TareaAccion" id="CmpFichaAccion<?php echo $DatFichaAccion->MinSigla?>TareaAccion" value="AccGarantiaTareaRegistrar.php" />
                                  </a></td>
                                  ...
                                  <td width="49%" align="right" valign="top"><a href="javascript:FncGarantiaTareaListar('<?php echo $DatFichaAccion->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a></td>
                                  <td width="1%" align="left" valign="top"><div id="CapFichaAccionTareasResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td colspan="2" align="left" valign="top">* Las TAREAS asignadas inicialmente desde la ORDEN DE TRABAJO van en este espacio</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                            ...
                            <td width="34%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="4%"><input type="hidden" name="CmpFichaAccion<?php echo $DatFichaAccion->MinSigla?>ProductoAccion" id="CmpFichaAccion<?php echo $DatFichaAccion->MinSigla?>ProductoAccion" value="AccGarantiaProductoRegistrar.php" /></td>
                                  <td width="47%"><div class="EstFormularioAccion" id="Cap<?php echo $DatFichaAccion->MinSigla?>ProductoAccion">Listo
                                    para registrar elementos </div></td>
                                  <td width="48%" align="right"><a href="javascript:FncGarantiaProductoListar('<?php echo $DatFichaAccion->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a></td>
                                  <td width="1%"><div id="CapFichaAccion<?php echo $DatFichaAccion->MinSigla?>ProductosResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td colspan="2">Los PRODUCTOS asignados inicialmente desde la ORDEN DE TRABAJO van en este espacio</td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                            ...
                            <td width="34%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="4%"><span class="EstFormularioAccion">
                                    <input type="hidden" name="CmpFichaAccion<?php echo $DatFichaAccion->MinSigla?>SuministroAccion" id="CmpFichaAccion<?php echo $DatFichaAccion->MinSigla?>SuministroAccion" value="AccGarantiaSuministroRegistrar.php" />
                                  </span></td>
                                  <td width="47%"><div class="EstFormularioAccion" id="Cap<?php echo $DatFichaAccion->MinSigla?>SuministroAccion">Listo
                                    para registrar elementos </div></td>
                                  <td width="48%" align="right"><a href="javascript:FncGarantiaSuministroListar('<?php echo $DatFichaAccion->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a><a href="javascript:FncGarantiaSuministroEliminarTodo('<?php echo $DatFichaAccion->MinSigla?>');"></a></td>
                                  <td width="1%"><div id="CapFichaAccion<?php echo $DatFichaAccion->MinSigla?>SuministrosResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
					...
					<div class="EstFormularioArea" >
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="69%"><span class="EstFormularioSubTitulo"> TAREAS del Plan de Mantenimiento</span></td>
                            <td width="30%" align="right"><a href="javascript:FncGarantiaMantenimientoListar('<?php echo $DatFichaAccion->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a></td>
                            <td width="0%">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                              ...
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="1%"><span class="EstFormularioAccion">
                                    <input type="hidden" name="CmpFichaAccionHerramientaAccion" id="CmpFichaAccionHerramientaAccion" value="AccGarantiaHerramientaRegistrar.php" /></span></td>
                                  <td width="49%"><div class="EstFormularioAccion" id="CapHerramientaAccion">Listo
                                    para registrar elementos
                                      
                                  </div></td>
                                  <td width="49%" align="right"><a href="javascript:FncGarantiaHerramientaListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a><a href="javascript:FncGarantiaHerramientaEliminarTodo();"></a></td>
