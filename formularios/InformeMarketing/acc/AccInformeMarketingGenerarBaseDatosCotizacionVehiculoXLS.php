...
$dat->CveTotal = (($dat->CveTotal/(empty($dat->CveTipoCambio)?1:$dat->CveTipoCambio)));
        ...
        <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle" width="13%"   ><?php echo $dat->CveId;  ?></td>
                ...
                <td  width="9%" align="right" ><?php echo $dat->LtiNombre;  ?></td>
                ...
                <td  width="14%" align="left" ><?php echo $dat->CliEmail;  ?></td>
                <td  width="14%" align="left" ><?php echo $dat->TrfNombre;  ?></td>
    </tr>
        <?php
		$f++;
