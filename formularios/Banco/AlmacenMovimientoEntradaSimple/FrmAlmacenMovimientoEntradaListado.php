...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ENTRADAS A ALMACEN</span>  </td>
</tr>
<tr>
  <td width="47%">
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->AmoId; ?>" nota_credito_compra="<?php echo $dat->AmoNotaCreditoCompra;?>" />				</td>
...
?>
			...
			?>
                  ...
                  <a href="javascript:FncVistaPreliminar('<?php echo $dat->AmoId;?>');"><img src="imagenes/preliminar.gif" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
			...
			?>        
                  ...
                  <a href="javascript:FncImprmir('<?php echo $dat->AmoId;?>');"><img src="imagenes/imprimir.gif" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
