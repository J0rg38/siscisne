          ...
          <td align="left" valign="top"><fieldset  class="EstFormularioContenedor">
            ...
            <table border="0" cellpadding="2" cellspacing="2">
              <tr>
                ...
                <td>
                <a href="javascript:FncProductoNuevo();"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                ...
                <input class="EstFormularioCaja" name="CmpProductoCodigoOriginal" type="text"  id="CmpProductoCodigoOriginal" value="" size="10" maxlength="10"/>
...
<tr>
  ...
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Producto/IfrProductoConsulta.php" target="IfrProductoConsulta" id="IfrProductoConsulta" name="IfrProductoConsulta" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
