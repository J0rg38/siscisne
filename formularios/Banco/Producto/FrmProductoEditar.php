		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td align="left" valign="top"><span id="sprytextfield4">
              <input name="CmpNombre" type="text" class="EstFormularioCaja" id="CmpNombre" value="<?php echo $InsProducto->ProNombre;?>" size="40" maxlength="200"  />
          ...
          <tr>
            ...
            <td align="left" valign="top"><span id="sprytextfield7">
              <label>
                <input class="EstFormularioCaja"  name="CmpStockMinimo" type="text" id="CmpStockMinimo" value="<?php if(empty($InsProducto->ProStockMinimo)){ echo "0.00";}else{ echo $InsProducto->ProStockMinimo; }?>" size="15" maxlength="10" />
                </label>
              <span class="textfieldRequiredMsg"><img src="imagenes/advertencia.png" width="20" height="20" border="0" align="absmiddle" title="Debe completar este campo" alt="[A]"  /></span></span></td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
			...
			?>
              <select class="EstFormularioCombo" name="CmpStockVerificado" id="CmpStockVerificado">
        ...
        <div class="EstFormularioArea">
           ...
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               ...
               <tr>
               <td>&nbsp;</td>
               <td><iframe src="formularios/Producto/acc/AccProductoSubirArchivo.php?Identificador=<?php echo $Identificador;?>" id="IfrProductoSubirArchivo" name="IfrProductoSubirArchivo" scrolling="Auto"  frameborder="0" width="100%" height="500"></iframe></td>
               <td>&nbsp;</td>
             </tr>           
             </table>
	...
	<tr>
        ...
        <div class="EstFormularioArea">
           ...
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="1%">&nbsp;</td>
               <td width="98%"><span class="EstFormularioSubTitulo">Archivo de Especififaciones del Producto</span></td>
               <td width="1%">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               ...
               <tr>
               <td>&nbsp;</td>
               <td><iframe src="formularios/Producto/acc/AccProductoSubirArchivoEspecificacion.php?Identificador=<?php echo $Identificador;?>" id="IfrProductoSubirArchivoEspecificacion" name="IfrProductoSubirArchivoEspecificacion" scrolling="Auto"  frameborder="0" width="100%" height="500"></iframe></td>
               <td>&nbsp;</td>
             </tr>           
             </table>
             ...
             <tr>
               ...
               <td><div class="EstFormularioArea">
                 <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                   ...
                   <tr>
                     <td>&nbsp;</td>
                     <td><a href="javascript:FncProductoCodigoReemplazoNuevo();"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                     ...
                     <td><a href="javascript:FncProductoCodigoReemplazoGuardar();"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                     <td>&nbsp;</td>
                   </tr>
                 </table>
               </div></td>
               ...
               <td><div class="EstFormularioArea" >
                 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                   <tr>
                     ...
                     <td width="49%" align="right"><a href="javascript:FncProductoCodigoReemplazoListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> Recargar</a><a href="javascript:FncProductoCodigoReemplazoEliminarTodo();"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/></a></td>
