...
if (!empty($_FILES)) {
	...
	$targetPath = '../../../subidos/producto_especificaciones/';
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg" || $extension=="pdf" || $extension=="doc" || $extension=="docx" || $extension=="xls" || $extension=="xlsx"){
		...
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesProEspecificacion'.$Identificador] = $file_name;
?>
Vista Previa:<br />
...
}elseif(!empty($_SESSION['SesProEspecificacion'.$Identificador])){
