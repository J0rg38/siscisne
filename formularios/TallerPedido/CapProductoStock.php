...
if(!empty($POST_AlmacenId)){
	...
	//$StockReal = $InsAlmacenProducto->MtdObtenerAlmacenProductoStockActual($POST_ProductoId,$POST_AlmacenId,date("Y"),$_SESSION['SesionSucursal']);
	$StockReal = $InsAlmacenStock->MtdObtenerAlmacenStockProductoStockReal($Sucursal,$POST_AlmacenId,date("Y"),$POST_ProductoId);
...
?>
  ...
  <a href="javascript:FncAlmacenStockConsultarCargar('<?php echo trim($POST_ProductoId);?>');">
    <?php
if($VerificarStock == 1){
?>
