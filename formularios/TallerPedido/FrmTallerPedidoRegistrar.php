...
require_once($InsPoo->MtdPaqActividad() . 'ClsFichaIngresoManoObra.php');
    ...
    if ($InsFichaIngreso->FinEstado == 4 || $InsFichaIngreso->FinEstado == 5) {

      include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccTallerPedidoRegistrar.php');
    }
   ...
   <?php
    if ($InsFichaIngreso->FinEstado == 4 || $InsFichaIngreso->FinEstado == 5 || !$Registro) {
    ?>
...
<?php
       ...
       <div class="EstCapContenido">
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
           ...
           <tr>
             <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ATENDER ORDEN DE TRABAJO (ALMACEN)</span></td>
           </tr>
           <tr>
             <td colspan="2">
                 ...
                 <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                   <tr>
                     ...
                     <td colspan="3" align="left" valign="top"> <input name="CmpFichaIngresoCliente" type="text" class="EstFormularioCaja" id="CmpFichaIngresoCliente" value="<?php echo $InsFichaIngreso->CliNombre; ?> <?php echo $InsFichaIngreso->CliApellidoPaterno; ?> <?php echo $InsFichaIngreso->CliApellidoMaterno; ?>" size="45" readonly="readonly" />
                       ...
                       <input name="CmpFichaIngresoClienteId" type="hidden" class="EstFormularioCaja" id="CmpFichaIngresoClienteId" value="<?php echo $InsFichaIngreso->CliId; ?>" size="45" readonly="readonly" />
                     </td>
                   ...
                   <tr>
                     ...
                     <td colspan="9" align="left" valign="top"><input name="CmpPersonalNombre" type="text" class="EstFormularioCaja" id="CmpPersonalNombre" value="<?php echo $InsFichaIngreso->PerNombre; ?>" size="20" readonly="readonly" />
                       ...
                       <input name="CmpPersonal3" type="text" class="EstFormularioCaja" id="CmpPersonal3" value="<?php echo $InsFichaIngreso->PerApellidoMaterno; ?>" size="20" readonly="readonly" />
                     </td>
                     <td align="left" valign="top">&nbsp;</td>
                   </tr>
                   <tr>
                   ...
                   <tr>
                     <td colspan="11" align="left" valign="top"><a href="javascript:FncPopUp('formularios/FichaIngreso/FrmFichaIngresoImprimirIN.php?Id=<?php echo $InsFichaIngreso->FinId; ?>&amp;P=',0,0,1,0,0,1,0,screen.height,screen.width);"><img src="imagenes/avisos/ficha.gif" alt="" width="25" height="25" border="0" align="Ficha" title="Ficha" /> Inventario</a> <a href="javascript:FncPopUp('formularios/FichaIngreso/FrmFichaIngresoImprimirFT.php?Id=<?php echo $InsFichaIngreso->FinId; ?>&amp;P=',0,0,1,0,0,1,0,screen.height,screen.width);"> <img src="imagenes/avisos/ficha.gif" alt="" width="25" height="25" border="0" align="Ficha" title="Ficha" /> Ficha Tecnica</a>
...
<img src="imagenes/iconos/documentos.png" alt="" width="25" height="25" border="0" align="Documentos" title="Documentos" />
Ver Documentacion
</a> 
  <?php
...
<?php	
                   ...
                   <tr>
                     <td colspan="11" align="left" valign="top">
                       ...
                       <span class="EstFormularioResaltar">Marcar como TRABAJO TERMINADO una vez guardado este formulario</span>
                     </td>
                   </tr>
                 </table>
               </div>
                         ...
                         <td colspan="4">
                           ...
                           <div class="EstFormularioArea">
                             <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                               <tr>
                                 <td>&nbsp;</td>
                                 <td colspan="6"><span class="EstFormularioSubTitulo">Datos del PEDIDO DE TALLER: <?php echo strtoupper($DatTallerPedido->MinNombre); ?></span>
                            ...
                            -->
                               ...
                               <tr>
                                    ...
                                    ?>
                                     ...
                                     <script type="text/javascript">
                                       Calendar.setup({
                                         ...
                                         ifFormat: "%d/%m/%Y", //  
                                         button: "BtnFecha_<?php echo $DatTallerPedido->MinSigla ?>" // el id del bot�n que  
                                       });
                                     </script> <?php
                                              }
                                                ?>
                                 ...
                                 <td align="left" valign="top">Mano de Obra e Insumos: <br /><span class="EstFormularioSubEtiqueta"> (%)</span></td>
                                 <td align="left" valign="top"> <input name="CmpPorcentajeMantenimiento_<?php echo $DatTallerPedido->MinSigla ?>" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPorcentajeMantenimiento_<?php echo $DatTallerPedido->MinSigla ?>" value="<?php echo number_format($DatTallerPedido->AmoPorcentajeMantenimiento, 2); ?>" size="15" maxlength="20" readonly="readonly" />
                             ...
                             <div class="EstFormularioArea" id="CapModalidad">
                                     ...
                                     <div class="EstFormularioArea">
                                       <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                         ...
                                         <tr>
                                           ...
                                           <td>
                                             <div id="Cap<?php echo $DatTallerPedido->MinSigla ?>ProductoBuscar"></div>
                                           </td>
                                           <td>&nbsp;</td>
                                         </tr>
                                         <tr>
                                           ...
                                           <td><input name="CmpTallerPedidoDetalleFecha_<?php echo $DatTallerPedido->MinSigla ?>" type="text" class="EstFormularioCajaFecha" id="CmpTallerPedidoDetalleFecha_<?php echo $DatTallerPedido->MinSigla ?>" size="10" maxlength="20" readonly="readonly" />
                                             ...
                                             <script type="text/javascript">
                                               Calendar.setup({
                                                 ...
                                                 ifFormat: "%d/%m/%Y", //  
                                                 button: "BtnTallerPedidoDetalleFecha_<?php echo $DatTallerPedido->MinSigla ?>" // el id del bot�n que  
                                               });
                                             </script>
								...
								*/
                                         ...
                                         <tr>
                                           <td>&nbsp;</td>
                                           <td width="49%">
                                             <div class="EstFormularioAccion" id="Cap<?php echo $DatTallerPedido->MinSigla ?>ProductoAccion">Listo
 ...
 -->
								...
								*/
                                         ...
                                         <tr>
                                           <td>&nbsp;</td>
                                           <td colspan="2">
                                             <div id="CapTallerPedido<?php echo $DatTallerPedido->MinSigla ?>Productos" class="EstCapTallerPedidoDetalles"></div>
                                           </td>
                                           <td>&nbsp;</td>
                                         </tr>
                                         <tr>
                                     ...
                                     <div class="EstFormularioArea">
                                       <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                         ...
                                         <tr>
                                           <td align="left" valign="top">&nbsp;</td>
                                           <td align="left" valign="top">
                                             <div class="EstFormularioCajaObservacion"> <?php echo stripslashes($FichaAccionPedido); ?> </div>
                                           </td>
                                           <td align="left" valign="top">&nbsp;</td>
                                         </tr>
                                         <tr>
                                     ...
                                     <div class="EstFormularioArea">
                                       <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                         ...
                                         <tr>
                                           <td align="left" valign="top">&nbsp;</td>
                                           <td colspan="2" align="left" valign="top">
                                             <div class="EstCapTallerPedidoFotos" id="CapTallerPedido<?php echo $DatFichaIngresoModalidad->MinSigla; ?>Fotos"></div>
                                           </td>
                                           <td align="left" valign="top">&nbsp;</td>
                                         </tr>
                                         <tr>
                             ...
                             <div class="EstFormularioArea">
                               <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                 ...
                                 <tr>
                                   <td>&nbsp;</td>
                                   <td colspan="2">
                                     <div id="CapTallerPedido<?php echo $DatTallerPedido->MinSigla ?>Mantenimientos" class="EstCapTallerPedidoMantenimientos"> </div>
                                   </td>
                                   <td>&nbsp;</td>
                                 </tr>
                                 <tr>
                                   ...
                                   <td colspan="2">
                                     <div class="EstFormularioArea">
                                       <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                         <tr>
                                           <td>&nbsp;</td>
                                           <td colspan="13"><span class="EstFormularioSubTitulo">PRODUCTOS ADICIONALES </span><span class="EstFormularioSubTitulo">
                           ...
                           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                             <tr>
                               ...
                               <td><span class="EstFormularioAccion">
                                   <input type="hidden" name="CmpTallerPedidoHerramientaAccion" id="CmpTallerPedidoHerramientaAccion" value="AccTallerPedidoHerramientaRegistrar.php" />
                                 </span></td>
                               <td align="right">&nbsp;</td>
                               <td>&nbsp;</td>
                             </tr>
                             <tr>
                               ...
                               <td width="49%" align="right">
                                 ...
                                 <a href="javascript:FncTallerPedidoHerramientaListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a>
                               ...
                               <td width="1%">
                                 <div id="CapTallerPedidoHerramientasResultado"> </div>
                               </td>
                             </tr>
                             <tr>
                               <td>&nbsp;</td>
                               <td colspan="2">
                                 <div id="CapTallerPedidoHerramientas" class="EstCapTallerPedidoHerramientas"></div>
                               </td>
                               <td>&nbsp;</td>
                             </tr>
                             <tr>
                                   ...
                                   <table width="918" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     ...
                                     <tr>
                                       ...
                                       <td align="left" valign="top">
                                         ...
                                         <!--<a href="comunes/Producto/FrmProductoBuscar.php?height=440&amp;width=850&amp;Modalidad=<?php echo $DatTallerPedido->MinSigla ?>" class="thickbox" title=""><img src="imagenes/acciones/buscador.png" width="25" height="25" border="0" align="absmiddle" ></a>-->
                                       </td>
                                     </tr>
                                   </table>
                                 </div>
                                 ...
                                 <div class="EstFormularioArea">
                                   <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     <tr>
                                       <td width="1%">&nbsp;</td>
                                       <td width="49%">
                                         <div class="EstFormularioAccion" id="CapTallerPedidoGastoAccion">Listo
                                           para registrar elementos</div>
                                       </td>
                                       ...
                                       <td width="1%">
                                         <div id="CapTallerPedidoGastosResultado"> </div>
                                       </td>
                                     </tr>
                                     <tr>
                                       <td>&nbsp;</td>
                                       <td colspan="2">
                                         <div id="CapTallerPedidoGastos" class="EstCapTallerPedidoGastos"> </div>
                                       </td>
                                       <td>&nbsp;</td>
                                     </tr>
                                     <tr>
                                 ...
                                 <div class="EstFormularioArea">
                                   <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     <tr>
                                       <td width="3%">&nbsp;</td>
                                       <td width="47%">
                                         <div class="EstFormularioAccion" id="CapTallerPedidoHistorialAccion">Listo
                                           para registrar elementos</div>
                                       </td>
                                       ...
                                       <td width="1%">
                                         <div id="CapTallerPedidoHistorialesResultado"> </div>
                                       </td>
                                     </tr>
                                     <tr>
                                       <td>&nbsp;</td>
                                       <td colspan="2">
                                         <div id="CapTallerPedidoHistoriales" class="EstCapTallerPedidoHistoriales"> </div>
                                       </td>
                                       <td>&nbsp;</td>
                                     </tr>
                                     <tr>
                                 ...
                                 <div class="EstFormularioArea">
                                   <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     <tr>
                                       <td width="3%">&nbsp;</td>
                                       <td width="47%">
                                         <div class="EstFormularioAccion" id="CapTallerPedidoCotizacionesAccion">Listo
                                           para registrar elementos</div>
                                       </td>
                                       ...
                                       <td width="1%">
                                         <div id="CapTallerPedidoCotizacionesResultado"> </div>
                                       </td>
                                     </tr>
                                     <tr>
                                       <td>&nbsp;</td>
                                       <td colspan="2">
                                         <div id="CapTallerPedidoCotizaciones" class="EstCapTallerPedidoCotizaciones"> </div>
                                       </td>
                                       <td>&nbsp;</td>
                                     </tr>
                                     <tr>
                                 ...
                                 <div class="EstFormularioArea">
                                   <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     ...
                                     <tr>
                                       <td align="left" valign="top">&nbsp;</td>
                                       <td align="left" valign="top">
                                         <div class="EstFormularioCajaObservacion"> <?php echo stripslashes($InsFichaIngreso->FinSalidaObservacion); ?> </div>
                                       </td>
                                       <td align="left" valign="top">&nbsp;</td>
                                     </tr>
                                     <tr>
                                   ...
                                   <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     <tr>
                                       ...
                                       <td colspan="2" align="left" valign="top">
                                         ...
                                         <a href="javascript:FncTallerPedidoFotoVINListar();"></a>
                                       </td>
                                       <td width="4" align="left" valign="top">&nbsp;</td>
                                     </tr>
                                     <tr>
                                     ...
                                     <tr>
                                       ...
                                       <td align="left" valign="top">&nbsp;</td>
                                       <td align="left" valign="top">
                                         <div class="EstCapTallerPedidoFotoVINs" id="CapTallerPedidoFotoVINs"></div>
                                       </td>
                                       <td align="left" valign="top">&nbsp;</td>
                                     </tr>
                                     <tr>
                                 ...
                                 <div class="EstFormularioArea">
                                   <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     ...
                                     <tr>
                                       ...
                                       <td align="left" valign="top">&nbsp;</td>
                                       <td align="left" valign="top">
                                         <div class="EstCapTallerPedidoFotoDelanteras" id="CapTallerPedidoFotoDelanteras"></div>
                                       </td>
                                       <td align="left" valign="top">&nbsp;</td>
                                     </tr>
                                     <tr>
                                 ...
                                 <div class="EstFormularioArea">
                                   <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     ...
                                     <tr>
                                       ...
                                       <td align="left" valign="top">&nbsp;</td>
                                       <td align="left" valign="top">
                                         <div class="EstCapTallerPedidoFotoCupones" id="CapTallerPedidoFotoCupones"></div>
                                       </td>
                                       <td align="left" valign="top">&nbsp;</td>
                                     </tr>
                                     <tr>
                                 ...
                                 <div class="EstFormularioArea">
                                   <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                     ...
                                     <tr>
                                       ...
                                       <td align="left" valign="top">&nbsp;</td>
                                       <td align="left" valign="top">
                                         <div class="EstCapTallerPedidoFotoMantenimientos" id="CapTallerPedidoFotoMantenimientos"></div>
                                       </td>
                                       <td align="left" valign="top">&nbsp;</td>
                                     </tr>
                                     <tr>
