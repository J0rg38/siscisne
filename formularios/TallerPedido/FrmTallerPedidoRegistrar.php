...
<input type="hidden"  name="CmpCotizacionProductoId" id="CmpCotizacionProductoId" value="<?php echo $InsFichaIngreso->CprId;?>"      />
    ...
    <tr>
      ...
      <input type="checkbox" name="CmpFichaIngresoEnviar" id="CmpFichaIngresoEnviar" value="1" />
       <span class="EstFormularioResaltar">Marcar como TRABAJO TERMINADO una vez guardado este formulario</span></td>
      </tr>
  </table>
</div>  
<br />
...
<input type="hidden" name="CmpAlmacen_<?php echo $DatTallerPedido->MinSigla?>" id="CmpAlmacen_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->AlmId;?>" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
