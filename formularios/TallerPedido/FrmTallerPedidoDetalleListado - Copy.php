...
<br />
            ...
            <tr>
              ...
              <td align="left" >&nbsp;</td>
              <td width="64%" align="right" class="Total">&nbsp;</td>
...
<tr>
  ...
  <th width="6%" align="center">Almacen</th>
  <th width="7%" align="center">Stk.</th>
  <th width="10%" align="center">Estado</th>
...
//MtdObtenerAlmacenProductoStockActual($oProducto,$oAlmacen,$oAno)
$StockReal = $InsAlmacenProducto->MtdObtenerAlmacenProductoStockActual($DatSesionObjeto->Parametro2,$DatSesionObjeto->Parametro31,date("Y"));
...
?>
    ...
    <!-- <?php if(!empty($DatSesionObjeto->Parametro27)){?>+ <b><?php echo number_format($DatSesionObjeto->Parametro27,2);?></b><?php }?>) -->
    </a>
