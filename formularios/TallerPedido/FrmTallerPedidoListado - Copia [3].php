...
<?php $PrivilegioCotizacionProductoRegistrar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"CotizacionProducto","Registrar"))?true:false;?>
...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsTallerPedido.js" ></script>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccTallerPedido.php');
...
//MtdObtenerFichaIngresos( $oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FinId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oPrioridad=NULL,$oModalidadIngreso=NULL,$oVIN=NULL,$oClienteId=NULL,$oPersonalId=NULL,$oTrabajoConcluido=0,$oCampana=NULL,$oClienteTipo=NULL,$oTipo=NULL,$oSalidaExterna=NULL)
										//											//MtdObtenerFichaIngresos( $oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FinId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oPrioridad=NULL,$oModalidadIngreso=NULL,$oVIN=NULL,$oClienteId=NULL,$oPersonalId=NULL,$oTrabajoConcluido=0,$oCampana=NULL,$oClienteTipo=NULL,$oTipo=NULL,$oSalidaExterna=NULL,$oConCampana=NULL)
if($POST_ChkIgnorarFacturados=="1"){
	$tipo = "4,5,6,7,71,72,73,74,75,8";	
}else{
	$tipo = "4,5,6,7,71,72,73,74,75,8,9,10";
}

//$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FinConductor,VmaNombre,VmoNombre,VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"4,5,6,7,71,72,73,74,75,8,9",$POST_Prioridad,$POST_Modalidad,NULL,NULL,NULL,0,NULL,NULL,NULL,2,$POST_ConCampana);
...
//    public function MtdObtenerFichaIngresos( $oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FinId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oPrioridad=NULL,$oModalidadIngreso=NULL,$oVIN=NULL,$oClienteId=NULL,$oPersonalId=NULL,$oTrabajoConcluido=0,$oCampana=NULL,$oClienteTipo=NULL,$oTipo=NULL,$oSalidaExterna=0,$oConCampana=NULL) {
	//
	//CAST(fin.FinEstado as VARCHAR(3)) 
	//CAST(fin.FinEstado as CHAR(3))  ASC
...
$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FinConductor,VmaNombre,VmoNombre,VveNombre,per.PerNombre,per.PerApellidoPaterno,per.PerApellidoMaterno",$POST_con,$POST_fil,"fin.FinEstado ASC,".$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$tipo,$POST_Prioridad,$POST_Modalidad,NULL,NULL,$POST_Personal,0,NULL,NULL,$POST_Tipo,0,$POST_ConCampana);//73,74,75,8,9
...
//function FncRecargar(){
//	location.reload();
//}
//
//$(function(){
//	setInterval("FncRecargar();",30000);
//});
...
<form id="FrmListado" name="FrmListado"  enctype="multipart/form-data" method="POST" action="#" >    
   ...
   <!-- <div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTallerSeleccionados();"><img src="imagenes/iconos/enviar_taller2.png" alt="[Enviar OT a Taller]" title="Enviar OT a Taller" />Taller</a></div> -->
    
<!--	<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTallerSeleccionados2();"><img src="imagenes/iconos/enviar_almacen_cancelar2.png" alt="[Rechazar envio de OT de Taller]" title="Rechazar envio de OT de Taller" /> Rechazar </a></div>
    -->
    <div class="EstSubMenuSeparacion"></div>
    
	<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTallerSeleccionados3();"><img src="imagenes/iconos/enviar_almacen_anular.png" alt="[Anular recepcion de OT de Taller]" title="Anular recepcion de OT de Taller" /> Anular </a></div>
    
    
    
    <div class="EstSubMenuSeparacion"></div>
    
    <div class="EstSubMenuBoton"><a href="javascript:FncMarcarTrabajoTerminadoSeleccionados();"><img src="imagenes/iconos/marcar_terminado.png" alt="[Marcar como Trabajo Terminado]" title="Marcar como Trabajo Terminado" /> Terminado</a></div> 

<!--	<div class="EstSubMenuBoton"><a href="javascript:FncDesmarcarTrabajoTerminadoSeleccionados();"><img src="imagenes/iconos/marcar_terminado_cancelar.png" alt="[Desmarcar como Trabajo Terminado]" title="Desmarcar como Trabajo Terminado" />  Desmarcar</a></div> -->
    ...
    <tr>
      ...
      <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO con PEDIDO DE TALLER [ALMACEN]</span></td>
      <td height="25" align="right" valign="top">
      <img src='imagenes/iconos/almacen.png' alt='ALMACEN' border='0' width='50' height='50' title='ALMACEN'  align="absmiddle">
      </td>
    </tr>
    <tr>
    ...
    Fecha Inicio:
      ...
      <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaFin" name="BtnFechaFin" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
        ...
        <input type="checkbox" name="ChkIgnorarFacturados" id="ChkIgnorarFacturados" value="1" <?php echo (($POST_ChkIgnorarFacturados=="1")?'checked="checked"':'');?>  /> Ignorar Facturados
     ...
     <tbody class="EstTablaListadoBody">
                <?php
                  ...
                  <tr id="Fila_<?php echo $f;?>">
                    <td width="2%" align="center" bgcolor="<?php echo $dat->FinPrioridadColor;?>"    ><?php echo $f;?></td>
                    <td width="2%" align="center"  >
                      
                      <?php
    //if($PrivilegioEditar and ($dat->FinEstado == 5 or $dat->FinEstado == 6)){
    ?>             
                      <input indice="<?php echo $f;?>"   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FinId; ?>" estado="<?php echo $dat->FinEstado;?>"  garantia="<?php echo $dat->FinGarantiaGenerar;?>" concluido="<?php echo $dat->FinTiempoTallerConcluido;?>" />
                      <?php
    //}
    ?>	
                  ...
                  <!--    </span>
                     -->
                      ...
                      <?php
                    if(!empty($dat->FinTiempoTallerConcluido) and ($dat->FinEstado == 4 or $dat->FinEstado == 5 or $dat->FinEstado == 6 or $dat->FinEstado == 7)){
        ?>
        <!--<img src="imagenes/advertencia.png" alt="Revisar" title="Revisar" width="15" height="15" />			-->
    
    <img src="imagenes/alerta.gif" alt="Revisar" title="Revisar" width="25" height="25" />
    ...
    ?>
    <img  title="<?php echo $dat->CprSeguro;?>" src="subidos/cliente_fotos/<?php echo $nombre_base.".".$extension;?>" width="25" height="25" border="0" />
    <?php
    }
    ?>
...
?>	 
                        ...
                        ?>
                                ...
                                <?php		
									...
									if($DatFichaIngresoModalidad->MinSigla <> "MA"){
                                        $TieneGarantia = true;
                                        $GarantiaFichaAccionId = $DatFichaIngresoModalidad->FccId;
                                    }
                                ?>
                    ...
                    <td  width="3%" align="left" ><?php echo $dat->FinFecha;  ?> <?php echo $dat->FinHora;  ?></td>
                    <td  width="5%" align="left" bgcolor="#AEE3AE" ><?php echo (empty($dat->FinFechaEntrega)?'':$dat->FinFechaEntrega);?> <?php echo ((empty($dat->FinHoraEntrega) or $dat->FinHoraEntrega == "00:00:00")?'':$dat->FinHoraEntrega);?></td>
                    <td  width="3%" align="left" ><?php echo ($dat->FinFechaGarantia);?>
                      <?php if(!empty($dat->FinGarantiaDiaTranscurrido)){?>
    (<?php echo $dat->FinGarantiaDiaTranscurrido;?>)
    <?php }?></td>
                    <td  width="3%" align="left" ><?php echo (empty($dat->LtiAbreviatura)?$dat->LtiNombre:$dat->LtiAbreviatura)//FncCortarTexto($dat->LtiNombre,15);?></td>
...
?>
                    ...
                    <td  width="5%" align="left" ><?php echo ($dat->VmaNombre);?></td>
                    <td  width="7%" align="left" ><?php echo ($dat->VmoNombre);?></td>
                    <td  width="6%" align="left" ><?php echo ($dat->VveNombre);?></td>
                    <td  width="4%" align="left" ><?php echo ($dat->EinColor);?></td>
                    <td  width="4%" align="left" ><?php echo ($dat->EinPlaca);?></td>
                    <td  width="4%" align="left" ><?php echo ($dat->FinVehiculoKilometraje);?></td>
                    <td  width="11%" align="left" ><?php echo ($dat->PerNombre);?></td>
    ...
    ?>
      <a href="formularios/TallerPedido/DiaAlmacenMovimientoListado.php?height=440&width=850&FinId=<?php echo $dat->FinId?>" class="thickbox" title=""><img src="imagenes/acciones/enlace.gif" align="Enlace" title="Enlace" border="0" width="18" height="18" /> Fichas Salida</a>
             <br />         
    ...
    //if($dat->FinAlmacenMovimientoSalida == "Si"){
    ?>
        <a href="javascript:FncFichaTecnicaVistaPreliminar('<?php echo $dat->FinId?>');" title=""><img src="imagenes/acciones/enlace.gif" align="Enlace" title="Enlace" border="0" width="18" height="18" /> Ficha Tecnica</a>
        <br />
   ...
   <?php
    //if($dat->FinAlmacenMovimientoSalida == "Si"){
    ?>
                      <a href="javascript:FncFichaInternaVistaPreliminar('<?php echo $dat->FinId?>');" title=""><img src="imagenes/acciones/enlace.gif" align="Enlace" title="Enlace" border="0" width="18" height="18" /> Ficha Interna</a>
<br />                      
                    <?php	
    //}
    ?>                   
    ...
    //if($dat->FinAlmacenMovimientoSalida == "Si"){
    ?>
    <a href="formularios/TallerPedido/DiaPedidoCompraListado.php?height=440&amp;width=850&amp;FinId=<?php echo $dat->FinId?>" class="thickbox" title=""><img src="imagenes/acciones/enlace.gif" align="Enlace" title="Enlace" border="0" width="18" height="18" /> Ord. Compra </a>
    <br />
	<?php	
    //}
    ?>       
             <?php
                    ...
                    ?>
    <a href="formularios/FichaIngreso/DiaCotizacionProductoListado.php?height=440&amp;width=850&amp;FinId=<?php echo $dat->FinId?>" class="thickbox" title=""><img src="imagenes/acciones/enlace.gif" alt="" width="18" height="18" border="0" align="Enlace" title="Enlace" /> Cot.</a>                
                   <br />
                    <?php
                    }
                    ?>   
    ...
    ?>
      <a href="formularios/TrabajoTerminado/DiaGarantiaListado.php?height=440&amp;width=850&amp;FinId=<?php echo $dat->FinId?>" class="thickbox" title=""><img src="imagenes/acciones/enlace.gif" align="Enlace" title="Enlace" border="0" width="18" height="18" />  Hoja Garantia</a>
...
<?php
//deb($dat->FinEstado." - ".$dat->FinCierre);
?>
    <?php
    ...
    <?php
    if($PrivilegioRegistrar and $dat->FinEstado == 4  ){
    ?>		                
        <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Registrar&FinId=<?php echo $dat->FinId;?>"><img src="imagenes/generar.jpg" width="19" height="19" border="0" title="Atender Pedido de Taller" alt="[Atender Pedido de Taller]"   /></a>                
    <?php
    }
    ?>  
    ...
    if($PrivilegioEditar and ($dat->FinEstado == 5 or $dat->FinEstado == 6)){
    ?>             
        <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $dat->FinId;?>"><img src="imagenes/editar.gif" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>                 
    <?php
    }
    ?>				
    
    <?php
    if($PrivilegioVer and $dat->FinEstado <> 4 ){
    ?>		                
        
        <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->FinId;?>"><img src="imagenes/ver.gif" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>                
    ...
    <?php
    /*if($PrivilegioEditar and ($dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 72)){
    ?>             
        <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Extornar&Id=<?php echo $dat->FinId;?>"><img src="imagenes/extornar.png" width="19" height="19" border="0" title="Extornar" alt="[Extornar]"   /></a>                 
    <?php
    }*/
    ?>
    ...
    */
	...
	and ( 
		...
		$dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 73 or $dat->FinEstado == 74) or ( ($dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 73 or $dat->FinEstado == 74 or $dat->FinEstado == 75 or $dat->FinEstado == 9 or $dat->FinEstado == 10
...
//    if($PrivilegioEditar and ( $dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 73  or $dat->FinEstado == 74 or $dat->FinEstado == 75 or $dat->FinEstado == 9 or $dat->FinEstado == 10) ){
//    if($PrivilegioEditar and ($dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 73) or ($dat->FinEstado == 74 or $dat->FinEstado == 75 or $dat->FinEstado == 9 or $dat->FinEstado == 10 or $dat->FinCierre == 2)){
    ?>
    <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Trabajar&Id=<?php echo $dat->FinId;?>"><img src="imagenes/editar2.gif" width="19" height="19" border="0" title="Adicionar" alt="[Adicionar]"   /></a>
    <?php
    }
    ?>
    ...
    <?php
    //if($PrivilegioCotizacionProductoRegistrar and ($dat->FinEstado == 5 or $dat->FinEstado == 6 or $dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 72)){
    if($PrivilegioCotizacionProductoRegistrar ){
    ?>             
    <a href="principal.php?Mod=CotizacionProducto&Form=Registrar&Origen=TallerPedido&FinId=<?php echo $dat->FinId;?>"><img src="imagenes/iconos/cotizacion.png" width="19" height="19" border="0" title="Generar Cotizacion" alt="[Generar Cotizacion]"   /></a>        
    <?php
    }
    ?>
    
    <?php
    if($PrivilegioGenerarPedidoCompra and $TieneGarantia ){
	//    if($PrivilegioGenerarPedidoCompra  ){
    ?>		                
        <a href="principal.php?Mod=PedidoCompra&Form=Registrar&Origen=FichaAccion&FccId=<?php echo $GarantiaFichaAccionId;?>"><img src="imagenes/generar_pedido.png" width="19" height="19" border="0" title="Generar Pedido de Compra" alt="[Generar Pedido de Compra]"   /></a>                
    <?php
    }
    ?>
...
//    if($PrivilegioGenerarPedidoCompra and $TieneGarantia ){
	//    if($PrivilegioGenerarPedidoCompra  ){
    ?>		                
        <a href="principal.php?Mod=SolicitudDesembolso&Form=Registrar&Origen=FichaIngreso&FinId=<?php echo $dat->FinId;?>"><img src="imagenes/acciones/icon_solicitudes_desembolso50.png" width="19" height="19" border="0" title="Generar Solicitud de Desembolso" alt="[Generar Solicitud de Desembolso]"   /></a>                
    <?php
//    }
    ?>
    ...
    <br />
<table class="EstPanelTablaListado">
