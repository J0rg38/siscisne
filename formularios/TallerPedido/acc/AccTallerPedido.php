...
//deb($POST_acc);
	...
	case 'EnviarOrdenTrabajoContabilidad':
		...
		$InsFichaIngreso->MtdActualizarEstadoFichaIngreso($POST_seleccionados,73);
		$InsFichaIngreso->MtdActualizarEstadoFichaIngreso($POST_seleccionados,74);
