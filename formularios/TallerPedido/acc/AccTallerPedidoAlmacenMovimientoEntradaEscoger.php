...
$InsTallerPedidoAlmacenMovimientoEntrada1 = $_SESSION['InsTallerPedidoAlmacenMovimientoEntrada'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);

$json = new JSON;
$var = $json->serialize( $InsTallerPedidoAlmacenMovimientoEntrada1 );
