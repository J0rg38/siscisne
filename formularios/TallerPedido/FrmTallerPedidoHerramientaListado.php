...
$RepSesionObjetos = $_SESSION['InsTallerPedidoHerramienta'.$Identificador]->MtdObtenerSesionObjetos(true);
...
<tr>
  ...
  <th width="74%" align="center"> Nombre
</th>
...
?>
  ...
  <a class="EstSesionObjetosItem" href="javascript:FncTallerPedidoHerramientaEscoger('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
...
if($_POST['Eliminar']==1){
?>
  <a href="javascript:FncTallerPedidoHerramientaEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');" >
