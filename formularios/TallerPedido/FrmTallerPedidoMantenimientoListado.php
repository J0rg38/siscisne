...
if (!isset($_SESSION['InsTallerPedidoMantenimiento' . $ModalidadIngreso . $Identificador])) {
  ...
  $_SESSION['InsTallerPedidoMantenimiento' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTallerPedidoMantenimiento' . $ModalidadIngreso . $Identificador]);
}
        ...
        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
          ...
          <tr>
                            ...
                            ?>
                              ...
                              <td align="right" valign="top">
                                ...
                                <select class="EstFormularioCombo" name="CmpAlmacenId_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" id="CmpAlmacenId_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" <?php echo ($POST_Editar == 2 or  $TallerPedidoDetalleFacturado == "1" or $TallerPedidoDetalleCierre == "1") ? 'disabled="disabled"' : ''; ?>>
                                  ...
                                  ?>
                                    <option value="<?php echo $DatAlmacen->AlmId ?>" <?php if ($TallerPedidoDetalleAlmacenId == $DatAlmacen->AlmId) {
                                                                                      echo 'selected="selected"';
                                                                                    } ?>><?php echo $DatAlmacen->AlmSigla ?></option>
                                  <?php
                                  }
                                  ?>
                                </select>
                              ...
                              <td align="right" valign="top">
                                ...
                                <div id="CapTallerPedidoDetalleStock_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>"></div>
                              ...
                              <td align="right" valign="top">
                                ...
                                <select class="<?php echo (($TallerPedidoDetalleEstado == "1") ? 'EstFormularioComboAnulado' : 'EstFormularioCombo'); ?>" name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>TallerPedidoDetalleEstado" id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>TallerPedidoDetalleEstado" <?php //echo ($POST_Editar==2 or  $TallerPedidoDetalleFacturado == "1" or $TallerPedidoDetalleCierre == "1")?'disabled="disabled"':'';
                                                                                                                                                                                                                                                                                                                      ?>>
                                  <option value="">-</option>
            ...
            -->
                                ...
                                <!--  (<?php echo $TallerPedidoDetalleAlmacenId; ?>) -->
          ...
          <tr>
            ...
            <td colspan="6" align="center"><b>I:</b> Inspección/ajuste
              ...
              <b>R:</b> Realizar
              <b>U:</b> Agregar <b>P:</b> Consultivo
            </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
                          ...
                          ?>
                            ...
                            ?>
                              ...
                              <td align="right" valign="top">
                                ...
                                if (!empty($ArrSesionObjetos)) {
                                  foreach ($ArrSesionObjetos as $DatSesionObjeto) {
                                    ...
                                    //deb($DatSesionObjeto->Parametro21);
                                    //	deb($DatPlanMantenimientoTarea->PmtId);
                              ...
                              <td align="left" valign="top">
                                ...
                                <span style="color:#F8F8F8;">(<?php echo $DatPlanMantenimientoTarea->PmtId ?>) /
                                  (<?php echo $AlmacenMovimientoSalidaDetalleId; ?>) /
                                  (<?php echo $FichaAccionMantenimientoId; ?>) /
                                  (<?php echo  $FichaAccionProductoId; ?>) / (<?php echo $ProductoId; ?>)</span>
