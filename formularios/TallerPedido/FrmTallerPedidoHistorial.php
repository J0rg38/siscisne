...
?>
    ...
    ?>
            ...
            <tr>
              ...
              <th width="6%" align="center">O.T.</th>
            ...
            <tbody class="EstTablaListadoBody">
                ...
                <td align="right" valign="top"  class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>"><?php echo $DatFichaIngreso->FinId;?></td>
                <td align="right" valign="top"  class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>">
                  <?php echo $DatFichaIngreso->FinFecha;?></td>
                <td align="right" valign="top"  class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>"><?php echo $DatFichaIngreso->FinSalidaObservacion;?></td>
                <td align="right" valign="top"  class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>">
...
?>
                ...
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>"><?php echo $DatFichaIngreso->FinVehiculoKilometraje;?>km</td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>">
           ...
           <!--     <a href="javascript:FncPopUp('formularios/FichaIngreso/FrmFichaIngresoImprimirFT.php?Id=<?php echo $DatFichaIngreso->FinId;?>',0,0,1,0,0,1,0,screen.height,screen.width);"><img border="0"  align="absmiddle" src="imagenes/iconos/ficha_tecnica.png" alt="[Ver]" title="Ver Ficha Tecnica" width="15" height="15"  /></a>
                -->
             <a href="javascript:FncPopUp('formularios/FichaIngreso/FrmFichaIngresoImprimirFT.php?Id=<?php echo $DatFichaIngreso->FinId;?>',0,0,1,0,0,1,0,screen.height,screen.width);"><img border="0"  align="absmiddle" src="imagenes/acciones/ficha_tecnica.png" alt="[Ver Ficha Tecnica]" title="Ver Ficha Tecnica" width="25" height="25"  /></a>
                
                <a href="javascript:FncPopUp('formularios/FichaIngreso/FrmFichaIngresoImprimirFI.php?Id=<?php echo $DatFichaIngreso->FinId;?>',0,0,1,0,0,1,0,screen.height,screen.width);"><img border="0"  align="absmiddle" src="imagenes/acciones/ficha_interna.png" alt="[Ver Ficha Interna]" title="Ver Ficha Interna" width="25" height="25"  /></a>
                
                <?php
if($DatFichaIngreso->FinAlmacenMovimientoSalida == "Si"){
?>
                   <a href="javascript:FncTallerPedidoFichasVerListado('<?php echo $DatFichaIngreso->FinId?>');" ><img border="0"  align="absmiddle" src="imagenes/acciones/ficha_salida.png" alt="[Ver Fichas de Salida]" title="Ver Fichas de Salida" width="25" height="25"  /></a>
