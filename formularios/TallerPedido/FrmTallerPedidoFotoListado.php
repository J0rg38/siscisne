...
session_start();
if (!isset($_SESSION['InsTallerPedidoFoto' . $ModalidadIngreso . $Identificador])) {
  $_SESSION['InsTallerPedidoFoto' . $ModalidadIngreso . $Identificador] = new ClsSesionObjeto();
} else {
  $_SESSION['InsTallerPedidoFoto' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTallerPedidoFoto' . $ModalidadIngreso . $Identificador]);
}
...
//deb('InsTallerPedidoFoto'.$ModalidadIngreso.$Identificador);
$RepSesionObjetos = $_SESSION['InsTallerPedidoFoto' . $ModalidadIngreso . $Identificador]->MtdObtenerSesionObjetos(true);
      ...
      <tr>
        ...
        ?>
          ...
          <td align="left" valign="top">
            ...
            if ($_POST['Eliminar'] == 1) {
            ?>
              <a href="javascript:FncTallerPedidoFotoEliminar('<?php echo $DatSesionObjeto->Item; ?>','<?php echo $ModalidadIngreso; ?>');">
