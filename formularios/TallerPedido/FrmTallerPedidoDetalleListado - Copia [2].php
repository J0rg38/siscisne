...
<tr>
  ...
  <th width="5%" align="center">Cod. Original</th>
  <th width="7%" align="center">Cod. Alternativo</th>
  <th width="23%" align="center"> Nombre
</th>
  ...
  <th width="4%" align="center">Fecha Salida Física</th>
  <th width="6%" align="center">Almacen</th>
  <th width="6%" align="center">Stk.</th>
...
<select  <?php echo (($_POST['Editar']==2)?'disabled="disabled"':'')?>  class="EstFormularioCombo" name="CmpAlmacen_<?php echo $ModalidadIngreso.$DatSesionObjeto->Item;?>" id="CmpAlmacen_<?php echo $ModalidadIngreso.$DatSesionObjeto->Item;?>">
...
?>
  ...
  <select <?php echo (($_POST['Editar']==2 or  $DatSesionObjeto->Parametro33 == "1" or $DatSesionObjeto->Parametro34 == "1")?'disabled="disabled"':'')?>    class="EstFormularioCombo" name="CmpTallerPedidoDetalleEstado_<?php echo $ModalidadIngreso.$DatSesionObjeto->Item;?>" id="CmpTallerPedidoDetalleEstado_<?php echo $ModalidadIngreso.$DatSesionObjeto->Item;?>">
    <option value="">-</option>
...
$Total = $POST_Total - $TotalBruto - $POST_Descuento;
...
<br />
            ...
            <tr>
              ...
              <td align="left" >&nbsp;</td>
              <td align="right" class="Total">Total de Repuestos:</td>
              <td align="right"><span class="EstMonedaSimbolo"><?php echo $InsMoneda->MonSimbolo; ?></span> <?php echo number_format($TotalBruto,2);?></td>
            </tr>
            <tr>
              <td align="right" class="Total">&nbsp;</td>
              <td align="left" >&nbsp;</td>
              <td width="64%" align="right" class="Total">Mantenimiento:</td>
              <td width="12%" align="right"><span class="EstMonedaSimbolo"><?php echo $InsMoneda->MonSimbolo; ?></span> <?php echo number_format($POST_Total,2);?></td>
              </tr>
            <tr>
              <td align="right" class="Total">&nbsp;</td>
              <td align="left" >&nbsp;</td>
