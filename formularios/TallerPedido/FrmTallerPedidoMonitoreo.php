...
<?php $PrivilegioGenerarTallerPedido = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"Registrar"))?true:false;?>
...
$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),4,$POST_Prioridad,$POST_Modalidad);
...
<tr>
  ...
  <span class="EstFormularioTitulo">MONITOREO DE ORDENES DE TRABAJO con PEDIDO</span>  </td>
</tr>
<tr>
  <td width="47%">
...
<tr>
 ...
 <span class="EstFormularioContenido">  
    ...
    <select class="EstFormularioCombo" name="Cam" id="Cam">
      <option value="FinId" <?php if($POST_cam=="FinId"){ echo 'selected="selected"';}?>>Id</option>
...
s      </select>
      ...
      <option value="" >Todos</option>
		<option  <?php if($POST_Prioridad==1){ echo 'selected="selected"';}?> value="1">Urgente</option>
		<option  <?php if($POST_Prioridad==2){ echo 'selected="selected"';}?> value="2">Normal</option>
		</select>
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input indice="<?php echo $f;?>"   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FinId; ?>" />				</td>
                ...
                <td  width="16%" align="right" ><?php echo ($dat->CliNombre);?></td>
                <td  width="7%" align="right" ><?php echo ($dat->EinVIN);?></td>
                <td  width="8%" align="right" ><?php echo ($dat->FinConductor);?></td>
                <td  width="10%" align="right" ><?php echo ($dat->FinVehiculoKilometraje);?></td>
                <td  width="16%" align="right" ><?php echo ($dat->PerNombre);?> <?php echo ($dat->PerApellidoPaterno);?> <?php echo ($dat->PerApellidoMaterno);?></td>
                <td  width="12%" align="center" ><?php echo ($dat->FinTiempoCreacion);?></td>
                <td  width="5%" align="center" >
  <?php
if($PrivilegioGenerarTallerPedido){
?>		                
