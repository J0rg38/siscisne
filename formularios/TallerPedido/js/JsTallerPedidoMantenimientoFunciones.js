...
function FncTallerPedidoMantenimientoListar(oModalidadIngreso){
	...
	$.ajax({
		...
		data: 'Identificador='+Identificador+'&ModalidadIngreso='+oModalidadIngreso+'&VehiculoModelo='+VehiculoModelo+'&VehiculoVersion='+VehiculoVersion+'&MantenimientoKilometraje='+MantenimientoKilometraje+'&Editar='+TallerPedidoMantenimientoEditar+'&Eliminar='+TallerPedidoMantenimientoEliminar+'&PrimerRegistro='+PrimerRegistro+'&SucursalId='+SucursalId+'&PlanMantenimientoId='+PlanMantenimientoId,
		success: function(html){
			
			
			console.log(oModalidadIngreso);
			console.log("#CapTallerPedido"+oModalidadIngreso+"Mantenimientos");
