...
$RepSesionObjetos = $_SESSION['InsTallerPedidoAlmacenMovimientoEntrada'.$Identificador]->MtdObtenerSesionObjetos(true);
...
?>
  ...
  <a class="EstSesionObjetosItem" href="javascript:FncTallerPedidoAlmacenMovimientoEntradaEscoger('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
...
if($_POST['Eliminar']==1){
?>
  <a href="javascript:FncTallerPedidoAlmacenMovimientoEntradaEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');" >
