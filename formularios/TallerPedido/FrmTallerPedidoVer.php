...
if(!empty($InsFichaIngreso->FichaIngresoModalidad)){
	foreach($InsFichaIngreso->FichaIngresoModalidad as $DatFichaIngresoModalidad){	
		...
		if (!isset($_SESSION['InsTallerPedidoDetalle'.$DatModalidadIngreso->MinSigla.$Identificador])){	
			$_SESSION['InsTallerPedidoDetalle'.$DatModalidadIngreso->MinSigla.$Identificador] = new ClsSesionObjeto();
		}else{	
			$_SESSION['InsTallerPedidoDetalle'.$DatModalidadIngreso->MinSigla.$Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTallerPedidoDetalle'.$DatModalidadIngreso->MinSigla.$Identificador]);
		}
		
		if (!isset($_SESSION['InsTallerPedidoMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador])){	
			$_SESSION['InsTallerPedidoMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador] = new ClsSesionObjeto();
		}else{	
			$_SESSION['InsTallerPedidoMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTallerPedidoMantenimiento'.$DatModalidadIngreso->MinSigla.$Identificador]);
		}
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccTallerPedidoEditar.php');
...
var TallerPedidoFichaEditar = 2;
var TallerPedidoFichaEliminar = 2;

var TallerPedidoDetalleEditar = 2;
var TallerPedidoDetalleEliminar = 2;

var TallerPedidoMantenimientoEditar = 2;
var TallerPedidoMantenimientoEliminar = 2;
...
var TallerPedidoGastoEditar = 2;
var TallerPedidoGastoEliminar = 2;

var TallerPedidoAlmacenMovimientoEntradaEditar = 2;
var TallerPedidoAlmacenMovimientoEntradaEliminar = 2;
...
<div class="EstCapMenu">
			...
			<?php
			if($PrivilegioEditar and ($InsFichaIngreso->FinEstado == 5 or $InsFichaIngreso->FinEstado == 6)){
			?>           
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER PEDIDO DE TALLER</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<div class="EstFormularioArea">
  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
    ...
    <tr>
      ...
      <td colspan="7" align="left" valign="top"><input name="CmpPersonalNombre" type="text" class="EstFormularioCaja" id="CmpPersonalNombre" value="<?php echo $InsFichaIngreso->PerNombre;?>" size="20" readonly="readonly" />
    ...
    <tr>
      ...
      <td colspan="7" align="left" valign="top"><textarea name="CmpNota" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpNota"><?php echo $InsFichaIngreso->FinNota;?></textarea></td>
      <td align="left" valign="top">&nbsp;</td>
      <td align="left" valign="top">&nbsp;</td>
      </tr> 
    <tr>
      ...
      <td colspan="9" align="left" valign="top">
        ...
        <a href="javascript:FncPopUp('formularios/FichaIngreso/FrmFichaIngresoImprimirIN.php?Id=<?php echo $InsFichaIngreso->FinId;?>&P=',0,0,1,0,0,1,0,screen.height,screen.width);">
          <img src="imagenes/avisos/ficha.gif" width="25" height="25" border="0" align="Ficha" title="Ficha" />
          Inventario</a>
        
        <a href="javascript:FncPopUp('formularios/FichaIngreso/FrmFichaIngresoImprimirFT.php?Id=<?php echo $InsFichaIngreso->FinId;?>&P=',0,0,1,0,0,1,0,screen.height,screen.width);">                            
          <img src="imagenes/avisos/ficha.gif" width="25" height="25" border="0" align="Ficha" title="Ficha" />
          Ficha Tecnica</a>
...
?>
      ...
      <input type="hidden"  name="CmpCotizacionProductoId" id="CmpCotizacionProductoId" value="<?php echo $InsFichaIngreso->CprId;?>"      /></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
  </table>
</div>  
...
<ul class="tabs">
    ...
    <li><a href="#tab<?php echo $c+6;?>">Venta Veh.</a></li>
...
<input name="CmpFichaAccionId_<?php echo $DatTallerPedido->MinSigla?>" type="hidden" id="CmpFichaAccionId_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->FccId;?>" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpDescuento_<?php echo $DatFichaAccion->MinSigla?>" type="text" class="EstFormularioCaja" id="CmpDescuento_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo number_format($DatTallerPedido->AmoDescuento,2);?>" size="10" maxlength="10" readonly="readonly" /></td>
                            <td align="left" valign="top">Fecha de Emisi&oacute;n::</td>
                            <td align="left" valign="top"><input name="CmpFecha_<?php echo $DatTallerPedido->MinSigla?>" type="text" class="EstFormularioCajaFecha" id="CmpFecha_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->AmoFecha;?>" size="10" maxlength="10" readonly="readonly" />
                            <script type="text/javascript">
Calendar.setup({ 
...
<!--<input type="hidden" name="CmpMonedaId_<?php echo $DatTallerPedido->MinSigla?>" id="CmpMonedaId_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->MonId;?>" />-->
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpMonedaId_<?php echo $DatTallerPedido->MinSigla?>" id="CmpMonedaId_<?php echo $DatTallerPedido->MinSigla?>">
...
?>
                            ...
                            <td align="left" valign="top"><table>
                              <tr>
                                <td><input name="CmpTipoCambio_<?php echo $DatTallerPedido->MinSigla?>" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->AmoTipoCambio?>" size="10" maxlength="10" readonly="readonly" /></td>
                                <td>&nbsp;</td>
                              </tr>
                            </table></td>
  ...
  <?php	
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><textarea name="CmpFichaAccionManoObraDetalle_<?php echo $DatTallerPedido->MinSigla?>" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpFichaAccionManoObraDetalle_<?php echo $DatTallerPedido->MinSigla?>"><?php echo stripslashes($FichaAccionManoObraDetalle);?></textarea></td>
                            ...
                            <select  disabled="disabled" class="EstFormularioCombo" name="CmpPersonal_<?php echo $DatTallerPedido->MinSigla?>" id="CmpPersonal_<?php echo $DatTallerPedido->MinSigla?>" >
					...
					?>	
                     ...
                     <div class="EstFormularioArea" id="CapModalidad">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="50%" align="center"><span class="EstFormularioSubTitulo"> Productos: <?php echo strtoupper($DatTallerPedido->MinNombre);?></span></td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><!--<div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="137" align="right" valign="top"><a href="javascript:FncTallerPedidoFichaListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
                            <td align="left" valign="top"><div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="4" align="left" valign="top">&nbsp;</td>
                                  <td colspan="2" align="left" valign="top"><span class="EstFormularioSubTitulo">Fotos</span> <a href="javascript:FncTallerPedidoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"></a></td>
                                  <td width="4" align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
					...
					<div class="EstFormularioArea" >
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2"><table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="1%">&nbsp;</td>
                                  <td colspan="2">TOTALES</td>
                                  <td>&nbsp;</td>
            ...
            <tr>
              <td width="97%" valign="top">
                <div class="EstFormularioArea" >
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td><span class="EstFormularioSubTitulo"> GASTO ADICIONALES</span></td>
                      </tr>
                    <tr>
                      <td>
...
<div class="EstFormularioArea">
                              <table width="852" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="4">&nbsp;</td>
                                  <td width="780" colspan="10"><span class="EstFormularioSubTitulo"> SERVICIOS Y PRODUCTOS ALTERNATIVOS </span><span class="EstFormularioSubTitulo">
                    ...
                    <tr>
                      <td><!--<div class="EstFormularioArea">
                        <table width="918" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="4">&nbsp;</td>
                            <td width="720" colspan="9"><span class="EstFormularioSubTitulo">REPUESTOS</span><span class="EstFormularioSubTitulo">
  ...
  <div class="EstFormularioCajaObservacion">
    <?php echo stripslashes($InsFichaIngreso->FinAlmacenObservacion);?>
	        ...
	        <input type="hidden" name="CmpAlmacenSalida" id="CmpAlmacenSalida" value="<?php echo stripslashes($InsFichaIngreso->FinAlmacenObservacion);?>" />
	        </td>
	      <td align="left" valign="top">&nbsp;</td>
	      </tr>
	    <tr>
...
<div id="tab<?php echo $c+5;?>" class="tab_content">
      ...
      <div id="tab<?php echo $c+6;?>" class="tab_content">
	  ...
	  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
	    <tr>
	      <td>&nbsp;</td>
	      <td colspan="2"><span class="EstFormularioSubTitulo">VENTA DE VEHICULO</span></td>
	      <td>&nbsp;</td>
	      </tr>
	    <tr>
	      <td>&nbsp;</td>
	    ...
	    <tr>
	      <td>&nbsp;</td>
	      <td align="left" valign="top">Ord. Ven. Veh.:</td>
	      <td align="left" valign="top">

<?php echo $InsFichaIngreso->FinOrdenVentaVehiculo;?>
...
<?php
//MtdObtenerOrdenVentaVehiculoObsequios($oCampo=NULL,$oFiltro=NULL,$oOrden = 'OvoId',$oSentido = 'Desc',$oPaginacion = '0,10',$oOrdenVentaVehiculo=NULL,$oEstado=NULL)
$InsOrdenVentaVehiculoObsequio =  new ClsOrdenVentaVehiculoObsequio();
$ResOrdenVentaVehiculoObsequio = $InsOrdenVentaVehiculoObsequio->MtdObtenerOrdenVentaVehiculoObsequios(NULL,NULL,'OvoId','Desc',NULL,$InsFichaIngreso->FinOrdenVentaVehiculo,NULL);
