...
<?php $PrivilegioGenerarSolicitudDesembolso = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"SolicitudDesembolso","Registrar"))?true:false;?>
...
include($InsProyecto->MtdFormulariosMsj("TrabajoTerminado").'MsjTrabajoTerminado.php');
...
$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FinConductor,VmaNombre,VmoNombre,VveNombre,per.PerNombre,per.PerApellidoPaterno,per.PerApellidoMaterno, CONCAT(CliNombre,' ',CliApellidoPaterno,' ',CliApellidoMaterno),CliNombreCompleto",$POST_con,$POST_fil,"fin.FinEstado ASC,".$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$tipo,$POST_Prioridad,$POST_Modalidad,NULL,NULL,$POST_Personal,0,NULL,NULL,$POST_Tipo,0,$POST_ConCampana,NULL,0,NULL,NULL,NULL,$POST_CodigoOriginal,$POST_Sucursal);//73,74,75,8,9
...
<!--	<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTallerSeleccionados2();"><img src="imagenes/iconos/enviar_almacen_cancelar2.png" alt="[Rechazar envio de OT de Taller]" title="Rechazar envio de OT de Taller" /> Rechazar </a></div>
	...
	<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTallerSeleccionados3();"><img src="imagenes/submenu/enviar_almacen_anular.png" alt="[Anular recepcion de OT de Taller]" title="Anular recepcion de OT de Taller" /> Anular </a></div>
...
<!--<div class="EstSubMenuBoton"><a href="javascript:FncMarcarTrabajoTerminadoSeleccionados('1');"><img src="imagenes/submenu/marcar_terminado_rapido.png" alt="[Marcar como Trabajo Terminado Rapido]" title="Marcar como Trabajo Terminado Rapido" /> Terminado Rapido</a></div>-->     
...
<!--	<div class="EstSubMenuBoton"><a href="javascript:FncDesmarcarTrabajoTerminadoSeleccionados();"><img src="imagenes/iconos/marcar_terminado_cancelar.png" alt="[Desmarcar como Trabajo Terminado]" title="Desmarcar como Trabajo Terminado" />  Desmarcar</a></div> -->
    ...
    <tr>
      ...
      <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO [ALMACEN]</span></td>
 ...
 <span class="EstFormularioContenido">  
	...
	<input placeholder="Ingrese un codigo original" class="EstFormularioCajaBuscar" name="CodigoOriginal" type="text" id="CodigoOriginal" value="<?php echo $POST_CodigoOriginal;?>" size="18" />
    ...
    ?>	
                    ...
                    <td align="left" valign="middle" width="2%" bgcolor="<?php echo $Color;?>"  >
...
?>	 
                    ...
                    <td  width="8%" align="left" bgcolor="<?php echo $Color;?>" >
                    ...
                    <td  width="3%" align="left" bgcolor="<?php echo $Color;?>" ><?php echo $dat->FinFecha;  ?> <?php echo $dat->FinHora;  ?></td>
                    ...
                    <td  width="3%" align="left" bgcolor="<?php echo $Color;?>" ><?php echo ($dat->FinFechaGarantia);?>
                      <?php if(!empty($dat->FinGarantiaDiaTranscurrido)){?>
    (<?php echo $dat->FinGarantiaDiaTranscurrido;?>)
    <?php }?></td>
                    <td  width="3%" align="left" bgcolor="<?php echo $Color;?>" ><?php echo (empty($dat->LtiAbreviatura)?$dat->LtiNombre:$dat->LtiAbreviatura)//FncCortarTexto($dat->LtiNombre,15);?></td>
                    <td  width="15%" align="left" bgcolor="<?php echo $Color;?>" >
    ...
    <?php	
        ...
        ?></td>
                    <td  width="3%" align="left" bgcolor="<?php echo $Color;?>" ><?php
    if($PrivilegioVehiculoIngresoEditar or $PrivilegioVehiculoIngresoVer){
    ?>
                      
                      <a href="javascript:FncVehiculoIngresoSimpleCargarFormulario('<?php echo (($PrivilegioVehiculoIngresoEditar)?'Editar':'Ver');?>','<?php echo $dat->EinId?>');"  ><?php echo ($dat->EinVIN);?></a>
...
?>
                    ...
                    <td  width="4%" align="left" bgcolor="<?php echo $Color;?>" ><?php echo ($dat->EinColor);?></td>
                    <td  width="4%" align="left" bgcolor="<?php echo $Color;?>" >
					
					<h2><?php echo ($dat->EinPlaca);?></h2></td>
                    <td  width="4%" align="left" bgcolor="<?php echo $Color;?>" >
				...
				?>
                    ...
                    <td  width="11%" align="left" bgcolor="<?php echo $Color;?>" >
					
					<?php
					/*if(!empty($dat->UsuUsuario)){
					?>
                    	<?php echo ($dat->UsuUsuario);?>                    
                    <?php
						}else{*/
					?>
                    ...
                    <td  width="6%" align="left" bgcolor="<?php echo $Color;?>" >
...
<a target="<?php echo (!empty($dat->ObsArchivo)?'_blank'.$dat->ObsArchivo:'');?>" href="<?php echo (!empty($dat->ObsArchivo)?'subidos/obsequio_archivos/'.$dat->ObsArchivo:'#');?>">
                ...
                ?>
                    ...
                    <td  width="2%" align="center" bgcolor="<?php echo $Color;?>" >
                     ...
                     <span title="<?php echo $dat->FinEstado;?>"><?php echo $dat->FinEstadoDescripcion;?></span>
                      
                      
                      
                      
                    </td>
                    <td  width="6%" align="center" bgcolor="<?php echo $Color;?>" >
...
//    if($PrivilegioEditar and ($dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 73) or ($dat->FinEstado == 74 or $dat->FinEstado == 75 or $dat->FinEstado == 9 or $dat->FinEstado == 10 or $dat->FinCierre == 2)){
    ...
    ?>
       ...
       <?php
//    if($PrivilegioGenerarPedidoCompra and $TieneGarantia ){
//	if($PrivilegioGenerarSolicitudDesembolso and  ($dat->FinEstado == 5 or $dat->FinEstado ==  6 or  $dat->FinEstado ==  7 ) ){
	if($PrivilegioGenerarSolicitudDesembolso and  ($dat->FinEstado == 5 or $dat->FinEstado ==  6 or  $dat->FinEstado ==  7 ) ){
    ?>		                
    ...
    ?>
      ...
      <?php	
if($PrivilegioEditar and ($dat->FinEstado  == 5 or $dat->FinEstado == 6 or $dat->FinEstado == 7 or $dat->FinEstado == 71 or $dat->FinEstado == 73 or $dat->FinEstado == 74 or $dat->FinEstado == 75 or $dat->FinEstado == 9)){
?>
