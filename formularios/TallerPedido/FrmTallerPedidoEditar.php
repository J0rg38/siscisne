...
?>
<?php
if($InsFichaIngreso->FinEstado == 5 || $InsFichaIngreso->FinEstado == 6){
?>
...
<div class="EstFormularioArea">
  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
    <tr>
      ...
      <input name="CmpFichaIngresoCliente" type="text" class="EstFormularioCaja" id="CmpFichaIngresoCliente" value="<?php echo $InsFichaIngreso->CliNombre;?> <?php echo $InsFichaIngreso->CliApellidoPaterno;?> <?php echo $InsFichaIngreso->CliApellidoMaterno;?>" size="45" readonly="readonly" />
      ...
      <td align="left" valign="top"><input type="hidden" name="Guardar" id="Guardar"   />
        ...
        <input name="CmpFichaIngresoVehiculoVersion" type="hidden" class="EstFormularioCaja" id="CmpFichaIngresoVehiculoVersion" value="<?php echo $InsFichaIngreso->VveId;?>"  />
        <!-- REVISAR -->
        ...
        <input name="CmpVehiculoIngresoAnoFabricacion2" type="hidden" class="EstFormularioCaja" id="CmpVehiculoIngresoAnoFabricacion2" value="<?php echo $InsFichaIngreso->EinAnoFabricacion;?>"  />
        ...
        <input name="CmpVehiculoIngresoId" type="hidden" class="EstFormularioCaja" id="CmpVehiculoIngresoId" value="<?php echo $InsFichaIngreso->EinId;?>"  /></td>
    </tr>
...
<input name="CmpId2_<?php echo $DatTallerPedido->MinSigla?>" type="hidden" class="EstFormularioCaja" id="CmpId2_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->AmoId;?>" size="15" maxlength="20"  />
...
<input name="CmpFichaAccionId_<?php echo $DatTallerPedido->MinSigla?>" type="hidden" id="CmpFichaAccionId_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->FccId;?>" />
                           ...
                           --> 
                              ...
                              <input name="CmpSucursal_<?php echo $DatTallerPedido->MinSigla?>" type="hidden" id="CmpSucursal_<?php echo $DatTallerPedido->MinSigla?>" value="<?php echo $DatTallerPedido->SucId;?>" />
...
?>
  ...
  <?php	
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><textarea name="CmpFichaAccionManoObraDetalle_<?php echo $DatTallerPedido->MinSigla?>" cols="45" rows="2" class="EstFormularioCaja" id="CmpFichaAccionManoObraDetalle_<?php echo $DatTallerPedido->MinSigla?>"><?php echo stripslashes($FichaAccionManoObraDetalle);?></textarea></td>
...
<!--<h1><?php echo $DatTallerPedido->MinId;?></h1>-->
					...
					?>	
                     ...
                     <div class="EstFormularioArea" id="CapModalidad">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td align="center"><p class="EstFormularioSubTitulo"> Productos: <?php echo strtoupper($DatTallerPedido->MinNombre);?></p>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <div class="EstFormularioArea">
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                <tr>
                                  <td>&nbsp;</td>
                                  <td colspan="14"><span class="EstFormularioSubTitulo">PRODUCTOS que componen el PEDIDO DE TALLER</span><span class="EstFormularioSubTitulo">
              ...
              <a href="javascript:FncPopUp('formularios/FichaAccion/FrmFichaAccionTallerPedidoImprimir.php?Id=<?php echo $DatFichaIngresoModalidad->FccId;?>&amp;P=',0,0,1,0,0,1,0,screen.height,screen.width);"> <img src="imagenes/avisos/ficha.gif" alt="" width="25" height="25" border="0" align="Ficha" title="Ficha" /> Resumen Ficha</a>   
					...
					<div class="EstFormularioArea" >
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="46%"><span class="EstFormularioSubTitulo"> Tareas del Plan de Mantenimiento</span></td>
                            <td width="52%" align="right"><a href="javascript:FncTallerPedidoMantenimientoListar('<?php echo $DatTallerPedido->MinSigla?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                            <td width="1%">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            ...
                            <td width="50%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="2%"><span class="EstFormularioAccion">
                                  ...
                                  <td width="47%"><div class="EstFormularioAccion" id="CapHerramientaAccion">Listo
                                    para registrar elementos
                                      
                                  </div></td>
                                  <td width="50%" align="right"><a href="javascript:FncTallerPedidoHerramientaListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a>
                ...
                <div class="EstFormularioArea" >
                    ...
                    <tr>
                      <td>
							...
							<div class="EstFormularioArea">
                              <table width="984" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="4">&nbsp;</td>
...
<a id="BtnGastoEditar" onclick="FncGastoCargarFormulario('Editar');" href="javascript:void(0)"   title=""> <img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" /> </a>
                                  ...
                                  <select  disabled="disabled"  class="EstFormularioCombo" name="CmpGastoMoneda" id="CmpGastoMoneda">
...
<a id="BtnAlmacenMovimientoEntradaRegistrar" onclick="FncAlmacenMovimientoEntradaCargarFormulario('Registrar');" href="javascript:void(0)" title=""> <img src="imagenes/acciones/registrar.png" alt="[Registrar]" width="25" height="25" border="0" align="absmiddle" title="Registrar" /> </a> 
 
<a id="BtnAlmacenMovimientoEntradaEditar" onclick="FncAlmacenMovimientoEntradaCargarFormulario('Editar');" href="javascript:void(0)"   title=""> <img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" /> </a>
