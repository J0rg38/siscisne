...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <div class="tab_container">
    ...
    ?>
            ...
            <td align="left" valign="top">Reporte por:</td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="6" align="left" valign="top"><span class="EstFormularioSubTitulo">DATOS DEL INCIDENTE</span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><textarea class="EstFormularioCaja" name="CmpDescripcion" id="CmpDescripcion" cols="45" rows="4"><?php echo $InsVehiculoIngresoEvento->VieObservacionInterna;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
