...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><span id="sprytextfield1">
                        <label>
                          <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if(empty($InsVentaDirecta->VdiFecha)){ echo date("d/m/Y");}else{ echo $InsVentaDirecta->VdiFecha; }?>" size="15" maxlength="10" />
                          </label>
	...
	?>
                            ...
                            <td> <span id="sprytextfield2">
                              ...
                              <input <?php if(!empty($InsVentaDirecta->CliId)){ echo 'readonly="readonly"';} ?>   tabindex="2" class="EstFormularioCaja" name="CmpClienteNombreCompleto" type="text" id="CmpClienteNombreCompleto" size="45" maxlength="255" value="<?php echo $InsVentaDirecta->CliNombre;?> <?php echo $InsVentaDirecta->CliApellidoPaterno;?> <?php echo $InsVentaDirecta->CliApellidoMaterno;?>"  />
			  ...
			  ?>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><span id="sprytextfield6">
                        ...
                        <input name="CmpClienteMargenUtilidad" type="text" class="EstFormularioCajaDeshabilitada" id="CmpClienteMargenUtilidad" value="<?php echo number_format($InsVentaDirecta->VdiPorcentajeMargenUtilidad,2);?>" size="10" maxlength="10" readonly="readonly" />
                        <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                      <td align="left" valign="top">Otros Costos: <br />
                        <span class="EstFormularioSubEtiqueta">(%)</span></td>
                      <td align="left" valign="top"><span id="sprytextfield9">
                        <label for="CmpPorcentajeOtroCosto"></label>
                        <input name="CmpPorcentajeOtroCosto" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPorcentajeOtroCosto" value="<?php echo number_format($InsVentaDirecta->VdiPorcentajeOtroCosto,2);?>" size="10" maxlength="10" readonly="readonly" />
                        <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                      <td align="left" valign="top">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><span id="sprytextfield4"><span class="textfieldRequiredMsg">Se necesita un valor.</span></span>                       <input name="CmpOrdenCompraNumero" type="text" class="EstFormularioCaja" id="CmpOrdenCompraNumero"  tabindex="3" value="<?php  echo $InsVentaDirecta->VdiOrdenCompraNumero;?>" size="25" maxlength="25" />                     </td>
                    ...
                    <tr>
                      <td width="98%">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="16"><span class="EstFormularioSubTitulo">PRODUCTOS </span><span class="EstFormularioSubTitulo">
