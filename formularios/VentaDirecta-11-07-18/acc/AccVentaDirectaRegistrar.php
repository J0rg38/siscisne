...
//							$InsNotificacion->NfnUsuario = $_SESSION['SesionUsuario'];
//														
//							$InsNotificacion->NfnModulo = "Pago";
//							$InsNotificacion->NfnFormulario = "Monitoreo";
//							$InsNotificacion->NfnDescripcion = "<b>".$_SESSION['SesionUsuario']."</b> te ha enviado una orden de cobro. - Cliente: ".$InsVentaDirecta->CliNombre." ".$InsVentaDirecta->CliApellidoPaterno." ".$InsCliente->CliApellidoMaterno;
...
//							$InsNotificacion->NfnEnlace = "principal.php?Mod=Pago&Form=AtenderOrdenCobro&Id=".$InsPago->PagId."&VdiId=".$InsPago->VdiId."&NfnId=".$InsPago->NfnId."&Leido=1";
...
//				$InsVentaDirecta->MtdNotificarVentaDirectaRegistro($InsVentaDirecta->VdiId,"jblanco@cyc.com.pe",true);
				...
				//$InsCorreo->MtdEnviarCorreo("jonathan.blanco.upt@gmail.com,jblanco@cyc.com.pe".$Destinatarios,"sistema.automotriz.cisne@gmail.com","C&C S.A.C.","NOTIFICACION: ORD. VEN. Nro.: ".$InsVentaDirecta->VdiId.(!empty($InsVentaDirecta->VdiOrdenCompraNumero)?" - O.C. REF: ".$InsVentaDirecta->VdiOrdenCompraNumero." ":"")." - CLIENTE: ".$InsVentaDirecta->CliNombre,"NOTIFICACION DE REGISTRO: <br><br> Orden de Venta Nro.: <b>".$InsVentaDirecta->VdiId."</b> <br> Fecha de Registro: <b>".FncCambiaFechaANormal($InsVentaDirecta->VdiFecha)."</b> <br> Cliente: <b>".$InsVentaDirecta->CliNombre."</b> <br> O.C.: Referencia: <b>".$InsVentaDirecta->VdiOrdenCompraNumero."</b> <br><br> Mensaje autogenerado por sistema siscyc a las ".date("d/m/Y H:i:s"));
					...
					if( $InsCotizacionProducto->CprVerificar == 2 or ( $InsCotizacionProducto->CprVerificar == 1 and $DatCotizacionProductoDetalle->CrdEstado == 1)){
						...
						$DatVentaDirectaDetalle->VerificarStock = 2;
							...
							if(!empty($InsUnidadMedidaConversion->UmcEquivalente)){
								...
								$DatCotizacionProductoDetalle->CrdCantidadReal = round($DatCotizacionProductoDetalle->CrdCantidadPendiente * $InsUnidadMedidaConversion->UmcEquivalente,6);
								...
								$DatVentaDirectaDetalle->VerificarStock = 0;			
							}
...
//						Parametro36 = VddPrecioBruto
							...
							//$DatCotizacionProductoDetalle->CrdImporte = $DatCotizacionProductoDetalle->CrdPrecio * $DatCotizacionProductoDetalle->CrdCantidad;
							
							///deb($InsVentaDirecta->MonId." - ".$EmpresaMonedaId);
							if($InsVentaDirecta->MonId <> $EmpresaMonedaId ){
								
							//	deb($DatCotizacionProductoDetalle->CrdPrecio );
