...
if($_POST['Editar']==1){
?>
<a class="EstSesionObjetosItem" href="javascript:FncVentaDirectaTareaEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
<?php
}
?>
...
if($_POST['Eliminar']==1){
?>
<a href="javascript:FncVentaDirectaTareaEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
