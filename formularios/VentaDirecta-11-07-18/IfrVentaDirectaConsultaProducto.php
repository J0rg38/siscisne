...
$ResProductoReemplazo = $InsProductoReemplazo->MtdObtenerProductoReemplazos("PreCodigo1,PreCodigo2,PreCodigo3,PreCodigo4,PreCodigo5,PreCodigo6,PreCodigo7,PreCodigo8,PreCodigo9,PreCodigo10","esigual",$POST_CodigoOriginal ,"PreId","ASC",NULL,1);
...
<?php }?>
        ...
        <tr>
          ...
          <th width="5%" rowspan="2">COD.</th>
          <th width="5%" rowspan="2">REPUESTO</th>
          <th width="5%" rowspan="2">CANT.</th>
          <th width="8%" rowspan="2">CLIENTE</th>
          <th width="4%" rowspan="2">O.C. REF.</th>
          <th width="6%" rowspan="2">O.C. REF. FECHA</th>
