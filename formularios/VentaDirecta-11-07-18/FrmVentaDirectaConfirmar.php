...
<?php $PrivilegioVentaConcretaRegistrar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VentaConcretada","Editar"))?true:false;?>
...
?>
			...
			?>           
             ...
             <div class="EstSubMenuBoton"><a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=VentaConcretada&Form=Registrar<?php echo (!empty($GET_dia)?'&Dia=1':'');?>&VdiId=<?php echo $InsVentaDirecta->VdiId;?>&Su=<?php echo $InsVentaDirecta->SucId;?>&Origen=VentaDirecta"><img src="imagenes/generar.jpg" alt="[Generar]" title="Generar" /> Venta Concretada</a></div>
             <?php
			}
			?>  
                   	<?php
 ...
 <div class="tab_container">
         ...
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top"><select <?php if(!empty($InsVentaDirecta->CliId)){ echo 'disabled="disabled"';} ?>  class="EstFormularioCombo" name="CmpClienteTipoDocumento" id="CmpClienteTipoDocumento">
                 <option value="">Escoja una opcion</option>
                 <?php
	...
	?>
			...
			?>
             ...
             <tr>
               <td>&nbsp;</td>
               <td align="left" valign="top" bgcolor="#CCFFCC">Abono</td>
             ...
             <tr>
               <td>&nbsp;</td>
               <td align="left" valign="top">Resultado:</td>
               <td colspan="3" align="left" valign="top"><textarea name="CmpResultado" cols="80" rows="4" readonly="readonly" class="EstFormularioCaja" id="CmpResultado"><?php echo $InsVentaDirecta->VdiResultado;?></textarea></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               ...
               <tr>
                 <td width="98%">
                   ...
                   <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                     <tr>
                       <td>&nbsp;</td>
                       <td colspan="17"><span class="EstFormularioSubTitulo">PRODUCTOS
...
<input type="hidden" name="CmpVentaDirectaDetalleId"  class="EstFormularioCaja" id="CmpVentaDirectaDetalleId"  />
                     ...
                     <tr>
                       ...
                       <a id="BtnListaPrecioEditar" onclick="FncListaPrecioCargarFormulario('Editar');" href="javascript:void(0)"   title=""> <img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" /></a>
                       <?php
							}
                       ?>
                       </td>
