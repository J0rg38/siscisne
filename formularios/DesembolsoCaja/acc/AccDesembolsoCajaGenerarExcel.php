...
$ResDesembolso = $InsDesembolso->MtdObtenerDesembolsos($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstTablaListado" >
      ...
      <thead class="EstTablaListadoHead">
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle"   ><?php echo $dat->DesNumero; ?></td>
                <td align="right" ><?php echo $dat->DesBanco; ?></td>
                <td align="right" ><?php
			switch($dat->DesMoneda){
				case "S":
			?>
                  Nuevos Soles
                  <?php
  ...
  <?php
			...
			?></td>
                <td align="right" ><?php echo $dat->DesIngresos; ?></td>
                <td align="right" ><?php echo $dat->DesSalidas; ?></td>
                <td align="right" ><?php echo $dat->DesSaldo; ?></td>
                <td align="right" >
