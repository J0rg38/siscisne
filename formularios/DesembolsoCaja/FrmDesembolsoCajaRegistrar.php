...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsDesembolsoCajaComprobanteFunciones.js" ></script>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccDesembolsoCajaRegistrar.php');
              ...
              -->                  </td>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><span id="sprytextfield1">
                    <label>
                      <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php  echo $InsDesembolso->DesFecha; ?>" size="10" maxlength="10" />
                    </label>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="98%"><table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><a href="javascript:FncDesembolsoComprobanteNuevo('');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                  ...
                  <td><a href="javascript:FncDesembolsoComprobanteGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
      ...
      <tr>
        <td colspan="2" align="center"><div class="EstFormularioArea" >
          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
            <tr>
              <td>&nbsp;</td>
              <td><input type="hidden" name="CmpDesembolsoComprobanteAccion2" id="CmpDesembolsoComprobanteAccion2" value="AccDesembolsoCajaComprobanteRegistrar.php" /></td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td width="49%" align="right"><a href="javascript:FncDesembolsoComprobanteListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a>
                <?php
if($InsDesembolso->VdiOrigen <> "CPR"){
?>
                <a href="javascript:FncDesembolsoComprobanteEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>
                <?php
}
?></td>
