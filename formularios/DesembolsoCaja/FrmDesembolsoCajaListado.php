...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsDesembolsoCaja.js" ></script>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccDesembolsoCaja.php');
...
$ResDesembolso = $InsDesembolso->MtdObtenerDesembolsos("DesId,DesConcepto,DesMonto",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"DesFecha","CUE-10000",$POST_Moneda,$POST_TipoDestino,$POST_Area,$POST_Sucursal);
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE DESEMBOLSOS DE CAJA</span></td>
</tr>
<tr>
  <td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstTablaListado" >
      ...
      <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?></th>
                <th width="5%" ><?php
				if($POST_ord == "DesReferencia"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('DesReferencia','ASC');">  Ref. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('DesReferencia','DESC');">  Ref. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('DesReferencia','ASC');"> Ref. </a>
                  <?php
				}
				?></th>
                <th width="7%" ><?php
	...
	<a class="EstPaginacion"  href="javascript:FncPaginar('<?php echo $num?>,<?php echo $numxpag;?>','<?php echo $i?>');" ><?php echo $i?></a>                        
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" ><?php echo $dat->DesReferencia; ?></td>
