...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"Desembolso","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"Desembolso","Listado") and empty($GET_dia)){
?>  
