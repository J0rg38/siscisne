...
<input disabled="disabled" type="radio" name="CmpTipoDestino" id="CmpTipoDestino2" value="2" <?php echo $OpcTipoDestino2;?>> Cliente
   <input disabled="disabled" type="radio" name="CmpTipoDestino" id="CmpTipoDestino3" value="3" <?php echo $OpcTipoDestino3;?>> Trabajador   
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if(empty($InsDesembolso->DesFecha)){ echo date("d/m/Y");}else{ echo $InsDesembolso->DesFecha; }?>" size="10" maxlength="10" readonly="readonly" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
