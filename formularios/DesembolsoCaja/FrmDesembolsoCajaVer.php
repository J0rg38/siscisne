...
*/
    ...
    */
    ...
    var Contador = 1;
    var DesembolsoComprobanteEditar = 2;
    var DesembolsoComprobanteEliminar = 2;
  </script>
...
-->
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><input name="CmpReferencia" type="text" class="EstFormularioCaja" id="CmpReferencia" value="<?php echo $InsDesembolso->DesReferencia; ?>" size="40" maxlength="45" readonly="readonly" /></td>
                      <td align="left" valign="top">Fecha de Salida: <br />
                        <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span>
                      </td>
                      <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if (empty($InsDesembolso->DesFecha)) {
                                                                                                                                              echo date("d/m/Y");
                                                                                                                                            } else {
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                          ...
                          ?>
                            <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsDesembolso->MonId == $DatMoneda->MonId) {
                      ...
                      <td align="left" valign="top">
                        <table>
                          <tr>
                            <td><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" value="<?php if (empty($InsDesembolso->DesTipoCambio)) {
                                                                                                                                            echo "";
                                                                                                                                          } else {
                                                                                                                                            echo $InsDesembolso->DesTipoCambio;
                                                                                                                                          } ?>" size="10" maxlength="10" readonly="readonly" /></td>
