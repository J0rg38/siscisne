...
if($POST_VerEstado==1){
?>
<th width="6%">Fec. Llegada GM</th>
<th width="5%">Status GM</th>
<th>Fecha</th>
<th>Cant.</th>
<?php
}
...
<td align="right" bgcolor="<?php echo $fondo;?>"><?php echo number_format($DatSesionObjeto->Parametro33,2);?></td>
<td align="right" bgcolor="<?php echo $fondo;?>"><?php echo number_format($DatSesionObjeto->Parametro30,2);?></td>
<td align="right" bgcolor="<?php echo $fondo;?>"><?php echo number_format($DatSesionObjeto->Parametro31,2);?></td>
...
if($POST_VerEstado==1){
?>
<td align="center" ><?php echo ($DatSesionObjeto->Parametro24);?></td>
<td align="center" ><?php echo ($DatSesionObjeto->Parametro25);?></td>
<td width="6%" align="center">
<?php echo ($DatSesionObjeto->Parametro27);?></td>
<td width="6%" align="center"><?php echo number_format($DatSesionObjeto->Parametro28,2);?></td>
<?php
}
?>
