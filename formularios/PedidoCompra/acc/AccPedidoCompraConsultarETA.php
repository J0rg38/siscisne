	...
	*/
	...
	if($Guardar){
		...
		if(!empty($InsPedidoCompra->PcoDestinatarios)){
				...
				//$InsOrdenCompra->MtdEnviarCorreoConsultaETA($InsOrdenCompra->OcoId,$Destinatario,"");  
				if($InsPedidoCompra->MtdEnviarCorreoConsultaETAPedidoCompra($InsPedidoCompra->PcoId,$InsPedidoCompra->PcoDestinatarios,NULL,$_SESSION['SesionNombre'])){
...
//		
//		$InsPedidoCompra->PcoDestinatarios = "jblanco@cyc.com.pe";
//	
//	}else{
//	
		//$InsPedidoCompra->PcoDestinatarios = "chevrolet.carperu@gm.com, pcondori@cyc.com.pe, jblanco@cyc.com.pe, aliendo@cyc.com.pe, iquezada@cyc.com.pe, scanepam@cyc.com.pe, bernardo.marcos@gm.com, richard.duenas@gm.com, dvercelone@cyc.com.pe, anace@cyc.com.pe, jean.anca@gm.com";
		$InsPedidoCompra->PcoDestinatarios = $CorreosGMConsultaETA;
...
*/					
			...
			$DatPedidoCompraDetalle->ProPromedioMensual
