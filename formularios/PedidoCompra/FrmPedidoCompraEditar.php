               ...
               <td align="left" valign="top"><table>
                 <tr>
                   ...
                   <td><input name="CmpOrdenCompraId" id="CmpOrdenCompraId" type="hidden"   tabindex="3" value="<?php  echo $InsPedidoCompra->OcoId;?>" size="20" maxlength="20" />
                     <input name="CmpOrdenCompra" type="text" class="EstFormularioCaja" id="CmpOrdenCompra"  tabindex="3" value="<?php  echo $InsPedidoCompra->OcoId;?>" size="25" maxlength="25" <?php echo (!empty($InsPedidoCompra->OcoId)?'readonly="readonly""':'');?>   /></td>
               ...
               <tr>
                 <td width="98%">
                   ...
                   <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                     <tr>
                       <td>&nbsp;</td>
                       <td colspan="18"><span class="EstFormularioSubTitulo">PRODUCTOS</span>
...
<input type="hidden" name="CmpPedidoCompraDetalleId"  class="EstFormularioCaja" id="CmpPedidoCompraDetalleId"  />
                      ...
                      <input type="hidden" name="CmpProductoPromedioMensual"  class="EstFormularioCaja" id="CmpProductoPromedioMensual"  /></td>
                       </tr>
                     <tr>
                       <td>&nbsp;</td>
                       <td>Estado:</td>
