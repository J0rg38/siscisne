...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsPedidoCompraSolicitarAutorizacionFunciones.js" ></script>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPedidoCompraSolicitarAutorizacion.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ENVIAR CORREO DE SOLICITUD DE AUTORIZACIOM DE PEDIDO DE COMPRA</span></td>
      </tr>
      <tr>
        <td colspan="2">
