...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPedidoCompraConsultarETA.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ENVIAR CORREO DE CONSULTA &quot;ETA&quot; DE PEDIDO DE COMPRA</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
?>
               ...
               <td align="left" valign="top"><textarea name="CmpSolicitudAprobacionRespuesta" cols="45" rows="2" class="EstFormularioCaja" id="CmpSolicitudAprobacionRespuesta"><?php echo $InsPedidoCompra->PcoSolicitudAprobacionRespuesta;?></textarea></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
