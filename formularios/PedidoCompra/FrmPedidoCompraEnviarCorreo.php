...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPedidoCompraEnviarCorreo.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ENVIAR  CORREO PEDIDO DE COMPRA</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
?>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="4" align="left" valign="top">Aprobacion</td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
