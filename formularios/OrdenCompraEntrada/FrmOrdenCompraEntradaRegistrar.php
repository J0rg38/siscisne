...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCompraEntradaRegistrar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        ENTRADA A ALMACEN c/ ORDEN COMPRA </span></td>
      </tr>
      <tr>
        <td colspan="2">
...
//			 deb($InsOrdenCompraEntrada->OceFecha);
           ...
           <tr>
             ...
             <select class="EstFormularioCombo" name="CmpProveedorTipoDocumentoAux" id="CmpProveedorTipoDocumentoAux" disabled="disabled">
               <option value="">Escoja una opcion</option>
               <?php
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="2%"><input type="hidden" name="CmpOrdenCompraEntradaPedidoAccion" id="CmpOrdenCompraEntradaPedidoAccion" value="AccOrdenCompraEntradaDetalleRegistrar.php" /></td>
               <td width="48%"><div class="EstFormularioAccion" id="CapProductoAccion">Listo
                 para registrar elementos</div></td>
               <td width="50%" align="right"><a href="javascript:FncOrdenCompraEntradaPedidoListar();"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a><a href="javascript:FncOrdenCompraEntradaPedidoEliminarTodo();"></a></td>
