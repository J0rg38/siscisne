...
$ResOrdenCompraEntrada = $InsOrdenCompraEntrada->MtdObtenerOrdenCompraEntradas($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,"3,4","CYC");
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ENTRADAS A ALMACEN c/ ORDEN COMPRA </span></td>
</tr>
<tr>
  <td width="47%">
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "OceId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OceId','ASC');"> Id <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OceId','DESC');"> Id <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('OceId','ASC');"> Id </a>
                <?php
				}
				?></th>
                <th width="7%" > <?php
				if($POST_ord == "OceFecha"){
					if($POST_sen == "DESC"){
				?>
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle" width="5%"   ><?php echo $dat->OceId;  ?></td>
                <td  width="7%" align="right" ><?php echo $dat->OceFecha;  ?></td>
                <td  width="6%" align="right" ><?php echo $dat->MonSimbolo;  ?></td>
                <td  width="9%" align="right" ><?php echo $dat->OceTipoCambio;  ?></td>
                <td  width="9%" align="right" ><?php echo $dat->OcoTipo;  ?></td>
                <td width="11%" align="right" valign="middle"   ><?php echo $dat->OcoId;  ?></td>
                <td  width="22%" align="right" ><?php echo $dat->PrvNombre;  ?></td>
                <td  width="7%" align="right" ><?php echo number_format($dat->OceTotal,2);?>
                <?php
					$Total += $dat->OceTotal ;
			
				?></td>
                <td  width="4%" align="right" ><?php echo ($dat->OceEstadoDescripcion);?></td>
                
        <td  width="8%" align="right" ><?php echo ($dat->OceTiempoModificacion);?></td>
            <td align="center">

<?php
if($PrivilegioEliminar and $dat->OceEstado == 1){
?>
<a href="javascript:FncEliminarSeleccionado('<?php echo $dat->OceId;?>');"> <img  src="imagenes/eliminar.gif" alt="[Eliminar]" width="19" height="19" border="0" title="Eliminar Completamente"   /></a>
<?php
}
?>   
