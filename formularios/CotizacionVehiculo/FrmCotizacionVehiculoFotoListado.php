...
?>
    ...
    <td align="left" valign="top">
       <img src="subidos/cotizacion_vehiculo_fotos/<?php echo $DatSesionObjeto->Parametro3;?>" alt="<?php echo $DatSesionObjeto->Parametro3;?>" width="30" height="30" border="0" title="<?php echo $DatSesionObjeto->Parametro3;?>" />
	<a target="_blank" href="subidos/cotizacion_vehiculo_fotos/<?php echo $DatSesionObjeto->Parametro3;?>">
 	<?php echo $DatSesionObjeto->Parametro3;?></a>
      
      <?php
    if($_POST['Eliminar']==1){
    ?> - 
      <a href="javascript:FncCotizacionVehiculoFotoEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $POST_Tipo;?>');" >
