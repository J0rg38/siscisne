...
$ResVehiculoStock = $InsVehiculoStock->MtdObtenerVehiculoStocks(NULL,NULL,NULL,"VmoNombre","ASC",NULL,NULL,$POST_VehiculoMarca,$POST_VehiculoModelo,$POST_VehiculoVersion,$POST_AnoFabricacion,$POST_AnoModelo,$POST_Color,NULL,NULL,date("Y"),NULL,NULL);
...
?>
    ...
    <td align="right"><?php echo $DatVehiculoStock->VehCodigoIdentificador;?></td>
