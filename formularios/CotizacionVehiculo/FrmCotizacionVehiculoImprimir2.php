...
<hr class="EstReporteLinea">
   ...
   <table width="100%" border="0" cellpadding="2" cellspacing="1" class="EstCotizacionVehiculoImprimirTabla">
    <tr>
      ...
      <span class="EstPlantillaTitulo">PROFORMA</span> <br />
    ...
    <tr>
      ...
      <td colspan="2" align="center" valign="top" >
		...
		//deb($InsCotizacionVehiculo->VveId);
		//deb($InsCotizacionVehiculo->VveFoto);
		if(!empty($InsCotizacionVehiculo->VveFoto)){
		?>
	...
	?>
        ...
        <table width="750" border="1" cellpadding="1" cellspacing="0" class="EstCotizacionVehiculoImprimirCaracteristica">
          <thead class="EstCotizacionVehiculoImprimirCaracteristicaHead">
            <tr>
              <th width="67%" align="center" ><?php echo $DatVehiculoCaracteristicaSeccion->VcsNombre?></th>
              <th width="33%" align="center" class="EstCotizacionVehiculoImprimirCaracteristicaSeccion">
...
<span class="EstCotizacionVehiculoImprimirContenido">
				...
				?>
                	-  <?php echo $DatCotizacionVehiculoCondicionVenta->CovNombre;?><br />
                <?php						
					}
				}				
				?>
...
<p align="center">
        <span class="EstCotizacionVehiculoImprimirNota2">Urb. Los Cedros Mz. B Lte. 10 Av. Manuel A. Odria Via Panamericana Sur (Costado Grifo Municipal)<br />
