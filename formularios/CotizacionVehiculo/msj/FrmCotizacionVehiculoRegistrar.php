...
tinymce.init({
	...
	height : 120
            ...
            <tr>
              ...
              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                        <tr>
                          <td>&nbsp;</td>
                          <td colspan="11"><span class="EstFormularioSubTitulo">Datos del Vehiculo
                              </span></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
  ...
  <img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" />
			...
			?>
                          ...
                          <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpAnoFabricacion" type="text" id="CmpAnoFabricacion" value="<?php echo ($InsCotizacionVehiculo->CveAnoFabricacion);?>" size="5" maxlength="4" />
                          <!-- <span class="EstFormularioCampoObligatorio">(*)</span>--></td>
					...
					?>
                          ...
                          <td align="left" valign="top"><input name="CmpTotal" type="text" class="EstFormularioCaja" id="CmpTotal" value="<?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?>" size="10" maxlength="10" />
                          <!-- <span class="EstFormularioCampoObligatorio">(*)</span>--></td>
                          <td align="left" valign="top"><input name="CmpVehiculoIngresoId" type="hidden" id="CmpVehiculoIngresoId" value="<?php echo $InsCotizacionVehiculo->EinId;?>" size="3" />
                          <input name="CmpPrecioLista" type="hidden" id="CmpPrecioLista" size="3" />
                          <input name="CmpPrecioCierre" type="hidden" id="CmpPrecioCierre" size="3" /></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
