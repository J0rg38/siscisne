         ...
         <td valign="top"><div class="EstFormularioArea">
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td>Color:</td>
               <td align="left" valign="top">A. Fab.</td>
			...
			?>
               ...
               <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpAnoFabricacion" type="text" id="CmpAnoFabricacion" value="<?php echo ($InsCotizacionVehiculo->CveAnoFabricacion);?>" size="5" maxlength="4" /></td>
               ...
               <td align="left" valign="top"><input name="CmpCantidad" type="text" class="EstFormularioCaja" id="CmpCantidad" value="<?php echo number_format($InsCotizacionVehiculo->CveCantidad,2);?>" size="10" maxlength="10" readonly="readonly" /></td>
               <td><input name="CmpTotal" type="text" class="EstFormularioCaja" id="CmpTotal" value="<?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?>" size="10" maxlength="10" readonly="readonly" /></td>
               <td><input name="CmpDescuento" type="text" class="EstFormularioCaja" id="CmpDescuento" value="<?php echo number_format($InsCotizacionVehiculo->CveDescuento,2);?>" size="10" maxlength="10" readonly="readonly" /></td>
               <td><input name="CmpTotal2" type="text" class="EstFormularioCaja" id="CmpTotal2" value="<?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?>" size="10" maxlength="10" readonly="readonly" /></td>
               <td><input name="CmpVehiculoIngresoId" type="hidden" id="CmpVehiculoIngresoId" value="<?php echo $InsCotizacionVehiculo->EinId;?>" size="3" /></td>
               </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
