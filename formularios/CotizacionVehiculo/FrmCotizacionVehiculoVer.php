...
var CotizacionVehiculoDetalleEditar = 2;
var CotizacionVehiculoDetalleEliminar = 2;
...
var CotizacionVehiculoFotoEditar = 2;
var CotizacionVehiculoFotoEliminar = 2;

var CotizacionVehiculoFotoSoloEditar = 2;
var CotizacionVehiculoFotoSoloEliminar = 2;
...
<div class="EstCapMenu">
    ...
    ?>
			...
			?>           
             ...
             <div class="EstSubMenuBoton"><a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=<?php echo $GET_mod;?>&Form=Editar<?php echo (!empty($GET_dia)?'&Dia=1':'');?>&Id=<?php echo $InsCotizacionVehiculo->CveId;?>"><img src="imagenes/iconos/editar.png" alt="[Editar]" title="Editar" />Editar</a></div>
             <?php
			}
			?>   
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER COTIZACION DE VEHICULO</span></td>
      </tr>
      <tr>
        <td colspan="2">
         ...
         <td valign="top"><div class="EstFormularioArea">
          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if(empty($InsCotizacionVehiculo->CveFecha)){ echo date("d/m/Y");}else{ echo $InsCotizacionVehiculo->CveFecha; }?>" size="15" maxlength="10" readonly="readonly" /></td>
		      <td align="left" valign="top">&nbsp;</td>
		      ...
		      <td align="left" valign="top"><?php
					switch($InsCotizacionVehiculo->CveNivelInteres){
						...
						break;
							...
							case 11:
							$OpcNivelInteres11 = 'selected = "selected"';
						break;
						
							case 12:
							$OpcNivelInteres12 = 'selected = "selected"';
						break;
...
//						break;
					...
					?>
                <select  disabled="disabled" class="EstFormularioCombo" name="CmpNivelInteres" id="CmpNivelInteres">
...
//deb($InsCotizacionVehiculo->CotizacionVehiculoCondicionVenta);
		...
		foreach($ArrCondicionVentas as $DatCondicionVenta){
			?>
		        ...
		        <input <?php echo $aux;?> type="checkbox" value="<?php echo $DatCondicionVenta->CovId;?>" name="CmpCondicionVenta_<?php echo $DatCondicionVenta->CovId;?>" id="CmpCondicionVenta_<?php echo $DatCondicionVenta->CovId;?>" disabled="disabled"  />
		        <?php echo $DatCondicionVenta->CovNombre;?><br />
		        <?php	
			}
			?>
		        <textarea name="CmpCondicionVentaOtro" cols="25" readonly="readonly" class="EstFormularioCaja" id="CmpCondicionVentaOtro"><?php echo $InsCotizacionVehiculo->CveCondicionVentaOtro;?></textarea></td>
			...
			?>
		            ...
		            <td><input name="CmpClienteNumeroDocumento" type="text" class="EstFormularioCaja" id="CmpClienteNumeroDocumento"  value="<?php echo $InsCotizacionVehiculo->CliNumeroDocumento;?>" size="20" maxlength="50" readonly="readonly" /></td>
		            <td><input name="CmpClienteNombre2" type="hidden" id="CmpClienteNombre2" value="<?php echo $InsCotizacionVehiculo->CliNombre;?>" size="3" />
                      ...
                      <input name="CmpClienteApellidoMaterno" type="hidden" id="CmpClienteApellidoMaterno" value="<?php echo $InsCotizacionVehiculo->CliId;?>" size="3" />                      <input name="CmpClienteNombre" type="text" class="EstFormularioCaja" id="CmpClienteNombre" value="<?php echo $InsCotizacionVehiculo->CliNombre;?> <?php echo $InsCotizacionVehiculo->CliApellidoPaterno;?> <?php echo $InsCotizacionVehiculo->CliApellidoMaterno;?>" size="45" maxlength="255" readonly="readonly" /></td>
		            <td>&nbsp;</td>
		            <td>&nbsp;</td>
		            </tr>
		          </table></td>
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top"><input name="CmpClienteDireccion" type="text" class="EstFormularioCaja" id="CmpClienteDireccion" value="<?php echo $InsCotizacionVehiculo->CveDireccion;?>" size="45" maxlength="255" readonly="readonly"  /></td>
		      <td align="left" valign="top">Telefono:</td>
		      <td align="left" valign="top"><input name="CmpClienteTelefono" type="text" class="EstFormularioCaja" id="CmpClienteTelefono" value="<?php echo $InsCotizacionVehiculo->CveTelefono;?>" size="20" maxlength="255" readonly="readonly"  /></td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		      </tr>
		    <tr>
		      ...
		      <td align="left" valign="top"><input name="CmpClienteEmail" type="text" class="EstFormularioCaja" id="CmpClienteEmail" value="<?php echo $InsCotizacionVehiculo->CveEmail;?>" size="45" maxlength="255" readonly="readonly"  /></td>
		      <td align="left" valign="top">Celular:</td>
		      <td align="left" valign="top"><input name="CmpClienteCelular" type="text" class="EstFormularioCaja" id="CmpClienteCelular" value="<?php echo $InsCotizacionVehiculo->CveCelular;?>" size="20" maxlength="255" readonly="readonly"  /></td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		      </tr>
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top"><table>
		        <tr>
		          ...
		          <td><a href="javascript:FncCotizacionVehiculoEstablecerMoneda();"></a></td>
		          </tr>
		        </table></td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top">Fecha de Vigencia:<br />
		        <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
		      <td align="left" valign="top"><input name="CmpFechaVigencia" type="text" class="EstFormularioCajaFecha" id="CmpFechaVigencia" value="<?php echo $InsCotizacionVehiculo->CveFechaVigencia; ?>" size="15" maxlength="10" readonly="readonly" /></td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		      </tr>
...
?>
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top">
		        ...
		        <!--<textarea name="CmpObservacion" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsCotizacionVehiculo->CveObservacion;?></textarea>--></td>
...
tinymce.init({
	...
	height : 120
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top"><input name="CmpAdicional" type="text"  class="EstFormularioCaja" id="CmpAdicional" value="<?php echo $InsCotizacionVehiculo->CveAdicional;?>" size="45" maxlength="255" readonly="readonly" <?php echo (!empty($InsCotizacionVehiculo->CliId)?'readonly="readonly"':'');?>  /></td>
		      ...
		      <td align="left" valign="top"><?php
					...
					?>
		        <select disabled="disabled"  class="EstFormularioCombo" name="CmpCotizoOtroLugar" id="CmpCotizoOtroLugar">
		          <option value="">-</option>
		    ...
		    <tr>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">Seguimiento / Status:</td>
		      <td align="left" valign="top"><?php
					
					switch($InsCotizacionVehiculo->CveStatus){
						
						case 1:
							$OpcStatus1 = 'selected = "selected"';
						break;
						
						case 2:
							$OpcStatus2 = 'selected = "selected"';
						break;
						
						case 3:
							$OpcStatus3 = 'selected = "selected"';
						break;
						
						case 4:
							$OpcStatus4 = 'selected = "selected"';						
						break;
						
						case 5:
							$OpcStatus5 = 'selected = "selected"';						
						break;
						
						case 6:
							$OpcStatus6 = 'selected = "selected"';						
						break;
						
						case 7:
							$OpcStatus7 = 'selected = "selected"';						
						break;
						
					}
					?>
		        <select disabled="disabled"  class="EstFormularioCombo" name="CmpStatus" id="CmpStatus">
		          <option <?php echo $OpcStatus1;?> value="1">Seguimiento</option>
		          <option <?php echo $OpcStatus2;?> value="2">Compro Otra Marca</option>
		          <option <?php echo $OpcStatus3;?> value="3">Creadito Rechazado</option>
		          <option <?php echo $OpcStatus4;?> value="4">Compra a mas de 60 días</option>
		          <option <?php echo $OpcStatus5;?> value="5">No esta interesado</option>
		          <option <?php echo $OpcStatus6;?> value="6">Cotizacion Cerrada</option>
		          <option <?php echo $OpcStatus7;?> value="7">Vendido</option>
		          </select></td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
		      <td align="left" valign="top">&nbsp;</td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea">
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               <td><a href="javascript:FncCotizacionVehiculoDetalleNuevo();"></a></td>
               <td align="left" valign="top"><select class="EstFormularioCombo" name="CmpVehiculoMarca" id="CmpVehiculoMarca" disabled="disabled" >
                 <option value="">Escoja una opcion</option>
                 <?php
			...
			?>
               ...
               <td><input name="CmpColor" type="text" class="EstFormularioCaja" id="CmpColor" value="<?php echo ($InsCotizacionVehiculo->CveColor);?>" size="15" maxlength="30" readonly="readonly" /></td>
               <td><input name="CmpAnoModelo" type="text" class="EstFormularioCaja" id="CmpAnoModelo" value="<?php echo ($InsCotizacionVehiculo->CveAnoModelo);?>" size="5" maxlength="4" readonly="readonly" /></td>
               <td align="left" valign="top"><?php
               ...
               <td align="left" valign="top"><input name="CmpCantidad" type="text" class="EstFormularioCaja" id="CmpCantidad" value="<?php echo number_format($InsCotizacionVehiculo->CveCantidad,2);?>" size="5" maxlength="10" readonly="readonly" /></td>
               <td><input name="CmpTotal" type="text" class="EstFormularioCaja" id="CmpTotal" value="<?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?>" size="7" maxlength="10" readonly="readonly" /></td>
               <td><input name="CmpDescuento" type="text" class="EstFormularioCaja" id="CmpDescuento" value="<?php echo number_format($InsCotizacionVehiculo->CveDescuento,2);?>" size="7" maxlength="10" readonly="readonly" /></td>
               <td><input name="CmpTotal2" type="text" class="EstFormularioCaja" id="CmpTotal2" value="<?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?>" size="7" maxlength="10" readonly="readonly" /></td>
               <td>&nbsp;</td>
               </tr>
             <tr>
               <td>&nbsp;</td>
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
         ...
         <div class="EstFormularioCajaObservacion">
          <?php echo stripslashes($InsCotizacionVehiculo->CveNota);?>
          </div>
          <input type="hidden" name="CmpNota" id="CmpNota" value="<?php echo stripslashes($InsCotizacionVehiculo->CveNota);?>" />
