...
<hr class="EstReporteLinea">
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="1" class="EstCotizacionVehiculoImprimirTabla">
    ...
    <!--  <p>
      <span class="EstCotizacionVehiculoImprimirTitulo">Cliente: </span>
      </p>-->
      </td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      ...
      <table  class="EstCotizacionVehiculoImprimirTabla" width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <?php echo $InsCotizacionVehiculo->TdoNombre;?>: <?php echo $InsCotizacionVehiculo->CliNumeroDocumento;?>
        </span>
      ...
      <tr>
        ...
        <td align="left" valign="top"><span class="EstCotizacionVehiculoImprimirContenido"><?php echo $InsCotizacionVehiculo->CliNombre;?> <?php echo $InsCotizacionVehiculo->CliApellidoPaterno;?> <?php echo $InsCotizacionVehiculo->CliApellidoMaterno;?>
          </span></td>
        <td align="left" valign="top"><span class="EstCotizacionVehiculoImprimirEtiqueta">Asesor de Ventas:</span></td>
        <td align="left" valign="top">
		<span class="EstCotizacionVehiculoImprimirContenido">
		<?php echo $InsCotizacionVehiculo->PerNombre;?> <?php echo $InsCotizacionVehiculo->PerApellidoPaterno;?> <?php echo $InsCotizacionVehiculo->PerApellidoMaterno;?>
        </span></td>
        </tr>
      <tr>
        ...
        <span class="EstCotizacionVehiculoImprimirContenido"> 
		 <?php echo $InsCotizacionVehiculo->CveAdicional;?> </span>
    ...
    <tr>
      ...
      <td colspan="2" align="left" valign="top" >
     <!-- <p>
      <span class="EstCotizacionVehiculoImprimirTitulo">Vehiculo: </span>
      </p>-->
      </td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstPlantillaImprimirTabla">
       ...
       <tr>
         <td align="center" valign="middle"><span class="EstCotizacionVehiculoImprimirMarcaModeloVersionPrincipal">
  ...
  <?php	
		...
		?></span>
         ...
         <td align="center"><span class="EstCotizacionVehiculoImprimirPrecio"><?php echo $InsCotizacionVehiculo->MonSimbolo;?></span> <span class="EstCotizacionVehiculoImprimirPrecio"><?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?></span></td>
         </tr>
        </tbody>
        </table>
    ...
    <tr>
      ...
      <!-- <p><span class="EstCotizacionVehiculoImprimirTitulo">Fotos referenciales: </span>
       </p>-->
      </td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td colspan="2" valign="top" ><table border="0" align="center" cellpadding="0" cellspacing="0">
		...
		?>
            <img src="../../subidos/cotizacion_vehiculo_fotos/<?php echo $InsCotizacionVehiculo->CveFoto;?>" height="105"  /> <br />
            <span class="EstCotizacionVehiculoImprimirSubContenido">* Foto Referencial</span>
            <?php
		}else if(!empty($InsCotizacionVehiculo->VveFoto)){
			
		?>
            <img src="../../subidos/vehiculo_version_fotos/<?php echo $InsCotizacionVehiculo->VveFoto;?>" height="105"  /> <br />
		...
		?>
        	<img src="../../subidos/vehiculo_version_fotos/<?php echo $InsCotizacionVehiculo->VveFotoLateral;?>" height="105"  />
            <br />
		...
		?>
        	<img src="../../subidos/vehiculo_version_fotos/<?php echo $InsCotizacionVehiculo->VveFotoPosterior;?>" height="105"  />
            <br />
    ...
    <tr>
      ...
      <td colspan="2" valign="top" >
      <!-- <p>
       <span class="EstCotizacionVehiculoImprimirTitulo">Caracteristicas: </span>
       </p>-->
      </td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    ...
    <tbody class="EstCotizacionVehiculoImprimirTablaVersionBody">
          ...
          <tr align="left">
            <td width="250" align="right">
					...
					<?php echo utf8_decode($ArrCaracteristicasDescripcion[$i]['Campo']);?>
