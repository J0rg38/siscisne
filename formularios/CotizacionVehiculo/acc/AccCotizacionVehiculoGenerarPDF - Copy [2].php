...
$pdf->Cell(65,5,($InsCotizacionVehiculo->TdoNombre." - ".$InsCotizacionVehiculo->CliNumeroDocumento),$Borde,0,'L');
$pdf->Cell(28,5,('Fecha:'),$Borde,0,'L');
$pdf->Cell(65,5,($InsCotizacionVehiculo->CveFecha),$Borde,0,'L');

$pdf->Ln(5);

$pdf->SetFont('Arial','B',8);
$pdf->Cell(28,5,('Nombres:'),$Borde,0,'L');
$pdf->Cell(65,5,($InsCotizacionVehiculo->CliNombre." ".$InsCotizacionVehiculo->CliApellidoPaterno." ".$InsCotizacionVehiculo->CliApellidoMaterno),$Borde,0,'L');
$pdf->Cell(28,5,('Asesor de Ventas:'),$Borde,0,'L');
$pdf->Cell(65,5,($InsCotizacionVehiculo->PerNombre." ".$InsCotizacionVehiculo->PerApellidoPaterno." ".$InsCotizacionVehiculo->PerApellidoMaterno),$Borde,0,'L');

$pdf->Ln(5);

$pdf->SetFont('Arial','B',8);
$pdf->Cell(28,5,('Adicionales:'),$Borde,0,'L');
$pdf->Cell(65,5,($InsCotizacionVehiculo->CveAdicional),$Borde,0,'L');
$pdf->Cell(28,5,('Contacto:'),$Borde,0,'L');

$Contacto = "";

if(!empty($InsCotizacionVehiculo->PerTelefono)){
	$Contacto.= "Tel.: ".$InsCotizacionVehiculo->PerTelefono;
}

if(!empty($InsCotizacionVehiculo->PerCelular)){
	$Contacto .= " / Cel.:".$InsCotizacionVehiculo->PerCelular;
}
	
if(!empty($InsCotizacionVehiculo->PerEmail)){
	$Contacto .= " /Email: ".$InsCotizacionVehiculo->PerEmail;
}
	    
$pdf->Cell(65,5,($Contacto),$Borde,1,'L');
...
$pdf->SetFont('Arial','B',8);
$pdf->Cell(15,5,(''),0,0,'T');
$pdf->Cell(120,5,('Modelo'),1,0,'C');
$pdf->Cell(30,5,('Precio'),1,0,'C');

$pdf->Ln(5);


$Modelo = $InsCotizacionVehiculo->VmaNombre." ".$InsCotizacionVehiculo->VmoNombre." ".$InsCotizacionVehiculo->VveNombre;

if(!empty($InsCotizacionVehiculo->CveAnoFabricacion)){
   $Modelo .= "- Fab. ".$InsCotizacionVehiculo->CveAnoFabricacion;
}

if(!empty($InsCotizacionVehiculo->CveAnoModelo)){
   $Modelo .= "- Mod. ".$InsCotizacionVehiculo->CveAnoModelo;
}
...
$pdf->Cell(15,5,(''),0,0,'T');
$pdf->Cell(120,5,($Modelo),1,0,'C');
$pdf->Cell(30,5,($InsCotizacionVehiculo->MonSimbolo." ".number_format($InsCotizacionVehiculo->CveTotal,2)),1,0,'C');


$pdf->Ln(5);	


/*$pdf->Cell(65,5,(!empty($InsCotizacionVehiculo->CveFoto)?$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->CveFoto),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0):$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFoto),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0)).(!empty($InsCotizacionVehiculo->VveFotoLateral)?$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoLateral),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0):"").(!empty($InsCotizacionVehiculo->VveFotoPosterior)?$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoPosterior),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0):""),$Borde,0,'L');*/


if(!empty($InsCotizacionVehiculo->CveFoto)){
	
	//$pdf->Cell(30,30, $pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->CveFoto),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0),1,0,'C');
	
	//mage(string file [, float x [, float y [, float w [, float h [, string type [, mixed link]]]]]])
	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->CveFoto),30,70,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);
	//$pdf->SetFont('Arial','',8);
	//$pdf->Cell(65,5,'* Foto referencial',$Borde,0,'L');
	
}else if(!empty($InsCotizacionVehiculo->VveFoto)){

	//$pdf->Cell(30,30, $pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFoto),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0),1,0,'C');
	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFoto),30,70,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);
	//$pdf->SetFont('Arial','',8);
	//$pdf->Cell(65,5,'* Foto referencial',$Borde,0,'L');
}
...
if(!empty($InsCotizacionVehiculo->VveFotoLateral)){
	...
	//$pdf->Cell(30,30, $pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoLateral),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0),1,0,'C');
	
	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoLateral),80,70,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);
	//$pdf->SetFont('Arial','',8);
	//$pdf->Cell(65,5,'* Foto Lateral',$Borde,0,'L');
}

if(!empty($InsCotizacionVehiculo->VveFotoPosterior)){
	
	//$pdf->Cell(30,30, $pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoPosterior),NULL,NULL,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0),1,0,'C');
	
	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoPosterior),130,70,NULL,20,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);
	//$pdf->SetFont('Arial','',8);
	//$pdf->Cell(65,5,'* Foto Posterior',$Borde,0,'L');
	
}

$pdf->SetFont('Arial','',8);
$pdf->Cell(190,25,'',$Borde,1,'L');

$pdf->SetFont('Arial','',8);
$pdf->Cell(50,3,'',$Borde,0,'L');
...
if(!empty($InsCotizacionVehiculo->CveFoto) or !empty($InsCotizacionVehiculo->VveFoto)){
	...
	$pdf->SetFont('Arial','',6);
	$pdf->Cell(30,3,'* Foto referencial',$Borde,$Saltar1,'L');
...
if(!empty($InsCotizacionVehiculo->VveFotoLateral)){
	...
	$pdf->SetFont('Arial','',6);
	$pdf->Cell(30,3,'* Foto Lateral',$Borde,$Saltar2,'L');
...
if(!empty($InsCotizacionVehiculo->VveFotoPosterior)){
	...
	$pdf->SetFont('Arial','',6);
	$pdf->Cell(30,3,'* Foto Posterior',$Borde,$Saltar3,'L');
			...
			if(!empty($InsCotizacionVehiculo->VehiculoVersionCaracteristica)){	
					foreach($InsCotizacionVehiculo->VehiculoVersionCaracteristica as $DatVehiculoVersionCaracteristica ){
						...
						if($DatVehiculoVersionCaracteristica->VcsId == $DatVehiculoCaracteristicaSeccion->VcsId){
							...
							$pdf->SetFont('Arial','',6);
							$pdf->Cell(100,3,utf8_decode(stripslashes($DatVehiculoVersionCaracteristica->VvcDescripcion)),1,0,'L');
...
$pdf->Cell(190,5,'Otras Versiones:',$Borde,1,'L');
...
if(!empty($InsCotizacionVehiculo->CveAnoModelo)){
        ...
        foreach($ArrVehiculoVersiones as $DatVehiculoVersion){
			...
			if(!empty($ArrVehiculoVersionCaracteristicas)){
				...
				//if($DatVehiculoVersion->VveId==$InsCotizacionVehiculo->VveId){
			   	...
			   	$pdf->SetFont('Arial','B',6);
				$pdf->Cell(30,5,$DatVehiculoVersion->VveNombre,1,((count($ArrVehiculoVersiones)==$TotalVersiones)?1:0),'C');
	...
	for($i=1;$i<($registro);$i++){
		...
		$pdf->SetFont('Arial','',6);
		$pdf->Cell(50,3,utf8_decode($ArrCaracteristicasDescripcion[$i]['Campo']),1,0,'R');	
...
//				$ArrVehiculoVersionCaracteristicas = $ResVehiculoVersionCaracteristica['Datos'];
				...
				$pdf->SetFont('Arial','',6);
				$pdf->Cell(30,3, (($ArrCaracteristicas[$DatVehiculoVersion->VveId][$i]=="X")?"Si":$ArrCaracteristicas[$DatVehiculoVersion->VveId][$i]),1,((count($ArrVehiculoVersiones)==$TotalVersiones
				)?1:0),'C');
