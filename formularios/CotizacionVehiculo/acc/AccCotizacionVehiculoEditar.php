...
if (isset($_POST['BtnGuardar_x']) or (isset($_POST['Guardar']) && $_POST['Guardar'] == "1")) {
	...
	$InsCotizacionVehiculo->CvePrecio = preg_replace("/,/", "", empty($_POST['CmpPrecio']) ? 0 : $_POST['CmpPrecio']);
	$InsCotizacionVehiculo->CveDescuento = preg_replace("/,/", "", empty($_POST['CmpDescuento']) ? 0 : $_POST['CmpDescuento']);

	$InsCotizacionVehiculo->CveTotal = preg_replace("/,/", "", empty($_POST['CmpTotal']) ? 0 : $_POST['CmpTotal']);
...
*/
	...
	$InsCotizacionVehiculo->CvePrecio2 = preg_replace("/,/", "", empty($_POST['CmpPrecio2']) ? 0 : $_POST['CmpPrecio2']);
	$InsCotizacionVehiculo->CveDescuento2 = preg_replace("/,/", "", empty($_POST['CmpDescuento2']) ? 0 : $_POST['CmpDescuento2']);

	$InsCotizacionVehiculo->CveTotal2 = preg_replace("/,/", "", empty($_POST['CmpTotal2']) ? 0 : $_POST['CmpTotal2']);
...
*/
	...
	$InsCotizacionVehiculo->CvePrecio3 = preg_replace("/,/", "", empty($_POST['CmpPrecio3']) ? 0 : $_POST['CmpPrecio3']);
	$InsCotizacionVehiculo->CveDescuento3 = preg_replace("/,/", "", empty($_POST['CmpDescuento3']) ? 0 : $_POST['CmpDescuento3']);

	$InsCotizacionVehiculo->CveTotal3 = preg_replace("/,/", "", empty($_POST['CmpTotal3']) ? 0 : $_POST['CmpTotal3']);
...
function FncCargarDatos()
{
	...
	if (!empty($InsCotizacionVehiculo->CotizacionVehiculoFoto)) {
		foreach ($InsCotizacionVehiculo->CotizacionVehiculoFoto as $DatCotizacionVehiculoFoto) {
			...
			$_SESSION['InsCotizacionVehiculoFoto' . $Identificador]->MtdAgregarSesionObjeto(
				1,
