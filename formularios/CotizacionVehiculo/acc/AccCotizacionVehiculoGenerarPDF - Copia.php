...
if(!empty($InsCotizacionVehiculo->CveFoto)){
	...
	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->CveFoto),$FotoAX,$FotoAY,NULL,18);
	
}else if(!empty($InsCotizacionVehiculo->VveFoto)){

	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFoto),$FotoAX,$FotoAY,NULL,18);
