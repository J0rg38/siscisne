...
$pdf->SetFont('Arial','B',8);
$pdf->Cell(28,5,utf8_decode('Modelo/Año:'),$Borde,0,'L');
$pdf->SetFont('Arial','',8);
...
$pdf->Cell(95,5,('ASESOR DE VENTAS'),1,0,'L');
	...
	*/
	...
	$ArchivoFacturaCodigoQR = $InsPersonal->PerId.'_QR.png'; 
	...
	$pdf->write2DBarcode($codeContents, 'QRCODE,Q', 95, 50, 25, 25, $style, 'N');
