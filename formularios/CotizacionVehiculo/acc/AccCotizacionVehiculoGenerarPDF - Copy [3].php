...
$pdf->SetFont('Arial','',8);
$pdf->Cell(67,5,($InsCotizacionVehiculo->CveAdicional),$Borde,0,'L');
$pdf->SetFont('Arial','B',8);
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(67,5,($Contacto),$Borde,1,'L');
...
if(!empty($InsCotizacionVehiculo->CveFoto)){
	...
	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->CveFoto),$FotoAX,$FotoAY,NULL,18,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);
	
}else if(!empty($InsCotizacionVehiculo->VveFoto)){

	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFoto),$FotoAX,$FotoAY,NULL,18,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);

}

if(!empty($InsCotizacionVehiculo->VveFotoLateral)){

	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoLateral),$FotoBX,$FotBY,NULL,18,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);
	
}

if(!empty($InsCotizacionVehiculo->VveFotoPosterior)){
	
	$pdf->Image('../../../subidos/vehiculo_version_fotos/'.utf8_decode($InsCotizacionVehiculo->VveFotoPosterior),$FotoCX,$FotoCY,NULL,18,NULL,NULL,NULL,true,NULL,NULL,NULL,NULL,0,0);
	
}

$pdf->SetFont('Arial','',8);
$pdf->Cell(190,28,'',$Borde,1,'L');
...
if(!empty($InsCotizacionVehiculo->CveFoto) or !empty($InsCotizacionVehiculo->VveFoto)){
	...
	$pdf->SetFont('Arial','',6);
	$pdf->Cell(30,3,'* Foto referencial',$Borde,$Saltar1,'C');
...
//				$ArrVehiculoVersionCaracteristicas = $ResVehiculoVersionCaracteristica['Datos'];
				...
				$pdf->SetFont('Arial','',6);
				$pdf->Cell(30,3, (($ArrCaracteristicas[$DatVehiculoVersion->VveId][$i]=="X")?"Si":$ArrCaracteristicas[$DatVehiculoVersion->VveId][$i]),0,((count($ArrVehiculoVersiones)==$TotalVersiones
				)?1:0),'C');
