...
$InsCotizacionVehiculoLlamada1 = array();
$InsCotizacionVehiculoLlamada1 = $_SESSION['InsCotizacionVehiculoLlamada'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
...
$_SESSION['InsCotizacionVehiculoLlamada'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsCotizacionVehiculoLlamada1->Parametro1,
...
3,
$InsCotizacionVehiculoLlamada1->Parametro7,
date("d/m/Y H:i:s"),
