...
<input type="hidden" name="Guardar" id="Guardar"   />
             ...
             <tr>
               ...
               <td align="left" valign="top"><input readonly="readonly" name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsCotizacionVehiculo->CveId;?>" size="25" maxlength="20" /></td>
               <td align="left" valign="top">Fecha:<br />
                 <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
               <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if(empty($InsCotizacionVehiculo->CveFecha)){ echo date("d/m/Y");}else{ echo $InsCotizacionVehiculo->CveFecha; }?>" size="15" maxlength="10" readonly="readonly" /></td>
               <td>&nbsp;</td>
               </tr>
             <tr>
               <td>&nbsp;</td>
...
//});
                 ...
                 <textarea name="CmpNota" cols="60" rows="8" class="EstFormularioCaja" id="CmpNota"><?php echo stripslashes($InsCotizacionVehiculo->CveNota);?></textarea></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
