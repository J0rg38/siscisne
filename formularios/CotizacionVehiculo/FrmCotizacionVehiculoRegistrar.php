...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccCotizacionVehiculoRegistrar.php');
...
//MtdObtenerCondicionVentas($oCampo=NULL,$oFiltro=NULL,$oOrden = 'CovId',$oSentido = 'Desc',$oPaginacion = '0,10',$oUso=NULL)

//echo $_SESSION['SesionSucursalSiglas']."asdf";
...
?>
					...
					?>
                      ...
                      <!-- <span class="EstFormularioCampoObligatorio">(*)</span>--></td>
                    <td align="left" valign="top">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="left" valign="top">&nbsp;</td>
			...
			?>
                        ...
                        <td><input name="CmpClienteNombre" type="hidden" id="CmpClienteNombre" value="<?php echo $InsCotizacionVehiculo->CliNombre;?>" size="3" />
...
<input <?php echo (!empty($InsCotizacionVehiculo->CliId)?'readonly="readonly"':'');?>  class="EstFormularioCaja" name="CmpClienteNombreCompleto" type="text" id="CmpClienteNombreCompleto" value="<?php echo $InsCotizacionVehiculo->CliNombre;?> <?php echo $InsCotizacionVehiculo->CliApellidoPaterno;?> <?php echo $InsCotizacionVehiculo->CliApellidoMaterno;?>" size="45" maxlength="255"  />                          <a href="comunes/Cliente/FrmClienteBuscar.php?height=440&amp;width=850" class="thickbox" title=""><img src="imagenes/acciones/buscador.png" width="25" height="25" border="0" align="absmiddle" ></a></td>
                        <td><!-- <span class="EstFormularioCampoObligatorio">(*)</span>--></td>
			...
			?>
			  ...
			  ?>
                  ...
                  <tr>
                    <td align="left" valign="top">&nbsp;</td>
                    <td colspan="4" align="left" valign="top"><span class="EstFormularioSubTitulo">Accesorios:</span></td>
                    <td align="left" valign="top">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="left" valign="top">&nbsp;</td>
...
tinymce.init({
	...
	height : 120
                  ...
                  <tr>
					...
					?>
                      <select  class="EstFormularioCombo" name="CmpStatus" id="CmpStatus">
                        ...
                        <option <?php echo $OpcStatus4;?> value="4">Compra a mas de 60 d�as</option>
                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">
                        ...
                        <a href="javascript:FncCotizacionVehiculoDetalleNuevo();">
			...
			?>
                      ...
                      <td align="left" valign="top">
                        ...
                        <input class="EstFormularioCaja" name="CmpColor" type="text" id="CmpColor" value="<?php echo ($InsCotizacionVehiculo->CveColor);?>" size="15" maxlength="30" />
                        
  </td>
                      <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpAnoModelo" type="text" id="CmpAnoModelo" value="<?php echo ($InsCotizacionVehiculo->CveAnoModelo);?>" size="5" maxlength="4" /></td>
                      <td align="left" valign="top"><?php
					...
					?>
                      ...
                      <td align="left" valign="top"><input name="CmpCantidad" type="text" class="EstFormularioCaja" id="CmpCantidad" value="<?php echo number_format($InsCotizacionVehiculo->CveCantidad,2);?>" size="5" maxlength="10" /></td>
                      <td align="left" valign="top"><input name="CmpPrecio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPrecio" value="<?php echo number_format($InsCotizacionVehiculo->CvePrecio,2);?>" size="7" maxlength="10" /></td>
                      <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpDescuento" type="text" id="CmpDescuento" value="<?php echo number_format($InsCotizacionVehiculo->CveDescuento,2);?>" size="7" maxlength="10" /></td>
                      <td align="left" valign="top"><input name="CmpTotal" type="text" class="EstFormularioCaja" id="CmpTotal" value="<?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?>" size="7" maxlength="10" />
                        <!-- <span class="EstFormularioCampoObligatorio">(*)</span>--></td>
                      <td align="left" valign="top">&nbsp;</td>
                      </tr>
                    <tr>
              ...
              <td valign="top">
                ...
                <div class="EstFormularioArea">
                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td><span class="EstFormularioSubTitulo">Disponibilidad/Lista de Precios</span></td>
                      <td align="right">
                        
                        <a href="javascript:FncVehiculoIngresoListar();">
                    ...
                    <tr>
                      ...
                      <td colspan="2">
                        ...
                        <div id="CapVehiculoIngreso" class="EstCapVehiculoIngreso">
                    ...
                    <tr>
                      ...
                      <td colspan="2">
                        ...
                        <div id="CapVehiculoListaPrecio" class="EstCapVehiculoListaPrecio"></div>
...
Calendar.setup({ 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnFechaVigencia"// el id del bot�n que  
	});
