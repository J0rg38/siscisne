...
*/
	...
	if(seleccionados==""){
		...
		if(confirm("¿Realmente deseas marcar a Listo la(s) Cotizaciones de Vehiculo?")){
			...
			if(actualizar){
				//$("#Acc").val("CotizacionVehiculoVentaAnularEnvioFacturacion");
...
FncPopUp('formularios/CotizacionVehiculo/FrmCotizacionVehiculoImprimir2.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
	...
	if(Tipo !== null){
		switch(Tipo.toUpperCase()){
			...
			case "2":
				...
				FncPopUp('formularios/CotizacionVehiculo/FrmCotizacionVehiculoImprimir2.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
