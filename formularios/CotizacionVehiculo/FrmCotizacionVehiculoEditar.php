...
//						break;
                 ...
                 <select  class="EstFormularioCombo" name="CmpNivelInteres" id="CmpNivelInteres">
                   ...
                   <option <?php echo $OpcNivelInteres1;?> value="1">Normal (Sin Inter�s)</option>
         ...
         <td valign="top">
           <div class="EstFormularioArea">
			...
			?>
                 ...
                 <td align="left" valign="top"><input name="CmpTotal" type="text" class="EstFormularioCaja" id="CmpTotal" value="<?php echo number_format($InsCotizacionVehiculo->CveTotal,2);?>" size="7" maxlength="10" /></td>
                 <td align="left" valign="top">&nbsp;</td>
               </tr>
               <tr>
                 <td>&nbsp;</td>
