...
*/
	...
	if ($PrivilegioAccesoTotal) {
		...
		$ResPersonal = $InsPersonal->MtdObtenerPersonales(NULL, NULL, NULL, "PerNombre", "ASC", NULL, NULL, 1, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, true);
		$ArrPersonales = $ResPersonal['Datos'];
	}
...
-->
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE COTIZACION DE VEHICULOS</span>
					</td>
				</tr>
				<tr>
					<td width="50%">
      ...
      <tr>
        ...
        <td width="14%" align="center"><div id="CapListadoTotal" ></div></td>
						...
						?>
							...
							<table width="100%" border="0" cellpadding="2" cellspacing="4" class="EstTablaTotales">
								<tr>
									<td width="65%" align="right" class="EstTablaTotalesEtiqueta">TOTAL: <span class="EstMonedaSimbolo"><?php echo $InsMoneda->MonSimbolo; ?></span></td>
									<td width="35%" align="right" class="EstTablaTotalesContenido">
      ...
      <option value="CveId" <?php if ($POST_cam == "CveId") {
								echo 'selected="selected"';
							} ?>>Id</option>
    ...
    <select class="EstFormularioCombo" name="Estado" id="Estado">
      <option value="0" <?php if ($POST_estado == 0) {
							echo 'selected="selected"';
						} ?>>Todos</option>
      ...
      <option value="0" <?php if ($POST_NivelInteres == 0) {
							echo 'selected="selected"';
						} ?>>Todos</option>
      <option value="1" <?php if ($POST_NivelInteres == 1) {
							echo 'selected="selected"';
						} ?>>Normal</option>
      <option value="2" <?php if ($POST_NivelInteres == 2) {
							echo 'selected="selected"';
						} ?>>Interesado</option>
      <option value="3" <?php if ($POST_NivelInteres == 3) {
							echo 'selected="selected"';
						} ?>>Muy Interesado</option>  
      <option value="3" <?php if ($POST_NivelInteres == 4) {
							echo 'selected="selected"';
						} ?>>Venta Concluida</option>  
      </select>-->


						<?php
						switch ($POST_NivelInteres) {
							case 1:
						...
						?>
						<select class="EstFormularioCombo" name="Status" id="Status">
							<option value="">Todos</option>
							...
							<option <?php echo $OpcStatus4; ?> value="4">Compra a mas de 60 d&iacute;as</option>
						...
						<table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0">
							...
							<thead class="EstTablaListadoHead">
								...
								<tr>
									...
									<th width="5%"><?php
													if ($POST_ord == "CveStatus") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('CveStatus','ASC');"> Status <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('CveStatus','DESC');"> Status <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('CveStatus','ASC');"> Status </a>
										<?php
													}
										?>
									</th>
								...
								<tr>
									...
									<td colspan="21" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $CotizacionVehiculosTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $CotizacionVehiculosTotal; ?>">Todos</option>
										</select>
							...
							<tbody class="EstTablaListadoBody">
								...
								?>
									...
									<tr id="Fila_<?php echo $f; ?>">
										<td width="1%" align="center" bgcolor="<?php //echo $dat->CveNivelColor;
																				?>"><?php echo $f; ?></td>
										<td width="2%" align="center">

											<input onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->CveId; ?>" orden_venta="<?php echo $dat->OvvId; ?>" estado="<?php echo $dat->OvvEstado; ?>" tiene_orden_venta="<?php echo $dat->CveOrdenVentaVehiculo; ?>" />
										</td>
										...
										<td width="16%" align="right"><?php
											...
											switch ($dat->CveNivelInteres) {
												case 1:
											?>
													<img src="imagenes/estado/icon_nivel1.png" width="25" height="25" align="Nivel 1" title="Nivel 1" />
												<?php
													break;

												case 11:
												?>
													<img src="imagenes/estado/icon_nivel11.png" width="25" height="25" align="Nivel 2" title="Nivel 2" />
												<?php
													break;
												...
												case 12:
												?>
													<img src="imagenes/estado/icon_nivel12.png" width="25" height="25" align="Nivel 3" title="Nivel 3" />
												<?php
													break;

												case 2:
												?>
													<img src="imagenes/estado/icon_nivel2.png" width="25" height="25" align="Nivel 4" title="Nivel 4" />
												<?php
													break;

												case 3:
												?>
													<img src="imagenes/estado/icon_nivel3.png" width="25" height="25" align="Nivel 5" title="Nivel 5" />
											<?php
													break;
											}
											?>
										...
										<td width="3%" align="right"><?php
																		...
																		?>
												<a href="formularios/CotizacionVehiculo/DiaOrdenVentaVehiculoListado.php?height=440&amp;width=850&amp;CveId=<?php echo $dat->CveId ?>" class="thickbox" title=""> Tiene Ord. Venta </a>
											<?php
																		} else {
											?>
												No Tiene Ord. Venta
										...
										<td width="5%" align="right"><?php echo $dat->CveStatusDescripcion;  ?></td>
										...
										<td width="10%" align="center">
											...
											if ($PrivilegioEditar and $dat->CveEstado <> 6) {
											?>
												<a href="javascript:FncCotizacionVehiculoEnviarCorreo('<?php echo $dat->CveId; ?>')">

													<img src="imagenes/acciones/enviar_correo3.png" width="19" height="19" border="0" title="Enviar Correo" alt="[Enviar Correo]" /></a>
											<?php
											}
											?>
										</td>
						...
						<table border="0" cellpadding="2" cellspacing="2" class="EstPanelTablaListado">
							<tbody class="EstPanelTablaListadoBody">
								<tr>
									...
									<td align="left" valign="middle"><img src="imagenes/estado/icon_nivel1.png" alt="" width="25" height="25" align="Nivel 1" title="Nivel 1" /></td>
									<td align="left" valign="middle">Normal (Sin Interés)</td>
									<td align="left" valign="middle"><img src="imagenes/estado/icon_nivel11.png" alt="" width="25" height="25" align="Nivel 2" title="Nivel 2" /></td>
									<td align="left" valign="middle">
										<p>Poco Interesado</p>
									</td>
									<td align="left" valign="middle"><img src="imagenes/estado/icon_nivel12.png" alt="" width="25" height="25" align="Nivel 3" title="Nivel 3" /></td>
									<td align="left" valign="middle">Medianamente Interesado</td>
									<td align="left" valign="middle"><img src="imagenes/estado/icon_nivel2.png" alt="" width="25" height="25" align="Nivel 4" title="Nivel 4" /></td>
									<td align="left" valign="middle"><span class="EstPanelTablaListadoContenido">Interesado</span></td>
									<td align="left" valign="middle"><span class="EstPanelTablaListadoEtiqueta"><img src="imagenes/estado/icon_nivel3.png" alt="" width="25" height="25" align="Nivel 5" title="Nivel 5" /></span></td>
									<td align="left" valign="middle">Muy Interesado</td>
