    ...
    ?>
          ...
          <tr>
            ...
            <td>
              ...
              <input readonly="readonly" class="EstFormularioCaja" name="CmpInicio" type="text" id="CmpInicio" value="<?php echo $InsNotaDebitoTalonario->NdtInicio;?>" size="20" maxlength="20" />
            </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>Descripcion:</td>
            <td><input name="CmpDescripcion" type="text" class="EstFormularioCaja" id="CmpDescripcion" value="<?php echo $InsNotaDebitoTalonario->NdtDescripcion;?>" size="45" readonly="readonly" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
