...
$ResPago = $InsPago->MtdObtenerPagos(NULL,NULL,NULL,"PagFecha","ASC","",3,$InsVentaDirecta->VdiId,NULL,$POST_CondicionPago,$InsVentaDirecta->MonId);
...
<link href="css/CssPagoVentaDirectaImprimir.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="js/JsPagoVentaDirectaImprimir.js"></script>
