                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                                ...
                                ?>
                                  <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsPago->MonId == $DatMoneda->MonId) {
                      ...
                      <td align="left" valign="top">
                        <table>
                          <tr>
                            <td><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncPagoDetalleListar();" value="<?php if (empty($InsPago->PagTipoCambio)) {
                                                                                                                                                                              echo "";
                                                                                                                                                                            } else {
                                                                                                                                                                              echo $InsPago->PagTipoCambio;
                    ...
                    <tr>
                      <td rowspan="3">&nbsp;</td>
                      <td align="left" valign="top">Observacion Interna: <input name="CmpConcepto" type="hidden" id="CmpConcepto" value="<?php echo $InsPago->PagConcepto; ?>" /></td>
                      ...
                      <td colspan="2" rowspan="3" align="left" valign="top"><iframe src="formularios/PagoVentaDirecta/acc/AccPagoVentaDirectaSubirArchivo.php?Identificador=<?php echo $Identificador; ?>" id="IfrPagoVentaDirectaSubirArchivo" name="IfrPagoVentaDirectaSubirArchivo" scrolling="auto" frameborder="0" width="310" height="200"></iframe></td>
                      <td rowspan="3">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top">Observacion Impresa:</td>
                      <td align="left" valign="top"><textarea class="EstFormularioCaja" name="CmpObservacionImpresa" id="CmpObservacionImpresa" cols="45" rows="3"><?php echo $InsPago->PagObservacionImpresa; ?></textarea></td>
                    </tr>
                    <tr>
                      <td align="left" valign="top">Observacion Caja:</td>
                      <td align="left" valign="top"><textarea class="EstFormularioCaja" name="CmpObservacionImpresaCaja" id="CmpObservacionImpresaCaja" cols="45" rows="3"><?php echo $InsPago->PagObservacionCaja; ?></textarea></td>
                    </tr>
...
if (empty($GET_dia)) {
  ...
  if (!$_SESSION['MysqlDeb']) {
    $InsMensaje->MtdRedireccionar("principal.php?Mod=" . (!empty($GET_NMod) ? $GET_NMod : $GET_mod) . "&Form=Listado&VdiId=" . $_GET['VdiId'], $Edito, 1500);
  }
}
