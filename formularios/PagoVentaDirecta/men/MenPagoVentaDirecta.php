...
?>  
	...
	<div class="EstSubMenuBoton"><a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=<?php echo (!empty($GET_NMod)?$GET_NMod:$GET_mod);?>&Form=Listado<?php echo (!empty($GET_dia)?'&Dia=1':'');?>&VdiId=<?php echo $_GET['VdiId'];?>"><img src="imagenes/iconos/listado.png" alt="[Listado]"  title="Ir a formulario de listado" />Listado</a></div>
