...
/*$POST_Moneda = $InsVentaDirecta->MonId;*/
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE ABONOS DE ORDEN DE VENTA (VENTA X MOSTRADOR): <?php echo $InsVentaDirecta->VdiId;?></span></td>
</tr>
...
<tr>
  ...
  <?php $InsVentaDirecta->VdiTotal = (($EmpresaMonedaId==$InsVentaDirecta->MonId or empty($InsVentaDirecta->MonId))?$InsVentaDirecta->VdiTotal:($InsVentaDirecta->VdiTotal/$InsVentaDirecta->VdiTipoCambio));?>
    <?php $InsVentaDirecta->VdiSaldo = (($EmpresaMonedaId==$InsVentaDirecta->MonId or empty($InsVentaDirecta->MonId))?$InsVentaDirecta->VdiSaldo:($InsVentaDirecta->VdiSaldo/$InsVentaDirecta->VdiTipoCambio));?>
    <!--<table width="100%" border="0" cellpadding="2" cellspacing="4" class="EstTablaTotales">
      <tr>
        <td align="right" class="EstTablaTotalesEtiqueta">TOTAL: <span class="EstMonedaSimbolo"> <?php echo $InsVentaDirecta->MonSimbolo;?></span></td>
        <td align="right" class="EstTablaTotalesContenido"><?php echo number_format($InsVentaDirecta->VdiTotal,2);?></td>
        <td align="right" class="EstTablaTotalesEtiqueta">POR COBRAR: <span class="EstMonedaSimbolo"> <?php echo $InsVentaDirecta->MonSimbolo;?></span></td>
        <td align="right" class="EstTablaTotalesContenido"><div id="CapTotalOrdenCobros" ></div></td>
        <td align="right" class="EstTablaTotalesEtiqueta">ABONADO: <span class="EstMonedaSimbolo"> <?php echo $InsVentaDirecta->MonSimbolo;?></span></td>
        <td align="right" class="EstTablaTotalesContenido"><div id="CapTotalAbonos" ></div></td>
        <td align="right" class="EstTablaTotalesEtiqueta">SALDO: <span class="EstMonedaSimbolo"><?php echo $InsVentaDirecta->MonSimbolo;?></span></td>
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td  width="5%" align="right" ><?php $dat->PagMonto = (($dat->PagMonto/(empty($dat->PagTipoCambio)?1:$dat->PagTipoCambio)));?>
...
?>
                  <a  target="_blank" href="subidos/pago_fotos/<?php echo $nombre_base.".".$extension;?>"  title=""><img  src="imagenes/documento.gif" alt="" border="0"  /></a>
                  <?php	
}
?>
                  <?php            
...
?>
                  ...
                  <a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=PagoVentaDirecta&Form=<?php echo (($dat->PagEstado==1)?"OrdenCobro":"Abono");?>Editar&Id=<?php echo $dat->PagId;?><?php echo (!empty($GET_dia)?'&Dia=1':'');?>&VdiId=<?php echo $GET_VdiId;?>&FtaId=<?php echo $GET_FtaId;?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>
...
?>
                  ...
                  <a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=PagoVentaDirecta&Form=<?php echo (($dat->PagEstado==1)?"OrdenCobro":"Abono");?>Ver&Id=<?php echo $dat->PagId;?><?php echo (!empty($GET_dia)?'&Dia=1':'');?>&VdiId=<?php echo $GET_VdiId;?>&FtaId=<?php echo $GET_FtaId;?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
