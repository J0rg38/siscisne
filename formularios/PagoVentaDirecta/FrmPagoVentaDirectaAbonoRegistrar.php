...
?>
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccPagoVentaDirectaAbonoRegistrar.php');
                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">
                        <table>
                          <tr>
                            <td><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" value="<?php if (empty($InsPago->PagTipoCambio)) {
                                                                                                                                            echo "";
                                                                                                                                          } else {
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">Observacion Interna:
                        <input name="CmpConcepto" type="hidden" id="CmpConcepto" value="<?php echo $InsPago->PagConcepto; ?>" />
                      </td>
                      ...
                      <td colspan="2" rowspan="5" align="left" valign="top">
                        ...
                        <iframe src="formularios/PagoVentaDirecta/acc/AccPagoVentaDirectaSubirArchivo.php?Identificador=<?php echo $Identificador; ?>" id="IfrPagoOrdenVentaVehiculoSubirArchivo" name="IfrPagoOrdenVentaVehiculoSubirArchivo" scrolling="auto" frameborder="0" width="310" height="200"></iframe>
                              ...
                              <table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <thead class="EstTablaListadoHead">
                                  <tr>
                                    ...
                                    <th width="17%">Monto (<?php echo $OtraMonedaSimbolo; ?>)</th>
...
if (empty($GET_dia)) {
  ...
  if (!$_SESSION['MysqlDeb']) {
    ...
    $InsMensaje->MtdRedireccionar("principal.php?Mod=" . (!empty($GET_NMod) ? $GET_NMod : $GET_mod) . "&Form=Listado&VdiId=" . $_GET['VdiId'], $Registro, 1500);
  }
}
