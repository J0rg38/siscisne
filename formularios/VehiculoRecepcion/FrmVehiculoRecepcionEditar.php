...
//for($i=0;$i<15;$i++){
//	if (isset($_SESSION['InsVehiculoRecepcionDetalleFoto'.$i.$Identificador])){
//		
//		$_SESSION['InsVehiculoRecepcionDetalleFoto'.$i.$Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsVehiculoRecepcionDetalleFoto'.$i.$Identificador]);
//	}	
//}
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top"><span id="sprytextfield10">
                 <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if(empty($InsVehiculoRecepcion->VreFecha)){ echo date("d/m/Y");}else{ echo $InsVehiculoRecepcion->VreFecha; }?>" size="15" maxlength="10" />
             ...
             <tr>
               ...
               <td align="left" valign="top">
                 <textarea name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo stripslashes($InsVehiculoRecepcion->VreObservacion);?></textarea></td>
                 ...
                 <td width="98%"><table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                   <tr>
                     ...
                     <td colspan="7">
                       ...
                       <span class="EstFormularioSubTitulo">DETALLES</span><span class="EstFormularioSubTitulo">
                   ...
                   <tr>
                     <td>&nbsp;</td>
                     <td><a href="javascript:FncVehiculoRecepcionDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                     ...
                     <td><a href="comunes/Producto/FrmProductoBuscar.php?height=440&amp;width=850" class="thickbox" title=""></a><a href="javascript:FncVehiculoRecepcionDetalleGuardar();"></a></td>
                     </tr>
                   <tr>
                     <td></td>
                     <td>&nbsp;</td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="0%">&nbsp;</td>
               <td colspan="2"><div class="EstFormularioAccion" id="CapVehiculoRecepcionDetalleAccion">Listo
                 para registrar elementos</div></td>
               <td width="49%" align="right"><a href="javascript:FncVehiculoRecepcionDetalleListar();">
                 <img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncVehiculoRecepcionDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a></td>
               <td width="1%"><div id="CapVehiculoRecepcionDetallesResultado"> </div></td>
               </tr>
             <tr>
               <td>&nbsp;</td>
               <td colspan="3"><div id="CapVehiculoRecepcionDetalles" class="EstCapVehiculoRecepcionDetalles" > </div></td>
               <td>&nbsp;</td>
               </tr>
             </table>
           </div></td>
