...
FncPopUp('formularios/VehiculoRecepcion/FrmVehiculoRecepcionImprimir.php?Id='+oId+'&P=1&ImprimirCodigo=1',0,0,1,0,0,1,0,screen.height,screen.width);

					break;
					
					case "2":

FncPopUp('formularios/VehiculoRecepcion/FrmVehiculoRecepcionImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);

					break;
					
					case "3":

FncPopUp('formularios/VehiculoRecepcion/FrmVehiculoRecepcionImprimir.php?Id='+oId+'&P=1+ImprimirCodigo=1&ImprimirPedido=1',0,0,1,0,0,1,0,screen.height,screen.width);
...
FncPopUp('formularios/VehiculoRecepcion/FrmVehiculoRecepcionImprimir.php?Id='+oId+'&ImprimirCodigo=1',0,0,1,0,0,1,0,screen.height,screen.width);
					break;
...
FncPopUp('formularios/VehiculoRecepcion/FrmVehiculoRecepcionImprimir.php?Id='+oId+'&ImprimirCodigo=1&ImprimirPedido=1',0,0,1,0,0,1,0,screen.height,screen.width);
