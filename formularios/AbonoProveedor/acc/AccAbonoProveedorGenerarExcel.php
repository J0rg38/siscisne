<?php
 ...
 header("Content-Disposition:  filename=\"DESEMBOLSO_".date('d-m-Y').".xls\";");
...
$ResDesembolso = $InsDesembolso->MtdObtenerDesembolsos("cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,per.PerNombre,per.PerApellidoPaterno,per.PerApellidoMaterno,prv.PrvNombre,PrvApellidoPaterno,prv.PrvApellidoMaterno",$POST_con,$POST_fil,$POST_ord,$POST_sen,NULL,$POST_est,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"DesFecha",$POST_Cuenta,$POST_Moneda,$POST_TipoDestino,$POST_Area);
