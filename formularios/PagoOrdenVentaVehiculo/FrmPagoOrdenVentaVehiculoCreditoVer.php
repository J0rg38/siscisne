                ...
                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    ...
                    <td rowspan="13" align="left" valign="top">
                      ...
                      if (!empty($_SESSION['SesPagFoto2' . $Identificador])) {
                      ...
                      ?>
                        Vista Previa:<br />
                        <img src="subidos/pago_fotos/<?php echo $nombre_base . "." . $extension; ?>" width="70" height="70" title="<?php echo $nombre_base . "_thumb." . $extension; ?>" />
                      <?php
                      } else {
                      ?>
                        No hay FOTO
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td align="left" valign="top">Fecha del Credito:<br />
                      <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span>
                    </td>
