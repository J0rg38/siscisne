                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">C&oacute;digo Interno:
                        ...
                        <input name="CmpOrdenVentaVehiculoTalonarioNumero" type="hidden" id="CmpOrdenVentaVehiculoTalonarioNumero" value="<?php echo $OrdenVentaVehiculoTalonarioNumero; ?>" />
                      </td>
                    ...
                    <tr>
                      ...
                      <td colspan="2" align="left" valign="top"><iframe src="formularios/PagoOrdenVentaVehiculo/acc/AccPagoOrdenVentaVehiculoSubirArchivo.php?Identificador=<?php echo $Identificador; ?>" id="IfrPagoOrdenVentaVehiculoSubirArchivo" name="IfrPagoOrdenVentaVehiculoSubirArchivo" scrolling="auto" frameborder="0" width="310" height="200"></iframe></td>
                      <td>&nbsp;</td>
                    </tr>
