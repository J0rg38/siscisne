...
?>
	...
	<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsPagoOrdenVentaVehiculo.js"></script>
	<?php
	/* 
	...
	<form id="FrmListado" name="FrmListado" enctype="multipart/form-data" method="POST" action="#">
      ...
      <tr>
        ...
        <select class="EstFormularioCombo" name="CmpCondicionPago" id="CmpCondicionPago">
      	...
      	<option value="PagId" <?php if ($POST_cam == "PagId") {
									echo 'selected="selected"';
								} ?>>Id</option>
        <option value="PagNumeroTranssaccion" <?php if ($POST_cam == "PagNombre") {
													echo 'selected="selected"';
												} ?>>Num. Transaccion</option>
        <option value="CueNumero" <?php if ($POST_cam == "PagNombre") {
										echo 'selected="selected"';
									} ?>>Num. Cuenta</option>
        <option value="BanNombre" <?php if ($POST_cam == "PagNombre") {
										echo 'selected="selected"';
									} ?>>Banco</option>
								...
								<tr>
									...
									<th width="7%"><?php
													if ($POST_ord == "OvvId") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('OvvId','ASC');"> Ord. Venta <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('OvvId','DESC');"> Ord. Venta <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /> </a>
											<?php
														}
													} else {
											...
											?>
											<a href="javascript:FncOrdenar('OvvId','ASC');"> Ord. Venta </a>
										<?php
													}
										?>
									</th>
									...
									<th width="11%"><?php
													if ($POST_ord == "PagFechaTransaccion") {
														if ($POST_sen == "DESC") {
													?>
												<a href="javascript:FncOrdenar('PagFechaTransaccion','ASC');"> Fecha. Transac. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														} else {
											?>
												<a href="javascript:FncOrdenar('PagFechaTransaccion','DESC');"> Fecha Transac <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]" width="15" height="15" align="absmiddle" /></a>
											<?php
														}
													} else {

											?>
											<a href="javascript:FncOrdenar('PagFechaTransaccion','ASC');"> Fecha Transac. </a>
										<?php
													}
										?>
									</th>
								...
								<tr>
									...
									<td colspan="14" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $PagosTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $PagosTotal; ?>">Todos</option>
										</select>
								...
								?>
									...
									<tr id="Fila_<?php echo $f; ?>">
										...
										<td width="2%" align="center">
											...
											<input onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->PagId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->PagId; ?>" />
										</td>

										<td align="right" valign="middle" width="3%"><?php echo $dat->PagId;  ?></td>
										<td align="right" valign="middle" width="7%"><?php echo $dat->OvvId;  ?></td>
										<td width="8%" align="right"><?php echo $dat->PagNumeroRecibo;  ?></td>
										<td width="8%" align="right"><?php echo $dat->PagFecha; ?></td>
										<td width="11%" align="right"><?php echo $dat->PagFechaTransaccion;  ?></td>
										<td width="11%" align="right"><?php echo $dat->PagNumeroTransaccion;  ?></td>
										<td align="right"><?php echo ($dat->MonNombre); ?></td>
										<td align="right"><?php echo ($dat->PagTipoCambio); ?></td>
										<td width="10%" align="right">


											<?php $dat->PagMonto = (($dat->PagMonto / (empty($dat->PagTipoCambio) ? 1 : (($EmpresaMonedaId == $dat->MonId) ? 1 : $dat->PagTipoCambio)))); ?>
										...
										<td width="15%" align="center">
											...
											?>
												...
												<a href="principal<?php echo (!empty($GET_dia) ? '2' : ''); ?>.php?Mod=PagoOrdenVentaVehiculo&Form=<?php echo (($dat->PagEstado == 1) ? "OrdenCobro" : "Abono"); ?>Editar&Id=<?php echo $dat->PagId; ?><?php echo (!empty($GET_dia) ? '&Dia=1' : ''); ?>&OvvId=<?php echo $GET_OvvId; ?>&FtaId=<?php echo $GET_FtaId; ?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]" /></a>
											...
											?>
												...
												<a href="principal<?php echo (!empty($GET_dia) ? '2' : ''); ?>.php?Mod=PagoOrdenVentaVehiculo&Form=<?php echo (($dat->PagEstado == 1) ? "OrdenCobro" : "Abono"); ?>Ver&Id=<?php echo $dat->PagId; ?><?php echo (!empty($GET_dia) ? '&Dia=1' : ''); ?>&OvvId=<?php echo $GET_OvvId; ?>&FtaId=<?php echo $GET_FtaId; ?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]" /></a>
