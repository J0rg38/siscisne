...
?>
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccPagoOrdenVentaVehiculoOrdenCobroRegistrar.php');
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpFecha" type="text" id="CmpFecha" value="<?php echo ($InsPago->PagFecha); ?>" size="10" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFecha" name="BtnFecha" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
