...
function FncNuevo(){
	...
	$TotalOrdenOriginal = $InsOrdenVentaVehiculo->OvvTotal;
	...
	$InsPago->PagConcepto = "Pago a cuenta de repuestos. O.V.: ".$OrdenVentaVehiculoId;
