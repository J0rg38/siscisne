...
<div class="tab_container">
	...
	?>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpMonto2" type="text" id="CmpMonto2" value="<?php echo number_format($InsPago->PagMonto,2);?>" size="10" maxlength="10" />              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFecha" name="BtnFecha" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
