...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPlanMantenimientoDetalleRegistrar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">REGISTRAR DETALLE DE 
        PLAN DE MANTENIMIENTO</span></td>
      </tr>
      <tr>
        <td colspan="2">
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td>&nbsp;</td>
            <td><input type="hidden" name="CmpPlanMantenimientoId" id="CmpPlanMantenimientoId" value="<?php echo $InsPlanMantenimientoDetalle->PmaId;?>" />
            <input type="hidden" name="CmpPlanMantenimientoTareaId" id="CmpPlanMantenimientoTareaId" value="<?php echo $InsPlanMantenimientoDetalle->PmtId;?>" />
          ...
          <tr>
            ...
            <select name="CmpPlanMantenimientoDetalleAccion" class="EstFormularioCaja" id="CmpPlanMantenimientoDetalleAccion">
