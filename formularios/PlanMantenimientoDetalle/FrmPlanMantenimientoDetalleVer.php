      ...
      <tr>
        ...
        <table class="EstFormulario" width="200" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <input name="CmpId" type="text" class="EstFormularioCaja" id="CmpId" value="<?php echo $InsBanco->BanId;?>" size="15" maxlength="20"  readonly="readonly"/>            </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><textarea class="EstFormularioCaja" name="CmpDescripcion" id="CmpDescripcion" cols="45" rows="5"><?php echo $InsBanco->BanDescripcion;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
