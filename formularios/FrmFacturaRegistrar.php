...
//MtdObtenerMonedas($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'MonId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL) 
			  ...
			  FncImprmir("<?php echo $InsFactura->FacId;?>","<?php echo $InsFactura->FtaId;?>");
			   ...
			   dhtmlx.confirm("¿Desea registrar el pago?", function(result){
					if(result==true){
						...
						window.location.href = 'principal.php?Mod=PagoFactura&Form=Registrar&FacId=<?php echo $InsFactura->FacId;?>&FtaId=<?php echo $InsFactura->FtaId;?>';
           ...
           <div class="EstFormularioArea" >
             ...
             <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
               ...
               <tr>
                 ...
                 <td colspan="2" align="center" valign="top">
                   ...
                   <table>
                     <tr>
                       <td><select  onchange="FncGenerarFacturaId(this.value);"  class="EstFormularioCombo" name="CmpTalonario" id="CmpTalonario">
                         <option value="">-</option>
                         <?php
			  ...
			  ?>
                       ...
                       <td>
                         ...
                         N&deg;.
                         <input tabindex="1" class="EstFormularioCaja" name="CmpId" type="text" id="CmpId" value="<?php echo $InsFactura->FacId;?>" size="20" maxlength="20"  /></td>
                       <td>
                 ...
                 <td colspan="4" align="left" valign="top"><table>
                   <tr>
                     ...
                     <td><input  tabindex="2" class="EstFormularioCaja" name="CmpClienteNombreCompleto" type="text" id="CmpClienteNombreCompleto" size="45" maxlength="255" value="<?php echo $InsFactura->CliNombre;?> <?php echo $InsFactura->CliApellidoPaterno;?> <?php echo $InsFactura->CliApellidoMaterno;?>"  <?php echo !empty($InsFactura->CliId)?'readonly="readonly"':'';?> />
                       <input type="hidden" name="CmpClienteNombre" id="CmpClienteNombre" value="<?php echo $InsFactura->CliNombre;?>" size="3" />
               ...
               <tr>
                 ...
                 <td align="left" valign="top"><input tabindex="6" class="EstFormularioCajaFecha" name="CmpFechaEmision" type="text" id="CmpFechaEmision" value="<?php if(empty($InsFactura->FacFechaEmision)){ echo date("d/m/Y");}else{ echo $InsFactura->FacFechaEmision; }?>" size="10" maxlength="10" />                   <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaEmision" name="BtnFechaEmision" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
                 <td align="left" valign="top">&nbsp;</td>
                 </tr>
               <tr>
                 <td>&nbsp;</td>
                 <td align="left" valign="top">Email:</td>
                 <td align="left" valign="top"><input tabindex="5" class="EstFormularioCaja" name="CmpClienteEmail" type="text" id="CmpClienteEmail" size="45" maxlength="255" value="<?php echo $InsFactura->FacEmail;?>"  /></td>
                 <td align="left" valign="top">&nbsp;</td>
                 <td align="left" valign="top">&nbsp;</td>
                 <td align="left" valign="top">&nbsp;</td>
                 <td align="left" valign="top">&nbsp;</td>
               ...
               <tr>
                 ...
                 <td align="left" valign="top"><textarea tabindex="8" name="CmpObservacionImpresa" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionImpresa"><?php echo stripslashes($InsFactura->FacObservacionImpresa);?></textarea></td>
                 <td align="left" valign="top">&nbsp;</td>
                 </tr>
               <tr>
                 <td>&nbsp;</td>
			...
			?>
               ...
               <tr>
                 ...
                 <td align="left" valign="top">&nbsp;</td>
                 <td align="left" valign="top">Guia de Remisión:</td>
...
?>
                 ...
                 <td align="left" valign="top">IGV:<br />
                   (%)</td>
                 <td align="left" valign="top"><input onchange="FncFacturaDetalleListar();" name="CmpPorcentajeImpuestoVenta" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoVenta" value="<?php if(empty($InsFactura->FacPorcentajeImpuestoVenta)){ echo $EmpresaImpuestoVenta; }else{echo $InsFactura->FacPorcentajeImpuestoVenta;}?>" size="10" maxlength="10" /></td>
                 <td align="left" valign="top">&nbsp;</td>
                 </tr>
               ...
               <tr>
                 ...
                 <td align="left" valign="top">ISC:<br />
                   (%)</td>
                 <td align="left" valign="top"><input onchange="FncFacturaDetalleListar();" name="CmpPorcentajeImpuestoSelectivo" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoSelectivo" value="<?php echo $InsFactura->FacPorcentajeImpuestoSelectivo;?>" size="10" maxlength="10" /></td>
                 <td align="left" valign="top">&nbsp;</td>
               </tr>
               <tr>
                 <td>&nbsp;</td>
			  ...
			  ?>
                 ...
                 <td align="left" valign="top"><table>
                   <tr>
                     <td><input name="CmpTipoCambio" type="text"  class="EstFormularioCaja" id="CmpTipoCambio" onchange="FncFacturaDetalleListar();" value="<?php if (empty($InsFactura->FacTipoCambio)){ echo "";}else{ echo $InsFactura->FacTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
                     <td>
			...
			?>
               ...
               <tr>
                 ...
                 <td align="left" valign="top"><span id="sprytextfield1">
                   <label>
                     <input readonly="readonly" tabindex="6" class="EstFormularioCajaFecha" name="CmpFechaVencimiento" type="text" id="CmpFechaVencimiento" value="<?php  echo $InsFactura->FacFechaVencimiento; ?>" size="10" maxlength="10" />
                   </label>
                 ...
                 <td colspan="5" align="left" valign="top">
                   <table cellpadding="2" cellspacing="2">
                     <tr>
                       ...
                       <td align="left" valign="top" class="EstFormulario"><input name="CmpVentaDirectaId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVentaDirectaId"  tabindex="3" value="<?php  echo $InsFactura->VdiId;?>" size="20" maxlength="20" readonly="readonly" /></td>
                       ...
                       <td align="left" valign="top" class="EstFormulario">&nbsp;</td>
                       <td align="left" valign="top" class="EstFormulario">&nbsp;</td>
                       </tr>
                     </table>
                   </td>
...
<!--<input <?php echo (($InsFactura->FacNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpNotificar" id="CmpNotificar" />
Notificar via email <br />-->

<input <?php echo (($InsFactura->FacProcesar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpProcesar" id="CmpProcesar" />
Procesar comprobante  <br />

<!--<input <?php echo (($InsFactura->FacEnviarSUNAT==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpEnviarSUNAT" id="CmpEnviarSUNAT" />
Enviar a SUNAT <br />   
                       --> 
                 ...
                 <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpAbono" type="text" id="CmpAbono" size="10" maxlength="10" value="<?php echo number_format($InsFactura->FacAbono,2);?>" /></td>
                 <td align="left" valign="top">&nbsp;</td>
               </tr>
               </table>
           ...
           <div id="CapFacturaDetalle" class="EstFormularioArea">
                 ...
                 -->
                     ...
                     <tr>
                       <td>&nbsp;</td>
                       <td>
                         <a href="javascript:FncFacturaDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                       ...
                       <td>
                         ...
                         <input tabindex="11" class="EstFormularioCaja" name="CmpFacturaDetalleDescripcion" type="text" id="CmpFacturaDetalleDescripcion" size="45"  /></td>
...
<input type="checkbox" name="CmpFacturaDetalleGratuito" id="CmpFacturaDetalleGratuito" value="1" />
Transf. Grat.
...
Inc. Select.
         ...
         <td width="25%" valign="top"><div id="CapFacturaDetalle" class="EstFormularioArea">
       ...
       <tr>
         <td rowspan="4" valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="1%">&nbsp;</td>
               <td width="49%"><div class="EstFormularioAccion" id="CapFacturaDetalleAccion">Listo
                 para registrar elementos</div></td>
               <td width="49%" align="right"><a href="javascript:FncFacturaDetalleListar();">
       ...
       <tr>
         <td valign="top"><div id="CapFacturaDetalle" class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             <tr>
               <td>&nbsp;</td>
               <td colspan="2"><span class="EstFormularioSubTitulo">Pagos</span></td>
               <td>&nbsp;</td>
             </tr>
           </table>
         </div></td>
