...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVentaConcretadaRegistrar.php');
//DATOS
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">
                        <span class="EstFormularioSubTitulo">Datos de la   Venta   Concretada
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><input type="hidden" name="CmpTipoOperacion" id="CmpTipoOperacion" value="<?php echo $InsVentaConcretada->TopId;?>" /></td>
                      <td align="left" valign="top">&nbsp;</td>
                      <td align="left" valign="top">&nbsp;</td>
                      <td align="left" valign="top">&nbsp;</td>
                      </tr>
			...
			?>
                          ...
                          <td><input readonly="readonly" class="EstFormularioCaja" name="CmpClienteNumeroDocumento" type="text" id="CmpClienteNumeroDocumento" size="20" maxlength="50" value="<?php echo $InsVentaConcretada->CliNumeroDocumento;?>" /></td>
                          <td><input readonly="readonly" class="EstFormularioCaja" name="CmpClienteNombre" type="text" id="CmpClienteNombre" size="45" maxlength="255" value="<?php echo $InsVentaConcretada->CliNombre;?> <?php echo $InsVentaConcretada->CliApellidoPaterno;?> <?php echo $InsVentaConcretada->CliApellidoMaterno;?>" /></td>
                          <td>&nbsp;</td>
                        </tr>
                      </table></td>
                      <td align="left" valign="top">&nbsp;</td>
			...
			?>
			  ...
			  ?>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><input type="hidden" name="CmpOrigen" id="CmpOrigen" value="<?php echo $InsVentaConcretada->VcoOrigen;?>" size="3" />                        
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><input name="CmpVentaDirectaId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVentaDirectaId"  tabindex="3" value="<?php  echo $InsVentaConcretada->VdiId;?>" size="25" maxlength="25" readonly="readonly" />                    
...
<a id="BtnProductoRegistrar" onclick="FncProductoCargarFormulario('Registrar');"  href="javascript:void(0)" title=""> <img src="imagenes/acciones/registrar.png" alt="[Registrar]" width="25" height="25" border="0" align="absmiddle" title="Registrar" /></a> <a id="BtnProductoEditar" onclick="FncProductoCargarFormulario('Editar');" href="javascript:void(0)"   title=""> <img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" /></a>
                            ...
                            <td><a href="javascript:FncVentaConcretadaDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                            <td>
              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <td width="49%" align="right"><a href="javascript:FncVentaConcretadaDetalleListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncVentaConcretadaDetalleEliminarTodo();"></a></td>
                    <td width="1%"><div id="CapVentaConcretadaDetallesResultado"> </div></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
...
Calendar.setup({ 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnEmpresaTransporteFecha"// el id del bot�n que  
	});
