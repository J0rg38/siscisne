...
$ResCotizacionProducto = $InsCotizacionProducto->MtdObtenerCotizacionProductos($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),2,$POST_Moneda);
...
<tr>
  ...
  <span class="EstFormularioTitulo">MONITOREO DE COTIZACIONES DE REPUESTO PENDIENTES</span>  </td>
</tr>
<tr>
  <td width="47%">
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td  width="6%" align="right" ><?php echo ($dat->CprTiempoModificacion);?></td>
        <td  width="8%" align="center" >



<?php
if($PrivilegioGenerarVentaConcretada){
?>		                
