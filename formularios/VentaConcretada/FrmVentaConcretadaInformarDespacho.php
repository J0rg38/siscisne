...
?>
  ...
  //$Destinatarios = "pzapana@cyc.com.pe,scanepam@cyc.com.pe,pcondori@cyc.com.pe,aliendo@cyc.com.pe,jblanco@cyc.com.pe";

  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccVentaConcretadaInformarDespacho.php');
  ...
  <form id="FrmEnviarCorreo" name="FrmEnviarCorreo" method="post" action="#" enctype="multipart/form-data" onsubmit="FncGuardar();">
    ...
    <div class="EstCapContenido">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">INFORME DE DESPACHO DE VENTA CONCRETADA</span></td>
        </tr>
        <tr>
          <td colspan="2">
                    ...
                    <td valign="top">
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2"><span class="EstFormularioSubTitulo">Datos del correo electronico </span></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><textarea name="CmpDestinatario" cols="100" rows="3" class="EstFormularioCaja" id="CmpDestinatario"><?php echo $Destinatarios; ?></textarea></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if (empty($InsVentaConcretada->VcoFecha)) {
                                                                                                                                                    echo date("d/m/Y");
                                                                                                                                                  } else {
                                                                                                                                                    echo $InsVentaConcretada->VcoFecha;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Cliente:
                              <input type="hidden" name="CmpClienteId" id="CmpClienteId" value="<?php echo $InsVentaConcretada->CliId; ?>" size="3" />
                            </td>
                              ...
                              <table>
                                <tr>
                                  ...
                                  <td><select disabled="disabled" class="EstFormularioCombo" name="CmpClienteTipoDocumento2" id="CmpClienteTipoDocumento2">
                                      ...
                                      ?>
                                        <option <?php if ($InsVentaConcretada->TdoId == $DatTipoDocumento->TdoId) {
                                                  echo 'selected="selected"';
                                                } ?> value="<?php echo $DatTipoDocumento->TdoId; ?>">[<?php echo $DatTipoDocumento->TdoCodigo; ?>] <?php echo $DatTipoDocumento->TdoNombre; ?></option>
                                      <?php
                                      }
                                      ?>
                                    </select></td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpClienteTipoAux" id="CmpClienteTipoAux">
                                ...
                                ?>
                                  <option value="<?php echo $DatClienteTipo->LtiId ?>" <?php if ($InsVentaConcretada->LtiId == $DatClienteTipo->LtiId) {
                                                                                        echo 'selected="selected"';
                              ...
                              <input type="hidden" name="CmpClienteTipo" id="CmpClienteTipo" value="<?php echo $InsVentaConcretada->LtiId; ?>" />
                            </td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId" disabled="disabled">
                                      ...
                                      ?>
                                        <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsVentaConcretada->MonId == $DatMoneda->MonId) {
                                                                                          echo 'selected="selected"';
                            ...
                            <td align="left" valign="top"><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncVentaConcretadaDetalleListar();" value="<?php if (empty($InsVentaConcretada->VcoTipoCambio)) {
                                                                                                                                                                                                                    echo "";
                                                                                                                                                                                                                  } else {
                                                                                                                                                                                                                    echo $InsVentaConcretada->VcoTipoCambio;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpAlmacen" id="CmpAlmacen">
                                ...
                                ?>
                                  <option value="<?php echo $DatAlmacen->AlmId ?>" <?php if ($InsVentaConcretada->AlmId == $DatAlmacen->AlmId) {
                                                                                    echo 'selected="selected"';
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span id="sprytextfield2">
                                <input name="CmpEmpresaTransporteFecha" type="text" class="EstFormularioCajaFecha" id="CmpEmpresaTransporteFecha" value="<?php echo $InsVentaConcretada->VcoEmpresaTransporteFecha; ?>" size="15" maxlength="10" />
                                <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></span><img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnEmpresaTransporteFecha" name="BtnEmpresaTransporteFecha" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            ...
                            <td width="0%">
                              <div id="CapVentaConcretadaDetallesResultado"> </div>
                            </td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapVentaConcretadaDetalles" class="EstCapVentaConcretadaDetalles"> </div>
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                        </table>
