...
<title>Venta Concretada No. <?php echo $InsVentaConcretada->VcoId;?></title>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="2" class="EstVentaConcretadaImprimirTabla">
      <tr>
        ...
        <td width="3%" height="23" align="left" valign="top">
          ...
          :        </td>
        <td width="6%" height="23" align="left" valign="top"><?php
...
?></td>
        ...
        <td height="23" align="left" valign="top" ><span class="EstVentaConcretadaImprimirContenido">
		
<?php echo $InsVentaConcretada->VcoId;?> <!--(<?php echo $InsVentaConcretada->VdiId;?>)-->
</span></td>
      </tr>
      <tr>
        <td width="8%" height="23" align="left" valign="top" class="EstVentaConcretadaImprimirEtiquetaFondo"><span class="EstVentaConcretadaImprimirEtiqueta">
          
          MARCA
          
        </span></td>
        <td width="2%" height="23" align="left" valign="top" ><span class="EstVentaConcretadaImprimirEtiqueta">
          
          :
          
        </span></td>
        <td width="14%" height="23" align="left" valign="top" >
...
?>
        ...
        <td width="12%" height="23" align="left" valign="top" ><span class="EstVentaConcretadaImprimirContenido"><?php
...
?>
 ...
 <?php
	if(!empty($DatVentaConcretadaDetalle->VcdCompraOrigen)){
	?>
		<b>[<?php echo $DatVentaConcretadaDetalle->VcdCompraOrigen;?>]</b>
    <?php	
	}
	?>
...
?>
        ...
        <tr>
          <td colspan="5" align="right" class="EstVentaConcretadaDetalleImprimirContenido">
            MATERIALES:
          </td>
...
?>
          ...
          <td align="right" valign="middle" class="EstVentaConcretadaImprimirEtiquetaFondo">
...
?>
          ...
          <td align="right" valign="middle" class="EstVentaConcretadaImprimirEtiquetaFondo"><?php
if ($_GET['P'] != 1) {
?>
...
?>
        ...
        <tr>
          ...
          <td width="13%" align="right" valign="middle" class="EstVentaConcretadaImprimirEtiquetaFondo">
...
?>          </td>
          <td width="12%" align="right" valign="middle" ><span class="EstMonedaSimbolo"><?php
echo $InsVentaConcretada->MonSimbolo;
