...
//		});	
	...
	$('input[type=checkbox]').each(function () {
			if($(this).attr('name')=="cmp_seleccionar[]"){
				...
				$("#CmpVehiculoIngresoObservadoMotivo_"+Id).keyup(function(){
								
					 clearTimeout($.data(this, 'timer'));
					  var wait = setTimeout("FncVehiculoIngresoUltimosEditarCampo('EinObservadoMotivo','CmpVehiculoIngresoObservadoMotivo','"+Id+"');", 1500);
...
function FncEditarObservadoSeleccionados(){
	...
	if(seleccionados==""){
		...
		if(confirm("¿Realmente desea actualizar el estado Observado los elementos seleccionados?")){
			
			var Tipo = prompt("Escoja el tipo de observado \n 0 = Libre \n 1 = Pedido \n 2 = Flota", "1");			
				...
				if(Tipo !== null){
					switch(Tipo.toUpperCase()){
						...
						case "1":
							...
							$("#Acc").val("ActualizarObservadorSi");
							$("#FrmListado").submit();	
						...
						case "2":
							...
							$("#Acc").val("ActualizarObservadorNo");
							$("#FrmListado").submit();	
...
function FncVehiculoIngresoUltimosEditarCampo(oCampo,oInput,oId){
	
	console.log("FncVehiculoIngresoUltimosEditarCampo");
