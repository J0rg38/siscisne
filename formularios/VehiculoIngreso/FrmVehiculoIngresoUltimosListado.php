...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoIngresoUltimos.js" ></script>
...
$POST_EstadoVehicular = $_POST['EstadoVehicular'];
$POST_Observado = $_POST['Observado'];
...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoIngresoUltimos.php');
//DATOS
...
/*if($PrivilegioEditar){
?>
 <div class="EstSubMenuBoton"><a href="javascript:FncEditarEstadoVehicularSeleccionados();"><img src="imagenes/submenu/estado_vehicular.png" alt="[Actualizar Estado Vehicular]" title="Actualizar Estado Vehicular" />Estado Vehicular</a></div>
<?php
}*/
?>
...
if($PrivilegioEditar){
?>
 <div class="EstSubMenuBoton"><a href="javascript:FncEditarObservadoSeleccionados();"><img src="imagenes/submenu/estado_observado.png" alt="[Actualizar Estado Observado]" title="Actualizar Estado Observado" />Observado</a></div>
<?php
}
?>
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">SEGUIMIENTO DE VEHICULOS</span></td>
</tr>
<tr>
  <td>
     ...
     <input placeholder="Ingrese una palabra para buscar" class="EstFormularioCajaBuscar" name="Fil" type="text" id="Fil" value="<?php echo $POST_fil;?>" size="18" />
       ...
       <!--<select class="EstFormularioCombo" name="Cam" id="Cam">
         ...
         <option value="EinPoliza" <?php if($POST_cam=="EinPoliza"){ echo 'selected="selected"';}?>>Poliza</option>
           ...
           <!--Proformado:
<select class="EstFormularioCombo" name="ConProforma" id="ConProforma">
<option value="">Todos</option>
<option <?php if($POST_ConProforma==1){ echo 'selected="selected"';}?> value="1">Con Proforma</option>
<option <?php if($POST_ConProforma==2){ echo 'selected="selected"';}?> value="2">Sin Proforma</option>

</select>-->

  
           Observado:
<select class="EstFormularioCombo" name="Observado" id="Observado">
<option value="">Todos</option>
<option <?php if($POST_Observado==1){ echo 'selected="selected"';}?> value="1">Si</option>
<option <?php if($POST_Observado==2){ echo 'selected="selected"';}?> value="2">No</option>

</select>
                
            Estado Vehicular:
<select class="EstFormularioCombo" name="EstadoVehicular" id="EstadoVehicular">
<option value="STOCK,VENDIDO,RESERVADO,C/INCIDENCIA,TRAMITE,STOCK">Todos</option>
<option <?php if($POST_EstadoVehicular=="STOCK"){ echo 'selected="selected"';}?> value="STOCK">STOCK</option>
<option <?php if($POST_EstadoVehicular=="VENDIDO"){ echo 'selected="selected"';}?> value="VENDIDO">VENDIDO</option>
<option <?php if($POST_EstadoVehicular=="RESERVADO"){ echo 'selected="selected"';}?> value="RESERVADO">RESERVADO</option>

<option <?php if($POST_EstadoVehicular=="C/INCIDENCIA"){ echo 'selected="selected"';}?> value="C/INCIDENCIA">C/INCIDENCIA</option>
<option <?php if($POST_EstadoVehicular=="TRAMITE"){ echo 'selected="selected"';}?> value="TRAMITE">TRAMITE</option>
<!--<option <?php if($POST_EstadoVehicular=="EXTERNO"){ echo 'selected="selected"';}?> value="EXTERNO">EXTERNO</option>-->
...
<tr>
      ...
      <tr>
        ...
        <th width="8%" ><?php
				if($POST_ord == "VehCodigoIdentificador"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('VehCodigoIdentificador','ASC');"> Cod. Identificador <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('VehCodigoIdentificador','DESC');"> Cod. Identificador <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('VehCodigoIdentificador','ASC');"> Cod. Identificador </a>
          <?php
				}
				?></th>
        <th width="4%" ><?php
        ...
        <th width="4%" ><?php
          ...
          <?php
				...
				?></th>
        <th width="17%" ><?php
				if($POST_ord == "EinEstadoVehicular"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('EinEstadoVehicular','ASC');"> Estado Veh. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('EinEstadoVehicular','DESC');"> Estado Veh. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('EinEstadoVehicular','ASC');"> Estado Veh. </a>
          <?php
				}
				?></th>
        <th width="3%" ><?php
				if($POST_ord == "EinObservado"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('EinObservado','ASC');"> ¿Obs.? <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('EinObservado','DESC');"> ¿Obs.? <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('EinObservado','ASC');"> ¿Obs.? </a>
          <?php
				}
				?></th>
  ...
  <tbody class="EstTablaListadoBody">
    ...
    <tr id="Fila_<?php echo $f;?>">
      ...
      <td align="right" valign="middle" width="6%"   ><?php echo $dat->SucNombre;  ?></td>
      <td align="right" valign="middle" width="6%"   ><?php echo $dat->VprAno;  ?></td>
      <td align="right" valign="middle" width="6%"   ><?php echo FncConvertirMes($dat->VprMes);  ?></td>
      <td align="right" valign="middle" width="4%"   ><?php echo $dat->VprCodigo;  ?></a></td>
      <td align="right" valign="middle" width="8%"   ><?php echo $dat->VehCodigoIdentificador;  ?></td>
...
?>  
      ...
      <td  width="17%" align="right" ><h2><?php echo $dat->EinEstadoVehicular;?></h2></td>
      <td  width="3%" align="right" >
        
        <?php
			switch($dat->EinObservado){
				case 1:
			?>
        <img src="imagenes/estado/estado_observado_si.png" alt="[Observado]" title="Observado" width="20" height="20" />
        <?php
				break;
				
				case 2:
			?>
        <img src="imagenes/estado/estado_observado_no.png" alt="[No Observado]" title="No Observado" width="20" height="20" />
        <?php
				break;
      ...
      <td  width="14%" align="right" ><input name="CmpVehiculoIngresoObservadoMotivo_<?php echo $dat->EinId;?>" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoObservadoMotivo_<?php echo $dat->EinId;?>" value="<?php echo $dat->EinObservadoMotivo;?>" size="25" maxlength="255" /></td>
      </tr>
