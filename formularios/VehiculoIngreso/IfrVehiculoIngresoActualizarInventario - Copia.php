...
<h2>Unidades Libres</h2>
		...
		<?php echo ($DatVehiculoIngreso->EinNumeroProforma);?>
          ...
          <td align="center" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" >
            ...
            <input  <?php echo (($DatVehiculoIngreso->CliCSIIncluir==1)?'checked="checked"':'')?>  type="checkbox" name="CmpClienteCSIincluir_<?php echo $DatVehiculoIngreso->CliId; ?>" id="CmpClienteCSIincluir_<?php echo $DatVehiculoIngreso->CliId; ?>" value="<?php echo $DatVehiculoIngreso->CliId; ?>" onChange="FncClienteCSIEditarAccion('<?php echo $DatVehiculoIngreso->CliId; ?>');" etiqueta="cliente" >
            
            
          </td>
<td align="center" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" >

<div id="CapClienteCSIEditarAccion_<?php echo $DatVehiculoIngreso->CliId; ?>"></div>

<!--<div <?php echo (($DatVehiculoIngreso->CliCSIIncluir==1)?'style="visibility:hidden"':'')?>  id="CapExcluir<?php echo $DatVehiculoIngreso->CliId; ?>">
<a href="javascript:FncClienteCSIEditarExcluir('<?php echo $DatVehiculoIngreso->CliId; ?>');">
<img src="imagenes/acciones/nochekeado.png" width="18" height="18" border="0">
</a>
</div>


<div <?php echo (($DatVehiculoIngreso->CliCSIIncluir==2)?'style="visibility:hidden"':'')?> id="CapIncluir<?php echo $DatVehiculoIngreso->CliId; ?>">
<a href="javascript:FncClienteCSIEditarIncluir('<?php echo $DatVehiculoIngreso->CliId; ?>');">
<img src="imagenes/acciones/chekeado.png" width="18" height="18" border="0">
    ...
    <!--
<a href="../../principal2.php?Mod=Cliente&Form=CSIEditar&Id=<?php echo $DatVehiculoIngreso->CliId?>&Dia=1&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=300&width=500&modal=true" class="thickbox" title="">[CSI]</a>
		-->
          </td>
          </tr>
        <?php	
