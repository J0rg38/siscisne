...
if($PrivilegioEditar){
?>
 <div class="EstSubMenuBoton"><a href="javascript:FncEditarObservadoSeleccionados();"><img src="imagenes/submenu/estado_observado.png" alt="[Actualizar Observado]" title="Actualizar Observado" /> Observado</a></div>
<?php
}
?>
      ...
      <tr>
        ...
        <th width="4%" ><?php
          ...
          <?php
				...
				?></th>
        <th width="4%" ><?php
				if($POST_ord == "EinCancelado"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('EinCancelado','ASC');"> Canc. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('EinCancelado','DESC');"> Canc. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('EinCancelado','ASC');"> Canc. </a>
          <?php
				}
				?></th>
        <th width="4%" ><?php
...
?>  
      ...
      <td  width="4%" align="right" ><?php
			switch($dat->EinCancelado){
				case 1:
			?>
        <img src="imagenes/estado/cancelado_proveedor_si.png" alt="[Cancelado]" title="Cancelado" width="20" height="20" />
        <?php
				break;
				
				case 2:
			?>
        <img src="imagenes/estado/cancelado_proveedor_no.png" alt="[Sin Cancelar]" title="Sin Cancelar" width="20" height="20" />
        <?php
				break;
