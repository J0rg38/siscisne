...
//Parametro11 = VicFecha
	...
	$InsVehiculoIngresoCliente1 = array();
	$InsVehiculoIngresoCliente1 = $_SESSION['InsVehiculoIngresoCliente'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
	
	
	$_SESSION['InsVehiculoIngresoCliente'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
	$InsVehiculoIngresoCliente1->Parametro1,
	$InsCliente->CliId,
	($InsCliente->CliNombre." ".$InsCliente->CliApellidoPaterno." ".$InsCliente->CliApellidoMaterno),
	$InsCliente->CliNumeroDocumento,
	$InsCliente->TdoId,
	$InsVehiculoIngresoCliente1->Parametro6,
	$InsVehiculoIngresoCliente1->Parametro7,
	date("d/m/Y H:i:s"),
