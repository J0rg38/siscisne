...
if (isset($_POST['BtnGuardar_x']) or (isset($_POST['Guardar']) && $_POST['Guardar'] == "1")) {
	...
	$InsVehiculoIngreso->EinUbicacionReferencia = $_POST['CmpUbicacionReferencia'];
	...
	$InsVehiculoIngreso->EinNotaPedido = $_POST['CmpNotaPedido'];
	$InsVehiculoIngreso->EinFacturaValor = preg_replace("/,/", "", (empty($_POST['CmpFacturaValor']) ? 0 : $_POST['CmpFacturaValor']));
...
function FncNuevo()
{
	...
	$InsVehiculoIngreso->OncId = "ONC-10007"; // $_SESSION['SesionConcesionario'];
	...
	$InsVehiculoIngreso->MonId = $EmpresaMonedaId;
