...
<div class="EstFormularioArea" >
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td align="left" valign="top"><input class="EstFormularioCajaFecha"  name="CmpFechaSalidaDAM" type="text" id="CmpFechaSalidaDAM" value="<?php if(!empty($InsVehiculoIngreso->EinFechaSalidaDAM)){ echo $InsVehiculoIngreso->EinFechaSalidaDAM;}?>" size="15" maxlength="10" />              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaSalidaDAM" name="BtnFechaSalidaDAM" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
            <td>Fecha Retorno:<br />
              <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
            <td><input class="EstFormularioCajaFecha"  name="CmpFechaRetornoDAM" type="text" id="CmpFechaRetornoDAM" value="<?php if(!empty($InsVehiculoIngreso->EinFechaRetornoDAM)){ echo $InsVehiculoIngreso->EinFechaRetornoDAM;}?>" size="15" maxlength="10" />              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaRetornoDAM" name="BtnFechaRetornoDAM" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
      ...
      <a href="javascript:FncCargarCaracteristicasPredeterminadas();">[Cargar Caracteristcas Predeterminadas]</a></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
<div class="EstFormularioArea" >
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td align="left" valign="top">Fecha Salida:<br />
              <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
            <td align="left" valign="top"><input class="EstFormularioCajaFecha"  name="CmpEstadoVehicularFechaSalida" type="text" id="CmpEstadoVehicularFechaSalida" value="<?php if(!empty($InsVehiculoIngreso->EinEstadoVehicularFechaSalida)){ echo $InsVehiculoIngreso->EinEstadoVehicularFechaSalida;}?>" size="15" maxlength="10" />              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnEstadoVehicularFechaSalida" name="BtnEstadoVehicularFechaSalida" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
            <td align="left" valign="top">Fecha Llegada:<br />
              <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
            <td align="left" valign="top"><input class="EstFormularioCajaFecha"  name="CmpEstadoVehicularFechaLlegada" type="text" id="CmpEstadoVehicularFechaLlegada" value="<?php if(!empty($InsVehiculoIngreso->EinEstadoVehicularFechaLlegada)){ echo $InsVehiculoIngreso->EinEstadoVehicularFechaLlegada;}?>" size="15" maxlength="10" />              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnEstadoVehicularFechaLlegada" name="BtnEstadoVehicularFechaLlegada" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
