...
?>
	...
	<a target="_blank" href="subidos/vehiculo_ingreso_archivos/<?php echo $DatSesionObjeto->Parametro3;?>">
      <img src="subidos/vehiculo_ingreso_archivos/<?php echo $DatSesionObjeto->Parametro3;?>" alt="<?php echo $DatSesionObjeto->Parametro3;?>" title="<?php echo $DatSesionObjeto->Parametro3;?>" width="50" height="50" border="0" /></a><br />
      
      <?php
    if($_POST['Eliminar']==1){
    ?>
      <a href="javascript:FncVehiculoIngresoFotoEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
