...
<?php }?>
      ...
      <!--    <input  type="checkbox" name="CmpClienteCSIincluir_<?php echo $DatReporteFichaIngreso->CliId; ?>" id="CmpClienteCSIincluir_<?php echo $DatReporteFichaIngreso->CliId; ?>" value="<?php echo $DatReporteFichaIngreso->CliId; ?>" onChange="FncClienteCSIEditarAccion('<?php echo $DatReporteFichaIngreso->CliId; ?>');" etiqueta="cliente" >
          -->
		...
		<?php echo ($DatReportePredictivoMantenimiento->EinVIN);?>
          ...
          <input readonly name="CmpNota_<?php echo $DatReportePredictivoMantenimiento->EinId?>"  type="text" class="EstFormularioCaja"  id="CmpNota_<?php echo $DatReportePredictivoMantenimiento->EinId?>" value="<?php echo $DatReportePredictivoMantenimiento->EinNota?>" size="25" maxlength="255">
