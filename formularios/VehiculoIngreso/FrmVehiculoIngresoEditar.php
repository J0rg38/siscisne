                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFechaRetornoDAM" type="text" id="CmpFechaRetornoDAM" value="<?php if (!empty($InsVehiculoIngreso->EinFechaRetornoDAM)) {
                                                                                                                                                                        echo $InsVehiculoIngreso->EinFechaRetornoDAM;
                                                                                                                                                                      } ?>" size="15" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFechaRetornoDAM" name="BtnFechaRetornoDAM" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td colspan="4" align="left" valign="top">
                              ...
                              <!--<iframe src="formularios/VehiculoIngreso/acc/AccVehiculoIngresoSubirArchivo2.php?Identificador=<?php echo $Identificador; ?>" id="IfrVehiculoIngresoSubirArchivo2" name="IfrVehiculoIngresoSubirArchivo2" scrolling="Auto"  frameborder="0" width="100%" height="200"></iframe>-->
                            </td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpEstadoVehicularFechaLlegada" type="text" id="CmpEstadoVehicularFechaLlegada" value="<?php if (!empty($InsVehiculoIngreso->EinEstadoVehicularFechaLlegada)) {
                                                                                                                                                                                              ...
                                                                                                                                                                                              } ?>" size="15" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnEstadoVehicularFechaLlegada" name="BtnEstadoVehicularFechaLlegada" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="top">&nbsp;</td>
