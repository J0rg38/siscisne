...
$RepSucursal = $InsSucursal->MtdObtenerSucursales(NULL,NULL,"SucNombre","ASC",NULL,"ALM,INICIAL");
...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos("EinVIN","contiene",$POST_BuscarVIN,"EinTiempoModificacion","ASC",NULL,"1",NULL,NULL,$POST_EstadoVehicular,$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$Sucursales);
...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos(NULL,NULL,NULL,"EinVIN","ASC",NULL,"1",NULL,NULL,"STOCK",$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$Sucursales);
$ArrVehiculoIngresos = $ResVehiculoIngreso['Datos'];
...
<h3>Unidades Libres</h3>
        ...
        ?>
        <tr   >
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivoX":"EstTablaReporteInactivoX";?>" align="right" valign="middle"   >
		...
		<?php echo ($DatVehiculoIngreso->EinNumeroProforma);?>
          ...
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivoX":"EstTablaReporteInactivoX";?>" align="right" valign="top"   ><a id="Fila_<?php echo ($DatVehiculoIngreso->EinId);?>" href="javascript:void(0);"> <?php echo ($DatVehiculoIngreso->EinVIN);?> </a></td>
          ...
          <select disabled class="EstFormularioCombo" name="CmpSucursal_<?php echo $DatVehiculoIngreso->EinId?>" id="CmpSucursal_<?php echo $DatVehiculoIngreso->EinId?>">
    ...
    ?>
		...
		<!--  <?php echo ($DatVehiculoIngreso->SucNombre);?> / 
          ...
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivoX":"EstTablaReporteInactivoX";?>" ><input name="CmpUbicacionReferencia_<?php echo $DatVehiculoIngreso->EinId?>"  type="text" class="EstFormularioCaja"  id="CmpUbicacionReferencia_<?php echo $DatVehiculoIngreso->EinId?>" value="<?php echo $DatVehiculoIngreso->EinUbicacionReferencia?>" size="15" maxlength="255"></td>
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivoX":"EstTablaReporteInactivoX";?>" >
          
          <input name="CmpFechaUltimoInventario_<?php echo ($DatVehiculoIngreso->EinId);?>" type="text" class="EstFormularioCajaFecha" id="CmpFechaUltimoInventario_<?php echo ($DatVehiculoIngreso->EinId);?>" tabindex="6" value="<?php  echo $DatVehiculoIngreso->EinFechaUltimoInventario ?>" size="10" maxlength="10" />                                                                    <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaUltimoInventario_<?php echo ($DatVehiculoIngreso->EinId);?>" name="BtnFechaUltimoInventario_<?php echo ($DatVehiculoIngreso->EinId);?>" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
          ...
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivoX":"EstTablaReporteInactivoX";?>" ><input name="CmpNota_<?php echo $DatVehiculoIngreso->EinId?>"  type="text" class="EstFormularioCaja"  id="CmpNota_<?php echo $DatVehiculoIngreso->EinId?>" value="<?php echo $DatVehiculoIngreso->EinNota?>" size="25" maxlength="255"></td>
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivoX":"EstTablaReporteInactivoX";?>" >
          
          <input name="CmpDatoAdicional_<?php echo $DatVehiculoIngreso->EinId?>"  type="text" class="EstFormularioCaja"  id="CmpDatoAdicional_<?php echo $DatVehiculoIngreso->EinId?>" value="<?php echo $DatVehiculoIngreso->EinDatoAdicional?>" size="15" maxlength="45">
...
<h3>Unidades c/ Incidencia</h3>


<?php


$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos(NULL,NULL,NULL,"EinVIN","ASC",NULL,"1",NULL,NULL,"C/INCIDENCIA",$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$Sucursales);
$ArrVehiculoIngresos = $ResVehiculoIngreso['Datos'];
...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos(NULL,NULL,NULL,"EinVIN","ASC",NULL,"1",NULL,NULL,"RESERVADO",$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$Sucursales);
$ArrVehiculoIngresos = $ResVehiculoIngreso['Datos'];
...
$ResOrdenVentaVehiculo = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculos(NULL,NULL,NULL,"OvvFecha","DESC","1",NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,$DatVehiculoIngreso->EinId,$Sucursales,NULL,NULL,NULL,NULL);
...
<!--          <input tabindex="6" class="EstFormularioCajaFecha" name="CmpFechaEntrega_<?php echo ($DatVehiculoIngreso->EinId);?>" type="text" id="CmpFechaEntrega_<?php echo ($DatVehiculoIngreso->EinId);?>" value="<?php  echo $FechaEntrega ?>" size="10" maxlength="10" />                                                                    <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaEntrega_<?php echo ($DatVehiculoIngreso->EinId);?>" name="BtnFechaEntrega_<?php echo ($DatVehiculoIngreso->EinId);?>" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />-->
