...
//$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos("EinVIN","contiene",$POST_BuscarVIN,"EinTiempoModificacion","ASC",NULL,"1",NULL,NULL,$POST_EstadoVehicular,$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$POST_Sucursal);
...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos("EinVIN","esigual",$POST_BuscarVIN,"EinVIN","ASC",NULL,"1",NULL,NULL,"STOCK",$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$POST_Sucursal);
$ArrVehiculoIngresos = $ResVehiculoIngreso['Datos'];
    ...
    ?>
		...
		<!--  <?php echo ($DatVehiculoIngreso->SucNombre);?> / 
		  ...
		  $OpcEstadoVehicular5 = "";
			...
			?>
            <select disabled class="EstFormularioCombo" name="CmpEstadoVehicular_<?php echo ($DatVehiculoIngreso->EinId);?>" id="CmpEstadoVehicular_<?php echo ($DatVehiculoIngreso->EinId);?>">
              <option value="">Escoja una opcion</option>
...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos("EinVIN","esigual",$POST_BuscarVIN,"EinVIN","ASC",NULL,"1",NULL,NULL,"C/INCIDENCIA",$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$POST_Sucursal);
$ArrVehiculoIngresos = $ResVehiculoIngreso['Datos'];
...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos("EinVIN","esigual",$POST_BuscarVIN,"EinVIN","ASC",NULL,"1",NULL,NULL,"RESERVADO",$POST_VehiculoMarca,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$POST_Sucursal);
$ArrVehiculoIngresos = $ResVehiculoIngreso['Datos'];
