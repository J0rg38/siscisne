...
?>
  ...
  //INSTANCIAS
  $InsVehiculoIngreso = new ClsVehiculoIngreso($InsMysql);
  $InsVehiculoMarca = new ClsVehiculoMarca($InsMysql);
  $InsConcesionario = new ClsConcesionario($InsMysql);
  ...
  //ACCIONES
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccVehiculoIngresoRegistrar.php');
  //DATOS
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpVehiculoCodigoIdentificador" type="text" class="EstFormularioCaja" id="CmpVehiculoCodigoIdentificador" value="<?php echo $InsVehiculoIngreso->VehCodigoIdentificador; ?>" size="20" maxlength="40" readonly="readonly" />
                              <input name="CmpVehiculoId" type="hidden" id="CmpVehiculoId" value="<?php echo $InsVehiculoIngreso->VehId; ?>" size="3" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top">Marca:
                              <input name="CmpVehiculoMarcaId" type="hidden" id="CmpVehiculoMarcaId" value="<?php echo $InsVehiculoIngreso->VmaId; ?>" size="3" />
                            </td>
                            <td align="left" valign="top">
                            ...
                            <td align="left" valign="top">Modelo:
                              <input name="CmpVehiculoModeloId" type="hidden" id="CmpVehiculoModeloId" value="<?php echo $InsVehiculoIngreso->VmoId; ?>" size="3" />
                            </td>
                            <td align="left" valign="top">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Version:
                              <input name="CmpVehiculoVersionId" type="hidden" id="CmpVehiculoVersionId" value="<?php echo $InsVehiculoIngreso->VveId; ?>" size="3" />
                            </td>
                            <td align="left" valign="top">
                              <table>
                                <tr>
                            ...
                            <td>Color Ext./Int.:
                              <input name="CmpVehiculoColorId" type="hidden" id="CmpVehiculoColorId" value="<?php echo $InsVehiculoIngreso->VehId; ?>" size="3" />
                            </td>
                            <td><input value="<?php echo $InsVehiculoIngreso->EinColor; ?>" class="EstFormularioCaja" name="CmpColor" type="text" id="CmpColor" size="15" maxlength="50" />
                              /
                              <input value="<?php echo $InsVehiculoIngreso->EinColorInterior; ?>" class="EstFormularioCaja" name="CmpColorInterior" type="text" id="CmpColorInterior" size="15" maxlength="50" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="4" align="left" valign="top"><span class="EstFormularioSubTitulo">Datos de proforma e ingreso</span></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td>Proforma:</td>
                            <td><input name="CmpNumeroProforma" type="text" class="EstFormularioCaja" id="CmpNumeroProforma" value="<?php echo $InsVehiculoIngreso->EinNumeroProforma; ?>" size="30" maxlength="50" /></td>
                            <td>Nota Pedido:</td>
                            <td><input name="CmpNotaPedido" type="text" class="EstFormularioCaja" id="CmpNotaPedido" value="<?php echo $InsVehiculoIngreso->EinNotaPedido; ?>" size="30" maxlength="50" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td>Precio Proformado: </td>
                            <td><input name="CmpProformaDetalleCosto" type="text" class="EstFormularioCaja" id="CmpProformaDetalleCosto" value="<?php echo $InsVehiculoIngreso->EinFacturaValor; ?>" size="30" maxlength="50" /></td>
                            ...
                            <td align="left" valign="top"><input name="CmpComprobanteCompraNumeroSerie" type="text" class="EstFormularioCaja" id="CmpComprobanteCompraNumeroSerie" value="<?php echo $InsVehiculoIngreso->EinComprobanteCompraNumeroSerie; ?>" size="10" maxlength="20" />
                              -
                              <input name="CmpComprobanteCompraNumeroNumero" type="text" class="EstFormularioCaja" id="CmpComprobanteCompraNumeroNumero" value="<?php echo $InsVehiculoIngreso->EinComprobanteCompraNumeroNumero; ?>" size="20" maxlength="20" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><?php
                              ...
                              <input name="CmpClienteId2" type="hidden" id="CmpClienteId2" value="<?php echo $InsVehiculoIngreso->CliId; ?>" size="3" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                        </table>
                      ...
                      <div class="EstFormularioArea">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            ...
                            <td colspan="4">
                              <span class="EstFormularioSubTitulo">
                                Datos Declaracion de Aduana</span>
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td>DUA:</td>
                            <td><input value="<?php echo $InsVehiculoIngreso->EinDUA; ?>" class="EstFormularioCaja" name="CmpDUA" type="text" id="CmpDUA" size="30" maxlength="50" /></td>
                            <td>Responsable</td>
                            <td><select class="EstFormularioCombo" name="CmpResponsable" id="CmpResponsable">
                                <option value="">Escoja una opcion</option>
                                <?php
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFechaSalidaDAM" type="text" id="CmpFechaSalidaDAM" value="<?php if (!empty($InsVehiculoIngreso->EinFechaSalidaDAM)) {
                                                                                                                                                                      echo $InsVehiculoIngreso->EinFechaSalidaDAM;
                                                                                                                                                                    } ?>" size="15" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFechaSalidaDAM" name="BtnFechaSalidaDAM" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                            <td>Fecha Retorno:<br />
                              <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span>
                            </td>
                            <td><input class="EstFormularioCajaFecha" name="CmpFechaRetornoDAM" type="text" id="CmpFechaRetornoDAM" value="<?php if (!empty($InsVehiculoIngreso->EinFechaRetornoDAM)) {
                                                                                                                                              echo $InsVehiculoIngreso->EinFechaRetornoDAM;
                                                                                                                                            } ?>" size="15" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFechaRetornoDAM" name="BtnFechaRetornoDAM" width="25" height="25" align="absmiddle" style="cursor:pointer;" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td><input name="CmpVehiculoVersionCaracteristicaAnoFabricacion" type="text" class="EstFormularioCaja" id="CmpVehiculoVersionCaracteristicaAnoFabricacion" value="<?php echo $InsVehiculoIngreso->EinAnoFabricacion; ?>" size="30" maxlength="50" readonly="readonly" /></td>
                          ...
                          <tr>
                            ...
                            <td><input name="CmpVehiculoVersionCaracteristica12" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoVersionCaracteristica12" value="<?php echo htmlspecialchars($InsVehiculoIngreso->EinCaracteristica12); ?>" size="25" maxlength="50" />
                              (*)</td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="4"> <input type="checkbox" name="CmpVehiculoVersionCaracteristicaPredeterminar" id="CmpVehiculoVersionCaracteristicaPredeterminar" value="1" />
                              ...
                              <div class="EstFormularioArea">
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  ...
                                  <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstCapVehiculoIngresoFotos" id="CapVehiculoIngresoArchivoDAMs"></div>
                                    </td>
                                    <td align="left" valign="top">&nbsp;</td>
                                  </tr>
                                  <tr>
...
-->
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="4"><!--<iframe src="formularios/VehiculoIngreso/acc/AccVehiculoIngresoSubirArchivo2.php?Identificador=<?php echo $Identificador; ?>" id="IfrVehiculoIngresoSubirArchivo2" name="IfrVehiculoIngresoSubirArchivo2" scrolling="Auto"  frameborder="0" width="100%" height="200"></iframe>-->
                              ...
                              <div class="EstFormularioArea">
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  ...
                                  <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstCapVehiculoIngresoFotos" id="CapVehiculoIngresoArchivoDAM2s"></div>
                                    </td>
                                    <td align="left" valign="top">&nbsp;</td>
                                  </tr>
                                  <tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="4"><!--<iframe src="formularios/VehiculoIngreso/acc/AccVehiculoIngresoSubirArchivo3.php?Identificador=<?php echo $Identificador; ?>" id="IfrVehiculoIngresoSubirArchivo3" name="IfrVehiculoIngresoSubirArchivo3" scrolling="Auto"  frameborder="0" width="100%" height="200"></iframe>-->
                              ...
                              <div class="EstFormularioArea">
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  ...
                                  <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstCapVehiculoIngresoFotos" id="CapVehiculoIngresoArchivoDAM3s"></div>
                                    </td>
                                    <td align="left" valign="top">&nbsp;</td>
                                  </tr>
                                  <tr>
                      ...
                      <div class="EstFormularioArea">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><?php
                                                          switch ($InsVehiculoIngreso->EinEstadoVehicular) {
                                                            ...
                                                            case "EXTERNO":
                                                              $OpcEstadoVehicular6 = 'selected="selected"';
                                                              break;

                                                            case "ENTREGADO":
                                                              $OpcEstadoVehicular7 = 'selected="selected"';
                                                              break;
                              ...
                              <select class="EstFormularioCombo" name="CmpEstadoVehicular" id="CmpEstadoVehicular">
                                ...
                                <option <?php echo $OpcEstadoVehicular5; ?> value="TRAMITE">TRAMITE</option>
                                <option <?php echo $OpcEstadoVehicular6; ?> value="EXTERNO">EXTERNO</option>
                                <option <?php echo $OpcEstadoVehicular7; ?> value="ENTREGADO">ENTREGADO</option>
                              </select>
                            </td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpEstadoVehicularFechaSalida" type="text" id="CmpEstadoVehicularFechaSalida" value="<?php if (!empty($InsVehiculoIngreso->EinEstadoVehicularFechaSalida)) {
                                                                                                                                                                                              echo $InsVehiculoIngreso->EinEstadoVehicularFechaSalida;
                                                                                                                                                                                            } ?>" size="15" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnEstadoVehicularFechaSalida" name="BtnEstadoVehicularFechaSalida" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                            <td align="left" valign="top">Fecha Llegada:<br />
                              <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span>
                            </td>
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpEstadoVehicularFechaLlegada" type="text" id="CmpEstadoVehicularFechaLlegada" value="<?php if (!empty($InsVehiculoIngreso->EinEstadoVehicularFechaLlegada)) {
                                                                                                                                                                                                echo $InsVehiculoIngreso->EinEstadoVehicularFechaLlegada;
                                                                                                                                                                                              } ?>" size="15" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnEstadoVehicularFechaLlegada" name="BtnEstadoVehicularFechaLlegada" width="25" height="25" align="absmiddle" style="cursor:pointer;" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
...
<option <?php echo $OpcEstadoVehicular5; ?> value="TACNA SUCURSAL">TACNA SUCURSAL</option>
                              ...
                              <select class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
                                ...
                                ?>
                                  <option value="<?php echo $DatSucursal->SucId; ?>" <?php if ($InsVehiculoIngreso->SucId == $DatSucursal->SucId) {
                            ...
                            <td align="left" valign="top">Ubicacion Ref.:</td>
                            <td align="left" valign="top"><input value="<?php echo $InsVehiculoIngreso->EinUbicacionReferencia; ?>" class="EstFormularioCaja" name="CmpUbicacionReferencia" type="text" id="CmpUbicacionReferencia" size="30" maxlength="50" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                                ...
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  <tr>
                                    ...
                                    <td colspan="3"><input type="hidden" name="CmpVehiculoIngresoClienteItem" id="CmpVehiculoIngresoClienteItem" />
                                      ...
                                      <input type="hidden" name="CmpClienteId" id="CmpClienteId" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpVehiculoIngresoClienteFecha" type="text" id="CmpVehiculoIngresoClienteFecha" size="10" maxlength="10" />
                                      <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnVehiculoIngresoClienteFecha" name="BtnVehiculoIngresoClienteFecha" width="25" height="25" align="absmiddle" style="cursor:pointer;" />
                                    </td>
                                    ...
                                    <td align="left" valign="top"><a href="javascript:FncVehiculoIngresoClienteGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                                  </tr>
                                </table>
                              </div>
                            </td>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  ...
                                  <tr>
                                    <td width="1%">&nbsp;</td>
                                    <td width="49%">
                                      <div class="EstFormularioAccion" id="CapVehiculoIngresoClienteAccion">Listo
                                    ...
                                    <td width="1%">
                                      <div id="CapVehiculoIngresoClientesResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapVehiculoIngresoClientes" class="EstCapVehiculoIngresoClientes"> </div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                </table>
                                ...
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="top">Moneda:
                                      <input type="hidden" name="CmpTipoCambioFecha" id="CmpTipoCambioFecha" value="<?php echo $InsCliente->CliTipoCambioFecha; ?>" />
                                    </td>
                                    <td align="left" valign="top">
                                      <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td><select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                                              ...
                                              ?>
                                                <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsVehiculoIngreso->MonId == $DatMoneda->MonId) {
                                                                                                  echo 'selected="selected"';
                                    ...
                                    <td align="left" valign="top">
                                      <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td><a href="javascript:FncVehiculoIngresoEstablecerMoneda();"><img src="imagenes/acciones/recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /></a><a href="javascript:FncClienteEstablecerMoneda();"></a></td>
                                        </tr>
                                      </table>
                                    </td>
                                    <td>&nbsp;</td>
