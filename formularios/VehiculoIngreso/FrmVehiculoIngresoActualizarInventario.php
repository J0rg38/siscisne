...
<input type="hidden" value="<?php echo $DatSucursal->SucId;?>" name="CmpSucursalId_<?php echo $DatSucursal->SucId?>" id="CmpSucursalId_<?php echo $DatSucursal->SucId;?>" />
        ...
        <div class="EstReporteCapaListado autoheight" id="CapVehiculoIngresoActualizarInventario_<?php echo $DatSucursal->SucId;?>"></div>
...
?> 
    ...
    <div id="tab<?php echo $tab+1;?>" class="tab_content">
     ...
     <div  class="EstReporteCapaListado autoheight" id="CapVehiculoIngresoActualizarInventarioOtro_OTRO"></div>
    ...
    <div id="tab<?php echo $tab+2;?>" class="tab_content">
        ...
        <div  class="EstReporteCapaListado autoheight" id="CapVehiculoIngresoActualizarEntrega_ENTREGA"></div>
