...
if($_GET['P']==2){
	...
	header("Content-Disposition:  filename=\"CONSULTA_VIN_PLACA_".date('d-m-Y').".xls\";");
}
...
if(empty($POST_VehiculoIngresoId)){
	die( "No se ha podido identificar el VIN");
}
        ...
        <tbody class="EstTablaReporteBody">
             ...
             <thead class="EstTablaReporteHead">
              <tr>
                ...
                <tr>
                  ...
                  <td align="left" valign="top">Año Mod.:</td>
                  <td align="left" valign="top"><?php echo $InsVehiculoIngreso->EinAnoModelo;?></td>
                ...
                <tr>
                  <td align="left" valign="top"><span class="EstTablaReporteEtiqueta"> Placa: </span></td>
                  <td align="left" valign="top"><?php echo $InsVehiculoIngreso->EinPlaca;?>&nbsp;</td>
				  ...
				  ?>
                    &nbsp;</td>
                  <td align="left" valign="top"><span class="EstTablaReporteEtiqueta"> Estado: </span></td>
                  <td align="left" valign="top"><?php echo strtoupper($InsVehiculoIngreso->EinEstadoVehicular);?></td>
                  </tr>
                <tr>
                  <td align="left" valign="top"><span class="EstTablaReporteEtiqueta">Registrado en Sistema:</span></td>
                  <td align="left" valign="top"><span class="EstTablaReporteContenido"><?php echo $InsVehiculoIngreso->EinTiempoCreacion?></span>&nbsp;</td>
          ...
          <tr>
            <td align="center"><table width="70%" border="0" cellpadding="2" cellspacing="2" class="EstTablaReporte">
              <thead class="EstTablaReporteHead">
                <tr>
                  <th colspan="8" align="center" valign="top"><span class="EstTablaReporteEtiqueta">VIN :</span> <?php echo $InsVehiculoIngreso->EinVIN;?>&nbsp;</th>
                </tr>
              </thead>
              <tbody class="EstTablaReporteBody">
                <tr>
                  <td width="13%" align="left" valign="top">Sucursal:</td>
                  <td width="13%" align="left" valign="top"><span class="EstTablaReporteContenido"><?php echo $InsVehiculoIngreso->OvvFacturaSucursal;?> <?php echo $InsVehiculoIngreso->OvvBoletaSucursal;?></span></td>
...
<?php
if(!empty($InsVehiculoIngreso->FacId)){
?>
<a target="_blank" href="formularios/Factura/FrmFacturaGenerarPDF.php?Id=<?php echo $InsVehiculoIngreso->FacId;?>&Ta=<?php echo $InsVehiculoIngreso->FtaId;?>">
<img src="imagenes/pdf.png" width="25" height="25" border="0" alt="PDF" >
</a>

<?php
}elseif(!empty($InsVehiculoIngreso->BolId)){
?>
<a target="_blank" href="formularios/Boleta/FrmBoletaGenerarPDF.php?Id=<?php echo $InsVehiculoIngreso->BolId;?>&Ta=<?php echo $InsVehiculoIngreso->BtaId;?>">
<img src="imagenes/pdf.png" width="25" height="25" border="0" alt="PDF" >
</a>
              ...
              <table class="EstTablaReporteListado" width="100%" cellpadding="0" cellspacing="0" border="0">
                <thead class="EstTablaReporteListadoHead">
                  <tr>
                    ...
                    <th width="26%" align="center"> Nombre</th>
                ...
                ?>
                  <tr>
                    ...
                    <td align="right" valign="top">
                     ...
                     <!-- <a href="javascript:FncPopUp('../../principal2.php?Mod=Cliente&Form=Ver&Id=<?php echo $DatVehiculoIngresoCliente->CliId;?>&Dia=1',0,0,1,0,0,1,0,screen.height,screen.width);">
					 -->
                     <a href="javascript:FncClienteCargarFormulario('Ver','<?php echo $DatVehiculoIngresoCliente->CliId;?>');">
                    ...
                    <td align="right" valign="top"><?php echo $DatVehiculoIngresoCliente->CliCelular;?> <?php echo $DatVehiculoIngresoCliente->CliContactoCelular1;?> <?php echo $DatVehiculoIngresoCliente->CliContactoCelular2;?> <?php echo $DatVehiculoIngresoCliente->CliContactoCelular3;?>&nbsp;</td>
                    <td align="right" valign="top"><?php echo $DatVehiculoIngresoCliente->CliEmail;?></td>
                    <td align="center" valign="top">
                    <a href="javascript:FncClienteCargarFormulario('Ver','<?php echo $DatVehiculoIngresoCliente->CliId;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/ver.png" alt="[Ver]" title="Ver Ficha Tecnica" width="15" height="15"  /></a></td>
                    </tr>
                  <?php
                    $c++;
                }
...
?>
 ...
 Descargar Resumen de Mantenimientos 
<a target="_blank" href="VehiculoIngreso/acc/AccVehiculoIngresoGenerarExcelResumenMantenimiento.php?VehiculoIngresoId=<?php echo $InsVehiculoIngreso->EinId?>">
<img src="imagenes/excel.png" width="25" height="25" border="0" alt="Excel" >
</a>
...
<a target="_blank" class="EstBotonIcono" href="principal.php?Mod=FichaIngreso&Form=Registrar&Origen=ConsultaVIN&EinId=<?php echo $InsVehiculoIngreso->EinId?>"><img src="imagenes/nicono/orden_trabajo.png" alt="[Registrar]" title="Registrar" border="0" align="absmiddle" width="40" height="40" /> Registrar Orden de Trabajo</a> 


<a target="_blank" class="EstBotonIcono" href="principal.php?Mod=CotizacionProducto&Form=Registrar&Origen=ConsultaVIN&EinId=<?php echo $InsVehiculoIngreso->EinId?>"><img src="imagenes/nicono/cotizacion_repuesto.png" alt="[Registrar]" title="Registrar" border="0" align="absmiddle" width="40" height="40" /> Registrar Cotizacion</a> 
