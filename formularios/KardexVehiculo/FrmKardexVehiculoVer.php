...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsKardexVehiculoVerFunciones.js" ></script>
         ...
         <table width="100%" class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <td width="76" colspan="3">
              ...
              <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>KardexVehiculo/IfrKardexVehiculoVer.php" target="IfrKardexVehiculoVer" id="FrmKardexVehiculo" name="FrmKardexVehiculo" method="GET">
...
?>
          ...
          <tr>
            ...
            <td colspan="3">
              ...
              <iframe class="autoHeight" id="IfrKardexVehiculoVer" name="IfrKardexVehiculoVer" scrolling="auto" frameborder="0" height="350" width="100%"></iframe>
