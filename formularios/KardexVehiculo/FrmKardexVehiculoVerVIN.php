...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsKardexVehiculoVerVINFunciones.js" ></script>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        KARDEX DE VEHICULOS X VIN</span></td>
      </tr>
      <tr>
        <td colspan="2">
         ...
         <table width="100%" class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <td width="76" colspan="3">
              ...
              <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>KardexVehiculo/IfrKardexVehiculoVerVIN.php" target="IfrKardex" id="FrmKardex" name="FrmKardex" method="GET">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="2">
                      <tr>
                        ...
                        <td align="center" class="EstFormulario"><input name="CmpVehiculoIngresoId" class="EstFormularioCaja" type="hidden" id="CmpVehiculoIngresoId" size="10" maxlength="20"  />
                          <input name="CmpVehiculoId" class="EstFormularioCaja" type="hidden" id="CmpVehiculoId" size="10" maxlength="20"  />
                          VIN:</td>
                        <td align="center" class="EstFormulario">&nbsp;</td>
                        <td align="center" class="EstFormulario">C&oacute;digo Vehiculo:</td>
                        ...
                        <td align="center" class="EstFormulario">Nombre: </td>
                      ...
                      <tr>
                        ...
                        <td class="EstFormulario"><input name="CmpVehiculoIngresoVIN"  type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoVIN" size="10" maxlength="20" /></td>
                        <td class="EstFormulario"><a href="javascript:FncVehiculoIngresoBuscar('VIN');"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                        <td class="EstFormulario"><input name="CmpVehiculoCodigoIdentificador"  type="text" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoCodigoIdentificador" size="10" maxlength="20" readonly="readonly" /></td>
                        ...
                        <td class="EstFormulario"><input  class="EstFormularioCajaDeshabilitada" name="CmpVehiculoNombre" type="text" id="CmpVehiculoNombre" size="10" maxlength="255" /></td>
                        <td class="EstFormulario"><select disabled="disabled"  class="EstFormularioCombo" name="CmpVehiculoUnidadMedidaKardexVehiculo" id="CmpVehiculoUnidadMedidaKardexVehiculo">
                        <?php
                        ...
                        <td class="EstFormulario"><select class="EstFormularioCombo" name="CmpMoneda" id="CmpMoneda">
