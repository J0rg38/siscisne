...
var PagoOrdenVentaVehiculoFotoEditar = 2;
var PagoOrdenVentaVehiculoFotoEliminar = 2;
...
<div class="EstCapMenu">
			...
			?>           
             ...
             <div class="EstSubMenuBoton"><a href="principal<?php echo (!empty($GET_dia)?'2':'');?>C.php?Mod=<?php echo $GET_mod;?>&Form=AbonoEditar<?php echo (!empty($GET_dia)?'&Dia=1':'');?>&Id=<?php echo $InsPago->PagId;?>&OvvId=<?php echo $_GET['OvvId'];?>"><img src="imagenes/iconos/editar.png" alt="[Editar]" title="Editar" />Editar</a></div>
             <?php
			}
			?>   
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	?>
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpCuentaId" id="CmpCuentaId">
              <option value="">Escoja una opcion</option>
              <?php
          ...
          <tr>
            ...
            <td align="left" valign="top"><div class="EstFormularioArea" >
									...
									$(document).ready(function(){
											...
											url:"formularios/PagoOrdenVentaVehiculoC/acc/AccPagoOrdenVentaVehiculoFotoSubir.php",
