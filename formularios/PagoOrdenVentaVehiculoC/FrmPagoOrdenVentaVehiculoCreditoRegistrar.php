    ...
    <!--Content-->     
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td rowspan="12" align="left" valign="top"><iframe src="formularios/PagoOrdenVentaVehiculoC/acc/AccPagoOrdenVentaVehiculoSubirArchivo2.php?Identificador=<?php echo $Identificador;?>" id="IfrPagoOrdenVentaVehiculoSubirArchivo2" name="IfrPagoOrdenVentaVehiculoSubirArchivo2" scrolling="auto"  frameborder="0" width="310" height="200"></iframe></td>
