...
//deb($InsVentaDirecta->VdiAbono." A");
...
//	deb($Guardar);		
					...
					if($Guardar){
						...
						if(!$InsPago->MtdRegistrarPago()){
							...
							$InsNotificacion->NfnEnlace = "principal.php?Mod=Pago&Form=AtenderOrdenCobro";
			...
			if($InsVentaDirecta->VdiNotificar==1){
				...
				$InsVentaDirecta->MtdNotificarVentaDirectaRegistro($InsVentaDirecta->VdiId,$Destinatarios.",".$CorreosNotificacionVentaDirectaRegistro,true);
	...
	switch($GET_Origen){
		...
		case "CotizacionProducto":
			...
			$InsVentaDirecta->VdiMargenUtilidad = $InsCotizacionProducto->CprMargenUtilidad;
			$InsVentaDirecta->VdiFlete = $InsCotizacionProducto->CprFlete;
...
function FncNuevo(){
	...
	$InsVentaDirecta->VdiMargenUtilidad = $EmpresaRepuestoMargenUtilidad;
	$InsVentaDirecta->VdiFlete = $EmpresaRepuestoFlete;
