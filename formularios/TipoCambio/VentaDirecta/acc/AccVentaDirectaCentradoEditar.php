...
$InsVentaDirectaCentrado1 = array();
$InsVentaDirectaCentrado1 = $_SESSION['InsVentaDirectaCentrado'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
...
$_SESSION['InsVentaDirectaCentrado'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$VentaDirectaCentradoId,
NULL,
$VentaDirectaCentradoDescripcion,
NULL,
$VentaDirectaCentradoImporte,
$InsVentaDirectaCentrado1->Parametro6,
date("d/m/Y H:i:s")
);
?>