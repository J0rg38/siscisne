...
?>
	...
	<a target="_blank" href="subidos/venta_directa/<?php echo $DatSesionObjeto->Parametro3;?>">
      <img src="subidos/venta_directa/<?php echo $DatSesionObjeto->Parametro3;?>" alt="<?php echo $DatSesionObjeto->Parametro3;?>" title="<?php echo $DatSesionObjeto->Parametro3;?>" width="50" height="50" border="0" /></a><br />
