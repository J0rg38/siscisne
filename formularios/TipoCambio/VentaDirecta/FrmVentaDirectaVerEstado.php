	...
	?>
			...
			?>
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpClienteMargenUtilidad" type="text" class="EstFormularioCajaDeshabilitada" id="CmpClienteMargenUtilidad" value="<?php echo number_format($InsVentaDirecta->VdiMargenUtilidad,2);?>" size="10" maxlength="10" /></td>
               <td align="left" valign="top">Otros Costos: <br />
                 <span class="EstFormularioSubEtiqueta">(%)</span></td>
               <td align="left" valign="top"><input name="CmpFletePorcentaje" type="text" class="EstFormularioCajaDeshabilitada" id="CmpFletePorcentaje" value="<?php echo number_format($InsVentaDirecta->VdiFlete,2);?>" size="10" maxlength="10" /></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
