...
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/VentaDirecta/acc/AccVentaDirectaGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncGenerarPago(oId){
	...
	var Tipo = prompt("Escoja el tipo de registro \n 1 = Abono (Cliente ya realizo el pago)  \n 2 = Orden de Cobro (Cliente recien realizara el pago en ventanilla)", "1");
