...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsComprobanteVentaMonitoreoOrdenVentaVehiculo.js" ></script>
...
<tr>
  ...
  <input type="hidden" name="CmpComprobanteVentaTipo" id="CmpComprobanteVentaTipo" value="MonitoreoOrdenVentaVehiculo" />
  </td>
</tr>
<tr>
  <td width="47%">
