...
function FncOrdenVentaVehiculoVistaPreliminar(oId){
	...
	FncPopUp('formularios/OrdenVentaVehiculo/FrmOrdenVentaVehiculoImprimirOV.php?Id='+oId+'&P=2',0,0,1,0,0,1,0,screen.height,screen.width);
	
}

function FncTallerPedidoVistaPreliminar(oId){
	
	FncPopUp('formularios/TallerPedido/FrmTallerPedidoImprimir.php?Id='+oId+'&P=2',0,0,1,0,0,1,0,screen.height,screen.width);
