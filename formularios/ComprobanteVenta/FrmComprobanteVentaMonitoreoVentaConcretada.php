...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO ORDENES DE VENTA DE REPUESTOS Y SERVICIOS  (VENTAS X MOSTRADOR)</span>  
    <input type="hidden" name="CmpComprobanteVentaTipo" id="CmpComprobanteVentaTipo" value="MonitoreoVentaConcretada" />
    
  </td>
  <td height="25" align="right" valign="top"><img src='imagenes/iconos/venta.png' alt='VENTAS X MOSTRADOR' border='0' width='50' height='50' title='Ventas x Mostrador' align="absmiddle" /></td>
</tr>
<tr>
  <td width="95%">
...
<a href="principal.php?Mod=Factura&Form=Registrar&Ori=VentaConcretada&VcoId=<?php echo $dat->VcoId;?>"><img src="imagenes/generar_factura.png" width="25" height="25" border="0" title="Generar Factura" alt="[Generar Factura]"   /></a>
...
<!--        <a href="javascript:FncVentaConcretadaGenerarFacturaSeleccionado('<?php echo $dat->VcoId;?>')"><img src="imagenes/generar_factura.png" width="19" height="19" border="0" title="Generar Factura" alt="[Generar Factura]"   /></a>-->
    ...
    ?>
        <a href="principal.php?Mod=Boleta&Form=Registrar&Ori=VentaConcretada&VcoId=<?php echo $dat->VcoId;?>"><img src="imagenes/generar_boleta.png" width="25" height="25" border="0" title="Generar Boleta" alt="[Generar Boleta]"   /></a>
    <?php
    }
    ?>
