...
<?php $PrivilegioAlmacenMovimientoSalidaVer = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"AlmacenMovimientoSalida","Ver"))?true:false;?>
...
<?php $PrivilegioMultisucursal = ((($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"Factura","Multisucursal"))?true:false) or ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"Boleta","Multisucursal"))?true:false);?>


<?php //$PrivilegioGenerarExcel = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"GenerarExcel"))?true:false;?>
<?php $PrivilegioGenerarExcel = true;?>

<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsComprobanteVentaMonitoreoFichaIngreso.js" ></script>
...
include($InsProyecto->MtdFormulariosMsj($GET_mod).'MsjComprobanteVenta.php');
...
//MtdObtenerFichaAcciones($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FccId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFichaIngresoModalidad=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oFichaIngresoEstado=NULL,$oPorFacturar=false)

include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccComprobanteVentaMonitoreoFichaIngreso.php');

//MtdObtenerFichaAcciones($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FccId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFichaIngresoModalidad=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oFichaIngresoEstado=NULL,$oPorFacturar=false,$oPorGenerarGarantia=false,$oFichaIngresoModalidadIngreso=NULL)
...
//MtdObtenerFichaAcciones($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FccId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFichaIngresoModalidad=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oFichaIngresoEstado=NULL,$oPorFacturar=false,$oPorGenerarGarantia=false,$oFichaIngresoModalidadIngreso=NULL,$oIgnorarTotalVacio=false,$oFacturable=NULL,$oGenerarFactura=false) {
	
//$ResFichaAccion = $InsFichaAccion->MtdObtenerFichaAcciones("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FinConductor,VmaNombre,VmoNombre,VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,false,false,"MIN-10001,MIN-10002,MIN-10003,MIN-10004,MIN-10005,MIN-10006,MIN-10007,MIN-10009,MIN-10015,MIN-10013",true,$POST_Facturable,true);//73,74,75,8,9

																					//MtdObtenerFichaIngresoxFacturar($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FccId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFichaIngresoModalidad=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oFichaIngresoEstado=NULL,$oPorFacturar=false,$oPorGenerarGarantia=false,$oFichaIngresoModalidadIngreso=NULL,$oIgnorarTotalVacio=false,$oFacturable=NULL,$oGenerarFactura=false,$oTipoFecha="fcc.FccFecha",$oSucursal=NULL,$oMoneda=NULL)
$ResComprobanteVenta = $InsComprobanteVenta->MtdObtenerFichaIngresoxFacturar("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FinConductor,VmaNombre,VmoNombre,VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,"75,8,9",false,false,"MIN-10016,MIN-10016,MIN-10001,MIN-10002,MIN-10003,MIN-10004,MIN-10005,MIN-10007,MIN-10009,MIN-10015,MIN-10013,MIN-10006,MIN-10017,MIN-10018,MIN-10028,MIN-10024,MIN-10019,MIN-10020,MIN-10021,MIN-10023,MIN-10026,MIN-10029",true,$POST_Facturable,true,"fcc.FccFecha",$POST_Sucursal,$POST_Moneda);//73,74,75,8,9
...
<a href="javascript:FncActualizarNoFacturableSeleccionados();"><img src="imagenes/acciones/nofacturable.png" alt="[Marcar como NO FACTURABLES]" title="Marcar como NO FACTURABLES seleccionados" />No Facturable</a>
</div> 

<div class="EstSubMenuBoton">
<a href="javascript:FncActualizarFacturableSeleccionados();"><img src="imagenes/acciones/facturable.png" alt="[Marcar como  FACTURABLES]" title="Marcar como  FACTURABLES seleccionados" /> Facturable</a>
</div> 

<div class="EstSubMenuBoton"><a href="javascript:FncFichaIngresoGenerarFacturaSeleccionados();"><img src="imagenes/iconos/factura.png" alt="[Generar Factura]"  title="Generar Factura con elementos seleccionados" />Factura</a></div>

<div class="EstSubMenuBoton"><a href="javascript:FncFichaIngresoGenerarBoletaSeleccionados();"><img src="imagenes/iconos/boleta.png" alt="[Generar Boleta]"  title="Generar Boleta con elementos seleccionados" />Boleta</a></div>
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO POR FACTURAR (TALLER) </span>  
  
  <input type="hidden" name="CmpComprobanteVentaTipo" id="CmpComprobanteVentaTipo" value="MonitoreoFichaIngreso" /></td>
  <td height="25" align="right" valign="top"><img src='imagenes/iconos/taller.png' alt='TALLER' border='0' width='50' height='50' title='Taller' align="absmiddle" /></td>
</tr>
<tr>
  <td width="95%">
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "VcoId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VcoId','ASC');"> Ficha <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VcoId','DESC');"> Ficha <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('VcoId','ASC');"> Ficha </a>
                <?php
				}
				?></th>
                <th width="3%" ><?php
				if($POST_ord == "AmoId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AmoId','ASC');"> Ficha Salida <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AmoId','DESC');"> Ficha Salida <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AmoId','ASC');"> Ficha Salida </a>
                <?php
				}
				?></th>
                <th width="3%" ><?php
				...
				if($POST_ord == "FinFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinFecha','ASC');"> Fec. Ord.  Trab. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinFecha','DESC');"> Fec. Ord.  Trab.  <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('FinFecha','ASC');"> Fec. Ord.  Trab.  </a>
                <?php
				}
				?></th>
                <th width="7%" ><?php
				...
				?></th>
                <th width="7%" ><?php
				if($POST_ord == "FimObsequio"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FimObsequio','ASC');"> Obsequio <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FimObsequio','DESC');"> Obsequio <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('FimObsequio','ASC');"> Obsequio </a>
                <?php
				}
				?></th>
                <th width="4%" ><?php
				...
				if($POST_ord == "MonSimbolo"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('MonSimbolo','ASC');"> Moneda <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('MonSimbolo','DESC');"> Moneda <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('MonSimbolo','ASC');"> Moneda </a>
                  <?php
				}
				?></th>
                <th width="7%" ><?php
...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
 ...
 <tbody class="EstTablaListadoBody">
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FccId; ?>" sigla="<?php echo $dat->MinSigla; ?>" />				</td>
                <td  width="3%" align="right" >
                  
                 <!-- <a href="javascript:FncPopUp('formularios/FichaAccion/FrmFichaAccionTallerPedidoImprimir.php?Id=<?php echo $dat->FccId;?>&amp;P=',0,0,1,0,0,1,0,screen.height,screen.width);"> 
                  --><!--<img src="imagenes/avisos/ficha.gif" alt="" width="25" height="25" border="0" align="Ficha" title="Ficha" /> -->
				  <?php echo $dat->FccId;  ?><!--</a>   -->
...
?>
                ...
                <td  width="3%" align="right" >
				 ...
				 <a href="javascript:FncTallerPedidoVistaPreliminar('<?php echo $dat->AmoId;?>');"> 
...
?>
                ...
                <td  width="7%" align="right" ><?php echo ($dat->MinNombre);?></td>
                ...
                <td  width="3%" align="right" ><?php echo ($dat->EinColor);?></td>
                <td  width="3%" align="right" ><h2><?php echo ($dat->EinPlaca);?></h2></td>
                ...
                <td  width="7%" align="right" ><?php echo ($dat->FinTiempoCreacion);?></td>
        <td  width="10%" align="center" >
		
	<?php
    if($PrivilegioGenerarFactura){
    ?>
        <a href="principal.php?Mod=Factura&Form=Registrar&Ori=FichaAccion&FccId=<?php echo $dat->FccId;?>"><img src="imagenes/generar_factura.png" width="25" height="25" border="0" title="Generar Factura" alt="[Generar Factura]"   /></a>
    <?php
    }
    ?>
    ...
    ?>
        <a href="principal.php?Mod=Boleta&Form=Registrar&Ori=FichaAccion&FccId=<?php echo $dat->FccId;?>"><img src="imagenes/generar_boleta.png" width="25" height="25" border="0" title="Generar Boleta" alt="[Generar Boleta]"   /></a>
    <?php
    }
    ?>
  ...
  /*  if($PrivilegioGenerarFacturaExportacion){
    ?>
        <a href="principal.php?Mod=FacturaExportacion&Form=Registrar&Ori=FichaAccion&VcoId=<?php echo $dat->FccId;?>"><img src="imagenes/acciones/factura_exportacion.png" width="19" height="19" border="0" title="Generar Factura de Exportacion" alt="[Generar Factura de Exportacion]"   /></a>
    <?php
    }*/
    ?>
