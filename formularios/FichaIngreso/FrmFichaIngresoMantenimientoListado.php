...
if (!isset($_SESSION['InsFichaIngresoMantenimiento' . $ModalidadIngreso . $Identificador])) {
    ...
    $_SESSION['InsFichaIngresoMantenimiento' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsFichaIngresoMantenimiento' . $ModalidadIngreso . $Identificador]);
}
