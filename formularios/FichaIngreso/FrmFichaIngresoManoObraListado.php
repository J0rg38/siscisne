...
if (!isset($_SESSION['InsFichaIngresoManoObra' . $ModalidadIngreso . $Identificador])) {
  ...
  $_SESSION['InsFichaIngresoManoObra' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsFichaIngresoManoObra' . $ModalidadIngreso . $Identificador]);
}
