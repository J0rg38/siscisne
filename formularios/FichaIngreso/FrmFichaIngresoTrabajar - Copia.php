             ...
             <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
               ...
               <tr>
                 ...
                 <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                   <tr>
                     <td><input name="CmpVehiculoIngresoVIN" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoIngresoVIN"  value="<?php echo $InsFichaIngreso->EinVIN;?>" size="25" maxlength="50" readonly="readonly" /></td>
                     </tr>
                 </table></td>
               ...
               <tr>
                 ...
                 <td colspan="5" align="left" valign="top"><table border="0" cellpadding="2" cellspacing="0">
                   <tr>
			...
			?>
               ...
               <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   ...
                   <td valign="top"><div id="CapClienteBuscar"></div></td>
                 </tr>
</table></td>
