...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsFichaIngresoSeguimientoFunciones.js"></script>
<?php
?>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">SEGUIMIENTO DE ORDENES DE TRABAJO</td>
  <td width="2%"><a href="formularios/FichaIngreso/inf/InfFichaIngresoSeguimiento.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>FichaIngreso/IfrFichaIngresoSeguimiento.php" target="IfrFichaIngresoSeguimiento" method="post" name="FrmFichaIngresoSeguimiento" id="FrmFichaIngresoSeguimiento">
      ...
      <table class="EstFormulario" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">     <fieldset class="EstFormularioContenedor">
            ...
            <table border="0" cellpadding="2" cellspacing="2">
              <tr>
                <td width="138">Num. Ord. Trabajo:</td>
                <td colspan="3"><input name="CmpFichaIngresoId" type="text" class="EstFormularioCaja" id="CmpFichaIngresoId" size="20" maxlength="50" /></td>
                <td width="5">&nbsp;</td>
                </tr>
              <tr>
                <td>VIN:</td>
                <td colspan="3"><input name="CmpVehiculoIngresoVIN" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoVIN" size="20" maxlength="50" /></td>
                <td>&nbsp;</td>
                </tr>
              <tr>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncFichaIngresoSeguimientoImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncFichaIngresoSeguimientoGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>FichaIngreso/IfrFichaIngresoSeguimiento.php" target="IfrFichaIngresoSeguimiento" id="IfrFichaIngresoSeguimiento" name="IfrFichaIngresoSeguimiento" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
