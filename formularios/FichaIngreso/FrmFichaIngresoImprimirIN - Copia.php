        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstFichaIngresoImprimirTabla">
          <tbody class="EstFichaIngresoImprimirTablaBody">
            ...
            <tr>
              ...
              <td width="18%" align="left" valign="top"><span class="EstFichaIngresoImprimirContenido"><?php echo $InsFichaIngreso->FinFechaEntrega;?>
              <?php echo $InsFichaIngreso->FinHoraEntrega;?>
              </span></td>
        ...
        <tbody class="EstFichaIngresoImprimirTablaBody">
          ...
          <tr>
            ...
            <td align="left" valign="top" >
              ...
              <h3>
              <span class="2EstFichaIngresoImprimirContenido">
                <?php echo $InsFichaIngreso->VmaNombre;?>/
                <?php echo $InsFichaIngreso->VmoNombre;?>/
                <?php echo $InsFichaIngreso->VveNombre;?>/
                <?php echo $InsFichaIngreso->EinAnoFabricacion;?>/
                 <?php echo $InsFichaIngreso->EinColor;?></span>
                </h3>
              </td>
            </tr>
          <tr>
