...
//Parmaetro18 = ProCodigoAlternativo
				...
				$Cantidad,
				$CantidadReal,
				$InsFichaIngresoProducto1->Parametro11,
				$InsUnidadMedida->UmeNombre,
				$InsFichaIngresoProducto1->Parametro13,
				$InsFichaIngresoProducto1->Parametro14,
				$InsFichaIngresoProducto1->Parametro15,
				$InsFichaIngresoProducto1->Parametro16,
				$InsFichaIngresoProducto1->Parametro17,
				$InsFichaIngresoProducto1->Parametro18
				);
