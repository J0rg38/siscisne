...
<!--<a href="comunes/FichaIngreso/DiaVehiculoIngresoRegistrar.php?height=440&width=850" class="thickbox" title=""><img src="imagenes/nuevo.png" alt="[Nuevo]" width="20" height="20" border="0" align="absmiddle" title="Nuevo" /></a>-->
                     ...
                     <tr>
                       ...
                       <td align="left" valign="top"><span id="sprytextfield9">
                         <input class="EstFormularioCaja"  name="CmpVehiculoKilometraje" type="text" id="CmpVehiculoKilometraje" value="<?php if(empty($InsFichaIngreso->FinVehiculoKilometraje)){ echo "0.00"; }else{echo $InsFichaIngreso->FinVehiculoKilometraje;}?>" size="10" maxlength="10" />
                     ...
                     <tr>
                       ...
                       <td colspan="5" align="left"><table border="0" cellpadding="0" cellspacing="0">
                         <tr>
                           ...
                           <td><div id="CapVehiculoPromocionResumen2"><a href="javascript:FncOrdenVentaVehiculoMantenimientoVerificar();"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></div></td>
                           </tr>
                       </table></td>
                       <td>&nbsp;</td>
                     </tr>
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
                            ...
                            <td valign="top"><div id="CapClienteBuscar"></div>
