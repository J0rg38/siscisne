...
?>
  ...
  $InsPlanMantenimiento = new ClsPlanMantenimiento($InsMysql);
  //MtdObtenerModalidadIngresos($oCampo=NULL,$oFiltro=NULL,$oOrden = 'MinId',$oSentido = 'Desc',$oPaginacion = '0,10',$oUso=NULL,$oEstado=NULL) {

  $ResModalidadIngreso = $InsModalidadIngreso->MtdObtenerModalidadIngresos(NULL, NULL, "MinOrden", "ASC", NULL, "1,3", "1");
  ...
  //ACCIONES
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccFichaIngresoRegistrar.php');
  //DATOS
  ...
  //MtdObtenerPersonales($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'PerId',$oSentido = 'Desc',$oPaginacion = '0,10',$oPersonalTipo=NULL,$oEstado=NULL,$oFechaNacimientoRango=NULL,$oTaller=NULL,$oRecepcion=NULL,$oVenta=NULL,$oArea=NULL,$oSucursal=NULL,$oAlmacen=NULL,$oFirmante=NULL,$oMultisucursal=false)
  $ResPersonal = $InsPersonal->MtdObtenerPersonales(NULL, NULL, NULL, "PerNombre", "ASC", NULL, NULL, 1, NULL, NULL, 1, NULL, NULL, $_SESSION['SesionSucursal'], NULL, NULL, true);
  ...
  //MtdObtenerTipoReparaciones($oCampo=NULL,$oFiltro=NULL,$oOrden = 'TreId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL) {
...
*/
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">REGISTRAR
              ODEN DE TRABAJO</span></td>
        </tr>
        <tr>
          <td colspan="2">

            <?php
            //deb($ArrModalidadIngresos);
            ?>
            ...
            <ul class="tabs">
              ...
              <li><a id="TabPresupuesto" href="#tab4">Presupuesto</a></li>
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">VIN:
                              ...
                              <input name="CmpVehiculoIngresoId" type="hidden" id="CmpVehiculoIngresoId" value="<?php echo $InsFichaIngreso->EinId; ?>" size="3" />
                            </td>
                            <td align="left" valign="top">
                              ...
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="left" valign="top">
                                    <a href="javascript:FncVehiculoIngresoSimpleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                                  </td>
                                  <td align="left" valign="top">
                                  ...
                                  <td align="left" valign="top">
                                    ...
                                    <!--<a href="comunes/FichaIngreso/DiaVehiculoIngresoRegistrar.php?height=440&width=850" class="thickbox" title=""><img src="imagenes/nuevo.png" alt="[Nuevo]" width="20" height="20" border="0" align="absmiddle" title="Nuevo" /></a>-->
                              ...
                              <table>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <input name="CmpVehiculoIngresoPlaca" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoPlaca" value="<?php echo $InsFichaIngreso->EinPlaca; ?>" size="30" maxlength="50" />
                                  </td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              ...
                              <input name="CmpVehiculoIngresoMarca" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoIngresoMarca" value="<?php echo $InsFichaIngreso->VmaNombre; ?>" size="30" maxlength="50" readonly="readonly" />
                            ...
                            <td align="left" valign="top">Modelo:
                              ...
                              <input name="CmpVehiculoModeloId" type="hidden" id="CmpVehiculoModeloId" value="<?php echo $InsFichaIngreso->VmoId; ?>" size="3" />
                            ...
                            <td align="left" valign="top">Version:
                              <input name="CmpVehiculoIngresoVersionId" type="hidden" id="CmpVehiculoIngresoVersionId" value="<?php echo $InsFichaIngreso->VveId; ?>" size="3" />
                            </td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpVehiculoIngresoClienteId" type="hidden" id="CmpVehiculoIngresoClienteId" value="<?php echo $InsFichaIngreso->CliId; ?>" size="3" />
                              ...
                              <input name="CmpMonedaId" type="hidden" id="CmpVehiculoIngresoId" value="<?php echo $InsFichaIngreso->MonId; ?>" size="3" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span id="sprytextfield9">
                                <input class="EstFormularioCaja" name="CmpVehiculoKilometraje" type="text" id="CmpVehiculoKilometraje" value="<?php if (empty($InsFichaIngreso->FinVehiculoKilometraje)) {
                                                                                                                                                echo "0.00";
                                                                                                                                              } else {
                            ...
                            <td align="left" valign="top">
                              ...
                              <select class="EstFormularioCombo" name="CmpMantenimientoKilometraje" id="CmpMantenimientoKilometraje" <?php echo (empty($InsFichaIngreso->FinMantenimientoKilometraje) ? 'disabled="disabled"' : ''); ?>>
                              </select>
                           ...
                           <?php
                            ...
                            <td align="left" valign="top"><input name="CmpCotizacionProductoId" type="hidden" id="CmpCotizacionProductoId" value="<?php echo $InsFichaIngreso->CprId; ?>" size="3" />
                              <input name="CmpCitaId" type="hidden" id="CmpCitaId" value="<?php echo $InsFichaIngreso->CitId; ?>" size="3" />
                            </td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top">Ord. Venta:
                            <td align="left" valign="top"><input name="CmpOrdenVentaVehiculoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculoId" value="<?php echo $InsFichaIngreso->OvvId; ?>" size="20" maxlength="20" readonly="readonly" />
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            ...
                            <td colspan="5" align="left" valign="top">
                              ...
                              <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  ...
                                  <td align="left"><input name="CmpCampanaId" type="hidden" id="CmpCampanaId" value="<?php echo $InsFichaIngreso->CamId; ?>" size="20" maxlength="50" />
                                    ...
                                    <input name="CmpCampanaNombre" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCampanaNombre" value="<?php echo $InsFichaIngreso->CamNombre; ?>" size="60" maxlength="500" readonly="readonly" />
                                  </td>
                                  <td align="left">
                          ...
                          <tr>
                            ...
                            <td colspan="5" align="left" valign="top">
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="left"><a href="javascript:FncVehiculoPromocionNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  <td align="left"><input name="CmpObsequioId" type="hidden" id="CmpObsequioId" value="<?php echo $InsFichaIngreso->ObsId; ?>" size="20" maxlength="50" />



                                    <input name="CmpObsequioNombre" type="text" class="EstFormularioCajaDeshabilitada" id="CmpObsequioNombre" value="<?php echo $InsFichaIngreso->ObsNombre; ?>" size="40" maxlength="500" readonly="readonly" />
                                  </td>
                                  <td align="left">
                          ...
                          <tr>
                            ...
                            <td colspan="5" align="left">
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><a href="javascript:FncOrdenVentaVehiculoMantenimientoNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a><a href="javascript:FncCampanaVehiculoNuevo();"></a></td>
                                  <td><input name="CmpOrdenVentaVehiculoMantenimientoId" type="hidden" id="CmpOrdenVentaVehiculoMantenimientoId" value="<?php echo $InsFichaIngreso->OvmId; ?>" size="20" maxlength="50" />
                                    Mant./
                                    <input name="CmpOrdenVentaVehiculoMantenimientoKilometraje" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculoMantenimientoKilometraje" value="<?php echo $InsFichaIngreso->OvmKilometraje; ?>" size="40" maxlength="500" readonly="readonly" />
                                  </td>
                                  <td>
                                    <div id="CapVehiculoPromocionResumen2"><a href="javascript:FncOrdenVentaVehiculoMantenimientoVerificar();"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                              ...
                              <table width="442" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td>
                                    ...
                                    <!--<input class="EstFormularioBoton" type="button" value="Agregar una nota" id="BtnAvisoCargarFormulario" name="BtnAvisoCargarFormulario" />
           -->
                                    <a id="BtnAvisoCargarFormulario" href="#">Agregar Nota</a> |
                                    <a id="BtnAvisoCargarListado" href="#">Ver Nota</a>
                                ...
                                <tr>
                                  <td colspan="2">
                                    ...
                                    <div id="CapAvisoCargarFormulario"></div>
                    ...
                    <td width="97%" valign="top">
                      ...
                      <div class="EstFormularioArea">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="6"><span class="EstFormularioSubTitulo">Datos de la Orden de Trabajo
                          ...
                          <tr>
                            ...
                            <td colspan="-2" align="left" valign="top"><input readonly="readonly" name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsFichaIngreso->FinId; ?>" size="15" maxlength="20" /></td>
                            <td align="left" valign="top">Codigo Garantia:</td>
                            <td colspan="-2" align="left" valign="top"><input name="CmpId2" type="text" class="EstFormularioCaja" id="CmpId2" value="<?php echo $InsFichaIngreso->FinId; ?>" size="15" maxlength="20" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td colspan="3" align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
                                ...
                                ?>
                                  <option value="<?php echo $DatSucursal->SucId; ?>" <?php if ($InsFichaIngreso->SucId == $DatSucursal->SucId) {
                                                                                      echo 'selected="selected"';
                                                                                    } ?>><?php echo $DatSucursal->SucNombre; ?></option>
                                <?php
                                }
                                ?>
                              </select></td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Fecha de Ingreso:<br />
                              <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span>
                            </td>
                            <td align="left" valign="top"><span id="sprytextfield7">
                                <label>
                                  <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php echo (empty($InsFichaIngreso->FinFecha) ? date("d/m/Y") : $InsFichaIngreso->FinFecha); ?>" size="15" maxlength="10" />
                                </label>
                            ...
                            <td align="left" valign="top"><input name="CmpHora" type="text" class="EstFormularioCaja" id="CmpHora" value="<?php if (empty($InsFichaIngreso->FinHora)) {
                                                                                                                                            echo date("H:i");
                                                                                                                                          } else {
                                                                                                                                            echo $InsFichaIngreso->FinHora;
                                                                                                                                          } ?>" size="10" maxlength="8" readonly="readonly" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            ...
                            <td align="left" valign="top"><input name="CmpHoraEntrega" type="text" class="EstFormularioCajaHora" id="CmpHoraEntrega" value="<?php if (empty($InsFichaIngreso->FinHoraEntrega)) {
                                                                                                                                                              echo "";
                                                                                                                                                            } else {
                                                                                                                                                              echo $InsFichaIngreso->FinHoraEntrega;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              ...
                              <input type="hidden" name="CmpEstado" id="CmpEstado" value="<?php echo $InsFichaIngreso->FinEstado; ?>" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Notas:<br />
                              <span class="EstFormularioSubEtiqueta">(Resumen de la situacion actual de la O.T.)</span>
                            </td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Indicaciones para el Tecnico:<br />
                              <span class="EstFormularioSubEtiqueta">(Mensaje que aparecera constantemente al tecnico )</span>
                            </td>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="6" align="left" valign="top">* El codigo es autogenerado al guardar la Orden de Trabajo</td>
                            <td>&nbsp;</td>
                          </tr>
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              ...
                              <input name="CmpClienteTipo" type="hidden" id="CmpClienteTipo" value="<?php echo $InsFichaIngreso->LtiId; ?>" size="3" />
                            ...
                            <td align="left" valign="top">Cliente:
                              ...
                              <input class="EstFormularioCaja" name="CmpClienteApellidoPaterno" type="hidden" id="CmpClienteApellidoPaterno" value="<?php echo $InsFichaIngreso->CliApellidoMaterno; ?>" size="45" maxlength="255" />
                            </td>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top"><input type="checkbox" name="CmpActualizarDatos" id="CmpActualizarDatos" value="1" checked="checked" />
                              Actualizar datos de contacto (Celular y Email)</td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td colspan="3" align="left" valign="top"><input class="EstFormularioCaja" name="CmpConductor" type="text" id="CmpConductor" value="<?php echo $InsFichaIngreso->FinConductor; ?>" size="45" maxlength="255" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior1" type="text" id="CmpInterior1" value="<?php if (empty($InsFichaIngreso->FinInterior1)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior1;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Cenicero:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior15" type="text" id="CmpInterior15" value="<?php if (empty($InsFichaIngreso->FinInterior15)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior15;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDelantero1" type="text" id="CmpExteriorDelantero1" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero1)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorDelantero1;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Gdfgo Posterior:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho1" type="text" id="CmpExteriorDerecho1" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho1)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho1;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Lunas Electricas:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior2" type="text" id="CmpInterior2" value="<?php if (empty($InsFichaIngreso->FinInterior2)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior2;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Manual:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior16" type="text" id="CmpInterior16" value="<?php if (empty($InsFichaIngreso->FinInterior16)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior16;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDelantero2" type="text" id="CmpExteriorDelantero2" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero2)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorDelantero2;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Tapa de Combustible:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho2" type="text" id="CmpExteriorDerecho2" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho2)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho2;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Asiento (tela, cuero):</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior3" type="text" id="CmpInterior3" value="<?php if (empty($InsFichaIngreso->FinInterior3)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior3;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Antena:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior17" type="text" id="CmpInterior17" value="<?php if (empty($InsFichaIngreso->FinInterior17)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior17;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDelantero3" type="text" id="CmpExteriorDelantero3" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero3)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorDelantero3;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Aros:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho3" type="text" id="CmpExteriorDerecho3" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho3)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho3;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Asiento Piloto:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior4" type="text" id="CmpInterior4" value="<?php if (empty($InsFichaIngreso->FinInterior4)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior4;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Copas de Aros / Vasos:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior18" type="text" id="CmpInterior18" value="<?php if (empty($InsFichaIngreso->FinInterior18)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior18;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDelantero4" type="text" id="CmpExteriorDelantero4" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero4)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorDelantero4;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Puerta Posterior:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho4" type="text" id="CmpExteriorDerecho4" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho4)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho4;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Controles de Tim&oacute;n:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior5" type="text" id="CmpInterior5" value="<?php if (empty($InsFichaIngreso->FinInterior5)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior5;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Airbags:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior19" type="text" id="CmpInterior19" value="<?php if (empty($InsFichaIngreso->FinInterior19)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior19;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDelantero5" type="text" id="CmpExteriorDelantero5" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero5)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorDelantero5;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Puerta Delantera:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho5" type="text" id="CmpExteriorDerecho5" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho5)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho5;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Perilla de Palanca:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior6" type="text" id="CmpInterior6" value="<?php if (empty($InsFichaIngreso->FinInterior6)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior6;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Seguro Cromado Rueda:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior20" type="text" id="CmpInterior20" value="<?php if (empty($InsFichaIngreso->FinInterior20)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior20;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDelantero6" type="text" id="CmpExteriorDelantero6" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero6)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorDelantero6;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Espejo Lateral:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho6" type="text" id="CmpExteriorDerecho6" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho6)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho6;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Radio (Cass/CD/MP/A/C):</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior7" type="text" id="CmpInterior7" value="<?php if (empty($InsFichaIngreso->FinInterior7)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior7;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Gancho de remolque:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior21" type="text" id="CmpInterior21" value="<?php if (empty($InsFichaIngreso->FinInterior21)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior21;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDelantero7" type="text" id="CmpExteriorDelantero7" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero7)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorDelantero7;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Gdfgo Delantero:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho7" type="text" id="CmpExteriorDerecho7" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho7)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho7;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">A/C:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior8" type="text" id="CmpInterior8" value="<?php if (empty($InsFichaIngreso->FinInterior8)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior8;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Estuche de Herram.:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior22" type="text" id="CmpInterior22" value="<?php if (empty($InsFichaIngreso->FinInterior22)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior22;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorDerecho8" type="text" id="CmpExteriorDerecho8" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho8)) {
                                                                                                                                                                    echo "1";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsFichaIngreso->FinExteriorDerecho8;
                                                                                                                                                                  } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Reloj:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior9" type="text" id="CmpInterior9" value="<?php if (empty($InsFichaIngreso->FinInterior9)) {
                                                                                                                                                      echo "1";
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsFichaIngreso->FinInterior9;
                                                                                                                                                    } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Gata llave de rueda Palanca:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior23" type="text" id="CmpInterior23" value="<?php if (empty($InsFichaIngreso->FinInterior23)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior23;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior10" type="text" id="CmpInterior10" value="<?php if (empty($InsFichaIngreso->FinInterior10)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior10;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Luz de Sal&oacute;n:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior24" type="text" id="CmpInterior24" value="<?php if (empty($InsFichaIngreso->FinInterior24)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior24;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td align="left" valign="top">Parachoque:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorPosterior1" type="text" id="CmpExteriorPosterior1" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior1)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorPosterior1;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior11" type="text" id="CmpInterior11" value="<?php if (empty($InsFichaIngreso->FinInterior11)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior11;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Triangulo:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior25" type="text" id="CmpInterior25" value="<?php if (empty($InsFichaIngreso->FinInterior25)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior25;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td align="left" valign="top">Faros:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorPosterior2" type="text" id="CmpExteriorPosterior2" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior2)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorPosterior2;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Gdfgo Posterior:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorIzquierdo1" type="text" id="CmpExteriorIzquierdo1" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo1)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorIzquierdo1;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Tapasoles:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior12" type="text" id="CmpInterior12" value="<?php if (empty($InsFichaIngreso->FinInterior12)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior12;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Extintor:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior26" type="text" id="CmpInterior26" value="<?php if (empty($InsFichaIngreso->FinInterior26)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior26;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorPosterior3" type="text" id="CmpExteriorPosterior3" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior3)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorPosterior3;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Aros:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorIzquierdo2" type="text" id="CmpExteriorIzquierdo2" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo2)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorIzquierdo2;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Sunroof:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior13" type="text" id="CmpInterior13" value="<?php if (empty($InsFichaIngreso->FinInterior13)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior13;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Cobertor de Maletera:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior27" type="text" id="CmpInterior27" value="<?php if (empty($InsFichaIngreso->FinInterior27)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior27;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td align="left" valign="top">Plumillas:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorPosterior4" type="text" id="CmpExteriorPosterior4" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior4)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorPosterior4;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Puerta Posterior:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorIzquierdo3" type="text" id="CmpExteriorIzquierdo3" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo3)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorIzquierdo3;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Encendedor:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpInterior14" type="text" id="CmpInterior14" value="<?php if (empty($InsFichaIngreso->FinInterior14)) {
                                                                                                                                                        echo "1";
                                                                                                                                                      } else {
                                                                                                                                                        echo $InsFichaIngreso->FinInterior14;
                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorPosterior5" type="text" id="CmpExteriorPosterior5" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior5)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorPosterior5;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Puerta Delantera:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorIzquierdo4" type="text" id="CmpExteriorIzquierdo4" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo4)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorIzquierdo4;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorPosterior6" type="text" id="CmpExteriorPosterior6" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior6)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorPosterior6;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Espejo Lateral:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorIzquierdo5" type="text" id="CmpExteriorIzquierdo5" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo5)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorIzquierdo5;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Gdfgo Delantero:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorIzquierdo6" type="text" id="CmpExteriorIzquierdo6" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo6)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorIzquierdo6;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Lunas:</td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpExteriorIzquierdo7" type="text" id="CmpExteriorIzquierdo7" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo7)) {
                                                                                                                                                                        echo "1";
                                                                                                                                                                      } else {
                                                                                                                                                                        echo $InsFichaIngreso->FinExteriorIzquierdo7;
                                                                                                                                                                      } ?>" size="10" maxlength="1" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td align="left" valign="top">Observacion de Inventario:</td>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    <td width="3%">&nbsp;</td>
                                    <td width="47%">
                                      <div class="EstFormularioAccion" id="CapFichaIngresoHistorialAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    ...
                                    <td width="1%">
                                      <div id="CapFichaIngresoHistorialesResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapFichaIngresoHistoriales" class="EstCapFichaIngresoHistoriales"> </div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                </table>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    <td width="3%">&nbsp;</td>
                                    <td width="47%">
                                      <div class="EstFormularioAccion" id="CapFichaIngresoCotizacionesAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    ...
                                    <td width="1%">
                                      <div id="CapFichaIngresoCotizacionesResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapFichaIngresoCotizaciones" class="EstCapFichaIngresoCotizaciones"> </div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                </table>
              ...
              <div id="tab4" class="tab_content">
                ...
                <div class="EstFormularioArea" id="CapPresupuesto">
                                ...
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  <tr>
                                    ...
                                    <td colspan="4"><span class="EstFormularioSubTitulo">TAREAS </span>
                                      ...
                                      <input type="hidden" name="Cmp<?php echo $DatModalidadIngreso->MinSigla; ?>TareaId" id="Cmp<?php echo $DatModalidadIngreso->MinSigla; ?>TareaId" />
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <select class="EstFormularioCombo" name="Cmp<?php echo $DatModalidadIngreso->MinSigla; ?>TareaAccion" id="Cmp<?php echo $DatModalidadIngreso->MinSigla; ?>TareaAccion">
                              ...
                              <div class="EstFormularioArea">
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  ...
                                  <tr>
                                    ...
                                    <td>Cantidad</td>
                                    <td>
                                      <div id="Cap<?php echo $DatModalidadIngreso->MinSigla; ?>ProductoBuscar"></div>
                                    </td>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    <td width="2%">&nbsp;</td>
                                    <td width="48%">
                                      <div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla; ?>TareaAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    ...
                                    <td width="1%">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>TareasResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>Tareas" class="EstCapFichaIngresoTareas"> </div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                </table>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    <td width="1%">&nbsp;</td>
                                    <td width="48%">
                                      <div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla; ?>ProductoAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    ...
                                    <td width="1%">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>ProductosResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>Productos" class="EstCapFichaIngresoProductos"> </div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                </table>
                                ...
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  <tr>
                                    ...
                                    <td colspan="4"><span class="EstFormularioSubTitulo">SERVICIOS </span>
                                      ...
                                      <input type="hidden" name="Cmp<?php echo $DatModalidadIngreso->MinSigla; ?>ManoObraId" id="Cmp<?php echo $DatModalidadIngreso->MinSigla; ?>ManoObraId" />
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    <td width="2%">&nbsp;</td>
                                    <td width="48%">
                                      <div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla; ?>ManoObraAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    ...
                                    <td width="1%">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>ManoObrasResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>ManoObras" class="EstCapFichaIngresoManoObras"> </div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                </table>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            <td align="left" valign="top">
                              ...
                              <input <?php echo ($FichaIngresoModalidadObsequio == 1) ? 'checked="checked"' : ''; ?> type="checkbox" name="CmpFichaIngresoModalidadObsequio_<?php echo $DatModalidadIngreso->MinSigla; ?>" id="CmpFichaIngresoModalidadObsequio_<?php echo $DatModalidadIngreso->MinSigla; ?>" value="1" />
                              <span class="EstFormularioResaltar"> Este SERVICIO es GRATUITO
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    ...
                                    <td width="49%">
                                      <div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla; ?>MantenimientoAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    ...
                                    <td width="1%">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>MantenimientosResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapFichaIngreso<?php echo $DatModalidadIngreso->MinSigla; ?>Mantenimientos" class="EstCapFichaIngresoMantenimientos"> </div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                </table>
  ...
  <script type="text/javascript">
    ...
    Calendar.setup({
      ...
      ifFormat: "%d/%m/%Y", //  
      button: "BtnFechaCita" // el id del bot�n que  
    });
  ...
  <script type="text/javascript">
    ...
    var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "currency", {
      minValue: 1
    });
  </script>
<?php
