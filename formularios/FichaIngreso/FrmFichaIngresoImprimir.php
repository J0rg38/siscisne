...
<tr>
  <td width="22%" align="left" valign="top">
   ...
   <img src="../../imagenes/logos/logo_impresion.png" width="150" title="Logo" alt="Logo" border="0" /></td>
...
<tr>
      ...
      <div class="EstFichaIngresoImprimirCapa">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstFichaIngresoImprimirTabla">
          <tbody class="EstFichaIngresoImprimirTablaBody">
            <tr>
              <td width="13%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo" ><span class="EstFichaIngresoImprimirEtiqueta">Asesor</span></td>
            ...
            <tr>
              ...
              <td width="20%" align="left" valign="top" ><span class="EstFichaIngresoImprimirContenido"><?php echo $InsFichaIngreso->FinFechaCita;?></span></td>
              <td width="15%" align="left" valign="top"><span class="EstFichaIngresoImprimirEtiqueta">Fecha de Entrega:</span></td>
              <td width="19%" align="left" valign="top"><span class="EstFichaIngresoImprimirContenido"><?php echo $InsFichaIngreso->FinFechaEntrega;?></span></td>
              <td width="8%" align="left" valign="top"><span class="EstFichaIngresoImprimirEtiqueta">R:</span></td>
              <td width="23%" align="left" valign="top"><span class="EstFichaIngresoImprimirContenido">-</span></td>
            </tr>
          </tbody>
        </table>
    ...
    <td width="25%" align="left" valign="top"><div class="EstFichaIngresoImprimirCapa">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstFichaIngresoImprimirTabla">
        <tbody class="EstFichaIngresoImprimirTablaBody">
          <tr>
          ...
          <tr>
            ...
            <td align="left" valign="top" ><span class="EstFichaIngresoImprimirEtiqueta">:</span></td>
            <td align="left" valign="top" ><span class="EstFichaIngresoImprimirContenido"><?php echo $InsFichaIngreso->FinFecha;?></span></td>
            </tr>
          <tr>
          ...
          <tr>
            <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">&nbsp;</td>
        ...
        <tbody class="EstFichaIngresoImprimirTablaBody">
          <tr>
			...
			?>
              ...
              <table width="100%"  border="1" cellpadding="1" cellspacing="0" class="EstFichaIngresoImprimirTabla">
...
?>
                  <tr>
                    <td align="right" valign="top" class="EstFichaIngresoDetalleImprimirContenido"><?php echo $i;?>.-</td>
                    <td align="right" valign="top" class="EstFichaIngresoDetalleImprimirContenido" ><?php echo $DatFichaIngresoMantenimiento->PmtNombre;?></td>
                    <td align="right" valign="top" class="EstFichaIngresoDetalleImprimirContenido" >
...
<tr>
  <td colspan="6" valign="top"><div class="EstFichaIngresoImprimirCapa">
    <table width="100%" height="155" border="0" cellpadding="3" cellspacing="2" class="EstFichaIngresoImprimirTabla">
      <tbody class="EstFichaIngresoImprimirTablaBody">
        <tr>
          <td colspan="2" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">Vista al rededor del vehiculo e inventario:</td>
          <td width="25%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">Fecha de Inspeccion:</td>
          <td width="25%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">Firma de conformidad del cliente</td>
          </tr>
        <tr>
        ...
        <tr>
          <td height="25" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">Firma de inspector</td>
          <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">Condiciones de conformidad</td>
          </tr>
        <tr>
          <td align="left" valign="top" >&nbsp;</td>
          <td align="left" valign="top" >&nbsp;</td>
