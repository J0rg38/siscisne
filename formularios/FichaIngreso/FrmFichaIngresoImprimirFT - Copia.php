...
<tr>
  <td width="28%" align="left" valign="top"><?php
		...
		?>
    <img src="../../imagenes/<?php echo $SistemaLogo;?>" width="110" height="29" />
    <?php
		}else{
		?>
    <img src="../../imagenes/logotipo.png" width="110" height="29" />
    <?php	
		}
		?></td>
...
<tr>
    ...
    <td width="37%" valign="top"><div class="EstFichaIngresoImprimirCapa">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstFichaIngresoImprimirTabla">
        <tbody class="EstFichaIngresoImprimirTablaBody">
          <tr>
            <td width="46%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo" ><span class="EstFichaIngresoImprimirEtiqueta">No. O/T:</span></td>
          ...
          <tr>
            <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo"><span class="EstFichaIngresoImprimirEtiqueta">Fecha O/T:</span></td>
            <td align="left" valign="top" ><span class="EstFichaIngresoImprimirEtiqueta">:</span></td>
          ...
          <tr>
            <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo" ><span class="EstFichaIngresoImprimirEtiqueta">RECEPCION O/T:</span></td>
            <td align="left" valign="top" ><span class="EstFichaIngresoImprimirEtiqueta">:</span></td>
            <td align="left" valign="top" >
...
<tr>
  <td colspan="6" valign="top"><div class="EstFichaIngresoImprimirCapa">
    <table width="100%" height="63" border="0" cellpadding="3" cellspacing="2" class="EstFichaIngresoImprimirTabla">
      <tbody class="EstFichaIngresoImprimirTablaBody">
        <tr>
          <td width="24%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">
          
          <span class="EstFichaIngresoImprimirEtiqueta">Observacion/Recepcion:</span></td>
          <td width="76%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo"><?php echo $InsFichaIngreso->FinObservacion;?></td>
        </tr>
        <tr>
          <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo"><span class="EstFichaIngresoImprimirEtiqueta">
          Observacion/Trabajo Terminado:</span></td>
          <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo"><?php echo $InsFichaIngreso->FinSalidaObservacion;?></td>
        </tr>
      </tbody>
    </table>
  </div></td>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="2" class="EstFichaIngresoImprimirTabla">
      <tbody class="EstFichaIngresoImprimirTablaBody">
        <tr>
          ...
          <td width="25%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo"><span class="EstFichaIngresoImprimirEtiqueta">Firma de conformidad del cliente</span></td>
          </tr>
        <tr>
        ...
        <tr>
          <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">
          <span class="EstFichaIngresoImprimirEtiqueta">Firma de mecanico asignado:</span></td>
          <td align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">&nbsp;</td>
          </tr>
        <tr>
          <td height="30" align="left" valign="top" >&nbsp;</td>
...
<tr>
  <td colspan="6" valign="top"><div class="EstFichaIngresoImprimirCapa">
   ...
   <table width="100%" border="0" cellpadding="3" cellspacing="2" class="EstFichaIngresoImprimirTabla">
      <tbody class="EstFichaIngresoImprimirTablaBody">
        <tr>
          <td width="76%" align="left" valign="top" class="EstFichaIngresoImprimirEtiquetaFondo">
          
		    Para una mejor atencion comuniquese con nosotros para separa su cita. Diego: 950312564 / Jose Luis 950309755
