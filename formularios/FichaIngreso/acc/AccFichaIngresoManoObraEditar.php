...
$InsFichaIngresoManoObra1 = array();
$InsFichaIngresoManoObra1 = $_SESSION['InsFichaIngresoManoObra'.$ModalidadIngreso.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);

$_SESSION['InsFichaIngresoManoObra'.$ModalidadIngreso.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsFichaIngresoManoObra1->Parametro1,
NULL,
$POST_ManoObraDescripcion,
$POST_ManoObraImporte,
NULL,
NULL,
$InsFichaIngresoManoObra1->Parametro7,
date("d/m/Y H:i:s")
);
?>