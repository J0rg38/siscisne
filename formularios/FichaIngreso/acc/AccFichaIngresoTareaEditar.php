...
$InsFichaIngresoTarea1 = $_SESSION['InsFichaIngresoTarea'.$ModalidadIngreso.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);

$_SESSION['InsFichaIngresoTarea'.$ModalidadIngreso.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsFichaIngresoTarea1->Parametro1,
NULL,
(stripslashes($_POST['TareaDescripcion'])),
NULL,
NULL,
$_POST['TareaAccion'],
$InsFichaIngresoTarea1->Parametro7,
date("d/m/Y H:i:s")
);
?>