...
<tr>
  ...
  <td width="54%" align="center" valign="top"><span class="EstReporteTitulo">SEGUIMIENTO DE ORDENES DE TRABAJO C/ COTIZACIO
...
?>
          ...
          <td class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>" align="right" ><?php echo $DatFichaIngresoCotizacionProductoSeguimiento->FinId;  ?></td>
