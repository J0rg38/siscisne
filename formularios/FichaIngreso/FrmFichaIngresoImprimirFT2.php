        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstFichaIngresoImprimirTabla">
          <tbody class="EstFichaIngresoImprimirTablaBody">
            ...
            <tr>
              ...
              <td width="18%" align="left" valign="top"><span class="EstFichaIngresoImprimirContenido"><?php echo $InsFichaIngreso->FinFechaEntrega;?></span></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstFichaIngresoImprimirTabla">
        <tbody class="EstFichaIngresoImprimirTablaBody">
          ...
          <tr>
            ...
            <span class="EstFichaIngresoImprimirContenido"><?php echo $InsFichaIngreso->FinTiempoTrabajoTerminado;?></span>
