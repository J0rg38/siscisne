...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO REVISADAS</span>  </td>
</tr>
<tr>
  <td width="47%">
...
?>             
<input indice="<?php echo $f;?>"   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FinId; ?>" estado="<?php echo $dat->FinEstado;?>" />				    
<?php
//}
?>	
                ...
                <td align="right" valign="middle" width="5%"   ><?php echo $dat->FinId;  ?></td>
                ...
                <td  width="14%" align="right" ><?php echo ($dat->CliNombre);?></td>
                <td  width="5%" align="right" ><?php echo ($dat->EinVIN);?></td>
                <td  width="15%" align="right" ><?php echo ($dat->FinConductor);?></td>
                <td  width="5%" align="right" ><?php echo ($dat->FinVehiculoKilometraje);?></td>
                <td  width="18%" align="right" ><?php echo ($dat->PerNombre);?> <?php echo ($dat->PerApellidoPaterno);?> <?php echo ($dat->PerApellidoMaterno);?></td>
...
if($PrivilegioEditar){
?>		                
	<a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->FinId;?>"><img src="imagenes/ver.gif" width="19" height="19" border="0" title="Revisar Ord. Trabaj. Terminado" alt="[Revisar Ord. Trabaj. Terminado]"   /></a>                
<?php
}
?>       
                </td>
