                    ...
                    <div class="EstFormularioArea">
                      <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><input name="CmpVehiculoKilometraje" type="text" class="EstFormularioCaja" id="CmpVehiculoKilometraje" value="<?php if (empty($InsFichaIngreso->FinVehiculoKilometraje)) {
                                                                                                                                                                        echo "0.00";
                                                                                                                                                                      } else {
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td><input name="CmpOrdenVentaVehiculoMantenimientoId" type="hidden" id="CmpOrdenVentaVehiculoMantenimientoId" value="<?php echo $InsFichaIngreso->OvmId; ?>" size="20" maxlength="50" />
                                  Mant./
                                  <input name="CmpObsequioNombre2" type="text" class="EstFormularioCajaDeshabilitada" id="CmpObsequioNombre2" value="<?php echo $InsFichaIngreso->OvmKilometraje; ?>" size="40" maxlength="500" readonly="readonly" />
                                </td>
                                <td>&nbsp;</td>
                              </tr>
                            </table>
