...
?>
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccFichaIngresoTrabajar.php');
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td colspan="2">
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpVehiculoIngresoClienteId" type="hidden" id="CmpVehiculoIngresoClienteId" value="<?php echo $InsFichaIngreso->CliId; ?>" size="3" /></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td colspan="5" align="left" valign="top">
                              <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  ...
                                  <td><a href="javascript:FncCampanaVehiculoVerificar();"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                            ...
                            <td colspan="5" align="left" valign="top">
                              <table border="0" cellpadding="2" cellspacing="0">
                                <tr>
                                  ...
                                  <td><a href="javascript:FncVehiculoPromocionVerificar();"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  <td>
                                    <div id="CapVehiculoPromocionResumen"></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
           ...
           -->
                                    <a id="BtnAvisoCargarFormulario" href="#">Agregar Nota</a> | <a id="BtnAvisoCargarListado" href="#">Ver Nota</a>
                                  </td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              ...
                              <input name="CmpFechaGarantia" type="hidden" id="CmpFechaGarantia" value="<?php echo $InsFichaIngreso->FinFechaGarantia; ?>" size="15" maxlength="10" readonly="readonly" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpHora" type="text" class="EstFormularioCajaDeshabilitada" id="CmpHora" value="<?php if (empty($InsFichaIngreso->FinHora)) {
                                                                                                                                                          echo date("H:i");
                                                                                                                                                        } else {
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span id="sprytextfield4">
                              ...
                              <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFechaEntrega" name="BtnFechaEntrega" width="25" height="25" align="absmiddle" style="cursor:pointer;" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span id="sprytextfield3">
                              ...
                              <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFechaCita" name="BtnFechaCita" width="25" height="25" align="absmiddle" style="cursor:pointer;" />
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">Referencia: <br />
                              <span class="EstFormularioSubEtiqueta">(Numero de O.T. de la hoja en fisico)</span>
                            </td>
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="right" valign="top"><a href="javascript:FncClienteSimpleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                            ...
                            <td align="left" valign="top">Cliente:
                              <input class="EstFormularioCaja" name="CmpClienteNombre" type="hidden" id="CmpClienteNombre" value="<?php echo $InsFichaIngreso->CliNombre; ?>" size="45" maxlength="255" />
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">&nbsp;</td>
                            <td colspan="4" rowspan="4" align="right" valign="top">
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td>1</td>
                                  <td>&nbsp;</td>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    ...
                                    <td width="49%" align="right"><a href="javascript:FncFichaIngresoProductoListar('<?php echo $DatModalidadIngreso->MinSigla; ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncFichaIngresoProductoEliminarTodo('<?php echo $DatModalidadIngreso->MinSigla; ?>');"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a></td>
                                    <td width="1%">
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            <td align="left" valign="top"><input <?php echo ($FichaIngresoModalidadObsequio == 1) ? 'checked="checked"' : ''; ?> type="checkbox" name="CmpFichaIngresoModalidadObsequio_<?php echo $DatModalidadIngreso->MinSigla; ?>" id="CmpFichaIngresoModalidadObsequio_<?php echo $DatModalidadIngreso->MinSigla; ?>" value="1" />
                              <span class="EstFormularioResaltar"> Este SERVICIO es GRATUITO </span>
                            </td>
                          </tr>
                          <tr>
                            <td align="left" valign="top">
