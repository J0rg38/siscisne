    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="98%" height="25">
          ...
          <span class="EstFormularioTitulo">SEGUIMIENTO DE ORD. TRABAJO C/ COTIZACION NO PEDIDO</span>
        </td>
