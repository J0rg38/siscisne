...
?>
  ...
  <a class="EstSesionObjetosItem" href="javascript:FncFichaIngresoSuministroEscoger('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
...
if($_POST['Eliminar']==1){
?>
  <a href="javascript:FncFichaIngresoSuministroEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');" >
