...
?>
  ...
  <?php $PrivilegioRapido = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'], $GET_mod, "Rapido")) ? true : false; ?>


  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsFichaIngreso.js"></script>
 ...
 */
  ...
  if ($_POST) {
    ...
    $POST_num = (isset($_SESSION[$GET_mod . "Num"]) ? $_SESSION[$GET_mod . "Num"] : '');
  }
...
*/
  ...
  if ($_POST) {
    ...
    $POST_Asesor = (empty($_GET['CmpAsesor']) ? (isset($_SESSION[$GET_mod . "CmpAsesor"]) ? $_SESSION[$GET_mod . "CmpAsesor"] : '') : $_GET['CmpAsesor']);
  }
...
*/
  ...
  $ResPersonal = $InsPersonal->MtdObtenerPersonales(NULL, NULL, NULL, "PerNombre", "ASC", NULL, NULL, 1, NULL, NULL, 1, NULL, NULL, $POST_Sucursal, NULL, NULL, true);
...
<?php
      ...
      ?>
        ...
        <div class="EstSubMenuBoton"><a href="javascript:FncEnviarOrdenTrabajoAnularSeleccionados();"><img src="imagenes/submenu/anulado.png" alt="[Enviar OT a Anular]" title="Enviar OT a Anular" /> Anular</a></div>
        ...
        ?>
          ...
          <!--<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoAlmacenSeleccionados('1');"><img src="imagenes/submenu/enviar_almacen_rapido.png" alt="[Enviar OT a Almacen]" title="Enviar OT a Almacen" /> Almacen Rapido</a></div>
-->
        <?php
        }
        ?>

        <div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTrabajoTerminadoSeleccionados('');"><img src="imagenes/submenu/trabajo_terminado.png" alt="[Enviar OT Trabajo Terminado]" title="Enviar OT Trabajo Terminado" /> Terminado</a></div>

        <?php
        if ($PrivilegioRapido) {
        ?>

          <!--<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTrabajoTerminadoSeleccionados('1');"><img src="imagenes/submenu/trabajo_terminado_rapido.png" alt="[Enviar OT Trabajo Terminado]" title="Enviar OT Trabajo Terminado" /> Terminado Rapido</a></div>
-->
    ...
    <div class="EstCapContenido">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="25" valign="top">
            ...
            <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO [ RECEPCION]</span>
          </td>
      ...
      <option value="fin.FinId" <?php if ($POST_cam == "fin.FinId") {
                                  echo 'selected="selected"';
                                } ?>>Id</option>
      <option value="EinVIN" <?php if ($POST_cam == "EinVIN") {
                                echo 'selected="selected"';
                              } ?>>VIN de Vehiculo</option>
      <option value="CliNombre" <?php if ($POST_cam == "CliNombre") {
                                  echo 'selected="selected"';
                                } ?>>Nombre del Cliente</option>
      <option value="CliNumeroDocumento" <?php if ($POST_cam == "CliNumeroDocumento") {
                                            echo 'selected="selected"';
                                          } ?>>Num. Doc. del Cliente</option>
      <option value="FinConductor" <?php if ($POST_cam == "FinConductor") {
                                      echo 'selected="selected"';
                                    } ?>>Nombre del Conductor</option>
s      </select>-->
            <!--    Estado
    <select class="EstFormularioCombo" name="Estado" id="Estado">
      <option value="" >Todos</option>
      <option value="1" <?php if ($POST_estado == 1) {
                          echo 'selected="selected"';
                        } ?>>Pendiente</option>
      <option value="2" <?php if ($POST_estado == 2) {
                          echo 'selected="selected"';
                        } ?>>En Proceso</option>
      <option value="3" <?php if ($POST_estado == 3) {
                          echo 'selected="selected"';
                        } ?>>Realizado</option>  
      </select>
      -->
            ...
            <select class="EstFormularioCombo" name="ConCampana" id="ConCampana">
              <option value="">Todos</option>
              <option <?php if ($POST_ConCampana == 1) {
                        echo 'selected="selected"';
                      } ?> value="1">Con Campaña</option>
              <option <?php if ($POST_ConCampana == 2) {
                        echo 'selected="selected"';
                      } ?> value="2">Sin Campaña</option>
            </select>

            Prioridad:
            <select class="EstFormularioCombo" name="Prioridad" id="Prioridad">
              <option value="">Todos</option>
              <option <?php if ($POST_estado == 1) {
                        echo 'selected="selected"';
                      } ?> value="1">Urgente</option>
              <option <?php if ($POST_estado == 2) {
                        echo 'selected="selected"';
                      } ?> value="2">Normal</option>
            </select>
            ...
            <select class="EstFormularioCombo" name="CmpAsesor" id="CmpAsesor">
              ...
              ?>
                <option <?php echo ($DatAsesor->PerId == $POST_Asesor) ? 'selected="selected"' : ''; ?> value="<?php echo $DatAsesor->PerId; ?>"><?php echo $DatAsesor->PerNombre ?> <?php echo $DatAsesor->PerApellidoPaterno; ?> <?php echo $DatAsesor->PerApellidoMaterno; ?></option>
              <?php
              }
              ?>
            </select>
            ...
            <span class="EstFormularioContenido">
              <select <?php echo ((!$PrivilegioMultisucursal) ? 'disabled="disabled"' : ''); ?> class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
                ...
                ?>
                  <option value="<?php echo $DatSucursal->SucId ?>" <?php if ($POST_Sucursal == $DatSucursal->SucId) {
                                                                      echo 'selected="selected"';
                ...
                <tr>
                  ...
                  <td colspan="14" align="center">
                    ...
                    <select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
                      ...
                      <option <?php if ($POST_num == $FichaIngresosTotal) {
                                echo 'selected="selected"';
                              } ?> value="<?php echo $FichaIngresosTotal; ?>">Todos</option>
                    </select>
              ...
              <tbody class="EstTablaListadoBody">
                ...
                ?>
                  ...
                  <tr id="Fila_<?php echo $f; ?>">
                    ...
                    <td width="2%" align="center" bgcolor="<?php echo $Color; ?>">
                      ...
                      <input indice="<?php echo $f; ?>" onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FinId; ?>" estado="<?php echo $dat->FinEstado; ?>" personal="<?php echo $dat->PerId ?>" />
                    </td>
                    <td align="right" valign="middle" width="2%" bgcolor="<?php echo $Color; ?>"><?php
                ...
                <?php 
                            ...
                            ?>
                              ...
                              ?>
                                <a target="<?php echo (!empty($dat->ObsArchivo) ? '_blank' . $dat->ObsArchivo : ''); ?>" href="<?php echo (!empty($dat->ObsArchivo) ? 'subidos/obsequio_archivos/' . $dat->ObsArchivo : '#'); ?>">
                                  <img src="imagenes/avisos/promocion.png" alt="Promocion" title="Vehiculo con promocion" border="0" width="25" height="25" /></a>
                              <?php
                              }
                              ?>
                        ...
                        <tr>
                          <td><?php
                            ...
                            ?>
                            <div class="<?php echo $clase ?>"> <?php echo number_format($porcentaje, 2); ?> % </div>
                          </td>
                        </tr>
                      </table>
                    ...
                    <td width="3%" align="right"><?php echo ($dat->FinFechaGarantia); ?>
                      ...
                      <?php } ?></td>
                    <td width="3%" align="left" valign="top" bgcolor="<?php echo $Color; ?>">


                      <table cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" valign="top"> <span class="EstTablaListadoEtiqueta">NOMBRE:</span></td>
                          <td align="left" valign="top">
                            <span class="EstTablaListadoContenido"><?php
                                                                    if ($PrivilegioClienteEditar or $PrivilegioClienteVer) {
                                                                    ?>

                                <a href="javascript:FncClienteSimpleCargarFormulario('<?php echo (($PrivilegioClienteEditar) ? 'Editar' : 'Ver'); ?>','<?php echo $dat->CliId ?>');"><?php echo ($dat->CliNombre); ?> <?php echo ($dat->CliApellidoPaterno); ?> <?php echo ($dat->CliApellidoMaterno); ?></a>
                        ...
                        <tr>
                          <td colspan="2" align="left" valign="top" bgcolor="<?php echo $Color; ?>">
                            ...
                            ?> <span class="EstTablaListadoEtiqueta"> OTROS PROPIETARIOS:</span>
                              <br />
                              <?php
                    ...
                    <td width="3%" align="left" valign="top" bgcolor="<?php echo $Color; ?>">
                      ...
                      <table cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">CONCESIONARIO:</span></td>
                          <td colspan="3" align="left" valign="top"><span class="EstTablaListadoContenido"><?php echo ($dat->OncNombre); ?></span></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">VIN: </span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoContenido">
                              <?php
                          ...
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">MARCA:</span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoContenido"><?php echo ($dat->VmaNombre); ?></span></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">MODELO:</span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoContenido"><?php echo ($dat->VmoNombre); ?></span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">VERSION:</span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoContenido"><?php echo ($dat->VveNombre); ?></span></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">COLOR:</span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoContenido"><?php echo ($dat->EinColor); ?></span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">PLACA:</span></td>
                          <td align="left" valign="top"><span class="EstTablaListadoContenido"><?php echo ($dat->EinPlaca); ?></span></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">KILOM.:</span></td>
                          <td align="left" valign="top"><?php echo ($dat->FinVehiculoKilometraje); ?></td>
                          <td align="left" valign="top">MANT.:</td>
                          <td align="left" valign="top">

                            <?php echo ($dat->FinMantenimientoKilometraje); ?>


                          </td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><span class="EstTablaListadoEtiqueta">TECNICO.:</span></td>
                          <td colspan="3" align="left" valign="top">
                            <div id="CapFichaIngresoPersonal_<?php echo $dat->FinId; ?>">
                              <?php echo ($dat->PerNombre); ?> <?php echo ($dat->PerApellidoPaterno); ?>
