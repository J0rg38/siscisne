...
if($_POST){
   $_SESSION[$GET_mod."CmpAsesor"] = $POST_Asesor;
	...
	$POST_Asesor = (empty($_GET['CmpAsesor'])?$_SESSION[$GET_mod."CmpAsesor"]:$_GET['CmpAsesor']);
}
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO [  RECEPCION]</span>  </td>
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <input indice="<?php echo $f;?>"   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FinId; ?>" estado="<?php echo $dat->FinEstado;?>" personal="<?php echo $dat->PerId?>" />				</td>
...
?>
                    ...
                    <tr>
                      ...
                      <td colspan="3" align="left" valign="top"><div id="CapFichaIngresoPersonal_<?php echo $dat->FinId;?>" >
