...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCotizacionRegistrar.php');
...
/*if($Guardar==false){
?>
	var ProveedorId = "<?php echo $InsOrdenCotizacion->PrvId?>";
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">
                        <span class="EstFormularioSubTitulo">Datos de Cotizacion 
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td>
                              ...
                              <input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncOrdenCotizacionDetalleListar();" value="<?php if (empty($InsOrdenCotizacion->OotTipoCambio)){ echo "";}else{ echo $InsOrdenCotizacion->OotTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" />                      </td>
...
?>
                      ...
                      <td align="left" valign="top"><input name="CmpPorcentajeImpuestoVenta" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPorcentajeImpuestoVenta"  value="<?php echo $InsOrdenCotizacion->OotPorcentajeImpuestoVenta;?>" size="10" maxlength="10" readonly="readonly" /></td>
                      <td align="left" valign="top">&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      <td width="98%">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="12"><span class="EstFormularioSubTitulo">
...
<input type="hidden" name="CmpOrdenCotizacionDetalleId"  class="EstFormularioCaja" id="CmpOrdenCotizacionDetalleId"  />
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="javascript:FncOrdenCotizacionDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                            ...
                            <td>&nbsp;</td>
                            <td colspan="11"><input type="checkbox" name="CmpOrdenCotizacionDetalleEstatico" id="CmpOrdenCotizacionDetalleEstatico" value="1" />  Mantener estatico A&ntilde;o y Modelo</td>
                            <td>&nbsp;</td>
                          </tr>
                          </table>                      
                          </td>
              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <td width="49%" align="right"><a href="javascript:FncOrdenCotizacionDetalleListar();">
...
Calendar.setup({ 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnFechaRespuesta"// el id del bot�n que  
	});
</script>
