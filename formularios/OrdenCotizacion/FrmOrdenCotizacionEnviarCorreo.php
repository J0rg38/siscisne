...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCotizacionEnviarCorreo.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ENVIAR SOLICITUD DE COTIZACION POR CORREO ELECTRONICO</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<div class="EstFormularioArea">
          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
            ...
            <td align="left" valign="top"><textarea name="CmpDestinatario" cols="100" class="EstFormularioCaja" id="CmpDestinatario"><?php echo $InsOrdenCotizacion->OotDestinatarios;?></textarea></td>
		      <td>&nbsp;</td>
		      </tr>
		    <tr>
		      <td>&nbsp;</td>
