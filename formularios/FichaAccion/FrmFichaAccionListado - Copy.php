...
?>		
                ...
                <td  width="3%" align="right" bgcolor="<?php echo $Color;?>" ><?php echo number_format($dat->FinVehiculoKilometraje);?></td>
...
//if($PrivilegioEditar and ($dat->FinEstado==4 or $dat->FinEstado==5 or $dat->FinEstado==6 or $dat->FinEstado == 72 or $dat->FinEstado==71 or $dat->FinEstado==7 or $dat->FinEstado == 73 or $dat->FinEstado == 74 or $dat->FinEstado == 75  or $dat->FinEstado == 9   or $dat->FinEstado == 10)){
	...
	and (
	$dat->FinEstado==4 or $dat->FinEstado==5 or $dat->FinEstado==6 or $dat->FinEstado == 72 or $dat->FinEstado==71 or $dat->FinEstado==7 or $dat->FinEstado == 73 or $dat->FinEstado == 73 or $dat->FinEstado == 74 or $dat->FinEstado == 75 or $dat->FinEstado == 9
