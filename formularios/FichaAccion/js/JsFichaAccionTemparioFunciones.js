...
function FncFichaAccionTemparioNuevo(oModalidadIngreso){
	...
	$('#CmpFichaAccion'+oModalidadIngreso+'TemparioAccion').val("AccFichaAccionTemparioRegistrar.php");
...
function FncFichaAccionTemparioListar(oModalidadIngreso){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/FichaAccion/FrmFichaAccionTemparioListado.php',
...
function FncFichaAccionTemparioEscoger(oItem,oModalidadIngreso){
	...
	$('#CmpFichaAccion'+oModalidadIngreso+'TemparioAccion').val("AccFichaAccionTemparioEditar.php");
	
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/FichaAccion/acc/AccFichaAccionTemparioEscoger.php',
...
function FncFichaAccionTemparioEliminar(oItem,oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/FichaAccion/acc/AccFichaAccionTemparioEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem+'&ModalidadIngreso='+oModalidadIngreso,
			success: function(){
...
function FncFichaAccionTemparioEliminarTodo(oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/FichaAccion/acc/AccFichaAccionTemparioEliminarTodo.php',
