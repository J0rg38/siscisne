...
function FncFichaAccionFotoListar(oModalidadIngreso){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/FichaAccion/FrmFichaAccionFotoListado.php',
...
function FncFichaAccionFotoEliminar(oItem,oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/FichaAccion/acc/AccFichaAccionFotoEliminar.php',
...
function FncFichaAccionFotoEliminarTodo(oModalidadIngreso){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/FichaAccion/acc/AccFichaAccionFotoEliminarTodo.php',
