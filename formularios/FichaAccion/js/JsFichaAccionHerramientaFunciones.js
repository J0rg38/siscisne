...
function FncFichaAccionHerramientaNuevo(){
	...
	$('#CmpFichaAccionHerramientaAccion').val("AccFichaAccionHerramientaRegistrar.php");
...
function FncFichaAccionHerramientaListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/FichaAccion/FrmFichaAccionHerramientaListado.php',
...
function FncFichaAccionHerramientaListar2(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/FichaAccion/FrmFichaAccionHerramientaListado2.php',
...
function FncFichaAccionHerramientaEscoger(oItem){
	...
	$('#CmpFichaAccionHerramientaAccion').val("AccFichaAccionHerramientaEditar.php");
	
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/FichaAccion/acc/AccFichaAccionHerramientaEscoger.php',
...
function FncFichaAccionHerramientaEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/FichaAccion/acc/AccFichaAccionHerramientaEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem,
			success: function(){
...
function FncFichaAccionHerramientaEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/FichaAccion/acc/AccFichaAccionHerramientaEliminarTodo.php',
