...
$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos("fin.FinId,EinVIN,EinPlaca,CliNombre,CliApellidoPaterno,CliApellidoMaterno,FinConductor,VmaNombre,VmoNombre,VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"11,2,3,4,5,6,7,71,72,73,74,75,8,9",$POST_Prioridad,$POST_Modalidad,NULL,NULL,$_SESSION['SesionPersonal']);
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "FinTiempoCreacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinTiempoCreacion','ASC');"> Fec. Registro <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinTiempoCreacion','DESC');"> Fec. Registro <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "FinEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinEstado','ASC');">Est. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinEstado','DESC');"> Est. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
...
<span class="EstTablaListadoCodigo">
                ...
                <td  width="4%" align="right" ><?php echo $dat->FinHora;  ?></td>
                <td  width="6%" align="right" ><?php echo ($dat->CliNombre);?></td>
                ...
                <td  width="8%" align="center" ><?php echo ($dat->FinTiempoCreacion);?></td>
...
<?php
if($PrivilegioEditar and ($dat->FinEstado==4 || $dat->FinEstado==5 || $dat->FinEstado==6)){
?>             
...
<?php
if($PrivilegioEditar and ($dat->FinEstado==2 or $dat->FinEstado==3)){
//if($PrivilegioEditar and ($dat->FinEstado==2 or $dat->FinEstado==3 or $dat->FinEstado==71 or $dat->FinEstado==7)){
?>             
...
<tr>
  <td align="left" valign="middle" class="Etiqueta">LEYENDA: </td>
