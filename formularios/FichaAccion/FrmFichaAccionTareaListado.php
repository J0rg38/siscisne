...
if (!isset($_SESSION['InsFichaAccionTarea' . $ModalidadIngreso . $Identificador])) {
  ...
  $_SESSION['InsFichaAccionTarea' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsFichaAccionTarea' . $ModalidadIngreso . $Identificador]);
}
    ...
    ?>
      ...
      <table class="EstTablaListado" width="100%" cellpadding="0" cellspacing="0" border="0">
        <thead class="EstTablaListadoHead">
          <tr>
            <th width="2%" align="center">#</th>
            <th width="75%" align="center"> Descripcion
            </th>
