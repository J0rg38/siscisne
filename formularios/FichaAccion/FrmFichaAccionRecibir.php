...
if( $InsFichaIngreso->FinEstado==7 or $InsFichaIngreso->FinEstado==71){
	
	include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccFichaAccionRecibir.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">RECIBIR PEDIDO</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<!--<input style="visibility:hidden;" etiqueta="modalidad" checked="checked"  type="checkbox" value="<?php echo $DatFichaAccion->MinId?>" name="CmpModalidadId_<?php echo $DatFichaAccion->MinSigla?>" id="CmpModalidadId_<?php echo $DatFichaAccion->MinSigla?>" sigla="<?php echo $DatFichaAccion->MinSigla?>" />-->
                          ...
                          <tr>
                            <td width="33%" align="left" valign="top"><div class="EstFormularioArea">
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td colspan="4" align="left" valign="top"><span class="EstFormularioSubTitulo">TAREAS que componen la SUB ORDEN DE TRABAJO</span>
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top"><a href="javascript:FncFichaAccionTareaEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');">
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top"><input name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>TareaDescripcion" type="text" class="EstFormularioCaja" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla?>TareaDescripcion" size="50" maxlength="200" /></td>
                            ...
                            <td align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="48%" align="right" valign="top"><a href="javascript:FncFichaAccionTareaListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a></td>
                            ...
                            <td align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="46%" align="right"><a href="javascript:FncFichaAccionProductoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a></td>
                              ...
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="50%"><div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla?>SuministroAccion">Listo
                                    para registrar elementos </div></td>
                                  <td width="47%" align="right"><a href="javascript:FncFichaAccionSuministroListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/></a></td>
					...
					<div class="EstFormularioArea" >
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td>&nbsp;</td>
                            <td width="18%">Kilometraje/Plan Mant.:</td>
                            <td width="30%"><?php
