...
<tr>
  ...
  <th width="38%" align="center"> Codigo
</th>
...
<th width="22%" align="center"> Acc.</th>
</tr>
</thead>
...
<td align="right"><?php echo $DatSesionObjeto->Parametro4;?> hrs</td>
<td align="center">
...
?>
  ...
  <a class="EstSesionObjetosItem" href="javascript:FncFichaAccionTemparioEscoger('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
...
if($_POST['Eliminar']==1){
?>
  <a href="javascript:FncFichaAccionTemparioEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');" >
