                  ...
                  ?>
                    ...
                    ?>
                      <tr>
                        ...
                        <td align="center">
                          <a id="BtnEstablecerAccion_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" href="javascript:void(0);" accion="<?php echo $PlanMantenimientoDetalleAccion; ?>">
...
*/
                              ...
                              <?php
                              //   $PlanMantenimientoDetalleAccion = "X";
                              switch ($PlanMantenimientoDetalleAccion) {
                              ...
                              <!-- <a id="BtnEstablecerAccionNinguna_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" href="javascript:void(0);" accion="X">
    [X]
    </a>-->
                            ...
                            <td align="right">
                              ...
                              <!--<input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>ProductoCodigoOriginal" type="text" class="<?php echo (($FichaAccionMantenimientoAccion <> "C" and $FichaAccionMantenimientoAccion <> "U") or $POST_Editar == 2) ? 'EstFormularioCajaDeshabilitada' : 'EstFormularioCaja' ?>"   <?php echo (($FichaAccionMantenimientoAccion <> "C" and $FichaAccionMantenimientoAccion <> "U") or $POST_Editar == 2) ? 'readonly="readonly"' : ''; ?> id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>ProductoCodigoOriginal" size="10" maxlength="20"  value="<?php echo $ProductoCodigoOriginal; ?>"    />-->


                              <input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>ProductoCodigoOriginal" type="text" class="<?php echo (($PlanMantenimientoDetalleAccion <> "C" and $PlanMantenimientoDetalleAccion <> "U") or $POST_Editar == 2 or ($FichaAccionProductoVerificar2 == 2 and !empty($FichaAccionProductoVerificar2))) ? 'EstFormularioCajaDeshabilitada' : 'EstFormularioCaja' ?>" <?php echo (($FichaAccionMantenimientoAccion <> "C" and $FichaAccionMantenimientoAccion <> "U") or $POST_Editar == 2) ? 'readonly="readonly"' : ''; ?> id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>ProductoCodigoOriginal" size="10" maxlength="20" value="<?php echo $ProductoCodigoOriginal; ?>" />


                            </td>
                            <td align="right">

                              <input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>ProductoNombre" type="text" class="<?php echo (($PlanMantenimientoDetalleAccion <> "C" and $PlanMantenimientoDetalleAccion <> "U") or $POST_Editar == 2 or ($FichaAccionProductoVerificar2 == 2 and !empty($FichaAccionProductoVerificar2))) ? 'EstFormularioCajaDeshabilitada' : 'EstFormularioCaja' ?>" <?php echo (($PlanMantenimientoDetalleAccion <> "C" and $PlanMantenimientoDetalleAccion <> "U") or $POST_Editar == 2 or ($FichaAccionProductoVerificar2 == 2 and !empty($FichaAccionProductoVerificar2))) ? 'readonly="readonly"' : ''; ?> id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>ProductoNombre" size="30" value="<?php echo $ProductoNombre; ?>" />
                            ...
                            <td align="left">
                              ...
                              <input style="visibility:hidden;" title="<?php echo $FichaAccionProductoId; ?>" type="checkbox" <?php echo ($PlanMantenimientoDetalleVerificar1 == 1) ? 'checked="checked"' : ''; ?> name="CmpPlanMantenimientoDetalleVerificar1_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" id="CmpPlanMantenimientoDetalleVerificar1_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" value="1" <?php //echo ($PlanMantenimientoDetalleAccion=="X" )?'disabled="disabled"':'';
                                                                                                                                                                                                                                                                                                                                                                                                                        ?> <?php echo ($POST_RecibirEditar == "2") ? 'disabled="disabled"' : ''; ?> />
...
*/
                              if (!empty($ArrSesionObjetos)) {
                                foreach ($ArrSesionObjetos as $DatSesionObjeto) {
                                  ...
                                  //deb($DatSesionObjeto->Parametro3."  /  ". $DatPlanMantenimientoTarea->PmtId);
