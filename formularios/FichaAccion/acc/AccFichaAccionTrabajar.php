	...
	//					deb("bbbb");
		...
		//					deb("lol");
							if($InsFichaAccion->MtdTrabajarFichaAccion()){
								...
								if($InsFichaAccion->MinSigla == "MA" and !empty($_POST['CmpFichaIngresoTiempoTrabajoConcluido'])){
									
//									$InsFichaAccion->MtdNotificarFichaAccionMantenimiento($InsFichaAccion->FccId,$PersonalEmail.",aliendo@cyc.com.pe,jblanco@cyc.com.pe");								
								...
								if( !empty($InsFichaAccion->FccPedido) ){
									...
									//	if($InsFichaAccion->MinSigla == "SI"){
//											
//											$PersonalEmail .= "iquezada@cyc.com.pe,";
//											
//										}
								...
								//$Resultado.='#'.strtoupper($InsFichaAccion->MinNombre);
...
//		Parametro8 = FaeTiempoModificacion	
				...
				//deb($InsFichaAccion->FichaAccionTempario);
				if(!empty($InsFichaAccion->FichaAccionTempario)){
					foreach($InsFichaAccion->FichaAccionTempario as $DatFichaAccionTempario){
