...
?>
  ...
  $InsSesionObjeto = new ClsSesionObjeto();
                ...
                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId" disabled="disabled">
                        ...
                        ?>
                          <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsFichaIngreso->MonId == $DatMoneda->MonId) {
                  ...
                  <?php
                  if ($InsFichaIngreso->FinEstado == "2" || $InsFichaIngreso->FinEstado == "3") {
                  ?>
                    <tr>
                      <td colspan="5" align="left" valign="top">
                        ...
                        <span class="EstFormularioResaltar">Enviar ORDEN DE TRABAJO a ALMACEN una vez guardado este formulario</span>


                      </td>
                      <td colspan="2" align="left" valign="top">Fecha y hora Inicio:</td>
                  ...
                  <tr>
                    <td colspan="5" align="left" valign="top"><input <?php echo (!empty($InsFichaIngreso->FinTiempoTallerConcluido) ? 'checked="checked"' : ''); ?> type="checkbox" name="CmpFichaIngresoTrabajoConcluido" id="CmpFichaIngresoTrabajoConcluido" value="1" />
                      <span class="EstFormularioResaltar">Marcar ORDEN DE TRABAJO como CONCLUIDO</span> <img src="imagenes/alerta.gif" alt="Revisar" title="Revisar" width="15" height="15" align="absmiddle" />
                    </td>
                    <td colspan="2" align="left" valign="top">Fecha y hora Fin:</td>
                    <td colspan="4" align="left" valign="top"><?php
                      ...
                      ?>
                      <input type="hidden" name="CmpFichaIngresoTiempoTrabajoConcluido" id="CmpFichaIngresoTiempoTrabajoConcluido" value="<?php echo $InsFichaIngreso->FinTiempoTallerConcluido; ?>" />
                    </td>
                  </tr>
                  <tr>
                    <td colspan="5" align="left" valign="top"><input <?php echo (!empty($InsFichaIngreso->FinTiempoTallerConcluido) ? 'checked="checked"' : ''); ?> type="checkbox" name="CmpFichaIngresoCorregido" id="CmpFichaIngresoCorregido" value="1" />
                      <span class="EstFormularioResaltar">Marcar ORDEN DE TRABAJO como CORREGIDO</span> <img src="imagenes/alerta.gif" alt="Revisar" title="Revisar" width="15" height="15" align="absmiddle" />
                    </td>
                    <td colspan="2" align="left" valign="top">Tiempo Trabajado:</td>
                    <td colspan="4" align="left" valign="top">
                                            ...
                                            <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                              ...
                                              <tr>
                                                ...
                                                <td align="left" valign="top"><a href="javascript:FncFichaAccionTemparioEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');">
                                                  ...
                                                  <input type="hidden" name="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla ?>TemparioId" id="Cmp<?php echo $DatFichaIngresoModalidad->MinSigla ?>TemparioId" />
                                                </td>
                                              ...
                                              <tr>
                                                ...
                                                <td width="49%" align="left" valign="top">
                                                  <div class="EstFormularioAccion" id="CapTemparioAccion">Listo
                                                    para registrar elementos<a href="javascript:FncFichaAccionTemparioEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"></a></div>
                                                </td>
                                                ...
                                                <td width="1%" align="left" valign="top">
                                                  <div id="CapFichaAccionTempariosResultado"> </div>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td align="left" valign="top">&nbsp;</td>
                                                <td colspan="2" align="left" valign="top">
                                                  <div id="CapFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla ?>Temparios" class="EstCapFichaAccionTemparios"> </div>
                                                </td>
                                                <td align="left" valign="top">&nbsp;</td>
                                              </tr>
                                            </table>
                                          ...
                                          <div class="EstFormularioArea">
                                            <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                              ...
                                              <tr>
                                                ...
                                                <td>Cantidad:</td>
                                                <td>
                                                  <div id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla ?>ProductoBuscar"></div>
                                                </td>
                                                <td>&nbsp;</td>
                                              </tr>
                                              <tr>
 							...
 							<?php
                                        ...
                                        <div class="EstFormularioArea">
                                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                            ...
                                            <tr>
                                              ...
                                              <td width="49%" align="left" valign="top">
                                                <div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla ?>TareaAccion2"> Listo
                                              ...
                                              <td width="1%" align="left" valign="top">
                                                <div id="CapFichaAccionTareasResultado2"> </div>
                                              </td>
                                            </tr>
                                            <?php
                                            /*
								...
								*/
                                            ...
                                            <tr>
                                              <td align="left" valign="top">&nbsp;</td>
                                              <td colspan="2" align="left" valign="top">
                                                <div id="CapFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla ?>Tareas" class="EstCapFichaAccionTareas"> </div>
                                              </td>
                                              <td align="left" valign="top">&nbsp;</td>
                                            </tr>
                                            <tr>
                                        ...
                                        <div class="EstFormularioArea">
                                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <div id="CapFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla ?>ProductosResultado"> </div>
                                              </td>
                                            </tr>
                                            ...
                                            <tr>
                                              <td>&nbsp;</td>
                                              <td colspan="2">
                                                <div id="CapFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla ?>Productos" class="EstCapFichaAccionProductos"></div>
                                              </td>
                                              <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                              ...
                                              <tr>
                                                ...
                                                <td align="left" valign="top">
                                                  ...
                                                  <textarea name="CmpFichaAccionSolucion_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" cols="60" rows="2" class="EstFormularioCaja" id="CmpFichaAccionSolucion_<?php echo $DatFichaIngresoModalidad->MinSigla ?>"><?php echo stripslashes($FichaAccionSolucion); ?></textarea>
                                                </td>
                                                <td align="left" valign="top">&nbsp;</td>
                                              </tr>
                                              <tr>
                                        ...
                                        <div class="EstFormularioArea">
                                          <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                            ...
                                            <tr>
                                              ...
                                              <td width="137" align="right" valign="top"><a href="javascript:FncFichaAccionFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                              <td align="left" valign="top">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td align="left" valign="top">&nbsp;</td>
                                                  ...
                                                  $(document).ready(function() {
                                                    $("#fileuploader<?php echo $DatFichaIngresoModalidad->MinSigla ?>").uploadFile({
                                                      ...
                                                      formData: {
                                                        ...
                                                        "ModalidadIngreso": "<?php echo $DatFichaIngresoModalidad->MinSigla; ?>"
                                                      },
                                                      multiple: true,
                                                      autoSubmit: true,
                                                      fileName: "Filedata",
                                            ...
                                            <tr>
                                              <td align="left" valign="top">&nbsp;</td>
                                              <td colspan="2" align="left" valign="top">
                                                <div class="EstCapFichaAccionFotos" id="CapFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla; ?>Fotos"></div>
                                              </td>
                                              <td align="left" valign="top">&nbsp;</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td colspan="3">
                                        <div id="CapFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla ?>Mantenimientos" class="EstCapFichaAccionMantenimientos"> </div>
                                      </td>
                                      <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td colspan="3"></td>
                                      <td>
                                        <div id="CapFichaAccion<?php echo $DatFichaIngresoModalidad->MinSigla ?>MantenimientosResultado"> </div>
                                      </td>
                                    </tr>
                                  </table>
                                </div>
                              ...
                              ?>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td width="33%" align="center"><span class="EstFormularioSubTitulo">SI - Tareas y Productos: <?php echo strtoupper($DatFichaIngresoModalidad->MinNombre); ?></span></td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="top">
                                        <div class="EstFormularioArea">
                                        ...
                                        <div class="EstFormularioArea">
                                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                            ...
                                            <tr>
                                              ...
                                              <td width="48%" align="right" valign="top"><a href="javascript:FncFichaAccionTareaListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncFichaAccionTareaEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a></td>
                                              <td align="left" valign="top">
                                                <div id="CapFichaAccionTareasResultado"> </div>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td align="left" valign="top">&nbsp;</td>
                                          ...
                                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                            ...
                                            <tr>
                                              ...
                                              <td width="47%" align="right">
                                                ...
                                                <a href="javascript:FncFichaAccionProductoListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncFichaAccionProductoEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a>
                              ...
                              ?>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td width="33%" align="center"><span class="EstFormularioSubTitulo">LI - Tareas y Productos: <?php echo strtoupper($DatFichaIngresoModalidad->MinNombre); ?></span></td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="top">
                                        <div class="EstFormularioArea">
                              ...
                              ?>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td width="33%" align="center"><span class="EstFormularioSubTitulo">PP - Tareas y Productos: <?php echo strtoupper($DatFichaIngresoModalidad->MinNombre); ?></span></td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="top">
                                        <div class="EstFormularioArea">
                        ...
                        <div class="EstFormularioArea">
                          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                            ...
                            <tr>
                              ...
                              <td>Cantidad:</td>
                              <td>
                                <div id="CapHerramientaBuscar"></div>
                              </td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                        ...
                        <div class="EstFormularioArea">
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              <td width="0%">&nbsp;</td>
                              <td width="50%">
                                <div class="EstFormularioAccion" id="CapHerramientaAccion">Listo
                              ...
                              <td width="1%">
                                <div id="CapFichaAccionHerramientasResultado"> </div>
                              </td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td colspan="2">
                                <div id="CapFichaAccionHerramientas" class="EstCapFichaAccionHerramientas"></div>
                              </td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                ...
                <div id="tab<?php echo $c; ?>" class="tab_content">
                  ...
                  <div class="EstFormularioArea">
                    ...
                    <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                      <tr>
                        <td>&nbsp;</td>
                        <td align="left" valign="top"><span class="EstFormularioSubTitulo">Observaciones de Taller</span></td>
                        <td align="left" valign="top">&nbsp;</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top">
                          ...
                          <textarea name="CmpObservacionSalidaInterna" cols="60" rows="2" class="EstFormularioCaja" id="CmpObservacionSalidaInterna"><?php echo stripslashes($InsFichaIngreso->FinSalidaObservacionInterna); ?></textarea>
                        </td>
                        <td align="left" valign="top">&nbsp;</td>
                      </tr>
                      <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    <tr>
                                      <td width="3%">&nbsp;</td>
                                      <td width="47%">
                                        <div class="EstFormularioAccion" id="CapFichaAccionHistorialAccion">Listo
                                          para registrar elementos</div>
                                      </td>
                                      ...
                                      <td width="1%">
                                        <div id="CapFichaAccionHistorialesResultado"> </div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td colspan="2">
                                        <div id="CapFichaAccionHistoriales" class="EstCapFichaAccionHistoriales"> </div>
                                      </td>
                                      <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    <tr>
                                      <td width="3%">&nbsp;</td>
                                      <td width="47%">
                                        <div class="EstFormularioAccion" id="CapFichaAccionCotizacionesAccion">Listo
                                          para registrar elementos</div>
                                      </td>
                                      ...
                                      <td width="1%">
                                        <div id="CapFichaAccionCotizacionesResultado"> </div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td colspan="2">
                                        <div id="CapFichaAccionCotizaciones" class="EstCapFichaAccionCotizaciones"> </div>
                                      </td>
                                      <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td align="right" valign="top"><a href="javascript:FncFichaAccionFotoVINListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      ...
                                      <td align="left" valign="top">
                                        <div class="EstCapFichaAccionFotoVINs" id="CapFichaAccionFotoVINs"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td align="right" valign="top"><a href="javascript:FncFichaAccionFotoDelanteraListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      ...
                                      <td align="left" valign="top">
                                        <div class="EstCapFichaAccionFotoDelanteras" id="CapFichaAccionFotoDelanteras"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left" valign="top">
                                        <div class="EstCapFichaAccionFotoCupones" id="CapFichaAccionFotoCupones"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left" valign="top">
                                        <div class="EstCapFichaAccionFotoMantenimientos" id="CapFichaAccionFotoMantenimientos"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                  ...
                                  <div class="EstFormularioArea">
                                    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                      <tr>
                                        <td width="3%">&nbsp;</td>
                                        <td width="47%">
                                          <div class="EstFormularioAccion" id="CapPreEntregaPDSDetallelAccion">Listo
                                            para registrar elementos</div>
                                        </td>
                                        ...
                                        <td width="1%">
                                          <div id="CapPreEntregaPDSDetallesResultado"> </div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>&nbsp;</td>
                                        <td colspan="2">
                                          <div id="CapPreEntregaPDSDetalles" class="EstCapPreEntregaPDSDetalles"> </div>
                                        </td>
                                        <td>&nbsp;</td>
                                      </tr>
                                    </table>
