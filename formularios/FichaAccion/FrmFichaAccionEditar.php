...
?>
        ...
        <tr>
          <td colspan="5" align="left" valign="top"><input <?php echo (!empty($InsFichaIngreso->FinTiempoTallerConcluido)?'checked="checked"':'');?> type="checkbox" name="CmpFichaIngresoTrabajoConcluido" id="CmpFichaIngresoTrabajoConcluido" value="1" />
            <span class="EstFormularioResaltar">Marcar ORDEN DE TRABAJO como CONCLUIDO</span> <img src="imagenes/alerta.gif" alt="Revisar" title="Revisar" width="15" height="15"  align="absmiddle" /></td>
...
<input type="hidden" name="CmpFichaIngresoTiempoTrabajoConcluido" id="CmpFichaIngresoTiempoTrabajoConcluido" value="<?php echo $InsFichaIngreso->FinTiempoTallerConcluido; ?>" /></td>
        ...
        <tr>
          <td colspan="5" align="left" valign="top"><input <?php echo (!empty($InsFichaIngreso->FinTiempoTallerConcluido)?'checked="checked"':'');?> type="checkbox" name="CmpFichaIngresoCorregido" id="CmpFichaIngresoCorregido" value="1" />
            <span class="EstFormularioResaltar">Marcar ORDEN DE TRABAJO como CORREGIDO</span> <img src="imagenes/alerta.gif" alt="Revisar" title="Revisar" width="15" height="15"  align="absmiddle" /></td>
