...
?>		
                ...
                <td  width="3%" align="right" ><?php echo number_format($dat->FinVehiculoKilometraje);?></td>
...
//if($PrivilegioEditar and ($dat->FinEstado==4 or $dat->FinEstado==5 or $dat->FinEstado==6 or $dat->FinEstado == 72 or $dat->FinEstado==71 or $dat->FinEstado==7 or $dat->FinEstado == 73 or $dat->FinEstado == 74 or $dat->FinEstado == 75  or $dat->FinEstado == 9   or $dat->FinEstado == 10)){
	...
	and (
	$dat->FinEstado==4 or $dat->FinEstado==5 or $dat->FinEstado==6 or $dat->FinEstado == 72 or $dat->FinEstado==71 or $dat->FinEstado==7 or $dat->FinEstado == 73 or $dat->FinEstado == 73 or $dat->FinEstado == 74
...
?>        
	<a href="javascript:FncImprmir('<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/imprimir.gif" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
<?php
}*/
?> 
