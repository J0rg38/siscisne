                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">C&oacute;digo Interno:
                        <input name="CmpTipo" type="hidden" id="CmpTipo" value="BOL" />
                      </td>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">Boleta:
                        ...
                        <input name="CmpBoletaTalonarioNumero" type="hidden" id="CmpBoletaTalonarioNumero" value="<?php echo $BoletaTalonarioNumero; ?>" />
                      </td>
                    ...
                    <td width="97%" valign="top">
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="4"><iframe src="formularios/PagoBoleta/acc/AccPagoFacturaSubirArchivo.php?Identificador=<?php echo $Identificador; ?>" id="IfrPagoFacturaSubirArchivo" name="IfrPagoFacturaSubirArchivo" scrolling="auto" frameborder="0" width="600" height="500"></iframe></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
