...
function FncCajaVerResumen(){
	...
	var Sucursal = $("#CmpSucursal").val();
		...
		$.ajax({
			type: 'GET',
			url: 'formularios/Caja/IfrCajaVerResumen.php',
...
function FncCajaImprimir(){
	...
	if(FncCajaValidar()){
		...
		FncPopUp("formularios/Caja/IfrCajaVerResumen.php?FechaInicio="+FechaInicio+"&FechaFin="+FechaFin+"&Moneda="+Moneda+"&Sucursal="+Sucursal+"&P=1");
