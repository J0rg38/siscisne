...
function FncCajaImprimir(){
	...
	if(FncCajaValidar()){
		...
		var Sucursal = $("#CmpSucursal").val();
		var FormaPago = $("#CmpFormaPago").val();
		FncPopUp("formularios/Caja/IfrCajaVer.php?FechaInicio="+FechaInicio+"&FechaFin="+FechaFin+"&Moneda="+Moneda+"&FormaPago="+FormaPago+"&Sucursal="+Sucursal+"&P=1");
...
function FncCajaGenerarExcel(){
	...
	if(FncCajaValidar()){
		...
		var Sucursal = $("#CmpSucursal").val();
		var FormaPago = $("#CmpFormaPago").val();
		FncPopUp("formularios/Caja/XLSCaja.php?FechaInicio="+FechaInicio+"&FechaFin="+FechaFin+"&Moneda="+Moneda+"&FormaPago="+FormaPago+"&Sucursal="+Sucursal+"&P=2");
