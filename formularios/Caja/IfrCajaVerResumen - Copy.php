...
<?php	
        ...
        ?></td>
  <td width="54%" rowspan="2" align="center" valign="top">REPORTE DE CAJA CHICA</td>
...
?>
  ...
  ?>
                    ...
                    <tr>
                      ...
                      <td width="14%" align="right"><?php echo number_format($TotalEgresos,2);?></td>
                    </tr>
        </table>
