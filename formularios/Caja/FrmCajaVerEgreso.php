...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsCajaVerEgresoFunciones.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">RESUMEN DE EGRESOS</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfCajaVerEgreso.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>
...
<!--    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrCaja.php" target="IfrCaja" method="post" name="FrmCaja" id="FrmCaja">
    ...
    ?>
			  ...
			  ?>
                ...
                <td>Incluir Saldos Iniciales:s</td>
                <td>
                
                <input type="checkbox" name="ChkIncluirSaldoInicial" id="ChkIncluirSaldoInicial" value="1"   />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
          ...
          <td align="left" valign="top">
            ...
            <table border="0" cellpadding="0" cellspacing="2">
              <tr>
                <td>
                  <input name="BtnVer"   id="BtnVer" type="image" border="0" src="imagenes/reporte_iconos/ver.png" alt="[Ver]" title="Ver" onclick="FncCajaVerEgresoVer();" />           </td>
                <td>
                  <?php
            if($PrivilegioImprimir){
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncCajaVerEgresoImprimir();" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncCajaVerEgresoGenerarExcel();" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
