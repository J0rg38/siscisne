...
$().ready(function() {
	...
	$('#CapGuiaRemisionAccion').html('Conectando con SUNAT para procesar archivo xml...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccGuiaRemisionProcesarXMLv2.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "P101":
					...
					$('#CapGuiaRemisionAccion').html('Archivo xml procesado correctamente. '+respuesta['MensajeRespuesta']);								
				...
				case "P102":
					...
					$('#CapGuiaRemisionAccion').html(respuesta['MensajeRespuesta']);
				...
				default:
					...
					$('#CapGuiaRemisionAccion').html('Ha ocurrido un error procesando el archivo xml, proceso cancelado. RESPUESTA: '+respuesta['MensajeRespuesta']);
