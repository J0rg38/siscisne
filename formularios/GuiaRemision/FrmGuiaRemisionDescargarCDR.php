...
$().ready(function() {
	...
	$('#CapFacturaAccion').html('Conectando con SERVIDOR para descargar archivo cdr...');	
	
	setTimeout("FncFacturaDescargarCDR('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncFacturaDescargarCDR(oArchivo,oUrl){
