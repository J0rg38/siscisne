...
$DireccionCliente = $InsGuiaRemision->GreDireccion;
...
for($j=1;$j<=$fila;$j++){
	...
	if($j==1){
		...
		$pdf->SetFont('times', 'B', 8);
		$pdf->Cell(5,5,"",$lineas,0,"R");
		$pdf->Cell(35,5,"DIRECCION: ",$lineas,0,"R");
		$pdf->SetFont('times', 'N', 8);
		$pdf->Cell(150,5,$afila[$j],$lineas,1,"L");
...
$pdf->SetFont('times', 'N', 8);
$pdf->Cell(150,5,$InsGuiaRemision->CliNumeroDocumento,$lineas,1);
...
$pdf->SetFont('times', 'N', 8);
$pdf->Cell(105,5,$InsGuiaRemision->GrePuntoPartida,$lineas,0);	

$pdf->SetFont('times', 'B', 8);
$pdf->Cell(25,5,"COD UBIGEO.",$lineas,0);	
$pdf->SetFont('times', 'N', 8);
...
$pdf->SetFont('times', 'N', 8);
$pdf->Cell(105,5,$InsGuiaRemision->GrePuntoLlegada,$lineas,0);	
...
$pdf->Cell(35,5,"DOC. IDENT:",$lineas,0,"R");
$pdf->SetFont('times', 'N', 8);
$pdf->Cell(55,5,($InsGuiaRemision->TdoNombre."/".$InsGuiaRemision->PrvNumeroDocumento),$lineas,1);
