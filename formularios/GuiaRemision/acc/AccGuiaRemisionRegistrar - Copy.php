		...
		case "FichaAccion":
			...
			if(!empty($ArrTallerPedidos)){		
				foreach($ArrTallerPedidos as $DatTallerPedido){
					...
					if($DatTallerPedido->AmoId == $GET_AmoId){
...
//			$InsTrasladoAlmacen->TalId = $GET_TalId;	
...
//			}
//			
//			$InsGuiaRemision->TalId = $InsTrasladoAlmacen->TalId;
//			
...
//			$InsGuiaRemision->GreObservacion = $InsAlmacenMovimientoSalida->AmoObservacion.chr(13).date("d/m/Y H:i:s")." - Guia de Remision Generada de Traslado.:".$InsTrasladoAlmacen->TalId;
//			
...
//			NULL,
//			NULL,
//			$InsTrasladoAlmacenSalida->TalId,
//			NULL);
//
//		break;
		...
		case "TrasladoAlmacenSalida":
			...
			$InsGuiaRemision->CliId = $InsTrasladoAlmacenSalida->CliId;
			$InsGuiaRemision->CliNombreCompleto = $InsTrasladoAlmacenSalida->CliNombreCompleto;
					
			$InsGuiaRemision->CliNombre = $InsTrasladoAlmacenSalida->CliNombre;
			$InsGuiaRemision->CliApellidoPaterno = $InsTrasladoAlmacenSalida->CliApellidoPaterno;
			$InsGuiaRemision->CliApellidoMaterno = $InsTrasladoAlmacenSalida->CliApellidoMaterno;
					
			$InsGuiaRemision->CliNumeroDocumento = $InsTrasladoAlmacenSalida->CliNumeroDocumento;
			$InsGuiaRemision->TdoId = $InsTrasladoAlmacenSalida->TdoId;
		
			$InsGuiaRemision->GrePuntoLlegada = $InsTrasladoAlmacenSalida->AlmDireccionDestino." ".$InsTrasladoAlmacenSalida->AlmDistritoDestino." ".$InsTrasladoAlmacenSalida->AlmProvinciaDestino." ".$InsTrasladoAlmacenSalida->AlmDepartamentoDestino;
			$InsGuiaRemision->GrePuntoPartida = $InsTrasladoAlmacenSalida->AlmDireccion." ".$InsTrasladoAlmacenSalida->AlmDistrito." ".$InsTrasladoAlmacenSalida->AlmProvincia." ".$InsTrasladoAlmacenSalida->AlmDepartamento;
			$InsGuiaRemision->GreObservacion = $InsTrasladoAlmacenSalida->TasObservacion.chr(13).date("d/m/Y H:i:s")." - Guia de Remision Generada de Transferencia.:".$InsTrasladoAlmacen->TalId;
...
*/
	...
	//Parametro12 = VmvSubTipo
			...
			NULL,
			NULL,
			$InsTrasladoAlmacenSalida->TasId,
			NULL);
