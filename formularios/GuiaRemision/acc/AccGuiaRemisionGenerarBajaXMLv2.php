...
//cbc:ReferenceDate
$ReferenceDate = $domtree->createElement("cbc:ReferenceDate",FncCambiaFechaAMysql($InsGuiaRemision->GreFechaEmision));
...
$AccountingSupplierParty = $xmlRoot->appendChild($AccountingSupplierParty);
	...
	$Party = $AccountingSupplierParty->appendChild($Party);
		...
		$VoidedDocumentsLine = $xmlRoot->appendChild($VoidedDocumentsLine);	
			...
			$DocumentSerialID = $domtree->createElement("sac:DocumentSerialID",$InsGuiaRemision->GrtNumero);
			$DocumentSerialID = $VoidedDocumentsLine->appendChild($DocumentSerialID);	
			
			//cbc:DocumentNumberID
			$DocumentNumberID = $domtree->createElement("sac:DocumentNumberID",$InsGuiaRemision->GreId);
...
$InsResumenBaja = new ClsResumenBaja();
$InsResumenBaja->GreId = $InsGuiaRemision->GreId;
$InsResumenBaja->GrtId = $InsGuiaRemision->GrtId;
...
//$InsGuiaRemision->MtdEditarGuiaRemisionDato("GreSunatRespuestaBajaId",$BajaNumeracion,$InsGuiaRemision->GreId,$InsGuiaRemision->GrtId);
