...
<tr>
  ...
  <tr>
    <td colspan="2"><table class="EstGuiaRemisionImprimirTabla" width="62%" border="0" cellpadding="3" cellspacing="2">
      <tr>
        <td width="505" align="right" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Tacna, </span>
          <?php
        ...
        <td width="28" align="right" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">/ </span></td>
        <td width="17" align="right" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $Mes;?></span></td>
        <td width="17" align="right" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">/ </span></td>
  ...
  <tr>
    <td width="645" height="15"><span class="EstGuiaRemisionImprimirEtiqueta">DESTINATARIO</span></td>
    <td width="646" height="15"><span class="EstGuiaRemisionImprimirEtiqueta">Datos de Comprador - distinto al destinatario</span></td>
  </tr>
  <tr>
    <td align="left" valign="top"><div class="EstGuiaRemisionImprimirSeparacion"  /></div></td>
    <td  align="left" valign="top"><div class="EstGuiaRemisionImprimirSeparacion"  /></div></td>
  </tr>
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="EstGuiaRemisionImprimirTabla">
      
      <tr>
        <td width="93" height="15" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Se&ntilde;or (es) :</span></td>
      ...
      <tr>
        <td height="15" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Ruc Nro.:</span></td>
        <td width="218" height="15" align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->GreDestinatarioNumeroDocumento1;?></span></td>
        <td width="120" height="15" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">DNI Nro. :</span></td>
    ...
    <td height="65" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="EstGuiaRemisionImprimirTabla">
      
      <tr>
        <td width="97" height="15" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Se&ntilde;or (es) :</span></td>
      ...
      <tr>
        <td height="15" align="left" valign="top">&nbsp;</td>
        <td width="163" height="15" align="left" valign="top">&nbsp;</td>
        <td width="71" height="15" align="left" valign="top">&nbsp;</td>
        <td width="304" height="15" align="left" valign="top">&nbsp;</td>
        </tr>
      <tr>
        <td height="15" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Ruc /:</span></td>
        <td height="15" align="left" valign="top">
		
		<span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->TdoNombre;?></span></td>
        <td height="15" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Nro. :</span></td>
  ...
  <tr>
    <td height="15" colspan="2"><span class="EstGuiaRemisionImprimirEtiqueta">Unidad de transporte y condutor(es)</span></td>
  </tr>
  <tr>
    <td  colspan="2"><div class="EstGuiaRemisionImprimirSeparacion"  /></div></td>
  </tr>
  <tr>
    <td height="90" colspan="2"><table class="EstGuiaRemisionImprimirTabla" width="100%" border="0" cellpadding="2" cellspacing="1">
      <tr>
        <td width="288" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta"> Raz&oacute;n Social:</span></td>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->PrvNombre;?></span></td>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta"> Chofer :</span></td>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->GreChofer;?></span></td>
      </tr>
      <tr>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta"> RUC N&deg;: </span></td>
        <td width="346" align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->PrvNumeroDocumento;?></span></td>
        <td width="325" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta"> Licencia de Conducir Nro. :</span></td>
        <td width="310" align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->GreNumeroLicenciaConducir;?></span></td>
        </tr>
      <tr>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Numero de Registro :</span></td>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->GreNumeroRegistro;?></span></td>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta"> Marca Unid. Transp. :</span></td>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->GreMarca;?></span></td>
      </tr>
      <tr>
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Constancia de Inscripci&oacute;n Nro .:</span></td>
        ...
        <td align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Nro. de Placa :</span></td>
  ...
  <tr>
   ...
   <table class="EstGuiaRemisionImprimirTabla" width="100%" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <td height="18" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Fecha de inicio de traslado:</span></td>
        ...
        <tr>
          <td width="316" height="18" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Punto de Partida :</span></td>
      <td height="18" align="left" valign="top"><span class="EstGuiaRemisionImprimirContenido"><?php echo $InsGuiaRemision->GrePuntoPartida;?></span></td>
        ...
        <tr>
          <td height="18" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Punto de Llegada :</span></td>
  ...
  <tr>
    <td  colspan="2" align="left" valign="top"><div class="EstGuiaRemisionImprimirSeparacion"  /></div></td>
  </tr>
  <tr>
    <td  colspan="2" align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td  colspan="2" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta"> En la fecha estamos remitiendo a Ud. lo siguiente </span></td>
  </tr>
...
?>
  <tr>
    ...
    <td height="10" align="center" widtd="135" ><span class="EstGuiaRemisionDetalleImprimirEtiqueta">
      ...
      </span><div class="EstGuiaRemisionImprimirSeparacion"  /></td>
    ...
    <td width="3" height="10" align="center" widtd="16" >&nbsp;</td>
    <td align="center" widtd="99" ><span class="EstGuiaRemisionDetalleImprimirEtiqueta">
...
?>
    ...
    <tr>
      <td width="3" height="21" align="center">&nbsp;</td>
      <td width="96" align="center"><span class="EstGuiaRemisionDetalleImprimirContenido"><?php echo $DatGuiaRemisionDetalle->GrdCantidad;?></span></td>
      <td width="3">&nbsp;</td>
      <td width="82" align="center"><span class="EstGuiaRemisionDetalleImprimirContenido"><?php echo $DatGuiaRemisionDetalle->GrdUnidadMedida;?></span></td>
      <td width="9">&nbsp;</td>
      <td width="468"><span class="EstGuiaRemisionDetalleImprimirContenido">
      ...
      <td align="center">&nbsp;</td>
      <td width="71" align="center"><span class="EstGuiaRemisionDetalleImprimirContenido"><?php echo $DatGuiaRemisionDetalle->GrdPesoNeto;?></span></td>
      <td width="3" align="center">&nbsp;</td>
      <td width="77" align="center"><span class="EstGuiaRemisionDetalleImprimirContenido"><?php echo $DatGuiaRemisionDetalle->GrdPesoTotal;?></span></td>
      </tr>
  <?php	
		}
	} 
      ...
      <table class="EstFormulario" width="100%" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
          <td colspan="2" align="left" valign="top"><table class="EstFormulario" width="100%" border="0" cellpadding="2" cellspacing="0">
            ...
            <tr>
              <td width="15%"><span class="EstGuiaRemisionImprimirEtiqueta">[a] Venta</span></td>
              ...
              <td width="0%">&nbsp;</td>
              <td width="29%"><span class="EstGuiaRemisionImprimirEtiqueta">[f ]Entre establecimientos <br />
                de la misma Empresa</span></td>
              <td width="1%">&nbsp;</td>
              <td width="4%"><?php if( $InsGuiaRemision->GreMotivoTraslado==6){ ?>
                <span class="EstGuiaRemisionImprimirContenido">X</span>
                <?php }?></td>
              <td width="1%">&nbsp;</td>
              <td width="12%"><span class="EstGuiaRemisionImprimirEtiqueta">[k] Importaci&oacute;n</span></td>
              <td width="1%">&nbsp;</td>
              <td width="11%">&nbsp;</td>
            ...
            <tr>
              <td colspan="2"><span class="EstGuiaRemisionImprimirEtiqueta">[b] Venta sujeto a <br />
                confirmar</span></td>
              <td>&nbsp;</td>
              <td><?php if( $InsGuiaRemision->GreMotivoTraslado==2){ ?>
                ...
                <?php }?></td>
              <td>&nbsp;</td>
              <td><span class="EstGuiaRemisionImprimirEtiqueta">[g] Para Transformaci&oacute;n</span></td>
              <td>&nbsp;</td>
              <td><?php if( $InsGuiaRemision->GreMotivoTraslado==7){ ?>
                <span class="EstGuiaRemisionImprimirContenido">X</span>
                <?php }?></td>
              <td>&nbsp;</td>
              <td><span class="EstGuiaRemisionImprimirEtiqueta">[l] Exportaci&oacute;n</span></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="2"><span class="EstGuiaRemisionImprimirEtiqueta">[c] Compra</span></td>
              <td>&nbsp;</td>
              <td><?php if( $InsGuiaRemision->GreMotivoTraslado==3){ ?>
                <span class="EstGuiaRemisionImprimirContenido">X</span>
                <?php }?></td>
              <td>&nbsp;</td>
              <td><span class="EstGuiaRemisionImprimirEtiqueta">[h] Recojo de Bienes transformados</span></td>
              <td>&nbsp;</td>
              <td><?php if( $InsGuiaRemision->GreMotivoTraslado==8){ ?>
                <span class="EstGuiaRemisionImprimirContenido">X</span>
                <?php }?></td>
              <td>&nbsp;</td>
              <td><span class="EstGuiaRemisionImprimirEtiqueta">[m] Venta con Entrega a Terceros</span></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="2"><span class="EstGuiaRemisionImprimirEtiqueta">[d] Consignacion</span></td>
              <td>&nbsp;</td>
              <td><?php if( $InsGuiaRemision->GreMotivoTraslado==4){ ?>
                <span class="EstGuiaRemisionImprimirContenido">X</span>
                <?php }?></td>
              <td>&nbsp;</td>
              <td><span class="EstGuiaRemisionImprimirEtiqueta">[i] Emisor Itinerante</span></td>
              <td>&nbsp;</td>
              <td><?php if( $InsGuiaRemision->GreMotivoTraslado==9){ ?>
                <span class="EstGuiaRemisionImprimirContenido">X</span>
                <?php }?></td>
              <td>&nbsp;</td>
              <td><span class="EstGuiaRemisionImprimirEtiqueta">[n] Otros:</span></td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="2"><span class="EstGuiaRemisionImprimirEtiqueta">[e] Devoluci&oacute;n</span></td>
              <td>&nbsp;</td>
              <td><?php if( $InsGuiaRemision->GreMotivoTraslado==5){ ?>
                <span class="EstGuiaRemisionImprimirContenido">X</span>
                <?php }?></td>
              <td>&nbsp;</td>
              <td><span class="EstGuiaRemisionImprimirEtiqueta">[j] Zona Primaria</span></td>
              <td>&nbsp;</td>
        ...
        <tr>
          <td width="13%" align="left" valign="top"><span class="EstGuiaRemisionImprimirEtiqueta">Comp. de Pago N&deg;</span></td>
