...
function FncGuiaRemisionGenerarXMLv2(oId,oTalonario,oTicket,oProcesar,oSUNAT){
	...
	if(oTicket!=""){
		...
		FncPopUp('formularios/GuiaRemision/FrmGuiaRemisionGenerarXMLv2.php?Id='+oId+'&Ta='+oTalonario+'&Procesar='+oProcesar+'&EnviarSUNAT='+oSUNAT,0,0,1,0,0,1,0,350,150);
...
function FncGuiaRemisionConsultarCDR(oId,oTalonario){
	
	FncPopUp('formularios/GuiaRemision/FrmGuiaRemisionConsultarCDR.php?Id='+oId+'&Ta='+oTalonario,0,0,1,0,0,1,0,350,150);
...
function FncGuiaRemisionSunatTareasv2(oId,oTalonario,oTicket,oEnvioCodigo,oEnvioRespuesta,oTicketBaja){
	...
	if(Tipo !== null){
		switch(Tipo.toUpperCase()){
			...
			case "1":
				FncGuiaRemisionGenerarXMLv2(oId,oTalonario,oTicket,1,1);		
			break;
			...
			case "3":
				...
				FncGuiaRemisionConsultarCDR(oId,oTalonario);
			break;
