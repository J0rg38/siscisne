...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccGuiaRemisionProcesarBajaXMLv2.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "B101":
					...
					$('#CapGuiaRemisionAccion').html('Archivo xml de baja procesado correctamente. '+respuesta['MensajeRespuesta']);				
				...
				default:
					...
					$('#CapGuiaRemisionAccion').html('Ha ocurrido un error procesando el archivo xml de baja, proceso cancelado.');
					//setTimeout("window.close();",2500);
