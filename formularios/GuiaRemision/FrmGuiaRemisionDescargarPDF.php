...
$().ready(function() {
	...
	$('#CapFacturaAccion').html('Conectando con SERVIDOR para descargar archivo pdf...');	
	
	setTimeout("FncFacturaDescargarPDF('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncFacturaDescargarPDF(oArchivo,oUrl){
