...
<?php
if($InsGuiaRemision->GreCierre==1){
?>
...
*/	
	...
	$('#CmpDestinoNumeroDocumento').focus();
...
<input type="hidden" name="CmpCierre" id="CmpCierre" value="<?php echo $InsGuiaRemision->GreCierre;?>" />
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">EDITAR GUIA DE REMISION</span></td>
      </tr>
      <tr>
        <td colspan="2">
       ...
       <tr>
         <td colspan="2" valign="top"><div class="EstFormularioArea">
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="4">&nbsp;</td>
               <td colspan="2"><span class="EstFormularioSubTitulo">Datos de la Guia de Remision - Remitente
               ...
               <td colspan="2" align="right">
                 ...
                 <table border="0" cellpadding="2" cellspacing="2">
                   <tr>
                     ...
                     <td>
                       <input type="hidden"  name="CmpTalonario" id="CmpTalonario"  value="<?php echo $InsGuiaRemision->GrtId; ?>" />
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="2" align="left" valign="top">    <fieldset title="">
                    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                      <tr>
             ...
             <tr>
               <td>&nbsp;</td>
               <td width="556" align="left" valign="top"><fieldset title="">
                 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                   <tr>
                     <td colspan="2" align="left" valign="top"><span class="EstFormularioSubTitulo">Datos de Comprador - distinto al destinatario</span></td>
                     </tr>
                   <tr>
                     <td width="24%" align="left" valign="top">Señor (es):
               ...
               <td width="543" align="left" valign="top"><fieldset title="">
               ...
               <td colspan="2" align="left" valign="top"><fieldset title="">
                 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                   ...
                   <tr>
                     ...
                     <td width="35%" align="left" valign="top"><table>
                       <tr>
                         ...
                         <td><input name="CmpProveedorNombre" type="text" class="EstFormularioCaja" id="CmpProveedorNombre" value="<?php echo $InsGuiaRemision->PrvNombre;?>" size="40" maxlength="255" /></td>
                     ...
                     <td width="13%" align="left" valign="top">Chofer:</td>
                     <td width="37%" align="left" valign="top"><input name="CmpChofer" type="text" class="EstFormularioCaja" id="CmpChofer" value="<?php echo $InsGuiaRemision->GreChofer;?>" size="40" maxlength="255" /></td>
                     </tr>
                   <tr>
             ...
             <tr>
                 ...
                 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                   <tr>
                     <td width="19%" align="left" valign="top">Fecha de inicio de traslado: <br />
                       <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
                     <td colspan="3" align="left" valign="top"><input class="EstFormularioCajaFecha"  name="CmpFechaInicioTraslado" type="text" id="CmpFechaInicioTraslado" value="<?php if(empty($InsGuiaRemision->GreFechaInicioTraslado)){ echo date("d/m/Y");}else{ echo $InsGuiaRemision->GreFechaInicioTraslado; }?>" size="15" maxlength="10" />                       <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaInicioTraslado" name="BtnFechaInicioTraslado" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
                     </tr>
                   <tr>
                     <td align="left" valign="top">Motivo de Traslado:</td>
                     <td colspan="3" align="left" valign="top"><select class="EstFormularioCombo" name="CmpMotivoTrasladoCodigo" id="CmpMotivoTrasladoCodigo">
			  ...
			  ?>
                   ...
                   <tr>
                     ...
                     <td width="31%" align="left" valign="top"><input name="CmpPesoTotal" type="text" class="EstFormularioCaja" id="CmpPesoTotal" value="<?php echo number_format($InsGuiaRemision->GrePesoTotal,2);?>" size="20" maxlength="20" /></td>
                     <td width="20%" align="left" valign="top">Cant. Paquetes:</td>
                     <td width="30%" align="left" valign="top"><input name="CmpTotalPaquetes" type="text" class="EstFormularioCaja" id="CmpTotalPaquetes" value="<?php echo number_format($InsGuiaRemision->GreTotalPaquetes,2);?>" size="20" maxlength="20" /></td>
                   </tr>
                   </table>
                 </fieldset></td>
               <td>&nbsp;</td>
             ...
             <tr>
               ...
               <td colspan="2" align="left" valign="top"><fieldset title="">
                 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                   <tr>
                     <td colspan="8" align="left" valign="top">OBSERVACIONES Y OTRAS REFERENCIAS</td>
                     </tr>
                   <tr>
       ...
       <tr>
         <td width="75%" valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td><input tabindex="7" name="CmpGuiaRemisionDetalleCodigo"  type="text" class="EstFormularioCaja" id="CmpGuiaRemisionDetalleCodigo" size="10" maxlength="20"   /></td>
               <td><input name="CmpGuiaRemisionDetalleDescripcion" type="text" class="EstFormularioCaja" id="CmpGuiaRemisionDetalleDescripcion" tabindex="8" size="45" /></td>
               <td><input tabindex="12" name="CmpGuiaRemisionDetalleCantidad" type="text" class="EstFormularioCaja" id="CmpGuiaRemisionDetalleCantidad" size="10" maxlength="10"  /></td>
         ...
         <td width="25%" valign="top"><div id="CapFacturaDetalle" class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             <tr>
               <td>&nbsp;</td>
               <td colspan="3"><span class="EstFormularioSubTitulo">Fichas </span>
                 ...
                 <input type="hidden" name="CmpVehiculoMovimientoId" id="CmpVehiculoMovimientoId" /></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               <td>&nbsp;</td>
               <td width="76%"><span class="EstFormularioSubTitulo"> Items
...
<?php
}elseif(!empty($InsGuiaRemision->GreCierre)){
echo ERR_GRE_401;
}
?>
<?php
