...
$ResGuiaRemisionTalonario = $InsGuiaRemisionTalonario->MtdObtenerGuiaRemisionTalonarios(NULL,NULL,"GrtNumero","DESC",NULL,$_SESSION['SesionSucursal']);
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "GreDestinatarioNombre"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GreDestinatarioNombre','ASC');"> Destinatario <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GreDestinatarioNombre','DESC');"> Destinatario<img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('GreDestinatarioNombre','ASC');"> Destinatario</a>
                <?php
				}
				?></th>
                <th width="6%" ><?php
				...
				if($POST_ord == "TalId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('TalId','ASC');"> Traslado <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('TalId','DESC');"> Traslado<img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('TalId','ASC');"> Traslado</a>
                <?php
				}
				?></th>
                <th width="7%" ><?php
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->GreId."%".$dat->GrtId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->GreId."%".$dat->GrtId; ?>" />				</td>
                ...
                <td align="right" ><?php echo ($dat->TalId);?></td>
                <td align="right" >
                  <?php 
				...
				?>                </td>
                <td width="4%" align="right" ><a href="javascript:FncBoletaSunatHistorialCargar('<?php echo $dat->GreId;?>','<?php echo $dat->BtaId;?>');" >
                  <?php
