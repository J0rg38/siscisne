...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    ?>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input value="<?php echo $InsPersonal->PerDepartamento;?>"  class="EstFormularioCaja"  name="CmpDepartamento" type="text" id="CmpDepartamento" size="40" maxlength="255" /></td>
            <td align="left" valign="top">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td align="left" valign="top"><input value="<?php echo $InsPersonal->PerProvincia;?>"  class="EstFormularioCaja"  name="CmpProvincia" type="text" id="CmpProvincia" size="40" maxlength="255" /></td>
            <td align="left" valign="top">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td align="left" valign="top"><input value="<?php echo $InsPersonal->PerDistrito;?>"  class="EstFormularioCaja"  name="CmpDistrito" type="text" id="CmpDistrito" size="40" maxlength="255" /></td>
            <td align="left" valign="top">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
<script type="text/javascript"> 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnFechaNacimiento"// el id del bot&oacute;n que  
	}); 
</script>
<?php
}else{
