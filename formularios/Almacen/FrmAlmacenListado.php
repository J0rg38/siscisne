        ...
        <tr>
          <td align="right">
            ...
            <select class="EstFormularioCombo" name="Cam" id="Cam">
              <option value="AlmId" <?php if ($POST_cam == "AlmId") {
                                      echo 'selected="selected"';
                                    } ?>>Id</option>
              <option value="AlmNombre" <?php if ($POST_cam == "AlmNombre") {
                                          echo 'selected="selected"';
                                        } ?>>Nombre</option>
                ...
                <tr>
                  ...
                  <td colspan="12" align="center">
                    ...
                    <select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
                      ...
                      <option <?php if ($POST_num == $AlmacenesTotal) {
                                echo 'selected="selected"';
                              } ?> value="<?php echo $AlmacenesTotal; ?>">Todos</option>
                    </select>
                ...
                ?>
                  ...
                  <tr id="Fila_<?php echo $f; ?>">
                    ...
                    <td width="2%" align="center">
                      ...
                      <input onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->AlmId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->AlmId; ?>" />
                    </td>
