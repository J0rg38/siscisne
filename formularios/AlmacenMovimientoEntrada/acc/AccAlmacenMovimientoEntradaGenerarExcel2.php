<?php
 ...
 header("Content-Disposition:  filename=\"COMPRAS_DETALLADO_".date('d-m-Y').".xls\";");
...
$ResAlmacenMovimientoEntradaDetalle =  $InsAlmacenMovimientoEntradaDetalle->MtdObtenerAlmacenMovimientoEntradaDetalles(NULL,NULL,NULL,NULL,NULL,1,NULL,$dat->AmoId);
...
?>
	...
	?>    
					...
					<td align="right" ><?php echo $DatAlmacenMovimientoEntradaDetalle->ProNombre;?></td>
					<td align="right" ><?php echo $DatAlmacenMovimientoEntradaDetalle->UmeNombre;?></td>
					<td align="right" >
					   <?php $DatAlmacenMovimientoEntradaDetalle->AmdCosto = (($DatAlmacenMovimientoEntradaDetalle->AmdCosto/(empty($dat->AmoTipoCambio)?1:$dat->AmoTipoCambio)));?>
					<?php echo number_format($DatAlmacenMovimientoEntradaDetalle->AmdCosto,2);?></td>
					<td align="right" ><?php echo number_format($DatAlmacenMovimientoEntradaDetalle->AmdCantidad,2);?></td>
					<td align="right" >
					
					   <?php $DatAlmacenMovimientoEntradaDetalle->AmdImporte = (($DatAlmacenMovimientoEntradaDetalle->AmdImporte/(empty($dat->AmoTipoCambio)?1:$dat->AmoTipoCambio)));?>
