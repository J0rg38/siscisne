...
switch($POST_acc){
	...
	case 'ActualizarAlmacenMovimientoEntradaValidarStockSi':

			if($InsAlmacenMovimientoEntrada->MtdActualizarValidarStockAlmacenMovimientoEntrada($POST_seleccionados,1)){
				$Resultado .= "#SAS_AMO_110";
			}else{
		...
		case 'ActualizarAlmacenMovimientoEntradaValidarStockNo':

			if($InsAlmacenMovimientoEntrada->MtdActualizarValidarStockAlmacenMovimientoEntrada($POST_seleccionados,2)){
				$Resultado .= "#SAS_AMO_110";
			}else{
				$Resultado .= "#ERR_AMO_110";
			}
