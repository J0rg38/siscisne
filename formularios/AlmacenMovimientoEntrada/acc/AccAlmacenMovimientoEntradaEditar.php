...
function FncCargarDatos(){
	...
	if($InsAlmacenMovimientoEntrada->MonId<>$EmpresaMonedaId && !empty($InsAlmacenMovimientoEntrada->MonId)){
		
		$InsAlmacenMovimientoEntrada->AmoNacionalTotalRecargo = ($InsAlmacenMovimientoEntrada->AmoNacionalTotalRecargo / $InsAlmacenMovimientoEntrada->AmoTipoCambio);
		
	}
	
	if($InsAlmacenMovimientoEntrada->MonIdNacional2<>$EmpresaMonedaId && !empty($InsAlmacenMovimientoEntrada->MonIdNacional2)){
		
		$InsAlmacenMovimientoEntrada->AmoNacionalTotalFlete = ($InsAlmacenMovimientoEntrada->AmoNacionalTotalFlete / $InsAlmacenMovimientoEntrada->AmoTipoCambio);
		
	}
	
	if($InsAlmacenMovimientoEntrada->MonIdNacional3<>$EmpresaMonedaId && !empty($InsAlmacenMovimientoEntrada->MonIdNacional3)){
