...
?>
	...
	$GET_Ori = $_GET['Origen'];
	$GET_ValidarStock = $_GET['ValidarStock'];
	$Registro = false;
											...
											<div class="EstFormularioArea">
												<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
													...
													<tr>
														...
														<td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoFecha)) {
																																													echo date("d/m/Y");
																																												} else {
																																													echo $InsAlmacenMovimientoEntrada->AmoFecha;
																																												} ?>" size="10" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFecha" name="BtnFecha" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
														<td>&nbsp;</td>
													</tr>
													<tr>
														<td>&nbsp;</td>
													...
													<tr>
														...
														<td align="left" valign="top"><span class="EstFormularioContenido">
																<select <?php echo ((!$PrivilegioMultisucursal) ? 'disabled="disabled"' : ''); ?> class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
																	...
																	?>
																		<option value="<?php echo $DatSucursal->SucId ?>" <?php if ($InsAlmacenMovimientoEntrada->SucId == $DatSucursal->SucId) {
																																echo 'selected="selected"';
													...
													<tr>
														<td>&nbsp;</td>
														<td valign="top"><input <?php echo (!empty($InsAlmacenMovimientoEntrada->OcoId) ? 'checked="checked"' : ''); ?> type="checkbox" name="CmpNotificar" id="CmpNotificar" value="1" />
															...
															<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
																...
																<tr>
																	...
																	<td>
																		...
																		<input name="CmpProductoCantidad" type="text" class="EstFormularioCaja" id="CmpProductoCantidad" size="10" maxlength="10" />
																	</td>
																	...
																	<td>
																		...
																		<input name="CmpProductoImporte" type="text" class="EstFormularioCaja" id="CmpProductoImporte" size="10" maxlength="10" />
																	</td>
											...
											<div class="EstFormularioArea">
												<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
													...
													<tr>
														...
														<td align="left" valign="top"><input class="EstFormularioCaja" name="CmpCantidadDia" type="text" id="CmpCantidadDia" size="10" maxlength="3" value="<?php echo $InsAlmacenMovimientoEntrada->AmoCantidadDia; ?>" /></td>
														<td align="left" valign="top">&nbsp;</td>
													</tr>
													<tr>
														<td>&nbsp;</td>
															...
															<table>
																<tr>
																	<td>
																		...
																		<input name="CmpTipoCambioComercial" type="hidden" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambioComercial" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoTipoCambioComercial)) {
																																																			echo "";
																																																		} else {
																																																			echo $InsAlmacenMovimientoEntrada->AmoTipoCambioComercial;
															...
															<div id="CapCostoInternacionales">
																...
																<table border="0" cellpadding="2" cellspacing="2">
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalAduana" type="text" id="CmpTotalAduana" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAduana)) {
																																																											echo "0.00";
																																																										} else {
																		...
																		<td>
																			...
																			<a href="javascript:FncProveedorNuevo('Internacional','1');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
																		...
																		<td>
																			...
																			<a href="javascript:FncProveedorBuscar('NumeroDocumento','Internacional','1');"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalTransporte" type="text" id="CmpTotalTransporte" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalTransporte)) {
																																																													echo "0.00";
																																																												} else {
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalDesestiba" type="text" id="CmpTotalDesestiba" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalDesestiba)) {
																																																													echo "0.00";
																																																												} else {
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalAlmacenaje" type="text" id="CmpTotalAlmacenaje" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAlmacenaje)) {
																																																													echo "0.00";
																																																												} else {
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalAdValorem" type="text" id="CmpTotalAdValorem" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAdValorem)) {
																																																													echo "0.00";
																																																												} else {
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalAduanaNacional" type="text" id="CmpTotalAduanaNacional" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAduanaNacional)) {
																																																															echo "0.00";
																																																														} else {
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalGastoAdministrativo" type="text" id="CmpTotalGastoAdministrativo" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalGastoAdministrativo)) {
																																																																		echo "0.00";
																																																																	} else {
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalOtroCosto1" type="text" id="CmpTotalOtroCosto1" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalOtroCosto1)) {
																																																													echo "0.00";
																																																												} else {
																	...
																	<tr>
																		...
																		<td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalOtroCosto2" type="text" id="CmpTotalOtroCosto2" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalOtroCosto2)) {
																																																													echo "0.00";
																																																												} else {
																	...
																	<tr>
																		...
																		<td>&nbsp;</td>
																		<td><input class="EstFormularioCaja" name="CmpTotaImportacion" type="text" id="CmpTotaImportacion" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoTotalImportacion)) {
																																														echo "0.00";
																																													} else {
															...
															<div id="CapCostoNacionales">
																...
																<table border="0" cellpadding="2" cellspacing="2">
																	...
																	<tr>
																		...
																		<td align="left" valign="top">-</td>
																		<td align="left" valign="top"><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalRecargo" type="text" id="CmpTotalRecargo" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoNacionalTotalRecargo)) {
																																																																		echo "0.00";
																																																																	} else {
																	...
																	<tr>
																		...
																		<td align="left" valign="top"><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalFlete" type="text" id="CmpTotalFlete" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoNacionalTotalFlete)) {
																																																																	echo "0.00";
																																																																} else {
																		...
																		<td align="left" valign="top"><a href="javascript:FncProveedorNuevo('Nacional','2');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
																		...
																		<td align="left" valign="top"><a href="javascript:FncProveedorBuscar('NumeroDocumento','Nacional','2');"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
																		<td align="left" valign="top">
																	...
																	<tr>
																		...
																		<td align="left" valign="top"><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalOtroCosto" type="text" id="CmpTotalOtroCosto" value="<?php if (empty($InsAlmacenMovimientoEntrada->AmoNacionalTotalOtroCosto)) {
																																																																			echo "0.00";
																																																																		} else {
																		...
																		<td align="left" valign="top"><a href="javascript:FncProveedorNuevo('Nacional','3');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
																		...
																		<td align="left" valign="top"><a href="javascript:FncProveedorBuscar('NumeroDocumento','Nacional','3');"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
																		<td align="left" valign="top">
															...
															<div class="EstFormularioArea">
																<table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
																	...
																	<tr>
																		...
																		<td align="right">
																			<a href="javascript:FncAlmacenMovimientoEntradaCostoVinculadoListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a>
