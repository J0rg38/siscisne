              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <!--<a href="javascript:FncAlmacenMovimientoEntradaDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>--></td>
	    ...
	    <tr>
          ...
          <table border="0" cellpadding="2" cellspacing="2">
	        ...
	        <tr>
	          ...
	          <td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalAduana" type="text" id="CmpTotalAduana" value="<?php if(empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAduana)){ echo "0.00"; }else{echo number_format($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAduana,2);}?>" size="10" maxlength="5" /></td>
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
	        ...
	        <tr>
	          ...
	          <td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalTransporte" type="text" id="CmpTotalTransporte" value="<?php if(empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalTransporte)){ echo "0.00"; }else{echo number_format($InsAlmacenMovimientoEntrada->AmoInternacionalTotalTransporte,2);}?>" size="10" maxlength="5" /></td>
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
	        ...
	        <tr>
	          ...
	          <td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalDesestiba" type="text" id="CmpTotalDesestiba" value="<?php if(empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalDesestiba)){ echo "0.00"; }else{echo number_format($InsAlmacenMovimientoEntrada->AmoInternacionalTotalDesestiba,2);}?>" size="10" maxlength="5" /></td>
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
	        ...
	        <tr>
	          ...
	          <td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalAdValorem" type="text" id="CmpTotalAdValorem" value="<?php if(empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAdValorem)){ echo "0.00"; }else{echo number_format($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAdValorem,2);}?>" size="10" maxlength="5" /></td>
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
	        ...
	        <tr>
	          ...
	          <td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalAduanaNacional" type="text" id="CmpTotalAduanaNacional" value="<?php if(empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAduanaNacional)){ echo "0.00"; }else{echo number_format($InsAlmacenMovimientoEntrada->AmoInternacionalTotalAduanaNacional,2);}?>" size="10" maxlength="5" /></td>
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
	        ...
	        <tr>
	          ...
	          <td><input class="EstFormularioCaja" onchange="FncAlmacenMovimientoEntradaCostoVinculadoListar();" name="CmpTotalOtroCosto2" type="text" id="CmpTotalOtroCosto2" value="<?php if(empty($InsAlmacenMovimientoEntrada->AmoInternacionalTotalOtroCosto2)){ echo "0.00"; }else{echo number_format($InsAlmacenMovimientoEntrada->AmoInternacionalTotalOtroCosto2,2);}?>" size="10" maxlength="5" /></td>
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
	        ...
	        <tr>
	          ...
	          <td>&nbsp;</td>
	          <td><input class="EstFormularioCaja" name="CmpTotaImportacion" type="text" id="CmpTotaImportacion" value="<?php if(empty($InsAlmacenMovimientoEntrada->AmoTotalImportacion)){ echo "0.00"; }else{echo number_format($InsAlmacenMovimientoEntrada->AmoTotalImportacion,2);}?>" size="10" maxlength="5" readonly="readonly" /></td>
	          <td>&nbsp;</td>
	          <td>&nbsp;</td>
	          <td>&nbsp;</td>
	          <td>&nbsp;</td>
