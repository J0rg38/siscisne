...
<link href="css/CssAlmacenMovimientoEntradaImprimir.css" rel="stylesheet" type="text/css" />
...
<tr>
  ...
  <td width="52%" align="center" valign="top"><span class="EstReporteTitulo">INGRESO A ALMACEN X COMPRA
	...
	if(is_array($InsAlmacenMovimientoEntrada->AlmacenMovimientoEntradaDetalle)){
		...
		foreach($InsAlmacenMovimientoEntrada->AlmacenMovimientoEntradaDetalle as $DatAlmacenMovimientoEntradaDetalle){
			...
			if($InsAlmacenMovimientoEntrada->MonId<>$EmpresaMonedaId){
				$DatAlmacenMovimientoEntradaDetalle->AmdCosto = $DatAlmacenMovimientoEntradaDetalle->AmdCosto / $InsAlmacenMovimientoEntrada->AmoTipoCambio;
			}else{
				$DatAlmacenMovimientoEntradaDetalle->AmdCosto = $DatAlmacenMovimientoEntradaDetalle->AmdCosto;
			}

			if($InsAlmacenMovimientoEntrada->MonId<>$EmpresaMonedaId ){
				$DatAlmacenMovimientoEntradaDetalle->AmdImporte = $DatAlmacenMovimientoEntradaDetalle->AmdImporte / $InsAlmacenMovimientoEntrada->AmoTipoCambio;
			}else{
				$DatAlmacenMovimientoEntradaDetalle->AmdImporte = $DatAlmacenMovimientoEntradaDetalle->AmdImporte;
			}
...
?>
    ...
    <tr>
      ...
      <td align="right" class="EstReporteDetalleImprimirContenido" ><?php echo $DatAlmacenMovimientoEntradaDetalle->ProCodigoOriginal;?></td>
...
if($InsAlmacenMovimientoEntrada->MonId<>$EmpresaMonedaId){
	...
	$Recargo = $InsAlmacenMovimientoEntrada->AmoNacionalTotalRecargo/ $InsAlmacenMovimientoEntrada->AmoTipoCambio;
}else{
	
	$Recargo = $InsAlmacenMovimientoEntrada->AmoNacionalTotalRecargo;
