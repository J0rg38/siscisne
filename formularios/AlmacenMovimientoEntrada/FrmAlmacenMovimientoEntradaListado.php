...
if(empty($POST_TipoFecha)){$POST_TipoFecha = "AmoComprobanteFecha";}
...
<div class="EstSubMenuBoton"><a href="javascript:FncMarcarRevisadoSeleccionados();"><img src="imagenes/submenu/revisado.png" alt="[Marcar como Revisado]" title="Marcar como Revisado" />Revisado</a></div> 
...
if($PrivilegioEditar){
?>
 <div class="EstSubMenuBoton"><a href="javascript:FncActualizarValidarStockSeleccionados();">
    <img src="imagenes/submenu/validar_stock.png" alt="[Act. Validar Stock]" title="Actualizar a validar stock seleccionados" />Val. Stock</a></div>



	<!--<div class="EstSubMenuBoton"><a href="javascript:FncActualizarValidarStockSiSeleccionados();">
    <img src="imagenes/iconos/validar_stock_si.png" alt="[Act. Validar Stock Si]" title="Actualizar a validar stock Si seleccionados" />Val. Stock</a></div>
    
   <div class="EstSubMenuBoton"><a href="javascript:FncActualizarValidarStockNoSeleccionados();">
    <img src="imagenes/iconos/validar_stock_si.png" alt="[Act. Validar Stock No]" title="Actualizar a validar stock No seleccionados" />No Val. Stock</a></div>
...
?>
    ...
    <img src="imagenes/submenu/no_realizado.png" alt="[Act. No Realizado]" title="Actualizar a estado NO REALIZADO seleccionados" />No/Realizado</a></div>
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE INGRESOS A ALMACEN X COMPRA</span>  </td>
</tr>
<tr>
  <td width="47%">
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "OcoId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OcoId','ASC');"> Ord. Compra <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OcoId','DESC');"> Ord. Compra <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "AlmNombre"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AlmNombre','ASC');"> Almacen <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AlmNombre','DESC');"> Almacen<img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AlmNombre','ASC');"> Almacen </a>
                <?php
				}
				?></th>
                <th width="4%" >
                  ...
                  <?php
				if($POST_ord == "AmoNotaCreditoCompra"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AmoNotaCreditoCompra','ASC');">  N. Cre. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AmoNotaCreditoCompra','DESC');">  N. Cre. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AmoNotaCreditoCompra','ASC');">  N. Cre.  </a>
                  <?php
				}
				?>
				...
				?></th>
                <th width="3%" > <?php
				if($POST_ord == "AmoValidarStock"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AmoValidarStock','ASC');"> Val. Stock <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AmoValidarStock','DESC');"> Val. Stock <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('AmoValidarStock','ASC');"> Val. Stock </a>
                  <?php
				}
				?>
                </th>
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td width="2%" align="right" valign="middle"   ><?php echo $dat->SucNombre;  ?></td>
...
?></td>
                ...
                <td  width="4%" align="right" ><?php echo $dat->AlmNombre;  ?></td>
...
?>
                  <!-- class="thickbox"-->
                  <a href="javascript:FncNotaCreditoCompraListado('<?php echo $dat->AmoId?>');" title="">Tiene N. Cred.</a>    
...
?>
                  <a target="_blank" href="subidos/almacen_movimiento_entrada_fotos/<?php echo $dat->AmoFoto;?>"  title=""><img  src="imagenes/documento.gif" width="20" height="20" border="0"  /></a>
                <?php	
}
?></td>
                <td  width="2%" align="right" ><?php            
if(!empty($dat->AmoGuiaRemisionFoto)){
	
	$extension = strtolower(pathinfo($dat->AmoGuiaRemisionFoto, PATHINFO_EXTENSION));
	$nombre_base = basename($dat->AmoGuiaRemisionFoto, '.'.$extension);  
?>
                  <a target="_blank" href="subidos/almacen_movimiento_entrada_fotos/<?php echo $dat->AmoGuiaRemisionFoto;?>"  title=""><img  src="imagenes/documento.gif" width="20" height="20" border="0"  /></a>
                <?php	
}
?></td>
...
?>
			...
			?>
                  ...
                  <a href="javascript:FncVistaPreliminar('<?php echo $dat->AmoId;?>');"><img src="imagenes/acciones/preliminar.gif" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
			...
			?>        
                  <a href="principal.php?Mod=NotaCreditoCompra&Form=Registrar&Origen=AlmacenMovimientoEntrada&AmoId=<?php echo $dat->AmoId; ?>"><img src="imagenes/acciones/nota_credito_compra.png" width="19" height="19" border="0" title="Nota de Credito" alt="[Nota de Credito]"   /></a>
			...
			?>        
                  <a href="principal.php?Mod=Reclamo&Form=Registrar&Origen=AlmacenMovimientoEntrada&AmoId=<?php echo $dat->AmoId; ?>"><img src="imagenes/acciones/reclamo.png" width="19" height="19" border="0" title="Reclamo" alt="[Reclamo]"   /></a>
