...
?>  
	<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=ImportarXML"><img src="imagenes/submenu/importar.png" alt="[Importar XML]"  title="Ir a formulario de Importacion XML" />Importar XML</a></div>
<?php
}
?>