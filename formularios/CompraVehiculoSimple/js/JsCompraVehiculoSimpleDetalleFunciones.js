...
function FncCompraVehiculoSimpleDetalleNuevo(){
	
	console.log("FncCompraVehiculoSimpleDetalleNuevo");
	...
	$('#CmpCompraVehiculoDetalleAccion').val("AccCompraVehiculoSimpleDetalleRegistrar.php");
...
function FncCompraVehiculoSimpleDetalleGuardar(){
	
	console.log("FncCompraVehiculoSimpleDetalleGuardar");
	...
	if(VehiculoIngresoId==""){
		...
		$('#CapVehiculoAccion').html('Guardando...');
				...
				$.ajax({
					type: 'POST',
					url: 'formularios/CompraVehiculoSimple/acc/'+Acc,
...
function FncCompraVehiculoSimpleDetalleListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/CompraVehiculoSimple/FrmCompraVehiculoSimpleDetalleListado.php',
		data: 'Identificador='+Identificador+
...
function FncCompraVehiculoSimpleDetalleEscoger(oItem){
		
	var Identificador = $('#Identificador').val();
	
	$('#CapVehiculoAccion').html('Editando...');
	
	$('#CmpCompraVehiculoDetalleAccion').val("AccCompraVehiculoSimpleDetalleEditar.php");
...
//Parametro25 = CvdEstado
	...
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/CompraVehiculoSimple/acc/AccCompraVehiculoSimpleDetalleEscoger.php',
		data: 'Identificador='+Identificador+
'&Item='+oItem,
...
function FncCompraVehiculoSimpleDetalleEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/CompraVehiculoSimple/acc/AccCompraVehiculoSimpleDetalleEliminar.php',
			data: 'Identificador='+Identificador+
'&Item='+oItem,
			success: function(){
...
function FncCompraVehiculoSimpleDetalleEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/CompraVehiculoSimple/acc/AccCompraVehiculoSimpleDetalleEliminarTodo.php',
			data: 'Identificador='+Identificador,
			success: function(){
				$('#CapVehiculoAccion').html('Eliminado');	
				FncCompraVehiculoSimpleDetalleListar();
...
function FncCompraVehiculoSimpleDetalleCalcularCosto(){
...
function FncCompraVehiculoSimpleDetalleCalcularImporte(){
