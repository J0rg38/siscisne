	...
	var Tipo = prompt("Escoja el tipo de reporte \n 1 = Resumido\n 2 = Detallado", "1");
			...
			if(Tipo !== null){
				switch(Tipo.toUpperCase()){
					case "1":
	document.getElementById("FrmListado").action = "formularios/CompraVehiculoSimple/acc/AccCompraVehiculoSimpleGenerarExcel.php";
					break;
					
					case "2":
	document.getElementById("FrmListado").action = "formularios/CompraVehiculoSimple/acc/AccCompraVehiculoSimpleGenerarExcel2.php";
					break;
...
function FncImprmir(oId){
	FncPopUp('formularios/CompraVehiculoSimple/FrmCompraVehiculoImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
}

function FncVistaPreliminar(oId){
	FncPopUp('formularios/CompraVehiculoSimple/FrmCompraVehiculoImprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
}
...
function FncNotaCreditoCompraListado(oCveId){
	...
	//FncPopUp('formularios/CompraVehiculoSimple/DiaNotaCreditoCompraListado.php?CveId='+oCveId,0,0,1,0,0,1,0,screen.height,screen.width);
	
	tb_show(this.title,'formularios/CompraVehiculoSimple/DiaNotaCreditoCompraListado.php?CveId='+oCveId,this.rel);		
