...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"CompraVehiculo","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"CompraVehiculo","Listado") and empty($GET_dia)){
?>  
