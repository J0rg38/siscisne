               ...
               <tr>
                 <td width="98%">
                   ...
                   <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                     ...
                     <tr>
                       <td>&nbsp;</td>
                       <td><a href="javascript:FncCompraVehiculoSimpleDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                       ...
                       <td valign="middle"><input name="CmpCompraVehiculoDetalleCantidad" type="text" class="EstFormularioCaja" id="CmpCompraVehiculoDetalleCantidad" size="8" maxlength="10" /></td>
                       ...
                       <td valign="middle"><input name="CmpCompraVehiculoDetalleImporte" type="text" class="EstFormularioCaja" id="CmpCompraVehiculoDetalleImporte" size="8" maxlength="10" /></td>
                       ...
                       <td><a href="javascript:FncCompraVehiculoSimpleDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
         ...
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               ...
               <!--<a href="javascript:FncCompraVehiculoSimpleDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>-->
...
<input name="CmpProveedorId" type="hidden" id="CmpProveedorId" value="<?php echo $InsCompraVehiculo->PrvId;?>" size="3" /></td>
               ...
               <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpProveedorNombreCompleto" type="text" id="CmpProveedorNombreCompleto" value="<?php echo $InsCompraVehiculo->PrvNombreCompleto;?>" size="45" maxlength="255"  />                 <a href="formularios/CompraVehiculoSimple/FrmProveedorBuscar.php?height=440&width=850" class="thickbox" title="">
