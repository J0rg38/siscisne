...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccCompraVehiculoSimpleRegistrar.php');
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">
                        <span class="EstFormularioSubTitulo">Datos de la Ingreso de Unidad Vehicular
...
<input type="hidden" name="CmpTiempoRegistroInicio" id="CmpTiempoRegistroInicio"  value="<?php echo $InsCompraVehiculo->CvhTiempoRegistroInicio; ?>" />
			...
			?>
                    ...
                    <tr>
                      ...
                      <td colspan="3"><iframe src="formularios/CompraVehiculoSimple/acc/AccCompraVehiculoSimpleGuiaRemisionFotoSubirArchivo.php?Identificador=<?php echo $Identificador;?>" id="IfrCompraVehiculoGuiaRemisionFotoSubirArchivo" name="IfrCompraVehiculoGuiaRemisionFotoSubirArchivo" scrolling="auto"  frameborder="0"  width="400" height="200"></iframe></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td align="left" valign="top">Observacion:</td>
                      <td align="left" valign="top"><textarea name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsCompraVehiculo->CvhObservacion;?></textarea></td>
    ...
    ?>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td valign="top"><input <?php echo (!empty($InsCompraVehiculo->OcoId)?'checked="checked"':'');?>  type="checkbox" name="CmpNotificar" id="CmpNotificar" value="1"  />
...
<input name="CmpVehiculoUnidadMedidaEquivalente"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoUnidadMedidaEquivalente" size="3" maxlength="20"  />
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td valign="middle"><a href="javascript:FncCompraVehiculoSimpleDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                            ...
                            <td valign="middle">
                              ...
                              <input name="CmpCompraVehiculoDetalleCantidad" type="text" class="EstFormularioCaja" id="CmpCompraVehiculoDetalleCantidad" size="8" maxlength="10" />                            </td>
                            <td valign="middle"><input name="CmpCompraVehiculoDetalleCosto" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCompraVehiculoDetalleCosto" size="8" maxlength="10" readonly="readonly" />                            </td>
                            <td valign="middle">
                              
                              <input name="CmpCompraVehiculoDetalleImporte" type="text" class="EstFormularioCaja" id="CmpCompraVehiculoDetalleImporte" size="8" maxlength="10" />                            </td>
                            <td valign="middle"><select  class="EstFormularioCombo" name="CmpCompraVehiculoDetalleEstado" id="CmpCompraVehiculoDetalleEstado">
                              <option value="0">-</option>
                              <option value="1">No Llego</option>
                              <option value="2">Da&ntilde;ado</option>
                              <option selected="selected" value="3">Conforme</option>
                            </select></td>
                            <td valign="middle"><a href="javascript:FncCompraVehiculoSimpleDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                            <td valign="middle">
              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <td width="49%" align="right"><a href="javascript:FncCompraVehiculoSimpleDetalleListar();">
                    ...
                    <!--<a href="javascript:FncCompraVehiculoSimpleDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>--></td>
...
<input name="CmpProveedorId" type="hidden" id="CmpProveedorId" value="<?php echo $InsCompraVehiculo->PrvId;?>" size="3" /></td>
                    ...
                    <td align="left" valign="top">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><a href="javascript:FncProveedorNuevo('','');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></a></td>
                          <td><input class="EstFormularioCaja" name="CmpProveedorNombreCompleto" type="text" id="CmpProveedorNombreCompleto" value="<?php echo $InsCompraVehiculo->PrvNombreCompleto;?>" size="45" maxlength="255"  />                            <a href="formularios/CompraVehiculoSimple/FrmProveedorBuscar.php?height=440&width=850" class="thickbox" title="">
			...
			?>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"> <input name="CmpComprobanteNumeroSerie" type="text" class="EstFormularioCaja" id="CmpComprobanteNumeroSerie" value="<?php echo $InsCompraVehiculo->CvhComprobanteNumeroSerie;?>" size="10" maxlength="50" />
- 
  <input name="CmpComprobanteNumeroNumero" type="text" class="EstFormularioCaja" id="CmpComprobanteNumeroNumero" value="<?php echo $InsCompraVehiculo->CvhComprobanteNumeroNumero;?>" size="20" maxlength="50" /></td>
			  ...
			  ?>
                    ...
                    <tr>
                    <td>
                    <input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncCompraVehiculoSimpleDetalleListar();" value="<?php if (empty($InsCompraVehiculo->CvhTipoCambio)){ echo "";}else{ echo $InsCompraVehiculo->CvhTipoCambio; } ?>" size="10" maxlength="10" />
                  ...
                  <tr>
                    ...
                    <td colspan="3"><iframe src="formularios/CompraVehiculoSimple/acc/AccCompraVehiculoSimpleSubirArchivo.php?Identificador=<?php echo $Identificador;?>" id="IfrCompraVehiculoSubirArchivo" name="IfrCompraVehiculoSubirArchivo" scrolling="auto"  frameborder="0" width="400" height="200"></iframe></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
