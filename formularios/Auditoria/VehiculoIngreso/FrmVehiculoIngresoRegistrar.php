...
<a id="BtnVehiculoMarcaRegistrar" onclick="FncVehiculoMarcaCargarFormulario('Registrar');" href="javascript:void(0)" title=""> <img src="imagenes/acciones/registrar.png" alt="[Registrar]" width="25" height="25" border="0" align="absmiddle" title="Registrar" /> </a> 
          ...
          <tr>
            ...
            <td align="left" valign="top"><input value="<?php echo $InsVehiculoIngreso->EinColor;?>"  class="EstFormularioCaja"  name="CmpColor" type="text" id="CmpColor" size="30" maxlength="50" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
<span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Proforma:</td>
            <td align="left" valign="top"><input  name="CmpProformaCodigo" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpProformaCodigo" value="<?php echo $InsVehiculoIngreso->VprCodigo;?>" size="30" maxlength="50" readonly="readonly" /></td>
            <td align="left" valign="top">Año/Mes Proforma</td>
            <td align="left" valign="top"><input  name="CmpProformaAno" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpProformaAno" value="<?php echo $InsVehiculoIngreso->VprAno;?>" size="10" maxlength="4" readonly="readonly" />
              /
              <?php
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Precio Proformado: </td>
            <td align="left" valign="top"><?php echo $InsVehiculoIngreso->MonSimbolo;?>
