      ...
      <table class="EstFormulario" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncVehiculoIngresoConsultaImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncVehiculoIngresoConsultaGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>VehiculoIngreso/IfrVehiculoIngresoConsulta.php" target="IfrVehiculoIngresoConsulta" id="IfrVehiculoIngresoConsulta" name="IfrVehiculoIngresoConsulta" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
