      ...
      <tr>
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td colspan="3" align="left"><input name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsEncuesta->EncId;?>" size="15" maxlength="20"  readonly="readonly"/></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="3" align="left" valign="top"><table>
              <tr>
                ...
                <td><!--<a href="javascript:FncFichaIngresoBuscar('Id');"><img src="imagenes/acciones/buscar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>--><a id="BtnFichaIngresoBuscarLista" href=" comunes/FichaIngreso/FrmFichaIngresoBuscar.php?height=440&amp;width=850" class="thickbox" title=""><img src="imagenes/acciones/buscador.png" alt="" width="25" height="25" border="0" align="absmiddle" /></a></td>
                <td></td>
                </tr>
              </table></td>
            <td>&nbsp;</td>
...
?>            </td>
          ...
          <tr>
            ...
            <?php
              ...
              <option value="EXPERIENCIA" <?php echo $opc2; ?>>EXPERIENCIA</option>
              <option value="LEALTAD" <?php echo $opc3; ?>>LEALTAD</option>
              <option value="CALIDAD DE TRABAJO" <?php echo $opc4; ?>>CALIDAD DE TRABAJO</option>
              <option value="COMUNICACIÓN" <?php echo $opc5; ?>>COMUNICACIÓN</option>
              <option value="PUNTUALIDAD" <?php echo $opc6; ?>>PUNTUALIDAD</option>
              <option value="COMPORTAMIENTO DEL CONSUMIDOR" <?php echo $opc7; ?>>COMPORTAMIENTO DEL CONSUMIDOR</option>
              <option value="EMPLEADOS" <?php echo $opc8; ?>>EMPLEADOS</option>
              <option value="INSTALACIONES" <?php echo $opc9; ?>>INSTALACIONES</option>
              <option value="LAVADO" <?php echo $opc10; ?>>LAVADO</option>
              <option value="PRECIO" <?php echo $opc11; ?>>PRECIO</option>
            </select>
