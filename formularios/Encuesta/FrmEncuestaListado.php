...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsEncuesta.js"></script>
<?php
/* 
...
$ResEncuesta = $InsEncuesta->MtdObtenerEncuestas("enc.FinId,ein.EinVIN,ein.EinPlaca,vma.VmaNombre,vmo.VmoNombre,vve.VveNombre","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"POSTVENTA",$POST_Sucursal);
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE ENCUESTAS DE POST VENTA</span></td>
</tr>
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "EncFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('EncFecha','ASC');"> Fecha Encuesta <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('EncFecha','DESC');"> Fecha Encuesta <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('EncFecha','ASC');"> Fecha Encuesta </a>
                  <?php
				}
				?></th>
                <th width="6%" ><?php
				if($POST_ord == "FinId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinId','ASC');"> Orden Trabajo <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinId','DESC');"> Orden Trabajo <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('FinId','ASC');"> Orden Trabajo  </a>
                  <?php
				}
				?></th>
                <th width="5%" ><?php
				if($POST_ord == "FinFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinFecha','ASC');"> Fecha O.T. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinFecha','DESC');"> Fecha O.T. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('FinFecha','ASC');"> Fecha O.T. </a>
                  <?php
				}
				?></th>
                <th width="17%" ><?php
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td  width="17%" align="right" ><?php echo $dat->CliNombre ?> <?php echo $dat->CliApellidoMaterno ?> <?php echo $dat->CliApellidoPaterno; ?></td>
                <td  width="6%" align="right" ><?php echo $dat->EinVIN; ?></td>
                <td  width="5%" align="right" ><?php echo $dat->EinPlaca; ?></td>
                ...
                <td  width="9%" align="right" ><?php echo ($dat->EncTiempoCreacion);?></td>
