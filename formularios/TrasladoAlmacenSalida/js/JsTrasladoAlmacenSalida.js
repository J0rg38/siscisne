...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/TrasladoAlmacenSalida/acc/AccTrasladoAlmacenSalidaGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/TrasladoAlmacenSalida/acc/AccTrasladoAlmacenSalidaGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	document.getElementById("FrmListado").action = "formularios/TrasladoAlmacenSalida/FrmTrasladoAlmacenSalidaListadoImprimir.php"
...
//						}
			...
			if(eliminar){
				...
				alert("Uno o mas de los elementos seleccionados no puede ser eliminado.");
			}
...
//1,2,3,4,5
			...
			if(actualizar){
					...
					$("#Acc").val("ActualizarTrasladoAlmacenSalidaEstadoPendiente");
				$("#FrmListado").submit();	
			}else{
...
//1,2,3,4,5
			...
			if(actualizar){
				$("#Acc").val("ActualizarTrasladoAlmacenSalidaEstadoRealizado");
				$("#FrmListado").submit();	
			}else{
				alert("Uno o mas de los elementos seleccionados no puede ser actualizado, verifique sus ESTADOS.");
			}
