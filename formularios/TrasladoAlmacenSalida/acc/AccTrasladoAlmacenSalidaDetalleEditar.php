...
//	Parametro19 = AmdEstado
			...
			$InsTrasladoAlmacenSalidaDetalle1 = array();
			$InsTrasladoAlmacenSalidaDetalle1 = $_SESSION['InsTrasladoAlmacenSalidaDetalle'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
			...
			//if(($InsProducto->ProStockReal + $InsTrasladoAlmacenSalidaDetalle1->Parametro12)<$CantidadReal){
			if($InsProducto->ProStock < $Cantidad){
				$VerificarStock = 1;
			}
			
			$_SESSION['InsTrasladoAlmacenSalidaDetalle'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro1,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro2,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro3,
			$Precio,
			$Cantidad,
			$Importe,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro7,
			date("d/m/Y H:i:s"),
			$InsUnidadMedida->UmeNombre,
			$InsUnidadMedida->UmeId,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro11,
			$CantidadReal,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro13,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro14,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro15,
			$VerificarStock,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro17,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro18,
			$InsTrasladoAlmacenSalidaDetalle1->Parametro19
			);
