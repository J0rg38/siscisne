...
if($POST_Borrar=="1"){
?>
<?php $_SESSION['SesCnoFoto1'.$Identificador] = ""; ?>
<?php	
}
?>
...
if (!empty($_FILES)) {
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg"){
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesCnoFoto1'.$Identificador] = $file_name;
...
}elseif(!empty($_SESSION['SesCnoFoto1'.$Identificador])){
	
	$extension = strtolower(pathinfo($_SESSION['SesCnoFoto1'.$Identificador], PATHINFO_EXTENSION));
	$nombre_base = basename($_SESSION['SesCnoFoto1'.$Identificador], '.'.$extension);  
?>
