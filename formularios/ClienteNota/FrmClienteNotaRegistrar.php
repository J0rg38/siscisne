...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccClienteNotaRegistrar.php');
    ...
    <!--Content-->     
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td width="759" align="left" valign="top">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
//		$InsMensaje->MtdRedireccionar("principal.php?Mod=".$GET_mod."&Form=Listado",$Registro,1500);
		$InsMensaje->MtdRedireccionar("principal.php?Mod=".$GET_mod."&Form=Listado&VdiId=".$_GET['VdiId'],$Registro,1500);
	}
