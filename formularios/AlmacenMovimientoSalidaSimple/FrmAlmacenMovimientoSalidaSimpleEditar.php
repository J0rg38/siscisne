                        ...
                        <div class="EstFormularioArea">
                          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if (empty($InsAlmacenMovimientoSalida->AmoFecha)) {
                                                                                                                                                      echo date("d/m/Y");
                                                                                                                                                    } else {
                                                                                                                                                      echo $InsAlmacenMovimientoSalida->AmoFecha;
                                                                                                                                                    } ?>" size="10" maxlength="10" /> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFecha" name="BtnFecha" width="25" height="25" align="absmiddle" style="cursor:pointer;" />
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><select class="EstFormularioCombo" name="CmpTipoOperacion" id="CmpTipoOperacion">
                                  ...
                                  ?>
                                    <option value="<?php echo $DatTipoOperacion->TopId ?>" <?php if ($InsAlmacenMovimientoSalida->TopId == $DatTipoOperacion->TopId) {
                              ...
                              <td align="left" valign="top"><select <?php echo ((!empty($InsAlmacenMovimientoSalida->FinId) or !empty($InsAlmacenMovimientoSalida->VdiId)) ? 'disabled="disabled"' : ''); ?> class="EstFormularioCombo" name="CmpClienteTipo" id="CmpClienteTipo">
                                  ...
                                  ?>
                                    <option value="<?php echo $DatClienteTipo->LtiId ?>" <?php if ($InsAlmacenMovimientoSalida->LtiId == $DatClienteTipo->LtiId) {
                                                                                          echo 'selected="selected"';
            ...
            -->
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><select class="EstFormularioCombo" name="CmpAlmacen" id="CmpAlmacen">
                                  ...
                                  ?>
                                    <option value="<?php echo $DatAlmacen->AlmId ?>" <?php if ($InsAlmacenMovimientoSalida->AlmId == $DatAlmacen->AlmId) {
                                                                                      echo 'selected="selected"';
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top"><?php
                                                            ...
                                                            ?>
                                <select d class="EstFormularioCombo" name="CmpTipoMovimiento" id="CmpTipoMovimiento">
                                  <option value="">Escoja una opcion</option>
                            ...
                            <tr>
                              <td width="98%">
                                ...
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="14"><span class="EstFormularioSubTitulo">PRODUCTOS
                        ...
                        <div class="EstFormularioArea">
                          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                            <tr>
                              ...
                              <td width="2%">
                                <div id="CapAlmacenMovimientoSalidaDetallesResultado"> </div>
                              </td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td colspan="2">
                                <div id="CapAlmacenMovimientoSalidaDetalles" class="EstCapAlmacenMovimientoSalidaSimpleDetalles"> </div>
                              </td>
                              <td>&nbsp;</td>
                            </tr>
                          </table>
