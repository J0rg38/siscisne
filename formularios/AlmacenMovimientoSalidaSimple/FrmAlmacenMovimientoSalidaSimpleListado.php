...
<?php $PrivilegioEliminar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"AlmacenMovimientoSalida","Eliminar"))?true:false;?>
<?php $PrivilegioMultisucursal = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"AlmacenMovimientoSalida","Multisucursal"))?true:false;?>

<?php $PrivilegioGenerarExcel = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"AlmacenMovimientoSalida","GenerarExcel"))?true:false;?>
...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsAlmacenMovimientoSalidaSimple.js" ></script>
<?php
/* 
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccAlmacenMovimientoSalidaSimple.php');
...
$ResAlmacenMovimientoSalida = $InsAlmacenMovimientoSalida->MtdObtenerAlmacenMovimientoSalidas("amo.AmoId",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_estado,NULL,NULL,0,0,NULL,NULL,false,NULL,"4",$POST_Sucursal);
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE SALIDA DE ALMACEN X OTRO CONCEPTO</span>  </td>
</tr>
<tr>
  <td width="47%">
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "AmoComprobanteNumero"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AmoComprobanteNumero','ASC');"> Documento <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AmoComprobanteNumero','DESC');"> Documento <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AmoComprobanteNumero','ASC');"> Documento </a>
                <?php
				}
				?></th>
                <th width="8%" ><?php
				if($POST_ord == "AmoResponsable"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AmoResponsable','ASC');"> Responsable <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AmoResponsable','DESC');"> Responsable <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AmoResponsable','ASC');"> Responsable </a>
                <?php
				}
				?></th>
                <th width="6%" ><?php
...
?>
                ...
                <td  width="6%" align="right" ><?php echo ($dat->SucNombreDestino);?></td>
                <td  width="7%" align="right" ><?php echo ($dat->AmoComprobanteNumero);?></td>
                <td  width="8%" align="right" ><?php echo ($dat->AmoResponsable);?></td>
                <td  width="6%" align="right" ><?php
				if($dat->AmoGuiaRemision == "Si"){
				?>
                  <a href="formularios/AlmacenMovimientoSalidaSimple/DiaGuiaRemisionListado.php?height=440&amp;width=850&amp;AmoId=<?php echo $dat->AmoId?>" class="thickbox" title=""><?php echo ($dat->AmoGuiaRemision); ?></a>
                  <?php	
				}else{
				?>
                ...
                <td  width="4%" align="right" ><?php echo ($dat->AmoTipoCambio);?></td>
				...
				/*switch($dat->AmoEstado){
						...
						case 1:
				?>
                  <img width="15" height="15" alt="[Transito]" title="En transito" src="imagenes/iconos/no_realizado.png" />
                  <?php
				...
				?></td>
                <td  width="3%" align="right" ><?php echo ($dat->AmoTotalItems);?></td>
...
?>
  ...
  <?php
			...
			?>
                  <a href="javascript:FncPopUp('formularios/AlmacenMovimientoSalidaSimple/FrmAlmacenMovimientoSalidaSimpleImprimir.php?Id=<?php echo $dat->AmoId;?>',0,0,1,0,0,1,0,screen.height,screen.width);"><img src="imagenes/acciones/preliminar.gif" alt="[Vista Preliminar]" title="Vista preliminar" width="19" height="19" border="0" /></a>
                  <?php
			}
			?>
			...
			?>        
                  ...
                  <a href="javascript:FncPopUp('formularios/AlmacenMovimientoSalidaSimple/FrmAlmacenMovimientoSalidaSimpleImprimir.php?Id=<?php echo $dat->AmoId;?>&P=1',0,0,1,0,1,1,0,screen.height,screen.width);"><img src="imagenes/acciones/imprimir.png" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
                  <?php
			}
			?> 
