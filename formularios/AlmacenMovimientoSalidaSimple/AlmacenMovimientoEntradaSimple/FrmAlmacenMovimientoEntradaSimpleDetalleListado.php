...
$RepAlmacenMovimientoEntradaSimpleDetalle = $_SESSION['InsAlmacenMovimientoEntradaDetalle'.$Identificador]->MtdObtenerSesionObjetos(true);
$ArrAlmacenMovimientoEntradaSimpleDetalles = $RepAlmacenMovimientoEntradaSimpleDetalle['Datos'];
...
?>
		...
		<?php
		if(empty($ArrAlmacenMovimientoEntradaSimpleDetalles)){
		?>
        ...
        ?>
            ...
            //$CantidadTotal = 0;
            //$TotalItems = 0;
            foreach($ArrAlmacenMovimientoEntradaSimpleDetalles as $DatSesionObjeto){
            ?>
            ...
            <td align="right"><?php echo $DatSesionObjeto->Parametro17;?>
...
<a target="_blank" href="principal.php?Mod=AlmacenStock&Form=Ver&Id=<?php echo $DatSesionObjeto->Parametro2;?>"   title=""> <img src="imagenes/almacen_stock.jpg" alt="[Stock]" width="20" height="20" border="0" align="absmiddle" title="Stock" /> </a>
            ...
            <a class="EstSesionObjetosItem" href="javascript:FncAlmacenMovimientoEntradaSimpleDetalleEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
            ...
            if($_POST['Eliminar']==1){
            ?>
            <a href="javascript:FncAlmacenMovimientoEntradaSimpleDetalleEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
