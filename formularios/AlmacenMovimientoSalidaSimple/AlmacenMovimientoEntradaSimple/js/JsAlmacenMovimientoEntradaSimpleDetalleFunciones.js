...
function FncAlmacenMovimientoEntradaSimpleDetalleNuevo(){
	...
	$('#CmpAlmacenMovimientoEntradaSimpleDetalleAccion').val("AccAlmacenMovimientoEntradaSimpleDetalleRegistrar.php");
...
//	var Accion = $('#CmpAlmacenMovimientoEntradaSimpleDetalleAccion').val();

//	if(Accion != "AccAlmacenMovimientoEntradaSimpleDetalleReemplazar.php"){
//		
...
function FncAlmacenMovimientoEntradaSimpleDetalleGuardar(){

	var Identificador = $('#Identificador').val();

	var Acc = $('#CmpAlmacenMovimientoEntradaSimpleDetalleAccion').val();		
			...
			if(ProductoId==""){
				...
				$('#CapProductoAccion').html('Guardando...');
						...
						$.ajax({
							type: 'POST',
							url: 'formularios/AlmacenMovimientoEntradaSimple/acc/'+Acc,
...
//								
					...
					FncAlmacenMovimientoEntradaSimpleDetalleNuevo();	
...
function FncAlmacenMovimientoEntradaSimpleDetalleListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/AlmacenMovimientoEntradaSimple/FrmAlmacenMovimientoEntradaSimpleDetalleListado.php',
		data: 'Identificador='+Identificador+
		'&Editar='+AlmacenMovimientoEntradaSimpleDetalleEditar+
		'&Eliminar='+AlmacenMovimientoEntradaSimpleDetalleEliminar+
		'&MonedaId='+MonedaId+
		...
		success: function(html){
			...
			$('#CapProductoAccion').html('Listo');	
			$("#CapAlmacenMovimientoEntradaSimpleDetalles").html("");
			$("#CapAlmacenMovimientoEntradaSimpleDetalles").append(html);
...
function FncAlmacenMovimientoEntradaSimpleDetalleEscoger(oItem){
		
	var Identificador = $('#Identificador').val();
	
	$('#CapProductoAccion').html('Editando...');
	$('#CmpAlmacenMovimientoEntradaSimpleDetalleAccion').val("AccAlmacenMovimientoEntradaSimpleDetalleEditar.php");
...
//Parametro25 = AmdEstado
	...
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/AlmacenMovimientoEntradaSimple/acc/AccAlmacenMovimientoEntradaSimpleDetalleEscoger.php',
...
/*
function FncAlmacenMovimientoEntradaSimpleDetalleEscogerReemplazo(oItem){
		
	var Identificador = $('#Identificador').val();
	
	$('#CapProductoAccion').html('Editando...');
	$('#CmpAlmacenMovimientoEntradaSimpleDetalleAccion').val("AccAlmacenMovimientoEntradaSimpleDetalleReemplazar.php");
...
function FncAlmacenMovimientoEntradaSimpleDetalleEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/AlmacenMovimientoEntradaSimple/acc/AccAlmacenMovimientoEntradaSimpleDetalleEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem,
			success: function(){
...
function FncAlmacenMovimientoEntradaSimpleDetalleEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/AlmacenMovimientoEntradaSimple/acc/AccAlmacenMovimientoEntradaSimpleDetalleEliminarTodo.php',
			data: 'Identificador='+Identificador,
			success: function(){
				$('#CapProductoAccion').html('Eliminado');	
				FncAlmacenMovimientoEntradaSimpleDetalleListar();
