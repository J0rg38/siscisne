...
function FncAlmacenMovimientoSalidaDetalleNuevo(){
	...
	$('#CmpAlmacenMovimientoSalidaSimpleDetalleAccion').val("AccAlmacenMovimientoSalidaSimpleDetalleRegistrar.php");
...
function FncAlmacenMovimientoSalidaDetalleGuardar(){
		...
		var Acc = $('#CmpAlmacenMovimientoSalidaSimpleDetalleAccion').val();		
			...
			//}else if(ProductoPrecio==""|| ProductoPrecio=="0"){
				...
				$('#CapProductoAccion').html('Guardando...');
						...
						$.ajax({
							type: 'POST',
							url: 'formularios/AlmacenMovimientoSalidaSimple/acc/'+Acc,
...
function FncAlmacenMovimientoSalidaDetalleListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/AlmacenMovimientoSalidaSimple/FrmAlmacenMovimientoSalidaSimpleDetalleListado.php',
		data: 'Identificador='+Identificador+
...
function FncAlmacenMovimientoSalidaDetalleEscoger(oItem){
	...
	$('#CmpAlmacenMovimientoSalidaSimpleDetalleAccion').val("AccAlmacenMovimientoSalidaSimpleDetalleEditar.php");
	
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/AlmacenMovimientoSalidaSimple/acc/AccAlmacenMovimientoSalidaSimpleDetalleEscoger.php',
		data: 'Identificador='+Identificador+
'&Item='+oItem,
...
function FncAlmacenMovimientoSalidaDetalleEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/AlmacenMovimientoSalidaSimple/acc/AccAlmacenMovimientoSalidaSimpleDetalleEliminar.php',
			data: 'Identificador='+Identificador+
'&Item='+oItem,
			success: function(){
...
function FncAlmacenMovimientoSalidaDetalleEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/AlmacenMovimientoSalidaSimple/acc/AccAlmacenMovimientoSalidaSimpleDetalleEliminarTodo.php',
			data: 'Identificador='+Identificador,
			success: function(){
				$('#CapProductoAccion').html('Eliminado');	
				FncAlmacenMovimientoSalidaDetalleListar();
...
function FncAlmacenMovimientoSalidaDetalleActualizarPrecio(){
	...
	var ClienteTipoId = $('#CmpClienteTipo').val();
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/AlmacenMovimientoSalidaSimple/acc/AccAlmacenMovimientoSalidaSimpleDetalleActualizarPrecio.php',
			data: 'Identificador='+Identificador+
