...
<title>Movimiento de Entrada a Almacen No. <?php echo $InsAlmacenMovimientoSalida->AmoId;?></title>
...
<tr>
    ...
    <tr>
      ...
      <td width="22%" align="left" valign="top" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo">&nbsp;</td>
    ...
    <tr>
      ...
      <td align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido">
        <?php
    switch($InsAlmacenMovimientoSalida->AmoIncluyeImpuesto){
  ...
  <?php
    ...
    ?>
      ...
      <td align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido"><?php echo $InsAlmacenMovimientoSalida->AmoPorcentajeImpuestoVenta;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
	...
	?></span></td>
      <td align="left" valign="top">&nbsp;</td>
      <td align="left" valign="top" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo">&nbsp;</td>
      <td align="left" valign="top" >&nbsp;</td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
...
?>
        ...
        <tr>
          ...
          <td align="right" class="EstReporteDetalleImprimirContenido" >
            <?php echo number_format(($DatAlmacenMovimientoSalidaDetalle->AmdCosto),2);?>
            </td>
          <td align="right" class="EstReporteDetalleImprimirContenido" >
...
<tr>
  <td align="left">&nbsp;</td>
  <td align="left">&nbsp;</td>
  <td align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo"><span class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaTotal">Impuesto (<?php echo $InsAlmacenMovimientoSalida->AmoPorcentajeImpuestoVenta;?>%):</span></td>
