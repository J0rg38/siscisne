<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"AlmacenMovimientoSalida","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"AlmacenMovimientoSalida","Listado") and empty($GET_dia)){
?>  
