...
<?php
	$TotalFichaIngreso = 0;
	$TotalVINs = count($InsCampana->CampanaVehiculo);
	$fila = 1;
  ...
  <?php
		...
		if(!empty($ArrFichaIngresos)){
			...
			foreach($ArrFichaIngresos as $DatFichaIngreso){
				...
				$RealizoCampana = true;
				$FichaIngresoFecha = $DatFichaIngreso->FinFecha;
...
<?php echo $fila;?>
            ...
            <td>
                <?php echo $DatCampanaVehiculo->AveVIN;?>
            </td>
            <td>
...
<tbody class="EstTablaListadoBody">
        ...
        <tr>
          <td>TOTAL VIN:
            ...
            <td>TOTAL O.T.</td>
            <td><?php echo $TotalFichaIngreso;?></td>
            </tr>
