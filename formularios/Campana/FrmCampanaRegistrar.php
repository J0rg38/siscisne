...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccCampanaRegistrar.php');
...
<iframe src="formularios/Campana/acc/AccCampanaArchivo1Importar.php?Identificador=<?php echo $Identificador;?>" id="IfrCampanaArchivo1Importar" name="IfrCampanaArchivo1Importar" scrolling="Auto"  frameborder="0" width="800" height="300"></iframe>
