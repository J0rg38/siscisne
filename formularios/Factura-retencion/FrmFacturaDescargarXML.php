...
$().ready(function() {
	...
	$('#CapFacturaAccion').html('Conectando con SERVIDOR para descargar archivo xml...');	
	
	setTimeout("FncFacturaDescargarXML('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncFacturaDescargarXML(oArchivo,oUrl){
