...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccFacturaConsultarEstadoCDR.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "D101":
					...
					$('#CapFacturaAccion').html('Consulta cdr solicitada correctamente. '+respuesta['MensajeRespuesta']);								
				...
				default:
					...
					$('#CapFacturaAccion').html('Ha ocurrido un error procesando el archivo xml, proceso cancelado. RESPUESTA: '+respuesta['MensajeRespuesta']);
		...
		error: function(respuesta){
			$('#CapFacturaAccion').html('Ha ocurrido un error procesando el archivo xml, proceso cancelado. RESPUESTA: '+respuesta);
