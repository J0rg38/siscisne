...
$().ready(function() {
	...
	$.ajax({
		...
		complete: function(response) {
			...
			window.setTimeout("FncFacturaFirmarBajaXML();",5000);
...
function FncFacturaFirmarBajaXML(){
...
function FncFacturaProcesarBajaXML(){
	...
	FncPopUp('FrmFacturaProcesarBajaXML.php?Nombre=<?php echo $GET_Nombre;?>&Id=<?php echo $InsFactura->FacId;?>&Ta=<?php echo $InsFactura->FtaId;?>&Procesar=<?php echo $GET_Procesar;?>&EnviarSUNAT=<?php echo $GET_EnviarSUNAT;?>&P=1',0,0,1,0,0,1,0,350,150);
