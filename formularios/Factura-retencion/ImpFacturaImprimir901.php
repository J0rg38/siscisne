...
<link href="css/CssFacturaImprimir901.css" rel="stylesheet" type="text/css" />
...
<tr>
  <td width="770" height="190" colspan="5" align="left" valign="top">
...
<tr>
<td height="223" colspan="5" valign="top">
...
?>
    ...
    if($_GET['P']!=1){ 
    ?>
        <span class="EstFacturaDetalleImprimirEtiqueta">VAL TOTAL </span>
        <?php 
    }
    ?></td>
      <td height="33" align="center" widtd="53" >&nbsp;</td>
    ...
    ?>
            <tr>
              <td width="5" align="center">&nbsp;</td>
            <td width="75" align="center"><span class="EstFacturaDetalleImprimirContenido"><?php echo $DatFacturaDetalle->FdeCantidad;?></span></td>
            <td width="5" align="right">&nbsp;</td>
            <td width="67" align="center"><span class="EstFacturaDetalleImprimirContenido"><?php echo $DatFacturaDetalle->FdeUnidadMedida;?></span></td>
            <td width="5" align="right">&nbsp;</td>
            <td width="374" align="left"><span class="EstFacturaDetalleImprimirContenido"><?php echo stripslashes( $DatFacturaDetalle->FdeDescripcion);?></span></td>
            <td align="right">&nbsp;</td>
    ...
    <?php //echo $InsFactura->MonSimbolo;?> 
     ...
     <?php echo number_format(($DatFacturaDetalle->FdePrecio),2);?>        </span>        </td>
            <td width="5" align="right">&nbsp;</td>
            <td width="90" align="right"><span class="EstFacturaDetalleImprimirContenido"><?php //echo $InsFactura->MonSimbolo;?> <?php echo number_format($DatFacturaDetalle->FdeImporte,2);?></span></td>
    ...
    ?>
          ...
          ?>
                ...
                <td align="left" valign="top">&nbsp;</td>
            <td width="90" align="right" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo number_format($MaterialImporte,2);?></span></td>
...
<tr>
  ...
  <td height="28" align="left"></td>
  <td width="330" height="28" align="center"><?php
  ...
  <td width="88" height="28" align="right"><?php if($_GET['P']!=1){ ?>
    <span class="EstFacturaImprimirEtiqueta">total</span>
    <?php }?></td>
  <td width="8" height="28" align="right">&nbsp;</td>
  <td width="114" height="28" align="right"><span class="EstFacturaImprimirContenido"><?php echo $InsFactura->MonSimbolo; ?> <?php echo number_format($Total,2);?></span></td>
  <td width="10" height="28" colspan="4" align="center">&nbsp;</td>
  </tr>
<tr>
  <td height="28">&nbsp;</td>
  <td width="42" height="28" align="right">&nbsp;</td>
