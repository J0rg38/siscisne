...
?>
        ...
        <td width="6" align="right" valign="top">&nbsp;</td>
        <td width="61" align="right" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo $DatFacturaDetalle->FdeUnidadMedida;?></span></td>
        <td width="11" align="right" valign="top">&nbsp;</td>
        <td width="391" align="left" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo stripslashes( $DatFacturaDetalle->FdeDescripcion);?></span>
