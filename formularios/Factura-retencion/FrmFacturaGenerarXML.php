...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccFacturaGenerarXML.php',
		data: 'Id=<?php echo $InsFactura->FacId;?>&Ta=<?php echo $InsFactura->BtaId;?>',
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				case "1":
					...
					if($GET_Procesar=="1"){
					?>	
						$('#CapFacturaAccion').html('Archivo xml generado correctamente, se enviara al facturador...');					
						window.setTimeout("FncFacturaEnviarXML('"+respuesta['Nombre']+"');",2500);
					...
					//FncPopUp('FrmFacturaEnviarXML.php?Nombre='+respuesta['Nombre']+'&Id=<?php echo $InsFactura->FacId;?>&Ta=<?php echo $InsFactura->BtaId;?>&Procesar=<?php echo $GET_Procesar?>&EnviarSUNAT=<?php echo $GET_EnviarSUNAT;?>&P=1',0,0,1,0,0,1,0,350,150);
...
function FncFacturaEnviarXML(oNombre){
	
	FncPopUp('FrmFacturaEnviarXML.php?Nombre='+oNombre+'&Id=<?php echo $InsFactura->FacId;?>&Ta=<?php echo $InsFactura->BtaId;?>&Procesar=<?php echo $GET_Procesar?>&EnviarSUNAT=<?php echo $GET_EnviarSUNAT;?>&P=1',0,0,1,0,0,1,0,350,150);
