...
<div class="EstFacturaImprimirCapaPrincipal">
    ...
    <img src="../../imagenes/transferencia_gratuita.png" width="306" height="240" />
    </div>
    <?php
	}
	?>
...
<tr>
  ...
  <tr>
    ...
    <tr>
      <td width="13%" align="left" valign="top"><span class="EstFacturaImprimirEtiqueta"> Señores:</span></td>
      <td colspan="3" align="left" valign="top"><span class="EstFacturaImprimirContenidoEspecial"><?php echo $InsFactura->CliNombre;?> <?php echo $InsFactura->CliApellidoPaterno;?> <?php echo $InsFactura->CliApellidoMaterno;?></span></td>
  ...
  <tr>
    ...
    <td width="25%" align="left" valign="top"><span class="EstFacturaImprimirContenido"><?php echo $InsFactura->CliNumeroDocumento;?></span></td>
    <td width="14%" align="left" valign="top"><span class="EstFacturaImprimirEtiqueta">Localidad:</span></td>
    <td width="18%" align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top"><span class="EstFacturaImprimirEtiqueta">Nª Guia: </span></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><span class="EstFacturaImprimirContenido"><?php echo $InsFactura->FacDireccion;?></span></td>
...
<tr>
  ...
  <td height="35" align="center" widtd="143" ><span class="EstFacturaDetalleImprimirEtiqueta">CANT.</span></td>
  <td height="35" align="center" widtd="54" >&nbsp;</td>
  <td height="35" align="center" widtd="54" ><span class="EstFacturaDetalleImprimirEtiqueta">UNIDAD</span></td>
  <td height="35" align="center" widtd="54" >&nbsp;</td>
  <td height="35" align="center" widtd="782" ><span class="EstFacturaDetalleImprimirEtiqueta">DESCRIPCION</span></td>
  <td width="4" height="35" align="center" widtd="18" >&nbsp;</td>
  <td height="35" align="center" widtd="104" ><span class="EstFacturaDetalleImprimirEtiqueta">P. UNIT. </span></td>
  <td height="35" align="center" widtd="84" >&nbsp;</td>
  <td height="35" align="center" widtd="53" ><span class="EstFacturaDetalleImprimirEtiqueta">VALOR TOTAL </span></td>
...
?>
        ...
        <td width="73" align="right" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo $DatFacturaDetalle->FdeCantidad;?></span></td>
        <td width="6" align="right" valign="top">&nbsp;</td>
        <td width="76" align="right" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo $DatFacturaDetalle->FdeUnidadMedida;?></span></td>
        <td width="4" align="right" valign="top">&nbsp;</td>
        <td width="408" align="left" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo stripslashes( $DatFacturaDetalle->FdeDescripcion);?></span></td>
        <td align="right" valign="top">&nbsp;</td>
        <td width="81" align="right" valign="top">
        <span class="EstFacturaDetalleImprimirContenido">        
<?php echo $InsFactura->MonSimbolo;?> 

 <?php echo number_format(($DatFacturaDetalle->FdePrecio),2);?>        </span>        </td>
        <td width="8" align="right" valign="top">&nbsp;</td>
        <td width="92" align="right" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo $InsFactura->MonSimbolo;?> <?php echo number_format($DatFacturaDetalle->FdeImporte,2);?></span></td>
...
?>
	  ...
	  ?>
            ...
            <td align="left" valign="top">&nbsp;</td>
        <td width="92" align="right" valign="top"><span class="EstFacturaDetalleImprimirContenido"><?php echo number_format($MaterialImporte,2);?></span></td>
...
<tr>
        ...
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td align="left"><span class="EstFacturaImprimirContenido"><?php echo $InsFactura->EinVIN;?><br />
            <?php echo $InsFactura->VmaNombre;?> <?php echo $InsFactura->VmoNombre;?> <?php echo $InsFactura->VveNombre;?><br />
            <?php echo $InsFactura->EinPlaca;?></span></td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
...
<tr>
  ...
  <td height="28" colspan="2" align="left"><?php
	...
	?></td>
  <td width="245" height="28" align="center">&nbsp;</td>
  <td width="22" height="28" align="right">&nbsp;</td>
  <td width="82" height="28" align="right"><span class="EstFacturaImprimirEtiqueta">sub total</span></td>
  <td width="37" height="28" align="right">&nbsp;</td>
  <td width="85" height="28" align="right">
<span class="EstFacturaImprimirContenido">

	  <?php echo $InsFactura->MonSimbolo; ?> <?php echo number_format($SubTotal,2);?></span>  </td>
  <td width="15" height="28" colspan="4" align="center">&nbsp;</td>
  </tr>
<tr>
  <td height="28">&nbsp;</td>
  <td width="51" height="28" align="right">&nbsp;</td>
  <td width="224" align="left" valign="top"></td>
  <td height="28" align="center"><?php
  ...
  <td height="28" align="right"><span class="EstFacturaImprimirEtiqueta">i.g.v. 19%</span></td>
