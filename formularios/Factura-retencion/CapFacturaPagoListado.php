...
$GET_FacId = $_POST['FacId'];
$GET_FtaId = $_POST['FtaId'];
...
if(empty($GET_FacId) and empty($GET_FtaId) and empty($GET_VdiId) and empty($GET_OvvId) and empty($GET_PagId) and empty($GET_FinId)){
...
<!-- <span class="EstFormularioTitulo">OTROS ABONOS RELACIONADOS</span> 
 -->
  ...
  <?php
//deb($InsFactura->VdiId);
if(!empty($GET_FacId) and !empty($GET_FtaId)){
	...
	$ResPago = $InsPago->MtdObtenerPagos("PagId,OvvId,FacId","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,NULL,NULL,$POST_CondicionPago,$POST_Moneda,$GET_FacId,$GET_FtaId,NULL,NULL);
