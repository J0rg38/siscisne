...
$ResFactura = $InsFactura->MtdObtenerFacturas("fta.Ftanumero,fac.FacId,cli.CliNombreCompleto,cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,cli.CliNumeroDocumento,fac.AmoId,fim.FinId,amo.VdiId,vdi.VdiOrdenCompraNumero,fac.OvvId,fac.FacDatoAdicional8",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$_SESSION['SesionSucursal'],$POST_estado,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_tal,NULL,NULL,$POST_npago,NULL,$POST_Moneda,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,$POST_Sucursal,$MostrarNoProcesados,$POST_Cancelado);
...
<!--<br />-->
     ...
     <select  class="EstFormularioCombo" name="Talonario" id="Talonario">
		...
		<option value="" >Todos</option>
      	<option value="Si" <?php if($POST_Cancelado=="Si"){ echo 'selected="selected"';}?>>Si</option>
		<option value="No" <?php if($POST_Cancelado=="No"){ echo 'selected="selected"';}?>>No</option>
		</select>
