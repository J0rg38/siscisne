...
<?php
if($PrivilegioEliminar & $dat->FacCierre==1 & $dat->FacNotaCredito=="No"  and $dat->FacSunatUltimaAccion != "ALTA" and $dat->FacSunatUltimaRespuesta != "APROBADO"){
?> 
...
<?php
if($PrivilegioPagoRegistrar and $dat->FacEstado <> 6 and $dat->FacMontoPendiente > 0){
?>
