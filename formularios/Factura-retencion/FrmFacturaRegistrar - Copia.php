			...
			?>
               ...
               <tr>
                 ...
                 <td align="left" valign="top"><span id="sprytextfield1">
                   <label>
                     <input tabindex="6" class="EstFormularioCajaFecha" name="CmpFechaVencimiento" type="text" id="CmpFechaVencimiento" value="<?php  echo $InsFactura->FacFechaVencimiento; ?>" size="10" maxlength="10" />
                   </label>
