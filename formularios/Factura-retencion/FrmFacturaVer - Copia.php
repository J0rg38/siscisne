         ...
         <td colspan="2" valign="top"><div class="EstFormularioArea" >
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpClienteEmail" type="text" class="EstFormularioCaja" id="CmpClienteEmail" tabindex="5" value="<?php echo $InsFactura->FacEmail;?>" size="45" maxlength="255" readonly="readonly"  /></td>
               <td>&nbsp;</td>
			...
			?>
             ...
             <tr>
               ...
               <td align="left" valign="top"><span id="sprytextfield1">
                 <label>
                   <input name="CmpFechaVencimiento" type="text" class="EstFormularioCajaFecha" id="CmpFechaVencimiento" tabindex="6" value="<?php echo $InsFactura->FacFechaVencimiento;?>" size="10" maxlength="10" readonly="readonly" />
                 </label>
               </span></td>
               <td align="left" valign="top">&nbsp;</td>
