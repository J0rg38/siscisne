...
<tr>
  ...
  <th width="49" rowspan="2">Tipo</th>
  <th width="9%" rowspan="2">Codigo</th>
  <th width="517" rowspan="2"> Descripci&oacute;n</th>
  <th width="61" rowspan="2">U.M.</th>
  <th width="78" rowspan="2">p/unitario</th>
  <th width="83" rowspan="2">Cantidad</th>
  <th width="85" rowspan="2">Desc.</th>
  <th width="85" rowspan="2">V. Venta</th>
  <th width="85" rowspan="2">Importe</th>
  <th colspan="3" valign="middle">Opciones</th>
  <th width="109" rowspan="2"> Acc.</th>
</tr>
<tr>
...
foreach($ArrSesionObjetos as $DatSesionObjeto2){
  $ImporteTotalOriginal += number_format($DatSesionObjeto2->Parametro6,2);
  $TotalDescuentoOriginal += $DatSesionObjeto2->Parametro21;
}
...
<td width="78" align="right" valign="top">
  ...
  <?php 
    ...
    $PorcentajePrecioIndividual = ($DatSesionObjeto->Parametro6 * 100)/$ImporteTotalOriginal;
    $PrecioUnitarioDescuento = (($PorcentajePrecioIndividual * $TotalDescuentoOriginal)/100)/$DatSesionObjeto->Parametro5;
    $NuevoPrecioUnitario = $DatSesionObjeto->Parametro4 - $PrecioUnitarioDescuento;
    echo round($NuevoPrecioUnitario, 2);
    //echo number_format(($DatSesionObjeto->Parametro4),2);
    // echo $PorcentajePrecioIndividual."%";
  ?>
...
<td width="85" align="right" valign="top">
  <?php
    $NuevoValorVentaIndividual = (($NuevoPrecioUnitario * $DatSesionObjeto->Parametro5)/1.18)/$DatSesionObjeto->Parametro5;
    $NuevoValorVentaConsolidado = $NuevoValorVentaIndividual * $DatSesionObjeto->Parametro5;
    echo round($NuevoValorVentaConsolidado, 2);
    //echo number_format($DatSesionObjeto->Parametro19,2);
  ?>
</td>
<td width="85" align="right" valign="top">
 
  <?php 
    $NuevoImporte = $NuevoPrecioUnitario * $DatSesionObjeto->Parametro5;
    echo round($NuevoImporte, 2);
    //echo number_format($DatSesionObjeto->Parametro6,2);
  
  ?> 
 
</td>
<td width="31" align="center" valign="top"><?php 
...
?></td>
<td width="35" align="center" valign="top"><?php 
...
<?php
	...
	*/
    ...
    // SI EXISTE DESCUENTO
    $TotalGravado += $NuevoValorVentaConsolidado;
...
?>
    ...
    <tr>
      <td>Año Mod.</td>
      <td>:</td>
      <td><?php echo $_SESSION['InsFacturaDatoAdicional27'.$Identificador]?></td>
      <td>No. Puertas</td>
      <td>&nbsp;</td>
