...
if (ftp_get($conn_id, $local_file, $remote_file, FTP_BINARY)) {
	...
	//	deb($xml_values[42]['value']);
		...
		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioDigestValue",$digestvalue,$InsFactura->FacId,$InsFactura->FtaId);
		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioSignatureValue",$signaturevalue,$InsFactura->FacId,$InsFactura->FtaId);
...
//		*/
//		
//		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioTicket",$xml_values[31]['value'],$InsFactura->FacId,$InsFactura->FtaId);
//		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioFecha",$xml_values[34]['value'],$InsFactura->FacId,$InsFactura->FtaId);
//		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioHora",$xml_values[35],$InsFactura->FacId,$InsFactura->FtaId);
//		
//		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioCodigo",$xml_values[65]['value'],$InsFactura->FacId,$InsFactura->FtaId);
//		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioContenido",$xml_values[66]['value'],$InsFactura->FacId,$InsFactura->FtaId);
...
//		$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaTicket",(!empty($xml_values[31]['value'])?$xml_values[31]['value']:$InsFactura->FacSunatRespuestaTicket),$InsFactura->FacId,$InsFactura->FtaId);
