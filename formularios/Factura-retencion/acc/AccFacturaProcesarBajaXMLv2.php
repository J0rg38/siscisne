...
//TICKET ENVIO
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaTicket",$Trama['TicketRespuesta'],$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaFecha",date("Y-m-d"),$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaHora",date("H:i:s"),$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaCodigo",$Trama['CodigoRespuesta'],$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaContenido",$Trama['MensajeRespuesta'],$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaTiempoCreacion",date("Y-m-d H:i:s"),$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
//$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaRespuesta",$UltimaRespuesta,$InsResumenBaja->FacId,$InsResumenBaja->FtaId);

//HISTORIAL OBSERVACIONES
$Observaciones = $InsFactura->FacSunatRespuestaObservacion;
$Observaciones .= date("d/m/Y h:i:s")." - ".$Trama['MensajeRespuesta'].chr(13);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaObservacion",$Observaciones,$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
//ULTIMO TICKET
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaTicket",(!empty($Trama['TicketRespuesta'])?$Trama['TicketRespuesta']:$InsFactura->FacSunatRespuestaTicket),$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaTicketEstado","",$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
//ACCIONES
$InsFactura->MtdEditarFacturaDato("FacSunatUltimaAccion","BAJA",$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatUltimaRespuesta",$UltimaRespuesta,$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
...
//$InsResumenBaja->MtdEditarResumenBajaDato("FacSunatRespuestaBajaRespuesta",$UltimaRespuesta,$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
...
//ULTIMO TICKET
$InsResumenBaja->MtdEditarResumenBajaDato("RbaSunatRespuestaTicket",(!empty($Trama['TicketRespuesta'])?$Trama['TicketRespuesta']:$InsFactura->FacSunatRespuestaTicket),$InsResumenBaja->RbaId);
$InsResumenBaja->MtdEditarResumenBajaDato("RbaSunatRespuestaTicketEstado","",$InsResumenBaja->RbaId);
//$InsResumenBaja->MtdEditarResumenBajaDato("FacSunatUltimaAccion","BAJA",$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
//$InsResumenBaja->MtdEditarResumenBajaDato("FacSunatUltimaRespuesta",$UltimaRespuesta,$InsResumenBaja->FacId,$InsResumenBaja->FtaId);
