...
$InsResumenBaja = new ClsResumenBaja();
$InsResumenBaja->FacId = $InsFactura->FacId;
$InsResumenBaja->FtaId = $InsFactura->FtaId;
...
//$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaBajaId",$BajaNumeracion,$InsFactura->FacId,$InsFactura->FtaId);
