...
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"Listado") and empty($GET_dia)){
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Resumen"><img src="imagenes/iconos/resumen.png" alt="[Resumen]"  title="Ir a formulario de resumen" />Resumen</a></div>
<?php
}
?>
