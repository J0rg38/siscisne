...
function FncProductoCargarFormulario(oForm,oProductoId){
	...
	tb_show(this.title,'principal2.php?Mod=Producto&Form='+oForm+'&Dia=1&Id='+oProductoId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
