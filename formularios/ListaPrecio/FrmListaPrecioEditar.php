...
//deb($ArrProductoTipoUnidadMedidaSalidas);

//echo count($ArrProductoTipoUnidadMedidaSalidas);
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">EDITAR PRECIO DE PRODUCTO</span></td>
      </tr>
      <tr>
        <td>
              ...
              <td align="left" valign="top">
                  ...
                  <div class="EstFormularioArea" >
                    <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                      <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><span class="EstFormularioSubTitulo"> Datos del Producto </span>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"><input name="CmpSucursalId" type="hidden" class="EstFormularioCajaDeshabilitada" id="CmpSucursalId" value="<?php echo $_SESSION['SesionSucursal'];?>" size="20" maxlength="20" readonly="readonly" /></td>
                        <td align="left" valign="top">&nbsp;</td>
                        <td align="left" valign="top">&nbsp;</td>
                        <td align="left" valign="top">&nbsp;</td>
                        <td>&nbsp;</td>
...
$ProductoCostoIngreso = $InsProducto->ProListaPrecioCosto * $UnidadMedidaEquivalente;

?>
<table border="0" cellpadding="2" cellspacing="2">
  <tr>
                              <td colspan="6" align="center">Equivalente: <input class="EstFormularioCaja" name="CmpUnidadMedidaEquivalente" type="text" id="CmpUnidadMedidaEquivalente" value="<?php echo $UnidadMedidaEquivalente;?>" readonly="readonly" /></td>
                              </tr>
                            <tr>
							...
							<input type="hidden" name="CmpUnidadMedidaIngreso" id="CmpUnidadMedidaIngreso" value="<?php echo $InsProducto->UmeIdIngreso;?>" />
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top">
								...
								<input name="CmpCosto" type="text" class="EstFormularioCaja" id="CmpCosto" value="<?php echo number_format($InsProducto->ProCosto,2);?>" size="8" maxlength="15" />
                                

								</td>
                              <td align="left" valign="top">&nbsp;</td>
                              <td align="left" valign="top">Costo:</td>
                              <td align="left" valign="top"><input name="CmpCostoIngreso" type="text" class="EstFormularioCaja" id="CmpCostoIngreso" value="<?php echo number_format($ProductoCostoIngreso,2);?>" size="8" maxlength="15" /></td>
                              <td align="left" valign="top">&nbsp;</td>
                            </tr>
                            <tr>
                              <td align="left" valign="top">&nbsp;</td>
...
(<?php echo ($DatClienteTipo->LtiId);?>)
    ...
    foreach($ArrProductoTipoUnidadMedidaSalidas as $DatProductoTipoUnidadMedidaSalida){
		...
		//MtdObtenerListaPrecios($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'LprId',$oSentido = 'Desc',$oPaginacion = '0,10',$oProducto=NULL,$oClienteTipo=NULL,$oUnidadMedida=NULL,$oSucursal=NULL)
		$InsListaPrecio = new ClsListaPrecio();
		$ResListaPrecio = $InsListaPrecio->MtdObtenerListaPrecios(NULL,NULL,NULL,'LprId','ASC','1',$InsProducto->ProId,$DatClienteTipo->LtiId,$DatProductoTipoUnidadMedidaSalida->UmeId,$_SESSION['SesionSucursal']);
		...
		//deb($DatClienteTipo->LtiNombre." - ".$DatProductoTipoUnidadMedidaSalida->UmeNombre." - ".$UnidadMedidaEquivalente);
		...
		if(!empty($ArrListaPrecios)){
			foreach($ArrListaPrecios as $DatListaPrecio){
				...
				$ListaPrecioEquivalente = (empty($DatListaPrecio->LprEquivalente)?1:$DatListaPrecio->LprEquivalente);
		...
		//AUX
		$ListaPrecioEquivalente = (empty($ListaPrecioEquivalente)?$UnidadMedidaEquivalente:$ListaPrecioEquivalente);
		$ListaPrecioCosto = (empty($ListaPrecioCosto)?($InsProducto->ProCosto*$ListaPrecioEquivalente):$ListaPrecioCosto);
		
		//deb($ListaPrecioCosto);
...
<!--CmpListaPrecioId_<?php echo $DatClienteTipo->LtiId;?>_<?php echo $DatProductoTipoUnidadMedidaSalida->UmeId;?>     
   -->
...
<?php	
	...
	//AUX
		...
		$ListaPrecioCosto = (empty($ListaPrecioCosto)?($InsProducto->ProCosto*$ListaPrecioEquivalente):$ListaPrecioCosto);
				...
				//deb($DatClienteTipo->LtiNombre." - ".$DatProductoTipoUnidadMedidaSalida->UmeNombre." - ".$UnidadMedidaEquivalente." - ".$ListaPrecioCosto);
...
<input ubicacion="<?php echo $Ubicacion;?>" etiqueta="precio" cliente_tipo="<?php echo $DatClienteTipo->LtiId;?>" unidad_medida="<?php echo $DatProductoTipoUnidadMedidaSalida->UmeId;?>"  name="CmpListaPrecioPrecio_<?php echo $DatClienteTipo->LtiId;?>_<?php echo $DatProductoTipoUnidadMedidaSalida->UmeId;?>" type="text" class="EstFormularioCaja" id="CmpListaPrecioPrecio_<?php echo $DatClienteTipo->LtiId;?>_<?php echo $DatProductoTipoUnidadMedidaSalida->UmeId;?>" value="<?php echo ($ListaPrecioPrecio);//echo number_format($ListaPrecioPrecio,2);?>" size="8" maxlength="15" /></td>
    <?php
