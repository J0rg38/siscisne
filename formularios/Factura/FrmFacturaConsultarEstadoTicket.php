...
//deb($InsFactura->FacSunatRespuestaTicket);
?>
...
$().ready(function() {
	...
	$('#CapFacturaAccion').html('Conectando con SUNAT para consultar estado de ticket...');	
	
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccFacturaConsultarEstadoTicket.php',
		data: 'Id=<?php echo $InsFactura->FacId;?>&Ta=<?php echo $InsFactura->FtaId;?>&Ticket=<?php echo $InsFactura->FacSunatRespuestaTicket;?>',
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "C101":
					...
					$('#CapFacturaAccion').html('Consulta de estado de ticket procesado correctamente. RESPUESTA: '+respuesta['MensajeRespuesta']);				
				...
				default:
					$('#CapFacturaAccion').html('Ha ocurrido un error consultando el estado del ticket, proceso cancelado.');
