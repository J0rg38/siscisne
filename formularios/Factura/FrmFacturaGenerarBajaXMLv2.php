...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccFacturaGenerarBajaXMLv2.php',
			...
			switch(respuesta['CodigoRespuesta']){
				case "1":
					...
					?>	
						...
						window.setTimeout("FncFacturaProcesarBajaXML('"+respuesta['Id']+"');",2500);
					<?php	
					}else{
					?>
...
function FncFacturaProcesarBajaXML(oId){
	
	FncPopUp("FrmFacturaProcesarBajaXMLv2.php?Id="+oId+"&Procesar=<?php echo $GET_Procesar?>&EnviarSUNAT=<?php echo $GET_EnviarSUNAT;?>&P=1",0,0,1,0,0,1,0,350,150);
