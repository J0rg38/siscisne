...
?>
	...
	<?php $PrivilegioPagoVer = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'], "Pago", "Ver")) ? true : false; ?>
...
*/
	...
	$ResFactura = $InsFactura->MtdObtenerFacturas("fta.Ftanumero,fac.FacId,cli.CliNombreCompleto,cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,cli.CliNumeroDocumento,fac.AmoId,fim.FinId,amo.VdiId,vdi.VdiOrdenCompraNumero,fac.OvvId,fac.FacDatoAdicional8", $POST_con, $POST_fil, $POST_ord, $POST_sen, $POST_pag, $_SESSION['SesionSucursal'], $POST_estado, FncCambiaFechaAMysql($POST_finicio), FncCambiaFechaAMysql($POST_ffin), $POST_tal, NULL, NULL, $POST_npago, NULL, $POST_Moneda, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, $MostrarNoProcesados, $POST_Cancelado);
...
<?php
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="25" colspan="2">
						...
						<span class="EstFormularioTitulo">LISTADO DE FACTURAS</span>
					</td>
				</tr>
				<tr>
					<td width="46%">
							...
							<table width="100%" border="0" cellpadding="2" cellspacing="4" class="EstTablaTotales">
								<tr>
									...
									<td width="20%" align="right" class="EstTablaTotalesEtiqueta">IMPUESTO: <span class="EstMonedaSimbolo">
											<?php echo $InsMoneda->MonSimbolo; ?></span></td>
									<td width="15%" align="right" class="EstTablaTotalesContenido">
	...
	<option value="FacId" <?php if ($POST_cam == "FacId") {
								echo 'selected="selected"';
							} ?>>Id</option>
	...
	<option value="CliNumeroDocumento" <?php if ($POST_cam == "CliNumeroDocumento") {
											echo 'selected="selected"';
										} ?>><span title="Numero de Documento">Num. Doc.</span> de Cliente</option>
    <option value="FacOrdenNumero" <?php if ($POST_cam == "FacOrdenNumero") {
										echo 'selected="selected"';
									} ?>>Num. Orden</option>
    <option value="FacSIAFNumero" <?php if ($POST_cam == "FacSIAFNumero") {
										echo 'selected="selected"';
									} ?>>Num. SIAF</option>
    <option value="FacTotal" <?php if ($POST_cam == "FacTotal") {
									echo 'selected="selected"';
								} ?>>Total</option>
						...
						<select class="EstFormularioCombo" name="Talonario" id="Talonario">
							...
							?>
								<option <?php if ($POST_tal == $DatFacturaTalonario->FtaId) {
											echo 'selected="selected"';
										} ?> value="<?php echo $DatFacturaTalonario->FtaId; ?>"><?php echo $DatFacturaTalonario->FtaNumero; ?></option>
							<?php
							}
							?>
						</select>
						...
						Cancelado:
						<select class="EstFormularioCombo" name="Cancelado" id="Cancelado">
							<option value="">Todos</option>
							<option value="Si" <?php if ($POST_Cancelado == "Si") {
													echo 'selected="selected"';
												} ?>>Si</option>
							<option value="No" <?php if ($POST_Cancelado == "No") {
													echo 'selected="selected"';
												} ?>>No</option>
						</select>
						...
						<select class="EstFormularioCombo" name="Estado" id="Estado">
							...
							<option value="7" <?php if ($POST_estado == 7) {
													echo 'selected="selected"';
												} ?>>Reservado</option>
						</select>
						Moneda:
						...
						<select name="CondicionPago" id="CondicionPago" class="EstFormularioCombo">
							...
							?>
								<option <?php if ($POST_npago == $DatCondicionPago->NpaId) {
											echo 'selected="selected"';
								...
								<tr>
									...
									<td colspan="26" align="center">
										...
										<select class="EstFormularioCombo" onChange="javascript:FncListar(this.value);" name="Num" id="Num">
											...
											<option <?php if ($POST_num == $FacturasTotal) {
														echo 'selected="selected"';
													} ?> value="<?php echo $FacturasTotal; ?>">Todos</option>
										</select>
							...
							<tbody class="EstTablaListadoBody">
								...
								?>
									...
									<tr id="Fila_<?php echo $f; ?>">
										<td align="center" bgcolor="<?php echo $Color; ?>"><?php echo $f; ?></td>
										<td align="center">




											<input indice="<?php echo $f; ?>" onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->FacId . "%" . $dat->FtaId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FacId . "%" . $dat->FtaId; ?>" cliente="<?php echo $dat->CliId; ?>" estado="<?php echo $dat->FacEstado; ?>" nota_credito="<?php echo $dat->FacNotaCredito; ?>" respuesta="<?php echo $dat->FacSunatRespuestaEnvioCodigo; ?>" sunat_ultima_accion="<?php echo $dat->FacSunatUltimaAccion; ?>" sunat_ultima_respuesta="<?php echo $dat->FacSunatUltimaRespuesta; ?>" cierre="<?php echo $dat->FacCierre; ?>" />
                ...
                <?php	
                  ...
                  <a href="javascript:FncVentaDirectaCargarFormulario('Ver','<?php echo $dat->VdiId; ?> ');"><?php echo $dat->VdiId; ?></a>      -->
											...
											?>
												<?php
												if ($PrivilegioPagoVer) {
												?>

													<a href="javascript:FncPagoVistaPreliminar('<?php echo $dat->PagId; ?>');"><?php echo $dat->PagId; ?></a>
										...
										<td align="right">
											...
											?>
												<img width="25" height="25" alt="[Si]" title="Cancelado " src="imagenes/estado/pagado_si.png" />
											<?php
											} elseif ($dat->FacCancelado == 2) {
											?>
												<img width="25" height="25" alt="[No]" title="Sin Cancelar" src="imagenes/estado/pagado_no.png" />
											<?php
											}
											?>
										...
										<td align="right"><?php echo ($dat->FacDiaTranscurrido); ?></td>
										...
										<td align="center">
											...
											<?php
											if ($PrivilegioEliminar & $dat->FacCierre == 2 & $dat->FacNotaCredito == "No"  and $dat->FacSunatUltimaAccion != "ALTA" and $dat->FacSunatUltimaRespuesta != "APROBADO") {
											?>
											...
											<?php
											if ($PrivilegioEditar & $dat->FacCierre == 2 & $dat->FacNotaCredito == "No" and $dat->FacSunatUltimaAccion != "ALTA" and $dat->FacSunatUltimaRespuesta != "APROBADO") {
											?>
											...
											?>
												...
												<a href="principal.php?Mod=<?php echo $GET_mod; ?>&Form=Editar&Id=<?php echo $dat->FacId; ?>&Ta=<?php echo $dat->FtaId; ?>"><img src="imagenes/acciones/acc_editar_especial.png" width="19" height="19" border="0" title="Editar" alt="[Editar]" /></a>
...
<?php
											...
											<?php
											if ($PrivilegioPagoRegistrar and (($dat->FacEstado <> 6 and $dat->FacCancelado == 2) || $PrivilegioEditarEspecial)) {
											?>
											...
											if ($PrivilegioPagoListado) {
											?>
												<a href="javascript:FncPagoFacturaCargarFormulario('Listado','<?php echo $dat->FacId; ?>','<?php echo $dat->FtaId; ?>');"><img src="imagenes/acciones/abonos_listado.png" alt="[Listar Pagos]" title="Listar Pagos" width="19" height="19" border="0" /></a>
											<?php
											}
											?>
											<?php
