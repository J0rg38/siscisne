...
if (!isset($_SESSION['InsFacturaLetra' . $Identificador])) {
	...
	$_SESSION['InsFacturaLetra' . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsFacturaLetra' . $Identificador]);
}
			...
			?>
				<tr>
					...
					<td align="center">
						...
						if ($_POST['Editar'] == 1) {
						?>
							<a class="EstSesionObjetosItem" href='javascript:FncFacturaLetraEscoger("<?php echo $DatSesionObjeto->Item; ?>");'><img border="0" align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25" /></a>
