...
function FncFacturaDetalleListar() {
  ...
  var RegimenId = $("#CmpRegimenId").val();
  var RegimenMonto = $("#CmpRegimenMonto").val();
  var RegimenPorcentaje = $("#CmpRegimenPorcentaje").val();
  ...
  $.ajax({
    ...
    data:
      ...
      RegimenPorcentaje +
      "&Editar=" +
      FacturaDetalleEditar +
      "&Eliminar=" +
      FacturaDetalleEliminar,
