...
<link href="css/CssFacturaImprimir103.css" rel="stylesheet" type="text/css" />
...
<tr>
  <td width="385" height="180"  align="left" valign="top">
  ...
  <td width="385"  align="right" valign="top"><?php
  ...
  <tr>
    ...
    <tr>
      <td width="14%" align="left" valign="top"><?php if($_GET['P']!=1){ ?>
        ...
        <?php }?></td>
      <td colspan="3" align="left" valign="top"><span class="EstFacturaImprimirContenido"> <?php echo $InsFactura->CliApellidoPaterno;?> <?php echo $InsFactura->CliApellidoMaterno;?> <?php echo $InsFactura->CliNombre;?></span></td>
  ...
  <tr>
    <td align="left" valign="top"><?php if($_GET['P']!=1){ ?>
      ...
      <?php }?></td>
    <td width="24%" align="left" valign="top"><span class="EstFacturaImprimirContenido"><?php echo $InsFactura->CliNumeroDocumento;?></span></td>
    <td width="14%" align="left" valign="top"><?php if($_GET['P']!=1){ ?>
...
<tr>
<td height="630" colspan="2"  valign="top">
...
?>
            ...
            <span class="EstFacturaDetalleImprimirContenido"><?php echo $DatFacturaDetalle->FdeUnidadMedida;?></span>
            ...
            <span class="EstFacturaDetalleImprimirContenido"><?php echo stripslashes( $DatFacturaDetalle->FdeDescripcion);?></span>
...
<span class="EstFacturaDetalleImprimirContenido"><?php //echo $InsFactura->MonSimbolo;?> <?php echo number_format($DatFacturaDetalle->FdeImporte,2);?></span>
<?php	
}
?>
...
<tr>
  ...
  <td width="239" height="28" align="center">&nbsp;</td>
  <td width="11" height="28" align="right">&nbsp;</td>
  <td width="83" height="28" align="right"><?php if($_GET['P']!=1){ ?><span class="EstFacturaImprimirEtiqueta">sub total</span><?php }?></td>
  <td width="34" height="28" align="right">&nbsp;</td>
  <td width="113" height="28" align="right">
  <span class="EstFacturaImprimirContenido">
    
    <?php echo $InsFactura->MonSimbolo; ?> <?php echo number_format($SubTotal,2);?></span>  
...
<tr>
  ...
  <td height="28" align="right"><?php if($_GET['P']!=1){ ?><span class="EstFacturaImprimirEtiqueta">i.g.v. 19%</span><?php }?></td>
