...
//deb($xml_values);
		...
		/*
			...
			*/
			...
			$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioTicket",$TicketRespuesta,$InsFactura->FacId,$InsFactura->FtaId);
			$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioFecha",$FechaRespuesta,$InsFactura->FacId,$InsFactura->FtaId);
			$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioHora",$HoraRespuesta,$InsFactura->FacId,$InsFactura->FtaId);
			
			$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioCodigo",$CodigoRespueta,$InsFactura->FacId,$InsFactura->FtaId);
			$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaEnvioContenido",$MensajeRespuesta,$InsFactura->FacId,$InsFactura->FtaId);
