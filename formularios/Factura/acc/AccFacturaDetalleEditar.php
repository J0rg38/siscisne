...
if($POST_IncluyeImpuesto=="1"){
	...
	if($POST_Exonerado == "1"){		
		...
		if($POST_Gratuito=="1"){
			...
			// $ValorVentaUnitario = $PrecioUnitario/1.18;
			// $DescuentoIndividual = $Descuento/$Cantidad;
			// $ValorVentaIndividual = $ValorVentaUnitario+$DescuentoIndividual;

			// $ValorVenta = ($ValorVentaIndividual*$Cantidad)-$Descuento;
			// $ValorVenta = $ValorVentaIndividual;
