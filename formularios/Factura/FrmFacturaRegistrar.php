             ...
             <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
			  ...
			  ?>
                       ...
                       <td>
                         ...
                         N&deg;.
                         <input name="CmpId" type="text" class="EstFormularioCaja" id="CmpId" tabindex="1" value="<?php echo $InsFactura->FacId;?>" size="20" maxlength="20" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?> /></td>
                       <td>
...
?>
			  ...
			  ?>
                 ...
                 <td align="left" valign="top"><table>
                   <tr>
                     <td><input name="CmpTipoCambio" type="text"  class="EstFormularioCaja" id="CmpTipoCambio" onchange="FncFacturaDetalleListar();" value="<?php if (empty($InsFactura->FacTipoCambio)){ echo "";}else{ echo $InsFactura->FacTipoCambio; } ?>" size="10" maxlength="10" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?> /></td>
                     <td>
...
Enviar a SUNAT <br />   
                 ...
                 <td align="left" valign="top"><input name="CmpAbono" type="text" class="EstFormularioCaja" id="CmpAbono" value="<?php echo number_format($InsFactura->FacAbono,2);?>" size="10" maxlength="10" /></td>
                 <td align="left" valign="top">&nbsp;</td>
               </tr>
               </table>
