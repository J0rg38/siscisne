...
if(empty($POST_ord)){
	$POST_ord = 'VehTiempoModificacion';
}
...
$ResVehiculo = $InsVehiculo->MtdObtenerVehiculos($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,NULL,NULL,$POST_VehiculoTipo,$POST_est);
...
<tr>
      ...
      <tr>
        ...
        <th width="11%" ><?php
          ...
          <?php
				...
				?></th>
        <th width="8%" ><?php
				if($POST_ord == "VehColor"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('VehColor','ASC');"> Color <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('VehColor','DESC');"> Color <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
          <?php
					}
				}else{
          ...
          <?php
				...
				?></th>
        <th width="2%" ><span title="Foto de Referencia">F</span></th>
        <th width="2%" ><span title="Archivo de Especificaciones">AE</span></th>
        <th width="7%" >
          <?php
				if($POST_ord == "VehTiempoModificacion"){
					if($POST_sen == "DESC"){
				?>
          
          <a href="javascript:FncOrdenar('VehTiempoModificacion','ASC');">
            U.A.
            <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" />				</a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('VehTiempoModificacion','DESC');">
  ...
  <tbody class="EstTablaListadoBody">
    ...
    <tr id="Fila_<?php echo $f;?>">
      ...
      <td align="right" valign="middle" width="8%"   ><?php echo $dat->VehId;  ?></td>
      <td align="right" valign="middle" width="29%"   ><?php echo $dat->VehNombre;  ?></td>
      <td align="right" valign="middle" width="8%"   ><?php echo $dat->VtiNombre; ?></td>
      <td align="right" valign="middle" width="8%"   ><?php echo $dat->VmaNombre; ?></td>
      <td align="right" valign="middle" width="8%"   ><?php echo $dat->VmoNombre; ?></td>
      <td  width="11%" align="right" ><?php echo $dat->VveNombre; ?></td>
      <td  width="8%" align="right" ><?php echo $dat->VehColor; ?></td>
      <td align="right" >
...
?></td>
      ...
      <td  width="7%" align="right" ><?php echo ($dat->VehTiempoModificacion);?></td>
