...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsFichaIngresoModalidadIngresoFunciones.js" ></script>

<!-- ARCHIVO DE ESTILOS CSS -->
<style type="text/css">
@import url('<?php echo $InsProyecto->MtdFormulariosCss($GET_mod);?>CssFichaIngresoModalidadIngreso.css');
</style>
<?php
...
$GET_id = $_GET['Id'];
//MENSAJES
include($InsProyecto->MtdFormulariosMsj($GET_mod).'MsjFichaIngresoModalidadIngreso.php');
//CLASES
...
//if($InsFichaIngreso->FinEstado == 2 || $InsFichaIngreso->FinEstado == 3  || $InsFichaIngreso->FinEstado == 4){
	include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccFichaIngresoModalidadIngresoEditar.php');
//}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        MODALIDAD DE INGRESO DE ORDEN DE TRABAJO (RECEPCION)</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
?>
    <tr>
      <td width="297" height="30" align="left" valign="middle">
      ...
      <td width="203" height="30" align="center" valign="middle">
      ...
      <td width="21" align="center" valign="middle">--&gt;</td>
      <td width="143" height="30" align="left" valign="middle">
        
        <?php
		if(empty($aux)){
		?>
        
        <select name="CmpFichaIngresoModalidadCopiar_<?php echo $DatModalidadIngreso->MinSigla?>"  id="CmpFichaIngresoModalidadCopiar_<?php echo $DatModalidadIngreso->MinSigla?>" >
		...
		?>
		  ...
		  if($DatFichaIngresoModalidad->MinId<>"MIN-10001"){
			?>
          <option value="<?php echo $DatFichaIngresoModalidad->FimId?>"><?php echo $DatFichaIngresoModalidad->MinNombre;?></option>
          <?php  
		  }
		  ?>
