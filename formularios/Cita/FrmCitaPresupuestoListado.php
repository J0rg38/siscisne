                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="left"><select class="EstFormularioCombo" name="CmpProductoUnidadMedidaConvertir_<?php echo $i; ?>" id="CmpProductoUnidadMedidaConvertir_<?php echo $i; ?>" disabled="disabled">
                                                    ...
                                                    <input type="hidden" name="CmpProductoUnidadMedida_<?php echo $i; ?>" id="CmpProductoUnidadMedida_<?php echo $i; ?>" value="">
                                                </td>
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <td align="left">
                                                                        ...
                                                                        <input name="CmpProductoCodigoOriginal_<?php echo $DatPlanMantenimientoTarea->PmtId ?>" type="text" class="EstFormularioCajaDeshabilitada" id="CmpProductoCodigoOriginal_<?php echo $DatPlanMantenimientoTarea->PmtId ?>" value="<?php echo $ProductoCodigoOriginal; ?>" size="10" readonly="readonly" />
                                                                    </td>
                                                                    <td align="left">
                                                                    ...
                                                                    <td align="center">
                                                                        ...
                                                                        <input name="CmpProductoCantidad_<?php echo $DatPlanMantenimientoTarea->PmtId ?>" type="text" class="EstFormularioCajaDeshabilitada" readonly id="CmpProductoCantidad_<?php echo $DatPlanMantenimientoTarea->PmtId ?>" size="5" maxlength="10" value="<?php echo number_format($ProductoCantidad, 2); ?>" />
                                                                    </td>
                                                                    <td align="center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="left"><select class="EstFormularioCombo" name="CmpProductoUnidadMedidaConvertir_<?php echo $i; ?>" id="CmpProductoUnidadMedidaConvertir_<?php echo $i; ?>" disabled="disabled">
                                                    ...
                                                    <input type="hidden" name="CmpProductoUnidadMedida<?php echo $i; ?>" id="CmpProductoUnidadMedida<?php echo $i; ?>" value="">
                                                </td>
