                              ...
                              <td width="2%" align="right">&nbsp; </td>
                                ...
                                ?>
                                    <?php if($POST_MantenimientoKilometraje == $DatKilometro['km']){?>
                                        <td colspan="4" align="center" ><i>(<?php echo $DatKilometroEtiqueta;?> km)</i></td>
                                    <?php	}?>
                                <?php	
                                }
                                ?>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td width="16%" align="center" class="EstPlanMantenimientoSeccion">Unidad</td>
                                <td width="13%" align="center" class="EstPlanMantenimientoSeccion">Importe</td>
                            </tr>                
                        <?php
                                foreach($ArrPlanMantenimientoTareas as $DatPlanMantenimientoTarea){
...
<tr>
								  <td colspan="5" class="EstPlanMantenimientoTarea">ADICIONALES:</td>
						  </tr>
...
?>  
                    ...
                    ?>
                        ...
                        <tr>
                            <td align="left" class="EstPlanMantenimientoSeccion"><?php //echo $DatPlanMantenimientoSeccion->PmsNombre;?></td>
<td width="594" align="center" class="EstPlanMantenimientoSeccion">Producto</td>
<td width="124" align="center" class="EstPlanMantenimientoSeccion">Cantidad</td>
<td width="162" align="center" class="EstPlanMantenimientoSeccion">Unidad</td>
                            <td width="115" align="center" class="EstPlanMantenimientoSeccion">Importe</td>
...
//if( $PlanMantenimientoDetalleAccion == "C" or $PlanMantenimientoDetalleAccion == "U" or !empty($_POST['CmpProductoId_'.$DatPlanMantenimientoTarea->PmtId])){ 

                                   // if($PlanMantenimientoDetalleAccion=="R" or $PlanMantenimientoDetalleAccion=="U"){
								   if( $PlanMantenimientoDetalleAccion == "R" or $PlanMantenimientoDetalleAccion == "U" or !empty($_POST['CmpProductoId_'.$DatPlanMantenimientoTarea->PmtId])){ 
					...
					for($i=1;$i<5;$i++){   
					   ?>
								...
								<tr>
                                    ...
                                    <?php echo $_POST['CmpProductoCodigoOriginal_'.$i];?>
...
?>  
            ...
            ?>  
                              ...
                              <tr>
                                <td>&nbsp;</td>
                                <td colspan="4" rowspan="3" align="left" valign="top">IMPORTANTE:<br>
                                ...
                                <td align="right" valign="middle">Total Adicional:</td>
                                <td align="right" valign="middle"><?php echo number_format($POST_AdicionalTotal,2);?></td>
                                <td align="right" valign="middle">&nbsp;</td>
                                <td align="right" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
