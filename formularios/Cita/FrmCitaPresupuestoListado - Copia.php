...
if($_GET['P']==2){
	...
	header("Content-Disposition:  filename=\"CITA_PRESUPUESTO_".date('d-m-Y').".xls\";");
}
?>
<html>
<head>
...
<input type="hidden" name="CmpProductoUnidadMedida_<?php echo $DatPlanMantenimientoTarea->PmtId?>" id="CmpProductoUnidadMedida_<?php echo $DatPlanMantenimientoTarea->PmtId?>" value="<?php echo $ProductoUnidadMedida;?>">
                    ...
                    <input class="EstFormularioCajaDeshabilitado" name="CmpProductoCantidad_<?php echo $DatPlanMantenimientoTarea->PmtId;?>" type="text"  readonly id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoCantidad" size="5" maxlength="10" value="<?php echo number_format($ProductoCantidad,2);?>"  />
                    
                    </td>
                                                <td align="center"   >
                                                
                                                <input class="EstFormularioCajaDeshabilitado" name="CmpProductoPrecio_<?php echo $DatPlanMantenimientoTarea->PmtId;?>" type="text" readonly id="CmpProductoPrecio_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoPrecio,2);?>"  />
                                                
                                                </td>
                                                <td align="center"   ><input class="EstFormularioCajaDeshabilitado" name="CmpProductoImporte_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" readonly id="CmpProductoImporte_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoImporte,2);?>"   /></td>
                                                <td align="center"   ><input class="EstFormularioCajaDeshabilitado" name="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" readonly id="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoStockReal,2);?>"   /></td>
                                  				<td align="center"   >
                ...
                <td>
                  ...
                  <a id="BtnProductoBuscar_<?php echo $i;?>" href="javascript:FncProductoBuscar('CodigoOriginal','<?php echo $i;?>');"><img src="imagenes/buscar2.gif" width="25" height="25" alt="[Buscar]" align="absmiddle" title="Buscar" border="0" /></a>
                    ...
                    ?>
                       ...
                       <td align="center"   ><input name="CmpProductoPrecio_<?php echo $i;?>" type="text" class="EstFormularioCajaDeshabilitado" readonly id="CmpProductoPrecio_<?php echo $i;?>" size="5" maxlength="10" value="0"  /></td>
                       <td align="center"   ><input name="CmpProductoImporte_<?php echo $i;?>" type="text" class="EstFormularioCajaDeshabilitado" readonly id="CmpProductoImporte_<?php echo $i;?>" size="5" maxlength="10" value=""   /></td>
                       <td align="center"   ><input class="EstFormularioCajaDeshabilitado" name="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" readonly id="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" /></td>
...
<input name="CmpProductoId_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="hidden" class="EstFormularioCaja"  readonly="readonly"   id="CmpProductoId_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="15" value="<?php echo $ProductoId;?>" />
                                                    ...
                                                    <input name="CmpProductoCodigoOriginal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" class="EstFormularioCajaDeshabilitado"   id="CmpProductoCodigoOriginal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" value="<?php echo $ProductoCodigoOriginal;?>" size="10"  readonly="readonly" /></td>
                                                    <td align="left"   >
                                                    
                             
    
                                                    <input name="CmpProductoNombre_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" class="EstFormularioCajaDeshabilitado"   id="CmpProductoNombre_<?php echo $DatPlanMantenimientoTarea->PmtId?>" value="<?php echo $ProductoNombre;?>" size="35"  readonly="readonly" />
                                    ...
                                    ?>
                                                    ...
                                                    <input name="CmpProductoCantidad_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" class="EstFormularioCajaDeshabilitado" readonly id="CmpProductoCantidad_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoCantidad,2);?>"  /></td>
                                                    <td align="center"   >


                                <input class="EstFormularioCajaDeshabilitado" name="CmpProductoPrecio_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text"  readonly id="CmpProductoPrecio_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoPrecio,2);?>"  /></td>
                                          <td align="center"   ><input name="CmpProductoImporte_<?php echo $DatPlanMantenimientoTarea->PmtId?>2" type="text" class="EstFormularioCajaDeshabilitado" readonly id="CmpProductoImporte_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoImporte,2);?>"  /></td>
                                                    <td align="center"   ><input class="EstFormularioCajaDeshabilitado" name="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" readonly id="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoStockReal,2);?>"   /></td>
                                                    <td align="center"   >
