...
<div class="EstCapMenu">
			...
			?>           
             ...
             <div class="EstSubMenuBoton"><a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=<?php echo $GET_mod;?>&Form=Editar<?php echo (!empty($GET_dia)?'&Dia=1':'');?>&Id=<?php echo $InsCita->CitId;?>"><img src="imagenes/iconos/editar.png" alt="[Editar]" title="Editar" />Editar</a></div>
             <?php
			}
			?>   
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td>Creado el:</td>
            <td><span class="EstFormularioDatoRegistro"><?php echo $InsCita->CitTiempoCreacion;?></span></td>
            <td>Modificado el</td>
            <td><span class="EstFormularioDatoRegistro"><?php echo $InsCita->CitTiempoModificacion;?></span></td>
          </tr>
        </table>
 ...
 <div class="tab_container">
       ...
       <tr>
        ...
        <table class="EstFormulario" width="200" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td><input name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsCita->CitId;?>" size="15" maxlength="20"  readonly="readonly"/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><span id="sprytextfield2">
              <label>
                <input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php  echo $InsCita->CitFecha;?>" size="15" maxlength="10" readonly="readonly" />
                </label>
            </span></td>
    ...
    ?>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><select disabled="disabled"  class="EstFormularioCombo" name="CmpPersonal" id="CmpPersonal" >
              <option value="">Escoja una opcion</option>
              <?php
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><select disabled="disabled"  class="EstFormularioCombo" name="CmpPersonalMecanico" id="CmpPersonalMecanico" >
              <option value="">Escoja una opcion</option>
              <?php
          ...
          <tr>
            ...
            <td align="left" valign="top"><label>
              <input name="CmpFechaProgramada" type="text" class="EstFormularioCajaFecha" id="CmpFechaProgramada" value="<?php  echo $InsCita->CitFechaProgramada;?>" size="15" maxlength="10" readonly="readonly" />
            </label></td>
            <td align="left" valign="top">Hora Programada:<br />
              <span class="EstFormularioSubEtiqueta">(00:00)</span></td>
            <td align="left" valign="top"><input name="CmpHoraProgramada" type="text" class="EstFormularioCajaFecha" id="CmpHoraProgramada" value="<?php  echo $InsCita->CitHoraProgramada;?>" size="15" maxlength="10" readonly="readonly" /></td>
	...
	?>
                ...
                <td>&nbsp;</td>
                <td><input name="CmpClienteNombreCompleto" type="text" class="EstFormularioCaja" id="CmpClienteNombreCompleto"   tabindex="2" value="<?php echo $InsCita->CliNombre;?> <?php echo $InsCita->CliApellidoPaterno;?> <?php echo $InsCita->CliApellidoMaterno;?>" size="45" maxlength="255" readonly="readonly" <?php if(!empty($InsCita->CliId)){ echo 'readonly="readonly"';} ?>  />
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><table>
              <tr>
                ...
                <td align="left" valign="top" class="EstFormulario"><input name="CmpVehiculoIngresoVIN" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoVIN"  value="<?php echo $InsCita->EinVIN;?>" size="25" maxlength="50" readonly="readonly" /></td>
                <td align="left" valign="top" class="EstFormulario">Placa:</td>
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoIngresoPlaca" type="text"  class="EstFormularioCaja" id="CmpVehiculoIngresoPlaca" value="<?php echo $InsCita->CitVehiculoPlaca;?>" size="10" maxlength="50" readonly="readonly"  /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoMarca" type="text"  class="EstFormularioCaja" id="CmpVehiculoMarca" value="<?php echo $InsCita->CitVehiculoMarca;?>" size="15" maxlength="50" readonly="readonly" /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoModelo" type="text"  class="EstFormularioCaja" id="CmpVehiculoModelo" value="<?php echo $InsCita->CitVehiculoModelo;?>" size="15" maxlength="50" readonly="readonly"  /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoVersion" type="text"  class="EstFormularioCaja" id="CmpVehiculoVersion" value="<?php echo $InsCita->CitVehiculoVersion;?>" size="15" maxlength="50" readonly="readonly" /></td>
                </tr>
              </table></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><input name="CmpReferencia" type="text" class="EstFormularioCaja" id="CmpReferencia" value="<?php echo $InsCita->CitReferencia;?>" size="45" maxlength="255" readonly="readonly" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Mantenimiento:</td>
            <td align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpCitaPresupuestoMantenimientoKilometraje" id="CmpCitaPresupuestoMantenimientoKilometraje"  >
              </select></td>
            <td align="left" valign="top"><input name="CmpKilometrajeMantenimiento" type="hidden" id="CmpKilometrajeMantenimiento" value="<?php echo $InsCita->CitKilometrajeMantenimiento;?>" size="3" /></td>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><textarea name="CmpDescripcion" cols="45" rows="4" readonly="readonly" class="EstFormularioCaja" id="CmpDescripcion"><?php echo $InsCita->CitDescripcion;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <table border="0" cellpadding="2" cellspacing="2">
              <tr>
                ...
                <td><span id="spryselect3">
                  <select disabled="disabled" class="EstFormularioCombo" name="CmpCitaPresupuestoClienteTipo" id="CmpCitaPresupuestoClienteTipo">
                    <option value="">Escoja una opcion</option>
                    <?php
			foreach($ArrClienteTipos as $DatClienteTipo){
			?>
                    <option <?php echo (($DatClienteTipo->LtiId==$InsCita->LtiId)?'selected="selected"':'');?>  value="<?php echo $DatClienteTipo->LtiId?>"><?php echo $DatClienteTipo->VmaNombre;?> - <?php echo $DatClienteTipo->LtiNombre?></option>
                    <?php
			}
			?>
                    </select>
