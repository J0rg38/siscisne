...
function FncValidar(){
	...
	var VehiculoIngresoPlaca = $("#CmpVehiculoIngresoPlaca").val();	
		...
		}else if(ClienteId == "" && Referencia==""){			
		
				dhtmlx.alert({
					title:"Aviso",
					type:"alert-error",
					text:"Debes escoger un cliente o ingresar una referencia",
					callback: function(result){
...
function FncCitaCalendarioCargarFormulario(){
	...
	FncCargarVentanaFullv3('principal2','Cita','VerCalendarioFull','');
...
function FncCitaVerRestriccionesoCargarFormulario(){
	...
	FncCargarVentanaFullv3('principal2','Cita','VerRestricciones','');		
