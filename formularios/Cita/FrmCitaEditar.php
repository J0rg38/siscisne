 ...
 <div class="tab_container">
    ...
    ?>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input class="EstFormularioCajaHora" name="CmpHoraProgramada" type="text" id="CmpHoraProgramada" value="<?php  echo $InsCita->CitHoraProgramada;?>" size="15" maxlength="10" />
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><a id="BtnCitaCalendario" href="javascript:void(0)"><img src="imagenes/acciones/icon_calendario_full120.png" width="25" height="25" border="0" alt="Calendario" title="Calendario" align="absmiddle" />Ver Calendario</a> <a id="BtnValidarCita" href="javascript:void(0);"><img src="imagenes/acciones/icon_validar120.png" width="25" height="25" border="0" alt="Validar" title="Validar" align="absmiddle" />Validar Cita</a> <a id="BtnCitaVerRestricciones" href="javascript:void(0)"><img src="imagenes/acciones/icon_restricciones120.png" width="25" height="25" border="0" alt="Restricciones" title="Restricciones" align="absmiddle" />Ver Restricciones</a></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
	...
	?>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><select class="EstFormularioCombo" name="CmpCitaPresupuestoMantenimientoKilometraje" id="CmpCitaPresupuestoMantenimientoKilometraje"  >
              </select>              <input name="CmpKilometrajeMantenimiento" type="hidden" id="CmpKilometrajeMantenimiento" value="<?php echo $InsCita->CitKilometrajeMantenimiento;?>" size="3" /><a href="javascript:FncVehiculoMantenimientoResumenListado();">Ver Mantenimientos</a></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Observaciones:</td>
            <td colspan="5" align="left" valign="top"><textarea class="EstFormularioCaja" name="CmpDescripcion" id="CmpDescripcion" cols="45" rows="4"><?php echo $InsCita->CitDescripcion;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td colspan="2" align="left" valign="top"><div class="EstFormularioArea" >
            <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
              <tr>
                <td width="3%">&nbsp;</td>
                <td width="47%"><div class="EstFormularioAccion" id="CapCitaHistorialAccion">Listo
