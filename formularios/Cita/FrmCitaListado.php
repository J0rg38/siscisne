...
PrivilegioGenerarExcel
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsCita.js"></script>
<?php
/* 
...
$ResCita = $InsCita->MtdObtenerCitas("cit.CitId,cit.CitVehiculoPlaca,ein.EinVIN,ein.EinPlaca,vma.VmaNombre,vmo.VmoNombre,vve.VveNombre,cit.CitVehiculoMarca,cit.CitVehiculoModelo,cit.CitVehiculoVersion,cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,cli.CliNombreCompleto,cli.CliTelefono,cli.CliCelular","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,NULL,$POST_Personal,FncCambiaFechaAMysql($POST_finicio),(FncCambiaFechaAMysql($POST_ffin)),$POST_TipoFecha,false,NULL,$POST_PersonalMecanico,NULL,$POST_Sucursal);
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE CITAS</span></td>
</tr>

<tr>
  <td>
    Mostrando <b><?php echo $CitasTotalSeleccionado;?></b> de <b><?php echo $CitasTotal;?></b> registros.</td>
</tr>
<tr>
<td align="right">
 ...
 <span class="EstFormularioContenido">  
     <input placeholder="Ingrese una palabra para buscar" class="EstFormularioCajaBuscar" name="Fil" type="text" id="Fil" value="<?php echo $POST_fil;?>" size="18" />
       ...
       <!--<select class="EstFormularioCombo" name="Cam" id="Cam">
      	<option value="CitId" <?php if($POST_cam=="CitId"){ echo 'selected="selected"';}?>>Id</option>
        <option value="CitNombre" <?php if($POST_cam=="CitNombre"){ echo 'selected="selected"';}?>>Numero</option>
       </select>-->
  ...
  <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaFin" name="BtnFechaFin" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
         ...
         Fecha:
          <select  class="EstFormularioCombo" name="TipoFecha" id="TipoFecha" >
            ...
            <option <?php if($POST_TipoFecha=="CitFecha"){ echo 'selected="selected"';}?> value="CitFecha">Fecha Registro</option>
             <option <?php if($POST_TipoFecha=="CitFechaProgramada"){ echo 'selected="selected"';}?> value="CitFechaProgramada">Fecha Programada</option>
            </select>       
            Asesor:
          <select  class="EstFormularioCombo" name="Personal" id="Personal" >
            ...
            Tecnico:
            <select  class="EstFormularioCombo" name="PersonalMecanico" id="PersonalMecanico" >
              <option value="">Escoja una opcion</option>
              <?php
					foreach($ArrTecnicos as $DatTecnico){
					?>
              <option <?php echo ($DatTecnico->PerId==$POST_PersonalMecanico)?'selected="selected"':'';?>  value="<?php echo $DatTecnico->PerId;?>"><?php echo $DatTecnico->PerNombre ?> <?php echo $DatTecnico->PerApellidoPaterno; ?> <?php echo $DatTecnico->PerApellidoMaterno; ?></option>
              <?php
					}
					?>
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "CitId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CitId','ASC');"> Id. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CitId','DESC');"> Id. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('CitId','ASC');"> Id.  </a>
                  <?php
				}
				?></th>
                <th width="4%" ><?php
				if($POST_ord == "CitFechaProgramada"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CitFechaProgramada','ASC');"> Fecha Prog. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CitFechaProgramada','DESC');"> Fecha Prog. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('CitFechaProgramada','ASC');"> Fecha Prog. </a>
                <?php
				}
				?></th>
                <th width="4%" ><?php
				if($POST_ord == "CitHoraProgramada"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CitHoraProgramada','ASC');"> Hora Prog. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CitHoraProgramada','DESC');"> Hora Prog. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('CitHoraProgramada','ASC');"> Hora Prog. </a>
                <?php
				}
				?></th>
                <th width="10%" ><?php
				...
				if($POST_ord == "PerNombre"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PerNombre','ASC');"> Asesor <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PerNombre','DESC');"> Asesor <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('PerNombre','ASC');"> Asesor </a>
                  <?php
				}
				?></th>
                <th width="4%" ><?php
				...
				?></th>
                <th width="6%" ><?php
				if($POST_ord == "CitDuracion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CitDuracion','ASC');"> Duracion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CitDuracion','DESC');"> Duracion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('CitDuracion','ASC');"> Duracion </a>
                  <?php
				}
				?></th>
                <th width="7%" ><?php
				if($POST_ord == "PerNombreRegistro"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PerNombreRegistro','ASC');"> Registrado por: <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PerNombreRegistro','DESC');"> Registrado por: <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('PerNombreRegistro','ASC');"> Registrado por: </a>
                  <?php
				}
				?></th>
                <th width="7%" ><?php
				if($POST_ord == "CitEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CitEstado','ASC');"> Estado <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CitEstado','DESC');"> Estado <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('CitEstado','ASC');"> Estado </a>
                <?php
				}
				?></th>
                <th width="8%" >
                  <?php
				if($POST_ord == "CitTiempoCreacion"){
					if($POST_sen == "DESC"){
				?>
                  
                  <a href="javascript:FncOrdenar('CitTiempoCreacion','ASC');">
                  Fecha Creacion
                  <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" />				</a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CitTiempoCreacion','DESC');">
...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
				  ...
				  <option <?php if($POST_num==$CitasTotal){ echo 'selected="selected"';}?> value="<?php echo $CitasTotal;?>">Todos</option>
                </select>
				...
				<?php
					...
					//if(empty($POST_fil)){
						$tregistros = $CitasTotal;
					//}else{
					//	$tregistros = ($CitasTotalSeleccionado);
					//}
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input indice="<?php echo $f;?>"   onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->CitId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->CitId; ?>" />				</td>
				...
				<?php echo $dat->PerNombreRegistro; ?> 
				<?php echo $dat->PerApellidoPaternoRegistro; ?>
				<?php echo $dat->PerApellidoMaternoRegistro; ?> 
...
if($PrivilegioEliminar){
?> 
<a href="javascript:FncEliminarSeleccionado('<?php echo $dat->CitId;?>');"> <img  src="imagenes/eliminar.gif" alt="[Eliminar]" width="19" height="19" border="0" title="Eliminar completamente"   /></a>
<?php
}
?>
...
if($PrivilegioEditar){
?>
<a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $dat->CitId;?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>
<?php
}
?>
...
if($PrivilegioVer){
?>
<a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->CitId;?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
<?php
}
?>

<?php
if($PrivilegioFichaIngresoRegistrar){
?>

 <a href="principal.php?Mod=FichaIngreso&Form=Registrar&CitId=<?php echo $dat->CitId;?>&Origen=Cita"><img src="imagenes/acciones/generar.png" width="19" height="19" border="0" title="Generar O.T." alt="[Generar O.T.]"   /></a>
<?php
}
?>
