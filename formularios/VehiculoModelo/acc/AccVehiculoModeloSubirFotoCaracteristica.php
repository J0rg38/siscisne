...
$targetFolder = '../../../subidos/vehiculo_modelo_fotos';// Relative to the root
...
if (!empty($_FILES)) {
	...
	$targetPath = $targetFolder;
	$fileName = $FotoIdentificador.$_FILES['Filedata']['name'];
	...
	if (in_array(strtolower($fileParts['extension']),$fileTypes)) {
		...
		if(move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesVmoFotoCaracteristica'.$Identificador] = $fileName;
			...
			$img->GenerateThumbFile($targetFile, '../../../subidos/vehiculo_modelo_fotos/thumb_'.$fileName);
			...
			$img->GenerateThumbFile($targetFile, '../../../subidos/vehiculo_modelo_fotos/thumb2_'.$fileName);
