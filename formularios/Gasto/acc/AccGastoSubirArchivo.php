...
if($POST_Borrar=="1"){
?>
<?php $_SESSION['SesGasFoto'.$Identificador] = ""; ?>
<?php	
}
?>
...
if (!empty($_FILES)) {
	...
	$targetPath = '../../../subidos/gastos_fotos/';
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg"){
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesGasFoto'.$Identificador] = $file_name;
			
			$mythumb = new thumb();
			$mythumb->loadImage('../../../subidos/gastos_fotos/'.$file_name);
			$mythumb->crop(250, 250,'bottom');
			$mythumb->save('../../../subidos/gastos_fotos/'.$nombre_base.'_thumb.'.$extension, 100);
			
?>
    Vista Previa:<br />
    
    
    <a target="_blank" href="../../../subidos/gastos_fotos/<?php echo $nombre_base.".".$extension;?>">
      <img  src="../../../subidos/gastos_fotos/<?php echo $nombre_base.".".$extension;?>" width="100" border="0" title="<?php echo $nombre_base.".".$extension;?>" />
      </a>
...
}elseif(!empty($_SESSION['SesGasFoto'.$Identificador])){
...
?>
    ...
    <a target="_blank" href="../../../subidos/gastos_fotos/<?php echo $nombre_base.".".$extension;?>">
      <img  src="../../../subidos/gastos_fotos/<?php echo $nombre_base.".".$extension;?>" width="100" border="0" title="<?php echo $nombre_base."_thumb.".$extension;?>" /></a>
...
if (!empty($_FILES)) {
	...
	$targetPath = '../../../subidos/almacen_movimiento_entrada_fotos/';
	$targetFile =  str_replace('//','/',$targetPath) . ($file_name);	
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg"  || $extension == "pdf"){
		...
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			if($extension <> "pdf"){
				...
				$mythumb = new thumb();
				$mythumb->loadImage('../../../subidos/almacen_movimiento_entrada_fotos/'.$file_name);
				$mythumb->crop(250, 250,'bottom');
				$mythumb->save('../../../subidos/almacen_movimiento_entrada_fotos/'.$nombre_base.'_thumb.'.$extension, 100);	
...
Vista Previa:<br />
	...
	if($extension <> "pdf"){
	?>
        <a target="_blank" href="../../../subidos/almacen_movimiento_entrada_fotos/<?php echo $nombre_base.".".$extension;?>">
        <img  src="../../../subidos/almacen_movimiento_entrada_fotos/<?php echo $nombre_base.".".$extension;?>" width="100" border="0" title="<?php echo $nombre_base.".".$extension;?>" />
        </a>   
    <?php
	}else{
	?>
...
Vista Previa:<br />
	...
	?>
        <a target="_blank" href="../../../subidos/almacen_movimiento_entrada_fotos/<?php echo $nombre_base.".".$extension;?>">
        <img  src="../../../subidos/almacen_movimiento_entrada_fotos/<?php echo $nombre_base.".".$extension;?>" width="100" border="0" title="<?php echo $nombre_base."_thumb.".$extension;?>" /></a>   
    <?php
	}else{
	?>
     <a target="_blank" href="../../../subidos/almacen_movimiento_entrada_fotos/<?php echo $nombre_base.".".$extension;?>">
