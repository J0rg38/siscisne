...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccGastoRegistrar.php');
...
//var GastoDetalleEditar = 1;
//var GastoDetalleEliminar = 1;
</script>
	...
	<tr>
	  <td valign="top"><div class="EstFormularioArea">
                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="4"><span class="EstFormularioSubTitulo">Datos del Comprobante
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><span id="sprytextfield1">
                      <label>
                        <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if(empty($InsGasto->GasFecha)){ echo date("d/m/Y");}else{ echo $InsGasto->GasFecha; }?>" size="15" maxlength="10" />
                      </label>
			...
			?>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"> <input name="CmpComprobanteNumeroSerie" type="text" class="EstFormularioCaja" id="CmpComprobanteNumeroSerie" value="<?php echo $InsGasto->GasComprobanteNumeroSerie;?>" size="10" maxlength="50" />
- 
  <input name="CmpComprobanteNumeroNumero" type="text" class="EstFormularioCaja" id="CmpComprobanteNumeroNumero" value="<?php echo $InsGasto->GasComprobanteNumeroNumero;?>" size="20" maxlength="50" /></td>
			  ...
			  ?>
                    ...
                    <td align="left" valign="top">
                      ...
                      <table>
                        <tr>
                          <td>
                            <input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" value="<?php if (empty($InsGasto->GasTipoCambio)){ echo "";}else{ echo $InsGasto->GasTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" />
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><textarea name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsGasto->GasObservacion;?></textarea></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    ...
                    <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span><span class="textfieldMinValueMsg">El valor introducido es inferior al m�nimo permitido.</span></span></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
	...
	<tr>
	  <td valign="top"><div class="EstFormularioArea" ></div></td>
	  </tr>
	<tr>
