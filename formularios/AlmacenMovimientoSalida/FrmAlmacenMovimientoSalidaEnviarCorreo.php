...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVentaConcretadaSolicitudFacturacion.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">SOLICITUD DE FACTURACION DE    VENTA  CONCRETADA</span></td>
      </tr>
      <tr>
        <td colspan="2">
         ...
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top"><textarea name="CmpDestinatario" cols="100" rows="3" class="EstFormularioCaja" id="CmpDestinatario">pzapana@cyc.com.pe, scanepam@cyc.com.pe, pcondori@cyc.com.pe, aliendo@cyc.com.pe, jblanco@cyc.com.pe
               </textarea></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
