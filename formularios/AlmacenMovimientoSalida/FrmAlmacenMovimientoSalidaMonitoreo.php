...
<?php $PrivilegioGenerarFichaAccion = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"Registrar"))?true:false;?>
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle" width="8%"   ><?php echo $dat->FinId;  ?></td>
                ...
                <td  width="5%" align="right" ><?php echo $dat->FinHora;  ?></td>
                <td  width="7%" align="right" ><?php echo ($dat->CliNumeroDocumento);?></td>
                <td  width="20%" align="right" ><?php echo ($dat->CliNombre);?></td>
                <td  width="9%" align="right" ><?php echo ($dat->EinVIN);?></td>
                <td  width="11%" align="right" ><?php echo ($dat->FinConductor);?></td>
                <td  width="7%" align="right" ><?php echo ($dat->FinVehiculoKilometraje);?></td>
                <td  width="13%" align="center" ><?php echo ($dat->FinTiempoCreacion);?></td>
                <td  width="5%" align="center" >
  <?php
if($PrivilegioGenerarFichaAccion){
?>		                
