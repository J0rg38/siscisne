...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/AlmacenMovimientoSalida/acc/AccAlmacenMovimientoSalidaGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/AlmacenMovimientoSalida/acc/AccAlmacenMovimientoSalidaGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	document.getElementById("FrmListado").action = "formularios/AlmacenMovimientoSalida/FrmAlmacenMovimientoSalidaListadoImprimir.php"
