...
if(isset($_POST['BtnGuardar_x']) or $_POST['Guardar']=="1"){	
	...
	*/
	...
	$ArrDesembolsoComprobantes = $ResDesembolsoComprobante['Datos'];
		...
		if($InsDesembolso->MtdEditarDesembolso()){		
		
			if($InsDesembolso->DesNotificar==1){
					
				//$InsDesembolso->MtdNotificarDesembolsoRegistro($InsDesembolso->DesId,"jblanco@cyc.com.pe");

				$InsDesembolso->MtdNotificarDesembolsoRegistro($InsDesembolso->DesId,"mluisagodinez@cyc.com.pe,gcanepam@cyc.com.pe,fcanepa@cyc.com.pe,scanepam@cyc.com.pe,gchura@cyc.com.pe,eacurio@cyc.com.pe,epilco@cyc.com.pe,avillanueva@cyc.com.pe,jblanco@cyc.com.pe");
...
function FncCargarDatos(){
	...
	unset($_SESSION['InsDesembolsoComprobante'.$Identificador]);
