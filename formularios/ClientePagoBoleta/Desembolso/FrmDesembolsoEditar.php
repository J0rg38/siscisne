...
<style type="text/css">
@import url('<?php echo $InsProyecto->MtdFormulariosCss($GET_mod);?>CssDesembolso.css');
</style>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    ?>
                  ...
                  <td align="left" valign="top"><span id="sprytextfield1">
                    <label>
                      <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if(empty($InsDesembolso->DesFecha)){ echo date("d/m/Y");}else{ echo $InsDesembolso->DesFecha; }?>" size="15" maxlength="10" />
                      </label>
