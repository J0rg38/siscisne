...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsClientePagoVentaDirectaFunciones.js" ></script>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccClientePagoVentaDirectaRegistrar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	?>
            ...
            <td>Num. Doc.:</td>
            <td><input name="CmpClienteNumeroDocumento" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpClienteNumeroDocumento" value="<?php echo $InsPago->CliNumeroDocumento;?>" size="20" maxlength="20" readonly="readonly" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><table>
              <tr>
                ...
                <td><a href="javascript:FncPagoVentaDirectaEstablecerMoneda();"><img src="imagenes/recargar.jpg" width="20" height="20" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /></a></td>
                </tr>
              </table></td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td><input name="CmpTransaccionNumero" type="text"  class="EstFormularioCaja" id="CmpTransaccionNumero" value="<?php echo $InsPago->PagNumeroTransaccion;?>" size="30" maxlength="45" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
