...
<input name="CmpVehiculoIngresoClienteId" type="hidden" id="CmpVehiculoIngresoClienteId" value="<?php echo $InsVehiculoRecepcion->CliId;?>" size="3" />
    ...
    <div class="EstFormularioAreaCampo">
		...
		<div class="EstFormularioAreaCampo">
         ...
         <!--   
            <div class="EstFormularioAreaDetalle">-->
...
<div class="EstFormularioAreaDetalleEstado">
	<div class="EstFormularioAccion" id="CapVehiculoRecepcionDetalleAccion">Listo para registrar elementos</div>
</div>

<div class="EstFormularioAreaDetalleAccion">
...
<div class="EstFormularioAreaDetalleResultado">
	<div id="CapVehiculoRecepcionDetallesResultado"> </div>
</div>

<div class="EstFormularioAreaDetalleListado">
	<div id="CapVehiculoRecepcionDetalles" class="EstCapVehiculoRecepcionDetalles" > </div>
</div>
