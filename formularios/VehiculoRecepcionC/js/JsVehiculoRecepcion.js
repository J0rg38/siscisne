...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/VehiculoRecepcion/acc/AccCotizacionGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/VehiculoRecepcion/acc/AccCotizacionGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncGenerarPDF(oId){
	...
	FncPopUp('formularios/VehiculoRecepcion/acc/AccVehiculoRecepcionGenerarPDF.php?Id='+oId+'&ImprimirCodigo=1',0,0,1,0,0,1,0,screen.height,screen.width);
