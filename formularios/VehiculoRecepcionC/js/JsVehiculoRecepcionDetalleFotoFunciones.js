...
function FncVehiculoRecepcionDetalleFotoListar(oFotoItem){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/VehiculoRecepcionC/FrmVehiculoRecepcionDetalleFotoListado.php',
...
function FncVehiculoRecepcionDetalleFotoEliminar(oItem,oFotoItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/VehiculoRecepcionC/acc/AccVehiculoRecepcionDetalleFotoEliminar.php',
...
function FncVehiculoRecepcionDetalleFotoEliminarTodo(oFotoItem){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/VehiculoRecepcionC/acc/AccVehiculoRecepcionDetalleFotoEliminarTodo.php',
