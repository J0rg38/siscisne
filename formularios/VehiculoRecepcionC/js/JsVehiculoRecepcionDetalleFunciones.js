...
function FncVehiculoRecepcionDetalleGuardar(){
			...
			if(VehiculoRecepcionDetalleZonaComprometida == ""){	
				...
				$('#CapVehiculoRecepcionDetalleAccion').html('Guardando...');
						...
						$.ajax({
							type: 'POST',
							url: 'formularios/VehiculoRecepcionC/acc/'+Acc,
...
function FncVehiculoRecepcionDetalleListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/VehiculoRecepcionC/FrmVehiculoRecepcionDetalleListado.php',
...
function FncVehiculoRecepcionDetalleEscoger(oItem){
	...
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/VehiculoRecepcionC/acc/AccVehiculoRecepcionDetalleEscoger.php',
...
function FncVehiculoRecepcionDetalleEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/VehiculoRecepcionC/acc/AccVehiculoRecepcionDetalleEliminar.php',
...
function FncVehiculoRecepcionDetalleEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/VehiculoRecepcionC/acc/AccVehiculoRecepcionDetalleEliminarTodo.php',
