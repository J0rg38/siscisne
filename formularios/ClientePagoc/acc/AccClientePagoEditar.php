...
if(isset($_POST['BtnGuardar_x']) or $_POST['Guardar']=="1"){	
	...
	$InsClientePago->CpaCierre = $_POST['CmpCierre'];	
	...
	/*		if($InsClientePago->MonId<>$EmpresaMonedaId and !empty($InsClientePago->CpaTipoCambio)){
				$InsClientePago->CpaMonto = $_POST['CmpMonto'] * $InsClientePago->CpaTipoCambio;
			}else{
				$InsClientePago->CpaMonto = $_POST['CmpMonto'];
			}*/
...
function FncCargarDatos(){
	...
	$_SESSION['SesCpaFoto'.$Identificador] =	$InsClientePago->CpaFoto;
