...
<?php
if($InsClientePago->CpaCierre==1){
?>

<form id="FrmEditar" name="FrmEditar" method="post" action="#" enctype="multipart/form-data">
<input type="hidden" name="CmpCierre" id="CmpCierre" value="<?php echo $InsClientePago->CpaCierre?>" />
	...
	<!--Content-->     
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td><input class="EstFormularioCaja" name="CmpDocumento" type="text" id="CmpDocumento" value="<?php echo $InsClientePago->DtaNumero;?> - <?php echo $InsClientePago->DocId;?>" size="20" maxlength="20"  /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <select disabled="disabled" onchange="FncMonedaBuscar('Id');" class="EstFormularioCombo" name="CmpMonedaId2" id="CmpMonedaId2">
              ...
              <span class="selectRequiredMsg"><img src="imagenes/advertencia.png" width="20" height="20" border="0" align="absmiddle" title="Debe seleccionar un elemento" alt="[A]"  /></span></td>
          ...
          <tr>
            ...
            <input  class="EstFormularioCaja" name="CmpTipoCambio" type="text" id="CmpTipoCambio" value="<?php if (empty($InsClientePago->CpaTipoCambio)){ echo "";}else{ echo $InsClientePago->CpaTipoCambio; } ?>" size="10" maxlength="10" onchange="FncCompraDetalleListar();" />
            </span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
<?php
}elseif(!empty($InsClientePago->CpaCierre) ){
	echo ERR_CPA_401;
}
?>
<?php
