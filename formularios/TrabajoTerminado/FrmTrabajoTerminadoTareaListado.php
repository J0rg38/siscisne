...
session_start();
if (!isset($_SESSION['InsTrabajoTerminadoTarea' . $ModalidadIngreso . $Identificador])) {
  $_SESSION['InsTrabajoTerminadoTarea' . $ModalidadIngreso . $Identificador] = new ClsSesionObjeto();
} else {
  $_SESSION['InsTrabajoTerminadoTarea' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTrabajoTerminadoTarea' . $ModalidadIngreso . $Identificador]);
}
...
$RepSesionObjetos = $_SESSION['InsTrabajoTerminadoTarea' . $ModalidadIngreso . $Identificador]->MtdObtenerSesionObjetos(true);
...
?>
  ...
  ?>
    ...
    ?>
      ...
      <span class="EstFormularioSubTitulo2"> PLANCHADO</span>
          ...
          ?>
              <tr>
                ...
                <td align="left" valign="top">
                  ...
                  ?></td>
                <td align="right" valign="top"><?php echo number_format($DatSesionObjeto->Parametro12, 2); ?></td>
    ...
    ?>
      ...
      <table class="EstTablaListado" width="100%" cellpadding="0" cellspacing="0" border="0">
        <thead class="EstTablaListadoHead">
          <tr>
            <th width="2%" align="center">#</th>
            <th width="77%" align="center"> Descripcion
            </th>
