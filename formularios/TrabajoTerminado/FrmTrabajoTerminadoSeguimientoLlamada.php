...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsTrabajoTerminadoSeguimientoLlamadaFuncionesv2.js"></script>
  <?php
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="25">
          ...
          <span class="EstFormularioTitulo">SEGUIMIENTO DE ORDENES DE TRABAJO - CALLCENTER</span>
        </td>
        <td width="2%"><a href="formularios/TrabajoTerminado/inf/InfTrabajoTerminadoSeguimientoLlamada.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
      </tr>

      <tr>
        <td colspan="2" align="center">
          <!--    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios(); ?>TrabajoTerminado/IfrTrabajoTerminadoSeguimientoLlamada.php" target="IfrTrabajoTerminadoSeguimientoLlamada" method="post" name="FrmTrabajoTerminadoSeguimientoLlamada" id="FrmTrabajoTerminadoSeguimientoLlamada">-->
          <!--    <form enctype="multipart/form-data"  target="IfrTrabajoTerminadoSeguimientoLlamada" method="post" name="FrmTrabajoTerminadoSeguimientoLlamada" id="FrmTrabajoTerminadoSeguimientoLlamada">-->
            ...
            <tr>
                  ...
                  <table border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      ...
                      <td><select class="EstFormularioCombo" name="CmpVehiculoMarca" id="CmpVehiculoMarca">
                          ...
                          ?>
                            <option <?php //echo (($DatVehiculoMarca->VmaId=="VMA-10017")?'selected="selected"':'');
                                    ?> value="<?php echo $DatVehiculoMarca->VmaId; ?>"><?php echo $DatVehiculoMarca->VmaNombre; ?></option>
                          <?php
                          }
                          ?>
                        </select></td>
                    ...
                    <tr>
                      <td>Modalidad:</td>
                      <td width="22"><select class="EstFormularioCombo" name="CmpModalidad" id="CmpModalidad">
                      ...
                      <td width="125">CSI:</td>
                      <td width="133"><select name="CmpIncluirCSI" id="CmpIncluirCSI" class="EstFormularioCombo">
                          <option value="">Todos</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                          <option value="FinId">Cod. de OT</option>
                          <option value="FinFecha">Fecha de OT</option>
                          <option value="FinTiempoTrabajoTerminado" selected="selected">Fecha de Cierre OT</option>
              ...
              <td align="left" valign="top">
                ...
                <table border="0" cellpadding="0" cellspacing="2">
                  <tr>
                    <td>
                      <input name="BtnVer" id="BtnVer" type="image" border="0" src="imagenes/reporte_iconos/ver.png" alt="[Ver]" title="Ver" />
                    </td>
                    <td>
                      <?php
      ...
      <tr>
        <td colspan="2" align="center">
          <div id="CapTrabajoTerminadoSeguimientoLlamada"></div>
          <!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios(); ?>TrabajoTerminado/IfrTrabajoTerminadoSeguimientoLlamada.php" target="IfrTrabajoTerminadoSeguimientoLlamada" id="IfrTrabajoTerminadoSeguimientoLlamada" name="IfrTrabajoTerminadoSeguimientoLlamada" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
        </td>
      </tr>
    </table>
  </div>
