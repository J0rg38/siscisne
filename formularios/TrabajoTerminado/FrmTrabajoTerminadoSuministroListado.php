...
session_start();
if (!isset($_SESSION['InsTrabajoTerminadoSuministro' . $ModalidadIngreso . $Identificador])) {
  $_SESSION['InsTrabajoTerminadoSuministro' . $ModalidadIngreso . $Identificador] = new ClsSesionObjeto();
} else {
  $_SESSION['InsTrabajoTerminadoSuministro' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTrabajoTerminadoSuministro' . $ModalidadIngreso . $Identificador]);
}
...
$RepSesionObjetos = $_SESSION['InsTrabajoTerminadoSuministro' . $ModalidadIngreso . $Identificador]->MtdObtenerSesionObjetos(true);
