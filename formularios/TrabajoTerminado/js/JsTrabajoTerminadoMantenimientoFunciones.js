...
function FncTrabajoTerminadoMantenimientoListar(oModalidadIngreso){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/TrabajoTerminado/FrmTrabajoTerminadoMantenimientoListado.php',
		...
		success: function(html){
			...
			$("#CapTrabajoTerminado"+oModalidadIngreso+"Mantenimientos").html("");
			$("#CapTrabajoTerminado"+oModalidadIngreso+"Mantenimientos").append(html);
	...
	//						$("#Cmp"+$(this).val()+"ProductoNombre").autocomplete('comunes/Producto/XmlProducto.php?Cbu=ProNombre', {
						...
						$("#CmpPlanMantenimientoDetalleAccion_"+$(this).val()).change(function(){
							...
							switch($(this).val()){
								...
								case "I":
									FncTrabajoTerminadoProductoNuevo(Sigla);
