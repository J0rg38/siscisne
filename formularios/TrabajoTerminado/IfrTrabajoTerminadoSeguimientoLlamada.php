...
if($_GET['P']==2){
	...
	header("Content-Disposition:  filename=\"SEGUIMIENTO_REPARACIONES_".date('d-m-Y').".xls\";");
}
?>
...
$POST_SucursalId = $_GET['SucursalId'];
...
$POST_Filtro = $_GET['Filtro'];

		
$POST_ord = isset($_GET['Orden'])?$_GET['Orden']:"FinTiempoTrabajoTerminado";
...
<tr>
  ...
  <td width="54%" align="center" valign="top"><span class="EstReporteTitulo">SEGUIMIENTO  DE  ORDENES DE TRABAJO - CALLCENTER 
...
<?php }?>
        ...
        <tr>
          ...
          <th width="6%">FECHA CIERRE</th>
          <th width="6%">FECHA</th>
          <th width="8%">DIAS TRANSC. AL <?php echo $POST_FechaFin;?></th>
...
<!--                      
          ...
          <td align="right" ><h1><?php echo ($DatReporteFichaIngreso->FinTiempoTrabajoTerminado);?></h1></td>
          <td align="right" ><?php echo ($DatReporteFichaIngreso->FinFecha);?></td>
          <td align="right" >

 <?php
		  if($DatReporteFichaIngreso->FinDiaTranscurridoTerminado>0){
		?>
<h2>		  

<?php echo ($DatReporteFichaIngreso->FinDiaTranscurridoTerminado);?> dia(s)
...
?>
          ...
          <td align="right" ><?php echo $DatReporteFichaIngreso->CliNombre;  ?> <?php echo $DatReporteFichaIngreso->CliApellidoPaterno;  ?> <?php echo $DatReporteFichaIngreso->CliApellidoMaterno;  ?>
...
$ResFichaIngresoLlamada =  $InsFichaIngresoLlamada->MtdObtenerFichaIngresoLlamadas(NULL,NULL,"FllId","ASC",NULL,$DatReporteFichaIngreso->FinId,NULL,FncCambiaFechaAMysql($POST_finicio),NULL,NULL);
...
?>
          ...
          <?php
		  	...
		  	$TotalLlamadas += count($ArrFichaIngresoLlamadas);
...
$ResEncuesta = $InsEncuesta->MtdObtenerEncuestas(NULL,NULL,NULL,"EncFecha","DESC","1",NULL,FncCambiaFechaAMysql($POST_finicio),NULL,"POSTVENTA",NULL,$DatReporteFichaIngreso->FinId);
