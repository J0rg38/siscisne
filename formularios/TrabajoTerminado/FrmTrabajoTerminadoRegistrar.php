...
?>
  ...
  <!--<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsTrabajoTerminadoProductoAdicionalFunciones.js" ></script>-->
  ...
  if (!isset($_SESSION['InsTrabajoTerminadoHerramienta' . $Identificador])) {
    ...
    $_SESSION['InsTrabajoTerminadoHerramienta' . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTrabajoTerminadoHerramienta' . $Identificador]);
  }
...
*/
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccTrabajoTerminadoRegistrar.php');
      ...
      $(document).ready(function() {
        ...
        $('input[type=checkbox]').each(function() {
          if ($(this).attr('etiqueta') == "modalidad") {
            ...
            //FncTrabajoTerminadoProductoAdicionalListar($(this).attr('sigla'));
...
-->
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top">
                      ...
                      <input class="EstFormularioCajaFecha" name="CmpTrabajoTerminadoFecha" type="text" id="CmpTrabajoTerminadoFecha" value="<?php echo $InsFichaIngreso->FinTiempoTrabajoTerminado; ?>" size="15" maxlength="10" />
                      <input name="CmpTrabajoTerminadoFecha2" type="hidden" id="CmpTrabajoTerminadoFecha2" value="<?php echo $InsFichaIngreso->FinTiempoTrabajoTerminado; ?>" size="15" maxlength="10" />

                      <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnTrabajoTerminadoFecha" name="BtnTrabajoTerminadoFecha" width="25" height="25" align="absmiddle" style="cursor:pointer;" />

                      <script type="text/javascript">
                        Calendar.setup({
                          inputField: "CmpTrabajoTerminadoFecha", // id del campo de texto 
                          ifFormat: "%d/%m/%Y", //  
                          button: "BtnTrabajoTerminadoFecha" // el id del bot�n que  
                        });
                      </script>
                  ...
                  <tr>
                    <td colspan="11" align="left" valign="top"><input checked="checked" type="checkbox" name="CmpFichaIngresoEnviar" id="CmpFichaIngresoEnviar" value="1" />
                      <span class="EstFormularioResaltar">
                        Enviar a ORDEN DE TRABAJO a FACTURACION una vez guardado este formulario
                      </span>
                    </td>
                  </tr>
                </table>
                          ...
                          <div class="EstFormularioArea">
                            <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"><textarea <?php echo (($DatFichaIngresoModalidad->MinSigla == "OB") ? 'readonly="readonly"' : ''); ?> name="CmpFichaAccionManoObraDetalle_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" cols="45" rows="2" class="EstFormularioCaja" id="CmpFichaAccionManoObraDetalle_<?php echo $DatFichaIngresoModalidad->MinSigla ?>"><?php echo stripslashes($FichaAccionManoObraDetalle); ?></textarea></td>
                                <td align="left" valign="top">&nbsp;</td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td align="left" valign="top">Costo de Mano de Obra:</td>
                                <td align="left" valign="top"><input <?php echo (($DatFichaIngresoModalidad->MinSigla == "OB") ? 'readonly="readonly"' : ''); ?> class="EstFormularioCaja" name="CmpFichaAccionManoObra_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" type="text" id="CmpFichaAccionManoObra_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" value="<?php echo number_format($FichaAccionManoObra, 2); ?>" size="10" maxlength="10" /></td>
                                <td align="left" valign="top">&nbsp;</td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td colspan="2" align="left" valign="top">
                                  ...
                                  <input <?php echo ($FichaIngresoModalidadObsequio == 1) ? 'checked="checked"' : ''; ?> type="checkbox" name="CmpFichaIngresoModalidadObsequio_<?php echo $DatFichaIngresoModalidad->MinSigla; ?>" id="CmpFichaIngresoModalidadObsequio_<?php echo $DatFichaIngresoModalidad->MinSigla; ?>" value="1" />
                                    ...
                                    <tr>
                                      <td colspan="2" align="left"><?php
                                          ...
                                          ?>
                                            ...
                                            ?>
                                              <a href="subidos/campana/<?php echo $InsFichaIngreso->CamBoletin; ?>" target="_blank"> <img src="imagenes/menu/campanas.png" alt="[Campa�as]" title="<?php echo $InsFichaIngreso->CamCodigo; ?> - <?php echo $InsFichaIngreso->CamNombre; ?>" border="0" align="absmiddle" width="20" height="20" /> <?php echo $InsFichaIngreso->CamCodigo; ?> - <?php echo $InsFichaIngreso->CamNombre; ?></a>
                                            <?php
                                                                        } else {
                                            ?>
                                              <a href="javascript:alert('!No se encontro boletin de campa�a�');"> <img src="imagenes/menu/campanas.png" alt="[Campa�as]" title="<?php echo $InsFichaIngreso->CamCodigo; ?> - <?php echo $InsFichaIngreso->CamNombre; ?>" border="0" align="absmiddle" width="20" height="20" /> <?php echo $InsFichaIngreso->CamCodigo; ?> - <?php echo $InsFichaIngreso->CamNombre; ?></a>
                                            <?php
                                                                        }
                                            ?>
                                          <?php
                                        ...
                                        <div class="EstFormularioArea">
                                          <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                            ...
                                            <tr>
                                              <td align="left" valign="top">&nbsp;</td>
                                              <td align="left" valign="top">
                                                <div class="EstFormularioAccion" id="CapTemparioAccion">Listo
                                                  para registrar elementos<a href="javascript:FncTrabajoTerminadoTemparioEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"></a></div>
                                              </td>
                                              ...
                                              <td align="left" valign="top">
                                                <div id="CapTrabajoTerminadoTempariosResultado"> </div>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td align="left" valign="top">&nbsp;</td>
                                              <td colspan="2" align="left" valign="top">
                                                <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Temparios" class="EstCapTrabajoTerminadoTemparios"> </div>
                                              </td>
                                              <td align="left" valign="top">&nbsp;</td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            ...
                                            <td width="49%" align="left" valign="top">
                                              <div class="EstFormularioAccion" id="CapTareaAccion">Listo
                                                para registrar elementos<a href="javascript:FncTrabajoTerminadoTareaEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"></a></div>
                                            </td>
                                            <td width="48%" align="right" valign="top"><a href="javascript:FncTrabajoTerminadoTareaListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td colspan="2" align="left" valign="top">
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Tareas" class="EstCapTrabajoTerminadoTareas"> </div>
                                            </td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
                                      ...
                                      <div class="EstFormularioArea">
                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            <td>&nbsp;</td>
                                            <td width="50%">
                                              <div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla ?>ProductoAccion">Listo
                                                para registrar elementos </div>
                                            </td>
                                            <td width="46%" align="right"><a href="javascript:FncTrabajoTerminadoProductoListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                            <td>&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2">
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Productos2" class="EstCapTrabajoTerminadoProductos"></div>
                                            </td>
                                            <td>&nbsp;</td>
                                          </tr>
                                          <tr>
                                    ...
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstFormularioArea">
                                        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td align="left" valign="top"><input type="hidden" name="CmpFichaAccionPedido_<?php echo $DatFichaIngresoModalidad->MinSigla ?>2" id="CmpFichaAccionPedido_<?php echo $DatFichaIngresoModalidad->MinSigla ?>2" value="<?php echo stripslashes($FichaAccionPedido); ?>" />
                                              <div class="EstFormularioObservacion"> <?php echo stripslashes($FichaAccionPedido); ?></div>
                                            </td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
                                    ...
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstFormularioArea">
                                        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td align="left" valign="top"><input type="hidden" name="CmpFichaAccionCausa_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" id="CmpFichaAccionCausa_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" value="<?php echo stripslashes($FichaAccionCausa); ?>" />
                                              <div class="EstFormularioObservacion"> <?php echo stripslashes($FichaAccionCausa); ?></div>
                                            </td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td align="left" valign="top"><span class="EstFormularioNota">* En caso de una Garantia, Campa&ntilde;a o Politica, rellene este espacio.</span></td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                        </table>
                                      </div>
                                    ...
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstFormularioArea">
                                        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td align="left" valign="top"><input type="hidden" name="CmpFichaAccionSolucion_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" id="CmpFichaAccionSolucion_<?php echo $DatFichaIngresoModalidad->MinSigla ?>" value="<?php echo stripslashes($FichaAccionSolucion); ?>" />
                                              <div class="EstFormularioObservacion"> <?php echo stripslashes($FichaAccionSolucion); ?></div>
                                            </td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
                                    ...
                                    <td colspan="2" align="left" valign="top">
                                      <div class="EstFormularioArea">
                                        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          <tr>
                                            <td width="4" align="left" valign="top">&nbsp;</td>
                                            <td colspan="2" align="left" valign="top"><span class="EstFormularioSubTitulo">Fotos</span> <a href="javascript:FncTrabajoTerminadoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"></a></td>
                                            <td width="4" align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td width="138" align="left" valign="top">&nbsp;</td>
                                            <td width="137" align="right" valign="top"><a href="javascript:FncTrabajoTerminadoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                          ...
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td colspan="2" align="left" valign="top">
                                              <div class="EstCapTrabajoTerminadoFotos" id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla; ?>Fotos"></div>
                                            </td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                          <tr>
...
<input <?php echo ($FichaIngresoModalidadObsequio == 1) ? 'checked="checked"' : ''; ?>  type="checkbox" name="CmpFichaIngresoModalidadObsequio_<?php echo $DatFichaIngresoModalidad->MinSigla; ?>" id="CmpFichaIngresoModalidadObsequio_<?php echo $DatFichaIngresoModalidad->MinSigla; ?>" value="1" />
        ...
        -->
                                  ...
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="3">
                                      <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Mantenimientos" class="EstCapTrabajoTerminadoMantenimientos"> </div>
                                    </td>
                                    <td>
                                      <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>MantenimientosResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                      ...
                                      <div class="EstFormularioArea">
                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            <td>&nbsp;</td>
                                            <td width="51%">
                                              <div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla ?>ProductoAccion2">Listo
                                                para registrar elementos </div>
                                            </td>
                                            ...
                                            <td>
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>ProductosResultado2"> </div>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2">
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Productos3" class="EstCapTrabajoTerminadoProductos"></div>
                                            </td>
                                            <td>&nbsp;</td>
                                          </tr>
                                          <tr>
                                        ...
                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            ...
                                            <td width="50%" align="left" valign="top">
                                              <div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla ?>TareaAccion"> Listo
                                                para registrar elementos</div>
                                            </td>
                                            ...
                                            <td align="left" valign="top">
                                              <div id="CapTrabajoTerminadoTareasResultado"> </div>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td colspan="2" align="left" valign="top">
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Tareas3" class="EstCapTrabajoTerminadoTareas"> </div>
                                            </td>
                                            <td align="left" valign="top">&nbsp;</td>
                                          </tr>
                                        </table>
                                      ...
                                      <div class="EstFormularioArea">
                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            ...
                                            <td width="47%" align="right"><a href="javascript:FncTrabajoTerminadoProductoListar('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncTrabajoTerminadoProductoEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla ?>');"></a></td>
                                            <td>
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>ProductosResultado"> </div>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2">
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Productos" class="EstCapTrabajoTerminadoProductos"></div>
                                            </td>
                                            <td>&nbsp;</td>
                                          </tr>
                                        </table>
                                      ...
                                      <div class="EstFormularioArea">
                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            <td align="left" valign="top">&nbsp;</td>
                                            <td width="50%" align="left" valign="top">
                                              <div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla ?>TareaAccion">
                                      ...
                                      <div class="EstFormularioArea">
                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="2">
                                              <div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla ?>Productos" class="EstCapTrabajoTerminadoProductos2"></div>
                                            </td>
                                            <td>&nbsp;</td>
                                          </tr>
                                          <tr>
                                        ...
                                        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                          ...
                                          <tr>
                                            ...
                                            <td align="left" valign="top">
                                              <table>
                                                <tr>
                                                  <td><input name="CmpProveedorNombre" type="text" class="EstFormularioCaja" id="CmpProveedorNombre" value="<?php echo $FichaAccionSalidaExternaProveedorNombreCompleto; ?>" size="45" maxlength="255" readonly="readonly" <?php if (!empty($FichaAccionSalidaExternaProveedorId)) {
                                            ...
                                            <td align="left" valign="top">Tipo Doc.:
                                              <input name="CmpProveedorId" type="hidden" id="CmpProveedorId" value="<?php echo $FichaAccionSalidaExternaProveedorId; ?>" size="3" />
                                            </td>
                                            <td align="left" valign="top"><select <?php if (!empty($FichaAccionSalidaExternaProveedorId)) {
                                                                                    echo 'disabled="disabled"';
                                                                                  } ?> class="EstFormularioCombo" name="CmpProveedorTipoDocumento" id="CmpProveedorTipoDocumento" disabled="disabled">
                                                <option value="">Escoja una opcion</option>
                                                <?php
                                            ...
                                            <td align="left" valign="top">
                                              <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  ...
                                                  <td><input name="CmpProveedorNumeroDocumento" type="text" class="EstFormularioCaja" id="CmpProveedorNumeroDocumento" value="<?php echo $FichaAccionSalidaExternaProveedorNumeroDocumento; ?>" size="20" maxlength="50" readonly="readonly" <?php if (!empty($FichaAccionSalidaExternaProveedorId)) {
                                                                                                                                                                                                                                                                                              echo 'readonly="readonly"';
                                                                                                                                                                                                                                                                                            } ?> /></td>
                                                  <td><a href="javascript:FncProveedorBuscar('NumeroDocumento');"></a></td>
                                                  <td>&nbsp;</td>
                                                  <td>
                                                    <div id="CapProveedorBuscar"></div>
                                                  </td>
                                                </tr>
                                              </table>
                                            </td>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    <tr>
                                      <td width="3%">&nbsp;</td>
                                      <td width="47%">
                                        <div class="EstFormularioAccion" id="CapTrabajoTerminadoHistorialAccion">Listo
                                          para registrar elementos</div>
                                      </td>
                                      ...
                                      <td width="1%">
                                        <div id="CapTrabajoTerminadoHistorialesResultado"> </div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td colspan="2">
                                        <div id="CapTrabajoTerminadoHistoriales" class="EstCapTrabajoTerminadoHistoriales"> </div>
                                      </td>
                                      <td>&nbsp;</td>
                                    </tr>
                                  </table>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    <tr>
                                      <td width="3%">&nbsp;</td>
                                      <td width="47%">
                                        <div class="EstFormularioAccion" id="CapTrabajoTerminadoCotizacionesAccion">Listo
                                          para registrar elementos</div>
                                      </td>
                                      ...
                                      <td width="1%">
                                        <div id="CapTrabajoTerminadoCotizacionesesResultado"> </div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td colspan="2">
                                        <div id="CapTrabajoTerminadoCotizacioneses" class="EstCapTrabajoTerminadoCotizacioneses"> </div>
                                      </td>
                                      <td>&nbsp;</td>
                                    </tr>
                                  </table>
                                ...
                                <div class="EstFormularioArea">
                                  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    <tr>
                                      <td width="1%">&nbsp;</td>
                                      <td width="49%">
                                        <div class="EstFormularioAccion" id="CapTrabajoTerminadoGastoAccion">Listo
                                          para registrar elementos</div>
                                      </td>
                                      ...
                                      <td width="1%">
                                        <div id="CapTrabajoTerminadoGastosResultado"> </div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td colspan="2">
                                        <div id="CapTrabajoTerminadoGastos" class="EstCapTrabajoTerminadoGastos"> </div>
                                      </td>
                                      <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="EstFormularioArea">
                          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                            ...
                            <tr>
                              ...
                              <td><input name="CmpInterior1" type="text" class="EstFormularioCaja" id="CmpInterior1" value="<?php if (empty($InsFichaIngreso->FinInterior1)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                                                                                                                              echo $InsFichaIngreso->FinInterior1;
                                                                                                                            } ?>" size="10" maxlength="1" readonly="readonly" /></td>
                              <td>&nbsp;</td>
                              <td>Cenicero:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior15" type="text" id="CmpInterior15" value="<?php if (empty($InsFichaIngreso->FinInterior15)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Parachoque:</td>
                              <td><input name="CmpExteriorDelantero1" type="text" class="EstFormularioCaja" id="CmpExteriorDelantero1" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero1)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td><input name="CmpExteriorDerecho1" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho1" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho1)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td><input name="CmpInterior2" type="text" class="EstFormularioCaja" id="CmpInterior2" value="<?php if (empty($InsFichaIngreso->FinInterior2)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Manual:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior16" type="text" id="CmpInterior16" value="<?php if (empty($InsFichaIngreso->FinInterior16)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Neblineros:</td>
                              <td><input name="CmpExteriorDelantero2" type="text" class="EstFormularioCaja" id="CmpExteriorDelantero2" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero2)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td><input name="CmpExteriorDerecho2" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho2" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho2)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td><input name="CmpInterior3" type="text" class="EstFormularioCaja" id="CmpInterior3" value="<?php if (empty($InsFichaIngreso->FinInterior3)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Antena:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior17" type="text" id="CmpInterior17" value="<?php if (empty($InsFichaIngreso->FinInterior17)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Faros:</td>
                              <td><input name="CmpExteriorDelantero3" type="text" class="EstFormularioCaja" id="CmpExteriorDelantero3" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero3)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Aros:</td>
                              <td><input name="CmpExteriorDerecho3" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho3" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho3)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td><input name="CmpInterior4" type="text" class="EstFormularioCaja" id="CmpInterior4" value="<?php if (empty($InsFichaIngreso->FinInterior4)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior18" type="text" id="CmpInterior18" value="<?php if (empty($InsFichaIngreso->FinInterior18)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Plumillas:</td>
                              <td><input name="CmpExteriorDelantero4" type="text" class="EstFormularioCaja" id="CmpExteriorDelantero4" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero4)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td><input name="CmpExteriorDerecho4" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho4" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho4)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td><input name="CmpInterior5" type="text" class="EstFormularioCaja" id="CmpInterior5" value="<?php if (empty($InsFichaIngreso->FinInterior5)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Airbags:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior19" type="text" id="CmpInterior19" value="<?php if (empty($InsFichaIngreso->FinInterior19)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Parabrisas:</td>
                              <td><input name="CmpExteriorDelantero5" type="text" class="EstFormularioCaja" id="CmpExteriorDelantero5" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero5)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td><input name="CmpExteriorDerecho5" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho5" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho5)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td><input name="CmpInterior6" type="text" class="EstFormularioCaja" id="CmpInterior6" value="<?php if (empty($InsFichaIngreso->FinInterior6)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior20" type="text" id="CmpInterior20" value="<?php if (empty($InsFichaIngreso->FinInterior20)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Emble:</td>
                              <td><input name="CmpExteriorDelantero6" type="text" class="EstFormularioCaja" id="CmpExteriorDelantero6" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero6)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td><input name="CmpExteriorDerecho6" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho6" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho6)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td><input name="CmpInterior7" type="text" class="EstFormularioCaja" id="CmpInterior7" value="<?php if (empty($InsFichaIngreso->FinInterior7)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior21" type="text" id="CmpInterior21" value="<?php if (empty($InsFichaIngreso->FinInterior21)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Bicel/Mascara:</td>
                              <td><input name="CmpExteriorDelantero7" type="text" class="EstFormularioCaja" id="CmpExteriorDelantero7" value="<?php if (empty($InsFichaIngreso->FinExteriorDelantero7)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td><input name="CmpExteriorDerecho7" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho7" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho7)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td>&nbsp;</td>
                              <td>A/C:</td>
                              <td><input name="CmpInterior8" type="text" class="EstFormularioCaja" id="CmpInterior8" value="<?php if (empty($InsFichaIngreso->FinInterior8)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior22" type="text" id="CmpInterior22" value="<?php if (empty($InsFichaIngreso->FinInterior22)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td>Lunas:</td>
                              <td><input name="CmpExteriorDerecho8" type="text" class="EstFormularioCaja" id="CmpExteriorDerecho8" value="<?php if (empty($InsFichaIngreso->FinExteriorDerecho8)) {
                                                                                                                                            echo "1";
                                                                                                                                          } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Reloj:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior9" type="text" id="CmpInterior9" value="<?php if (empty($InsFichaIngreso->FinInterior9)) {
                                                                                                                              echo "1";
                                                                                                                            } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior23" type="text" id="CmpInterior23" value="<?php if (empty($InsFichaIngreso->FinInterior23)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior10" type="text" id="CmpInterior10" value="<?php if (empty($InsFichaIngreso->FinInterior10)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior24" type="text" id="CmpInterior24" value="<?php if (empty($InsFichaIngreso->FinInterior24)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Parachoque:</td>
                              <td><input name="CmpExteriorPosterior1" type="text" class="EstFormularioCaja" id="CmpExteriorPosterior1" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior1)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior11" type="text" id="CmpInterior11" value="<?php if (empty($InsFichaIngreso->FinInterior11)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Triangulo:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior25" type="text" id="CmpInterior25" value="<?php if (empty($InsFichaIngreso->FinInterior25)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Faros:</td>
                              <td><input name="CmpExteriorPosterior2" type="text" class="EstFormularioCaja" id="CmpExteriorPosterior2" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior2)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Gdfgo Posterior:</td>
                              <td><input name="CmpExteriorIzquierdo1" type="text" class="EstFormularioCaja" id="CmpExteriorIzquierdo1" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo1)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Tapasoles:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior12" type="text" id="CmpInterior12" value="<?php if (empty($InsFichaIngreso->FinInterior12)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Extintor:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior26" type="text" id="CmpInterior26" value="<?php if (empty($InsFichaIngreso->FinInterior26)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Maletera:</td>
                              <td><input name="CmpExteriorPosterior3" type="text" class="EstFormularioCaja" id="CmpExteriorPosterior3" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior3)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Aros:</td>
                              <td><input name="CmpExteriorIzquierdo2" type="text" class="EstFormularioCaja" id="CmpExteriorIzquierdo2" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo2)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Sunroof:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior13" type="text" id="CmpInterior13" value="<?php if (empty($InsFichaIngreso->FinInterior13)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                              ...
                              <td><input class="EstFormularioCaja" name="CmpInterior27" type="text" id="CmpInterior27" value="<?php if (empty($InsFichaIngreso->FinInterior27)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Plumillas:</td>
                              <td><input name="CmpExteriorPosterior4" type="text" class="EstFormularioCaja" id="CmpExteriorPosterior4" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior4)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Puerta Posterior:</td>
                              <td><input name="CmpExteriorIzquierdo3" type="text" class="EstFormularioCaja" id="CmpExteriorIzquierdo3" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo3)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Encendedor:</td>
                              <td><input class="EstFormularioCaja" name="CmpInterior14" type="text" id="CmpInterior14" value="<?php if (empty($InsFichaIngreso->FinInterior14)) {
                                                                                                                                echo "1";
                                                                                                                              } else {
                            ...
                            <tr>
                              ...
                              <td><input name="CmpExteriorPosterior5" type="text" class="EstFormularioCaja" id="CmpExteriorPosterior5" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior5)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Puerta Delantera:</td>
                              <td><input name="CmpExteriorIzquierdo4" type="text" class="EstFormularioCaja" id="CmpExteriorIzquierdo4" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo4)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td>Emblema:</td>
                              <td><input name="CmpExteriorPosterior6" type="text" class="EstFormularioCaja" id="CmpExteriorPosterior6" value="<?php if (empty($InsFichaIngreso->FinExteriorPosterior6)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                              ...
                              <td>&nbsp;</td>
                              <td>Espejo Lateral:</td>
                              <td><input name="CmpExteriorIzquierdo5" type="text" class="EstFormularioCaja" id="CmpExteriorIzquierdo5" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo5)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td>Gdfgo Delantero:</td>
                              <td><input name="CmpExteriorIzquierdo6" type="text" class="EstFormularioCaja" id="CmpExteriorIzquierdo6" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo6)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td>Lunas:</td>
                              <td><input name="CmpExteriorIzquierdo7" type="text" class="EstFormularioCaja" id="CmpExteriorIzquierdo7" value="<?php if (empty($InsFichaIngreso->FinExteriorIzquierdo7)) {
                                                                                                                                                echo "1";
                                                                                                                                              } else {
                    ...
                    <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"><span id="sprytextfield3">
                            <label>
                              <input class="EstFormularioCajaFecha" name="CmpActaEntregaFecha" type="text" id="CmpActaEntregaFecha" value="<?php echo $InsFichaIngreso->FinActaEntregaFecha; ?>" size="15" maxlength="10" />
                            </label>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top">
                          ...
                          <script type="text/javascript">
                            tinymce.init({
                              selector: "textarea#CmpActaEntrega",
                              theme: "modern",
                              menubar: false,
                              toolbar1: "bold italic | bullist numlist",
                              width: 700,
                          ...
                          <textarea name="CmpActaEntrega" class="EstFormularioCaja" id="CmpActaEntrega"><?php echo stripslashes($InsFichaIngreso->FinActaEntrega); ?></textarea>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"><span id="sprytextfield2">
                            <label>
                              <input class="EstFormularioCajaFecha" name="CmpVentaFechaEntrega" type="text" id="CmpVentaFechaEntrega" value="<?php echo $InsFichaIngreso->FinVentaFechaEntrega; ?>" size="15" maxlength="10" />
                            </label>
                            <span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" alt="" border="0" align="absmiddle" title="Formato no valido" /></span></span><img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnVentaFechaEntrega" name="BtnVentaFechaEntrega" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                        <td align="left" valign="top">&nbsp;</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left" valign="top">
                                        <div class="EstCapTrabajoTerminadoFotoVINs" id="CapTrabajoTerminadoFotoVINs"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left" valign="top">
                                        <div class="EstCapTrabajoTerminadoFotoDelanteras" id="CapTrabajoTerminadoFotoDelanteras"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td align="left" valign="top">
                                        <div id="fileuploaderCupon">Escoger Archivos</div>
                                      </td>
                                      <td align="left" valign="top">
                                        <div class="EstCapTrabajoTerminadoFotoCupones" id="CapTrabajoTerminadoFotoCupones"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="EstFormularioArea">
                                  <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                    ...
                                    <tr>
                                      <td align="left" valign="top">&nbsp;</td>
                                      <td align="left" valign="top">
                                        <div id="fileuploaderMantenimiento">Escoger Archivos</div>
                                      </td>
                                      <td align="left" valign="top">
                                        <div class="EstCapTrabajoTerminadoFotoMantenimientos" id="CapTrabajoTerminadoFotoMantenimientos"></div>
                                      </td>
                                      <td align="left" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr>
    ...
    <script type="text/javascript">
      ...
      Calendar.setup({
        ...
        ifFormat: "%d/%m/%Y", //  
        button: "BtnActaEntregaFecha" // el id del bot�n que  
      });
      ...
      Calendar.setup({
        ...
        ifFormat: "%d/%m/%Y", //  
        button: "BtnVentaFechaEntrega" // el id del bot�n que  
      });
