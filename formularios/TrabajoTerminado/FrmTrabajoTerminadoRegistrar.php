                              ...
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top"><input type="hidden" name="CmpFichaAccionCausa_<?php echo $DatFichaIngresoModalidad->MinSigla?>" id="CmpFichaAccionCausa_<?php echo $DatFichaIngresoModalidad->MinSigla?>" value="<?php echo stripslashes($FichaAccionCausa);?>" />
                                    <div class="EstFormularioObservacion"> <?php echo stripslashes($FichaAccionCausa);?></div></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                              ...
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top"><input type="hidden" name="CmpFichaAccionSolucion_<?php echo $DatFichaIngresoModalidad->MinSigla?>" id="CmpFichaAccionSolucion_<?php echo $DatFichaIngresoModalidad->MinSigla?>" value="<?php echo stripslashes($FichaAccionSolucion);?>" />
                                    <div class="EstFormularioObservacion"> <?php echo stripslashes($FichaAccionSolucion);?></div></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td colspan="3"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td width="51%"><div class="EstFormularioAccion" id="Cap<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductoAccion2">Listo
                                    para registrar elementos </div></td>
                                  ...
                                  <td><div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductosResultado2"> </div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td colspan="2"><div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla?>Productos3" class="EstCapTrabajoTerminadoProductos" ></div></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
