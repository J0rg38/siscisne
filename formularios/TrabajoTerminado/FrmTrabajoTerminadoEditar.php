...
//if($InsFichaIngreso->FinEstado == 74 or $InsFichaIngreso->FinEstado == 73 or $InsFichaIngreso->FinEstado == 75){
if($InsFichaIngreso->FinEstado == 73 or $InsFichaIngreso->FinEstado == 74){
?>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">EDITAR ORDEN DE TRABAJO TERMINADO</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<input name="CmpModalidadIngresoId_<?php echo $DatFichaIngresoModalidad->MinSigla?>" type="hidden" id="CmpModalidadIngresoId_<?php echo $DatFichaIngresoModalidad->MinSigla?>" value="<?php echo $DatFichaIngresoModalidad->MinId;?>" />
                            ...
                            <span style="color:#F5F5F5">(<?php echo $FichaAccionId;?>) / (<?php echo $DatFichaIngresoModalidad->FimId;?>) / (<?php echo $FichaAccionFecha;?>) </span></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td align="left" valign="top">Detalle de Mano de Obra:</td>
                            <td align="left" valign="top"><textarea name="CmpFichaAccionManoObraDetalle_<?php echo $DatFichaIngresoModalidad->MinSigla?>" cols="45" rows="2" class="EstFormularioCaja" id="CmpFichaAccionManoObraDetalle_<?php echo $DatFichaIngresoModalidad->MinSigla?>"><?php echo stripslashes($FichaAccionManoObraDetalle);?></textarea></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            ...
                            <input class="EstFormularioCaja" name="CmpFichaAccionManoObra_<?php echo $DatFichaIngresoModalidad->MinSigla?>" type="text" id="CmpFichaAccionManoObra_<?php echo $DatFichaIngresoModalidad->MinSigla?>" value="<?php echo number_format($FichaAccionManoObra,2);?>" size="10" maxlength="10" />
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2" align="left" valign="top"><input <?php echo ($FichaIngresoModalidadObsequio==1)?'checked="checked"':''; ?>  type="checkbox" name="CmpFichaIngresoModalidadObsequio_<?php echo $DatFichaIngresoModalidad->MinSigla; ?>" id="CmpFichaIngresoModalidadObsequio_<?php echo $DatFichaIngresoModalidad->MinSigla; ?>" value="1" />
...
<div class="EstFormularioArea" >
                          ...
                          <tr>
                            <td width="33%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  <td width="2%" align="left" valign="top"><a href="javascript:FncTrabajoTerminadoTareaEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"></a></td>
                                  ...
                                  <td width="1%" align="left" valign="top"><div id="CapTrabajoTerminadoTareasResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                            ...
                            <td width="33%" align="left" valign="top"><div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="2%"><div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla?>ProductosResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
    ...
    <div class="EstFormularioObservacion"> <?php echo stripslashes($FichaAccionCausa);?>                               </div>
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top">
                                    ...
                                    <span class="EstFormularioNota">* En caso de una Garantia, Campa�a o Politica, rellene este espacio.</span>
...
<div class="EstFormularioArea" >
    ...
    <div class="EstFormularioObservacion"> <?php echo stripslashes($FichaAccionSolucion);?>                               </div>
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top"><span class="EstFormularioNota">* En caso de una Garantia, Campa�a o Politica, rellene este espacio.</span></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                              </table>
                            </div>
                              ...
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td colspan="2" align="left" valign="top">
                                    ...
                                    <a href="javascript:FncTrabajoTerminadoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"></a>                                  </td>
                                  <td width="4" align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td colspan="2" align="left" valign="top"><div id="fileuploader<?php echo $DatFichaIngresoModalidad->MinSigla?>">Escoger Archivos</div></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td colspan="2" align="left" valign="top"><div class="EstCapTrabajoTerminadoFotos" id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla;?>Fotos2"></div></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                              ...
                              <table width="30%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="49%" align="left" valign="top"><div class="EstFormularioAccion" id="CapTemparioAccion">Listo
                                    para registrar elementos<a href="javascript:FncTrabajoTerminadoTemparioEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"></a></div></td>
                                  <td width="49%" align="right" valign="top"><a href="javascript:FncTrabajoTerminadoTemparioListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncTrabajoTerminadoTemparioEliminarTodo('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a></td>
                                  <td width="1%" align="left" valign="top"><div id="CapTrabajoTerminadoTempariosResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td colspan="2" align="left" valign="top"><div id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla?>Temparios" class="EstCapTrabajoTerminadoTemparios" > </div></td>
                          ...
                          <tr>
                            <td align="left" valign="top"><div class="EstFormularioArea">
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                <tr>
                                  <td width="4" align="left" valign="top">&nbsp;</td>
                                  <td width="344" align="left" valign="top">PRODUCTOS</td>
                                  <td width="5" align="left" valign="top">&nbsp;</td>
                                </tr>
                              </table>
                            </div></td>
...
<div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="139" align="right" valign="top"><a href="javascript:FncTrabajoTerminadoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
    ...
    <div id="tab<?php echo $c+1;?>" class="tab_content">
        ...
        <tr>
          ...
          <td align="left" valign="top"><span id="sprytextfield3">
            ...
            <span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" alt=""  border="0" align="absmiddle" title="Formato no valido"  /></span></span> <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnActaEntregaFecha" name="BtnActaEntregaFecha" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
          <td align="left" valign="top">&nbsp;</td>
          </tr>
        <tr>
          <td>&nbsp;</td>
