	...
	*/				
			if(!empty($ProductoId)){
				...
				if(empty($InsFichaAccionMantenimiento->Parametro12)){
					...
					//deb('InsFichaAccionMantenimiento'.$ModalidadIngreso.$Identificador);
					//deb($InsFichaAccionMantenimiento->Item);
					// echo "NOOB";
					
					//deb($ProductoNombre." - ".$ProductoCantidad);
...
$OpcAccion4 = '';
						//deb("xxx");
                            if($DatSesionObjeto->Parametro3 == $DatPlanMantenimientoTarea->PmtId){
								...
								$FichaAccionProductoVerificar2 = $DatSesionObjeto->Parametro15;//$DatSesionObjeto->Parametro9;
...
<?php //deb($FichaAccionProductoVerificar2);?>

 <select  name="CmpPlanMantenimientoDetalleAccion_<?php echo $DatPlanMantenimientoTarea->PmtId;?>" id="CmpPlanMantenimientoDetalleAccion_<?php echo $DatPlanMantenimientoTarea->PmtId;?>" <?php echo ( ($POST_Editar == 2 and $POST_RecibirEditar == 2) or ($FichaAccionProductoVerificar2 == 2 and !empty($FichaAccionProductoVerificar2)) )?'disabled="disabled"':'';?>    >
...
if($POST_Editar==1 ){
?>
	<a <?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 )?'style="display:none;"':''?> id="Btn<?php echo $DatPlanMantenimientoTarea->PmtId?>FichaAccionProductoNuevo" href="javascript:FncFichaAccionProductoNuevo('<?php echo $DatPlanMantenimientoTarea->PmtId?>');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
<?php
}
?>
				</td>
...
<input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoNombre" type="text" class="<?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2))  )?'EstFormularioCajaDeshabilitada':'EstFormularioCaja'?>"   <?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'readonly="readonly"':'';?>  id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoNombre" size="40" value="<?php echo $ProductoNombre;?>" />
...
<select  class="EstFormularioCombo" name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir" id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir"  <?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'disabled="disabled"':'';?> >
...
<input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId;?>ProductoCantidad" type="text" class="<?php echo ($PlanMantenimientoDetalleAccion<>"C" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'EstFormularioCajaDeshabilitada':'EstFormularioCaja'?>"   <?php echo ($PlanMantenimientoDetalleAccion<>"C"or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'readonly="readonly"':'';?>  id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoCantidad" size="10" maxlength="10" value="<?php echo number_format($ProductoCantidad,2);?>"  />
...
<input title="<?php echo $FichaAccionProductoId;?>" type="checkbox" <?php echo ($PlanMantenimientoDetalleVerificar1==1)?'checked="checked"':'';?>  name="CmpPlanMantenimientoDetalleVerificar1_<?php echo $DatPlanMantenimientoTarea->PmtId;?>" id="CmpPlanMantenimientoDetalleVerificar1_<?php echo $DatPlanMantenimientoTarea->PmtId;?>" value="1"   <?php echo ($PlanMantenimientoDetalleAccion=="X" )?'disabled="disabled"':'';?>   />
                </td>
                <td align="left"   >
...
?>
                ...
                <input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoNombre" type="text" class="<?php echo ($PlanMantenimientoDetalleAccion<>"R" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'EstFormularioCajaDeshabilitada':'EstFormularioCaja'?>"   <?php echo ($PlanMantenimientoDetalleAccion<>"R" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'readonly="readonly"':'';?>  id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoNombre" size="40" value="<?php echo $ProductoNombre;?>" />
...
$ArrProductoTipoUnidadMedidas = $ResProductoTipoUnidadMedida['Datos'];
?>
<select  class="EstFormularioCombo" name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir" id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId?>ProductoUnidadMedidaConvertir"  <?php echo ($PlanMantenimientoDetalleAccion<>"R" or $POST_Editar==2 or ($FichaAccionProductoVerificar2==2 and !empty($FichaAccionProductoVerificar2)) )?'disabled="disabled"':'';?> >
  <option value="">Escoja una opcion</option>
  <?php
if(!empty($ProductoTipoId) || !empty($ProductoUnidadMedida)){
?>
...
session_start();
if (!isset($_SESSION['InsTrabajoTerminadoMantenimiento'.$ModalidadIngreso.$Identificador])){
	$_SESSION['InsTrabajoTerminadoMantenimiento'.$ModalidadIngreso.$Identificador] = new ClsSesionObjeto();	
}
...
$RepSesionObjetos = $_SESSION['InsTrabajoTerminadoMantenimiento'.$ModalidadIngreso.$Identificador]->MtdObtenerSesionObjetos(true);
$ArrSesionObjetos = $RepSesionObjetos['Datos'];
$SesionObjetosTotal = $RepSesionObjetos['Total'];
$SesionObjetosTotalSeleccionado = $RepSesionObjetos['TotalSeleccionado'];
...
if($POST_Editar==1){
?>
<a href="javascript:FncTrabajoTerminadoProductoNuevo('<?php echo $DatPlanMantenimientoTarea->PmtId?>');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
<?php
}
?>
				</td>
