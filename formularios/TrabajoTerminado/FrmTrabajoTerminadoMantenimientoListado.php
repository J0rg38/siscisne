...
if (!isset($_SESSION['InsTrabajoTerminadoMantenimiento' . $ModalidadIngreso . $Identificador])) {
  ...
  $_SESSION['InsTrabajoTerminadoMantenimiento' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTrabajoTerminadoMantenimiento' . $ModalidadIngreso . $Identificador]);
}
  ...
  ?>
    ...
    if ($POST_MantenimientoLlenadoAutomatico == 1) {
      ...
      foreach ($ArrTareaProductos as $DatTareaProducto) {
        ...
        $RepFichaAccionMantenimiento = $_SESSION['InsTrabajoTerminadoMantenimiento' . $ModalidadIngreso . $Identificador]->MtdVerificarExisteSesionObjeto2($DatTareaProducto->PmtId);
        $ExisteFichaAccionMantenimiento = $RepFichaAccionMantenimiento['Existe'];
        $InsTrabajoTerminadoMantenimiento = $RepFichaAccionMantenimiento['Datos'];
	...
	*/
          if (!empty($ProductoId)) {
            //deb($InsTrabajoTerminadoMantenimiento->Parametro12);
            if (empty($InsTrabajoTerminadoMantenimiento->Parametro12)) {

              //deb('InsTrabajoTerminadoMantenimiento'.$ModalidadIngreso.$Identificador);
              //deb($InsTrabajoTerminadoMantenimiento->Item);
              // echo "NOOB";

              //deb($ProductoNombre." - ".$ProductoCantidad);

              $_SESSION['InsTrabajoTerminadoMantenimiento' . $ModalidadIngreso . $Identificador]->MtdEditarSesionObjeto(
                $InsTrabajoTerminadoMantenimiento->Item,
                1,
                $InsTrabajoTerminadoMantenimiento->Parametro1,
                NULL,
                $InsTrabajoTerminadoMantenimiento->Parametro3,
                $InsTrabajoTerminadoMantenimiento->Parametro4,
                $InsTrabajoTerminadoMantenimiento->Parametro5,
                date("d/m/Y H:i:s"),
                $InsTrabajoTerminadoMantenimiento->Parametro7,
                $InsTrabajoTerminadoMantenimiento->Parametro8,
                $InsTrabajoTerminadoMantenimiento->Parametro9,
                $InsTrabajoTerminadoMantenimiento->Parametro10,
                ...
                $ProductoUnidadMedidaOrigen,
                2,
                $InsTrabajoTerminadoMantenimiento->Parametro25
              );
            }
          }
        }
    ...
    ?>
        ...
        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
          ...
          <tr>
            ...
            <td width="277" align="left"><?php //echo $InsPlanMantenimiento->VveNombre;
                                          ?></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
*/
                              ...
                              <select class="EstFormularioCombo" name="CmpPlanMantenimientoDetalleAccion_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" id="CmpPlanMantenimientoDetalleAccion_<?php echo $DatPlanMantenimientoTarea->PmtId; ?>" disabled="disabled">
                            ...
                            <td align="right">
                              ...
                              <input name="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId; ?>ProductoCantidad" type="text" class="EstFormularioCajaDeshabilitada" readonly="readonly" id="Cmp<?php echo $DatPlanMantenimientoTarea->PmtId ?>ProductoCantidad" size="10" maxlength="10" value="<?php echo number_format($ProductoCantidad, 2); ?>" />
