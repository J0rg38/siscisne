...
session_start();
if (!isset($_SESSION['InsTrabajoTerminadoFoto'.$ModalidadIngreso.$Identificador])){
	$_SESSION['InsTrabajoTerminadoFoto'.$ModalidadIngreso.$Identificador] = new ClsSesionObjeto();	
}
...
$RepSesionObjetos = $_SESSION['InsTrabajoTerminadoFoto'.$ModalidadIngreso.$Identificador]->MtdObtenerSesionObjetos(true);
