...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsTrabajoTerminado.js" ></script>

<!-- ARCHIVO DE ESTILOS CSS -->
<style type="text/css">
@import url('<?php echo $InsProyecto->MtdFormulariosCss("FichaIngreso");?>CssFichaIngreso.css');
</style>
<?php
/* 
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccTrabajoTerminado.php');
...
$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos("fin.FinId,EinVIN,EinPlaca,EinColor,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FinConductor,VmaNombre,VmoNombre,VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"73,74,75,8,9,10",$POST_Prioridad,$POST_Modalidad,NULL,NULL,$POST_Personal,1,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,$POST_VehiculoMarca,NULL,$POST_Sucursal);
...
<!--<div class="EstSubMenuBoton"><a href="javascript:FncEnviarOrdenTrabajoTallerSeleccionados();"><img src="imagenes/iconos/enviar_taller3.png" alt="[Regresar OT a Taller]" title="Regresar OT a Taller" /> Taller</a></div>
...
<!--<div class="EstSubMenuBoton"><a href="javascript:FncEnviarFichaIngresoTallerSeleccionados();"><img src="imagenes/submenu/enviar_taller2.png" alt="[Enviar OT a Taller]" title="Enviar OT a Taller" /> Taller</a></div>-->

<div class="EstSubMenuSeparacion"></div>
  
<div class="EstSubMenuBoton"><a href="javascript:FncEnviarOrdenTrabajoNoFacturableSeleccionados();"><img src="imagenes/submenu/no_facturable.png" alt="[No Facturable]" title="No Facturable" /> No/Fact.</a></div>


<div class="EstSubMenuBoton"><a href="javascript:FncEnviarOrdenTrabajoNoFacturableCancelarSeleccionados();"><img src="imagenes/submenu/no_facturable_cancelar.png" alt="[No Facturable]" title="No Facturable" /> Cancelar</a></div>


<div class="EstSubMenuSeparacion"></div>

<div class="EstSubMenuBoton"><a href="javascript:FncEnviarOrdenTrabajoContabilidadSeleccionados();"><img src="imagenes/submenu/enviar_facturacion.png" alt="[Enviar OT a Contabilidad]" title="Enviar OT a Contabilidad" /> Facturacion</a></div> 

<div class="EstSubMenuBoton"><a href="javascript:FncEnviarOrdenTrabajoRecepcionSeleccionados();"><img src="imagenes/submenu/enviar_facturacion_cancelar.png" alt="[Cancelar envio de OT a Contabilidad]" title="Cancelar envio de OT a Contabilidad" /> Cancelar</a></div>


<div class="EstSubMenuSeparacion"></div>
  
<div class="EstSubMenuBoton"><a href="javascript:FncGenerarGarantiaSeleccionados();"><img src="imagenes/submenu/garantias.png" alt="[Generar Garantias]" title="Generar Garantias" /> Garantia</a></div>

<div class="EstSubMenuBoton"><a href="javascript:FncGenerarGarantiaRepuestoIsuzuSeleccionados();"><img src="imagenes/submenu/icon_formulario_reclamo_isuzu128.png" alt="[Generar Formulario de Reclamacion - Isuzu]" title="Generar Formulario de Reclamacion Isuzu" /> Reclamo</a></div>


<div class="EstSubMenuBoton"><a href="javascript:FncActualiarCierreSeleccionados();"><img src="imagenes/submenu/cierre_ot.png" alt="[Actualizar Cierre O.T.]" title="Actualizar Cierre O.T." /> Cierre O.T.</a></div>
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ORDENES DE TRABAJO TERMINADAS</span>  </td>
...
<select class="EstFormularioCombo" name="CmpVehiculoMarca" id="CmpVehiculoMarca" >
          ...
          Tecnico: <select  class="EstFormularioCombo" name="CmpPersonal" id="CmpPersonal" >
                    <option value="">Escoja una opcion</option>
                    <?php
					foreach($ArrTecnicos as $DatTecnico){
					?>
                    <option <?php echo ($DatTecnico->PerId==$POST_Personal)?'selected="selected"':'';?>  value="<?php echo $DatTecnico->PerId;?>"><?php echo $DatTecnico->PerNombre ?> <?php echo $DatTecnico->PerApellidoPaterno; ?> <?php echo $DatTecnico->PerApellidoMaterno; ?></option>
                    <?php
					}
					?>
                  </select>                
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td width="2%" align="center" bgcolor="<?php echo $Color;?>"  >
                  ...
                  <input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FinId; ?>" estado="<?php echo $dat->FinEstado;?>" garantia="<?php echo $dat->FinGarantiaGenerar;?>" />				
                  
                  
                </td>
                <td align="right" valign="middle" width="4%"  bgcolor="<?php echo $Color;?>"  >
				...
				<?php echo $dat->FinId;  ?>
                  ...
                  <?php
if($dat->FinEstado <> 73 and $dat->FinEstado <> 74 and $dat->FinEstado <> 75 and $dat->FinEstado <> 8 and $dat->FinEstado <> 9 and $dat->FinEstado<>777){
?>
...
?>	          
		...
		?>
                  ...
                  <?php
				/*  if(!empty($dat->FinMantenimientoKilometraje) and $DatFichaIngresoModalidad->MinSigla=="MA"){
					  ?>
                      (<?php echo ($dat->FinMantenimientoKilometraje); ?> km)
                      <?php
				  }*/
				  ?> 
                  <br />
  <?php
		...
		?></td>
                ...
                <td  width="3%" align="right" bgcolor="<?php echo $Color;?>" ><?php echo (empty($dat->LtiAbreviatura)?$dat->LtiNombre:$dat->LtiAbreviatura)//FncCortarTexto($dat->LtiNombre,15);?></td>
                <td  width="5%" align="left" bgcolor="<?php echo $Color;?>" >
                  - <?php
if($PrivilegioClienteEditar or $PrivilegioClienteVer){
?>
                  
                  
  <a href="javascript:FncClienteCargarFormulario('<?php echo (($PrivilegioClienteEditar)?'Editar':'Ver');?>','<?php echo $dat->CliId?>');"  >
  <?php echo ($dat->CliNombre);?> <?php echo ($dat->CliApellidoPaterno);?> <?php echo ($dat->CliApellidoMaterno);?></a>
...
?>
    ...
    ?>
                ...
                <td  width="5%" align="right" bgcolor="<?php echo $Color;?>" ><h2><?php echo ($dat->EinPlaca);?></h2></td>
...
<b>Marca:</b> <?php echo ($dat->VmaNombre);?><br />
<b>Modelo:</b> <?php echo ($dat->VmoNombre);?><br />
<b>Version:</b> <?php echo ($dat->VveNombre);?>

</td>
                <td  width="4%" align="right" bgcolor="<?php echo $Color;?>" ><?php echo ($dat->EinColor);?></td>
                <td  width="3%" align="right" bgcolor="<?php echo $Color;?>" ><?php echo number_format($dat->FinFichaAccionManoObra,2);?></td>
                <td  width="3%" align="right" bgcolor="<?php echo $Color;?>" >
                ...
                <td  width="9%" align="right" bgcolor="<?php echo $Color;?>" ><?php echo ($dat->PerNombre);?> <?php echo ($dat->PerApellidoPaterno);?> <?php echo ($dat->PerApellidoMaterno);?></td>
                <td  width="7%" align="right" bgcolor="<?php echo $Color;?>" >
                ...
                <td  width="7%" align="left" bgcolor="<?php echo $Color;?>" >
                  <?php
if($dat->FinAlmacenMovimientoSalida == "Si"){	
?>
                  <a href="formularios/TallerPedido/DiaAlmacenMovimientoListado.php?height=440&amp;width=850&amp;FinId=<?php echo $dat->FinId?>" class="thickbox" title=""><img src="imagenes/acciones/enlace.gif" alt="" width="18" height="18" title="Enlace" align="Enlace" border="0" /> Fichas Salida</a>
                  <br />
                  <?php	
}
?>
...
?>
                  ...
                  <?php
if($dat->FinVentaDirecta=="Si"){
?>
                  <a href="formularios/FichaIngreso/DiaVentaDirectaListado.php?height=440&amp;width=850&amp;FinId=<?php echo $dat->VdiId?>" class="thickbox" title=""><img src="imagenes/acciones/enlace.gif" alt="" width="18" height="18" border="0" align="Enlace" title="Enlace" /> V.D.</a>
                  <br />
                  <?php
}
?>
...
?>
  ...
  <a target="<?php echo (!empty($dat->ObsArchivo)?'_blank'.$dat->ObsArchivo:'');?>" href="<?php echo (!empty($dat->ObsArchivo)?'subidos/obsequio_archivos/'.$dat->ObsArchivo:'#');?>">
    ...
    <img src="imagenes/avisos/<?php echo $dat->ObsFoto;?>" alt="<?php echo $dat->ObsNombre?>" title="<?php echo $dat->ObsNombre?>" border="0" width="25" height="25"/>
                ...
                ?>                </td>
                <td  width="9%" align="center" bgcolor="<?php echo $Color;?>" >
                  
                  <?php
if($dat->FinEstado == 73 || $dat->FinEstado == 74 || $dat->FinEstado == 75 || $dat->FinEstado == 8 || $dat->FinEstado == 9  || $dat->FinEstado == 10){
?>
				  <?php
...
<?php
if($PrivilegioEditar  and $dat->FinEstado==73){
?>		                
                  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Registrar&Id=<?php echo $dat->FinId;?>"><img src="imagenes/acciones/generar.jpg" width="19" height="19" border="0" title="Revisar Ord. Trabaj. Terminado" alt="[Revisar Ord. Trabaj. Terminado]"   /></a>                
...
?>
	...
	<?php
    if($PrivilegioEditar and ( $dat->FinEstado==74 )){
    ?>             
                  
                  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $dat->FinId;?>"><img src="imagenes/acciones/editar.gif" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>                 
	...
	<?php
    if($PrivilegioEditar and ($dat->FinEstado==75 ||  $dat->FinEstado==8 || $dat->FinEstado==9 || $dat->FinEstado==10) ){
    ?>             
                  
		<a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Adicionar&Id=<?php echo $dat->FinId;?>"><img src="imagenes/acciones/editar2.gif" width="19" height="19" border="0" title="Adicionar" alt="[Adicionar]"   /></a> 
...
if($PrivilegioVer){
?>		                
                  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->FinId;?>"><img src="imagenes/acciones/ver.gif" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>                
...
?>
			...
			?>        
                  ...
                  <a href="javascript:FncGenerarPDF('<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/pdf.png" alt="[PDF]" title="PDF" width="19" height="19" border="0" /></a>
...
if($PrivilegioEditar){
?>	
  <a href="javascript:FncFichaIngresoSeguimientoClienteCargarFormulario('<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/llamadas2.png" alt="[Llamadas]" title="Llamadas" width="19" height="19" border="0" /></a>
  <?php
}
?> 
...
?>
    ...
    <?php
    if($PrivilegioEncuestaRegistrar){
    ?>	
    
        <a href="javascript:FncEncuestaCargarFormulario('Registrar','','<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/encuesta2.jpg" alt="[Encuesta]" title="Encuesta" width="19" height="19" border="0" /></a>
    <?php
    }
    ?> 
...
?>
	<?php
	if($PrivilegioEncuestaEditar or $PrivilegioEncuestaVer){
	?>	
   
    
		<a href="javascript:FncEncuestaCargarFormulario('<?php echo (($PrivilegioEncuestaEditar)?'Editar':'Ver');?>','<?php echo $dat->EncId;?>','<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/encuesta2.jpg" alt="[Encuesta]" title="Encuesta" width="19" height="19" border="0" /></a>
	<?php
	}
	?>   
...
?>             
                  <a href="javascript:FncFichaIngresoModalidadIngresoEditar('<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/mingreso.png" width="19" height="19" border="0" title="Modalidad Ingreso" alt="[Modalidad Ingreso]"   /></a>
                  
  <?php
}else if($PrivilegioEditar and ($dat->FinEstado  == 2 or $dat->FinEstado == 3 or $dat->FinEstado == 4)){
?>
                  
                  <a href="javascript:FncFichaAccionModalidadIngresoEditar('<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/mingreso.png" width="19" height="19" border="0" title="Modalidad Ingreso" alt="[Modalidad Ingreso]"   /></a>   
...
?>
                  ...
                  <a href="javascript:FncTallerPedidoModalidadIngresoEditar('<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/mingreso.png" width="19" height="19" border="0" title="Modalidad Ingreso" alt="[Modalidad Ingreso]"   /></a>        
...
/*if($PrivilegioEditar){
?>	
  <a href="javascript:FncTrabajoTerminadoEnviarMensajeTexto('<?php echo $dat->FinId;?>');"><img src="imagenes/acciones/icon_enviar_sms50.png" alt="[Enviar SMS]" title="Enviar SMS" width="19" height="19" border="0" /></a>
  <?php
}*/
?>  
