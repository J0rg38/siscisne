...
if (!isset($_SESSION['InsTrabajoTerminadoProducto' . $ModalidadIngreso . $Identificador])) {
  ...
  $_SESSION['InsTrabajoTerminadoProducto' . $ModalidadIngreso . $Identificador] = FncRepararClase('ClsSesionObjeto', $_SESSION['InsTrabajoTerminadoProducto' . $ModalidadIngreso . $Identificador]);
}
