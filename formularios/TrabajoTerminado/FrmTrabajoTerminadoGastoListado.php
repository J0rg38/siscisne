...
//SesionObjeto-TrabajoTerminadoGasto
//Parametro1 = FigId
//Parametro2 = GasId
...
$RepSesionObjetos = $_SESSION['InsTrabajoTerminadoGasto'.$Identificador]->MtdObtenerSesionObjetos(true);
...
<td align="right"><?php echo number_format($DatSesionObjeto->Parametro14,3,'.','');?></td>
<td align="right">
...
?>
  ...
  <a class="EstSesionObjetosItem" href="javascript:FncTrabajoTerminadoGastoEscoger('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
...
if($_POST['Eliminar']==1){
?>
  <a href="javascript:FncTrabajoTerminadoGastoEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');" >
