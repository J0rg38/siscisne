...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccTrabajoTerminadoAdicionar.php');
...
<?php
if($InsFichaIngreso->FinEstado == 75 or $InsFichaIngreso->FinEstado == 8 or $InsFichaIngreso->FinEstado == 9  or $InsFichaIngreso->FinEstado == 10){
?>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ADICIONAR ORDEN DE TRABAJO TERMINADO</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<input name="CmpModalidadIngresoId_<?php echo $DatFichaIngresoModalidad->MinSigla?>" type="hidden" id="CmpModalidadIngresoId_<?php echo $DatFichaIngresoModalidad->MinSigla?>" value="<?php echo $DatFichaIngresoModalidad->MinId;?>" />
                          ...
                          <tr>
                            ...
                            <input name="CmpFichaAccionManoObra_<?php echo $DatFichaIngresoModalidad->MinSigla?>" type="text" class="EstFormularioCaja" id="CmpFichaAccionManoObra_<?php echo $DatFichaIngresoModalidad->MinSigla?>" value="<?php echo number_format($FichaAccionManoObra,2);?>" size="10" maxlength="10"  />
                            ...
                            <td colspan="2" align="left" valign="top"><div class="EstFormularioArea" >
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="130" align="right" valign="top"><a href="javascript:FncTrabajoTerminadoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                              ...
                              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                <tr>
                                  ...
                                  <td width="132" align="right" valign="top">
									...
									<a href="javascript:FncTrabajoTerminadoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"></a>
                                ...
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top"></td>
                                  <td align="right" valign="top"><a href="javascript:FncTrabajoTerminadoFotoListar('<?php echo $DatFichaIngresoModalidad->MinSigla?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
                                  ...
                                  <td align="left" valign="top"><div class="EstCapTrabajoTerminadoFotos" id="CapTrabajoTerminado<?php echo $DatFichaIngresoModalidad->MinSigla;?>Fotos"></div></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top">&nbsp;</td>
 ...
 <div class="EstFormularioArea">
	  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
	    ...
	    <tr>
	      ...
	      <td align="left" valign="top"><span id="sprytextfield3"><span id="sprytextfield">
	        <label>
	        ...
	        <span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" alt=""  border="0" align="absmiddle" title="Formato no valido"  /></span></span><span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" alt=""  border="0" align="absmiddle" title="Formato no valido"  /></span></span> <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnActaEntregaFecha" name="BtnActaEntregaFecha" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
	      <td align="left" valign="top">&nbsp;</td>
	      </tr>
	    <tr>
	      <td>&nbsp;</td>
