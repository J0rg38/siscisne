...
<select class="EstFormularioCombo" name="Con" id="Con">
      ...
      <option <?php if($POST_con=="nocontiene"){ echo 'selected="selected"';}?> value="nocontiene">No Contiene</option>
       ...
       <!--<select class="EstFormularioCombo" name="Cam" id="Cam">
      	<option value="AciId" <?php if($POST_cam=="AciId"){ echo 'selected="selected"';}?>>Id</option>
        <option value="AciNumero" <?php if($POST_cam=="AciNumero"){ echo 'selected="selected"';}?>>Nombre</option>
      </select>-->
 ...
 <!--      Estado
	  ...
	  <input class="EstFormularioBoton" name="btn_buscar" type="submit" onAcick="javascript:FncBuscar();" id="btn_buscar" value="Filtrar" /></td>
</tr>
<tr>
<td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstTablaListado" >
      ...
      <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				<input onAcick="javascript:FncSeleccionarTodo();" type="checkbox" name="cmp_seleccionar_todo" id="cmp_seleccionar_todo" />				</th>
...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
				  ...
				  <option <?php if($POST_num==$AlmacenCierresTotal){ echo 'selected="selected"';}?> value="<?php echo $AlmacenCierresTotal;?>">Todos</option>
                </select>
	...
	<a class="EstPaginacion"  href="javascript:FncPaginar('<?php echo $num?>,<?php echo $numxpag;?>','<?php echo $i?>');" ><?php echo $i?></a>                        
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input onclick="javascript:FncAgregarSeleccionado();" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->AciId; ?>" />				</td>
