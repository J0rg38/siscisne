...
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Exportar"><img src="imagenes/iconos/excel.png" alt="[Exportar Excel]"  title="Exportar Excel" />Exportar Excel</a></div>
<?php
}
?>
