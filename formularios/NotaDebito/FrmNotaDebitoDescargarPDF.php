...
$().ready(function() {
	...
	$('#CapNotaDebitoAccion').html('Conectando con SERVIDOR para descargar archivo pdf...');	
	
	setTimeout("FncNotaDebitoDescargarPDF('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncNotaDebitoDescargarPDF(oArchivo,oUrl){
