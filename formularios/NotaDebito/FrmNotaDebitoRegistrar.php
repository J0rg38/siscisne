...
include($InsProyecto->MtdFormulariosMsj($GET_mod).'MsjNotaDebito.php');
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccNotaDebitoRegistrar.php');
...
//var DocumentoAutocompletarVariables = '&NotaDebito=Si';
//var DocumentoAutocompletarFuncion = "FncNotaDebitoDetalleDocumentoGuardar";
...
*/			
	...
	<?php
	if(!empty($_SESSION['SisNdtId']) and empty($GET_id) or !empty($POST_do) ){
	?>
		FncGenerarNotaDebitoId('<?php echo $_SESSION['SisNdtId'];?>');
	<?php
	}
	?>
    ...
    <div id="tab1" class="tab_content">
       ...
       <tr>
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="4">&nbsp;</td>
            <td colspan="6"><span class="EstFormularioSubTitulo">Datos de la Nota de Debito</span>
          ...
          <tr>
            ...
            <td colspan="6" align="right">
              ...
              <table>
                ...
                <select  onchange="FncGenerarNotaDebitoId(this.value);"  class="EstFormularioCombo" name="CmpTalonario" id="CmpTalonario">
                    <option value="">-</option>
                    <?php
                    foreach($ArrNotaDebitoTalonarios as $DatNotaDebitoTalonario){
                    ?>
                    <option <?php if(!empty($InsNotaDebito->NdtId)){ if($InsNotaDebito->NdtId==$DatNotaDebitoTalonario->NdtId){ echo 'selected="selected"';}}elseif($_SESSION['SisNdtId']==$DatNotaDebitoTalonario->NdtId){ 	echo 'selected="selected"';}?> 			  value="<?php echo $DatNotaDebitoTalonario->NdtId;?>" ><?php echo $DatNotaDebitoTalonario->NdtNumero;?> (<?php echo $DatNotaDebitoTalonario->NdtDescripcion;?>)</option>
                    <?php
                    }
                    ?>
                </select>
                  ...
                  <td>N°.
                    <input name="CmpId" type="text" class="EstFormularioCaja" id="CmpId" tabindex="1" value="<?php echo $InsNotaDebito->NdbId;?>" size="10" maxlength="20" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?>  /></td>
                  <td><a href="javascript:FncGenerarNotaDebitoId(document.getElementById('CmpTalonario').value);"><img border="0" src="imagenes/recargar.jpg" alt="[Recargar]" title="Recargar" width="18" height="18" align="absmiddle"  /></a></td>
                  <td>
                    <div id="CapNotaDebito"></div>
                    </td>
                  </tr>
                </table>            </td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td width="369" align="left" valign="top"><input name="CmpClienteDireccion" type="text" class="EstFormularioCaja" id="CmpClienteDireccion" tabindex="5" value="<?php echo $InsNotaDebito->NdbDireccion;?>" size="45" maxlength="255" readonly="readonly"  /></td>
            <td width="9" align="left" valign="top">&nbsp;</td>
            <td width="197" align="left" valign="top">Fecha de Emisi&oacute;n:<br />
              <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
            <td colspan="2" align="left" valign="top"><input name="CmpFechaEmision" type="text" class="EstFormularioCajaFecha" id="CmpFechaEmision" tabindex="6" value="<?php if(empty($InsNotaDebito->NdbFechaEmision)){ echo date("d/m/Y");}else{ echo $InsNotaDebito->NdbFechaEmision; }?>" size="15" maxlength="10" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?> />              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaEmision" name="BtnFechaEmision" width="25" height="25" align="absmiddle"  style="cursor:pointer;" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Observaci&oacute;n Interna:</td>
            <td align="left" valign="top"><textarea tabindex="7" name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo stripslashes($InsNotaDebito->NdbObservacion);?></textarea></td>
            <td align="left" valign="top">&nbsp;</td>
            <td align="left" valign="top">Observaci&oacute;n Impresa:</td>
            <td colspan="2" align="left" valign="top"><textarea tabindex="8" name="CmpObservacionImpresa" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionImpresa"><?php echo stripslashes($InsNotaDebito->NdbObservacionImpresa);?></textarea></td>
            <td>&nbsp;</td>
          </tr>
...
?>
          ...
          <tr>
            ...
            <td align="left" valign="top">ISC:<br />
              (%)</td>
            <td colspan="2" align="left" valign="top"><input onchange="FncNotaCreditoDetalleListar();" name="CmpPorcentajeImpuestoSelectivo" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoSelectivo" value="<?php echo $InsNotaDebito->NdbPorcentajeImpuestoSelectivo;?>" size="10" maxlength="10" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <td colspan="2" align="left" valign="top"><textarea tabindex="8" name="CmpMotivo" cols="45" rows="2" class="EstFormularioCaja" id="CmpMotivo"><?php echo stripslashes($InsNotaDebito->NdbMotivo);?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <td colspan="2" align="left" valign="top"><table>
              <tr>
                <td><input name="CmpTipoCambio" type="text"  class="EstFormularioCaja" id="CmpTipoCambio" onchange="FncNotaDebitoDetalleListar();" value="<?php if (empty($InsNotaDebito->NdbTipoCambio)){ echo "";}else{ echo $InsNotaDebito->NdbTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" <?php echo (($PrivilegioRegistrarEspecial)?'':'readonly="readonly"');?> /></td>
          ...
          <tr>
            ...
            <td colspan="2" align="left" valign="top"><input name="CmpOrdenVentaVehiculoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculoId"  tabindex="3" value="<?php  echo $InsNotaDebito->OvvId;?>" size="20" maxlength="20" readonly="readonly" /></td>
            <td align="left" valign="top">&nbsp;</td>
            <td colspan="2" align="left" valign="top">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="2" align="left" valign="top">
<input <?php echo (($InsNotaDebito->NdbProcesar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpProcesar" id="CmpProcesar" />
         ...
         <td colspan="2" valign="top">
           <div class="EstFormularioArea">
                 ...
                 -->
                     ...
                     <tr>
                       <td>&nbsp;</td>
                       <td><a href="javascript:FncNotaDebitoDetalleNuevo();"></a></td>
                       <td colspan="6" align="right"><input type="checkbox" name="CmpNotaDebitoDetalleGratuito" id="CmpNotaDebitoDetalleGratuito" value="1" />
                         Transf. Grat.
                         <input type="checkbox" name="CmpNotaDebitoDetalleExonerado" id="CmpNotaDebitoDetalleExonerado" value="1" />
                         Exon. Imp.</td>
                       <td><a href="javascript:FncNotaDebitoDetalleGuardar();"></a></td>
                       </tr>
                     </table>
             </div>                                 </td>
         </tr>
       <tr>
         <td colspan="2" valign="top"><div class="EstFormularioArea" >
             <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
               <tr>
                 <td width="1%">&nbsp;</td>
                 <td width="48%"><div class="EstFormularioAccion" id="CapNotaDebitoDetalleAccion">Listo
                   para registrar elementos</div></td>
                 <td width="50%" align="right"><a href="javascript:FncNotaDebitoDetalleListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncNotaDebitoDetalleEliminarTodo();"><img  src="imagenes/eliminar_todo.png"  width="20" height="20"  border="0" title="Eliminar Todo"   alt="[Eliminar Todo]" align="absmiddle"/> Eliminar Todo</a>
