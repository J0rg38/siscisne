...
function FncNotaDebitoImprimir(){
...
//alert(jsPrintSetup.getPaperSizeList());
	...
	for(i=0;i<ArrImpresoras.length;i++){
		...
		if(ArrImpresoras[i]=="NOTA DE DEBITO"){
			Imprimir = true;			
		}
	}
...
//	alert(jsPrintSetup.getPaperMeasure ());
	...
	if(Imprimir==true){
		...
		//jsPrintSetup.setPrinter("NOTA DE DEBITO");	
		...
		alert("No se pudo encontrar la impresora prederminada para la impresion de NotaDebitos.");	
	}*/
