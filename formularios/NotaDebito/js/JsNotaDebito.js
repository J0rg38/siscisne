...
FncPopUp('formularios/NotaDebito/FrmNotaDebitoGenerarPDF.php?Id='+oId+'&Ta='+oTalonario+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
...
FncPopUp('formularios/NotaDebito/FrmNotaDebitoGenerarPDF.php?Id='+oId+'&Ta='+oTalonario,0,0,1,0,0,1,0,screen.height,screen.width);
...
function FncNotaDebitoGenerarXMLv2(oId,oTalonario,oTicket,oProcesar,oSUNAT,oValidar){
	...
	if(oValidar){
		...
		if(oTicket!=""){
			...
			//FncPopUp('formularios/NotaDebito/FrmNotaDebitoGenerarXMLv2.php?Id='+oId+'&Ta='+oTalonario+'&Procesar='+oProcesar+'&EnviarSUNAT='+oSUNAT,0,0,1,0,0,1,0,350,150);
			tb_show(this.title,'formularios/NotaDebito/FrmNotaDebitoGenerarXMLv2.php?Id='+oId+'&Ta='+oTalonario+'&Procesar='+oProcesar+'&EnviarSUNAT='+oSUNAT+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=200&width=400&modal=false',this.rel);
...
function FncNotaDebitoGenerarBajaXMLv2(oId,oTalonario,oTicket){
	...
	tb_show(this.title,'formularios/NotaDebito/FrmNotaDebitoGenerarBajaXMLv2.php?Id='+oId+'&Ta='+oTalonario+'&Ticket='+oTicket+'&Procesar=1&EnviarSUNAT=1&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=200&width=400&modal=false',this.rel);

}

function FncNotaDebitoConsultarCDR(oId,oTalonario){
	
	//FncPopUp('formularios/NotaDebito/FrmNotaDebitoConsultarCDR.php?Id='+oId+'&Ta='+oTalonario,0,0,1,0,0,1,0,350,150);
	tb_show(this.title,'formularios/NotaDebito/FrmNotaDebitoConsultarCDR.php?Id='+oId+'&Ta='+oTalonario+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=200&width=400&modal=false',this.rel);
...
function FncNotaDebitoSunatTareasv2(oId,oTalonario,oTicket,oEnvioCodigo,oEnvioRespuesta,oTicketBaja){
	...
	if(Tipo !== null){
		switch(Tipo.toUpperCase()){
			...
			case "1":
				FncNotaDebitoGenerarXMLv2(oId,oTalonario,oTicket,1,1,true);		
			break;
			
			case "11":
				FncNotaDebitoGenerarXMLv2(oId,oTalonario,oTicket,1,1,false);		
			break;
			...
			case "3":
				...
				FncNotaDebitoConsultarCDR(oId,oTalonario);
			break;
			...
			break;
				...
				//GENERAR 
			case "8":
				FncNotaDebitoGenerarXMLv2(oId,oTalonario,oTicket,2,2);		
			break;
...
/*function FncNotaDebitoProcesarXMLv3(oId,oTalonario,oTicket){
	...
	if(oTicket!=""){
		...
		FncPopUp('formularios/NotaDebito/FrmNotaDebitoProcesarXMLv3.php?Id='+oId+'&Ta='+oTalonario+'&Procesar=1&EnviarSUNAT=1',0,0,1,0,0,1,0,350,150);
	}
		
}*/

/*
function FncNotaDebitoSunatTareasv3(oId,oTalonario,oTicket,oEnvioCodigo,oEnvioRespuesta,oTicketBaja){
	...
	if(Tipo !== null){
		switch(Tipo.toUpperCase()){
			...
			case "1":
				FncNotaDebitoProcesarXMLv3(oId,oTalonario,oTicket);		
			break;
			...
			case "4":
				//FncNotaDebitoReenviar(oId,oTalonario,oTicket);
			break;
