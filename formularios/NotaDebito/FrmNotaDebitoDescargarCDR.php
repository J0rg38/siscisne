...
$NOMBRE = 'R-'.$EmpresaCodigo.'-01-'.$InsNotaDebito->NdtNumero.'-'.$InsNotaDebito->NdbId;
$ARCHIVO = $NOMBRE.'.zip';
?>
...
$().ready(function() {
	...
	$('#CapNotaDebitoAccion').html('Conectando con SERVIDOR para descargar archivo cdr...');	
	
	setTimeout("FncNotaDebitoDescargarCDR('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncNotaDebitoDescargarCDR(oArchivo,oUrl){
