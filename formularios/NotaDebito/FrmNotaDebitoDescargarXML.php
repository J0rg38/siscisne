...
$().ready(function() {
	...
	$('#CapNotaDebitoAccion').html('Conectando con SERVIDOR para descargar archivo xml...');	
	
	setTimeout("FncNotaDebitoDescargarXML('<?php echo $ARCHIVO;?>','');",1000);
	
});

function FncNotaDebitoDescargarXML(oArchivo,oUrl){
