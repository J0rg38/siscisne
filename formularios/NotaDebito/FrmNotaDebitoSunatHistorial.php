...
<tr>
  <td>Ultima Accion</td>
  <td>:</td>
  <td><?php echo $InsNotaDebito->NdbSunatUltimaAccion;?></td>
</tr>
<tr>
  <td>Ultima Respuesta</td>
  <td>:</td>
  <td><?php echo $InsNotaDebito->NdbSunatUltimaRespuesta ?></td>
</tr>
<tr>
...
<tr>
  <td>Ticket Envio</td>
  <td>:</td>
  <td><?php echo $InsNotaDebito->NdbSunatRespuestaEnvioTicket ?></td>
</tr>
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsNotaDebito->NdbSunatRespuestaEnvioCodigo ?> - <?php echo $InsNotaDebito->NdbSunatRespuestaEnvioContenido ?></td>
</tr>
<tr>
...
<tr>
  ...
  <td>:</td>
  <td><?php echo $InsNotaDebito->NdbSunatRespuestaBajaTicket ?></td>
</tr>
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsNotaDebito->NdbSunatRespuestaBajaCodigo; ?> - <?php echo $InsNotaDebito->NdbSunatRespuestaBajaContenido; ?></td>
</tr>
<tr>
...
<tr>
  <td>Respuesta</td>
  <td>:</td>
  <td><?php echo $InsNotaDebito->NdbSunatRespuestaConsultaCodigo; ?> - <?php echo $InsNotaDebito->NdbSunatRespuestaConsultaContenido; ?></td>
</tr>
<tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
