...
$().ready(function() {
	...
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'acc/AccNotaDebitoProcesarBajaXMLv2.php',
		...
		success: function(respuesta){
			...
			switch(respuesta['CodigoRespuesta']){
				...
				case "B101":
					...
					$('#CapNotaDebitoAccion').html('Archivo xml de baja procesado correctamente. '+respuesta['MensajeRespuesta']);				
				...
				default:
					...
					$('#CapNotaDebitoAccion').html('Ha ocurrido un error procesando el archivo xml de baja, proceso cancelado.');
					//setTimeout("window.close();",2500);
