...
//deb($Comprobante);
///exit();
$l_stResult = $l_oProxy->MtdDarBajaNotaDebito(json_encode($Comprobante));
...
//TICKET ENVIO
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaBajaTicket",$Trama['TicketRespuesta'],$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaBajaFecha",date("Y-m-d"),$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaBajaHora",date("H:i:s"),$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaBajaCodigo",$Trama['CodigoRespuesta'],$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaBajaContenido",$Trama['MensajeRespuesta'],$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaBajaTiempoCreacion",date("Y-m-d H:i:s"),$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
//$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaBajaRespuesta",$UltimaRespuesta,$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);

//HISTORIAL OBSERVACIONES
$Observaciones = $InsNotaDebito->NdbSunatRespuestaObservacion;
$Observaciones .= date("d/m/Y h:i:s")." - ".$Trama['MensajeRespuesta'].chr(13);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaObservacion",$Observaciones,$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
//ULTIMO TICKET
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaTicket",(!empty($Trama['TicketRespuesta'])?$Trama['TicketRespuesta']:$InsNotaDebito->NdbSunatRespuestaTicket),$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatRespuestaTicketEstado","",$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
//ACCIONES
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatUltimaAccion","BAJA",$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
$InsNotaDebito->MtdEditarNotaDebitoDato("NdbSunatUltimaRespuesta",$UltimaRespuesta,$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
...
//$InsResumenBaja->MtdEditarResumenBajaDato("NdbSunatRespuestaBajaRespuesta",$UltimaRespuesta,$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
...
//ULTIMO TICKET
$InsResumenBaja->MtdEditarResumenBajaDato("RbaSunatRespuestaTicket",(!empty($Trama['TicketRespuesta'])?$Trama['TicketRespuesta']:$InsNotaDebito->NdbSunatRespuestaTicket),$InsResumenBaja->RbaId);
$InsResumenBaja->MtdEditarResumenBajaDato("RbaSunatRespuestaTicketEstado","",$InsResumenBaja->RbaId);
//$InsResumenBaja->MtdEditarResumenBajaDato("NdbSunatUltimaAccion","BAJA",$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
//$InsResumenBaja->MtdEditarResumenBajaDato("NdbSunatUltimaRespuesta",$UltimaRespuesta,$InsResumenBaja->NdbId,$InsResumenBaja->NdtId);
