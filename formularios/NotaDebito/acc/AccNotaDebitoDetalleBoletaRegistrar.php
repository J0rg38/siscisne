...
foreach($ArrBoletaDetalles as $DatBoletaDetalle){
	$_SESSION['InsNotaDebitoDetalle'.$Identificador]->MtdAgregarSesionObjeto(1,NULL,$DatBoletaDetalle->BdeDescripcion,NULL,$DatBoletaDetalle->BdePrecio,$DatBoletaDetalle->BdeCantidad,$DatBoletaDetalle->BdeImporte,
date("d/m/Y H:i:s"),
date("d/m/Y H:i:s"));
}
