...
foreach($ArrFacturaDetalles as $DatFacturaDetalle){
	$_SESSION['InsNotaDebitoDetalle'.$Identificador]->MtdAgregarSesionObjeto(1,NULL,$DatFacturaDetalle->FdeDescripcion,NULL,$DatFacturaDetalle->FdePrecio,$DatFacturaDetalle->FdeCantidad,$DatFacturaDetalle->FdeImporte,
date("d/m/Y H:i:s"),
date("d/m/Y H:i:s"));	
}
