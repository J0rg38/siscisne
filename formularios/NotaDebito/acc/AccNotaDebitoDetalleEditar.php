...
$InsNotaDebitoDetalle1 = array();
$InsNotaDebitoDetalle1 = $_SESSION['InsNotaDebitoDetalle'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
...
$_SESSION['InsNotaDebitoDetalle'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsNotaDebitoDetalle1->Parametro1,
addslashes($_POST['Descripcion']),
NULL,
$Precio,
$Cantidad,
$Importe,
$InsNotaDebitoDetalle1->Parametro7,
date("d/m/Y H:i:s"),
$InsNotaDebitoDetalle1->Parametro9,
$InsNotaDebitoDetalle1->Parametro10,
NULL,
$_POST['NotaDebitoDetalleTipo'],
$_POST['UnidadMedida'],
$InsNotaDebitoDetalle1->Parametro14,
$InsNotaDebitoDetalle1->Parametro15,
$InsNotaDebitoDetalle1->Parametro16,
$InsNotaDebitoDetalle1->Parametro17,
$_POST['Codigo'],
$ValorVenta,
$Impuesto,
$Descuento,
