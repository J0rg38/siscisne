...
$ResFacturaDetalle =  $InsFacturaDetalle->MtdObtenerFacturaDetalles(NULL,NULL,NULL,NULL,1,NULL,$_POST['FacId'],$_POST['FtaId']);
...
foreach($ArrFacturaDetalles as $DatFacturaDetalle){
	$_SESSION['InsNotaCreditoDetalle'.$Identificador]->MtdAgregarSesionObjeto(1,NULL,$DatFacturaDetalle->FdeDescripcion,NULL,$DatFacturaDetalle->FdePrecio,$DatFacturaDetalle->FdeCantidad,$DatFacturaDetalle->FdeImporte,
date("d/m/Y H:i:s"),
date("d/m/Y H:i:s"));	
}
