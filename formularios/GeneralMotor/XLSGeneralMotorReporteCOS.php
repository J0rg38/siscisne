...
//	}
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'7', !empty($RcoIngresoPrimeraRevision[$mes])?$RcoIngresoPrimeraRevision[$mes]:'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			//$objPHPExcel->setActiveSheetIndex(1)
			//		->setCellValue('E18', !empty($RcoIngresoServicio50000Mas[$mes])?$RcoIngresoServicio50000Mas[$mes]:'');
...
//			$TotalIngresoTipoMensual[$mes] += $FichaIngresoReparacionMensualTotal;
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'20', !empty($RcoIngresoServicioPlanchadoPintado[$mes])?$RcoIngresoServicioPlanchadoPintado[$mes]:'');
...
//						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'20', !empty($FichaIngresoTrabajoInternoMensualTotal)?$FichaIngresoTrabajoInternoMensualTotal:'');
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'21', !empty($RcoIngresoServicioTrabajoInterno[$mes])?$RcoIngresoServicioTrabajoInterno[$mes]:'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'22', !empty($RcoIngresoServicioInstalacionAccesorios[$mes])?$RcoIngresoServicioInstalacionAccesorios[$mes]:'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'23', !empty($RcoIngresoServicioInstalacionGLP[$mes])?$RcoIngresoServicioInstalacionGLP[$mes]:'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'24', !empty($RcoIngresoServicioSuperCambio99[$mes])?$RcoIngresoServicioSuperCambio99[$mes]:'');
...
//						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'21', !empty($FichaIngresoGarantiaMensualTotal)?$FichaIngresoGarantiaMensualTotal:'');
				...
				$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'25', !empty($RcoIngreseServicioGarantias[$mes])?$RcoIngreseServicioGarantias[$mes]:'');
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'22', !empty($FichaIngresoReingresoMensualTotal)?$FichaIngresoReingresoMensualTotal:'');
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'26', !empty($RcoIngresoServicioReingresos[$mes])?$RcoIngresoServicioReingresos[$mes]:'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'27', !empty($RcoTotalIngresosUnidadesMantenimiento[$mes])?$RcoTotalIngresosUnidadesMantenimiento[$mes]:'');
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'26', !empty($FichaIngresoMantenimientoMensualTotalSparkLite)?$FichaIngresoMantenimientoMensualTotalSparkLite:'');					
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'30', !empty($RcoIngresoSparkLite[$mes])?$RcoIngresoSparkLite[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'27', !empty($FichaIngresoMantenimientoMensualTotalSparkGT)?$FichaIngresoMantenimientoMensualTotalSparkGT:'');	
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'31', !empty($RcoIngresoSparkGT[$mes])?$RcoIngresoSparkGT[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'28', !empty($FichaIngresoMantenimientoMensualTotalN300MoveMax)?$FichaIngresoMantenimientoMensualTotalN300MoveMax:'');	
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'32', !empty($RcoIngresoN300MoveMax[$mes])?$RcoIngresoN300MoveMax[$mes]:'');					
...
//			
		...
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'33', !empty($RcoIngresoN300Work[$mes])?$RcoIngresoN300Work[$mes]:'');					
...
//		
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'34', !empty($RcoIngresoCorsaChevyTaxi[$mes])?$RcoIngresoCorsaChevyTaxi[$mes]:'');					
...
//								
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'35', !empty($RcoIngresoAveo[$mes])?$RcoIngresoAveo[$mes]:'');					
...
//		
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'36', !empty($RcoIngresoSail[$mes])?$RcoIngresoSail[$mes]:'');					
		
			
		//ONIX
		
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'37', !empty($RcoIngresoOnix[$mes])?$RcoIngresoOnix[$mes]:'');					
		
		//PRISMA
		
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'38', !empty($RcoIngresoPrisma[$mes])?$RcoIngresoPrisma[$mes]:'');					
...
//					
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'39', !empty($RcoIngresoNuevoSail[$mes])?$RcoIngresoNuevoSail[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'34', !empty($FichaIngresoMantenimientoMensualTotalOptra)?$FichaIngresoMantenimientoMensualTotalOptra:'');	
		...
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'40', !empty($RcoIngresoOptra[$mes])?$RcoIngresoOptra[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'35', !empty($FichaIngresoMantenimientoMensualTotalSonic)?$FichaIngresoMantenimientoMensualTotalSonic:'');	
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'41', !empty($RcoIngresoSonic[$mes])?$RcoIngresoSonic[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'36', !empty($FichaIngresoMantenimientoMensualTotalCruze)?$FichaIngresoMantenimientoMensualTotalCruze:'');	
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'42', !empty($RcoIngresoCruze[$mes])?$RcoIngresoCruze[$mes]:'');					
						
		//SPIN
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'43', !empty($RcoIngresoSpin[$mes])?$RcoIngresoSpin[$mes]:'');					
...
//					
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'44', !empty($RcoIngresoTracker[$mes])?$RcoIngresoTracker[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'38', !empty($FichaIngresoMantenimientoMensualTotalVivant)?$FichaIngresoMantenimientoMensualTotalVivant:'');
		...
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'45', !empty($RcoIngresoVivant[$mes])?$RcoIngresoVivant[$mes]:'');					
...
//				
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'46', !empty($RcoIngresoOrlando[$mes])?$RcoIngresoOrlando[$mes]:'');					
...
//					
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'47', !empty($RcoIngresoCaptiva[$mes])?$RcoIngresoCaptiva[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'41', !empty($FichaIngresoMantenimientoMensualTotalS10)?$FichaIngresoMantenimientoMensualTotalS10:'');						
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'48', !empty($RcoIngresoS10[$mes])?$RcoIngresoS10[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'42', !empty($FichaIngresoMantenimientoMensualTotalTrailblazer)?$FichaIngresoMantenimientoMensualTotalTrailblazer:'');
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'49', !empty($RcoIngresoTrailblazer[$mes])?$RcoIngresoTrailblazer[$mes]:'');					
...
//					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'43', !empty($FichaIngresoMantenimientoMensualTotalTraverse)?$FichaIngresoMantenimientoMensualTotalTraverse:'');
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'50', !empty($RcoIngresoTraverse[$mes])?$RcoIngresoTraverse[$mes]:'');					
...
//			
		...
		$objPHPExcel->setActiveSheetIndex(1)
						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'51', !empty($RcoIngresoTahoeSuburban[$mes])?$RcoIngresoTahoeSuburban[$mes]:'');					
...
//OTROS
	...
	$objPHPExcel->setActiveSheetIndex(1)
						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'52', !empty($RcoIngresoOtrasUnidades[$mes])?$RcoIngresoOtrasUnidades[$mes]:'');					
...
//				->setCellValue(FncConvertirNumeroALetraExcel($Columna).'46', !empty($TotalIngresoTipoMensualModelo[$mes])?$TotalIngresoTipoMensualModelo[$mes]:'');
			$objPHPExcel->setActiveSheetIndex(1)
				->setCellValue(FncConvertirNumeroALetraExcel($Columna).'54', !empty($RcoTotalIngresosUnidades[$mes])?$RcoTotalIngresosUnidades[$mes]:'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'56', !empty($RcoNumeroCitas[$mes])?round($RcoNumeroCitas[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'57', !empty($RcoCitasEfectivas[$mes])?round($RcoCitasEfectivas[$mes],2):'');
...
//	 }				
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'58', !empty($RcoPromedioPermanencia[$mes])?round($RcoPromedioPermanencia[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'59', !empty($RcoParalizados[$mes])?round($RcoParalizados[$mes],2):'');
	...
	*/ 		
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'63', !empty($RcoPersonalMecanicos[$mes])?round($RcoPersonalMecanicos[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 		...
		 		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
		$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'64', !empty($RcoPersonalAsesores[$mes])?round($RcoPersonalAsesores[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'65', !empty($RcoPersonalOtros[$mes])?round($RcoPersonalOtros[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'66', !empty($RcoDiasLaborados[$mes])?round($RcoDiasLaborados[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'67',  !empty($RcoHoraDisponibles[$mes])?round($RcoHoraDisponibles[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		 ...
		 if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'68', !empty($RcoHoraLaboradas[$mes])?round($RcoHoraLaboradas[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'72', !empty($RcoTarifaMO[$mes])?round($RcoTarifaMO[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
						->setCellValue(FncConvertirNumeroALetraExcel($Columna).'73',!empty($RcoHoraMOVendidas[$mes])?round($RcoHoraMOVendidas[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'74', !empty($RcoVentaManoObra[$mes])?round($RcoVentaManoObra[$mes],2):'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'75', !empty($RcoVentaRepuestos[$mes])?$RcoVentaRepuestos[$mes]:'');
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'76', !empty($RcoVentaMecanica[$mes])?$RcoVentaMecanica[$mes]:'');
...
//	}	
	...
	for($mes=1;$mes<=$POST_Mes;$mes++){
		...
		if( ($mes<=date("m") and date("Y")== $POST_Ano) or  $POST_Ano!=date("Y")){
			...
			$objPHPExcel->setActiveSheetIndex(1)
					->setCellValue(FncConvertirNumeroALetraExcel($Columna).'77', !empty($RcoVentaGarantiaFA[$mes])?$RcoVentaGarantiaFA[$mes]:'');
