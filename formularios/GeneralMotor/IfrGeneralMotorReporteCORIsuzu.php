...
<?php }?>
        ...
        <?php	
                ...
                ?></td>
          <td width="54%" rowspan="2" align="center" valign="top">CONTROL DE OPERACIONES DE REPUESTOS  - COR- ISUZU
      </td>
                        ...
                        <tr>
                          <td ><?php echo $DatProducto->ProCodigoOriginal?></td>
                            ...
                            ?>
                                ...
                                <?php
								//MtdObtenerReporteProductoVentasMensual($oProductoId,$oAno,$oMes,$oVehiculoMarca,$oSucursal=NULL)
