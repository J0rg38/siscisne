...
$ArrReporteFichaIngresos = $ResReporteFichaIngreso['Datos'];
 ...
 // Create new PHPExcel object
  ...
  $objReader = PHPExcel_IOFactory::createReader('Excel5');
			  ...
			  $objPHPExcel = $objReader->load("../../plantilla/TemCSIPostVenta.xls");
		...
		if(!empty($ArrReporteFichaIngresos)){
			foreach($ArrReporteFichaIngresos as $DatReporteFichaIngreso){
			 	...
			 	$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(3).$fila, $DatReporteFichaIngreso->FinId);

			 	$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(6).$fila, $EmpresaNombre);
								
				$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(7).$fila, $EmpresaDepartamento);
								
								
								
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(8).$fila, $DatReporteFichaIngreso->FinTiempoTrabajoTerminado);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(9).$fila, $DatReporteFichaIngreso->EinVIN);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(10).$fila, $DatReporteFichaIngreso->EinPlaca);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(11).$fila, $DatReporteFichaIngreso->CliNombre);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(12).$fila, $DatReporteFichaIngreso->CliApellidoPaterno." ".$DatReporteFichaIngreso->CliApellidoMaterno);
								
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(13).$fila, $DatReporteFichaIngreso->MinNombre);
								
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(14).$fila, $DatReporteFichaIngreso->FinMantenimientoKilometraje);
								
								
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(17).$fila, $DatReporteFichaIngreso->VmoNombre);
...
//$Emails .= (!empty($DatReporteFichaIngreso->CliEmailFacturacion)?"/":"").$DatReporteFichaIngreso->CliEmailFacturacion;
								...
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(18).$fila,$Emails);
								



								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(19).$fila, $DatReporteFichaIngreso->CliTelefono);
...
if(!empty($DatReporteFichaIngreso->CliCelular)){
	...
	$Celular .= $DatReporteFichaIngreso->CliContactoCelular3;
								...
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(20).$fila, $Celular);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(21).$fila, $DatReporteFichaIngreso->CliDireccion);
								
								
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(23).$fila, $DatReporteFichaIngreso->CliDepartamento);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(24).$fila, $DatReporteFichaIngreso->CliProvincia);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(25).$fila, $DatReporteFichaIngreso->PerNumeroDocumento);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(26).$fila, $DatReporteFichaIngreso->PerNombre);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(27).$fila, $DatReporteFichaIngreso->PerApellidoPaterno." ".$DatReporteFichaIngreso->PerApellidoMaterno);
        ...
        $objWriter->save("../../generados/reportes/CSI_POST_VENTA_".date("Y")."_".date("m")."_".date("d").".xls");
        
        //$objWriter->save(str_replace('.php', '.xls', __FILE__));
        /*
        <a href="<?php echo $InsOrdenCompra->OcoId;?>.xls">DESCARGAR: <?php echo $InsOrdenCompra->OcoId;?>.xls</a>
        */
        header("Location: ../../generados/reportes/CSI_POST_VENTA_".date("Y")."_".date("m")."_".date("d").".xls");
