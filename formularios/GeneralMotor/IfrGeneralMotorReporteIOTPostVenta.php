...
<?php }?>
        ...
        <?php	
                ...
                ?></td>
          <td width="54%" rowspan="2" align="center" valign="top">IOT POST VENTA</td>
        ...
        <?php }?>
                    ...
                    <th width="80" align="center">Modelo Año</th>
...
?>
                          ...
                          <td width="80" align="center" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>"><?php echo $DatReporteFichaIngreso->EinAnoModelo;  ?></td>
                          <td width="80" align="center" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>">
