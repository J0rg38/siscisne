...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsGeneralMotorReporteCSIVenta.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE GENERAL MOTOR - CSI VENTA</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfGeneralMotorReporteCSIVenta.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
<!--    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrGeneralMotorReporteCSIVenta.php" target="IfrGeneralMotorReporteCSIVenta" method="post" name="FrmGeneralMotorReporteCSIVenta" id="FrmGeneralMotorReporteCSIVenta">
     --> 
         ...
         <fieldset  class="EstFormularioContenedor">
          ...
          <td align="left" valign="top">
            ...
            <table border="0" cellpadding="0" cellspacing="2">
              <tr>
                <td>
                  <input name="BtnVer"   id="BtnVer" type="image" border="0" src="imagenes/reporte_iconos/ver.png" alt="[Ver]" title="Ver" onclick="FncGeneralMotorReporteCSIVentaVer();" />           </td>
                <td>
                  <?php
            if($PrivilegioImprimir){
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncGeneralMotorReporteCSIVentaImprimir();" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncGeneralMotorReporteCSIVentaGenerarExcel();" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrGeneralMotorReporteCSIVenta.php" target="IfrGeneralMotorReporteCSIVenta" id="IfrGeneralMotorReporteCSIVenta" name="IfrGeneralMotorReporteCSIVenta" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
      <div id="CapGeneralMotorReporteCSIVenta"></div>
