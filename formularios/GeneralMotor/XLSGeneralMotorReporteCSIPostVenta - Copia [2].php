...
if(!empty($DatReporteFichaIngreso->CliCelular)){
	...
	$Celular .= $DatReporteFichaIngreso->CliContactoCelular3;
								...
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(22).$fila, $DatReporteFichaIngreso->CliDepartamento);
								
								$objPHPExcel->setActiveSheetIndex(0)
								->setCellValue(FncConvertirNumeroALetraExcel(23).$fila, $DatReporteFichaIngreso->CliProvincia);
