...
//MtdObtenerPagos($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'PagId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oVentaDirecta=NULL,$oPago=NULL,$oCondicionPago=NULL,$oMoneda=NULL,$oFactura=NULL,$oFacturaTalonario=NULL,$oBoleta=NULL,$oBoletaTalonario=NULL,$oArea=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oFecha="PagFecha",$oOrigen=NULL,$oFormaPago=NULL,$oSucursal=NULL,$oFichaIngresoId=NULL,$oPersonalId=NULL,$oTipo=NULL)
$ResPago = $InsPago->MtdObtenerPagos("PagId,cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,cli.CliNombreCompleto,cli.CliNumeroDocumento","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_Estado,$GET_VdiId,NULL,$POST_CondicionPago,$POST_Moneda,NULL,NULL,NULL,NULL,$POST_Area,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"PagFecha",$POST_Origen,$POST_FormaPago,$POST_Sucursal,NULL,NULL,$POST_Tipo);
...
<select class="EstFormularioCombo" name="CmpFormaPago" id="CmpFormaPago">
  ...
  Origen:
    <select class="EstFormularioCombo" name="Origen" id="Origen">
      ...
      Estado:
    <select class="EstFormularioCombo" name="Estado" id="Origen">
      <option value="" >Todos</option>
...
<option value="" >Todos</option>
<option value="VDI" <?php if($POST_Tipo=="VDI"){ echo 'selected="selected"';}?>>Orden Venta (Venta x Mostrador)</option>
<option value="OVV" <?php if($POST_Tipo=="OVV"){ echo 'selected="selected"';}?>>Orden Ven. Vehiculo</option> 
<option value="FAC" <?php if($POST_Tipo=="FAC"){ echo 'selected="selected"';}?>>Factura</option>  
<option value="BOL" <?php if($POST_Tipo=="BOL"){ echo 'selected="selected"';}?>>Boleta</option>  
<option value="LIB" <?php if($POST_Tipo=="LIB"){ echo 'selected="selected"';}?>>Libres</option>  
</select>
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "PagComprobante"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PagComprobante','ASC');"> Doc. Ref. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PagComprobante','DESC');"> Doc. Ref. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('PagComprobante','ASC');"> Doc. Ref. </a>
                <?php
				}
				?></th>
                <th width="4%" ><?php
...
?>
	 ...
	 <a href="principal.php?Mod=Pago<?php echo $Tipo;?>&Form=<?php echo $Aux;?>Editar&Id=<?php echo $dat->PagId;?>&Area=<?php echo $POST_Area;?>&NMod=Pago"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
...
?>
	...
	<a href="principal.php?Mod=Pago<?php echo $Tipo;?>&Form=<?php echo $Aux;?>Ver&Id=<?php echo $dat->PagId;?>&Area=<?php echo $POST_Area;?>&NMod=Pago"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
...
<?php
            ...
            <a href="javascript:FncPagoVistaPreliminar('<?php echo $dat->PagId;?>','<?php echo $dat->PagTipo;?>');"><img src="imagenes/acciones/preliminar.gif" alt="[Vista Preliminar]" title="Vista preliminar" width="19" height="19" border="0" /></a>
     ...
     <a href="javascript:FncPagoImprmir('<?php echo $dat->PagId;?>','<?php echo $dat->PagTipo;?>');"><img src="imagenes/acciones/imprimir.png" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
...
<?php
	switch($dat->PagTipo){
		case "VDI":
	?>
  <a href="principal.php?Mod=PagoVentaDirecta&Form=AbonoRegistrar&VdiId=<?php echo $dat->VdiId;?>&Area=<?php echo $POST_Area;?>&NMod=Pago"><img src="imagenes/acciones/orden_cobro.png" width="19" height="19" border="0" title="Registrar" alt="[Registrar]"   /></a>
    <?php	
		break;
		
		case "OVV":
	?>
    <a href="principal.php?Mod=PagoVentaDirecta&Form=AbonoRegistrar&OvvId=<?php echo $dat->OvvId;?>&Area=<?php echo $POST_Area;?>&NMod=Pago"><img src="imagenes/acciones/orden_cobro.png" width="19" height="19" border="0" title="Registrar" alt="[Registrar]"   /></a>
    <?php	
		break;
		
			case "FAC":
	?>
  <a href="principal.php?Mod=PagoFactura&Form=AbonoRegistrar&FacId=<?php echo $dat->FacId;?>&FtaId=<?php echo $dat->FtaId;?>&Area=<?php echo $POST_Area;?>&NMod=Pago"><img src="imagenes/acciones/orden_cobro.png" width="19" height="19" border="0" title="Registrar" alt="[Registrar]"   /></a>
    <?php	
		break;
		
		case "BOL":
	?>
    <a href="principal.php?Mod=PagoBoleta&Form=AbonoRegistrar&BolId=<?php echo $dat->BolId;?>&BtaId=<?php echo $dat->BtaId;?>&Area=<?php echo $POST_Area;?>&NMod=Pago"><img src="imagenes/acciones/orden_cobro.png" width="19" height="19" border="0" title="Registrar" alt="[Registrar]"   /></a>
    <?php	
		break;
...
?>
      ...
      <?php
    if($PrivilegioGenerarFactura and empty($dat->FacId)  and empty($dat->BolId)) {
    ?>
...
<a href="principal.php?Mod=Factura&Form=Registrar&Ori=Pago&PagId=<?php echo $dat->PagId;?>"><img src="imagenes/generar_factura.png" width="25" height="25" border="0" title="Generar Factura" alt="[Generar Factura]"   /></a>
    ...
    <?php
    if($PrivilegioGenerarBoleta and empty($dat->BolId)  and empty($dat->FacId)){
    ?>
