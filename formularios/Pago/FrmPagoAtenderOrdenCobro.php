...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsPagoAtenderOrdenCobroFunciones.js" ></script>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPagoAtenderCobro.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ATENDER
...
<div class="tab_container">
	...
	?>
          ...
          <tr>
            ...
            <td><textarea class="EstFormularioCaja" name="CmpObservacion" id="CmpObservacion" cols="45" rows="3"><?php echo $InsPago->PagObservacion;?></textarea></td>
            <td valign="top">Observacion Impresa:</td>
            <td><textarea class="EstFormularioCaja" name="CmpObservacionImpresa" id="CmpObservacionImpresa" cols="45" rows="3"><?php echo $InsPago->PagObservacionImpresa;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Concepto (Para imprimir en recibo):</td>
            <td align="left" valign="top"><textarea name="CmpConcepto" cols="45" rows="4" class="EstFormularioCaja" id="CmpConcepto"><?php echo $InsPago->PagConcepto;?></textarea></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
