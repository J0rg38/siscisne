...
$ResPago = $InsPago->MtdObtenerPagos("PagId,cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,cli.CliNombreCompleto,cli.CliNumeroDocumento","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,1,$GET_VdiId,NULL,$POST_CondicionPago,$POST_Moneda,NULL,NULL,NULL,NULL,$POST_Area,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"PagFecha",$POST_Origen);
...
<table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0" >
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?></th>
                <th width="9%" ><?php
				if($POST_ord == "PagObservacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('PagObservacion','ASC');"> Observacion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('PagObservacion','DESC');"> Observacion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('PagObservacion','ASC');"> Observacion </a>
                <?php
				}
				?></th>
                <th width="6%" ><?php
...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
 ...
 <tbody class="EstTablaListadoBody">
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" ><?php echo $dat->PagObservacion;  ?></td>
                <td align="right" >(<?php echo ($dat->MonSimbolo);?>)</td>
                <td align="right" ><?php echo ($dat->PagTipoCambio);?></td>
                <td  width="8%" align="right" ><?php echo number_format($dat->PagMonto,2); ?></td>
