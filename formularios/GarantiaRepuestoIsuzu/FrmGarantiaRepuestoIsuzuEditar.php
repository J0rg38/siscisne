...
Calendar.setup({ 
	...
	Calendar.setup({ 
		...
		ifFormat   : "%d/%m/%Y",  //  
		button     : "BtnTransaccionFecha"// el id del bot�n que  
	});
		...
		ifFormat   : "%d/%m/%Y",  //  
		button     : "BtnFechaPago"// el id del bot�n que  
	});
...
//		ifFormat   : "%d/%m/%Y",  //  
//		button     : "BtnGarantiaRepuestoIsuzuManoObraTransaccionFecha"// el id del bot�n que  
//	});
//	
//	
//	
...
//		ifFormat   : "%d/%m/%Y",  //  
//		button     : "BtnGarantiaRepuestoIsuzuManoObraFechaAprobacion"// el id del bot�n que  
//	});
//	
//	
//	
...
//		ifFormat   : "%d/%m/%Y",  //  
//		button     : "BtnGarantiaRepuestoIsuzuManoObraFechaPago"// el id del bot�n que  
//	});
//
</script>
