...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsGarantiaRepuestoIsuzu.js" ></script>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccGarantiaRepuestoIsuzu.php');

//MtdObtenerGarantiaRepuestoIsuzus($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'GriId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oMoneda=NULL,$oFichaIngreso=NULL,$oFichaAccion=NULL)
$ResGarantiaRepuestoIsuzu = $InsGarantiaRepuestoIsuzu->MtdObtenerGarantiaRepuestoIsuzus("fin.FinId,GriId,EinVIN,EinPlaca,CliNombreCompleto,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,VmaNombre,VmoNombre,CamBoletinCodigo,CamNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_estado,$POST_Moneda);
$ArrGarantiaRepuestoIsuzus = $ResGarantiaRepuestoIsuzu['Datos'];
$GarantiaRepuestoIsuzusTotal = $ResGarantiaRepuestoIsuzu['Total'];
$GarantiaRepuestoIsuzusTotalSeleccionado = $ResGarantiaRepuestoIsuzu['TotalSeleccionado'];
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE FORMULARIO DE RECLAMACION ISUZUS</span>  </td>
...
<tr>
  <td width="47%" valign="top">
    Mostrando <b><?php echo $GarantiaRepuestoIsuzusTotalSeleccionado;?></b> de <b><?php echo $GarantiaRepuestoIsuzusTotal;?></b> registros</td>
...
<tr>
  <td colspan="2" align="right" valign="top">
    ...
    <!--<select class="EstFormularioCombo" name="Cam" id="Cam">
      <option value="fin.GriId" <?php if($POST_cam=="fin.GriId"){ echo 'selected="selected"';}?>>Id</option>
      ...
      <option value="GriConductor" <?php if($POST_cam=="GriConductor"){ echo 'selected="selected"';}?>>Nombre del Conductor</option>
s      </select>-->
<!--    Estado
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "GriId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GriId','ASC');"> Id. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GriId','DESC');"> Id. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('GriId','ASC');"> Id.  </a>
                  <?php
				}
				?></th>
                <th width="4%" ><?php
                ...
                <th width="5%" >
                                ...
                                <?php
				if($POST_ord == "GriFechaEmision"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GriFechaEmision','ASC');"> Fecha <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GriFechaEmision','DESC');"> Fecha <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('GriFechaEmision','ASC');"> Fecha </a>
                  <?php
				}
				?>                </th>
                <th width="4%" ><?php
				...
				?></th>
                <th width="4%" ><?php
				if($POST_ord == "GriTransaccionNumero"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GriTransaccionNumero','ASC');"> Num. Transac. Num. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GriTransaccionNumero','DESC');"> Num. Transac. Num. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('GriTransaccionNumero','ASC');"> Num. Transac. Num. </a>
                <?php
				}
				?></th>
                <th width="7%" ><?php
				if($POST_ord == "GriTotal"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GriTotal','ASC');"> Total <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GriTotal','DESC');"> Total <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('GriTotal','ASC');"> Total </a>
                  <?php
				}
				?></th>
                <th width="4%" ><?php
				...
				?></th>
                <th width="4%" ><?php
				if($POST_ord == "GriTotalLlamadas"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GriTotalLlamadas','ASC');"> Llamadas <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GriTotalLlamadas','DESC');"> Llamadas <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('GriTotalLlamadas','ASC');"> Llamadas </a>
                <?php
				}
				?></th>
                <th width="4%" ><?php
				if($POST_ord == "GriEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GriEstado','ASC');">Est. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GriEstado','DESC');"> Est. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('GriEstado','ASC');"> Est. </a>
                  <?php
				}
				?></th>
                <th width="8%" ><?php
				if($POST_ord == "GriTiempoCreacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('GriTiempoCreacion','ASC');"> Fecha Registro <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('GriTiempoCreacion','DESC');"> Fecha Registro <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('GriTiempoCreacion','ASC');"> Fecha Registro </a>
                <?php
				}
				?></th>
...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
				  ...
				  <option <?php if($POST_num==$GarantiaRepuestoIsuzusTotal){ echo 'selected="selected"';}?> value="<?php echo $GarantiaRepuestoIsuzusTotal;?>">Todos</option>
                </select>
				...
				<?php
					...
					//if(empty($POST_fil)){
						$tregistros = $GarantiaRepuestoIsuzusTotal;
					//}else{
					//	$tregistros = ($GarantiaRepuestoIsuzusTotalSeleccionado);
					//}
	...
	<a class="EstPaginacion"  href="javascript:FncPaginar('<?php echo $num?>,<?php echo $numxpag;?>','<?php echo $i?>');" ><?php echo $i?></a>                        
					...
					if($POST_p<>$cant_paginas){
					?>
						<a class="EstPaginacion"  href="javascript:FncPaginar('<?php echo ($num-$numxpag);?>,<?php echo $numxpag;?>','<?php echo ($i-1);?>');">Grial</a>
					<?php
					}
					?>
					&nbsp;
 ...
 <tbody class="EstTablaListadoBody">
            <?php
					...
					$Impuesto = 0;
					$Total = 0;
								foreach($ArrGarantiaRepuestoIsuzus as $dat){
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->GriId; ?>" estado="<?php echo $dat->GriEstado;?>" />				</td>

                <td align="right" valign="middle" width="3%"   >
                  
                <span class="EstTablaListadoCodigo"><?php echo $dat->GriId;  ?></span></td>
...
?>
              ...
              <!--  <span class="EstTablaListadoCodigo">
                ...
                <td  width="5%" align="right" ><?php echo $dat->GriFechaEmision;  ?></td>
...
?>
                ...
                <td  width="7%" align="right" ><?php echo ($dat->GriModelo);?></td>
                <td  width="4%" align="right" ><?php echo $dat->GriTransaccionNumero;?></td>
                <td  width="7%" align="right" >
				
				 <?php $dat->GriTotal = ( ($EmpresaMonedaId==$POST_Moneda or empty($POST_Moneda) )?$dat->GriTotal:($dat->GriTotal/$dat->GriTipoCambio) );?>
                 
                 
				<?php echo number_format($dat->GriTotal,2);?>
                ...
                <?php
				if(!empty($dat->GriTotalLlamadas)){
				?>
					<?php echo ($dat->GriTotalLlamadas);?> Llamadas
                <?php	
				}else{
				?>
					No tiene llamadas
                ...
                <td  width="4%" align="right" ><?php echo $dat->GriEstadoDescripcion;?></td>
                <td  width="8%" align="right" ><?php echo ($dat->GriTiempoCreacion);?></td>
                <td  width="15%" align="center" >
                  
  <?php
if($PrivilegioAuditoriaVer){
?>
                  <a href="formularios/Auditoria/FrmAuditoriaListado.php?Id=<?php echo $dat->GriId;?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=440&width=850&modal=true" class="thickbox"  ><img src="imagenes/auditoria.png" alt="[Auditar]" width="19" height="19" border="0" title="Auditar" /></a>
  <?php
}
?>
...
if($PrivilegioEliminar){
?> 
                  <a href="javascript:FncEliminarSeleccionado('<?php echo $dat->GriId;?>');"> <img  src="imagenes/eliminar.gif" alt="[Eliminar]" width="19" height="19" border="0" title="Eliminar completamente"   /></a>
  <?php
}
?>
...
if($PrivilegioEditar){
?>	
                  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $dat->GriId;?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>                 
  <?php
}
?> 
...
if($PrivilegioVer){
?>		                
                  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->GriId;?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>                
...
?>
                  <a href="javascript:FncVistaPreliminar('<?php echo $dat->GriId;?>');"><img src="imagenes/acciones/preliminar.gif" alt="[Vista Preliminar]" title="Vista preliminar" width="19" height="19" border="0" /></a>
  <?php
}
?>
...
if($PrivilegioImprimir){
?> 
                  <a href="javascript:FncImprmir('<?php echo $dat->GriId;?>');"><img src="imagenes/acciones/imprimir.png" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
  <?php
}
?>              
                  <?php
...
if($PrivilegioEditar){
?>	
  <a href="javascript:FncGarantiaRepuestoIsuzuSeguimientoClienteCargarFormulario('<?php echo $dat->GriId;?>');"><img src="imagenes/acciones/llamadas2.png" alt="[Llamadas]" title="Llamadas" width="19" height="19" border="0" /></a>
  <?php
}
?> 
