...
/*if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"Listado") and empty($GET_dia)){
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Monitoreo"><img src="imagenes/iconos/monitoreo.png" alt="[Monitoreo]"  title="Ir a formulario de monitoreo" /> O.T.</a></div>
<?php
}*/
?>
