...
$RepSesionObjetos = $_SESSION['InsGarantiaRepuestoIsuzuManoObra'.$Identificador]->MtdObtenerSesionObjetos(true);
...
<?php
$GarantiaRepuestoIsuzuManoObraTotal = 0;
$c = 1;
...
if($_POST['Editar']==1){
?>
  <a class="EstSesionObjetosItem" href="javascript:FncGarantiaRepuestoIsuzuManoObraEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
  <?php
}
?>
...
if($_POST['Eliminar']==1){
?>
  <a href="javascript:FncGarantiaRepuestoIsuzuManoObraEliminar('<?php echo $DatSesionObjeto->Item;?>');" > <img align="absmiddle" src="imagenes/acciones/listado_eliminar.png" alt="[Eliminar]" title="Eliminar" width="25" height="25" border="0" /></a>
  <?php
}
?>
...
<?php
		$GarantiaRepuestoIsuzuManoObraTotal += $DatSesionObjeto->Parametro5;
		$c++;
