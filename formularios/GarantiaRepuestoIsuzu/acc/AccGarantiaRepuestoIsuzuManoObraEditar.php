...
$InsGarantiaRepuestoIsuzuManoObra1 = array();
$InsGarantiaRepuestoIsuzuManoObra1 = $_SESSION['InsGarantiaRepuestoIsuzuManoObra'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
...
$_SESSION['InsGarantiaRepuestoIsuzuManoObra'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
$InsGarantiaRepuestoIsuzuManoObra1->Parametro1,
...
$InsGarantiaRepuestoIsuzuManoObra1->Parametro7,
date("d/m/Y H:i:s"),
