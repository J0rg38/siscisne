...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/GarantiaRepuestoIsuzu/acc/AccGarantiaRepuestoIsuzuGenerarExcel.php";
//					break;
					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/GarantiaRepuestoIsuzu/acc/AccGarantiaRepuestoIsuzuGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	document.getElementById("FrmListado").action = "formularios/GarantiaRepuestoIsuzu/FrmGarantiaRepuestoIsuzuListadoImprimir.php"
...
function FncGarantiaRepuestoIsuzuSeguimientoClienteCargarFormulario(oGarantiaRepuestoIsuzuId){
	
	//tb_show(this.title,'principal2.php?Mod=GarantiaRepuestoIsuzu&Form=SeguimientoCliente&Dia=1&Id='+oGarantiaRepuestoIsuzuId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&modal=true',this.rel);	
	FncCargarVentana("GarantiaRepuestoIsuzu","SeguimientoCliente",oGarantiaRepuestoIsuzuId);
}
