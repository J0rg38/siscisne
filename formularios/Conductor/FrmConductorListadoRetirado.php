...
$POST_Modalidad = $_GET['Modalidad'];
$POST_Turno = $_GET['Turno'];
$POST_ConClave = $_GET['ConClave'];
$POST_ConUnidad = $_GET['ConUnidad'];
...
//MtdObtenerConductores($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'ConId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oTurno=NULL,$oNuevo=0,$oRetirado=0,$oConClave=0,$oConAplicacion=0,$oModalidad=NULL,$oConUnidad=0)
$ResConductor = $InsConductor->MtdObtenerConductores($POST_Campo,"contiene",$POST_Filtro,$POST_Orden,$POST_Sentido,$POST_Paginacion,"3",$POST_Turno,0,0,$POST_ConClave,0,$POST_Modalidad,$POST_ConUnidad);
...
<tr>
  <td height="25" align="center"><span class="EstFormularioTitulo">LISTAR CONDUCTORES RETIRADOS</span>
...
<table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0" >
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?></th>
                <th width="3%" align="center" ><?php
				if($POST_Orden == "ConAplicacion"){
					if($POST_Sentido == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('ConAplicacion','ASC');"> App. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('ConAplicacion','DESC');"> App. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('ConAplicacion','ASC');"> App. </a>
                  <?php
				}
				?></th>
				...
				?></th>
                <th width="14%" align="center" ><?php
				if($POST_Orden == "ConDireccion"){
					if($POST_Sentido == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('ConDireccion','ASC');"> Direccion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('ConDireccion','DESC');"> Direccion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('ConDireccion','ASC');"> Direccion </a>
                <?php
				}
				?></th>
                <th width="6%" align="center" ><?php
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="left" valign="middle" width="3%"   ><?php echo $dat->ConId;  ?></td>
                <td  width="7%" align="left" ><?php echo $dat->ConModalidad;  ?></td>
                <td  width="3%" align="left" >
			<?php
				if(!empty($dat->ConClave)){
			?>
					<img src="imagenes/pedidos/android.png" width="29" height="29" alt="Celular/Android" title="Celular/Android" />
            <?php			
				}
			?>	
				<?php
			...
			?></td>
                ...
                <td align="left" valign="middle" width="9%"   ><?php echo $dat->ConNombre; ?></td>
                <td  width="6%" align="left" ><?php echo $dat->ConApellido; ?></td>
                <td  width="14%" align="left" ><?php echo $dat->ConDireccion; ?></td>
...
<img src="imagenes/chat.png" width="25" height="25" border="0" />
			...
			?>
                ...
                <td  width="6%" align="right" ><?php echo ($dat->ConTiempoCreacion);?></td>
...
?>
<a href="tareas/TarCargarConductorSolo.php?ConId=<?php echo $dat->ConId?>" target="_blank"><img src="imagenes/sincronizar.png" width="19" height="19" border="0" title="Sincronizar" alt="[Sincronizar]"   /></a>
<?php
}
?>
...
?>
<a href="tareas/TarCargarConductorResetear.php?ConId=<?php echo $dat->ConId?>" target="_blank"><img src="imagenes/resetear.png" width="19" height="19" border="0" title="Resetear" alt="[Resetear]"   /></a>
<?php
}
?>
