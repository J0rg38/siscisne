...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccConductorRegistrar.php');
...
<input name="BtnGuardar"   id="BtnGuardar" type="image" border="0" src="imagenes/iconos/guardar.png" height="55" alt="[Guardar]" title="Guardar" />
</div>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2" align="center"><span class="EstFormularioTitulo">REGISTRAR
        CONDUCTOR</span></td>
      </tr>
      <tr>
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="2" align="left" valign="top"><span class="EstFormularioSubTitulo">DATOS DEL CONDUCTOR</span></td>
            <td align="left" valign="top">&nbsp;</td>
            <td align="left" valign="top">&nbsp;</td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left" valign="top"><span id="sprytextfield4">
              <label>
                <input name="CmpFechaInicio" type="text" class="EstFormularioCajaFecha" id="CmpFechaInicio" value="<?php echo $InsConductor->ConFechaInicio; ?>" size="15" maxlength="10" />
                </label>
          ...
          <tr>
            ...
            <a  href="javascript:FncPropietarioNuevo();"><img align="absmiddle" src="imagenes/acciones/limpiar.png" alt="Limpiar" title="Limpiar datos de propietario" border="0" width="25" height="25"  /></a>
            
            
            <span id="sprytextfield9">
              <input class="EstFormularioCaja" name="CmpPropietarioNumeroDocumento" type="text" id="CmpPropietarioNumeroDocumento" value="<?php echo $InsConductor->ProNumeroDocumento;?>" size="20" maxlength="8" />
              ...
              <span class="textfieldRequiredMsg">Se necesita un valor.</span></span>
               ...
               <a target="_blank" href="http://www.reniec.gob.pe/portal/masServiciosLinea.htm#">Consultar DNI</a>
                          ...
                          <div id="CapPropietarioEstado"></div>
          ...
          <tr>
            ...
            <td align="left" valign="top">Nombres:
              ...
              <input class="EstFormularioCaja" name="CmpPropietarioId" type="hidden" id="CmpPropietarioId" value="<?php echo $InsConductor->ProId;?>" size="40" maxlength="250" />
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="2" align="left" valign="top"><span class="EstFormularioSubTitulo">DATOS DE LA UNIDAD</span></td>
            <td align="left" valign="top">&nbsp;</td>
            <td align="left" valign="top">&nbsp;</td>
            </tr>
          <tr>
            ...
            <td align="left" valign="top"><!--  <input readonly="readonly"  class="EstFormularioCajaDeshabilitada" name="CmpVehiculoUnidadId" type="text" id="CmpVehiculoUnidadId" value="<?php echo $InsConductor->ConVehiculoUnidad;?><?php echo $InsConductor->ConVehiculoUnidad2;?><?php echo $InsConductor->ConVehiculoUnidad3;?>" size="15" maxlength="20" />-->
		   ...
		   ?>
              </select>                          <!--<a href="javascript:FncVehiculoNuevo();">Limpiar datos de unidad</a>-->
          ...
          <tr>
            ...
            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpVehiculoPlaca" type="text" id="CmpVehiculoPlaca" value="<?php echo $InsConductor->VehPlaca;?>" size="20" maxlength="8" />
              <a target="_blank" href=" https://m.sunarp.gob.pe/mobile/m_ConsultaVehicular.aspx">Consultar Placa</a></td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="4" align="left" valign="top"><span class="EstFormularioSubTitulo">DOCUMENTOS</span></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
...
var sprytextfield7 = new Spry.Widget.ValidationTextField("sprytextfield8", "date", {format:"dd/mm/yyyy", isRequired:false});
var sprytextfield7 = new Spry.Widget.ValidationTextField("sprytextfield4", "date", {format:"dd/mm/yyyy", isRequired:false});
