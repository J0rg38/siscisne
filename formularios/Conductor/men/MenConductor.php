...
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Importar&ses=<?php echo $Identificador;?>"><img src="imagenes/iconos/importar.png" alt="[Importar]"  title="Ir a formulario de Importar" />Importar</a></div>
<?php
}
?>
