...
?>
	<tr>
		<td colspan="<?php echo count($InsPlanMantenimiento->PmaChevroletKilometrajesResumen)+1;?>" align="left" class="EstPlanMantenimientoSeccion"><?php echo $DatPlanMantenimientoSeccion->PmsNombre;?></td>
	</tr>                
<?php
...
//deb($PlanMantenimientoDetalleAccion);
	...
	<tr>
		<td align="left" valign="top" class="EstPlanMantenimientoTarea">
			...
			<span title="<?php echo $DatPlanMantenimientoTarea->PmtId;?>"><?php echo $DatPlanMantenimientoTarea->PmtNombre;?> </span>
            
            
           <!-- <span style="color:#CCC;">[<?php echo $DatPlanMantenimientoTarea->PmtId;?>]</span>-->
...
<div id="CapPlanMantenimientoDetalle_<?php echo $DatPlanMantenimientoTarea->PmtId;?>_<?php echo $DatKilometro['eq'];?>" >
...
?>
                 ...
                 <?php  $TprId =  $DatTareaProducto->TprId;?>
                  
                  
                  
                  <span style="font-size:8px; color:#F00;">Cod.: <?php echo $DatTareaProducto->ProCodigoOriginal;?></span><br />
                  <span style="font-size:8px;">Nomb.: <?php echo $DatTareaProducto->ProNombre;?></span><br />
                  <span style="font-size:8px; color:#03F;">Cant.: <?php echo $DatTareaProducto->TprCantidad;?></span><br />
                  <span style="font-size:8px; color:#0C3;">Und.: <?php echo $DatTareaProducto->UmeNombre;?></span><br />
                  
                 <!-- <span style="font-size:6px; color:#CCC;"><?php echo $TprId;?></span><br />-->
...
if(empty($TprId)){
?>
<!--FncTareaProductoCargarFormulario(oForm,oId,oPlanMantenimientoDetalleId,oPlanMantenimientoId,oPlanMantenimientoTareaId,oPlanMantenimientoDetalleKilometraje)  -->
    <a   href="javascript:FncTareaProductoCargarFormulario('Registrar','','<?php echo $PlanMantenimientoDetalleId;?>','<?php echo $InsPlanMantenimiento->PmaId;?>','<?php echo $DatPlanMantenimientoTarea->PmtId;?>','<?php echo $DatKilometro['eq'];?>');">
...
?>
    ...
    <a   href="javascript:FncTareaProductoCargarFormulario('Editar','<?php echo $TprId;?>','<?php echo $PlanMantenimientoDetalleId;?>','<?php echo $InsPlanMantenimiento->PmaId;?>','<?php echo $DatPlanMantenimientoTarea->PmtId;?>','<?php echo $DatKilometro['eq'];?>');">
    <?php echo (($PlanMantenimientoDetalleAccion=="X")?'':$PlanMantenimientoDetalleAccion);?>
    </a>
