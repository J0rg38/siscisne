...
?>
<a id="<?php echo $DatPlanMantenimientoTarea->PmtId?>-<?php echo $DatKilometro['eq']?>" target="_blank" href="migrar/corregir.php?TprId=<?php echo $TprId;?>&PmaId=<?php echo $InsPlanMantenimiento->PmaId;?>&PmtId=<?php echo $DatPlanMantenimientoTarea->PmtId;?>&Kilometraje=<?php echo $DatKilometro['eq'];?>&Kilometrajes=<?php echo $Kilometrajes;?>">
