...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">EDITAR PLAN DE MANTENIMIENTO</span></td>
      </tr>
      <tr>
        <td>
...
?>
	<tr>
		<td colspan="<?php echo count($InsPlanMantenimiento->PmaChevroletKilometrajesResumen)+2;?>" align="left" class="EstPlanMantenimientoSeccion"><?php echo $DatPlanMantenimientoSeccion->PmsNombre;?></td>
	</tr>                
<?php
...
//deb($PlanMantenimientoDetalleAccion);
?>
<div class="CapPlanMantenimientoDetalle_<?php echo $PlanMantenimientoDetalleId;?>" >
<?php
if($PlanMantenimientoDetalleAccion<>"X"){
?>

    <a   href="javascript:FncPlanMantenimientoDetalleCargarFormulario('Editar','<?php echo $PlanMantenimientoDetalleId;?>','<?php echo $InsPlanMantenimiento->PmaId;?>','<?php echo $DatPlanMantenimientoTarea->PmtId;?>','<?php echo $DatKilometro['eq'];?>');">
    <?php echo ($PlanMantenimientoDetalleAccion);?>
    </a>
<?php	
}else{
?>
     <a   href="javascript:FncPlanMantenimientoDetalleCargarFormulario('Registrar','<?php echo $PlanMantenimientoDetalleId;?>','<?php echo $InsPlanMantenimiento->PmaId;?>','<?php echo $DatPlanMantenimientoTarea->PmtId;?>','<?php echo $DatKilometro['eq'];?>');">
    -
    </a>
<?php	
}
...
//MtObtenerPlanMantenimientoDetalleId($oPlanMantenimiento=NULL,$oKilometraje=NULL,$oSeccion=NULL,$oTarea=NULL)
...
-->
<!--
FncTareaProductoCargarFormulario(oForm,oPlanMantenimientoDetalleId,oPlanMantenimientoId,oPlanMantenimientoTareaId,oPlanMantenimientoDetalleKilometraje){
