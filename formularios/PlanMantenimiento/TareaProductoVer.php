...
$ResTareaProducto = $InsTareaProducto->MtdObtenerTareaProductos(NULL,NULL,NULL,'TprId','Desc',NULL,$GET_PlanMantenimientoId,$GET_MantenimientoKilometraje,$GET_PlanMantenimientoTareaId);
