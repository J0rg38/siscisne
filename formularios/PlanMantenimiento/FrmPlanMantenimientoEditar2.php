...
<a id="<?php echo $DatPlanMantenimientoTarea->PmtId?>-<?php echo $DatKilometro['eq']?>" target="_blank" href="formularios/PlanMantenimiento/DiaPlanMantenimientoEditar.php?PmaId=<?php echo $InsPlanMantenimiento->PmaId;?>&PmdId=<?php echo $PlanMantenimientoDetalleId;?>&PmaId=<?php echo $InsPlanMantenimiento->PmaId;?>&PmtId=<?php echo $DatPlanMantenimientoTarea->PmtId;?>&Kilometraje=<?php echo $DatKilometro['eq'];?>&Kilometrajes=<?php echo $Kilometrajes;?>">
...
?>	
	<span style="font-size:8px;"><?php echo $TprId =  $DatTareaProducto->TprId;?></span><br />
<?php
}
?>  
