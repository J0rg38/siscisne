...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/TrasladoAlmacen/acc/AccTrasladoAlmacenGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/TrasladoAlmacen/acc/AccTrasladoAlmacenGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	...
	document.getElementById("FrmListado").action = "formularios/TrasladoAlmacen/FrmTrasladoAlmacenListadoImprimir.php"
...
//
//			if(actualizar){
//				$("#Acc").val("EnviarTrasladoAlmacenContabilidad");
//				$("#FrmListado").submit();	
//			}else{
		...
		if(confirm("¿Realmente desea GENERAR la ORDEN DE COMPRA con los elementos seleccionados?")){
			...
			if(actualizar){
				...
				if(actualizar2){
					...
					$("#FrmListado").attr("action","principal.php?Mod=OrdenCompra&Form=Registrar&Ori=TrasladoAlmacen");
					$("#FrmListado").submit();	
