...
if($InsUnidadMedida->UmeId == $InsProducto->UmeId){
	...
	foreach($ArrUnidadMedidaConversiones as $DatUnidadMedidaConversion){
		$InsUnidadMedidaConversion->UmcEquivalente = $DatUnidadMedidaConversion->UmcEquivalente;
			...
			*/
	$InsTrasladoAlmacenDetalle1 = array();
	$InsTrasladoAlmacenDetalle1 = $_SESSION['InsTrasladoAlmacenDetalle'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
	
	$Cantidad = round($_POST['ProductoCantidad'],3);
	$CantidadReal = round($Cantidad * $InsUnidadMedidaConversion->UmcEquivalente,6);
	
	$_SESSION['InsTrasladoAlmacenDetalle'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
	$InsTrasladoAlmacenDetalle1->Parametro1,
	$InsTrasladoAlmacenDetalle1->Parametro2,
	$InsTrasladoAlmacenDetalle1->Parametro3,
	0,
	$Cantidad,
	$CantidadReal,
	$InsTrasladoAlmacenDetalle1->Parametro7,
	date("d/m/Y H:i:s"),
	$InsUnidadMedida->UmeNombre,
	$InsUnidadMedida->UmeId,
	$InsTrasladoAlmacenDetalle1->Parametro11,
	NULL,
	$InsTrasladoAlmacenDetalle1->Parametro13,
	NULL,
	$InsTrasladoAlmacenDetalle1->Parametro15,
	3,
	$InsTrasladoAlmacenDetalle1->Parametro17
	);
