...
var TrasladoAlmacenDetalleVerEstado = 1;
...
<div class="tab_container">
         ...
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top"><input  name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if(empty($InsTrasladoAlmacen->TalFecha)){ echo date("d/m/Y");}else{ echo $InsTrasladoAlmacen->TalFecha; }?>" size="15" maxlength="10" readonly="readonly" /></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td align="left" valign="top">Tipo Doc.:
                 <input type="hidden" name="CmpClienteId" id="CmpClienteId" value="<?php echo $InsTrasladoAlmacen->CliId;?>" size="3" /></td>
	...
	?>
                 <option <?php echo $DatTipoDocumento->TdoId;?> <?php echo ($DatTipoDocumento->TdoId==$InsTrasladoAlmacen->TdoId)?'selected="selected"':"";?> value="<?php echo $DatTipoDocumento->TdoId?>"><?php echo $DatTipoDocumento->TdoCodigo?> - <?php echo $DatTipoDocumento->TdoNombre?></option>
                 <?php
	}
	?>
               </select></td>
               ...
               <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td><span id="sprytextfield5">
                     <input tabindex="4" class="EstFormularioCajaDeshabilitada" name="CmpClienteNumeroDocumento" type="text" id="CmpClienteNumeroDocumento" size="20" maxlength="50" value="<?php echo $InsTrasladoAlmacen->CliNumeroDocumento;?>"   />
                     </span></td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><span id="sprytextfield2">
                 <label>
                   <input  tabindex="2" class="EstFormularioCajaDeshabilitada" name="CmpClienteNombre" type="text" id="CmpClienteNombre" size="45" maxlength="255" value="<?php echo $InsTrasladoAlmacen->CliNombre;?> <?php echo $InsTrasladoAlmacen->CliApellidoPaterno;?> <?php echo $InsTrasladoAlmacen->CliApellidoMaterno;?>"  />
                   </label>
                 </span></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
             ...
             <tr>
			  ...
			  ?>
                     <option value="<?php echo $DatMoneda->MonId?>" <?php if($InsTrasladoAlmacen->MonId==$DatMoneda->MonId){ echo 'selected="selected"';}elseif($EmpresaMonedaId==$DatMoneda->MonId){  echo 'selected="selected"';}?> ><?php echo $DatMoneda->MonNombre?> ( <?php echo $DatMoneda->MonSimbolo;?>)</option>
                     <?php
			  }
			  ?>
                     </select></td>
               ...
               <td align="left" valign="top"><input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncTrasladoAlmacenDetalleListar();" value="<?php if (empty($InsTrasladoAlmacen->TalTipoCambio)){ echo "";}else{ echo $InsTrasladoAlmacen->TalTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td align="left" valign="top">Impuesto (%):</td>
               <td align="left" valign="top"><input name="CmpPorcentajeImpuestoVenta" type="text" class="EstFormularioCajaDeshabilitada" id="CmpPorcentajeImpuestoVenta" onchange="FncFacturaDetalleListar();" value="<?php echo $InsTrasladoAlmacen->TalPorcentajeImpuestoVenta;?>" size="10" maxlength="10" readonly="readonly" /></td>
               ...
               <td align="left" valign="top"><?php
                 ...
                 <!--<input type="hidden" name="CmpEstado" id="CmpEstado" value="<?php echo $InsTrasladoAlmacen->TalEstado;?>" />--></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               ...
               <td align="left" valign="top"><!-- <input type="hidden" name="CmpOrigen" id="CmpOrigen" value="<?php echo $InsTrasladoAlmacen->TalOrigen;?>" size="3" />-->
                 <?php
                    switch($InsTrasladoAlmacen->TalOrigen){
						case "TAL":
                 ...
                 <select  class="EstFormularioCombo" name="CmpOrigen" id="CmpOrigen" disabled="disabled" >
                   <option <?php echo $OpcOrigen1;?> value="TAL">Ped. Compra Normal</option>
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpVentaDirectaId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVentaDirectaId"  tabindex="3" value="<?php  echo $InsTrasladoAlmacen->VdiId;?>" size="20" maxlength="25" readonly="readonly" />
/
  <input name="CmpVentaDirectaOrdenCompraNumero" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVentaDirectaOrdenCompraNumero"  tabindex="3" value="<?php  echo $InsTrasladoAlmacen->VdiOrdenCompraNumero;?>" size="20" maxlength="25" readonly="readonly" /></td>
               <td align="left" valign="top">Orden de Compra: </td>
               <td align="left" valign="top"><table>
                 <tr>
                   <td>&nbsp;</td>
                   <td><input name="CmpOrdenCompraId" id="CmpOrdenCompraId" type="hidden"   tabindex="3" value="<?php  echo $InsTrasladoAlmacen->OcoId;?>" size="20" maxlength="20" />
                     <input name="CmpOrdenCompra" type="text" class="EstFormularioCaja" id="CmpOrdenCompra"  tabindex="3" value="<?php  echo $InsTrasladoAlmacen->OcoId;?>" size="25" maxlength="25" readonly="readonly" /></td>
                   <td>&nbsp;</td>
                   <td></td>
                   </tr>
               </table></td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpFichaIngresoId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpFichaIngresoId"  tabindex="3" value="<?php  echo $InsTrasladoAlmacen->FinId;?>" size="20" maxlength="25" readonly="readonly" />
                 /
                 <input name="CmpFichaIngresoModalidad" type="text" class="EstFormularioCajaDeshabilitada" id="CmpFichaIngresoModalidad"  tabindex="3" value="<?php  echo $InsTrasladoAlmacen->MinNombre;?>" size="20" maxlength="45" readonly="readonly" />
                 <span class="EstFormularioSubTitulo">
                   <input type="hidden" name="CmpFichaAccionId" id="CmpFichaAccionId" value="<?php  echo $InsTrasladoAlmacen->FccId;?>" />
                 </span></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td>&nbsp;</td>
               <td><input type="hidden" name="CmpTrasladoAlmacenDetalleAccion" id="CmpTrasladoAlmacenDetalleAccion" value="AccTrasladoAlmacenDetalleRegistrar.php" /></td>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td width="49%" align="right"><a href="javascript:FncTrasladoAlmacenDetalleListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a></td>
