...
<tr>
  ...
  <span class="EstPlantillaTitulo">TRANSFERENCIA ENTRE ALMACENES</span><br />
...
<tr>
    ...
    <tr>
      <td colspan="6" align="left" valign="top"><span class="EstTrasladoAlmacenImprimirCabecera">Datos de Transferencia</span></td>
      <td width="3%" align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td width="13%" align="left" valign="top" class="EstTrasladoAlmacenImprimirEtiquetaFondo">&nbsp;</td>
      <td width="3%" align="left" valign="top" >&nbsp;</td>
    ...
    <tr>
      <td align="left" valign="top" class="EstTrasladoAlmacenImprimirEtiquetaFondo"><span class="EstTrasladoAlmacenImprimirEtiqueta">Fecha salida</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirContenido"><?php echo $InsTrasladoAlmacen->TalFecha;?></span></td>
      <td align="left" valign="top" class="EstTrasladoAlmacenImprimirEtiquetaFondo"><span class="EstTrasladoAlmacenImprimirEtiqueta">Fecha llegada</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirContenido"><?php echo $InsTrasladoAlmacen->TalFecha;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td align="left" valign="top" class="EstTrasladoAlmacenImprimirEtiquetaFondo"><span class="EstTrasladoAlmacenImprimirEtiqueta">ALMACEN ORIGEN</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirContenido"><?php echo $InsTrasladoAlmacen->TalFecha;?></span></td>
      <td align="left" valign="top" class="EstTrasladoAlmacenImprimirEtiquetaFondo"><span class="EstTrasladoAlmacenImprimirEtiqueta">ALMACEN DESTINO</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirEtiqueta">:</span></td>
      <td align="left" valign="top" ><span class="EstTrasladoAlmacenImprimirContenido"><?php echo $InsTrasladoAlmacen->TalFecha;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
  ...
  <tr>
    <td colspan="5" align="center"><table class="EstTablaTotal" width="100%" cellpadding="3" cellspacing="2" border="0">
      <tbody class="EstTablaTotalBody">
        <tr>
          <td width="11%" align="right" valign="top"><span class="EstTrasladoAlmacenImprimirEtiqueta">ObservacionES</span></td>
          ...
          <td width="20%" align="right" valign="top" class="EstTrasladoAlmacenImprimirEtiquetaFondo">&nbsp;</td>
