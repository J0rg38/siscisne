...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="4">&nbsp;</td>
            <td width="147"><span class="EstFormularioSubTitulo">
          ...
          <tr>
            ...
            <td valign="top"><select class="EstFormularioCombo" name="CmpVehiculoMarca" id="CmpVehiculoMarca" >
          ...
          <tr>
            <td>&nbsp;</td>
            <td>Nombre:</td>
            <td><input class="EstFormularioCaja"   name="CmpNombre" type="text" id="CmpNombre" value="<?php echo $InsVehiculoVersion->VveNombre;?>" size="40" maxlength="250" /></td>
            <td>&nbsp;</td>
          </tr>
            ...
            <td align="left" valign="top"><div class="EstFormularioArea" >
              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                ...
                <tr>
                  ...
                  <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                    <tr>
                      <td width="275" colspan="2" align="left" valign="top"><div id="fileUploadVehiculoVersionFoto">Escoger Archivo</div>
                        <script type="text/javascript">
            ...
            <td align="left" valign="top"><div class="EstFormularioArea" >
              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                ...
                <tr>
                  ...
                  <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                    <tr>
                      <td width="275" colspan="2" align="left" valign="top"><div id="fileUploadVehiculoVersionFotoLateral">Escoger Archivo</div>
                        <script type="text/javascript">
            ...
            <td align="left" valign="top"><div class="EstFormularioArea" >
              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                ...
                <tr>
                  ...
                  <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                    <tr>
                      <td width="275" colspan="2" align="left" valign="top"><div id="fileUploadVehiculoVersionFotoPosterior">Escoger Archivo</div>
                        <script type="text/javascript">
            ...
            <td align="left" valign="top"><div class="EstFormularioArea" >
              <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                ...
                <tr>
                  ...
                  <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                    <tr>
                      <td width="275" colspan="2" align="left" valign="top"><div id="fileUploadVehiculoVersionArchivo">Escoger Archivo</div>
                        <script type="text/javascript">
