...
function FncBuscar(){
	//document.getElementById('Est').value = 'TODOS';
	document.getElementById('Pag').value = '0,'+document.getElementById('Num').value;
	document.getElementById('Ord').value = '';
	document.getElementById('Sen').value = '';
	tree.saveOpenStates("CooVehiculoVersion");
	$("#FrmListado").submit();
}
...
* VERSIONES
*/
function FncVehiculoVersionActualizarCaracteristicas(oVehiculoVersionId){
	
	tb_show(this.title,'principal2.php?Mod=VehiculoVersion&Form=ActualizarCaracteristicas&Dia=1&Id='+oVehiculoVersionId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
