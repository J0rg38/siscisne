...
<tr>
  <th width="2%">#</th>
  <th width="7%">Id</th>
  <th width="17%">Seccion</th>
  <th width="32%">Caracteristica</th>
...
<td align="right" valign="top" class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>"><?php echo $DatSesionObjeto->Parametro10;?></td>
<td align="right" valign="top" class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>"><?php echo $DatSesionObjeto->Parametro10;?></td>
<td align="right" valign="top" class="<?php echo (($c%2==0)?'Activo':'Inactivo');?>">
