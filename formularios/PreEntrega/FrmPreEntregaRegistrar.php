...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPreEntregaRegistrar.php');
//DATOS
...
<img src="imagenes/acciones/editar.png" alt="[Editar]" width="25" height="25" border="0" align="absmiddle" title="Editar" />
                     ...
                     <tr>
                       ...
                       <td align="left"><input class="EstFormularioCaja"  name="CmpVehiculoKilometraje" type="text" id="CmpVehiculoKilometraje" value="<?php if(empty($InsFichaIngreso->FinVehiculoKilometraje)){ echo "0.00"; }else{echo $InsFichaIngreso->FinVehiculoKilometraje;}?>" size="10" maxlength="10" /></td>
              ...
              <td width="97%" valign="top">
                ...
                <div class="EstFormularioArea">
                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="6"><span class="EstFormularioSubTitulo">Datos de la Pre-Entrega (PDS)
    ...
    ?>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="6" align="left" valign="top">* El codigo es autogenerado al guardar la Pre-Entrega (PDS)</td>
                      <td>&nbsp;</td>
                      </tr>
                          ...
                          <div class="EstFormularioArea">
                            <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                              <tr>
								...
								<input type="hidden" name="Cmp<?php echo $DatModalidadIngreso->MinSigla?>SuministroUnidadMedida" id="Cmp<?php echo $DatModalidadIngreso->MinSigla?>SuministroUnidadMedida" value="" />
                                    <input type="hidden" name="Cmp<?php echo $DatModalidadIngreso->MinSigla?>SuministroUnidadMedidaEquivalente"   id="Cmp<?php echo $DatModalidadIngreso->MinSigla?>SuministroUnidadMedidaEquivalente" value=""  />
                              ...
                              <tr>
                                <td>&nbsp;</td>
                                <td><input type="hidden" name="CmpPreEntrega<?php echo $DatModalidadIngreso->MinSigla;?>SuministroAccion" id="CmpPreEntrega<?php echo $DatModalidadIngreso->MinSigla;?>SuministroAccion" value="AccPreEntregaSuministroRegistrar.php" /></td>
                                <td>Nombre : </td>
                                <td>U.M. </td>
                                <td>Cantidad:</td>
						 ...
						 /* 
                          ...
                          <div class="EstFormularioArea" >
                            <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                              <tr>
                                <td width="1%">&nbsp;</td>
                                <td width="50%"><div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla;?>SuministroAccion">Listo
                                  para registrar elementos</div></td>
                                <td width="48%" align="right"><a href="javascript:FncPreEntregaSuministroListar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncPreEntregaSuministroEliminarTodo('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a></td>
