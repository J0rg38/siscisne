...
<tr>
  ...
  <th width="14%" align="center">Cod. Alternativo</th>
  <th width="68%" align="center"> Nombre
</th>
<th width="4%" align="center"> Acc.</th>
</tr>
</thead>
...
<a class="EstSesionObjetosItem" href="javascript:FncPreEntregaProductoEscoger('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
...
if($_POST['Eliminar']==1){
?>
    <a href="javascript:FncPreEntregaProductoEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $ModalidadIngreso;?>');" >
