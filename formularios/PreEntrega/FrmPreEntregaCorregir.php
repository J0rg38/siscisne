...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPreEntregaCorregir.php');
...
$(document).ready(function (){
	...
	//FncPreEntregaHistorialListar();	//FncPreEntregaMantenimientoKilometrajeEstablecer();
...
<input name="CmpClienteId" type="hidden" id="CmpClienteId" value="<?php echo $InsFichaIngreso->CliId;?>" size="3" /></td>
                 ...
                 <td align="left" valign="top"><input name="CmpClienteNombre" type="text" class="EstFormularioCajaDeshabilitada" id="CmpClienteNombre" value="<?php echo $InsFichaIngreso->CliNombre;?> <?php echo $InsFichaIngreso->CliApellidoPaterno;?> <?php echo $InsFichaIngreso->CliApellidoMaterno;?>" size="45" maxlength="255" readonly="readonly"  /></td>
                 <td>&nbsp;</td>
                 </tr>
               <tr>
                 <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <div class="EstFormularioArea">
                    <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td><a href="javascript:FncPreEntregaTareaNuevo('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                        ...
                        <td><a href="javascript:FncPreEntregaTareaGuardar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <td align="left" valign="top"><div class="EstFormularioArea">
                    <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td><a href="javascript:FncPreEntregaProductoNuevo('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                        ...
                        <td><a href="javascript:FncPreEntregaProductoGuardar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img src="imagenes/guardar.gif" width="20" height="20" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                  ...
                  <td width="50%" align="left" valign="top"><div class="EstFormularioArea" >
                    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                      ...
                      <tr>
                        ...
                        <td width="49%" align="right"><a href="javascript:FncPreEntregaTareaListar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a></td>
                    ...
                    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                      ...
                      <tr>
                        ...
                        <td width="49%"><div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla;?>ProductoAccion">Listo
                          para registrar elementos</div></td>
                        <td width="48%" align="right"><a href="javascript:FncPreEntregaProductoListar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a></td>
                    ...
                    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                      ...
                      <tr>
                        ...
                        <td width="49%"><div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla;?>SuministroAccion">Listo
                          para registrar elementos</div></td>
                        <td width="48%" align="right"><a href="javascript:FncPreEntregaSuministroListar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a></td>
                            ...
                            <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="javascript:FncPreEntregaTareaNuevo('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img src="imagenes/registrar.png" width="20" height="20" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                          ...
                          <td align="left" valign="top"><div class="EstFormularioArea" >
                            <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                              ...
                              <tr>
                                ...
                                <td width="49%"><div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla;?>ProductoAccion">Listo
                                  para registrar elementos</div></td>
                                <td width="49%" align="right"><a href="javascript:FncPreEntregaProductoListar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a><a href="javascript:FncPreEntregaProductoEliminarTodo('<?php echo $DatModalidadIngreso->MinSigla;?>');"></a></td>
                            ...
                            <div class="EstFormularioArea" >
                              <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                ...
                                <tr>
                                  ...
                                  <td width="49%"><div class="EstFormularioAccion" id="Cap<?php echo $DatModalidadIngreso->MinSigla;?>TareaAccion">Listo
                                  para registrar elementos</div></td>
                                  <td width="49%" align="right"><a href="javascript:FncPreEntregaTareaListar('<?php echo $DatModalidadIngreso->MinSigla;?>');"><img  src="imagenes/recargar.gif"  width="20" height="20"  border="0" title="Recargar"   alt="[Recargar]" align="absmiddle"/> [Recargar]</a><a href="javascript:FncPreEntregaTareaEliminarTodo('<?php echo $DatModalidadIngreso->MinSigla;?>');"></a></td>
                                  <td width="1%"><div id="CapPreEntrega<?php echo $DatModalidadIngreso->MinSigla;?>TareasResultado"> </div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
