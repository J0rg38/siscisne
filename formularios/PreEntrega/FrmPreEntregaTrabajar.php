...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPreEntregaTrabajar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">EDITAR PRE-ENTREGA (PDS)</span> *</td>
      </tr>
      <tr>
        <td colspan="2">
 ...
 <div class="tab_container">
    ...
    ?>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input  name="CmpHora" type="text" class="EstFormularioCajaDeshabilitada" id="CmpHora" value="<?php if(empty($InsFichaIngreso->FinHora)){ echo date("H:i"); }else{echo $InsFichaIngreso->FinHora;}?>" size="10" maxlength="5" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
