...
$ResPersonal = $InsPersonal->MtdObtenerPersonales(NULL,NULL,NULL,"PerNombre","ASC",NULL,NULL,1,NULL,NULL,1,NULL,NULL,$InsVehiculoIngresoBono->SucId,NULL,NULL,true);
...
//MtdObtenerPersonales($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'PerId',$oSentido = 'Desc',$oPaginacion = '0,10',$oPersonalTipo=NULL,$oEstado=NULL,$oFechaNacimientoRango=NULL,$oTaller=NULL,$oRecepcion=NULL,$oVenta=NULL,$oArea=NULL,$oSucursal=NULL,$oAlmacen=NULL,$oFirmante=NULL,$oMultisucursal=false)
$ResPersonal = $InsPersonal->MtdObtenerPersonales(NULL,NULL,NULL,"PerNombre","ASC",NULL,NULL,1,NULL,1,NULL,NULL,NULL,$InsVehiculoIngresoBono->SucId,NULL,NULL,true);
$ArrTecnicos = $ResPersonal['Datos'];
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
 ...
 <div class="tab_container">
	...
	?>
                ...
                <td><input <?php if(!empty($InsVehiculoIngresoBono->CliId)){ echo 'readonly="readonly"';} ?>   tabindex="2" class="EstFormularioCaja" name="CmpClienteNombreCompleto" type="text" id="CmpClienteNombreCompleto" size="45" maxlength="255" value="<?php echo $InsVehiculoIngresoBono->CliNombre;?> <?php echo $InsVehiculoIngresoBono->CliApellidoPaterno;?> <?php echo $InsVehiculoIngresoBono->CliApellidoMaterno;?>"  />
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><table>
              <tr>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoIngresoPlaca" type="text"  class="EstFormularioCaja" id="CmpVehiculoIngresoPlaca" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoPlaca;?>" size="10" maxlength="50"  /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoMarca" type="text"  class="EstFormularioCaja" id="CmpVehiculoMarca" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoMarca;?>" size="15" maxlength="50"  /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoModelo" type="text"  class="EstFormularioCaja" id="CmpVehiculoModelo" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoModelo;?>" size="15" maxlength="50" /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoVersion" type="text"  class="EstFormularioCaja" id="CmpVehiculoVersion" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoVersion;?>" size="15" maxlength="50"/></td>
                </tr>
              </table></td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><input class="EstFormularioCaja" name="CmpTotal" type="text" id="CmpTotal" size="10" maxlength="10" value="<?php echo round($InsVehiculoIngresoBono->VibTotal,2);?>" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Observaciones:</td>
            <td colspan="5" align="left" valign="top"><textarea class="EstFormularioCaja" name="CmpDescripcion" id="CmpDescripcion" cols="45" rows="4"><?php echo $InsVehiculoIngresoBono->VibDescripcion;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
