 ...
 <div class="tab_container">
	...
	?>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><table>
              <tr>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoIngresoPlaca" type="text"  class="EstFormularioCaja" id="CmpVehiculoIngresoPlaca" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoPlaca;?>" size="10" maxlength="50" readonly="readonly"  /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoMarca" type="text"  class="EstFormularioCaja" id="CmpVehiculoMarca" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoMarca;?>" size="15" maxlength="50" readonly="readonly" /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoModelo" type="text"  class="EstFormularioCaja" id="CmpVehiculoModelo" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoModelo;?>" size="15" maxlength="50" readonly="readonly"  /></td>
                ...
                <td align="left" valign="top" class="EstFormulario"><input  name="CmpVehiculoVersion" type="text"  class="EstFormularioCaja" id="CmpVehiculoVersion" value="<?php echo $InsVehiculoIngresoBono->VibVehiculoVersion;?>" size="15" maxlength="50" readonly="readonly" /></td>
                </tr>
              </table></td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"><input name="CmpTotal" type="text" class="EstFormularioCaja" id="CmpTotal" value="<?php echo round($InsVehiculoIngresoBono->VibTotal,2);?>" size="10" maxlength="10" readonly="readonly" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Observaciones:</td>
            <td colspan="5" align="left" valign="top"><textarea name="CmpDescripcion" cols="45" rows="4" readonly="readonly" class="EstFormularioCaja" id="CmpDescripcion"><?php echo $InsVehiculoIngresoBono->VibDescripcion;?></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
