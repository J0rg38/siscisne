...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	?>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpTotal" type="text" id="CmpTotal" size="10" maxlength="10" value="<?php echo round($InsVehiculoIngresoBono->VibTotal,2);?>" /></td>
            <td align="left" valign="top">&nbsp;</td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><textarea class="EstFormularioCaja" name="CmpDescripcion" id="CmpDescripcion" cols="45" rows="4"><?php echo $InsVehiculoIngresoBono->VibDescripcion;?></textarea></td>
            <td align="left" valign="top">&nbsp;</td>
            <td colspan="3" align="left" valign="top">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
