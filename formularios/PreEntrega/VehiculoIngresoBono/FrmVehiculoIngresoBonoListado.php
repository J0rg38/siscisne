...
//MtdObtenerVehiculoIngresoBonos($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'VibId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oCliente=NULL,$oPersonal=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oFecha="VibFecha",$oSinFichaIngreso=false,$oVehiculoIngresoId=NULL,$oPersonalMecanico=NULL,$oHora=NULL,$oSucursal=NULL) 
$ResVehiculoIngresoBono = $InsVehiculoIngresoBono->MtdObtenerVehiculoIngresoBonos("cit.VibId,cit.VibVehiculoPlaca,ein.EinVIN,ein.EinPlaca,vma.VmaNombre,vmo.VmoNombre,vve.VveNombre,cit.VibVehiculoMarca,cit.VibVehiculoModelo,cit.VibVehiculoVersion,cli.CliNombre,cli.CliApellidoPaterno,cli.CliApellidoMaterno,cli.CliNombreCompleto,cli.CliTelefono,cli.CliCelular","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,NULL,$POST_Personal,FncCambiaFechaAMysql($POST_finicio),(FncCambiaFechaAMysql($POST_ffin)),$POST_TipoFecha,false,NULL,$POST_PersonalMecanico,NULL,$POST_Sucursal);
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" valign="middle" width="3%"   ><?php echo $dat->VibId;  ?></td>
                <td align="right" valign="middle" width="5%"   ><?php echo $dat->VibFechaProgramada;  ?></td>
                <td align="right" valign="middle" width="13%"   ><?php echo $dat->EinVIN; ?></td>
                <td align="right" valign="middle" width="9%"   ><?php echo $dat->VibVehiculoMarca; ?></td>
                <td width="9%" align="right" valign="middle"   ><?php echo $dat->VibVehiculoModelo; ?></td>
                <td width="8%" align="right" valign="middle"   ><?php echo $dat->VibVehiculoVersion; ?></td>
                <td width="15%" align="right" valign="middle"   ><?php echo $dat->CliNombre;  ?> <?php echo $dat->CliApellidoPaterno;  ?> <?php echo $dat->CliApellidoMaterno;  ?> / <?php echo $dat->VibReferencia;  ?></td>
                <td width="6%" align="right" valign="middle"   ><?php echo $dat->PerNombre; ?> <?php echo $dat->PerApellidoMaterno; ?> <?php echo $dat->PerApellidoPaterno; ?></td>
...
?>
 ...
 <a href="principal.php?Mod=FichaIngreso&Form=Registrar&VibId=<?php echo $dat->VibId;?>&Origen=VehiculoIngresoBono"><img src="imagenes/acciones/generar.png" width="19" height="19" border="0" title="Generar O.T." alt="[Generar O.T.]"   /></a>
<?php
}
?>
