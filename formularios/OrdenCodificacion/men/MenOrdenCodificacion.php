...
/*if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],$GET_mod,"Registrar") and empty($GET_dia)){
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Importar"><img src="imagenes/iconos/importar.png" alt="[Importar]"  title="Ir a formulario para Importar" />Importar</a></div>
<?php
}*/
?>
