...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">
                        <span class="EstFormularioSubTitulo">Datos de Consulta Tecnica PN 
			...
			?>
                          ...
                          <td><input <?php if(!empty($InsOrdenCodificacion->PrvId)){ echo 'readonly="readonly"';} ?> class="EstFormularioCaja" name="CmpProveedorNombre" type="text" id="CmpProveedorNombre" value="<?php echo $InsOrdenCodificacion->PrvNombreCompleto;?>" size="35" maxlength="255"  />                            <a href="comunes/Proveedor/FrmProveedorBuscar.php?height=440&amp;width=850" class="thickbox" title=""><img src="imagenes/acciones/buscador.png" alt="" width="25" height="25" border="0" align="absmiddle" /></a></td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4" align="left" valign="top"><span class="EstFormularioSubTitulo">Foto de Referencia del OrdenCodificacion</span>                      </td>
                      <td align="left" valign="top">&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
