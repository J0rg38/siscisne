...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/OrdenCodificacion/acc/AccOrdenCodificacionGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/OrdenCodificacion/acc/AccOrdenCodificacionGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	...
	document.getElementById("FrmListado").action = "formularios/OrdenCodificacion/FrmOrdenCodificacionListadoImprimir.php"
