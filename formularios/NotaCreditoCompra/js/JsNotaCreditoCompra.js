...
function FncGenerarExcel(){
	document.getElementById("FrmListado").action = "formularios/NotaCreditoCompra/acc/AccNotaCreditoCompraGenerarExcel.php"
	document.getElementById("FrmListado").submit();
	document.getElementById("FrmListado").action = "#";
}

function FncListadoImprimir(){
	document.getElementById("FrmListado").action = "formularios/NotaCreditoCompra/FrmNotaCreditoCompraListadoImprimir.php"
...
function FncNotaCreditoCompraImprmir(oId,oTalonario){
...
function FncNotaCreditoCompraVistaPreliminar(oId,oTalonario){
...
*/
//
//function FncAlmacenMovimientoEntradaCargarFormulario(oForm,oAlmacenMovimientoEntradaId){
//	
//	tb_show(this.title,'principal2.php?Mod=AlmacenMovimientoEntrada&Form='+oForm+'&Dia=1&Id='+oAlmacenMovimientoEntradaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
//
//}
