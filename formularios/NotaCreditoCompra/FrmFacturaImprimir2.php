...
<?php
if(file_exists("ImpFacturaImprimir".$InsFactura->FtaNumero."F.php")){
	include("ImpFacturaImprimir".$InsFactura->FtaNumero."F.php");	
}else{
?>
No existe version con formato para esta serie de factura.
<?php
}
?>
<?php
//include("ImpFacturaImprimir.php");
?>
