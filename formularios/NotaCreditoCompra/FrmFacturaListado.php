...
$ResFactura = $InsFactura->MtdObtenerFacturas("Ftanumero,FacId,CliNombreCompleto,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNumeroDocumento,FacOrdenNumero,FacSIAFNumero,FacTotal,fac.AmoId,FinId,amo.VdiId,vdi.VdiOrdenCompraNumero",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$_SESSION['SisSucId'],$POST_estado,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_tal,NULL,NULL,$POST_npago,NULL,$POST_Moneda);
     
//$ResFactura = $InsFactura->MtdObtenerFacturas($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$_SESSION['SisSucId'],$POST_estado,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_tal,NULL,NULL,$POST_npago,NULL,$POST_Moneda);
$ArrFacturas = $ResFactura['Datos'];
$FacturasTotal = $ResFactura['Total'];
$FacturasTotalSeleccionado = $ResFactura['TotalSeleccionado'];

$ResFacturaTalonario = $InsFacturaTalonario->MtdObtenerFacturaTalonarios(NULL,NULL,"FtaNumero","DESC",NULL,$_SESSION['SisSucId']);
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "FtaNumero"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FtaNumero','ASC');"> - <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FtaNumero','DESC');"> - <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "FacId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacId','ASC');"> Id. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacId','DESC');"> Id. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "CliNumeroDocumento"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CliNumeroDocumento','ASC');"> <span title="Numero de Documento">Num. Doc.</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CliNumeroDocumento','DESC');"> <span title="Numero de Documento">Num. Doc.</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "FacFechaEmision"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacFechaEmision','ASC');"> Fecha  <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacFechaEmision','DESC');"> Fecha  <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "NpaNombre"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('NpaNombre','ASC');"> <span title="Condicion de Pago">Cond. Pago</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('NpaNombre','DESC');"> <span title="Condicion de Pago">Cond. Pago</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "FacTipoCambio"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacTipoCambio','ASC');"> <span title="Tipo de Cambio">T.C.</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacTipoCambio','DESC');"> <span title="Tipo de Cambio">T.C.</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "FacObsequio"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacObsequio','ASC');"> <span title="Estado">Obs.</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacObsequio','DESC');"> <span title="Estado">Obs.</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "FacSpot"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacSpot','ASC');"> <span title="Estado"> Spot</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacSpot','DESC');"> <span title="Estado">Spot</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('FacSpot','ASC');"> <span title="Estado">Spot</span></a>
                <?php
				}
				?></th>
                <th width="2%" ><?php
				if($POST_ord == "FacEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacEstado','ASC');"> <span title="Estado">Est.</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacEstado','DESC');"> <span title="Estado">Est.</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "FinId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FinId','ASC');"> Ord. Trab./PDS <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FinId','DESC');"> Ord. Trab./PDS <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "CprId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CprId','ASC');"> Cot. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CprId','DESC');"> Cot. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "VdiId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VdiId','ASC');"> Ord. Ven. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VdiId','DESC');"> Ord. Ven. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "VdiOrdenCompraNumero"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('VdiOrdenCompraNumero','ASC');"> Ref. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('VdiOrdenCompraNumero','DESC');"> Ref.  <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "AmoId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AmoId','ASC');"> Mov. Alm. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AmoId','DESC');"> Mov. Alm. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "CveId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('CveId','ASC');"> Prof. Veh. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('CveId','DESC');"> Prof. Veh. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				if($POST_ord == "OvvId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OvvId','ASC');"> Ord. Ven. Veh. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OvvId','DESC');"> Ord. Ven. Veh. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
                ...
                <th width="3%" >Canc.</th>
                <th width="3%" ><?php
				if($POST_ord == "FacSubTotal"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacSubTotal','ASC');"> Sub Total <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacSubTotal','DESC');"> Sub Total <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('FacSubTotal','ASC');"> Sub Total  </a>
                  <?php
				}
				?></th>
                <th width="7%" ><?php
				if($POST_ord == "FacImpuesto"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacImpuesto','ASC');">Impuesto<img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacImpuesto','ASC');">Impuesto</a><a href="javascript:FncOrdenar('FacTotal','DESC');"><img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('FacImpuesto','ASC');">Impuesto </a>
                  <?php
				}
				?></th>
                <th width="3%" ><?php
				if($POST_ord == "FacTotal"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacTotal','ASC');"> Total <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacTotal','DESC');"> Total <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
				...
				?></th>
                <th width="6%" ><?php
				if($POST_ord == "RegNombre"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('RegNombre','ASC');"> Regimen <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('RegNombre','DESC');"> Regimen <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('RegNombre','ASC');"> Regimen </a>
                <?php
				}
				?></th>
                <th width="4%" ><?php
				if($POST_ord == "FacRegimenMonto"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacRegimenMonto','ASC');"> Reg. Monto <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacRegimenMonto','DESC');"> Reg. Monto <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('FacRegimenMonto','ASC');"> Reg. Monto </a>
                <?php
				}
				?></th>
				...
				if($POST_ord == "FacTotalItems"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacTotalItems','ASC');"> <span title="Items">It.</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacTotalItems','DESC');"> <span title="Items">It.</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{
				...
				?></th>
                <th width="9%" ><?php
				if($POST_ord == "FacTiempoModificacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('FacTiempoModificacion','ASC');"> <span title="Ultima Actualizacion">U.A.</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('FacTiempoModificacion','DESC');"> <span title="Ultima Actualizacion">U.A.</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('FacTiempoModificacion','ASC');"> <span title="Ultima Actualizacion">U.A.</span> </a>
                <?php
				}
				?></th>
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->FacId."%".$dat->FtaId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->FacId."%".$dat->FtaId; ?>" cliente = "<?php echo $dat->CliId;?>" estado="<?php echo $dat->FacEstado; ?>" nota_credito="<?php echo $dat->FacNotaCredito;?>" />				</td>
...
?>
  ...
  <?php  
				...
				<?php $dat->FacSubTotal = (($EmpresaMonedaId==$POST_Moneda or empty($POST_Moneda))?$dat->FacSubTotal:($dat->FacSubTotal/$dat->FacTipoCambio));?>
                
				<?php echo number_format($dat->FacSubTotal,2); ?></td>
                <td align="right" >  

				<?php $dat->FacImpuesto = (($EmpresaMonedaId==$POST_Moneda or empty($POST_Moneda))?$dat->FacImpuesto:($dat->FacImpuesto/$dat->FacTipoCambio));?>

				<?php echo number_format($dat->FacImpuesto,2); ?></td>
                <td align="right" > 
...
<?php $dat->FacRegimenMonto = (($EmpresaMonedaId==$POST_Moneda or empty($POST_Moneda))?$dat->FacRegimenMonto:($dat->FacRegimenMonto/$dat->FacTipoCambio));?>
				<?php echo number_format($dat->FacRegimenMonto,2);?>
