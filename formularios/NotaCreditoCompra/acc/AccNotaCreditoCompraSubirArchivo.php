...
if($POST_Borrar=="1"){
?>
<?php $_SESSION['SesNccFoto'.$Identificador] = ""; ?>
<?php	
}
?>
...
if (!empty($_FILES)) {
	...
	$targetPath = '../../../subidos/nota_credito_compra_fotos/';
	...
	if($extension=="jpg" || $extension == "png" || $extension == "gif" || $extension == "jpeg"){
		if (move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesNccFoto'.$Identificador] = $file_name;
			
			$mythumb = new thumb();
			$mythumb->loadImage('../../../subidos/nota_credito_compra_fotos/'.$file_name);
			$mythumb->crop(250, 250,'bottom');
			$mythumb->save('../../../subidos/nota_credito_compra_fotos/'.$nombre_base.'_thumb.'.$extension, 100);
			
?>
    Vista Previa:<br />
    
    
    <a target="_blank" href="../../../subidos/nota_credito_compra_fotos/<?php echo $nombre_base.".".$extension;?>">
      <img  src="../../../subidos/nota_credito_compra_fotos/<?php echo $nombre_base.".".$extension;?>" width="100" border="0" title="<?php echo $nombre_base.".".$extension;?>" />
      </a>
...
}elseif(!empty($_SESSION['SesNccFoto'.$Identificador])){
...
?>
    ...
    <a target="_blank" href="../../../subidos/nota_credito_compra_fotos/<?php echo $nombre_base.".".$extension;?>">
      <img  src="../../../subidos/nota_credito_compra_fotos/<?php echo $nombre_base.".".$extension;?>" width="100" border="0" title="<?php echo $nombre_base."_thumb.".$extension;?>" /></a>
