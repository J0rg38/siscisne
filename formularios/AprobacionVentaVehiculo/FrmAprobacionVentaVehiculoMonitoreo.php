...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsAprobacionVentaVehiculoMonitoreo.js" ></script>
<?php
/* 
...
$ResOrdenVentaVehiculo = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculos("OvvId,EinVIN,CliNombre,CliApellidoPaterno,CliApellidoMaterno,CliNombreCompleto,vma.VmaNombre,vmo.VmoNombre,vve.VveNombre",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),3,NULL,NULL,NULL,0,NULL,NULL,NULL,$POST_Sucursal,1,3,0);
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE APROBACIONES DE VENTA DE VEHICULOS PENDIENTES</span>  </td>
</tr>
<tr>
  <td width="50%">
...
?>
                ...
                <td  width="7%" align="right" >
                  ...
                  <?php $dat->OvvTotal = (($EmpresaMonedaId==$POST_Moneda or empty($POST_Moneda))?$dat->OvvTotal:($dat->OvvTotal/(empty($dat->OvvTipoCambio)?1:$dat->OvvTipoCambio)));?>
