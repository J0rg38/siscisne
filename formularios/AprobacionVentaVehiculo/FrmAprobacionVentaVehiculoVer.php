...
var AprobacionVentaVehiculoDetalleEditar = 2;
...
var AprobacionVentaVehiculoPropietarioEditar = 2;
var AprobacionVentaVehiculoPropietarioEliminar = 2;
         ...
         <td valign="top"><div class="EstFormularioArea">
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td align="left" valign="top"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php if(empty($InsAprobacionVentaVehiculo->AovFecha)){ echo date("d/m/Y");}else{ echo $InsAprobacionVentaVehiculo->AovFecha; }?>" size="15" maxlength="10" readonly="readonly" /></td>
               <td>&nbsp;</td>
             </tr>
             <tr>
               <td>&nbsp;</td>
             ...
             <tr>
               ...
               <td align="left" valign="top"><textarea name="CmpObservacion" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsAprobacionVentaVehiculo->AovObservacion;?></textarea></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
               <td>&nbsp;</td>
               </tr>
             ...
             <tr>
               <td>&nbsp;</td>
               <td colspan="4" align="center" valign="top"><?php
         ...
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
			...
			?>
               ...
               <td align="left" valign="top"><input name="VehiculoIngresoColor" type="text" class="EstFormularioCaja" id="VehiculoIngresoColor" value="<?php echo ($InsAprobacionVentaVehiculo->AovColor);?>" size="10" maxlength="30" readonly="readonly" /></td>
