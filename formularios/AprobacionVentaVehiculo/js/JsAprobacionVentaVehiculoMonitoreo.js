...
* EXTERNOS
*/
function FncOrdenVentaVehiculoVistaPreliminar(oId,oTalonario){

	FncPopUp('formularios/OrdenVentaVehiculo/FrmOrdenVentaVehiculoImprimir.php?Id='+oId+'&Ta='+oTalonario,0,0,1,0,0,1,0,screen.height,screen.width);
