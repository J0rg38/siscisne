...
function FncAprobacionVentaVehiculoActualizarPendienteSeleccionados(){
	...
	if(seleccionados==""){
		...
		if(confirm("¿Realmente desea marcar como Pendiente la(s) asignaciones de vin?")){
			...
			if(actualizar){
				$("#Acc").val("AprobacionVentaVehiculoActualizarPendiente");
				$("#FrmListado").submit();	
			}else{
...
function FncAprobacionVentaVehiculoActualizarEmitidoSeleccionados(){
	...
	if(seleccionados==""){
		...
		if(confirm("¿Realmente desea marcar como Aprobado la(s) asignaciones de vin?")){
			...
			if(actualizar){
				//$("#Acc").val("AprobacionVentaVehiculoVentaAnularEnvioFacturacion");
				$("#Acc").val("AprobacionVentaVehiculoActualizarEmitido");
				$("#FrmListado").submit();	
			}else{
				alert("Uno o mas de los elementos seleccionados no puede ser enviado, verifique sus ESTADOS.");
			}
...
function FncAprobacionVentaVehiculoActualizarAnuladoSeleccionados(){
				...
				if(actualizar){
					...
					if(actualizar2){	
						...
						if(actualizar3){	
							...
							$("#Acc").val("AprobacionVentaVehiculoActualizarAnulado");
							$("#FrmListado").submit();
...
//function FncAprobacionVentaVehiculoCargarFormulario(oForm,oAprobacionVentaVehiculoId){
//		
//	FncCargarVentana("AprobacionVentaVehiculo",oForm,oAprobacionVentaVehiculoId);
//
//}
...
function FncGenerarExcel(){
	document.getElementById("FrmListado").action = "formularios/AprobacionVentaVehiculo/acc/AccAprobacionVentaVehiculoGenerarExcel.php"
	document.getElementById("FrmListado").submit();
	document.getElementById("FrmListado").action = "#";
}