...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccAprobacionVentaVehiculoRegistrar.php');
...
<?php
if($InsCotizacionVehiculo->CveGenerarAprobacionVentaVehiculo<>"No"){
?>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	<ul class="tabs">
        <li><a href="#tab1">Aprobacion de Venta de Vehiculo</a></li>
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
            ...
            <tr>
              <td width="97%" valign="top">
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4"><span class="EstFormularioSubTitulo">Datos de la Aprobacion de Venta de Vehiculo
			  ...
			  ?>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td align="left" valign="top"><!--Estado: -->Estado: </td>
      ...
      <?php
        ...
        <input type="radio" name="CmpAprobacion" id="CmpAprobacion21" value="1" <?php echo $OpcAprobacion21;?>> 

<img src="imagenes/estado/aprobado.png" alt="Aprobado" title="Aprobado"  width="35" height="35" /> 

Aprobado


              
<input type="radio" name="CmpAprobacion" id="CmpAprobacion22" value="2" <?php echo $OpcAprobacion22;?> > 

<img src="imagenes/estado/desaprobado.png" alt="Desaprobado" title="Desaprobado"  width="35" height="35" /> 
...
Desaprobado
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4" align="left" valign="top"><input <?php echo (($InsAprobacionVentaVehiculo->AovNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpNotificar" id="CmpNotificar" />
            ...
            <tr>
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  ...
                  <tr>
                    <td width="1%">&nbsp;</td>
                    <td width="49%"><div class="EstFormularioAccion" id="CapAprobacionVentaVehiculoPropietarioAccion">Listo
                      para registrar elementos</div></td>
                    <td width="49%" align="right"><a href="javascript:FncAprobacionVentaVehiculoPropietarioListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncAprobacionVentaVehiculoPropietarioEliminarTodo();"></a></td>
			...
			?>
                  ...
                  <tr>
                    ...
                    <td align="right">&nbsp;</td>
                    <td align="right" valign="top">&nbsp;</td>
                    <td align="left" valign="top"><input name="CmpOrdenVentaVehiculoPrecio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculoPrecio" value="<?php echo number_format($InsAprobacionVentaVehiculo->OvvPrecio,2);?>" size="8" maxlength="10" readonly="readonly" /></td>
