...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsAprobacionVentaVehiculo.js" ></script>
<?php
/* 
...
//MtdObtenerAprobacionVentaVehiculos($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'AovId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oOrdenVentaVehiculo=NULL)
...
<!--<div class="EstSubMenuBoton"><a href="javascript:FncAprobacionVentaVehiculoActualizarPendienteSeleccionados();"><img src="imagenes/submenu/pendiente.png" alt="[Actualizar a Pendiente]" title="Actualizar a Pendiente" /> Pendiente</a></div>-->

<div class="EstSubMenuBoton"><a href="javascript:FncAprobacionVentaVehiculoActualizarEmitidoSeleccionados();"><img src="imagenes/submenu/realizar.png" alt="[Actualizar a Revisado]" title="Actualizar a Revisado" /> Revisado</a></div>

<div class="EstSubMenuBoton"><a href="javascript:FncAprobacionVentaVehiculoActualizarAnuladoSeleccionados();"><img src="imagenes/submenu/anular.png" alt="[Actualizar a Anulado]" title="Actualizar a Anulado" /> Anulado</a></div> 
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE APROBACIONES DE VENTA DE VEHICULOS</span>  </td>
</tr>
<tr>
  <td width="50%">
    Mostrando <b><?php echo $AprobacionVentaVehiculosTotalSeleccionado;?></b> de <b><?php echo $AprobacionVentaVehiculosTotal;?></b> registros.</td>
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "AovId"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AovId','ASC');"> Id. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AovId','DESC');"> Id. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AovId','ASC');"> Id.  </a>
                  <?php
				}
				?></th>
                <th width="4%" >
                                ...
                                <?php
				if($POST_ord == "AovFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AovFecha','ASC');"> Fecha <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AovFecha','DESC');"> Fecha <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AovFecha','ASC');"> Fecha </a>
                  <?php
				}
				?>                </th>
                <th width="3%" ><?php
				...
				?></th>
                <th width="3%" ><?php
				if($POST_ord == "AovAprobacion"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AovAprobacion','ASC');"> Aprob. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AovAprobacion','DESC');"> Aprob.<img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('AovAprobacion','ASC');"> Aprob. </a>
                  <?php
				}
				?></th>
                <th width="3%" ><?php
                ...
                <th width="3%" ><?php
				if($POST_ord == "AovEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AovEstado','ASC');">Est. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AovEstado','DESC');"> Est. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('AovEstado','ASC');"> Est.  </a>
                  <?php
				}
				?></th>
                <th width="8%" ><?php
                ...
                <th width="10%" >
                  <?php
				if($POST_ord == "AovTiempoCreacion"){
					if($POST_sen == "DESC"){
				?>
                  
                  <a href="javascript:FncOrdenar('AovTiempoCreacion','ASC');">
                 Fecha Creacion
                  <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" />				</a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AovTiempoCreacion','DESC');">
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->AovId; ?>" estado = "<?php echo $dat->AovEstado; ?>" factura_estado="<?php echo $dat->AovFacturaEstado; ?>" boleta_estado="<?php echo $dat->AovBoletaEstado; ?>" />				</td>
