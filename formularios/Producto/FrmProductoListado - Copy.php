...
$ResProducto = $InsProducto->MtdObtenerProductos("ProId,ProCodigoOriginal,ProCodigoAlternativo,ProNombre,ProId,ProUbicacion,ProReferencia,RtiNombre,ProCodigoBarra",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est,$POST_ProductoTipo,1,NULL,NULL,NULL,NULL,false,$POST_Referencia,NULL,0,$POST_ProductoCategoria,false,NULL,$POST_ProductoCalculoPrecio);
...
<tr>
  ...
  <table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0" >
    ...
    <thead class="EstTablaListadoHead">
      ...
      <tr>
        ...
        <th width="7%" >Calc. Precio Auto.</th>
  ...
  <tbody class="EstTablaListadoBody">
    ...
    <?php  
      ...
      <td width="5%" align="right" valign="middle" bgcolor="#A0DF82"   ><?php echo $dat->ProCodigoOriginal; ?></td>
