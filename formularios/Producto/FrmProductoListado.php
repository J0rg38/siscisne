...
$ResProducto = $InsProducto->MtdObtenerProductos("ProId,ProCodigoOriginal,ProCodigoAlternativo,ProNombre,ProId,ProUbicacion,ProReferencia,RtiNombre,ProCodigoBarra",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est,$POST_ProductoTipo,NULL,NULL,NULL,NULL,NULL,false,$POST_Referencia,NULL,0,$POST_ProductoCategoria,false,NULL,$POST_ProductoCalculoPrecio);
...
<div class="EstSubMenuBoton"><a href="javascript:FncActualizarActivoInactivoSeleccionados();"><img src="imagenes/submenu/activoinactivo.png" alt="[Actualizar Criticos]" title="Actualizar Activo/Inactivo seleccionados" />Act./Inact.</a></div>


<div class="EstSubMenuBoton"><a href="javascript:FncActualizarCriticoSeleccionados();"><img src="imagenes/submenu/critico.png" alt="[Actualizar Criticos]" title="Actualizar Criticos seleccionados" />Critico</a></div>
<div class="EstSubMenuBoton"><a href="javascript:FncActualizarDescontinuadoSeleccionados();"><img src="imagenes/submenu/descontinuado.png" alt="[Actualizar Criticos]" title="Actualizar Descontinuado seleccionados" />Descontinuado</a></div>

<div class="EstSubMenuBoton"><a href="javascript:FncActualizarCalculoPrecioSeleccionados();"><img src="imagenes/submenu/calculoprecio.png" alt="[Actualizar Calculo Precio Autom.]" title="Actualizar Calculo Precio Autom. seleccionados" />Calc. Autom.</a></div>
...
<input type="hidden" name="CmpCategoria" id="CmpCategoria" value="" />
 ...
 <span class="EstFormularioEtiquetaCaja">
 ...
 <span class="EstFormularioContenido">  
     <input placeholder="Ingrese una palabra para buscar" class="EstFormularioCajaBuscar" name="Fil" type="text" id="Fil" value="<?php echo $POST_fil;?>" size="18" />
      ...
      <span class="EstFormularioEtiquetaCaja">
        Referencia:
        <input class="EstFormularioCajaBuscar" name="Referencia" type="text" id="Referencia" value="<?php echo $POST_Referencia;?>" size="18" />
       </span>
...
Clasificacion:
       ...
       <select class="EstFormularioCombo" name="CmpProductoCategoria" id="CmpProductoCategoria">
       ...
       <select class="EstFormularioCombo" name="CmpProductoCalculoPrecio" id="CmpProductoCalculoPrecio">
			<option <?php if($POST_ProductoCalculoPrecio==""){ echo 'selected="selected"';}?> value="">Todos</option>
			<option <?php if($POST_ProductoCalculoPrecio=="1"){ echo 'selected="selected"';}?> value="1">Si</option>
			<option <?php if($POST_ProductoCalculoPrecio=="2"){ echo 'selected="selected"';}?> value="2">No</option>
            </select>
            </span>
      ...
      <tr>
        ...
        <th width="2%" ><?php
          ...
          <?php
				...
				?></th>
        <th width="4%" ><?php
				if($POST_ord == "PcaNombre"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('PcaNombre','ASC');"> Clasificacion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('PcaNombre','DESC');"> Clasificacion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('PcaNombre','ASC');"> Clasificacion </a>
          <?php
				}
				?></th>
        <th width="5%" ><?php
        ...
        <th width="7%" ><?php
          ...
          <?php
				...
				?></th>
        <th width="7%" ><?php
				if($POST_ord == "ProMarcaReferencia"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('ProMarcaReferencia','ASC');"> Marca Ref. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('ProMarcaReferencia','DESC');"> Marca Ref. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('ProMarcaReferencia','ASC');"> Marca Ref. </a>
          <?php
				}
				?></th>
        <th width="7%" ><?php
        ...
        <th width="14%" ><?php
				if($POST_ord == "ProUbicacion"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('ProUbicacion','ASC');"> Ubicacion <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('ProUbicacion','DESC');"> Ubicacion <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
          ...
          <?php
				...
				?></th>
        <th width="6%" >Stk. Min.</th>
        <th width="6%" >Uso</th>
        <th width="6%" ><?php
				if($POST_ord == "ProCostoIngreso"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('ProCostoIngreso','ASC');"> Costo (Ingreso) <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('ProCostoIngreso','DESC');">  Costo (Ingreso) <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
          <?php
					}
				}else{
        ...
        <th width="4%" ><?php
				if($POST_ord == "ProCosto"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('ProCosto','ASC');"> Costo (Base) <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('ProCosto','DESC');"> Costo (Base) <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
        ...
        <th width="3%" >
          ...
          <?php
				if($POST_ord == "ProValidarStock"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('ProValidarStock','ASC');">  Val. Stock <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('ProValidarStock','DESC');">  Val. Stock <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('ProValidarStock','ASC');">  Val. Stock </a>
          <?php
				}
				?>
  ...
  <tbody class="EstTablaListadoBody">
    ...
    <tr id="Fila_<?php echo $f;?>">
      ...
      <td width="2%" align="center"  >
        ...
        <input indice="<?php echo $f;?>"   onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->ProId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->ProId; ?>" />				</td>
      ...
      <td width="4%" align="right" valign="middle"   ><?php echo $dat->PcaNombre; ?></td>
      <td width="5%" align="right" valign="middle" bgcolor="#A0DF82"   >
	  <h1>
	  ...
	  if($dat->ProCritico==1){
		?>
        <img src="imagenes/estado/critico.png" alt="Critico" title="Critico" width="20" height="20" border="0" />
        <?php
	  }
	  ?>
      
      <?php
	  if($dat->ProDescontinuado==1){
		?>
        <img src="imagenes/estado/descontinuado.png" alt="Descontinuado" title="Descontinuado" width="20" height="20" border="0" />
        <?php
	  }
	  ?>
      
      
	  <?php echo $dat->ProNombre; ?></td>
      <td  width="7%" align="right" ><?php echo $dat->ProMarca; ?></td>
      <td  width="7%" align="right" ><?php echo $dat->ProMarcaReferencia; ?></td>
      <td  width="7%" align="right" >
        
        
        
        <?php
				/*if(strlen($dat->ProReferencia)>65){
				?>
                
					<?php 
                    $dat->ProReferenciaCorto = substr($dat->ProReferencia,0,65);
                    ?>
        ...
        <?php echo $dat->ProReferencia; ?></td>
      <td  width="14%" align="right" ><?php echo $dat->ProUbicacion; ?></td>
      <td  width="6%" align="left" ><h1><?php echo number_format($dat->ProStockMinimo,2); ?></h1></td>
...
?>
      ...
      <td  width="6%" align="right" ><span class="EstMonedaSimbolo"><?php echo $EmpresaMoneda;?></span><?php echo number_format($dat->ProCostoIngreso,2); ?></td>
      <td  width="4%" align="right" ><span class="EstMonedaSimbolo"><?php echo $EmpresaMoneda;?></span><?php echo number_format($dat->ProCosto,2); ?></td>
      <td width="4%" align="right" valign="middle"   ><?php echo $dat->RtiNombre; ?></td>
...
?> 
        ...
        <a target="_blank" href="subidos/producto_fotos/<?php echo $dat->ProFoto;?>" ><img src="imagenes/foto.jpg" alt="Foto" width="25" height="25" border="0" title="Foto de Referencia" /></a>
...
?>	      
      ...
      <td  width="3%" align="center" ><?php
				...
				switch($dat->ProValidarStock){
					
						case 1:
				?>
        <img width="25" height="25" alt="[Si]" title="Validar Stock" src="imagenes/estado/validar_stock_si.png" />
        <?php
						...
						case 2:
				?>
        <img width="25" height="25" alt="[No]" title="No Validar Stock" src="imagenes/estado/validar_stock_no.png" />
        <?php							
						break;	
						default:
					?>
...
?>
<a href="<?php echo $InsProyecto->MtdRutFormularios();?>Auditoria/FrmAuditoriaListado.php?Id=<?php echo $dat->ProId;?>&TipoTabla=v2&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=440&width=850&modal=true" class="thickbox"  ><img src="imagenes/auditoria.png" alt="[Auditar]" width="19" height="19" border="0" title="Auditar" /></a>
  <?php
}
?>
...
?>
		...
		if($PrivilegioEditar){
		?>
      <a href="javascript:FncProductoPrecioCalculoCargarFormulario('<?php echo $dat->ProId; ?>');">
      <img  src="imagenes/acciones/calculo.png" alt="[Calcular Precio]" width="19" height="19" border="0" title="Calcular Precio"   /> 
      </a>
...
if($PrivilegioVer){
?>
  <a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=GenerarCodigoBarra&Id=<?php echo $dat->ProId;?>"><img src="imagenes/iconos/codigo_barra.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
  <?php
}
?>
...
?>
		...
		if($PrivilegioEditar){
		?>
      <a href="javascript:FncProductoEditarCodigoOriginal('<?php echo $dat->ProId?>');" ><img src="imagenes/acciones/cambiar.png" alt="Actualizar Cod. Original" title="Actualizar Cod. Original" border="0" width="20" height="20" /></a>    
		...
		if($PrivilegioEditar){
		?>
      <a href="javascript:FncProcesarProductoListaPrecioGMSolo('<?php echo $dat->ProId?>');" ><img src="imagenes/acciones/procesar_precio.png" alt="Procesar Precio de Lista" title="Procesar Precio de Lista" border="0" width="20" height="20" /></a>    
