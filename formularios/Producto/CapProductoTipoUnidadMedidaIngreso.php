...
?>
    ...
    ?>
        ...
        ?>
          ...
          <span title="<?php echo $DatProductoTipoUnidadMedida->UmeId?>">  <?php echo $DatProductoTipoUnidadMedida->UmeNombre?> [<?php echo $DatProductoTipoUnidadMedida->UmeAbreviacion?>]</span><br />
