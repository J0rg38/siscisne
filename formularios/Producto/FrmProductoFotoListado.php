...
?>
    ...
    <td align="left" valign="top">
      ...
      <img src="subidos/producto_fotos/<?php echo $DatSesionObjeto->Parametro3;?>" width="30" height="30" alt="<?php echo $DatSesionObjeto->Parametro3;?>"  border="0"  />
      
	<a target="_blank" href="subidos/producto_fotos/<?php echo $DatSesionObjeto->Parametro3;?>">
    <?php echo $DatSesionObjeto->Parametro3;?></a>
      
      <?php
    if($_POST['Eliminar']==1){
    ?> - 
      <a href="javascript:FncProductoFotoEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $POST_Tipo;?>');" >
