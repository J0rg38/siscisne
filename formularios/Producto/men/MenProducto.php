...
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=ImportarStockMinimo"><img src="imagenes/submenu/importar.png" alt="[Listado]"  title="Ir a formulario de importar" />Imp. Stk. Min.</a></div>
<?php
}
?>
