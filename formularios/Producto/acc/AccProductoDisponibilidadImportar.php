...
<tr>
  <td align="left" valign="top">
    ...
    <input  type="checkbox" value="1" name="CmpTipo" id="CmpTipo" /> Disponibilidad Numerica
...
//								$ProductoId = "";								
//								$ProductoId = $InsProducto->MtdVerificarExisteProducto("ProCodigoOriginal",$InsProductoDisponibilidad->PdiCodigo);
//								
//								if(!empty($ProductoId)){
//									
//									$InsProducto->MtdEditarProductoDato("ProTieneDisponibilidadGM",$InsProductoDisponibilidad->PdiDisponible,$ProductoId);	
//									$InsProducto->MtdEditarProductoDato("ProDisponibilidadCantidadGM",$InsProductoDisponibilidad->PdiCantidad,$ProductoId);
//																		
//								}
//								
				?>
				...
				/*
					...
					for ($i = 1; $i <= $data->sheets[0]['numRows']; $i++) {	
						...
						$InsProductoDisponibilidad->PdiCodigo  = $data->sheets[0]['cells'][$i][1];
						$InsProductoDisponibilidad->PdiCodigo  = str_replace("'", "&#8217;", $InsProductoDisponibilidad->PdiCodigo);	
						  
						$InsProductoDisponibilidad->PdiNombre  = $data->sheets[0]['cells'][$i][2];
						$InsProductoDisponibilidad->PdiNombre  = str_replace("'", "&#8217;", $InsProductoDisponibilidad->PdiNombre);	
						  
						$InsProductoDisponibilidad->PdiDisponible  = $data->sheets[0]['cells'][$i][3];
						$InsProductoDisponibilidad->PdiDisponible  = str_replace("'", "&#8217;", $InsProductoDisponibilidad->PdiDisponible);	
