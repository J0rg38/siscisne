  ...
  <form id="FrmEditar" name="FrmEditar" method="post" action="#" enctype="multipart/form-data">
    ...
    <div class="EstCapContenido">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="961" height="25"><span class="EstFormularioTitulo">EDITAR PRODUCTO</span></td>
        </tr>
        <tr>
          <td>
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            ...
                            <td colspan="2">
                              <span class="EstFormularioSubTitulo">
                                Datos del Producto </span> <input type="hidden" name="Identificador" id="Identificador" value="<?php echo $Identificador; ?>" />
                            </td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpCodigoOriginal" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCodigoOriginal" value="<?php echo $InsProducto->ProCodigoOriginal; ?>" size="30" maxlength="45" readonly="readonly" />

                              <input value="<?php echo $InsProducto->ProCodigoOriginalAnterior; ?>" class="EstFormularioCaja" name="CmpCodigoOriginalAnterior" type="hidden" id="CmpCodigoOriginalAnterior" size="30" maxlength="45" />
                            </td>
                            <td align="left" valign="top">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input name="CmpLargo" type="text" class="EstFormularioCaja" id="CmpLargo" value="<?php echo $InsProducto->ProLargo; ?>" size="5" maxlength="10" />
                              ...
                              x
                              <input name="CmpAlto" type="text" class="EstFormularioCaja" id="CmpAlto" value="<?php echo $InsProducto->ProAlto; ?>" size="5" maxlength="10" />
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpStockMinimo" type="text" id="CmpStockMinimo" value="<?php if (empty($InsProducto->ProStockMinimo)) {
                                                                                                                                                          echo "0.00";
                                                                                                                                                        } else {
                                                                                                                                                          echo $InsProducto->ProStockMinimo;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              ...
                              <input type="radio" name="CmpCritico" id="CmpCritico1" <?php echo $critico1; ?> value="1" /> Si
                              <input type="radio" name="CmpCritico" id="CmpCritico2" <?php echo $critico2; ?> value="2" /> No
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              <?php //deb($InsProducto->ProMarcaReferencia);
                              ?>
                              <input type="hidden" name="CmpVehiculoMarca" id="CmpVehiculoMarca" value="<?php echo $InsProducto->VmaId; ?>" />
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td colspan="3" align="left" valign="top">
                              ...
                              <input type="checkbox" name="CmpValidarUso" id="CmpValidarUso" value="2" <?php echo (($InsProducto->ProValidarUso == 2) ? 'checked="checked"' : ''); ?> /> Este producto puede ser utilizado por cualquier modelo y a&ntilde;o.
                            </td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    ...
                                    <td width="50%" align="right">
                                      <div class="EstFormularioAccion" id="CapProductoFotoSolosAccion">Listo
                                  ...
                                  <tr>
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                                        ...
                                        <tr>
                                          <td colspan="2" align="left" valign="top">
                                            <div class="EstCapProductoFotoSolos" id="CapProductoFotoSolos"></div>
                                          </td>
                                          <td align="left" valign="top">&nbsp;</td>
                                        </tr>
                                      </table>
                                    ...
                                    <td>
                                      <div id="CapProductoFotoSolosResultado"> </div>
                                    </td>
                                  </tr>
                                </table>
                              ...
                              <!--<iframe src="formularios/Producto/acc/AccProductoSubirArchivo.php?Identificador=<?php echo $Identificador; ?>" id="IfrProductoSubirArchivo" name="IfrProductoSubirArchivo" scrolling="Auto"  frameborder="0" width="100%" height="300"></iframe>-->
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                              ...
                              <div class="EstFormularioArea">
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    ...
                                    <td width="50%" align="right">
                                      <div class="EstFormularioAccion" id="CapProductoFotosAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    <td width="1%">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td colspan="2">
                                      <table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                                        ...
                                        <tr>
                                          <td colspan="2" align="left" valign="top">
                                            <div class="EstCapProductoFotos" id="CapProductoFotos"></div>
                                          </td>
                                          <td align="left" valign="top">&nbsp;</td>
                                        </tr>
                                      </table>
                                    ...
                                    <td>
                                      <div id="CapProductoFotosResultado"> </div>
                                    </td>
                                  </tr>
                                </table>
                              </div>
                        ...
                        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span class="EstMonedaSimbolo"><?php echo $EmpresaMoneda; ?>
                                <input name="CmpCostoIngreso" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCostoIngreso" value="<?php if (empty($InsProducto->ProCostoIngreso)) {
                                                                                                                                                echo "0.00";
                                                                                                                                              } else {
                                                                                                                                                echo $InsProducto->ProCostoIngreso;
                                                                                                                                              } ?>" size="15" maxlength="10" readonly="readonly" />
                              </span></td>
                            <td align="left" valign="top">&nbsp;</td>
                            <td align="left" valign="top">Costo (Base):</td>
                            <td align="left" valign="top"><span class="EstMonedaSimbolo"><?php echo $EmpresaMoneda; ?>
                                <input name="CmpCosto" type="text" class="EstFormularioCajaDeshabilitada" id="CmpCosto" value="<?php if (empty($InsProducto->ProCosto)) {
                                                                                                                                  echo "0.00";
                                                                                                                                } else {
                                                                                                                                  echo $InsProducto->ProCosto;
                                                                                                                                } ?>" size="15" maxlength="10" readonly="readonly" />
                              </span></td>
                            <td>&nbsp;</td>
                          </tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="6"><span class="EstFormularioSubTitulo"> Precios</span></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span class="EstMonedaSimbolo">
                                <input name="CmpPorcentajeAdicional" type="text" class="EstFormularioCaja" id="CmpPorcentajeAdicional" value="<?php if (empty($InsProducto->ProPorcentajeAdicional)) {
                                                                                                                                                echo "0.00";
                                                                                                                                              } else {
                                                                                                                                                echo $InsProducto->ProPorcentajeAdicional;
                            ...
                            <td align="left" valign="top"><span class="EstMonedaSimbolo">
                                <input name="CmpPorcentajeDescuento" type="text" class="EstFormularioCaja" id="CmpPorcentajeDescuento" value="<?php if (empty($InsProducto->ProPorcentajeDescuento)) {
                                                                                                                                                echo "0.00";
                                                                                                                                              } else {
                                                                                                                                                echo $InsProducto->ProPorcentajeDescuento;
                                                                                                                                              } ?>" size="15" maxlength="10" />
                              </span></td>
                            <td>&nbsp;</td>
                          </tr>
                              ...
                              <div class="EstFormularioArea">
                                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                  ...
                                  <tr>
                                    ...
                                    <td>Numero:</td>
                                    <td>
                                      <div id="CapProductoCodigoReemplazoBuscar"></div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                              ...
                              <div class="EstFormularioArea">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    <td width="1%">&nbsp;</td>
                                    <td width="34%">
                                      <div class="EstFormularioAccion" id="CapProductoCodigoReemplazoAccion">Listo
                                        para registrar elementos </div>
                                    </td>
                                    <td width="62%" align="right"><a href="javascript:FncProductoCodigoReemplazoListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncProductoCodigoReemplazoEliminarTodo();"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a></td>
                                    <td width="3%">
                                      <div id="CapProductoCodigoReemplazosResultado"> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="2">
                                      <div id="CapProductoCodigoReemplazos" class="EstCapProductoCodigoReemplazos"></div>
                                    </td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
