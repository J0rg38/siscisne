       ...
       <tr>
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <input value="<?php echo $InsProducto->ProCodigoOriginalAnterior;?>"  class="EstFormularioCaja"  name="CmpCodigoOriginalAnterior" type="hidden" id="CmpCodigoOriginalAnterior" size="30" maxlength="45" /></td>
            <td align="left" valign="top">&nbsp;</td>
...
<input type="hidden" name="CmpUnidadMedidaBaseAux" id="CmpUnidadMedidaBaseAux" value="<?php echo $InsProducto->UmeId;?>"	     />			    
  ...
  <fieldset>
<div id="CapProductoTipoUnidadMedidaIngreso"></div></fieldset>   
			    </td>
			  <td align="left" valign="top">&nbsp;</td>
			  <td align="left" valign="top">
 <fieldset>	    
        ...
        <div class="EstFormularioArea">
           ...
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               ...
               <!--<iframe src="formularios/Producto/acc/AccProductoSubirArchivo.php?Identificador=<?php echo $Identificador;?>" id="IfrProductoSubirArchivo" name="IfrProductoSubirArchivo" scrolling="Auto"  frameborder="0" width="100%" height="300"></iframe>--></td>
               <td>&nbsp;</td>
             </tr>
               <tr>
                 <td>&nbsp;</td>
			...
			?>
               ...
               <tr>
                 ...
                 <td align="left" valign="top">Descuento Adicional:<br />
                   <span class="EstFormularioSubEtiqueta">(%)</span></td>
                 <td align="left" valign="top"><span class="EstMonedaSimbolo">
                   <input name="CmpPorcentajeDescuento" type="text" class="EstFormularioCaja" id="CmpPorcentajeDescuento" value="<?php if(empty($InsProducto->ProPorcentajeDescuento)){ echo "0.00";}else{ echo $InsProducto->ProPorcentajeDescuento; }?>" size="15" maxlength="10" />
                 </span></td>
                 <td>&nbsp;</td>
               </tr>
               <tr>
             ...
             <tr>
               ...
               <td><div class="EstFormularioArea" >
                 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                   <tr>
                     <td width="1%">&nbsp;</td>
                     <td width="34%"><div class="EstFormularioAccion" id="CapProductoCodigoReemplazoAccion">Listo
                       para registrar elementos </div></td>
                     ...
                     <td width="3%"><div id="CapProductoCodigoReemplazosResultado"> </div></td>
                     </tr>
                   <tr>
                     <td>&nbsp;</td>
