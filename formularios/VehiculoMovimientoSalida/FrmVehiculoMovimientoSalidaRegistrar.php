...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoMovimientoSalidaRegistrar.php');
...
<input name="CmpVehiculoUnidadMedidaEquivalente"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoUnidadMedidaEquivalente" size="3" maxlength="20"  />
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td valign="middle"><a href="javascript:FncVehiculoMovimientoSalidaDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
			...
			?>
                            ...
                            <td valign="middle"><a href="javascript:FncVehiculoMovimientoSalidaDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                            <td valign="middle">
              ...
              <td valign="top"><div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <!--<a href="javascript:FncVehiculoMovimientoSalidaDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>--></td>
