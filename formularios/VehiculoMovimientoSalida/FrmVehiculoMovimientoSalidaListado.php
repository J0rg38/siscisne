...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoSalida.js" ></script>
<?php
/* 
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoMovimientoSalida.php');
...
?>
                 <!-- <a  class="thickbox" href="subidos/vehiculo_movimiento_fotos/<?php echo $dat->VmvFoto;?>"  title="">-->  <a   href="javascript:FncVisualizarArchivo('subidos/vehiculo_movimiento_fotos/<?php echo $dat->VmvFoto;?>')">
