...
<tr>
  <td>&nbsp;</td>
  <td width="98%">B&uacute;squeda de Clientees
...
<tr>
  ...
  <!--<select name="CmpClienteCampo" id="CmpClienteCampo" class="EstFormularioCombo">
    ...
    <option value="CliNumeroDocumento">Num. Documento</option>
    </select>    <select class="EstFormularioCombo" name="CmpClienteCondicion" id="CmpClienteCondicion">
    ...
    <a href="javascript:FncClienteFiltrar2();">
...
<tr>
  <td>&nbsp;</td>
  <td><div class="EstCapClientees" id="CapClientees"></div></td>
  <td>&nbsp;</td>
</tr>
</table>
