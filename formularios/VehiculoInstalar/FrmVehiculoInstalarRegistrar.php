...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoInstalarRegistrar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div id="tab1" class="tab_content">
       ...
       <tr>
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="4">&nbsp;</td>
            <td width="118"><span class="EstFormularioSubTitulo">
          ...
          <tr>
            ...
            <td width="309" align="left" valign="top"><input name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsVehiculoInstalar->VisId;?>" size="15" maxlength="20"  readonly="readonly"/></td>
	...
	?>
          ...
          <tr>
            ...
            <td align="left" valign="top"><textarea class="EstFormularioCaja" name="CmpObservacionInterna" id="CmpObservacionInterna" cols="45" rows="4"><?php echo $InsVehiculoInstalar->VisObservacionInterna;?></textarea></td>
                 ...
                 <table width="100%" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                     <td width="98%"><table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                       <tr>
                         <td>&nbsp;</td>
                         <td colspan="12"><span class="EstFormularioSubTitulo">ACCESORIOS</span>
                       ...
                       <tr>
                         <td>&nbsp;</td>
                         <td><a href="javascript:FncVehiculoInstalarDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                         ...
                         <td><a href="javascript:FncVehiculoInstalarDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
