...
function FncImprmir(oId){
	FncPopUp('formularios/VehiculoInstalar/FrmVehiculoInstalarImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
}

function FncVistaPreliminar(oId){
	FncPopUp('formularios/VehiculoInstalar/FrmVehiculoInstalarImprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
}
