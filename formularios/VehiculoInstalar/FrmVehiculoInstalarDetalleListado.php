...
$RepVehiculoInstalarDetalle = $_SESSION['InsVehiculoInstalarDetalle'.$Identificador]->MtdObtenerSesionObjetos(true);
$ArrVehiculoInstalarDetalles = $RepVehiculoInstalarDetalle['Datos'];
...
?>
		...
		<?php
		if(empty($ArrVehiculoInstalarDetalles)){
		?>
        ...
        ?>
            ...
            //$CantidadTotal = 0;
            //$TotalItems = 0;
            foreach($ArrVehiculoInstalarDetalles as $DatSesionObjeto){
            ?>
...
<a target="_blank" href="principal.php?Mod=AlmacenStock&Form=Ver&Id=<?php echo $DatSesionObjeto->Parametro2;?>"   title=""> <img src="imagenes/almacen_stock.jpg" alt="[Stock]" width="20" height="20" border="0" align="absmiddle" title="Stock" /> </a>
  ...
  <?php	
            ...
            <a class="EstSesionObjetosItem" href="javascript:FncVehiculoInstalarDetalleEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/editar.gif" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
            ...
            if($_POST['Eliminar']==1){
            ?>
            <a href="javascript:FncVehiculoInstalarDetalleEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
            <img align="absmiddle" src="imagenes/eliminar.gif" alt="[Eliminar]" title="Eliminar" width="25" height="25" border="0" /></a>
            <?php
            }
            ?>
