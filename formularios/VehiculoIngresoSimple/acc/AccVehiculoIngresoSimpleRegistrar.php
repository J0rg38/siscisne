...
if (isset($_POST['BtnGuardar_x']) or (isset($_POST['Guardar']) && $_POST['Guardar'] == "1")) {
	...
	if ($Guardar) {
		...
		if ($InsVehiculoIngreso->MtdRegistrarVehiculoIngresoSimple()) {
			echo "bb";
...
?>
				<script type="text/javascript">
					...
					self.parent.FncVehiculoIngresoSimpleFormularioFuncion();
...
function FncNuevo()
{
	...
	$InsVehiculoIngreso->EinEstadoVehicular = "EXTERNO";
	...
	$InsVehiculoIngreso->EinOrigen = 2;
