...
if (isset($_POST['BtnGuardar_x']) or (isset($_POST['Guardar']) && $_POST['Guardar'] == "1")) {
	...
	$InsVehiculoIngreso->SucId = $_POST['CmpSucursal'];
	...
	$InsVehiculoIngreso->EinColorInterior = $_POST['CmpColorInterior'];
	...
	$InsVehiculoIngreso->VehCodigoIdentificador = $_POST['CmpVehiculoCodigoIdentificador'];
	...
	if (!empty($ArrVehiculoIngresoClientes)) {
		...
		foreach ($ArrVehiculoIngresoClientes as $DatSesionObjeto) {
			...
			$InsVehiculoIngresoCliente1 = new ClsVehiculoIngresoCliente($InsMysql);
	...
	if (!empty($ArrSesionObjetos)) {
		foreach ($ArrSesionObjetos as $DatSesionObjeto) {
			...
			$InsVehiculoIngresoFoto1 = new ClsVehiculoIngresoFoto($InsMysql);
	...
	if ($InsVehiculoIngreso->MtdEditarVehiculoIngresoSimple()) {
...
<?php
		...
		if ($InsVehiculoIngreso->VehiculoProformaMonId <> $EmpresaMonedaId and !empty($InsVehiculoIngreso->VehiculoProformaMonId)) {

			$InsVehiculoIngreso->VpdCosto = round($InsVehiculoIngreso->VpdCosto / $InsVehiculoIngreso->VprTipoCambio, 3);
		}

		if ($InsVehiculoIngreso->MonId <> $EmpresaMonedaId and !empty($InsVehiculoIngreso->MonId)) {
...
function FncCargarDatos()
{
	...
	$InsVehiculoIngreso->SucId = $_SESSION['SesionSucursal'];
	...
	if (!empty($InsVehiculoIngreso->VehiculoIngresoCliente)) {
		foreach ($InsVehiculoIngreso->VehiculoIngresoCliente as $DatVehiculoIngresoCliente) {
			...
			$_SESSION['InsVehiculoIngresoCliente' . $Identificador]->MtdAgregarSesionObjeto(
				1,
	...
	if (!empty($InsVehiculoIngreso->VehiculoIngresoFoto)) {
		foreach ($InsVehiculoIngreso->VehiculoIngresoFoto as $DatVehiculoIngresoFoto) {
			...
			$_SESSION['InsVehiculoIngresoFoto' . $Identificador]->MtdAgregarSesionObjeto(
				1,
