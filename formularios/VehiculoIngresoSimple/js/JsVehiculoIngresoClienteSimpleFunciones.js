...
function FncVehiculoIngresoClienteNuevo(){
	...
	$('#CmpVehiculoIngresoClienteAccion').val("AccVehiculoIngresoSimpleClienteRegistrar.php");
...
*/
	...
	$('#CmpVehiculoIngresoClienteAccion').val("AccVehiculoIngresoSimpleClienteEditar.php");

	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/VehiculoIngreso/acc/AccVehiculoIngresoSimpleClienteEscoger.php',
		data: 'Identificador='+Identificador+
'&Item='+oItem,
...
function FncVehiculoIngresoClienteEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/VehiculoIngreso/acc/AccVehiculoIngresoSimpleClienteEliminar.php',
			data: 'Identificador='+Identificador+
'&Item='+oItem,
			success: function(){
...
function FncVehiculoIngresoClienteEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/VehiculoIngreso/acc/AccVehiculoIngresoSimpleClienteEliminarTodo.php',
			data: 'Identificador='+Identificador,
			success: function(){
				$('#CapVehiculoIngresoClienteAccion').html('Eliminado');	
				FncVehiculoIngresoClienteListar();
