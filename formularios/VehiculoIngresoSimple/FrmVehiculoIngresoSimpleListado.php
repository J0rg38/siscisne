...
<?php $PrivilegioEditar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoIngreso","Editar"))?true:false;?>
<?php $PrivilegioEliminar = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoIngreso","Eliminar"))?true:false;?>
<?php $PrivilegioGenerarExcel = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"VehiculoIngreso","GenerarExcel"))?true:false;?>
...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoIngresoSimple.js" ></script>
...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoIngresoSimple.php');
//DATOS
...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos("ein.EinId,ein.EinVIN,VmaNombre,VmoNombre,VveNombre,EinAnoFabricacion,EinNumeroMotor,EinPlaca,EinPoliza,EinComprobanteCompraNumero",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est,NULL,NULL,"EXTERNO",$POST_VehiculoMarcaId,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma,"EinFechaRecepcion",NULL,NULL,$POST_Sucursal);
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE INGRESO DE VEHICULOS EXTERNOS</span></td>
</tr>
<tr>
  <td>
...
?>  
      ...
      <td  width="4%" align="right" ><h2><?php echo $dat->EinPlaca; ?></h2></td>
