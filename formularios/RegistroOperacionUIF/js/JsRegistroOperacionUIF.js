...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/RegistroOperacionUIF/acc/AccRegistroOperacionUIFGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/RegistroOperacionUIF/acc/AccRegistroOperacionUIFGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	...
	document.getElementById("FrmListado").action = "formularios/RegistroOperacionUIF/FrmRegistroOperacionUIFListadoImprimir.php"
...
//
//			if(actualizar){
//				$("#Acc").val("EnviarRegistroOperacionUIFContabilidad");
//				$("#FrmListado").submit();	
//			}else{
		...
		if(confirm("¿Realmente desea GENERAR la ORDEN DE COMPRA con los elementos seleccionados?")){
			...
			if(actualizar){
				...
				if(actualizar2){
					...
					$("#FrmListado").attr("action","principal.php?Mod=OrdenCompra&Form=Registrar&Ori=RegistroOperacionUIF");
					$("#FrmListado").submit();	
