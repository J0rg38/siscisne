...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod.'C');?>JsOrdenVentaVehiculoConfirmarEntregaFunciones.js" ></script>
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod.'C');?>JsOrdenVentaVehiculoFotoActaEntregaFunciones.js" ></script>
                          ...
                          <tr>
                            <td width="398" align="left"><div class="EstFormularioArea" >
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                <tr>
                                  <td>&nbsp;</td>
                                  <td colspan="2" align="left" valign="top"><span class="EstFormularioSubTitulo">Datos de la Orden
                                ...
                                <tr>
                                  ...
                                  <span class="EstFormularioSubEtiqueta">(dd/mm/yyyy)</span></td>
                                  <td align="left" valign="top"><input name="CmpFechaEntrega" type="text" class="EstFormularioCajaFecha" id="CmpFechaEntrega" value="<?php  echo $InsOrdenVentaVehiculo->OvvActaEntregaFecha;?>" size="15" maxlength="10" />
        ...
        <p>Some extra select boxes to show to it works under IE.<br/>
            ...
            --></td>
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top"><textarea name="CmpObservacion" cols="35" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsOrdenVentaVehiculo->OvvActaEntregaDescripcion;?></textarea></td>
                                  <td align="left" valign="top">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="2" align="left" valign="top"><div class="EstFormularioArea" >
                                    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                      <tr>
                                        <td width="2%">&nbsp;</td>
                                        <td width="94%"><a href="javascript:FncOrdenVentaVehiculoFotoActaEntregaListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncOrdenVentaVehiculoFotoActaEntregaEliminarTodo();"></a></td>
                                        <td width="4%">&nbsp;</td>
                                      </tr>
                                      <tr>
                                        <td>&nbsp;</td>
                                        <td><div class="EstFormularioAccion" id="CapOrdenVentaVehiculoFotoActaEntregasAccion">Listo
                                      ...
                                      <tr>
                                        ...
                                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                                          <tr>
                                            <td colspan="2" align="left" valign="top"><div id="fileUploadOrdenVentaVehiculoFotoActaEntrega">Escoger Archivo</div>
                                            <script type="text/javascript">
									...
									$(document).ready(function(){
											...
											url:"formularios/OrdenVentaVehiculoC/acc/AccOrdenVentaVehiculoFotoActaEntregaSubir.php",
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td colspan="2" align="left" valign="top"><input <?php echo (($InsOrdenVentaVehiculo->OvvNotificar==1)?'checked="checked"':'');?> value="1"  type="checkbox" name="CmpNotificar" id="CmpNotificar" />
