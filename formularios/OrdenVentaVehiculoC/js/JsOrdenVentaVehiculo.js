...
function FncOrdenCobroCargarFormulario(oForm,oVentaDirectaId){
	...
	///tb_show(this.title,'principalC.php?Mod=PagoOrdenVentaVehiculo&Form=OrdenCobro'+oForm+'&Dia=1&OvvId='+oVentaDirectaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
	//FncCargarVentanaFullv3('principal2C','PagoOrdenVentaVehiculo','OrdenCobro'+oForm,'OvvId='+oVentaDirectaId);
	FncPopUp('principal2C.php?Mod=PagoOrdenVentaVehiculo&Form=OrdenCobro'+oForm+'&Dia=1&OvvId='+oVentaDirectaId,0,0,1,0,0,1,0,screen.height,screen.width);
	
}

function FncAbonoCargarFormulario(oForm,oVentaDirectaId){
	
	//FncCargarVentanaFullv3(oRaiz,oMod,oForm,oVariables)
	
	//FncCargarVentanaFullv3('principal2C','PagoOrdenVentaVehiculo','Abono'+oForm,'OvvId='+oVentaDirectaId);
	
	FncPopUp('principal2C.php?Mod=PagoOrdenVentaVehiculo&Form=Abono'+oForm+'&Dia=1&OvvId='+oVentaDirectaId,0,0,1,0,0,1,0,screen.height,screen.width);
		//tb_show(this.title,'principalC.php?Mod=PagoOrdenVentaVehiculo&Form=Abono'+oForm+'&Dia=1&OvvId='+oVentaDirectaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height='+screen.height+'&width='+screen.width+'&modal=true',this.rel);	
	
///	FncPopUp('principalC.php?Mod=PagoOrdenVentaVehiculo&Form=Abono'+oForm+'&Dia=1&OvvId='+oVentaDirectaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',0,0,1,0,0,1,0,screen.height,screen.width);
	
}

function FncCreditoCargarFormulario(oForm,oVentaDirectaId){
	//tb_show(this.title,'principalC.php?Mod=PagoOrdenVentaVehiculo&Form=Credito'+oForm+'&Dia=1&OvvId='+oVentaDirectaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
	//FncCargarVentanaFullv3('principal2C','PagoOrdenVentaVehiculo','Credito'+oForm,'OvvId='+oVentaDirectaId);
	FncPopUp('principal2C.php?Mod=PagoOrdenVentaVehiculo&Form=Credito'+oForm+'&Dia=1&OvvId='+oVentaDirectaId,0,0,1,0,0,1,0,screen.height,screen.width);
	
}

function FncPagoOrdenVentaVehiculoCargarFormulario(oForm,oVentaDirectaId){
	//tb_show(this.title,'principalC.php?Mod=PagoOrdenVentaVehiculo&Form='+oForm+'&Dia=1&OvvId='+oVentaDirectaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=620&width=890&modal=true',this.rel);		
	//FncCargarVentanaFullv3('principal2C','PagoOrdenVentaVehiculo',''+oForm,'OvvId='+oVentaDirectaId);
	FncPopUp('principal2C.php?Mod=PagoOrdenVentaVehiculo&Form='+oForm+'&Dia=1&OvvId='+oVentaDirectaId,0,0,1,0,0,1,0,screen.height,screen.width);
	...
	if(Tipo !== null){
		...
		switch(Tipo.toUpperCase()){
			...
			case "1":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
	
			break;
			
			case "2":
			
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirCR.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
			...
			/*	var Tipo = prompt("Escoja el tipo de vista preliminar \n 1 = DJ Con membrete\n  2 = DJ sin Membrete  ", "2");
				...
				if(Tipo !== null){
					...
					switch(Tipo.toUpperCase()){
						case "1":
							...
							FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirDJ.php?M=1&Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
				
						break;
						
						case "2":
				
							FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirCC.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
				...
				//FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirDJ.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
			...
			case "3":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirCC.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
			...
			case "4":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirAE.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
			...
			case "5":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirMP1.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
	
			break;
			
				case "6":
	
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirMP2.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
			...
			break;
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/acc/AccOrdenVentaVehiculoGenerarExcelFI1.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
	
			break;
			
				case "8":
	
				FncPopUp('formularios/OrdenVentaVehiculoC/acc/AccOrdenVentaVehiculoGenerarExcelFI2.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
	...
	if(Tipo !== null){
		switch(Tipo.toUpperCase()){
			case "1":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirOV.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
	
			break;
			
			case "2":
			
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirCR.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
			...
			case "4":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirAE.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
...
* FORMULARIOS
*/
function FncEncuestaCargarFormulario(oForm,oEncuestaId,oOrdenVentaVehiculoId){//tb_show(this.title,'principalC.php?Mod=Garantia&Form=SeguimientoCliente&Dia=1&Id='+oGarantiaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&modal=true',this.rel);	
...
function FncEntregaVentaVehiculoCargarFormulario(oMod,oForm,oOrdenVentaVehiculoId){
	...
	//FncCargarVentanaFullv3('principal2C',oMod,oForm,'OvvId='+oOrdenVentaVehiculoId+'&Origen=OrdenVentaVehiculo');
	FncPopUp('principal2C.php?Mod='+oMod+'&Form='+oForm+'&Dia=1&OvvId='+oOrdenVentaVehiculoId,0,0,1,0,0,1,0,screen.height,screen.width);
	
}

function FncClienteCargarFormulario(oForm,oClienteId){

	FncCargarVentanaFullv2("Avanzado","principalC.php?Mod=Cliente&Form="+oForm,"true","true","savedValues","","Dia=1&Id="+oClienteId);
...
function FncOrdenVentaVehiculoSolicitarAprobacionVIN(oId){
	...
	if(oId==""){
		...
		FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoSolicitarAprobacionVIN.php?Id='+oId,0,0,1,0,0,1,0,350,150);						
...
function FncOrdenVentaVehiculoSolicitarVIN(oId,oVIN,oLineaCreditoActiva){
	...
	if(oVIN == ""){
		...
		window.location = "principalC.php?Mod=OrdenVentaVehiculo&Form=SolicitarVIN&Id="+oId;	
