...
function FncClienteCargarFormulario(oForm,oClienteId){
	...
	FncCargarVentanaFullv2("Avanzado","principal2C.php?Mod=Cliente&Form="+oForm,"true","true","savedValues","","Dia=1&Id="+oClienteId);
	...
	if(Tipo !== null){
		switch(Tipo.toUpperCase()){
				...
				if(Tipo !== null){
					...
					switch(Tipo.toUpperCase()){
						case "1":
							...
							FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirDJ.php?M=1&Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
	
						break;
						
						case "2":
				
							FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirDJ.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
			...
			case "3":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirPM.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
	
			break;
			
				case "4":
	
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirROP.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
			...
			case "6":
				...
				FncPopUp('formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoImprimirRDP.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
...
* FORMULARIOS
*/
function FncEncuestaCargarFormulario(oForm,oEncuestaId,oOrdenVentaVehiculoId){//tb_show(this.title,'principal2C.php?Mod=Garantia&Form=SeguimientoCliente&Dia=1&Id='+oGarantiaId+'&placeValuesBeforeTB_=savedValues&TB_iframe=true&modal=true',this.rel);	
