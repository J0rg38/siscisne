...
function FncOrdenVentaVehiculoLlamadaListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/OrdenVentaVehiculoC/FrmOrdenVentaVehiculoLlamadaListado.php',
...
function FncOrdenVentaVehiculoLlamadaEscoger(oItem){
	...
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/OrdenVentaVehiculoC/acc/AccOrdenVentaVehiculoLlamadaEscoger.php',
...
function FncOrdenVentaVehiculoLlamadaEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/OrdenVentaVehiculoC/acc/AccOrdenVentaVehiculoLlamadaEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem,
			success: function(){
...
function FncOrdenVentaVehiculoLlamadaEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/OrdenVentaVehiculoC/acc/AccOrdenVentaVehiculoLlamadaEliminarTodo.php',
