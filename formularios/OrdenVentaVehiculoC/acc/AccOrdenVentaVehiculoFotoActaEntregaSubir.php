...
$targetFolder = '../../../subidos/orden_venta_vehiculo_fotos';// Relative to the root
...
if (!empty($_FILES)) {
	...
	if (in_array(strtolower($fileParts['extension']),$fileTypes)) {
		...
		if(move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesOvvFotoActaEntrega'.$Identificador] = $FotoIdentificador.$_FILES['Filedata']['name'];
