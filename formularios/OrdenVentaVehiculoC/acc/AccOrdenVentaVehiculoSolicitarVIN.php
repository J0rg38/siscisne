...
list($InsOrdenVentaVehiculo->OvvAno,$InsOrdenVentaVehiculo->OvvMes,$aux) = explode("-",$InsOrdenVentaVehiculo->OvvFecha);
	$InsOrdenVentaVehiculo->OvvObservacion = addslashes($_POST['CmpObservacion']);
		$InsOrdenVentaVehiculo->OvvObservacionCorreo = addslashes($_POST['CmpObservacionCorreo']);
	...
	if($Guardar){
		...
		if(!empty($InsOrdenVentaVehiculo->OvvDestinatarios)){
				...
				if($InsOrdenVentaVehiculo->MtdGenerarExcelOrdenVentaVehiculoSolicitarVIN($InsOrdenVentaVehiculo->OvvId,'')){
					
					// MtdEnviarCorreoSolicitarAutorizacionOrdenVentaVehiculo($oOrdenCompra,$oDestinatario,$oRemitente,$oAdjunto=array()){
					if($InsOrdenVentaVehiculo->MtdEnviarCorreoSolicitarVINOrdenVentaVehiculo($InsOrdenVentaVehiculo->OvvId,$InsOrdenVentaVehiculo->OvvDestinatarios,$_SESSION['SesionNombre'],array("generados/orden_venta_vehiculo/".$InsOrdenVentaVehiculo->OvvId.".xls"))){
					//if($InsOrdenVentaVehiculo->MtdEnviarCorreoSolicitarVINOrdenVentaVehiculo($InsOrdenVentaVehiculo->OvvId,$InsOrdenVentaVehiculo->OvvDestinatarios,$_SESSION['SesionNombre'],NULL)){
