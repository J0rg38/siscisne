...
<tr>
    ...
    <tr>
      <td height="93" align="left" valign="top">&nbsp;</td>
...
<?php //echo $InsOrdenVentaVehiculo->OvvFecha;?>
  ...
  <td height="150" align="center" valign="bottom">
    ...
    <?php echo strtoupper($EmpresaRepresentanteNombre);?><br />
    <?php echo strtoupper($EmpresaRepresentanteNumeroDocumento);?>
          </span>    
