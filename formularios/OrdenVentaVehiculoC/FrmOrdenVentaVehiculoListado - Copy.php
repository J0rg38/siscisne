...
<tr>
  <td width="50%">Mostrando <b><?php echo $OrdenVentaVehiculosTotalSeleccionado;?></b> de <b><?php echo $OrdenVentaVehiculosTotal;?></b> registros.</td>
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				if($POST_ord == "OvvActaEntregaFecha"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OvvActaEntregaFecha','ASC');"> Entrega <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OvvActaEntregaFecha','DESC');"> Entrega. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('OvvActaEntregaFecha','ASC');"> Entrega </a>
                <?php
				}
				?></th>
                <th width="5%" >
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<a href="principalC.php?Mod=<?php echo $GET_mod;?>&Form=Ver&Id=<?php echo $dat->OvvId;?>">
				<?php echo $dat->OvvId;  ?>
                </a>
