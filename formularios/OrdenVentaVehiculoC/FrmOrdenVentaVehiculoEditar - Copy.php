         ...
         <td valign="top"><div class="EstFormularioArea">
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
			...
			?>
               ...
               <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpVehiculoMotor" type="text" id="CmpVehiculoMotor" value="<?php echo ($InsOrdenVentaVehiculo->OvvMotor);?>" size="8" maxlength="30" /></td>
