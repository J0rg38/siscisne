              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="center" valign="middle"  bgcolor="<?php echo $Color;?>"  >
                  <table width="100%">
                    <tr>
                      <td width="14%">Id:</td>
                      <td width="86%"><?php echo $dat->OvvId;  ?></td>
                    </tr>
                    <tr>
                      <td>Fecha:</td>
                      <td><?php echo $dat->OvvFecha;  ?></td>
                    </tr>
                    <tr>
                      <td>Num. Doc.</td>
                      <td><?php echo ($dat->CliNumeroDocumento);?></td>
                    </tr>
                    <tr>
                      <td>Cliente</td>
                      <td>
...
//deb( $ArrOrdenVentaVehiculoPropietarios);
  ...
  <?php		 
				 ...
				 ?></td>
                    ...
                    <tr>
                      <td>Vehiculo:</td>
                      <td><b>Marca:</b> <?php echo ($dat->VmaNombre);?><br />
                        <b>Modelo:</b> <?php echo ($dat->VmoNombre);?><br />
                      <b>Version:</b> <?php echo ($dat->VveNombre);?></td>
                    </tr>
                    <tr>
                      <td>Num. Motor:</td>
                      <td><?php echo ($dat->EinNumeroMotor);?></td>
                    </tr>
                    <tr>
                      <td>Color</td>
                      <td><?php echo ($dat->OvvColor);?></td>
                    </tr>
                    <tr>
                      <td>Proforma:</td>
                      <td><?php echo ($dat->CveId);?></td>
                    </tr>
                    <tr>
                      <td>Comprob.</td>
                      <td><?php
  ...
  <?php	
				...
				?></td>
                    ...
                    <tr>
                      <td>Entrega:</td>
                      <td><?php echo $dat->OvvActaEntregaFecha;  ?></td>
                    </tr>
                    <tr>
                      <td>Num. Comprob. </td>
                      <td><?php
...
<?php
				...
				?></td>
                    ...
                    <tr>
                      ...
                      <td><?php echo $dat->PerNombre;?> <?php echo $dat->PerApellidoPaterno;?> <?php echo $dat->PerApellidoMaterno;?></td>
                    </tr>
                    <tr>
                      <td>Fecha Creacion:</td>
                      <td><?php echo ($dat->OvvTiempoCreacion);?></td>
                    </tr>
                    <tr>
                      <td>Acciones:</td>
                      <td>
