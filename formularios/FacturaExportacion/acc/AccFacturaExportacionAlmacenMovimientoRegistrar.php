...
if (!$ResSesionObjeto['Existe']) {
	...
	$_SESSION['InsFacturaExportacionAlmacenMovimiento' . $Identificador]->MtdAgregarSesionObjeto(
		1,
		NULL,
	...
	foreach ($ArrAlmacenMovimientoSalidaDetalles  as $DatAlmacenMovimientoSalidaDetalle) {
		...
		$_SESSION['InsFacturaExportacionDetalle' . $Identificador]->MtdAgregarSesionObjeto(
			1,
			NULL,
