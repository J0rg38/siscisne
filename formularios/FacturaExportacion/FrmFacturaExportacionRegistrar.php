...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccFacturaExportacionRegistrar.php');
...
*/	
	...
	<?php
	if(!empty($_SESSION['SisFetId']) and empty($POST_id) or !empty($POST_do)){ 
	?>
		FncGenerarFacturaExportacionId('<?php echo $_SESSION['SisFetId'];?>');
	<?php
	}
	?>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo"> REGISTRAR FACTURA DE EXPORTACION</span></td>
      </tr>
      <tr>
        <td>		
...
<div class="tab_container">
    <div id="tab1" class="tab_content">
       ...
       <tr>
         <td width="1099" colspan="2" valign="top"><div class="EstFormularioArea" >
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td>&nbsp;</td>
            <td colspan="6">
              <span class="EstFormularioSubTitulo">
                Datos de la factura</span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <td colspan="3" align="center" valign="bottom">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <span id="spryselect1"><span class="selectRequiredMsg"><img src="imagenes/advertencia.png" width="20" height="20" border="0" align="absmiddle" title="Debe seleccionar un elemento" alt="[A]"  /></span>
                      <label>
                        <select  onchange="FncGenerarFacturaExportacionId(this.value);" class="EstFormularioCombo" name="CmpTalonario" id="CmpTalonario">
                          <option value="">-</option>
                          <?php
			  ...
			  ?>
				  ...
				  <?php if(!empty($InsFacturaExportacion->FetId)){ if($InsFacturaExportacion->FetId==$DatFacturaExportacionTalonario->FetId){ echo 'selected="selected"';}}elseif($_SESSION['SisFetId']==$DatFacturaExportacionTalonario->FetId){ 	echo 'selected="selected"';}?> value="<?php echo $DatFacturaExportacionTalonario->FetId;?>" ><?php echo $DatFacturaExportacionTalonario->FetNumero;?></option>
                          <?php
			  }
			  ?>
                          </select>
                  ...
                  <td>
                    ...
                    Nº<span id="sprytextfield3">
                      <label>
                        <input tabindex="1" class="EstFormularioCaja" name="CmpId" type="text" id="CmpId" value="<?php echo $InsFacturaExportacion->FexId;?>" size="20" maxlength="20"  />
                        </label>
                  ...
                  <td>
                    ...
                    <a href="javascript:FncGenerarFacturaExportacionId(document.getElementById('CmpTalonario').value);"><img border="0" src="imagenes/recargar.jpg" alt="[Recargar]" title="Recargar" width="18" height="18" align="absmiddle"  /></a>
                    
                    </td>
                  <td>
                    <div id="CapFacturaExportacion"></div>
                    </td>
                  </tr>
                </table>
          ...
          <tr>
            ...
            <td align="left" valign="top">Se&ntilde;ores:
              <input type="hidden" name="CmpClienteId" id="CmpClienteId" value="<?php echo $InsFacturaExportacion->CliId;?>" /></td>
			...
			?>
                  ...
                  <td>
                    <input tabindex="3" class="EstFormularioCaja" name="CmpClienteNumeroDocumento" type="text" id="CmpClienteNumeroDocumento" size="20" maxlength="50" value="<?php echo $InsFacturaExportacion->CliNumeroDocumento;?>" <?php echo !empty($InsFacturaExportacion->CliId)?'readonly="readonly"':'';?>   />
                    </td>
                  <td>
          ...
          <tr>
            ...
            <td colspan="2" align="left" valign="top"><textarea tabindex="7" name="CmpObservacionImpresa" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacionImpresa"><?php echo $InsFacturaExportacion->FexObservacionImpresa;?></textarea></td>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <label>
              <input  name="CmpPorcentajeImpuestoVenta" type="text" class="EstFormularioCaja" id="CmpPorcentajeImpuestoVenta" value="<?php if(empty($InsFacturaExportacion->FexPorcentajeImpuestoVenta)){ echo $EmpresaImpuestoVenta; }else{echo $InsFacturaExportacion->FexPorcentajeImpuestoVenta;}?>" size="10" maxlength="10" />
            </label>
            <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
			  ...
			  ?>
              <option value="<?php echo $DatMoneda->MonId?>" <?php if($InsFacturaExportacion->MonId==$DatMoneda->MonId){ echo 'selected="selected"';}elseif($EmpresaMonedaId==$DatMoneda->MonId){  echo 'selected="selected"';}?> ><?php echo $DatMoneda->MonNombre?> ( <?php echo $DatMoneda->MonSimbolo;?>)</option>
              <?php
			  }
			  ?>
            </select>
            ...
            <input  class="EstFormularioCajaDeshabilitada" name="CmpTipoCambio" type="text" id="CmpTipoCambio" value="<?php if (empty($InsFacturaExportacion->FexTipoCambio)){ echo "";}else{ echo $InsFacturaExportacion->FexTipoCambio; } ?>" size="10" maxlength="10" onchange="FncFacturaExportacionDetalleListar();" />
            </span>
            </td>
            <td>
           ...
           <div class="EstFormularioArea"> 
             ...
             <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
               ...
               <tr>
                 ...
                 <td><input tabindex="11" class="EstFormularioCaja" name="CmpFacturaExportacionDetalleImporte" type="text" id="CmpFacturaExportacionDetalleImporte" size="10" maxlength="10"   /></td>
       ...
       <tr>
         <td colspan="2" valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td width="1%">&nbsp;</td>
               <td width="49%"><div class="EstFormularioAccion" id="CapFacturaExportacionDetalleAccion">Listo
