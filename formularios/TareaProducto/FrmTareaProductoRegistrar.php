...
/*
"PlanMantenimientoId="+oPlanMantenimientoId+"&PlanMantenimientoTareaId="+oPlanMantenimientoTareaId+"&PlanMantenimientoDetalleKilometraje="+oPlanMantenimientoDetalleKilometraje+"&Id="+oPlanMantenimientoDetalleId
*/
...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccTareaProductoRegistrar.php');
        ...
        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            ...
            <td>Codigo Original:
              ...
              <input name="CmpPlanMantenimientoTareaId" type="hidden" class="EstFormularioCaja" id="CmpPlanMantenimientoTareaId" value="<?php echo $InsTareaProducto->PmtId;?>" size="15" maxlength="20"  readonly="readonly"/> 
