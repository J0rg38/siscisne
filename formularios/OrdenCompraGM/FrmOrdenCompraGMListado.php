...
<?php //$PrivilegioRegistrarEntradaAlmacen = ($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"AlmacenMovimientoEntrada","Registrar"))?true:false;?>

<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsOrdenCompraGM.js" ></script>
<?php
/* 
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCompraGM.php');

//MtdObtenerOrdenCompras($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'OcoId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL)

$ResOrdenCompra = $InsOrdenCompra->MtdObtenerOrdenCompras($POST_cam,$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_estado,"ZGAR,ZVOR,YRUSH,ZTOOL,STK");
...
if($PrivilegioEditar){
?>
	<div class="EstSubMenuBoton"><a href="javascript:FncMarcarEnviadoSeleccionados();"><img src="imagenes/iconos/marcar_enviado.png" alt="[Marcar como Enviado]" title="Marcar como Enviado" /> Enviar</a></div>
<?php
}
?>
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE ORDEN DE COMPRAS GM</span>  </td>
</tr>
<tr>
  <td width="47%">
...
<table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0" >
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?></th>
                <th width="13%" ><?php
				if($POST_ord == "OcoCodigoDealer"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OcoCodigoDealer','ASC');"> Cod. Dealer <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OcoCodigoDealer','DESC');"> Cod. Dealer <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /></a>
                  <?php
					}
				}else{

				?>
                  <a href="javascript:FncOrdenar('OcoCodigoDealer','ASC');"> Cod. Dealer </a>
                <?php
				}
				?></th>
                <th width="9%" >
				...
				if($POST_ord == "OcoEstado"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('OcoEstado','ASC');">Est. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" /> </a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('OcoEstado','DESC');"> Est. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15" /> </a>
                  <?php
					}
				}else{
 ...
 <tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
				...
				<input   onclick="javascript:FncAgregarSeleccionado(this.value);" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->OcoId; ?>" total_pedidos = "<?php echo $dat->OcoTotalPedidos;?>" estado = "<?php  echo $dat->OcoEstado?>" />				
                </td>

                <td align="right" valign="middle" width="14%"   ><?php echo $dat->OcoId;  ?></td>
                <td  width="4%" align="right" ><?php echo $dat->OcoTipo;  ?></td>
                <td  width="13%" align="right" ><?php echo $dat->OcoCodigoDealer;  ?></td>
                <td  width="9%" align="right" ><?php echo $dat->OcoFecha;  ?></td>
                <td  width="7%" align="right" ><?php echo $dat->OcoHora;  ?></td>
                <td  width="10%" align="right" ><?php echo $dat->MonSimbolo;  ?></td>
                <td  width="7%" align="right" ><?php echo $dat->OcoTipoCambio;  ?></td>
                <td  width="6%" align="right" >
                  
                  <?php 
				  echo $dat->OcoEstadoDescripcion;
				  ?>
                  <?php
			/*	switch($dat->OcoEstado){
				...
				?>
                  ...
                  <?php
						...
						case 3:
				?>
                  <img width="15" height="15" alt="[Enviado]" title="Enviado" src="imagenes/realizado.gif" />
                  <?php							
						break;	
                ...
                <td  width="8%" align="right" ><?php echo ($dat->OcoTiempoModificacion);?></td>
        <td  width="12%" align="center" >


<?php
if($PrivilegioEliminar and ($dat->OcoEstado ==1 or $dat->OcoEstado == 3  )){
?>
...
<?php
if($PrivilegioEditar and ($dat->OcoEstado ==1 or $dat->OcoEstado == 3  )){
?>             
...
?>
	<a href="javascript:FncPopUp('formularios/OrdenCompraGM/FrmOrdenCompraGMImprimir.php?Id=<?php echo $dat->OcoId;?>',0,0,1,0,0,1,0,screen.height,screen.width);"><img src="imagenes/acciones/preliminar.gif" alt="[Vista Preliminar]" title="Vista preliminar" width="19" height="19" border="0" /></a>
<?php
}
?>
...
?>        
	<a href="javascript:FncPopUp('formularios/OrdenCompraGM/FrmOrdenCompraGMImprimir.php?Id=<?php echo $dat->OcoId;?>&P=1',0,0,1,0,1,1,0,screen.height,screen.width);"><img src="imagenes/acciones/imprimir.png" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
<?php
}
?> 

<?php
if($PrivilegioGenerarExcel and $dat->OcoEstado == 3){
?>        
	<a href="javascript:FncPopUp('formularios/OrdenCompraGM/FrmOrdenCompraGMGenerarExcel.php?Id=<?php echo $dat->OcoId;?>&P=2',0,0,1,0,1,1,0,screen.height,screen.width);"><img src="imagenes/excel.png" alt="[Generar Excel]" title="Generar Excel" width="19" height="19" border="0" /></a>
<?php
}
?> 
...
<?php
/*if($PrivilegioRegistrarEntradaAlmacen and $dat->OcoEstado == 3){
?>        
<a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Entrar&Id=<?php echo $dat->OcoId;?>"><img src="imagenes/recepcionar.gif" width="19" height="19" border="0" title="Recepcionar" alt="[Ver]"   /></a>                
<?php
}*/
?> 
