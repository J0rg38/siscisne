...
function FncOrdenCompraPedidoListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/OrdenCompraGM/FrmOrdenCompraGMPedidoListado.php',
		data: 'Identificador='+Identificador+'&Editar='+OrdenCompraPedidoEditar+'&Eliminar='+OrdenCompraPedidoEliminar+'&MonedaId='+MonedaId+'&MonedaSimbolo='+MonedaSimbolo+'&TipoCambio='+TipoCambio,
