...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER ORDEN DE COMPRA GM</span></td>
      </tr>
      <tr>
        <td colspan="2">
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea">
          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
		    <tr>
		      <td>&nbsp;</td>
		      <td colspan="4"><span class="EstFormularioSubTitulo">Datos de la Orden de Compra GM
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top">
		        <table border="0" cellpadding="0" cellspacing="0">
		          <tr>
		            <td>
		              <select class="EstFormularioCombo" name="CmpMonedaIdAux" id="CmpMonedaIdAux">
		                <option value="">Escoja una opcion</option>
		                <?php
		      ...
		      <td align="left" valign="top"><input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncAlmacenMovimientoEntradaDetalleListar();" value="<?php if (empty($InsOrdenCompra->AmoTipoCambio)){ echo "";}else{ echo $InsOrdenCompra->AmoTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
		    ...
		    <tr>
		      ...
		      <td colspan="5" align="left" valign="top"><textarea name="CmpObservacion" cols="60" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsOrdenCompra->OcoObservacion;?></textarea></td>
		      <td>&nbsp;</td>
		      </tr>
		    <tr>
		      <td>&nbsp;</td>
