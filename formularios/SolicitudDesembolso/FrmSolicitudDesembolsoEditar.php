...
<?php
//if($InsSolicitudDesembolso->SdsFactura=="No"){
?>
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td><span class="EstFormularioSubTitulo">
                 <input type="hidden" name="CmpClienteId" id="CmpClienteId"  value="<?php echo $InsSolicitudDesembolso->CliId?>" />
                 </span></td>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
             ...
             <tr>
			  ...
			  ?>
               ...
               <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td><input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncSolicitudDesembolsoDetalleListar();" value="<?php if (empty($InsSolicitudDesembolso->SdsTipoCambio)){ echo "";}else{ echo $InsSolicitudDesembolso->SdsTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
