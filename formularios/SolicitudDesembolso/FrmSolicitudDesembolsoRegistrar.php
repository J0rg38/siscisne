...
?>
  ...
  //MtdObtenerPersonales($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'PerId',$oSentido = 'Desc',$oPaginacion = '0,10',$oPersonalTipo=NULL,$oEstado=NULL,$oFechaNacimientoRango=NULL,$oTaller=NULL,$oRecepcion=NULL,$oVenta=NULL,$oArea=NULL) {
  ...
  //deb($InsSolicitudDesembolso->SdsGastoAsumido);
...
*/
    ...
    */
    ...
    var SolicitudDesembolsoDetalleEditar = 1;
    var SolicitudDesembolsoDetalleEliminar = 1;
  </script>
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if (empty($InsSolicitudDesembolso->SdsFecha)) {
                                                                                                                                                    echo date("d/m/Y");
                                                                                                                                                  } else {
                                                                                                                                                    echo $InsSolicitudDesembolso->SdsFecha;
                              ...
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                                      ...
                                      ?>
                                        <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsSolicitudDesembolso->MonId == $DatMoneda->MonId) {
                              ...
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td>
                                    ...
                                    <input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncSolicitudDesembolsoDetalleListar();" value="<?php if (empty($InsSolicitudDesembolso->SdsTipoCambio)) {
                                                                                                                                                                                                  echo "";
                                                                                                                                                                                                } else {
                                                                                                                                                                                                  echo $InsSolicitudDesembolso->SdsTipoCambio;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><?php
                              ...
                              <select class="EstFormularioCombo" name="CmpGastoAsumido" id="CmpGastoAsumido">
                              ...
                              <table>
                                <tr>
                                  ...
                                  <td><input name="CmpFichaIngresoId" id="CmpFichaIngresoId" type="hidden" value="<?php echo $InsSolicitudDesembolso->FinId; ?>" size="20" maxlength="20" />
                                    <input name="CmpFichaIngreso" type="text" class="EstFormularioCaja" id="CmpFichaIngreso" tabindex="3" value="<?php echo $InsSolicitudDesembolso->FinId; ?>" size="15" maxlength="25" <?php echo (!empty($InsSolicitudDesembolso->FinId) ? 'readonly="readonly"' : '') ?> />
                                  </td>
                          ...
                          <tr>
                            <td width="98%">
                              ...
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                <tr>
                                  <td>&nbsp;</td>
                                  <td colspan="6"><span class="EstFormularioSubTitulo">DETALLE DE LO REQUERIDO</span><span class="EstFormularioSubTitulo">
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>
                                    <a href="javascript:FncSolicitudDesembolsoDetalleNuevo('');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a>
                                  </td>
                                  <td><input name="CmpServicioRepuestoNombre" type="text" class="EstFormularioCaja" id="CmpServicioRepuestoNombre" size="45" /></td>
                                  <td><input class="EstFormularioCaja" name="CmpSolicitudDesembolsoDetalleCantidad" type="text" id="CmpSolicitudDesembolsoDetalleCantidad" size="10" maxlength="10" /></td>
                                  <td><input class="EstFormularioCaja" name="CmpSolicitudDesembolsoDetalleImporte" type="text" id="CmpSolicitudDesembolsoDetalleImporte" size="10" maxlength="10" /></td>
                                  <td>
                                  ...
                                  <td>
                                    ...
                                    <a href="javascript:FncSolicitudDesembolsoDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            ...
                            <td width="49%">
                              <div class="EstFormularioAccion" id="CapServicioRepuestoAccion">Listo
                            ...
                            <td width="49%" align="right">
                              ...
                              <a href="javascript:FncSolicitudDesembolsoDetalleEliminarTodo();"><img src="imagenes/acciones/listado_eliminar_todo.png" width="25" height="25" border="0" title="Eliminar Todo" alt="[Eli. Todo.]" align="absmiddle" /> Eliminar Todo</a>


                            </td>
                            <td width="1%">
                              <div id="CapSolicitudDesembolsoDetallesResultado"> </div>
                            </td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapSolicitudDesembolsoDetalles" class="EstCapSolicitudDesembolsoDetalles"> </div>
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                        </table>
