...
<div class="EstFormularioArea" >
  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
    ...
    <tr>
      ...
      <td><input  name="CmpVehiculoVersionCaracteristica10" type="text"  class="EstFormularioCaja" id="CmpVehiculoVersionCaracteristica10" value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica10);?>" size="25" maxlength="50" />
        /
    ...
    <tr>
      ...
      <td><input  name="CmpVehiculoVersionCaracteristica12" type="text"  class="EstFormularioCaja" id="CmpVehiculoVersionCaracteristica12" value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica12);?>" size="25" maxlength="50" />
        /
<input value="<?php echo htmlspecialchars($InsVehiculoIngreso->EinCaracteristica12);?>"  class="EstFormularioCaja"  name="CmpCaracteristica12" type="text" id="CmpCaracteristica12" size="15" maxlength="50" />
  (**)</td>
    ...
    <tr>
      ...
      <td><input  name="CmpVehiculoVersionCaracteristica13" type="text"  class="EstFormularioCaja" id="CmpVehiculoVersionCaracteristica13" value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica13);?>" size="25" maxlength="50" />
