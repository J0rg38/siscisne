...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">REGISTRAR INGRESO DE VEHICULO</span></td>
      </tr>
      <tr>
        <td>
...
<span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
          ...
          <tr>
            ...
            <td><input value="<?php echo $InsVehiculoIngreso->EinNumeroMotor;?>"  class="EstFormularioCaja"  name="CmpNumeroMotor" type="text" id="CmpNumeroMotor" size="30" maxlength="50" /></td>
            <td>Transmision:</td>
            <td><?php
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input name="CmpClienteId2" type="hidden" id="CmpClienteId2" value="<?php echo $InsVehiculoIngreso->CliId;?>" size="3" /></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
...
<div class="EstFormularioArea" >
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <td colspan="4">
              <span class="EstFormularioSubTitulo">
                Datos Declaracion	de Aduana</span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><span id="sprytextfield3">
              ...
              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnFechaRetornoDAM" name="BtnFechaRetornoDAM" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>Nombre</td>
            <td><input  name="CmpVehiculoIngresoNombre" type="text"  class="EstFormularioCaja" id="CmpVehiculoIngresoNombre" value="<?php echo $InsVehiculoIngreso->EinNombre;?>" size="30" maxlength="50" />
              (**)</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica7);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica7" type="text" id="CmpVehiculoVersionCaracteristica7" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica8);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica8" type="text" id="CmpVehiculoVersionCaracteristica8" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica9);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica9" type="text" id="CmpVehiculoVersionCaracteristica9" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica10);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica10" type="text" id="CmpVehiculoVersionCaracteristica10" size="25" maxlength="50" />
              /
          ...
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica1);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica1" type="text" id="CmpVehiculoVersionCaracteristica1" size="25" maxlength="50" />
              (*)</td>
            <td>Peso Bruto: <span class="EstFormularioSubIndice">(11)</span></td>
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica11);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica11" type="text" id="CmpVehiculoVersionCaracteristica11" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica2);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica2" type="text" id="CmpVehiculoVersionCaracteristica2" size="25" maxlength="50" />
              (*)</td>
            <td>Carga Util: <span class="EstFormularioSubIndice">(12)</span></td>
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica12);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica12" type="text" id="CmpVehiculoVersionCaracteristica12" size="25" maxlength="50" />
            /
          ...
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica13);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica13" type="text" id="CmpVehiculoVersionCaracteristica13" size="25" maxlength="50" />
              /
          ...
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica14);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica14" type="text" id="CmpVehiculoVersionCaracteristica14" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica3);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica3" type="text" id="CmpVehiculoVersionCaracteristica3" size="25" maxlength="50" />
              (*)</td>
            <td>Largo: <span class="EstFormularioSubIndice">(15)</span></td>
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica15);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica15" type="text" id="CmpVehiculoVersionCaracteristica15" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica4);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica4" type="text" id="CmpVehiculoVersionCaracteristica4" size="25" maxlength="50" />
              (*)</td>
            <td>Ancho: <span class="EstFormularioSubIndice">(16)</span></td>
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica16);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica16" type="text" id="CmpVehiculoVersionCaracteristica16" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica5);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica5" type="text" id="CmpVehiculoVersionCaracteristica5" size="25" maxlength="50" />
              (*)</td>
            <td>Dist. Ejes: <span class="EstFormularioSubIndice">(17)</span></td>
            <td><input value="<?php echo htmlspecialchars($InsVehiculoIngreso->VveCaracteristica17);?>"  class="EstFormularioCaja"  name="CmpVehiculoVersionCaracteristica17" type="text" id="CmpVehiculoVersionCaracteristica17" size="25" maxlength="50" />
              (*)</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="2">(*) Estos campos solo deben ser modificados con los datos originales de la DUA.<br />
(**) Estos campos reemplazarán los datos originales del vehiculo en la facturación. (Ejem.: Vehiculos con sistema GLP) </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
<div class="EstFormularioArea" >
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <td colspan="4">
              <span class="EstFormularioSubTitulo">
                Datos Estado Vehicular</span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><span id="sprytextfield8">
              ...
              <span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" width="20" height="20" border="0" align="absmiddle" title="Formato no valido" alt="[A]"  /></span></span>
              <img src="imagenes/acciones/calendario.png" alt="[Calendario]"  id="BtnEstadoVehicularFechaLlegada" name="BtnEstadoVehicularFechaLlegada" width="25" height="25" align="absmiddle"  style="cursor:pointer;" />
              </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
