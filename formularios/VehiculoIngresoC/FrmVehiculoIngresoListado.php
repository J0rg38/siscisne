...
$ResVehiculoIngreso = $InsVehiculoIngreso->MtdObtenerVehiculoIngresos("ein.EinId,ein.EinVIN,VmaNombre,VmoNombre,VveNombre,EinAnoFabricacion,EinNumeroMotor,EinPlaca,EinPoliza",$POST_con,$POST_fil,$POST_ord,$POST_sen,$POST_pag,$POST_est,NULL,NULL,$POST_EstadoVehicular,$POST_VehiculoMarcaId,$POST_VehiculoModeloId,$POST_VehiculoVersionId,NULL,NULL,NULL,$POST_ConProforma);
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE INGRESO DE VEHICULOS</span></td>
</tr>
<tr>
  <td>
      ...
      <tr>
        ...
        <th width="8%" ><?php
          ...
          <?php
				...
				?></th>
        <th width="8%" ><?php
				if($POST_ord == "EinGuiaTransporte"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('EinGuiaTransporte','ASC');"> Guia Transp.<img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /> </a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('EinGuiaTransporte','DESC');"> Guia Transp.<img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /> </a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('EinGuiaTransporte','ASC');"> Guia Transp. </a>
          <?php
				}
				?></th>
        <th width="6%" ><?php
				if($POST_ord == "EinGuiaRemision"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('EinGuiaRemision','ASC');"> Guia Rem. <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('EinGuiaRemision','DESC');"> Guia Rem. <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('EinGuiaRemision','ASC');"> Guia Rem. </a>
          <?php
				}
				?></th>
        <th width="4%" ><?php
          ...
          <?php
				...
				?></th>
        <th width="5%" ><?php
				if($POST_ord == "EinZofra"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('EinZofra','ASC');"> ¿Zofra? <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('EinZofra','DESC');"> ¿Zofra? <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('EinZofra','ASC');"> ¿Zofra? </a>
          <?php
				}
				?></th>
        <th width="7%" ><?php
				if($POST_ord == "EinNacionalizado"){
					if($POST_sen == "DESC"){
				?>
          <a href="javascript:FncOrdenar('EinNacionalizado','ASC');"> <span title="¿Nacionalizado?">¿Nac.?</span> <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
          <?php
					}else{
				?>
          <a href="javascript:FncOrdenar('EinNacionalizado','DESC');"> <span title="¿Nacionalizado?">¿Nac.?</span> <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
          <?php
					}
				}else{
				...
				?>
          <a href="javascript:FncOrdenar('EinNacionalizado','ASC');"> <span title="¿Nacionalizado?">¿Nac.?</span> </a>
          <?php
				}
				?></th>
        <th width="4%" ><?php
  ...
  <tbody class="EstTablaListadoBody">
    ...
    <tr id="Fila_<?php echo $f;?>">
      ...
      <td width="2%" align="center"  >
        ...
        <input   onclick="javascript:FncAgregarSeleccionado(this.value,'<?php echo $dat->EinId; ?>');" type="checkbox" name="cmp_seleccionar[]" id="cmp_seleccionar[]" value="<?php echo $dat->EinId; ?>" />				</td>
...
?>  
      ...
      <td  width="8%" align="right" ><?php echo $dat->EinEstadoVehicular;?></td>
      <td  width="8%" align="right" ><?php echo $dat->EinUbicacion; ?></td>
      <td  width="8%" align="right" ><?php echo $dat->EinGuiaTransporte; ?></td>
      <td  width="6%" align="right" ><?php echo $dat->EinGuiaRemision; ?></td>
