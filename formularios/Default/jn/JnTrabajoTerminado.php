...
$ResNotificacion = $InsNotificacion->MtdObtenerNotificacions(NULL,NULL,NULL,'NfnId','DESC','1','1',$GET_Usuario,FncCambiaFechaAMysql($GET_FechaInicio),FncCambiaFechaAMysql($GET_FechaFin)) ;
