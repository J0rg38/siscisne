...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCompraConsultaETA.php');
...
<div class="EstFormularioArea">
          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
            ...
            <td align="left"><textarea name="CmpDestinatario" cols="100" rows="3" class="EstFormularioCaja" id="CmpDestinatario"><?php echo $InsOrdenCompra->OcoDestinatarios;?></textarea></td>
		      <td>&nbsp;</td>
		      </tr>
		    <tr>
		      <td>&nbsp;</td>
