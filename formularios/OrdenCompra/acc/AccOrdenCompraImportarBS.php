...
$InsPedidoCompraDetalle1->MtdEditarPedidoCompraDetalleDato("PcdBSTiempoCarga",date("Y-m-d H:i:s"),$DatPedidoCompraDetalle->PcdId);
$InsPedidoCompraDetalle1->MtdEditarPedidoCompraDetalleDato("PcdBSCantidad",($Cantidad),$DatPedidoCompraDetalle->PcdId);
?>
