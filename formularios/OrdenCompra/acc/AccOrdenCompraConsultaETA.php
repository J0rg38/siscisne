...
if(isset($_POST['BtnEnviarCorreo_x']) or $_POST['Guardar']=="1"){	
	...
	if($Guardar){
		...
		$InsOrdenCompra->MtdEditarOrdenCompraDato("OcoTieneETA","S",$InsOrdenCompra->OcoId);
...
function FncCargarDatos(){
	...
	$InsOrdenCompra->OcoDestinatarios = "sandra.irey@gm.com,Willian.Pelaez@Cevalogistics.com,chevrolet.carperu@gm.com, jblanco@cyc.com.pe, aliendo@cyc.com.pe, iquezada@cyc.com.pe, scanepam@cyc.com.pe, bernardo.marcos@gm.com,richard.duenas@gm.com,dvercelone@cyc.com.pe,anace@cyc.com.pe,jean.anca@gm.com,carlos.diaz@gm.com";
//deb($InsOrdenCompra);
