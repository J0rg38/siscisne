...
$objPHPExcel = $objReader->load("../../plantilla/TemOrdenCompra".(($InsOrdenCompra->OcoTipo<>"ALM")?"GM":"").".xls");
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('E13', $InsOrdenCompra->OcoFecha);
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('E14', $InsOrdenCompra->OcoHora);						
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('H13', $InsOrdenCompra->OcoVIN);						
						
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('G14', 'O.T.');	
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('H14', $InsOrdenCompra->OcoOrdenTrabajo);						
...
$objWriter->save("../../generados/".$InsOrdenCompra->OcoId.".xls");
