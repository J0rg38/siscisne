           ...
           <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
			...
			?>
             ...
             <tr>
               ...
               <td colspan="3" align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td><a href="javascript:FncProveedorNuevo();">
                     <select <?php if(!empty($InsOrdenCompra->PrvId)){ echo 'disabled="disabled"';} ?>  class="EstFormularioCombo" name="CmpProveedorTipoDocumento" id="CmpProveedorTipoDocumento">
                       <option value="">Escoja una opcion</option>
                       <?php
			...
			?>
                   ...
                   <td><span id="sprytextfield5">
                     ...
                     <span class="textfieldRequiredMsg">Se necesita un valor.</span></span> <a href="formularios/AlmacenMovimientoEntrada/FrmProveedorBuscar.php?height=440&amp;width=850" class="thickbox" title=""><img src="imagenes/acciones/buscador.png" width="25" height="25" border="0" align="absmiddle" ></a></td>
             ...
             <tr>
               ...
               <td colspan="-1" align="left" valign="top">Hora:<br />
...
?>
             ...
             <tr>
               ...
               <td align="left"><?php
					...
					?>
                 <select  class="EstFormularioCombo" name="CmpProcesadoProveedor" id="CmpProcesadoProveedor" >
...
Calendar.setup({ 
	...
	ifFormat   : "%d/%m/%Y",  //  
	button     : "BtnFechaLlegadaEstimada"// el id del bot�n que  
	});
