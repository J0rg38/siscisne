...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCompraEditar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER ORDEN DE COMPRA</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<option value="">Escoja una opcion</option>
			...
			?>
		            ...
		            <td><input name="CmpProveedorNumeroDocumento" type="text" class="EstFormularioCaja" id="CmpProveedorNumeroDocumento"  value="<?php echo $InsOrdenCompra->PrvNumeroDocumento;?>" size="15" maxlength="50" readonly="readonly" /></td>
		            <td><input name="CmpProveedorNombre" type="text" class="EstFormularioCaja" id="CmpProveedorNombre" value="<?php echo $InsOrdenCompra->PrvNombreCompleto;?>" size="35" maxlength="255" readonly="readonly"  /></td>
		            </tr>
		          </table></td>
		      <td>&nbsp;</td>
		      </tr>
...
?>
		    ...
		    <tr>
		      ...
		      <td align="left" valign="top"><input name="CmpVIN" type="text" class="EstFormularioCaja" id="CmpVIN" value="<?php echo $InsOrdenCompra->OcoVIN;?>" size="20" maxlength="20" readonly="readonly" /></td>
		      <td align="left" valign="top">Orden de Trabajo:</td>
		      <td align="left" valign="top"><input name="CmpOrdenTrabajo" type="text" class="EstFormularioCaja" id="CmpOrdenTrabajo" value="<?php echo $InsOrdenCompra->OcoOrdenTrabajo;?>" size="20" maxlength="20" readonly="readonly" /></td>
		      <td>&nbsp;</td>
		      </tr>
		    <tr>
		      <td>&nbsp;</td>
