...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccOrdenCompraEnviarCorreoETA.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">ENVIAR CONSULTA &quot;ETA&quot; DE ORDEN DE COMPRA POR CORREO ELECTRONICO</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
<div class="EstFormularioArea">
          <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
		    ...
		    <tr>
		      <td>&nbsp;</td>
		      <td>Destinatario:</td>
            <td><input name="CmpDestinatario" type="text" class="EstFormularioCaja" id="CmpDestinatario" value="chevrolet.carperu@gm.com, jblanco@cyc.com.pe, aliendo@cyc.com.pe, iquezada@cyc.com.pe, scanepam@cyc.com.pe, bernardo.marcos@gm.com, richard.duenas@gm.com,luis.1.rosales@gm.com,luis.1.rosales@gm.com,dvercelone@cyc.com.pe,anace@cyc.com.pe,jean.anca@gm.com" size="100" maxlength="255"  /></td>
		      <td>&nbsp;</td>
		      </tr>
		    <tr>
		      <td>&nbsp;</td>
