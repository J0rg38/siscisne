...
?>  
	...
	<div class="EstSubMenuBoton"><a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=PagoVentaDirecta&Form=Listado<?php echo (!empty($GET_dia)?'&Dia=1':'');?>&VdiId=<?php echo $_GET['VdiId'];?>&FtaId=<?php echo $_GET['FtaId'];?>"><img src="imagenes/iconos/listado.png" alt="[Listado]"  title="Ir a formulario de listado" />Listado</a></div>
