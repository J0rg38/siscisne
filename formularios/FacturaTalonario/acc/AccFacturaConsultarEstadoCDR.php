...
$l_oClient = new nusoap_client('http://'.$URL_REMOTO.'/'.$CARPETA.'/WsSUNAT-TEST.php?wsdl','wsdl');
...
$ComprobanteXML['Serie'] = $InsFactura->FtaNumero;
...
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaConsultaCDRFecha",$Trama['FechaRespuesta'],$InsFactura->FacId,$InsFactura->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaConsultaCDRHora",$Trama['HoraRespuesta'],$InsFactura->FacId,$InsFactura->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaConsultaCDRCodigo",$Trama['CodigoRespuesta'],$InsFactura->FacId,$InsFactura->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaConsultaCDRContenido",$Trama['MensajeRespuesta'],$InsFactura->FacId,$InsFactura->FtaId);
$InsFactura->MtdEditarFacturaDato("FacSunatRespuestaConsultaCDRTiempoCreacion",date("Y-m-d H:i:s"),$InsFactura->FacId,$InsFactura->FtaId);
...
//ACCIONES
$InsFactura->MtdEditarFacturaDato("FacSunatUltimaAccion","CONSULTACDR",$InsFactura->FacId,$InsFactura->FtaId);
