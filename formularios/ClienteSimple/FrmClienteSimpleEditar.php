...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccClienteSimpleEditar.php');
//DATOS
          ...
          <td>
			...
			?>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input <?php echo (($PrivilegioEditarSimple)?'readonly="readonly"':'');;?>  value="<?php echo $InsCliente->CliNumeroDocumento;?>"  class="<?php echo (($PrivilegioEditarSimple)?'EstFormularioCajaDeshabilitada':'EstFormularioCaja');;?>"  name="CmpNumeroDocumento" type="text" id="CmpNumeroDocumento" size="40" maxlength="50" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td align="left" valign="top">Nombres/Razón Social:</td>
                  <td align="left" valign="top"><input <?php echo (($PrivilegioEditarSimple)?'readonly="readonly"':'');;?>  class="<?php echo (($PrivilegioEditarSimple)?'EstFormularioCajaDeshabilitada':'EstFormularioCaja');;?>" name="CmpNombre" type="text" id="CmpNombre" value="<?php echo stripslashes($InsCliente->CliNombre);?>" size="40" maxlength="250" /></td>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input <?php echo (($PrivilegioEditarSimple)?'readonly="readonly"':'');;?> class="<?php echo (($PrivilegioEditarSimple)?'EstFormularioCajaDeshabilitada':'EstFormularioCaja');;?>" name="CmpApellidoPaterno" type="text" id="CmpApellidoPaterno" value="<?php echo stripslashes($InsCliente->CliApellidoPaterno);?>" size="40" maxlength="250" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td align="left" valign="top">Apellido Materno:</td>
                  <td align="left" valign="top"><input <?php echo (($PrivilegioEditarSimple)?'readonly="readonly"':'');;?> class="<?php echo (($PrivilegioEditarSimple)?'EstFormularioCajaDeshabilitada':'EstFormularioCaja');;?>" name="CmpApellidoMaterno" type="text" id="CmpApellidoMaterno" value="<?php echo $InsCliente->CliApellidoMaterno;?>" size="40" maxlength="250" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
			...
			?>
                    <option <?php echo $DatClienteTipo->LtiId;?> <?php echo ($DatClienteTipo->LtiId==$InsCliente->LtiId)?'selected="selected"':"";?> value="<?php echo $DatClienteTipo->LtiId?>"><?php echo $DatClienteTipo->VmaNombre;?> - <?php echo $DatClienteTipo->LtiNombre?> <?php echo (($DatClienteTipo->LtiEstado==2)?'':'');?></option>
                    <?php
			}
			?>
                  </select></td>
