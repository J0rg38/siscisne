...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsTallerPedidoModalidadIngresoFunciones.js" ></script>

<!-- ARCHIVO DE ESTILOS CSS -->
<style type="text/css">
@import url('<?php echo $InsProyecto->MtdFormulariosCss($GET_mod);?>CssTallerPedidoModalidadIngreso.css');
</style>
<?php
...
$GET_id = $_GET['Id'];
//MENSAJES
include($InsProyecto->MtdFormulariosMsj($GET_mod).'MsjTallerPedidoModalidadIngreso.php');
//CLASES
...
//ACCIONES
//if($InsFichaIngreso->FinEstado == 72 or $InsFichaIngreso->FinEstado == 6 or $InsFichaIngreso->FinEstado == 5){
	
	include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccTallerPedidoModalidadIngresoEditar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        MODALIDAD DE INGRESO DE ORDEN DE TRABAJO (ALMACEN)</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
?>
					...
					?>
                    <img src="imagenes/advertencia.png" alt="Advertencia" title="Advertencia" width="15" height="15" align="absmiddle" /> [Tiene Ficha de Salida]
                    <?php	
					}
					?>
