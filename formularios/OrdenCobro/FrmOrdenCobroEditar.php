...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsOrdenCobroFunciones.js"></script>
  ...
  //INSTANCIAS
  $InsOrdenCobro = new ClsOrdenCobro($InsMysql);
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccOrdenCobroEditar.php');
              ...
              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                  ...
                  <td>C&oacute;digo Interno:
                    ...
                    <input name="CmpVentaDirectaTalonarioNumero" type="hidden" id="CmpVentaDirectaTalonarioNumero" value="<?php echo $VentaDirectaTalonarioNumero; ?>" />
                  </td>
                  <td><input name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsOrdenCobro->OcbId; ?>" size="15" maxlength="20" readonly="readonly" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <td align="left" valign="top"><input name="CmpVentaDirecta" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVentaDirecta" value="<?php echo $VentaDirectaId; ?>" size="15" maxlength="20" readonly="readonly" />
                    /
                    <input name="CmpOrdenVentaVehiculo" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenVentaVehiculo" value="<?php echo $OrdenVentaVehiculoId; ?>" size="15" maxlength="20" readonly="readonly" />
                  </td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td align="left" valign="top"><input name="CmpClienteId" type="hidden" id="CmpClienteId" value="<?php echo $InsOrdenCobro->CliId; ?>" />
                    <input name="CmpClienteNombre" type="text" class="EstFormularioCajaDeshabilitada" id="CmpClienteNombre" value="<?php echo $InsOrdenCobro->CliNombre; ?> <?php echo $InsOrdenCobro->CliApellidoPaterno; ?> <?php echo $InsOrdenCobro->CliApellidoMaterno; ?>" size="45" maxlength="255" readonly="readonly" />
                  </td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><span id="sprytextfield7">
                      <label>
                        <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php echo $InsOrdenCobro->OcbFecha; ?>" size="15" maxlength="10" />
                      </label>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><textarea name="CmpConcepto" cols="45" rows="4" class="EstFormularioCaja" id="CmpConcepto"><?php echo $InsOrdenCobro->OcbConcepto; ?></textarea></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                      ...
                      <tr>
                        <td><span id="spryselect3">
                            <select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                              ...
                              ?>
                                <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsOrdenCobro->MonId == $DatMoneda->MonId) {
                ...
                <tr>
                  ...
                  <td align="left" valign="top">
                    <table>
                      <tr>
                        <td><input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncOrdenCobroDetalleListar();" value="<?php if (empty($InsOrdenCobro->OcbTipoCambio)) {
                                                                                                                                                                                echo "";
                                                                                                                                                                              } else {
                                                                                                                                                                                echo $InsOrdenCobro->OcbTipoCambio;
                                                                                                                                                                              } ?>" size="10" maxlength="10" readonly="readonly" /></td>
                        <td><a href="javascript:FncOrdenCobroEstablecerMoneda();"><img src="imagenes/acciones/recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /></a></td>
                      </tr>
                    </table>
                  </td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><span id="sprytextfield4">
                      <input class="EstFormularioCaja" name="CmpMonto" type="text" id="CmpMonto" value="<?php echo number_format($InsOrdenCobro->OcbMonto, 2); ?>" size="10" maxlength="10" />
                ...
                <tr>
                  ...
                  <td><textarea class="EstFormularioCaja" name="CmpDescripcion" id="CmpDescripcion" cols="45" rows="4"><?php echo $InsOrdenCobro->OcbObservacion; ?></textarea></td>
                  <td>&nbsp;</td>
                </tr>
