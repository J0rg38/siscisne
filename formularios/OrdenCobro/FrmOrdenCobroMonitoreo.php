...
<option <?php if($POST_num=="150"){ echo 'selected="selected"';}?> value="150">150</option>
 ...
 <tbody class="EstTablaListadoBody">
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td width="5%" align="right" valign="middle"   ><?php echo $dat->OcbId;  ?></td>
                <td width="7%" align="right" valign="middle"   ><?php echo $dat->VdiId;  ?></td>
                ...
                <td  width="23%" align="right" ><?php echo $dat->CliNombre;  ?> <?php echo $dat->CliApellidoPaterno;  ?> <?php echo $dat->CliApellidoMaterno;  ?></td>
                <td  width="7%" align="right" ><?php echo $dat->OcbFecha; ?></td>
                <td  width="6%" align="right" ><?php echo $dat->NpaNombre; ?></td>
                <td align="right" >(<?php echo ($dat->MonSimbolo);?>)</td>
                <td align="right" ><?php echo ($dat->OcbTipoCambio);?></td>
                <td  width="9%" align="right" ><?php echo number_format($dat->OcbMonto,2); ?></td>

                <td  width="10%" align="right" ><?php echo ($dat->OcbTiempoCreacion);?></td>
...
?>
    ...
    <a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=<?php echo $GET_mod;?>&Form=Editar&Id=<?php echo $dat->OcbId;?><?php echo (!empty($GET_dia)?'&Dia=1':'');?>&VdiId=<?php echo $GET_VdiId;?>">
