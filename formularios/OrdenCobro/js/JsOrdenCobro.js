...
function FncOrdenCobroImprmir(oId){
	
	FncPopUp('formularios/OrdenCobro/FrmOrdenCobroImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);

}


function FncOrdenCobroVistaPreliminar(oId){
		
	FncPopUp('formularios/OrdenCobro/FrmOrdenCobroImprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
