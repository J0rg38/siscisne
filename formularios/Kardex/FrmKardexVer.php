         ...
         <table width="100%" class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <td width="76" colspan="3">
              ...
              <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Kardex/IfrKardex.php" target="IfrKardex" id="FrmKardex" name="FrmKardex" method="GET">
