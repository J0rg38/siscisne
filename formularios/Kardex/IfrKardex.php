...
<body>
	...
	$POST_UnidadMedidaUso = $_GET['CmpProductoUnidadMedidaKardex'];
	$POST_FechaInicio = $_GET['CmpFechaInicio'];
	$POST_FechaFin = $_GET['CmpFechaFin'];
	$POST_ProductoId = $_GET['CmpProductoId'];
	$POST_Moneda = $_GET['CmpMoneda'];
	$POST_AlmacenId = $_GET['CmpAlmacenId'];
	...
	//$ResKardex = $InsKardex->MtdObtenerKardexs($Campo,"esigual",$POST_ProductoId ,'AmoFecha ASC,(AmdTiempoCreacion) ASC','',NULL,$POST_ProductoId ,FncCambiaFechaAMysql($KardexFechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_UnidadMedidaUso,$POST_Moneda,"AmoFecha",$POST_AlmacenId);
	$ResKardex = $InsKardex->MtdObtenerKardexs($Campo, "esigual", $POST_ProductoId, 'amd.AmdFecha ASC,(amd.AmdTiempoCreacion) ASC', '', NULL, $POST_ProductoId, FncCambiaFechaAMysql($KardexFechaInicio), FncCambiaFechaAMysql($POST_FechaFin), $POST_UnidadMedidaUso, $POST_Moneda, "amd.AmdFecha", $POST_AlmacenId);
	...
	<table class="EstTablaListado" width="100%">
		<thead class="EstTablaListadoHead">
			<tr>
				...
				<th width="40" rowspan="2">Tipo</th>
				<th width="40" rowspan="2">Fecha Mov.</th>
				<th width="76" rowspan="2">Ubicacion</th>
		...
		<tbody class="EstTablaListadoBody">
				...
				?>
					...
					?>
						<tr>
							...
							<td width="60" height="30" align="center" valign="top" bgcolor="#66CC99">
								<?php
								echo number_format($Saldo, 2);
								?>
							</td>
							<td width="72" height="30" align="center" valign="top" bgcolor="#66CC99">
								<?php
							...
							<td width="64" height="30" align="center" valign="top" bgcolor="#66CC99">-</td>
						</tr>
					<?php
					}
					...
					<tr>
						...
						<td align="left" valign="top"><?php echo $DatKardex->KdxUbicacion; ?></td>
						<td align="left" valign="top">
						...
						<td width="64" align="center" valign="top" bgcolor="#66CC99">
							<?php echo $DatKardex->KdxTiempoCreacion; ?>
			...
			?>
				<tr>
					...
					<td align="center" valign="top" bgcolor="#66CC99"><?php
																		echo number_format($CostoTotalAnterior, 2);
																		?></td>
					<td height="30" align="center" valign="top" bgcolor="#66CC99">-</td>
				</tr>
			<?php
			}
			?>
			...
			<tr>
				...
				<td align="right">&nbsp;</td>
				<td align="right">&nbsp;</td>
				<td align="right"><?php //echo number_format($TotalEntradaGeneral,2);
									?>&nbsp;</td>
				<td align="right">&nbsp;</td>
				<td align="right">&nbsp;</td>
				<td align="right"><?php //echo number_format($TotalSalidaGeneral,2);
									?>&nbsp;</td>
				<td align="right">&nbsp;</td>
				<td align="right">&nbsp;</td>
				<td align="right">&nbsp;</td>
