...
$POST_ProductoCategoria = $_GET['CmpProductoCategoria'];
...
$POST_TipoUnidadMedida = $_GET['CmpTipoUnidadMedida'];
...
$ResProducto = $InsProducto->MtdObtenerProductos(NULL,NULL,NULL,"ProNombre","ASC",NULL,1,NULL,1,NULL,NULL,NULL,NULL,false,NULL,NULL,0,$POST_ProductoCategoria);
...
//	$ResKardex = $InsKardex->MtdObtenerKardexs(NULL,NULL,NULL,'AmoFecha ASC,(AmdTiempoCreacion) ASC','',NULL,$DatProducto->ProId,FncCambiaFechaAMysql($KardexFechaInicio),FncCambiaFechaAMysql($POST_FechaFin),1,$POST_Moneda,$POST_FechaTipo,$POST_AlmacenId);
	$ResKardex = $InsKardex->MtdObtenerKardexs(NULL,NULL,NULL,'amd.AmdFecha ASC,(amd.AmdTiempoCreacion) ASC','',NULL,$DatProducto->ProId,FncCambiaFechaAMysql($KardexFechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_TipoUnidadMedida,$POST_Moneda,"amd.AmdFecha",$POST_AlmacenId);
