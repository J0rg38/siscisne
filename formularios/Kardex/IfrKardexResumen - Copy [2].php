...
<tr>
  ...
  <th width="124" rowspan="2" align="center">ID</th>
  <th width="124" rowspan="2" align="center">UM ID</th>
...
<tr>
    ...
    <td width="124" align="right"><?php echo $DatProducto->ProId;?></td>
    <td width="124" align="right"><?php echo $DatProducto->UmeId;?></td>
