...
$POST_FechaTipo = (empty($_GET['FechaTipo'])?"IFNULL(amo.AmoComprobanteFecha,amd.AmdFecha)":$_GET['FechaTipo']);
...
<tr>
  ...
  <th width="124" align="center">COD. ORIG</th>
  <th width="405" align="center">NOMBRE</th>
  <th width="134" align="center">MARCA</th>
  <th width="134" align="center">TIPO</th>
  <th width="134" align="center">REF.</th>
  <th width="134" align="center">CATEGORIA</th>
  <th width="134" align="center">FECHA ULTIMA ENTRADA</th>
  <th width="134" align="center">FECHA ULTIMA SALIDA</th>
  <th width="134" align="center">U.M.</th>
...
?>
   ...
   // $ArrKardexs = $ResKardex['Datos'];
	...
	$ResKardex = $InsKardex->MtdObtenerKardexs(NULL,NULL,NULL ,'IFNULL(amo.AmoComprobanteFecha,amd.AmdFecha)',' ASC',NULL,$DatProducto->ProId ,FncCambiaFechaAMysql($InventarioFechaInicio),FncCambiaFechaAMysql($POST_FechaFin),3,$POST_Moneda,$POST_FechaTipo,$POST_Almacen,$POST_Sucursal);
	$ArrKardexs = $ResKardex['Datos'];
...
<tr>
    ...
    <td width="405" align="right"><?php echo $DatProducto->ProNombre;?></td>
							 ...
							 <?php //echo $DatProducto->VmaNombre;?>
                                <?php echo $DatProducto->ProMarcaReferencia;?>
                             </td>
