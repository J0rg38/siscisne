...
$ManoObra  = $InsClienteTipo->LtiManoObra;
...
//                                                     
//								if($DatKilometro['eq'] == "10000" || $DatKilometro['eq'] == "5000"  || $DatKilometro['eq'] == "20000" || $DatKilometro['eq'] == "30000" || $DatKilometro['eq'] == "40000"   || $DatKilometro['eq'] == "50000"   || $DatKilometro['eq'] == "25000" || $DatKilometro['eq'] == "35000" || $DatKilometro['eq'] == "45000" || $DatKilometro['eq'] == "55000" || $DatKilometro['eq'] == "60000" || $DatKilometro['eq'] == "65000" || $DatKilometro['eq'] == "70000" || $DatKilometro['eq'] == "75000"  || $DatKilometro['eq'] == "80000"  || $DatKilometro['eq'] == "15000" ) {
//								
//									 $InsPlanMantenimientoDetalle = new ClsPlanMantenimientoDetalle();
                                               ...
                                               // $PresupuestoTotal = 0;	
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <h2>
														<?php echo $DatKilometroEtiqueta;?> km <i>(<?php echo $DatKilometro['eq'];?>)</i>
                                                        </h2>
                                                    ...
                                                    ?>
                                                            ...
                                                            ?>
                                                          			...
                                                          			<td width="100" align="center" class="EstPlanMantenimientoSeccion"><strong>Codigo</strong></td>
                                                                    <td width="150" align="center" class="EstPlanMantenimientoSeccion"><strong>Descripción</strong></td>
                                                                    <td width="100" align="center" class="EstPlanMantenimientoSeccion"><strong>Cantidad</strong></td>
                                                                    <td width="100" align="center" class="EstPlanMantenimientoSeccion"><strong>UM</strong></td>
                                                                    <td width="100" align="center" class="EstPlanMantenimientoSeccion"><strong>P. Unit.</strong></td>
                                                                    <td width="100" align="center" class="EstPlanMantenimientoSeccion"><strong>P. Total</strong></td>
                        ...
                        //deb($PresupuestoTotal[$DatKilometroEtiqueta]);
                                            ...
                                            ?>  
                                                          ...
                                                          <?php
                                                           ...
                                                           <td colspan="5" align="right" class="Total"  >MANO DE OBRA:</td>
                                                           <td align="right" class="Total"  ><?php  echo number_format($ManoObra,2);?></td>
													...
													<?php
														...
														$PresupuestoTotal[$DatKilometroEtiqueta] += $ManoObra;
...
<table class="EstPlanMantenimientoTabla" border="0" cellpadding="0" cellspacing="0">
													...
													<h2><?php echo $DatKilometroEtiqueta;?> km <i>(<?php echo $DatKilometro['eq'];?>)</i>
                                                    </h2>
                                                    </td>
