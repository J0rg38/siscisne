                        ...
                        <input type="hidden" name="CmpClienteTipo" id="CmpClienteTipo" value="<?php echo $POST_ClienteTipo;?>">
                         ...
                         -->
                             ...
                             <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                                      <tr>
                                                        <td width="1">&nbsp;</td>
                                                        <td align="center" valign="top"><?php echo $InsPlanMantenimiento->VmaNombre;?>                                <?php echo $InsPlanMantenimiento->VmoNombre;?> (<?php echo $InsPlanMantenimiento->VmoNombreComercial;?>)</td>
                                                        <td width="5">&nbsp;</td>
                                                      </tr>
                                                      <tr>
                                                        <td>&nbsp;</td>
                                               ...
                                               // $PresupuestoTotal = 0;	
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td colspan="5" align="center" ><?php echo $DatKilometroEtiqueta;?> km <i>(<?php echo $DatKilometro['eq'];?>)</i></td>   
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>
                                                                  <?php
                                                                    if($DatKilometro['eq'] == "10000" || $DatKilometro['eq'] == "5000"){
                                                                    ?>
                                                                <td align="center" class="EstPlanMantenimientoSeccion">Codigo</td>
                                                                <td align="center" class="EstPlanMantenimientoSeccion">Descripción</td>
                                                                <td align="right" class="EstPlanMantenimientoSeccion">Cantidad</td>
                                                                <td align="right" class="EstPlanMantenimientoSeccion">P. Unit.</td>
                                                                <td align="right" class="EstPlanMantenimientoSeccion">P. Total</td>
                                                         ...
                                                         <tr>
                                                          ...
                                                          <?php
                                                            ...
                                                            <?php
                                                                            if($DatKilometro['eq'] == "10000" || $DatKilometro['eq'] == "5000"){
                                                                           ?>
                                                              <td colspan="4" align="center" class="Total"  >TOTAL:</td>
