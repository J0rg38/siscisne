...
<tr>
  ...
  <?php
		...
		?>
    <img src="../../imagenes/<?php echo $SistemaLogo;?>" height="40" />
    <?php
		}else{
		?>
    <img src="../../imagenes/logotipo.png" height="40" />
    <?php	
		}
		?>
  </td>
...
<input type="hidden" name="CmpClienteId" id="CmpClienteId" value="<?php echo $POST_ClienteId;?>">
     ...
     <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                              ...
                              <tr>
                                ...
                                <tr>
                                  <td>Cliente:</td>
                                  <td colspan="3"><?php echo $ClienteNombre;?></td>
                                  <td>Fecha:</td>
                                  <td><?php echo $Fecha;?></td>
                                </tr>
                                <tr>
                                  <td>Marca: </td>
                                  <td><?php echo $InsPlanMantenimiento->VmaNombre;?></td>
                                  <td>Modelo: </td>
                                  <td><?php echo $InsPlanMantenimiento->VmoNombre;?></td>
                                  <td>Kilometraje</td>
                                <td><?php
                                echo $POST_MantenimientoKilometraje;
								?>
km</td>
                                </tr>
                                </table>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td width="48" align="center" class="EstPlanMantenimientoSeccion">Stock</td>
                                <td width="48" align="center" class="EstPlanMantenimientoSeccion">Prom.</td>
										...
										?>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    ?>
                                                       ...
                                                       // if($DatTareaProducto->PmtId == $DatPlanMantenimientoTarea->PmtId and $DatTareaProducto->TprKilometraje == $DatKilometro['km']){
                                                        if($DatTareaProducto->PmtId == $DatPlanMantenimientoTarea->PmtId and $DatTareaProducto->TprKilometraje ==  $InsPlanMantenimiento->PmaChevroletKilometrajesNuevo[$POST_MantenimientoKilometraje]['eq']){
															...
															//deb($ProductoId." - ".$POST_ClienteTipo." - ".$ProductoUnidadMedida);
                                                    ...
                                                    <?php
//													deb($EmpresaMantenimientoPorcentajeManoObra);
...
<input type="hidden" name="CmpProductoUnidadMedida_<?php echo $DatPlanMantenimientoTarea->PmtId?>" id="CmpProductoUnidadMedida_<?php echo $DatPlanMantenimientoTarea->PmtId?>" value="<?php echo $ProductoUnidadMedida;?>">
                    ...
                    <input class="EstFormularioCajaDeshabilitada" name="CmpProductoCantidad_<?php echo $DatPlanMantenimientoTarea->PmtId;?>" type="text"  readonly id="CmpProductoCantidad_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoCantidad,2);?>"  />
...
<td class="<?php echo (($PlanMantenimientoDetalleAccion=="R" or $PlanMantenimientoDetalleAccion=="U")?'EstPlanMantenimientoTareaActivo':'EstPlanMantenimientoTareaInactivo')?>">
                   ...
                   <?php
                                    ...
                                    $InsTareaProducto = new ClsTareaProducto();
                                    $ResTareaProducto = $InsTareaProducto->MtdObtenerTareaProductos(NULL,NULL,NULL,'TprId','Desc',NULL,$InsPlanMantenimiento->PmaId,$InsPlanMantenimiento->PmaIsuzuKilometrajesNuevo[$POST_VehiculoMantenimientoKilometraje]['eq']);
                                    $ArrTareaProductos = $ResTareaProducto['Datos'];
                                    ?>
                                    ...
                                    ?>
                                       ...
                                       // if($DatTareaProducto->PmtId == $DatPlanMantenimientoTarea->PmtId and $DatTareaProducto->TprKilometraje == $DatKilometro['km']){
                                        if($DatTareaProducto->PmtId == $DatPlanMantenimientoTarea->PmtId and $DatTareaProducto->TprKilometraje ==  $InsPlanMantenimiento->PmaIsuzuKilometrajesNuevo[$POST_MantenimientoKilometraje]['eq']){
                                            ...
                                            foreach($ArrListaPrecios as $DatListaPrecio){
												...
												//deb($ProductoPrecio." - ". $ProductoCodigoOriginal);
...
<input name="CmpProductoId_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="hidden" class="EstFormularioCaja"  readonly="readonly"   id="CmpProductoId_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="15" value="<?php echo $ProductoId;?>" />
                                ...
                                <input class="EstFormularioCajaDeshabilitada" name="CmpProductoPrecio_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text"  readonly id="CmpProductoPrecio_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoPrecio,2);?>"  /></td>
                                                    <td align="center"   ><input name="CmpProductoImporte_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" class="EstFormularioCajaDeshabilitada" readonly id="CmpProductoImporte_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoImporte,2);?>"  /></td>
                                                    <td align="center"   >
                                                    
                                                    <input class="EstFormularioCajaDeshabilitada" name="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" readonly id="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" value="<?php echo number_format($ProductoStockReal,2);?>"   />
...
Item <?php echo $i;?>
                ...
                <td>
                  ...
                  <a id="BtnProductoBuscar_<?php echo $i;?>" href="javascript:FncProductoBuscar('CodigoOriginal','<?php echo $i;?>');"><img src="imagenes/buscar2.gif" width="25" height="25" alt="[Buscar]" align="absmiddle" title="Buscar" border="0" /></a>
                    ...
                    ?>
                       ...
                       <input class="EstFormularioCajaDeshabilitada" name="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" type="text" readonly id="CmpProductoStockReal_<?php echo $DatPlanMantenimientoTarea->PmtId?>" size="5" maxlength="10" />
            ...
            ?>  
                              ...
                              <tr>
                                <td>&nbsp;</td>
                                <td width="62" align="right" valign="middle">&nbsp;</td>
                                <td width="219" align="right" valign="middle">&nbsp;</td>
                                <td width="73" align="right" valign="middle">&nbsp;</td>
                                <td width="281" align="right" valign="middle">&nbsp;</td>
                                <td width="96" align="right" valign="middle">Total Mantenimiento:</td>
                                <td width="272" align="right" valign="middle"><input name="CmpMantenimientoTotal" type="text" class="EstFormularioCaja" readonly id="CmpMantenimientoTotal" size="5" maxlength="10" value="<?php echo number_format($PresupuestoTotal,2);?>"   /></td>
