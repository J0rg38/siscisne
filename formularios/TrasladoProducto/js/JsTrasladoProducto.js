	...
	var Tipo = prompt("Escoja el tipo de reporte \n 1 = Resumido\n 2 = Detallado", "1");
			...
			if(Tipo !== null){
				switch(Tipo.toUpperCase()){
					case "1":
	document.getElementById("FrmListado").action = "formularios/TrasladoProducto/acc/AccTrasladoProductoGenerarExcel.php";
					break;
					
					case "2":
	document.getElementById("FrmListado").action = "formularios/TrasladoProducto/acc/AccTrasladoProductoGenerarExcel2.php";
					break;
...
function FncListadoImprimir(){
	document.getElementById("FrmListado").action = "formularios/TrasladoProducto/FrmTrasladoProductoListadoImprimir.php"
...
//1,2,3,4,5
			...
			if(actualizar){
				...
				alert("Uno o mas de los elementos seleccionados no puede ser eliminado. Verifique que no se encuentre Cerrado o con Guia de Remision.");
			}
...
//1,2,3,4,5
			...
			if(actualizar){
					...
					$("#Acc").val("ActualizarTrasladoProductoEstadoPendiente");
				$("#FrmListado").submit();	
			}else{
...
//1,2,3,4,5
			...
			if(actualizar){
				$("#Acc").val("ActualizarTrasladoProductoEstadoRealizado");
				$("#FrmListado").submit();	
			}else{
				alert("Uno o mas de los elementos seleccionados no puede ser actualizado, verifique sus ESTADOS.");
			}
