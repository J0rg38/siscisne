...
$InsAlmacenMovimientoSalida->TptId = $GET_id;
...
<title>Ficha de Salida No. <?php echo $InsAlmacenMovimientoSalida->TptId;?></title>
...
<?php if($_GET['P']==1 and !empty($InsAlmacenMovimientoSalida->TptId)){?> 
...
<tr>
  ...
  <?php echo $InsAlmacenMovimientoSalida->TptId;?></span></td>
...
<tr>
    ...
    <tr>
      <td colspan="5" align="left" valign="top"><span class="EstAlmacenMovimientoSalidaSimpleImprimirCabecera">Datos de la Traslado de Producto</span></td>
    ...
    <tr>
      ...
      <td width="22%" align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido"><?php echo $InsAlmacenMovimientoSalida->TptFecha;?></span></td>
    ...
    <tr>
      ...
      <td align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido"><?php echo $InsAlmacenMovimientoSalida->TptComprobanteNumero;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
      ...
      <td align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido"><?php echo $InsAlmacenMovimientoSalida->TptResponsable;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido"><?php echo $InsAlmacenMovimientoSalida->TptTipoCambio;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td align="left" valign="top" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo"><span class="EstAlmacenMovimientoSalidaSimpleImprimirEtiqueta">Incluye Impuesto:</span></td>
      <td align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido">
        <?php
    switch($InsAlmacenMovimientoSalida->TptIncluyeImpuesto){
  ...
  <?php
    ...
    ?>
      ...
      <td align="left" valign="top">&nbsp;</td>
      <td align="left" valign="top" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo"><span class="EstAlmacenMovimientoSalidaSimpleImprimirEtiqueta">Impuesto:</span></td>
      <td align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido"><?php echo $InsAlmacenMovimientoSalida->TptPorcentajeImpuestoVenta;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td align="left" valign="top" >
        <span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido">
         ...
         <?php echo $InsAlmacenMovimientoSalida->TptEstadoDescripcion;?>
          <?php
		/*switch($InsAlmacenMovimientoSalida->TptEstado){
			case 1:
	?>
         Pendiente
          <?php
    ...
    <tr>
      ...
      <td colspan="4" align="left" valign="top" ><span class="EstAlmacenMovimientoSalidaSimpleImprimirContenido"><?php echo $InsAlmacenMovimientoSalida->TptObservacion;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    </table></td>
  </tr>
	...
	if(is_array($InsAlmacenMovimientoSalida->AlmacenMovimientoSalidaDetalle)){
		...
		foreach($InsAlmacenMovimientoSalida->AlmacenMovimientoSalidaDetalle as $DatAlmacenMovimientoSalidaDetalle){
			...
			if($InsAlmacenMovimientoSalida->MonId<>$EmpresaMonedaId){
				$DatAlmacenMovimientoSalidaDetalle->AmdCosto = $DatAlmacenMovimientoSalidaDetalle->AmdCosto / $InsAlmacenMovimientoSalida->TptTipoCambio;
			}else{
				$DatAlmacenMovimientoSalidaDetalle->AmdCosto = $DatAlmacenMovimientoSalidaDetalle->AmdCosto;
			}

			if($InsAlmacenMovimientoSalida->MonId<>$EmpresaMonedaId ){
				$DatAlmacenMovimientoSalidaDetalle->AmdImporte = $DatAlmacenMovimientoSalidaDetalle->AmdImporte / $InsAlmacenMovimientoSalida->TptTipoCambio;
			}else{
...
//$Recargo = $InsAlmacenMovimientoSalida->TptTotalRecargo;
//$Impuesto = round(($SubTotal + $Recargo) * ($InsAlmacenMovimientoSalida->TptPorcentajeImpuestoVenta/100),2);
//$Total = $SubTotal + $Recargo + $Impuesto;
if($InsAlmacenMovimientoSalida->TptIncluyeImpuesto == 2){

	$ImpuestoVenta = ($InsAlmacenMovimientoSalida->TptPorcentajeImpuestoVenta/100);
	...
	$SubTotal = $TotalBruto;
	$Impuesto = $SubTotal * ($InsAlmacenMovimientoSalida->TptPorcentajeImpuestoVenta/100);	
...
<tr>
  ...
  <td width="18%" align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo"><span class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaTotal">SubTotal:</span></td>
  <td width="22%" align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirContenidoTotal">

    <span class="EstMonedaSimbolo"><?php echo $InsAlmacenMovimientoSalida->MonSimbolo;?></span> <?php echo number_format($SubTotal,2);?>
...
<tr>
  <td align="left">&nbsp;</td>
  <td align="left">&nbsp;</td>
  <td align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo"><span class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaTotal">Recargo:</span></td>
  <td align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirContenidoTotal"><span class="EstMonedaSimbolo"><?php echo $InsAlmacenMovimientoSalida->MonSimbolo; ?></span> <?php echo number_format($Recargo,2);?></td>
  </tr>
<tr>
  <td align="left">&nbsp;</td>
  <td align="left">&nbsp;</td>
  <td align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo"><span class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaTotal">Impuesto (<?php echo $InsAlmacenMovimientoSalida->TptPorcentajeImpuestoVenta;?>%):</span></td>
  <td align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirContenidoTotal">
  

    <span class="EstMonedaSimbolo"><?php echo $InsAlmacenMovimientoSalida->MonSimbolo;?></span> <?php echo number_format($Impuesto,2);?>
...
<tr>
  <td align="right">&nbsp;</td>
  <td align="right">&nbsp;</td>
  <td align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaFondo"><span class="EstAlmacenMovimientoSalidaSimpleImprimirEtiquetaTotal">Total:</span></td>
  <td align="right" class="EstAlmacenMovimientoSalidaSimpleImprimirContenidoTotal">
