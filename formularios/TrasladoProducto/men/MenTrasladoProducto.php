<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"TrasladoProducto","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"TrasladoProducto","Listado") and empty($GET_dia)){
?>  
