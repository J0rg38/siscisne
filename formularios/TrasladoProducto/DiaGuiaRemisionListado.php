...
$ResGuiaRemision = $InsGuiaRemision->MtdObtenerGuiaRemisiones(NULL,NULL,NULL,"GreFechaInicioTraslado","ASC",NULL,NULL,NULL,NULL,NULL,$GET_TptId);
...
<div id="ForBuscadorProductos"  >
  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
    <tr>
      <td width="1%">&nbsp;</td>
      <td width="98%"><span class="EstFormularioSubTitulo"> Listado de GUIAS DE REMISION de la FICHA DE SALIDA
        </span></td>
      <td width="1%">&nbsp;</td>
    </tr>
    <tr>
...
?>
			...
			?>
         <a href="javascript:FncPopUp('formularios/GuiaRemision/FrmGuiaRemisionImprimir.php?Id=<?php echo $DatGuiaRemision->GreId;?>&Ta=<?php echo $DatGuiaRemision->GrtId;?>',0,0,1,0,0,1,0,screen.height,screen.width);"><img src="imagenes/acciones/preliminar.gif" alt="[Vista Preliminar]" title="Vista preliminar" width="19" height="19" border="0" /></a>
        	<?php
			}
			?>
			...
			?>        
                ...
                <a href="javascript:FncPopUp('formularios/GuiaRemision/FrmGuiaRemisionImprimir.php?Id=<?php echo $DatGuiaRemision->GreId;?>&Ta=<?php echo $DatGuiaRemision->GrtId;?>&P=1',0,0,1,0,1,1,0,screen.height,screen.width);"><img src="imagenes/acciones/imprimir.png" alt="[Imprimir]" title="Imprimir" width="19" height="19" border="0" /></a>
			<?php
			}
			?> 
