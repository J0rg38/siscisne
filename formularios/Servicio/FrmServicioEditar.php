...
$Edito = false;
//deb($_GET);
//deb($_SESSION['SesServicioId']);
//$GET_id = (empty($_SESSION['SesServicioId'])?$_GET['Id']:$_SESSION['SesServicioId']);
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">EDITAR SERVICIO</span></td>
      </tr>
      <tr>
        <td>
          ...
          <tr>
            ...
            <td colspan="2">
              <span class="EstFormularioSubTitulo">
                Datos del	Servicio</span>			<input type="hidden" name="Identificador" id="Identificador"  value="<?php echo $Identificador; ?>" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td valign="top">Codigo Interno:</td>
            <td valign="top"><input name="CmpId" type="text" class="EstFormularioCajaDeshabilitada" id="CmpId" value="<?php echo $InsServicio->SerId;?>" size="20" maxlength="20" readonly="readonly" /></td>
            <td valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
               ...
               <tr>
                 ...
                 <td colspan="2"><div class="EstFormularioArea">
                   <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                     ...
                     <tr>
                       <td><a href="javascript:FncServicioDetalleNuevo('');"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
