                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td><input name="CmpPais" type="text" class="EstFormularioCaja" id="CmpPais" value="<?php echo $InsConfiguracionEmpresa->CemPais; ?>" size="40" maxlength="30" />
                        <input name="CmpPaisAbreviacion" type="text" class="EstFormularioCaja" id="CmpPaisAbreviacion" value="<?php echo $InsConfiguracionEmpresa->CemPaisAbreviacion; ?>" size="5" maxlength="10" />
                      </td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><span id="spryselect1">
                          ...
                          <select class="EstFormularioCombo" name="CmpMoneda" id="CmpMoneda" disabled="disabled">
                            ...
                            ?>
                              <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsConfiguracionEmpresa->MonId == $DatMoneda->MonId) {
                          ...
                          <span class="selectInvalidMsg">Seleccione un elemento v�lido.</span> <span class="selectRequiredMsg"><img src="imagenes/advertencia.png" width="20" height="20" border="0" align="absmiddle" title="Debe seleccionar un elemento" alt="[A]" /></span></span>
              ...
              <div id="tab2" class="tab_content">
                ...
                <div class="EstFormularioArea">
                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Nro. Cuenta Destraccion:</td>
                      <td><input name="CmpCuentaDetraccion" type="text" class="EstFormularioCaja" id="CmpCuentaDetraccion" value="<?php echo $InsConfiguracionEmpresa->CemCuentaDetraccion; ?>" size="40" maxlength="30" /></td>
                      <td>&nbsp;</td>
                    </tr>
