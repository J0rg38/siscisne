              ...
              <div class="EstFormularioArea">
                ...
                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>Nombre:
                      <input type="hidden" name="CmpId" id="CmpId" value="<?php echo $InsConfiguracionEmpresa->CemId ?>" />
                    </td>
                  ...
                  <tr>
                    ...
                    <td><input name="CmpPais" type="text" class="EstFormularioCaja" id="CmpPais" value="<?php echo $InsConfiguracionEmpresa->CemPais; ?>" size="40" maxlength="30" readonly="readonly" />
                      <input name="CmpPaisAbreviacion" type="text" class="EstFormularioCaja" id="CmpPaisAbreviacion" value="<?php echo $InsConfiguracionEmpresa->CemPaisAbreviacion; ?>" size="5" maxlength="10" readonly="readonly" />
                    </td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <select class="EstFormularioCombo" name="CmpMoneda" id="CmpMoneda" disabled="disabled">
                        ...
                        ?>
                          <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsConfiguracion->EmpresaMoneda == $DatMoneda->MonId) {
                  ...
                  <tr>
                    ...
                    <td><select class="EstFormularioCombo" name="CmpCalificacion" id="CmpCalificacion">
                        ...
                        ?>
                          <option value="<?php echo $DatCalificacion->CalId ?>" <?php if ($InsConfiguracionEmpresa->CalId == $DatCalificacion->CalId) {
                                                                                  echo 'selected="selected"';
                                                                                } ?>><?php echo $DatCalificacion->CalTipo ?></option>
                        <?php
                        }
                        ?>
                      </select></td>
                  ...
                  <tr>
                    ...
                    <td><select class="EstFormularioCombo" name="CmpAlmacen" id="CmpAlmacen" disabled="disabled">
                        ...
                        ?>
                          <option value="<?php echo $DatAlmacen->AlmId ?>" <?php if ($InsConfiguracionEmpresa->AlmId == $DatAlmacen->AlmId) {
                                                                              echo 'selected="selected"';
                ...
                <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top">
                      ...
                      <input class="EstFormularioCaja" name="CmpImpuestoVenta" type="text" id="CmpImpuestoVenta" size="10" maxlength="10" value="<?php if (empty($InsConfiguracion->EmpresaImpuestoVenta)) {
                                                                                                                                                    echo "0.00";
                                                                                                                                                  } else {
                                                                                                                                                    echo $InsConfiguracion->EmpresaImpuestoVenta;
                                                                                                                                                  } ?>" readonly="readonly" />
                    </td>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top">
                      ...
                      <input class="EstFormularioCaja" name="CmpImpuestoRenta" type="text" id="CmpImpuestoRenta" size="10" maxlength="10" value="<?php if (empty($InsConfiguracion->EmpresaImpuestoRenta)) {
                                                                                                                                                    echo "0.00";
                                                                                                                                                  } else {
                                                                                                                                                    echo $InsConfiguracion->EmpresaImpuestoRenta;
                                                                                                                                                  }  ?>" readonly="readonly" />
                    </td>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td align="left" valign="top">Nro. Cuenta Destraccion:</td>
                    <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpCuentaDetraccion" type="text" id="CmpCuentaDetraccion" value="<?php echo $InsConfiguracionEmpresa->CemCuentaDetraccion; ?>" size="40" maxlength="30" readonly="readonly" /></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
