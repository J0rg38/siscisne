...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccProveedorComunicadoRegistrar.php');
...
var ProveedorComunicadoFotoSoloEditar = 1;
var ProveedorComunicadoFotoSoloEliminar = 1;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">REGISTRAR COMUNICADO</span></td>
      </tr>
      <tr>
        <td>
...
<div class="tab_container">
    ...
    <div id="tab1" class="tab_content">
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Proveedor:<input name="CmpProveedorId" type="hidden" id="CmpProveedorId" value="<?php echo $InsProveedorComunicado->PrvId;?>" size="3" /></td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input value="<?php echo $InsProveedorComunicado->PomCodigo;?>"  class="EstFormularioCaja"  name="CmpCodigo" type="text" id="CmpCodigo" size="30" maxlength="45" /></td>
            <td align="left" valign="top">Fecha:<br />
              (dd/mm/yyyy)</td>
            <td align="left" valign="top"><span id="sprytextfield7">
              <label>
                <input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php  echo $InsProveedorComunicado->PomFecha; ?>" size="15" maxlength="10" />
                </label>
          ...
          <tr>
            ...
            <td colspan="3" align="left" valign="top"><input name="CmpRemitente" type="text" class="EstFormularioCaja" id="CmpRemitente" value="<?php echo $InsProveedorComunicado->PomRemitente;?>" size="45" maxlength="100"  /></td>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top">Asunto:</td>
            <td colspan="3" align="left" valign="top"><span id="sprytextfield4">
              <input name="CmpAsunto" type="text" class="EstFormularioCaja" id="CmpAsunto" value="<?php echo $InsProveedorComunicado->PomAsunto;?>" size="45" maxlength="200"  />
            </span></td>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="3" align="left" valign="top"><textarea name="CmpDescripcion" cols="40" class="EstFormularioCaja" id="CmpDescripcion"><?php echo $InsProveedorComunicado->PomDescripcion;?></textarea></td>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <td colspan="3" align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
              <tr>
                <td width="275" colspan="2" align="left" valign="top">
                  ...
                  <div id="fileUploadProveedorComunicadoFotoSolo">Escoger Archivo</div>
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><div class="EstCapProveedorComunicadoFotoSolos" id="CapProveedorComunicadoFotoSolos"></div></td>
                <td align="left" valign="top">&nbsp;</td>
                </tr>
            </table></td>
            <td align="left" valign="top">&nbsp;</td>
