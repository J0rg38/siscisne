...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">EDITAR COMUNICADO</span></td>
      </tr>
      <tr>
        <td>
       ...
       <tr>
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <td colspan="4">
              <span class="EstFormularioSubTitulo">
                Datos del Comunicado			</span>			<input type="hidden" name="Identificador" id="Identificador"  value="<?php echo $Identificador; ?>" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input  name="CmpCodigo" type="text"  class="EstFormularioCaja" id="CmpCodigo" value="<?php echo $InsProveedorComunicado->PomCodigo;?>" size="30" maxlength="45" /></td>
          ...
          <tr>
            ...
            <td colspan="3" align="left" valign="top"><input name="CmpAsunto" type="text" class="EstFormularioCaja" id="CmpAsunto" value="<?php echo $InsProveedorComunicado->PomAsunto;?>" size="45" maxlength="200"  /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
