...
$RepSesionObjetos = $_SESSION['InsProveedorComunicadoFoto'.$Identificador]->MtdObtenerSesionObjetos(true);
...
?>
    ...
    if($_POST['Eliminar']==1){
    ?> - 
      <a href="javascript:FncProveedorComunicadoFotoEliminar('<?php echo $DatSesionObjeto->Item;?>','<?php echo $POST_Tipo;?>');" >
