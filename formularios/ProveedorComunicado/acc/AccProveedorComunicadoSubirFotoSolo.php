...
$targetFolder = '../../../subidos/comunicado_fotos';// Relative to the root
...
if (!empty($_FILES)) {
	...
	if (in_array(strtolower($fileParts['extension']),$fileTypes)) {
		...
		if(move_uploaded_file($tempFile,$targetFile)){
			...
			$_SESSION['SesProveedorComunicadoArchivoSolo'.$Identificador] = $FotoIdentificador.$_FILES['Filedata']['name'];
			//echo "TTEST ".$FotoIdentificador.$_FILES['Filedata']['name'];
