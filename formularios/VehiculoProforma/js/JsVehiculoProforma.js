...
function FncBuscar(){
	...
	$("#Ord").val("");
	$("#Sen").val("");
	tree.saveOpenStates("CooVehiculoProformaCategoria");
	$("#FrmListado").submit();
}
...
function FncGenerarExcel(){
	...
	document.getElementById("FrmListado").action = "formularios/VehiculoProforma/acc/AccVehiculoProformaGenerarExcel.php"
...
function FncImprmir(oId){
	...
	FncPopUp('formularios/VehiculoProforma/FrmVehiculoProformaImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
...
function FncVistaPreliminar(oId){
	...
	FncPopUp('formularios/VehiculoProforma/FrmVehiculoProformaImprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
