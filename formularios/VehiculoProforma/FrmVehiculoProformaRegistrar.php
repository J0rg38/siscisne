...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoProformaRegistrar.php');
//DATOS
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="961" height="25"><span class="EstFormularioTitulo">REGISTRAR PROFORMA DE VEHICULO</span></td>
      </tr>
      <tr>
        <td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><label for="CmpCodigo"></label>
              <span id="sprytextfield1">
                <input class="EstFormularioCaja" name="CmpCodigo" type="text" id="CmpCodigo" value="<?php echo $InsVehiculoProforma->VprCodigo;?>" size="20" maxlength="45" />
...
?>
                      ...
                      <td width="98%">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            ...
                            <td align="center"><span title="Año Fabricacion">Año Fab.</span></td>
  ...
  <a href="javascript:FncVehiculoProformaDetalleNuevo();"></a>
                            ...
                            <td>
                              <input name="CmpVehiculoProformaDetalleCosto" type="text" class="EstFormularioCaja" id="CmpVehiculoProformaDetalleCosto" size="15" maxlength="45"  /></td>
           ...
           <div class="EstFormularioArea" >
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  ...
                  <tr>
                    ...
                    <td width="49%" align="right"><a href="javascript:FncVehiculoProformaDetalleListar();">
                    <img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncVehiculoProformaDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>
