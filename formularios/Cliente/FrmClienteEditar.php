...
<div class="tab_container">
          ...
          <td>
			...
			?>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input class="EstFormularioCaja"   name="CmpRepresentanteNacionalidad" type="text" id="CmpRepresentanteNacionalidad" value="<?php echo $InsCliente->CliRepresentanteNumeroDocumento;?>" size="40" maxlength="45" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <td align="left" valign="top"><input class="EstFormularioCaja"   name="CmpRepresentanteActividadEconomica" type="text" id="CmpRepresentanteActividadEconomica" value="<?php echo $InsCliente->CliRepresentanteNumeroDocumento;?>" size="40" maxlength="250" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td align="left" valign="top">Apellido Materno:</td>
                  <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpApellidoMaterno" type="text" id="CmpApellidoMaterno" value="<?php echo $InsCliente->CliApellidoMaterno;?>" size="40" maxlength="250" /></td>
                  <td>&nbsp;</td>
			...
			?>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input name="CmpDepartamentoId" type="hidden"  id="CmpDepartamentoId" value="<?php echo $InsCliente->CliDepartamento;?>" size="20" maxlength="10" readonly="readonly" />
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input name="CmpProvinciaId" type="hidden"  id="CmpProvinciaId" value="<?php echo $InsCliente->CliProvincia;?>" size="20" maxlength="10" readonly="readonly" />
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input name="CmpDistritoId" type="hidden"  id="CmpDistritoId" value="<?php echo $InsCliente->CliDistrito;?>" size="20" maxlength="10" readonly="readonly" />
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td align="left" valign="top">Registrado por:
                    <input name="CmpPersonalAnterior" type="hidden"  id="CmpPersonalAnterior" value="<?php echo $InsCliente->PerIdAnterior;?>" size="20" maxlength="10" readonly="readonly" /></td>
                ...
                <tr>
                  ...
                  <select class="EstFormularioCombo" name="CmpTipoReferido" id="CmpTipoReferido">
                    <option value="">Escoja una opcion</option>
                    <?php
          ...
          <td>
            ...
            <div class="EstFormularioArea">
              ...
              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="6"><span class="EstFormularioSubTitulo">Datos de Linea de Credito</span></td>
                  <td>&nbsp;</td>
                  </tr>
                <tr>
                  <td>&nbsp;</td>
			  ...
			  ?>
                  ...
                  <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="43"><input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio"  value="<?php if (empty($InsCliente->CliTipoCambio)){ echo "";}else{ echo $InsCliente->CliTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
    ...
    <div id="tab6" class="tab_content">
		...
		<table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td>&nbsp;</td>
            <td colspan="2"><span class="EstFormularioSubTitulo">VEHICULOS RELACIONADOS</span></td>
            <td>&nbsp;</td>
          </tr>
