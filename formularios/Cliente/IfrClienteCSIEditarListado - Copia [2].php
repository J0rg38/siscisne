...
<?php }?>
        ...
        <tr   >
         ...
         <!-- <input name="CmpClienteCSIExcluirMotivo_<?php echo $c;?>" type="text" class="EstFormularioCaja" id="CmpClienteCSIExcluirMotivo_<?php echo $c;?>" value="<?php echo $DatReporteFichaIngreso->CliCSIExcluirMotivo;?>" size="25" maxlength="255" />
          ...
          <a id="BtnRegistrarEncuesta_<?php echo $c; ?>" ficha_ingreso="<?php echo $DatReporteFichaIngreso->FinId; ?>" href="javascript:void(0);">
          <img width="25" height="25" src="imagenes/acciones/encuesta.gif" alt="Encuesta" title="Registrar Encuesta">
          </a>
          
            <a id="BtnRegistrarLlamada_<?php echo $c; ?>" ficha_ingreso="<?php echo $DatReporteFichaIngreso->FinId; ?>" href="javascript:void(0);">
          <img  width="25" height="25" src="imagenes/acciones/llamadas.png" alt="Llamada" title="Registrar Llamada">
          </a>
