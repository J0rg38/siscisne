...
$ResTipoReferido = $InsTipoReferido->MtdObtenerTipoReferidos(NULL,NULL,"TrfNombre","ASC",NULL,1,NULL);
			...
			?>
                ...
                <tr>
                  ...
                  <td align="left" valign="top">
                   ...
                   <input name="CmpDepartamentoId" type="hidden" class="CmpDepartamentoux" id="CmpDepartamentoId" value="<?php echo $InsCliente->CliDepartamento;?>" size="20" maxlength="10" readonly="readonly" />
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><select class="EstFormularioCombo" name="CmpTipoReferido" id="CmpTipoReferido">
                    <option value="">Escoja una opcion</option>
                    <?php
