...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsClienteCSIVentaEditarListado.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">ACTUALZARCLIENTE / CSI  VENTA</span></td>
  <td width="2%"><a href="formularios/Cliente/inf/InfClienteCSIVentaEditarListado.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Cliente/IfrClienteCSIVentaEditarListado.php" target="IfrClienteCSIVentaEditarListado" method="post" name="FrmClienteCSIVentaEditar" id="FrmClienteCSIVentaEditar">
      -->
    ...
    ?>
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      <option value="OvvFecha" selected="selected">Fecha de Orden</option>
          ...
          <td align="left" valign="top">
            ...
            <table border="0" cellpadding="0" cellspacing="2">
              <tr>
                <td>
                  <input name="BtnVer"   id="BtnVer" type="image" border="0" src="imagenes/reporte_iconos/ver.png" alt="[Ver]" title="Ver" onclick="FncClienteCSIVentaEditarCargarListado();" />           </td>
                <td>
                  <?php
...
<!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Cliente/IfrClienteCSIVentaEditarListado.php" target="IfrClienteCSIVentaEditarListado" id="IfrClienteCSIVentaEditarListado" name="IfrClienteCSIVentaEditarListado" scrolling="auto"  frameborder="0"  height="420" width="100%" onload='javascript:resizeIframe(this);'></iframe>
  
  -->
  
   <!--class="EstFormularioCapaListado"-->
  <div id="CapClienteCSIVentaEditar"></div>
  </td>
</tr>
</table>
</div>
