...
<tr>
<td><input name="CapClienteCSIExcluirMotivo_<?php echo $InsCliente->CliId;?>" type="text" class="EstFormularioCaja" id="CapClienteCSIExcluirMotivo_<?php echo $InsCliente->CliId;?>" value="<?php echo $InsCliente->CliCSIExcluirMotivo;?>" size="25" maxlength="255" />
</td>
