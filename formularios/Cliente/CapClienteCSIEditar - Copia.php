...
<tr>
<td><textarea name="CapClienteCSIExcluirMotivo_<?php echo $InsCliente->CliId;?>" cols="30" rows="4" class="EstFormularioCaja" id="CapClienteCSIExcluirMotivo_<?php echo $InsCliente->CliId;?>"><?php echo $InsCliente->CliCSIExcluirMotivo;?></textarea>
</td>
