...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsClienteCSIEditarListado.js"></script>
...
<tr>
  <td  height="25">
    ...
    <span class="EstFormularioTitulo">ACTUALIZAR CLIENTE / CSI - POST VENTA</span></td>
  <td width="2%"><a href="formularios/Cliente/inf/InfClienteCSIEditarListado.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Cliente/IfrClienteCSIEditarListado.php" target="IfrClienteCSIEditarListado" method="post" name="FrmClienteCSIEditar" id="FrmClienteCSIEditar">
      -->
<form enctype="multipart/form-data" action="#" method="post" name="FrmClienteCSIEditar" id="FrmClienteCSIEditar"  onsubmit="return false">
        ...
        <tr>
          ...
          <fieldset  class="EstFormularioContenedor">
            ...
            <table border="0" cellpadding="2" cellspacing="2">
              <tr>
                <td>Sucursal:</td>
                <td colspan="3"><select  class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
    ...
    ?>
              ...
              <tr>
                <td>Modalidad:</td>
                <td><select  class="EstFormularioCombo" name="CmpModalidad" id="CmpModalidad">
        ...
        <!--              <option value="MinNombre" >Modalidad de Ingreso</option>-->
          ...
          <td align="left" valign="top">
           ...
           /* if($PrivilegioImprimir){
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncClienteCSIEditarImprimir('');" />           
                  <?php	  
            }*/
            ?>                  </td>
                <td>
           ...
           /* if($PrivilegioGenerarExcel){
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncClienteCSIEditarGenerarExcel('');" />           
                  <?php	  
            }*/
            ?>                  </td>
                </tr>
...
<!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Cliente/IfrClienteCSIEditarListado.php" target="IfrClienteCSIEditarListado" id="IfrClienteCSIEditarListado" name="IfrClienteCSIEditarListado" scrolling="auto"  frameborder="0"  height="420" width="100%" onload='javascript:resizeIframe(this);'></iframe>
   class="EstFormularioCapaListado"
  -->
  
  
  <div id="CapClienteCSIEditar"></div>
  </td>
</tr>
</table>
</div>
