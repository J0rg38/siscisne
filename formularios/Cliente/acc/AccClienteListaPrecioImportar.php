...
if($POST_MonedaId<>$EmpresaMonedaId){
	if(empty($POST_TipoCambio)){
		exit("No ha ingresado el tipo de cambio");
	}
}
...
<input name="CmpClienteId" type="hidden" id="CmpClienteId" value="<?php echo $InsCliente->CliId;?>" size="3" />
...
if (!empty($_FILES)) {
	...
	$targetPath = '../../../subidos/cliente_lista_precio_excel/';
...
//	$targetFile = "../../../subidos/cliente_lista_precio_excel/kukenam.xls";	
...
<?php					
				...
				//$data->read("../../../subidos/cliente_lista_precio_excel/johnson");
