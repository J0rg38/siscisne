...
switch($POST_acc){
		...
		break;
			...
			if($InsCliente->MtdActualizarClienteEstado($POST_seleccionados,"1")){
				$Resultado .= "#SAS_CLI_109";
			}else{
		...
		case 'ActualizarInactivo':
			...
			if($InsCliente->MtdActualizarClienteEstado($POST_seleccionados,"2")){
				$Resultado .= "#SAS_CLI_110";
			}else{
				$Resultado .= "#ERR_CLI_110";
			}
