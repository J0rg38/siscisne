...
if(isset($_POST['BtnGuardar_x']) or $_POST['Guardar']=="1"){	
	...
	if(!empty($InsCliente->CliNumeroDocumento)){
		...
		$ClienteId = $InsCliente->MtdVerificarClienteExiste("CliNumeroDocumento",$InsCliente->CliNumeroDocumento);
		
		if(!empty($ClienteId)){
			$Guardar = false;
			$Resultado.='#ERR_CLI_603';
		}
...
function FncNuevo(){
	...
	$InsCliente->PerId = $_SESSION['SesionPersonal'];
