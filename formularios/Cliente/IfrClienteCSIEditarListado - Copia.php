...
$ResReporteFichaIngreso = $InsReporteFichaIngreso->MtdObtenerReporteFichaIngresoClientes(NULL,NULL,NULL ,$POST_ord ,$POST_sen,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,$POST_Sucursal);
...
<!--<input  <?php echo (($DatReporteFichaIngreso->CliCSIIncluir==1)?'checked="checked"':'')?>  type="checkbox" name="CmpClienteCSIincluir_<?php echo $DatReporteFichaIngreso->CliId; ?>" id="CmpClienteCSIincluir_<?php echo $DatReporteFichaIngreso->CliId; ?>" value="<?php echo $DatReporteFichaIngreso->CliId; ?>" onChange="FncClienteCSIEditarAccion('<?php echo $DatReporteFichaIngreso->CliId; ?>');" etiqueta="cliente" >
         --> <input  <?php echo (($DatReporteFichaIngreso->CliCSIIncluir==1)?'checked="checked"':'')?>  type="checkbox" name="CmpClienteCSIincluir_<?php echo $DatReporteFichaIngreso->CliId; ?>" id="CmpClienteCSIincluir_<?php echo $DatReporteFichaIngreso->CliId; ?>" value="<?php echo $DatReporteFichaIngreso->CliId; ?>" etiqueta="cliente" >
         
          
          </td>
          <td align="center" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" ><input name="CmpClienteCSIExcluirMotivo_<?php echo $DatReporteFichaIngreso->CliId;?>" type="text" class="EstFormularioCaja" id="CmpClienteCSIExcluirMotivo_<?php echo $DatReporteFichaIngreso->CliId;?>" value="<?php echo $DatReporteFichaIngreso->CliCSIExcluirMotivo;?>" size="25" maxlength="255" /></td>
<td align="center" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" >
