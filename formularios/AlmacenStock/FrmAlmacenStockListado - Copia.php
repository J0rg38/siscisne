...
if($POST_IncluirReemplazo == "1"){
	...
	$ResProductoReemplazo = $InsProductoReemplazo->MtdObtenerProductoReemplazos("PreCodigo1,PreCodigo2,PreCodigo3,PreCodigo4,PreCodigo5,PreCodigo6,PreCodigo7,PreCodigo8,PreCodigo9,PreCodigo10","esigual",$POST_fil,"PreId","ASC",NULL,1);
...
//MtdObtenerAlmacenStocks($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'AstNombre',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oProductoTipo=NULL,$oVehiculoMarca=NULL,$oReferencia=NULL,$oProducto=NULL,$oProductoCategoria=NULL,$oAlmacen=NULL,$oTieneMovimiento=false,$oSucursal=NULL)
...
<select class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
  ...
  <td><input class="EstFormularioBoton" name="btn_buscar" type="submit" onclick="javascript:FncBuscar();" id="btn_buscar" value="Filtrar" /></td>
</tr>
<tr>
  <td>&nbsp;</td>
  <td align="right">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="EstTablaListado" >
      ...
      <thead class="EstTablaListadoHead">
              ...
              <tr>
				...
				?>                </th>
                <th width="7%"><?php
				if($POST_ord == "AstPedidoTipo"){
					if($POST_sen == "DESC"){
				?>
                  <a href="javascript:FncOrdenar('AstPedidoTipo','ASC');">  Pedido Tipo <img src="imagenes/ascendente.png" border="0" title="Ascendente" alt="[Ascendente]" width="15" height="15" align="absmiddle" /></a>
                  <?php
					}else{
				?>
                  <a href="javascript:FncOrdenar('AstPedidoTipo','DESC');">  <img src="imagenes/descendente.png" border="0" title="Descendente" alt="[Descendente]"  width="15" height="15"  align="absmiddle"  /></a>
                  <?php
					}
				}else{
				...
				?>
                  <a href="javascript:FncOrdenar('AstPedidoTipo','ASC');"> Pedido Tipo </a>
                  <?php
				}
				?></th>
                <th width="7%">Disp.  GM
	...
	<a class="EstPaginacion"  href="javascript:FncPaginar('<?php echo $num?>,<?php echo $numxpag;?>','<?php echo $i?>');" ><?php echo $i?></a>                        
            ...
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td align="right" ><?php echo $dat->AstPromedioMensual; ?></td>
...
?>
                  <?php
    $Reemplazo = "NO";
     $ResProductoReemplazo = $InsProductoReemplazo->MtdObtenerProductoReemplazos("PreCodigo1,PreCodigo2,PreCodigo3,PreCodigo4,PreCodigo5,PreCodigo6,PreCodigo7,PreCodigo8,PreCodigo9,PreCodigo10","esigual",$dat->ProCodigoOriginal ,"PreTiempoCreacion","DESC",NULL,1);
    $ArrProductoReemplazos = $ResProductoReemplazo['Datos'];
