...
?>
                ...
                <tr>
                  ...
                  <td align="right"><a href="javascript:FncAlmacenStockCargarEntradas();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncAlmacenMovimientoSalidaDetalleEliminarTodo();"></a></td>
                  <td><div id="CapAlmacenMovimientoSalidaDetallesResultado"> </div></td>
                  </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="4">
...
?>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="3"><div id="CapAlmacenStockSalidaAccion"></div></td>
                  <td align="right"><a href="javascript:FncAlmacenStockCargarSalidas();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncAlmacenMovimientoSalidaDetalleEliminarTodo();"></a></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
...
?>
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td align="right">STOCK:                    <input name="CmpStock" type="text" class="EstFormularioCajaDeshabilitada" id="CmpStock" value="<?php echo number_format($StockReal,3)?>" size="10" readonly="readonly"            /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
