...
// MtdObtenerNotaCreditoCompras($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'NccId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oMoneda=NULL,$oVehiculoMovimientoEntrada=NULL,$oProveedor=NULL)
$ResNotaCreditoCompra = $InsNotaCreditoCompra->MtdObtenerNotaCreditoCompras(NULL,NULL,NULL,"NNccFechaEmision","ASC",NULL,"3",NULL,NULL,NULL,$GET_VmvId,NULL);
