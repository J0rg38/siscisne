...
<td align="right">
  ...
  <!--<a  href="javascript:FncVehiculoMovimientoEntradaProveedorEscoger('<?php echo $_POST['Tipo']?>','<?php echo $_POST['Ruta']?>','<?php echo $DatProveedor->PrvId;?>','<?php echo $DatProveedor->PrvNumeroDocumento;?>','<?php echo $DatProveedor->PrvNombre;?>','<?php echo $DatProveedor->PrvDireccion;?>','<?php echo $DatProveedor->TdoId;?>');">
