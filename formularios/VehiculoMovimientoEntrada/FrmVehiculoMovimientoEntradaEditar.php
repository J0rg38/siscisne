...
?>
  ...
  $InsVehiculoMovimientoEntrada = new ClsVehiculoMovimientoEntrada($InsMysql);
                      ...
                      <div class="EstFormularioArea">
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><input class="EstFormularioCajaFecha" name="CmpFecha" type="text" id="CmpFecha" value="<?php if (empty($InsVehiculoMovimientoEntrada->VmvFecha)) {
                                                                                                                                                    echo date("d/m/Y");
                                                                                                                                                  } else {
                                                                                                                                                    echo $InsVehiculoMovimientoEntrada->VmvFecha;
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><select disabled="disabled" class="EstFormularioCombo" name="CmpTipoOperacion" id="CmpTipoOperacion">
                                ...
                                ?>
                                  <option value="<?php echo $DatTipoOperacion->TopId ?>" <?php if ($InsVehiculoMovimientoEntrada->TopId == $DatTipoOperacion->TopId) {
                            ...
                            <td align="left" valign="top"><input name="CmpOrdenCompra" type="text" class="EstFormularioCajaDeshabilitada" id="CmpOrdenCompra" value="<?php echo $InsVehiculoMovimientoEntrada->OcoId;  ?>" size="20" maxlength="20" readonly="readonly" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            ...
                            <td align="left" valign="top"><input name="CmpGuiaRemisionNumeroSerie" type="text" class="EstFormularioCaja" id="CmpGuiaRemisionNumeroSerie" value="<?php echo $InsVehiculoMovimientoEntrada->VmvGuiaRemisionNumeroSerie; ?>" size="10" maxlength="50" />
                              -
                              <input name="CmpGuiaRemisionNumeroNumero" type="text" class="EstFormularioCaja" id="CmpGuiaRemisionNumeroNumero" value="<?php echo $InsVehiculoMovimientoEntrada->VmvGuiaRemisionNumeroNumero; ?>" size="20" maxlength="50" />
                            </td>
                                ...
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    ...
                                    <td width="50%" align="right">
                                      <div class="EstFormularioAccion" id="CapVehiculoMovimientoEntradaGuiaRemisionFotosAccion">Listo
                                  ...
                                  <tr>
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                                        <tr>
                                          <td width="275" colspan="2" align="left" valign="top">
                                            <div id="fileUploadVehiculoMovimientoEntradaGuiaRemisionFoto">Escoger Archivo</div>
                                            <script type="text/javascript">
                                              $(document).ready(function() {
                                        ...
                                        <tr>
                                          <td colspan="2" align="left" valign="top">
                                            <div class="EstCapVehiculoMovimientoEntradaGuiaRemisionFotos" id="CapVehiculoMovimientoEntradaGuiaRemisionFotos"></div>
                                          </td>
                                    ...
                                    <td>
                                      <div id="CapVehiculoMovimientoEntradaGuiaRemisionFotosResultado"> </div>
                                    </td>
                                  </tr>
                                </table>
                              </div>
                        ...
                        ?>
                        <option value="<?php echo $DatAlmacen->AlmId ?>" <?php if ($InsVehiculoMovimientoEntrada->AlmId == $DatAlmacen->AlmId) {
                                                                            echo 'selected="selected"';
                        ...
                        ?>
                              ...
                              <select disabled="disabled" class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
                                ...
                                ?>
                                  <option value="<?php echo $DatSucursal->SucId; ?>" <?php if ($InsVehiculoMovimientoEntrada->SucId == $DatSucursal->SucId) {
                                                                                        echo 'selected="selected"';
                              ...
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                <tr>
                                  ...
                                  <td colspan="18"><span class="EstFormularioSubTitulo">VEHICULOS</span>
                                    ...
                                    <input name="CmpVehiculoMovimientoEntradaDetalleId" type="hidden" class="EstFormularioCaja" id="CmpVehiculoMovimientoEntradaDetalleId" size="3" maxlength="20" />
                                  </td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td valign="top">
                                    <div id="CapVehiculoIngresoBuscar"></div>
                                  </td>
                                  <td valign="top">VIN:
                                    <input name="CmpVehiculoIngresoId" type="hidden" id="CmpVehiculoIngresoId" value="" size="3" />
                                  </td>
                                  <td valign="top">&nbsp;</td>
                                  <td align="left" valign="top">&nbsp;</td>
                                  <td align="left" valign="top">Codigo Unico:
                                    <input name="CmpVehiculoId" type="hidden" id="CmpVehiculoId" size="3" />
                                  </td>
                                  <td align="left" valign="top">Marca:
                                    <input name="CmpVehiculoIngresoMarcaId" type="hidden" id="CmpVehiculoIngresoMarcaId" size="3" />
                                  </td>
                                  <td align="left" valign="top">Modelo:
                                    <input name="CmpVehiculoIngresoModeloId" type="hidden" id="CmpVehiculoIngresoModeloId" size="3" />
                                  </td>
                                  <td align="left" valign="top">Version:
                                    <input name="CmpVehiculoIngresoVersionId" type="hidden" id="CmpVehiculoIngresoVersionId" size="3" />
                                  </td>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><a href="javascript:FncVehiculoMovimientoEntradaDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                                  ...
                                  <td valign="middle"><select disabled="disabled" class="EstFormularioCombo" name="CmpVehiculoMovimientoEntradaDetalleUnidadMedida" id="CmpVehiculoMovimientoEntradaDetalleUnidadMedida">
                                      <option value="">Escoja una opcion</option>
                                      <?php
                                  ...
                                  <td valign="middle"><input name="CmpVehiculoMovimientoEntradaDetalleCantidad" type="text" class="EstFormularioCaja" id="CmpVehiculoMovimientoEntradaDetalleCantidad" size="8" maxlength="10" /></td>
                                  ...
                                  <td valign="middle"><input name="CmpVehiculoMovimientoEntradaDetalleImporte" type="text" class="EstFormularioCaja" id="CmpVehiculoMovimientoEntradaDetalleImporte" size="8" maxlength="10" /></td>
                                  <td><a href="javascript:FncVehiculoMovimientoEntradaDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                      ...
                      <div class="EstFormularioArea">
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="49%">
                              <div class="EstFormularioAccion" id="CapVehiculoAccion">Listo
                                para registrar elementos</div>
                            </td>
                            <td width="49%" align="right"><a href="javascript:FncVehiculoMovimientoEntradaDetalleListar();">
                              ...
                              <!--<a href="javascript:FncVehiculoMovimientoEntradaDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>-->


                            </td>
                            <td width="1%">
                              <div id="CapVehiculoMovimientoEntradaDetallesResultado"> </div>
                            </td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2">
                              <div id="CapVehiculoMovimientoEntradaDetalles" class="EstCapVehiculoMovimientoEntradaDetalles"> </div>
                            </td>
                            <td>&nbsp;</td>
                          </tr>
                        </table>
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              ...
                              :
                              <input name="CmpProveedorId" type="hidden" id="CmpProveedorId" value="<?php echo $InsVehiculoMovimientoEntrada->PrvId; ?>" size="3" />
                            </td>
                            <td align="left" valign="top">
                            ...
                            <td align="left" valign="top">Proveedor:
                              ...
                              <input class="EstFormularioCaja" name="CmpProveedorApellidoMaterno" type="hidden" id="CmpProveedorApellidoMaterno" value="<?php echo $InsVehiculoMovimientoEntrada->PrvApellidoMaterno; ?>" size="45" maxlength="255" />
                            </td>
                            <td align="left" valign="top"><input class="EstFormularioCaja" name="CmpProveedorNombreCompleto" type="text" id="CmpProveedorNombreCompleto" value="<?php echo $InsVehiculoMovimientoEntrada->PrvNombreCompleto; ?>" size="45" maxlength="255" /> <a href="formularios/VehiculoMovimientoEntrada/FrmProveedorBuscar.php?height=440&width=850" class="thickbox" title="">
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span id="spryselect3">
                                <select class="EstFormularioCombo" name="CmpComprobanteTipo" id="CmpComprobanteTipo">
                                  ...
                                  ?>
                                    <option value="<?php echo $DatComprobanteTipo->CtiId ?>" <?php if ($InsVehiculoMovimientoEntrada->CtiId == $DatComprobanteTipo->CtiId) {
                                                                                                echo 'selected="selected"';
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top">
                              <input name="CmpComprobanteNumeroSerie" type="text" class="EstFormularioCaja" id="CmpComprobanteNumeroSerie" value="<?php echo $InsVehiculoMovimientoEntrada->VmvComprobanteNumeroSerie; ?>" size="10" maxlength="50" />
                              -
                              <input name="CmpComprobanteNumeroNumero" type="text" class="EstFormularioCaja" id="CmpComprobanteNumeroNumero" value="<?php echo $InsVehiculoMovimientoEntrada->VmvComprobanteNumeroNumero; ?>" size="20" maxlength="50" />
                            </td>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><select name="CmpCondicionPago" id="CmpCondicionPago" class="EstFormularioCombo">
                                ...
                                ?>
                                  <option <?php if ($InsVehiculoMovimientoEntrada->NpaId == $DatCondicionPago->NpaId) {
                                            echo 'selected="selected"';
                          ...
                          <tr>
                                ...
                                <tr>
                                  <td><span id="spryselect2">
                                      <select class="EstFormularioCombo" name="CmpMonedaId" id="CmpMonedaId">
                                        ...
                                        ?>
                                          <option value="<?php echo $DatMoneda->MonId ?>" <?php if ($InsVehiculoMovimientoEntrada->MonId == $DatMoneda->MonId) {
                                                                                            echo 'selected="selected"';
                            ...
                            <td align="left" valign="top">
                              <?php
                              //	deb($InsVehiculoMovimientoEntrada);
                              ?>
                              ...
                              <table>
                                <tr>
                                  <td>
                                    ...
                                    <input name="CmpTipoCambio" type="text" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncVehiculoMovimientoEntradaDetalleListar();" value="<?php if (empty($InsVehiculoMovimientoEntrada->VmvTipoCambio)) {
                                                                                                                                                                                                        echo "";
                                                                                                                                                                                                      } else {
                                                                                                                                                                                                        echo $InsVehiculoMovimientoEntrada->VmvTipoCambio;
                                                                                                                                                                                                      } ?>" size="10" maxlength="10" readonly="readonly" />

                                    <input name="CmpTipoCambioComercial" type="hidden" class="EstFormularioCajaDeshabilitada" id="CmpTipoCambioComercial" value="<?php if (empty($InsVehiculoMovimientoEntrada->VmvTipoCambioComercial)) {
                                                                                                                                                                    echo "";
                                                                                                                                                                  } else {
                                                                                                                                                                    echo $InsVehiculoMovimientoEntrada->VmvTipoCambioComercial;
                              ...
                              <div class="EstFormularioArea">
                                <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                                  <tr>
                                    ...
                                    <td width="50%" align="right">
                                      <div class="EstFormularioAccion" id="CapVehiculoMovimientoEntradaFotosAccion">Listo
                                        para registrar elementos</div>
                                    </td>
                                    <td width="1%">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td colspan="2">
                                      <table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                                        <tr>
                                          <td width="275" colspan="2" align="left" valign="top">
                                            <div id="fileUploadVehiculoMovimientoEntradaFoto">Escoger Archivo</div>
                                            <script type="text/javascript">
                                              $(document).ready(function() {
                                        ...
                                        <tr>
                                          <td colspan="2" align="left" valign="top">
                                            <div class="EstCapVehiculoMovimientoEntradaFotos" id="CapVehiculoMovimientoEntradaFotos"></div>
                                          </td>
                                          <td align="left" valign="top">&nbsp;</td>
                                        </tr>
                                      </table>
                                    ...
                                    <td>
                                      <div id="CapVehiculoMovimientoEntradaFotosResultado"> </div>
                                    </td>
                                  </tr>
                                </table>
                              </div>
