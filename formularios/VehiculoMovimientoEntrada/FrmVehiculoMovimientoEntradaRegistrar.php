                              ...
                              <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                  ...
                                  <td valign="middle">
                                    ...
                                    <input name="CmpVehiculoMovimientoEntradaDetalleCantidad" type="text" class="EstFormularioCaja" id="CmpVehiculoMovimientoEntradaDetalleCantidad" size="8" maxlength="10" />
                                  </td>
                                  ...
                                  <td valign="middle">
                                    ...
                                    <input name="CmpVehiculoMovimientoEntradaDetalleImporte" type="text" class="EstFormularioCaja" id="CmpVehiculoMovimientoEntradaDetalleImporte" size="8" maxlength="10" />
                                  </td>
