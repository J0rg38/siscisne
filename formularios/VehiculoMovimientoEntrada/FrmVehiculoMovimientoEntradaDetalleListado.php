...
?>
       ...
       <!--     
 <a href="javascript:FncVehiculoMovimientoEntradaDetalleReemplazorCargar('<?php echo  $Identificador;?>','<?php echo trim($DatSesionObjeto->Item);?>');"><?php echo $DatSesionObjeto->Parametro17;?></a>-->
...
-->
            ...
            <td align="right"><?php echo number_format($DatSesionObjeto->Parametro5,2);?> <br /></td>
            <td align="right">
			...
			<!--<select  class="EstFormularioCombo" name="CmpVehiculoMovimientoEntradaDetalleEstado_<?php echo $DatSesionObjeto->Item;?>" id="CmpVehiculoMovimientoEntradaDetalleEstado_<?php echo $DatSesionObjeto->Item;?>" <?php echo ($POST_Editar==2 or  $VehiculoMovimientoEntradaDetalleFacturado == "1" or $VehiculoMovimientoEntradaDetalleCierre == "1")?'disabled="disabled"':'';?>>
  <option value="">-</option>
  ...
  <option <?php echo (($DatSesionObjeto->Parametro25=="3")?'selected="selected"':'');?> value="3">Conforme</option>
            ...
            <a class="EstSesionObjetosItem" href="javascript:FncVehiculoMovimientoEntradaDetalleEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
            ...
            if($_POST['Eliminar']==1){
            ?>
            <a href="javascript:FncVehiculoMovimientoEntradaDetalleEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
