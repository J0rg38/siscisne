...
<title>Movimiento de Compra de Vehiculo No. <?php echo $InsVehiculoMovimientoEntrada->VmvId;?></title>

<link rel="stylesheet" type="text/css" href="<?php echo $InsProyecto->MtdRutEstilos();?>CssReporte.css">
<link href="css/CssVehiculoMovimientoEntradaImprimir.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="js/JsVehiculoMovimientoEntradaImprimir.js"></script>
...
<tr>
  ...
  <td width="52%" align="center" valign="top"><span class="EstReporteTitulo">COMPRA DE VEHICULO
...
<tr>
    ...
    <tr>
      <td colspan="5" align="left" valign="top"><span class="EstVehiculoMovimientoEntradaImprimirCabecera">Datos de la Compra de Vehiculo</span></td>
    ...
    <tr>
      <td align="left" valign="top" class="EstVehiculoMovimientoEntradaImprimirEtiquetaFondo"><span class="EstVehiculoMovimientoEntradaImprimirEtiqueta">Numero de Guia de Remision:</span></td>
      <td align="left" valign="top" ><span class="EstVehiculoMovimientoEntradaImprimirContenido"><?php echo $InsVehiculoMovimientoEntrada->VmvGuiaRemisionNumero;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
      <td align="left" valign="top" class="EstVehiculoMovimientoEntradaImprimirEtiquetaFondo"><span class="EstVehiculoMovimientoEntradaImprimirEtiqueta">Fecha de Guia Remision:</span></td>
      <td align="left" valign="top" ><span class="EstVehiculoMovimientoEntradaImprimirContenido"><?php echo $InsVehiculoMovimientoEntrada->VmvGuiaRemisionFecha;?></span></td>
      <td align="left" valign="top">&nbsp;</td>
    </tr>
    <tr>
...
<tr>
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="2" class="EstVehiculoMovimientoEntradaImprimirTabla">
    <tr>
      <td colspan="5" align="left" valign="top" class="EstVehiculoMovimientoEntradaImprimirCabecera">Comprobante de Pago</td>
      <td align="left" valign="top">&nbsp;</td>
      </tr>
    <tr>
      <td width="24%" align="left" valign="top" class="EstVehiculoMovimientoEntradaImprimirEtiquetaFondo"><span class="EstVehiculoMovimientoEntradaImprimirEtiqueta"> R.U.C.:</span></td>
      <td width="22%" align="left" valign="top" ><span class="EstVehiculoMovimientoEntradaImprimirContenido"><?php echo $InsVehiculoMovimientoEntrada->PrvNumeroDocumento;?></span></td>
      <td width="1%" align="left" valign="top">&nbsp;</td>
      <td width="22%" align="left" valign="top" class="EstVehiculoMovimientoEntradaImprimirEtiquetaFondo"><span class="EstVehiculoMovimientoEntradaImprimirEtiqueta">Proveedor:</span></td>
      <td width="29%" align="left" valign="top" ><span class="EstVehiculoMovimientoEntradaImprimirContenido"><?php echo $InsVehiculoMovimientoEntrada->PrvNombreCompleto;?></span></td>
      <td width="2%" align="left" valign="top">&nbsp;</td>
      </tr>
    <tr>
    ...
    <tr>
      <td align="left" valign="top" class="EstVehiculoMovimientoEntradaImprimirEtiquetaFondo"><span class="EstVehiculoMovimientoEntradaImprimirEtiqueta">Numero de Comprobante:</span></td>
      ...
      <td align="left" valign="top">&nbsp;</td>
      <td align="left" valign="top" class="EstVehiculoMovimientoEntradaImprimirEtiquetaFondo"><span class="EstVehiculoMovimientoEntradaImprimirEtiqueta">Fecha de Comprobante:</span></td>
