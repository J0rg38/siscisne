	...
	var Tipo = prompt("Escoja el tipo de reporte \n 1 = Resumido\n 2 = Detallado", "1");
			...
			if(Tipo !== null){
				switch(Tipo.toUpperCase()){
					case "1":
	document.getElementById("FrmListado").action = "formularios/VehiculoMovimientoEntrada/acc/AccVehiculoMovimientoEntradaGenerarExcel.php";
					break;
					
					case "2":
	document.getElementById("FrmListado").action = "formularios/VehiculoMovimientoEntrada/acc/AccVehiculoMovimientoEntradaGenerarExcel2.php";
					break;
...
function FncImprmir(oId){
	FncPopUp('formularios/VehiculoMovimientoEntrada/FrmVehiculoMovimientoEntradaImprimir.php?Id='+oId+'&P=1',0,0,1,0,0,1,0,screen.height,screen.width);
}

function FncVistaPreliminar(oId){
	FncPopUp('formularios/VehiculoMovimientoEntrada/FrmVehiculoMovimientoEntradaImprimir.php?Id='+oId,0,0,1,0,0,1,0,screen.height,screen.width);
}
...
function FncNotaCreditoCompraListado(oVmvId){
	
	//FncPopUp('formularios/VehiculoMovimientoEntrada/DiaNotaCreditoCompraListado.php?VmvId='+oVmvId,0,0,1,0,0,1,0,screen.height,screen.width);
	
	tb_show(this.title,'formularios/VehiculoMovimientoEntrada/DiaNotaCreditoCompraListado.php?VmvId='+oVmvId,this.rel);		
