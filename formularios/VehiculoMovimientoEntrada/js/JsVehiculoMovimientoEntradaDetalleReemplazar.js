...
//function FncVehiculoEscoger(oProId,oProNombre,oProPrecio,oProCosto,oProFoto,oProEspecificacion,oRtiId,oUmeId,oProCodigoOriginal,oProCodigoAlternativo,oUnidadMedidaIngreso,oProCostoIngreso,oProCostoIngresoNeto,oVmdId,oProValorVenta){	

function FncVehiculoEscoger(InsVehiculo){	


//FncVehiculoEscoger(InsVehiculo.ProId,InsVehiculo.ProNombre,InsVehiculo.ProPrecio,InsVehiculo.ProCosto,InsVehiculo.ProFoto,InsVehiculo.ProEspecificacion,InsVehiculo.RtiId,InsVehiculo.UmeId,InsVehiculo.ProCodigoOriginal,InsVehiculo.ProCodigoAlternativo,InsVehiculo.UmeIdIngreso,InsVehiculo.ProCostoIngreso,InsVehiculo.ProCostoIngresoNeto,InsVehiculo.VmdId);
...
//	$('#CmpVehiculoCodigoAlternativo').val(InsVehiculo.ProCodigoAlternativo);
	...
	//$('#CmpVehiculoMovimientoEntradaDetalleId').val(InsVehiculo.VmdId);
