...
$POST_Costo = $_POST['VehiculoMovimientoEntradaDetalleCosto'];
$POST_Cantidad = $_POST['VehiculoMovimientoEntradaDetalleCantidad'];
$POST_Importe = $_POST['VehiculoMovimientoEntradaDetalleImporte'];
$POST_Estado = $_POST['VehiculoMovimientoEntradaDetalleEstado'];
$POST_VehiculoMovimientoEntradaDetalleUnidadMedida = $_POST['VehiculoMovimientoEntradaDetalleUnidadMedida'];



$POST_CostoAnterior = $_POST['VehiculoMovimientoEntradaDetalleCostoAnterior'];
$POST_Utilidad = $_POST['VehiculoMovimientoEntradaDetalleUtilidad'];
$POST_UtilidadPorcentaje = $_POST['VehiculoMovimientoEntradaDetalleUtilidadPorcentaje'];
...
//Parametro28 = UmeNombre
	...
	$InsVehiculoMovimientoEntradaDetalle1->Parametro16,
