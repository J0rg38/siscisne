...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoEntrada.js" ></script>
<?php
/* 
...
//if(empty($POST_Moneda)){$POST_Moneda = "MON-10001";}
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoMovimientoEntrada.php');
...
<tr>
  ...
  <span class="EstFormularioTitulo">LISTADO DE COMPRAS DE VEHICULOS</span>  </td>
</tr>
<tr>
  <td width="47%">
...
<!--    <select class="EstFormularioCombo" name="Cam" id="Cam">
    ...
    <option value="VmvFecha" <?php if($POST_TipoFecha=="VmvFecha"){ echo 'selected="selected"';}?>>Fecha Ingreso</option>
...
?>    
				...
				<?php //echo $dat->VmvEstadoIcono;?> <?php echo $dat->VmvEstadoDescripcion;?>
                  <?php
				/*switch($dat->VmvEstado){
...
?></td>
                <td  width="2%" align="right" ><?php            
if(!empty($dat->VmvGuiaRemisionFoto)){
	
	$extension = strtolower(pathinfo($dat->VmvGuiaRemisionFoto, PATHINFO_EXTENSION));
	$nombre_base = basename($dat->VmvGuiaRemisionFoto, '.'.$extension);  
?>
                 <!-- <a  class="thickbox" href="subidos/vehiculo_movimiento_fotos/<?php echo $dat->VmvGuiaRemisionFoto;?>"  title="">-->
                   <a   href="javascript:FncVisualizarArchivo('subidos/vehiculo_movimiento_fotos/<?php echo $dat->VmvGuiaRemisionFoto;?>')">
