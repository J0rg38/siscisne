...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteFichaIngresoSinFacturar.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE ORDENES DE TRABAJO SIN FACTURAR</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteFichaIngresoSinFacturar.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFichaIngresoSinFacturar.php" target="IfrReporteFichaIngresoSinFacturar" method="GET" name="FrmReporteFichaIngresoSinFacturar" id="FrmReporteFichaIngresoSinFacturar">
    ...
    ?>
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      ...
                      <option value="FinFecha" selected="selected">Fecha</option>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteFichaIngresoSinFacturarImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteFichaIngresoSinFacturarGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="EstReporteCapaListado autoheight" target="IfrReporteFichaIngresoSinFacturar" id="IfrReporteFichaIngresoSinFacturar" name="IfrReporteFichaIngresoSinFacturar" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>
