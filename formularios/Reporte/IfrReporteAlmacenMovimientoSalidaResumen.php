...
$ResTallerPedidoDetalle = $InsReporteAlmacenMovimiento->MtdObtenerTallerPedidoDetalles(NULL,NULL,NULL,'AmdId','Desc',NULL,NULL,3,NULL,NULL,NULL,$oProductoTipo,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,$POST_Sucursal);
...
$ResVentaConcretadaDetalle = $InsReporteAlmacenMovimiento->MtdObtenerVentaConcretadaDetalles(NULL,NULL,'AmdId','Desc',NULL,NULL,3,NULL,NULL,NULL,NULL,$oProductoTipo,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_Sucursal);
...
<?php }?>
        ...
        ?>
                ...
                <td bgcolor="<?php echo $fondo;?>"  align="right" valign="top"   ><?php echo ($DatTallerPedidoDetalle->TopNombre);?></td>
        ...
        <span class="EstTablaReporteTitulo">ORDENES DE VENTA(VENTAS X MOSTRADOR)</span>
        ...
        ?>
                ...
                <td bgcolor="<?php echo $fondo;?>"  align="right" valign="top"   ><?php echo ($DatVentaConcretadaDetalle->TopNombre);?></td>
