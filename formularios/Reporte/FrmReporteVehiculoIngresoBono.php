...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE BONOS DE VEHICULOS</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteVehiculoIngresoBono.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteVehiculoIngresoBono.php" target="IfrReporteVehiculoIngresoBono" method="post" name="FrmReporteVehiculoIngresoBono" id="FrmReporteVehiculoIngresoBono">
...
<tr>
  ...
  <td align="left">&nbsp;</td>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteVehiculoIngresoBonoImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteVehiculoIngresoBonoGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteVehiculoIngresoBono.php" target="IfrReporteVehiculoIngresoBono" id="IfrReporteVehiculoIngresoBono" name="IfrReporteVehiculoIngresoBono" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
-->
<iframe class="autoHeight"  src="" target="IfrReporteVehiculoIngresoBono" id="IfrReporteVehiculoIngresoBono" name="IfrReporteVehiculoIngresoBono" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
