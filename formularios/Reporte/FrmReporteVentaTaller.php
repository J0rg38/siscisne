...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsReporteVentaTaller.js"></script>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="98%" height="25">
          <span class="EstFormularioTitulo">REPORTE DE VENTAS X TALLER</span>
        </td>
        <td width="2%"><a href="formularios/Reporte/inf/InfReporteVentaTaller.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
      </tr>

      <tr>
        <td colspan="2" align="center">
          <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios(); ?>Reporte/IfrReporteVentaTaller.php" target="IfrReporteVentaTaller" method="post" name="FrmReporteVentaTaller" id="FrmReporteVentaTaller">
      -->
                  ...
                  <table border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td><select class="EstFormularioCombo" name="CmpPersonal" id="CmpPersonal">
                          ...
                          ?>
                            <option <?php if ($_SESSION['SesionPersonal'] == $DatTecnico->PerId) {
                                      echo 'selected="selected"';
                                    } ?> value="<?php echo $DatTecnico->PerId; ?>"><?php echo $DatTecnico->PerNombre ?> <?php echo $DatTecnico->PerApellidoPaterno; ?> <?php echo $DatTecnico->PerApellidoMaterno; ?></option>
                          <?php
                          }
                          ?>
                        </select></td>
      ...
      <tr>
        <td colspan="2" align="center">
          ...
          <div class="EstReporteCapaListado autoheight" id="CapReporteVentaTaller"></div>
