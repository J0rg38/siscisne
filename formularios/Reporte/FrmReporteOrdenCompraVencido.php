...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteOrdenCompraVencido.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE ORDEN DE COMPRA VENCIDOS</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteOrdenCompraVencido.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteOrdenCompraVencido.php" target="IfrReporteOrdenCompraVencido" method="post" name="FrmReporteOrdenCompraVencido" id="FrmReporteOrdenCompraVencido">
  ...
  <tr>
    ...
    <td><input class="EstFormularioCaja" name="CmpProveedorNombre" type="text" id="CmpProveedorNombre" size="40" maxlength="255"   value="<?php echo $ProveedorNombre;?> <?php echo $ProveedorApellidoPaterno;?> <?php echo $ProveedorApellidoMaterno;?>"/></td>
    <td>&nbsp;</td>
  </tr>
  </table>
            </fieldset>                  </td>
...
<fieldset  class="EstFormularioContenedor">
            ...
            <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">  
              ...
              <tr>
                <td>Dias:</td>
                <td><input name="CmpDiaTranscurrido" type="text" class="EstFormularioCaja" id="CmpDiaTranscurrido" value="180" size="10" maxlength="10"/></td>
              </tr>
              </table>
          </fieldset> 
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteOrdenCompraVencidoImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteOrdenCompraVencidoGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="autoHeight"  src="" target="IfrReporteOrdenCompraVencido" id="IfrReporteOrdenCompraVencido" name="IfrReporteOrdenCompraVencido" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
