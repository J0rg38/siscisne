				 ...
				 $objPHPExcel->setActiveSheetIndex(0)
								...
								->setCellValue("AF".$Fila, ($DatReporteResumenVenta->RvrPrecioSFinal));
								 ...
								 ->setCellValue("AG".$Fila, ($DatReporteResumenVenta->RvrDescuentoSFinal));
								  ...
								  $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("AH".$Fila, ($DatReporteResumenVenta->RvrPrecioDescuentoSFinal));
								
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AI".$Fila, ($DatReporteResumenVenta->RvrImporteSFinal));
								
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AJ".$Fila, ($DatReporteResumenVenta->RvrImporteDescuentoSFinal));
								
								
								 
								 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("AK".$Fila, ($DatReporteResumenVenta->RvrPrecioUSFinal));
								
								 $objPHPExcel->setActiveSheetIndex(0)
								 ->setCellValue("AL".$Fila, ($DatReporteResumenVenta->RvrDescuentoUSFinal));
								 
								  $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("AM".$Fila, ($DatReporteResumenVenta->RvrPrecioDescuentoUSFinal));
								
								 
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AN".$Fila, ($DatReporteResumenVenta->RvrImporteUSFinal));
								
									 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AO".$Fila, ($DatReporteResumenVenta->RvrImporteDescuentoUSFinal));
								
								
								 
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AP".$Fila, ($DatReporteResumenVenta->RvrModalidad));

								$objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AQ".$Fila, ($DatReporteResumenVenta->RvrNotaCredito));

								$objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AR".$Fila, ($DatReporteResumenVenta->RvrNotaCreditoTotal));
								
								$objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AS".$Fila, ($DatReporteResumenVenta->VmaNombre));
