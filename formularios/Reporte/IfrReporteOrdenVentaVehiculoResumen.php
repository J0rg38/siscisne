...
$POST_finicio = isset($_GET['CmpFechaInicio'])?$_GET['CmpFechaInicio']:"01/".date("m/Y");
...
$POST_ord = isset($_GET['CmpOrden'])?$_GET['CmpOrden']:"OvvId";
$POST_sen = isset($_GET['CmpSentido'])?$_GET['CmpSentido']:"DESC";

$POST_Moneda = ($_GET['CmpMoneda']);

$POST_ConCotizacion = ($_GET['CmpConCotizacion']);
