...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteFichaIngresoMantenimientoModeloMensual.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE CUADRO DE ORDENES DE TRABAJO X MODELO X TIPO CLIENTE X AÑO (MANTENIMIENTOS)</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteFichaIngresoMantenimientoModeloMensual.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFichaIngresoMantenimientoModeloMensual.php" target="IfrReporteFichaIngresoMantenimientoModeloMensual" method="post" name="FrmReporteFichaIngresoMantenimientoModeloMensual" id="FrmReporteFichaIngresoMantenimientoModeloMensual">
...
<tr>
  ...
  <td align="left"><span id="spryselect2">
    ...
    <span class="selectRequiredMsg">Seleccione un elemento.</span></span></td>
  <td align="left">Tipo Cli.</td>
  <td colspan="4" align="left"><span id="spryselect3">
...
<tr>
  ...
  <td colspan="4" align="left"></td>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteFichaIngresoMantenimientoModeloMensualImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteFichaIngresoMantenimientoModeloMensualGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFichaIngresoMantenimientoModeloMensual.php" target="IfrReporteFichaIngresoMantenimientoModeloMensual" id="IfrReporteFichaIngresoMantenimientoModeloMensual" name="IfrReporteFichaIngresoMantenimientoModeloMensual" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
-->
<iframe class="autoHeight"  src="" target="IfrReporteFichaIngresoMantenimientoModeloMensual" id="IfrReporteFichaIngresoMantenimientoModeloMensual" name="IfrReporteFichaIngresoMantenimientoModeloMensual" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
