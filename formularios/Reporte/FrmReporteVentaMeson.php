...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsReporteVentaMeson.js"></script>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="98%" height="25">
          ...
          <span class="EstFormularioTitulo">RESUMEN DE VENTAS X MESON</span>
        </td>
        <td width="2%"><a href="formularios/Reporte/inf/InfReporteVentaMeson.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
      </tr>

      <tr>
        <td colspan="2" align="center">

          <form enctype="multipart/form-data" action="#" method="post" name="FrmReporteVentaMeson" id="FrmReporteVentaMeson" onsubmit="return false;">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <select <?php echo ((!$PrivilegioMultisucursal) ? 'disabled="disabled"' : ''); ?> class="EstFormularioCombo" name="CmpSucursal" id="CmpSucursal">
                            ...
                            ?>
                              <option value="<?php echo $DatSucursal->SucId ?>" <?php if ($_SESSION['SesionSucursal'] == $DatSucursal->SucId) {
                  ...
                  <table border="0" cellpadding="0" cellspacing="2">
                    <tr>
                      ...
                      <td>
                        ...
                        ?>
                          <input name="BtnImprimir" id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteVentaMesonImprimir('');" />
                        <?php
                        }
                        ?>
                      </td>
                      <td>
                        ...
                        ?>
                          <input name="BtnExcel" id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteVentaMesonGenerarExcel('');" />
                        <?php
                        }
                        ?>
                      </td>
      ...
      <tr>
        <td colspan="2" align="center">
          ...
          <div class="EstReporteCapaListado autoheight" id="CapReporteVentaMeson"></div>
