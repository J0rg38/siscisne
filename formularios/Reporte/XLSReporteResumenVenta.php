		...
		if(!empty($ArrReporteResumenVentas)){
			foreach($ArrReporteResumenVentas as $DatReporteResumenVenta){
				...
				$objPHPExcel->setActiveSheetIndex(0)
				 ...
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("I".$Fila, ($DatReporteResumenVenta->RvrVendedor));
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("J".$Fila, ($DatReporteResumenVenta->RvrAsesorAccesorio));
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("K".$Fila, ($DatReporteResumenVenta->RvrCodigo));
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("L".$Fila, ($DatReporteResumenVenta->RvrDescripcion));
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("M".$Fila, ($DatReporteResumenVenta->RvrCantidad));
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("N".$Fila, ($DatReporteResumenVenta->RvrCostoUs));
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("O".$Fila, ($DatReporteResumenVenta->RvrCostoIgv));
				 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("P".$Fila, ($DatReporteResumenVenta->RvrTipoCambio));
								
								 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("Q".$Fila, ($DatReporteResumenVenta->RvrUnidadMedida));
								 
								 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("R".$Fila, ($DatReporteResumenVenta->RvrPrecioSFinal));
								
								 $objPHPExcel->setActiveSheetIndex(0)
								 ->setCellValue("S".$Fila, ($DatReporteResumenVenta->RvrDescuentoSFinal));
								 
								  $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("T".$Fila, ($DatReporteResumenVenta->RvrPrecioDescuentoSFinal));
								
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("U".$Fila, ($DatReporteResumenVenta->RvrImporteSFinal));
								
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("V".$Fila, ($DatReporteResumenVenta->RvrImporteDescuentoSFinal));
								 
								 $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("W".$Fila, ($DatReporteResumenVenta->RvrPrecioUSFinal));
								
								 $objPHPExcel->setActiveSheetIndex(0)
								 ->setCellValue("X".$Fila, ($DatReporteResumenVenta->RvrDescuentoUSFinal));
								 
								  $objPHPExcel->setActiveSheetIndex(0)
								->setCellValue("Y".$Fila, ($DatReporteResumenVenta->RvrPrecioDescuentoUSFinal));
								
								 
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("Z".$Fila, ($DatReporteResumenVenta->RvrImporteUSFinal));
								
									 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AA".$Fila, ($DatReporteResumenVenta->RvrImporteDescuentoUSFinal));
								
								
								 
								 $objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AB".$Fila, ($DatReporteResumenVenta->RvrModalidad));

								$objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AC".$Fila, ($DatReporteResumenVenta->RvrNotaCredito));

								$objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AD".$Fila, ($DatReporteResumenVenta->RvrNotaCreditoTotal));
								
								$objPHPExcel->setActiveSheetIndex(0)								 
								->setCellValue("AE".$Fila, ($DatReporteResumenVenta->VmaNombre));
