...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteFichaIngresoCita.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE  DE CITAS C/ ORDEN DE TRABAJO</span>  </td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteFichaIngresoCita.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFichaIngresoCita.php" target="IfrReporteFichaIngresoCita" method="post" name="FrmReporteFichaIngresoCita" id="FrmReporteFichaIngresoCita">
      -->
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                     <option value="CitFechaProgramada" selected="selected">Fecha Programada</option>
...
<!--  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFichaIngresoCita.php" target="IfrReporteFichaIngresoCita" id="IfrReporteFichaIngresoCita" name="IfrReporteFichaIngresoCita" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
   
 
     <div class="EstReporteCapaListado autoheight" id="CapReporteFichaIngresoCita" ></div>
