...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteVentaPerdida.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo $InsProyecto->MtdRutEstilos();?>CssReporte.css">

<?php

$POST_FechaInicio  = "01/".date("m")."/".date("Y");
$POST_FechaFin  = date("d")."/".date("m")."/".date("Y");
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE VENTAS PERDIDAS DE REPUESTOS</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteVentaPerdida.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
<!--    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteVentaPerdida.php" target="IfrReporteVentaPerdida" method="post" name="FrmReporteVentaPerdida" id="FrmReporteVentaPerdida">
     --> 
    ...
    ?>
              ...
              <tr>
                <td class="EstFormulario">Asesor:</td>
                <td class="EstFormulario"><select disabled="disabled"  class="EstFormularioCombo" name="CmpPersonal" id="CmpPersonal" >
                  <option value="">Escoja una opcion</option>
                  <?php
          ...
          <td align="left" valign="top">
            ...
            <table border="0" cellpadding="0" cellspacing="2">
              <tr>
                <td>
                  <input name="BtnVer"   id="BtnVer" type="image" border="0" src="imagenes/reporte_iconos/ver.png" alt="[Ver]" title="Ver" onclick="FncReporteVentaPerdidaVer();" />           </td>
                <td>
                  <?php
            if($PrivilegioImprimir){
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteVentaPerdidaImprimir();" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteVentaPerdidaGenerarExcel();" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <div class="EstReporteCapaListado autoheight" id="CapReporteVentaPerdida"></div>
