...
<tr>
  ...
  <iframe class="EstReporteCapaListado autoheight" target="IfrReporteClienteFichaIngreso" id="IfrReporteClienteFichaIngreso" name="IfrReporteClienteFichaIngreso" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>
