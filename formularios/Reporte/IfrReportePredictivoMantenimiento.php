...
if($_GET['P']==2){
	...
	header("Content-Disposition:  filename=\"REPORTE_PREDICTIVO_MANTENIMIENTO_".date('d-m-Y').".xls\";");
}
?>
<html>
<head>
...
$POST_ord = isset($_POST['CmpOrden'])?$_POST['CmpOrden']:"EinFichaIngresoFechaPredecida";
...
$ResReportePredictivoMantenimiento = $InsReportePredictivoMantenimiento->MtdObtenerReportePredictivoMantenimientos(FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),$POST_ord,$POST_sen);
...
<tr>
  ...
  <td width="54%" align="center" valign="top"><span class="EstReporteTitulo">REPORTE DE PREDICTIVO DE MANTENIMIENTOSDEL
      <?php
  if($POST_finicio == $POST_ffin){
?>
      <?php echo $POST_finicio; ?>
...
<?php }?>
        ...
        <tr>
          ...
          <th width="6%">FECHA OT UTL.</th>
          <th width="8%">KM. OT ULT.</th>
          <th width="8%">PROX. FECHA ESTIMADA</th>
          <th width="9%">PROX. KM ESTIMADO</th>
        ...
        <tr   >
          ...
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" align="right" ><?php echo $DatReportePredictivoMantenimiento->EinPlaca;  ?></td>
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" align="right" ><?php echo $DatReportePredictivoMantenimiento->VmaNombre;  ?></td>
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" align="right" ><?php echo $DatReportePredictivoMantenimiento->VmoNombre;  ?></td>
