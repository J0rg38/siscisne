...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteAlmacenMovimientoSalidaDetallado.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE SALIDAS DE REPUESTOS DETALLADO</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteAlmacenMovimientoSalidaDetallado.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>
...
//  deb($POST_Sucursal);
  ?>
    <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteAlmacenMovimientoSalidaDetallado.php" target="IfrReporteAlmacenMovimientoSalidaDetallado" method="post" name="FrmReporteAlmacenMovimientoSalidaDetallado" id="FrmReporteAlmacenMovimientoSalidaDetallado" onsubmit="FncReporteAlmacenMovimientoSalidaDetalladoVer();">-->
...
<tr>
  <td colspan="2" align="center">
   <!--class="autoHeight"-->
  <!--<iframe class="autoHeight"  src="" target="IfrReporteAlmacenMovimientoSalidaDetallado" id="IfrReporteAlmacenMovimientoSalidaDetallado" name="IfrReporteAlmacenMovimientoSalidaDetallado" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
  
   <div id="CapReporteAlmacenMovimientoSalidaDetallado"></div>
  </td>
