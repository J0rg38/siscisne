...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteComprobanteVentaResumenDetalle.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REGISTRO DE VENTAS DETALLE DETALLADO</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteComprobanteVentaResumenDetalle.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteComprobanteVentaResumenDetalle.php" target="IfrReporteComprobanteVentaResumenDetalle" method="GET" name="FrmReporteComprobanteVentaResumenDetalle" id="FrmReporteComprobanteVentaResumenDetalle" >
    -->  
...
<tr>
  ...
  <!--<iframe class="autoHeight" target="IfrReporteComprobanteVentaResumenDetalle" id="IfrReporteComprobanteVentaResumenDetalle" name="IfrReporteComprobanteVentaResumenDetalle" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
  
  <div class="EstReporteCapaListado autoheight" id="CapReporteComprobanteVentaResumenDetalle"></div>
