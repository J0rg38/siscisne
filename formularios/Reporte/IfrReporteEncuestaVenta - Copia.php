...
?>
    ...
    ?>
		<?php echo $DatEncuestaPreguntaSeccion->EpsNombre;?>
...
//	
//	$dataSet->addPoint(new Point("Si", $SiPorcentaje+1-1));
//	$dataSet->addPoint(new Point("No", $NoPorcentaje+1-1));
//
//	$chart->setDataSet($dataSet);
//
//	$chart->setTitle("");
//	
//	if(file_exists("../../generados/reportes/Encuesta3V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$DatEncuestaPregunta->EprId.$POST_Sucursal.".png")){
//		unlink("../../generados/reportes/Encuesta3V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$DatEncuestaPregunta->EprId.$POST_Sucursal.".png");
//	}
//	
//	$chart->render("../../generados/reportes/Encuesta3V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$DatEncuestaPregunta->EprId.$POST_Sucursal.".png");
//	
//	
//	
?>
 
<!--<img align="absmiddle" alt="Pie Chart"  src="generados/reportes/Encuesta3V<?php echo FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$DatEncuestaPregunta->EprId;?>.png" style="border: 1px solid gray;"/></td>
...
$filename = "Encuesta3V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$DatEncuestaPregunta->EprId.$POST_Sucursal.".png";
...
//	$dataSet = new XYDataSet();
//	
//	$dataSet->addPoint(new Point("Promotores", $PromotoresPorcentaje+1-1));
//	$dataSet->addPoint(new Point("Detractores", $DetractoresPorcentaje+1-1));
//	$dataSet->addPoint(new Point("Neutros", $NeutrosPorcentaje+1-1));
//	
//	
//	$chart->setDataSet($dataSet);
//
//	$chart->setTitle("");
//	
//	if(file_exists("../../generados/reportes/EncuestaV".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png")){
//		unlink("../../generados/reportes/EncuestaV".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png");
//	}
//	
//	$chart->render("../../generados/reportes/EncuestaV".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png");


?>
 
<!--<img align="absmiddle" alt="Pie Chart"  src="generados/reportes/EncuestaV<?php echo FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin);?>.png" style="border: 1px solid gray;"/></td>
-->
...
//require_once 'phplot.php';
$dir = "../../generados/reportes/";
$filename = "EncuestaV".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png";
...
//	$dataSet = new XYDataSet();
//	
//	$dataSet->addPoint(new Point("TT Insatisfecho", $TTInsatisfechoPorcentaje+1-1));
//	$dataSet->addPoint(new Point("Poco Satisfecho", $PocoSatisfechoPorcentaje+1-1));
//	$dataSet->addPoint(new Point("Algo Satisfecho", $AlgoSatisfechoPorcentaje+1-1));
//	$dataSet->addPoint(new Point("Muy Satisfecho", $MuySatisfechoPorcentaje+1-1));
//	$dataSet->addPoint(new Point("Total Satisfecho", $TotalSatisfechoPorcentaje+1-1));
//	
//	
//	$chart->setDataSet($dataSet);
//
//	$chart->setTitle("");
//	
//	if(file_exists("../../generados/reportes/Encuesta2V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png")){
//		unlink("../../generados/reportes/Encuesta2V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png");
//	}
//	
//	$chart->render("../../generados/reportes/Encuesta2V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png");
//
//

?>
 
<!--<img align="absmiddle" alt="Pie Chart"  src="generados/reportes/Encuesta2V<?php echo FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin);?>.png" style="border: 1px solid gray;"/></td>
...
//require_once 'phplot.php';
$dir = "../../generados/reportes/";
$filename = "Encuesta2V".FncCambiaFechaAMysql($POST_finicio).FncCambiaFechaAMysql($POST_ffin).$POST_Sucursal.".png";
