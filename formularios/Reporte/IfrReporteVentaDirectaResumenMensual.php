...
<table width="100%">
<tr>
  <td align="center" valign="middle">  RESUMEN ORDENES DE VENTA MENSUAL - A&Ntilde;O <?php echo $POST_Ano;?><br>
...
<?php echo number_format($VentaDirectaTotal[$i],2);?>
  ...
  <td colspan="2" align="center" valign="top"><?php
	...
	$chart->setTitle("RESUMEN ORDENES DE VENTA MENSUAL DE VENTAS - AÑO ".$POST_Ano." EN ".$InsMoneda->MonNombre." ");
	$chart->render("Graficos/ResumenVentaDirectaMensualVentas_".$POST_Ano."_".$InsMoneda->MonId."_".$Identificador.".png");
    
?>
    <img alt="RESUMEN MENSUAL DE VENTAS"  src="Graficos/ResumenVentaDirectaMensualVentas_<?php echo $POST_Ano;?>_<?php echo $InsMoneda->MonId?>_<?php echo $Identificador?>.png" style="border: 1px solid gray;"/></td>
</tr>
</table>    
