...
<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReportePersonalFichaIngreso.php" target="IfrReportePersonalFichaIngreso" method="GET" name="FrmReportePersonalFichaIngreso" id="FrmReportePersonalFichaIngreso">
    ...
    ?>
              ...
              <tr>
                <td>C/ Detalle O.T.</td>
                <td><select name="CmpDetalle" id="CmpDetalle" class="EstFormularioCombo">
...
<tr>
  ...
  <iframe class="autoHeight"  target="IfrReportePersonalFichaIngreso" id="IfrReportePersonalFichaIngreso" name="IfrReportePersonalFichaIngreso" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
