...
switch($POST_TipoFecha){
	...
	case "ENTREGA":
		$TipoFecha = "ovv.OvvActaEntregaFecha";
	break;
...
<?php }?>
   ...
   <?php  //echo (($_GET['P']==1)?$InsProyecto->MtdRutGenerados():'generados/');?>
			...
			?>
				...
				?>
           		 ...
           		 <td width="80" align="center">
                            ...
                            //MtdObtenerEncuestaDetalles($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'EdeId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oEncuesta=NULL,$oEncuestaPregunta=NULL,$oSucursal=NULL,$POST_Personal) 
...
//MtdObtenerEncuestaDetallesValor($oFuncion="SUM",$oParametro="EprId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'EdeId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oEncuesta=NULL,$oEncuestaPregunta=NULL,$oEncuestaRespuesta=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oSucursal=NULL,$oTipoFecha="EncFecha",$oPersonal=NULL) 
                            $EncuestaDetalleValor = $InsEncuestaDetalle->MtdObtenerEncuestaDetallesValor("COUNT","EprId",NULL,NULL,NULL,NULL,NULL,'EdeId','Desc','1',3,NULL,$DatEncuestaPregunta->EprId,$DatEncuestaPreguntaRespuesta->EpeValor,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_Sucursal,$TipoFecha,$POST_Personal);
...
$filename = "Encuesta3".FncCambiaFechaAMysql($POST_FechaInicio).FncCambiaFechaAMysql($POST_FechaFin).$DatEncuestaPregunta->EprId.$POST_Sucursal.".png";
...
//require_once 'phplot.php';
$dir = "../../generados/reportes/";
$filename = "Encuesta".FncCambiaFechaAMysql($POST_FechaInicio).FncCambiaFechaAMysql($POST_FechaFin).$POST_Sucursal.".png";
$filename = str_replace("-","",$filename);
...
//require_once 'phplot.php';
$dir = "../../generados/reportes/";
$filename = "Encuesta2".FncCambiaFechaAMysql($POST_FechaInicio).FncCambiaFechaAMysql($POST_FechaFin).$POST_Sucursal.".png";
$filename = str_replace("-","",$filename);
...
?>
  ...
  <!-- <?php  //echo (($_GET['P']==1)?$InsProyecto->MtdRutGenerados():'generados/');?>reportes/<?php echo $filename;?>
...
$ResReporteOrdenVentaVehiculo = $InsReporteOrdenVentaVehiculo->MtdObtenerReporteOrdenVentaVehiculoClientes(NULL,NULL,NULL,"OvvFechaEntrega" ,"DESC",NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_VehiculoMarca,$DatSucursal->SucId,$POST_IncluirCSI,"Mayor",$POST_Dias,"IFNULL(ovv.OvvActaEntregaFecha,ovv.OvvActaEntregaFechaPDS)");
...
$ATotalBase[$DatSucursal->SucId] = count($ArrReporteOrdenVentaVehiculos);
...
$InsEncuesta = new ClsEncuesta();
$ResEncuesta = $InsEncuesta->MtdObtenerEncuestas(NULL,NULL,NULL,"EncId","DESC",$POST_pag,NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),"VENTA",$DatSucursal->SucId);
...
$InsEncuesta = new ClsEncuesta();
$ResEncuesta = $InsEncuesta->MtdObtenerEncuestas(
	NULL,
	NULL,
	NULL,
	"EncId",
	...
	$POST_pag,
	NULL,
	FncCambiaFechaAMysql($POST_FechaInicio),
	FncCambiaFechaAMysql($POST_FechaFin),
	"VENTA",
	$POST_Sucursal,
	$POST_Personal
	// NULL,
