...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsReporteVentaDirectaDetalleResumen.js"></script>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="98%" height="25">
          ...
          <span class="EstFormularioTitulo">RESUMEN DE ORDENES DE VENTA C/ DETALLE</span>
        </td>
        <td width="2%"><a href="formularios/Reporte/inf/InfReporteVentaDirectaDetalleResumen.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
      </tr>

      <tr>
        <td colspan="2" align="center">
          <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios(); ?>Reporte/IfrReporteVentaDirectaDetalleResumen.php" target="IfrReporteVentaDirectaDetalleResumen" method="post" name="FrmReporteVentaDirectaDetalleResumen" id="FrmReporteVentaDirectaDetalleResumen" onsubmit="FncReporteVentaDirectaDetalleResumenVer();">
                  ...
                  <table border="0" cellpadding="0" cellspacing="2">
                    <tr>
                      ...
                      <td>
                        ...
                        ?>
                          <input name="BtnImprimir" id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteVentaDirectaDetalleResumenImprimir('');" />
                        <?php
                        }
                        ?>
                      </td>
                      <td>
                        ...
                        ?>
                          <input name="BtnExcel" id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteVentaDirectaDetalleResumenGenerarExcel('');" />
                        <?php
                        }
                        ?>
                      </td>
      ...
      <tr>
        <td colspan="2" align="center">
          <!--class="autoHeight"-->
          <iframe class="autoHeight" src="" target="IfrReporteVentaDirectaDetalleResumen" id="IfrReporteVentaDirectaDetalleResumen" name="IfrReporteVentaDirectaDetalleResumen" scrolling="auto" frameborder="0" height="420" width="100%"></iframe>
        </td>
      </tr>
    </table>
  </div>
