...
//								$ArrOrdenVentaVehiculoPersonales = $ResPersonal['Datos'];
								
								$ResOrdenVentaVehiculo = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculoPersonales(NULL,NULL,NULL,'OvvId','Desc','',FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$DatSucursal->SucId,$POST_VehiculoMarca);
$ArrOrdenVentaVehiculoPersonales = $ResOrdenVentaVehiculo['Datos'];


								$Colspan = count($ArrOrdenVentaVehiculoPersonales);
...
$ArrOrdenVentaVehiculoPersonales = $ResOrdenVentaVehiculo['Datos'];
					...
					?>
                    		...
                    		<?php
							if( count($ArrOrdenVentaVehiculoPersonales)>0){
							?>
						<?php
						if(!empty($ArrOrdenVentaVehiculoPersonales )){
                      ...
                      <!--   <small>
						 ...
						 <?php echo (empty($DatOrdenVentaVehiculoPersonal->PerAbreviatura)?$DatOrdenVentaVehiculoPersonal->UsuUsuario:$DatOrdenVentaVehiculoPersonal->PerAbreviatura);?>
...
$ArrOrdenVentaVehiculoPersonales = $ResOrdenVentaVehiculo['Datos'];
								...
								if(!empty($ArrOrdenVentaVehiculoPersonales )){
									foreach($ArrOrdenVentaVehiculoPersonales  as $DatOrdenVentaVehiculoPersonal){
										...
										$OrdeneVentaVehiculoTotalMostrar += $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculosValor("COUNT","OvvId",NULL,NULL,NULL,NULL,NULL,'OvvId','ASC',NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),array(2,3,4,5),NULL,$DatOrdenVentaVehiculoPersonal->PerId,NULL,NULL,$DatSucursal->SucId,$DatVehiculoVersion->VveId);
...
//MtdObtenerOrdenVentaVehiculosValor($oFuncion="SUM",$oParametro="OvvId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'OvvId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oMoneda=NULL,$oPersonal=NULL,$oModelo=NULL,$oMarca=NULL,$oSucursal=NULL)
						//$OrdeneVentaVehiculoTotal = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculosValor("COUNT","OvvId",NULL,NULL,NULL,NULL,NULL,'OvvId','ASC',NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),5,NULL,$DatOrdenVentaVehiculoPersonal->PerId,$DatVehiculoVersion->VmoId,NULL,$DatSucursal->SucId);
						//$OrdeneVentaVehiculoAnteriorTotal = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculosValor("COUNT","OvvId",NULL,NULL,NULL,NULL,NULL,'OvvId','ASC',NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($FechaFinComparativo),5,NULL,$DatOrdenVentaVehiculoPersonal->PerId,$DatVehiculoVersion->VmoId,NULL,$DatSucursal->SucId);

						$OrdeneVentaVehiculoTotal = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculosValor("COUNT","OvvId",NULL,NULL,NULL,NULL,NULL,'OvvId','ASC',NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),array(2,3,4,5),NULL,$DatOrdenVentaVehiculoPersonal->PerId,NULL,NULL,$DatSucursal->SucId,$DatVehiculoVersion->VveId);
						
						 
						 $OrdeneVentaVehiculoSumaTotal[$DatSucursal->SucId][$DatOrdenVentaVehiculoPersonal->PerId] += $OrdeneVentaVehiculoTotal;
					...
					?>
                      <?php
                          ...
                          <td width="50"   align="right" class="EstTablaReporteColumnaEspecial4">
                                ...
                                <?php echo ($OrdeneVentaVehiculoSumaTotal[$DatSucursal->SucId][$DatOrdenVentaVehiculoPersonal->PerId]);?>
							  <?php 	$TotalModeloAsesor += $OrdeneVentaVehiculoSumaTotal[$DatSucursal->SucId][$DatOrdenVentaVehiculoPersonal->PerId] ;?>
                          </td>
...
//							$ArrOrdenVentaVehiculoPersonales = $ResPersonal['Datos'];
							...
							$ResOrdenVentaVehiculo = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculoPersonales(NULL,NULL,NULL,'OvvId','Desc','',FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),NULL,$POST_VehiculoMarca);
$ArrOrdenVentaVehiculoPersonales = $ResOrdenVentaVehiculo['Datos'];
                                ...
                                foreach($ArrOrdenVentaVehiculoPersonales  as $DatOrdenVentaVehiculoPersonal){
									...
									if(!empty($ArrSucursales)){
										foreach($ArrSucursales as $DatSucursal){
											...
											$OrdeneVentaVehiculoTotalMostrar += $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculosValor("COUNT","OvvId",NULL,NULL,NULL,NULL,NULL,'OvvId','ASC',NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),array(2,3,4,5),NULL,$DatOrdenVentaVehiculoPersonal->PerId,$DatVehiculoModelo->VmoId,NULL,$DatSucursal->SucId,NULL);
...
$ArrOrdenVentaVehiculoPersonales = $ResOrdenVentaVehiculo['Datos'];
					...
					?>
						...
						?>
                            <tr>
                              <td><?php echo (empty($DatOrdenVentaVehiculoPersonal->PerAbreviatura)?$DatOrdenVentaVehiculoPersonal->UsuUsuario:$DatOrdenVentaVehiculoPersonal->PerAbreviatura);?></td>
                              <td><?php echo (($DatOrdenVentaVehiculoPersonal->PerNombre));?> <?php echo (($DatOrdenVentaVehiculoPersonal->PerApellidoPaterno));?> <?php echo (($DatOrdenVentaVehiculoPersonal->PerApellidoMaterno));?></td>
                            </tr>
                            <?php		
							}
