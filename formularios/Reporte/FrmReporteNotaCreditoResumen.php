...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteNotaCreditoResumen.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">RESUMEN DE NOTAS DE CREDITO</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteNotaCreditoResumen.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteNotaCreditoResumen.php" target="IfrReporteNotaCreditoResumen" method="post" name="FrmReporteNotaCreditoResumen" id="FrmReporteNotaCreditoResumen" >
            ...
            <table border="0" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td><table>
                  <tr>
                    <td><a href="javascript:FncClienteNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                    <td><input tabindex="2" class="EstFormularioCaja" name="CmpClienteNombre" type="text" id="CmpClienteNombre" size="25" maxlength="255"  />
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      ...
                      <option value="NcrFechaEmision" selected="selected">Fecha Comprob.</option>
...
<tr>
  ...
  <iframe class="autoHeight" target="IfrReporteNotaCreditoResumen" id="IfrReporteNotaCreditoResumen" name="IfrReporteNotaCreditoResumen" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
