...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteCliente1Vehiculo.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE CLIENTES QUE COMPRARON MAS DE 1 UNIDAD</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteCliente1Vehiculo.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
<!--    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteCliente1Vehiculo.php" target="IfrReporteCliente1Vehiculo" method="post" name="FrmReporteCliente1Vehiculo" id="FrmReporteCliente1Vehiculo">
     --> 
...
<tr>
  ...
  <!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteCliente1Vehiculo.php" target="IfrReporteCliente1Vehiculo" id="IfrReporteCliente1Vehiculo" name="IfrReporteCliente1Vehiculo" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
      <div id="CapReporteCliente1Vehiculo"></div>
