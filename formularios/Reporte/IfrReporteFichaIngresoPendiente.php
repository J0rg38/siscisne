...
//MtdObtenerReporteFichaIngresoPendientes($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FinId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oModalidadIngreso=NULL,$oDiaTranscurrido=NULL,$oEstado=NULL,$oTipo=NULL,$oSucursal=NULL)
$ResReporteFichaIngreso = $InsReporteFichaIngreso->MtdObtenerReporteFichaIngresoPendientes(NULL,NULL,NULL,$POST_ord,$POST_sen,"",FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,3,"11,2,3,4,5,6,7,71,72",1,$POST_Sucursal);
