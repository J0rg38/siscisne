...
$POST_finicio = isset($_GET['CmpFechaInicio'])?$_GET['CmpFechaInicio']:date("d/m/Y");
...
//$ResReporteFichaIngreso = $InsReporteFichaIngreso->MtdObtenerReporteFichaIngresos(NULL,NULL,NULL,"PerNombre","ASC",NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"MIN-10001,MIN-10003,MIN-10019,MIN-10020,MIN-10021,MIN-10016,MIN-10026",NULL,NULL,NULL,false,NULL,false,$POST_Sucursal);
...
$ResReporteFichaIngreso = $InsReporteFichaIngreso->MtdObtenerReporteFichaIngresos(NULL,NULL,NULL,"PerNombre","ASC",NULL,NULL,NULL,"MIN-10001,MIN-10003,MIN-10019,MIN-10020,MIN-10021,MIN-10016,MIN-10026",NULL,NULL,NULL,false,NULL,false,$POST_Sucursal,"FinFecha",FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin));
$ArrReporteFichaIngresos = $ResReporteFichaIngreso['Datos'];
...
//				if($DatModalidadIngreso->MinSigla == "MA" or $DatModalidadIngreso->MinSigla == "RE" or $DatModalidadIngreso->MinSigla == "RI"){
				...
				?>
					<th width="21"><?php echo strtoupper($DatModalidadIngreso->MinNombre)?></th>       
					<th width="99">FACTURADO</th>
		  ...
		  <?php	
			...
			?>
            	<th width="21">OTROS</th>       
				<th width="99">FACTURADO</th>
                    
			<th width="104">TOTAL OTs</th>
			<th width="73">TOTAL FACTURADO</th>
...
?>
                    ...
                    $TotalPersonalModalidadFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresosValor("COUNT","fin.FinId",NULL,NULL,NULL,NULL,NULL,'fin.FinId','Desc',NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,$DatModalidadIngreso->MinId,NULL,NULL,$DatTecnico->PerId,0,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,false,false,$POST_Sucursal);
             ...
             <td  align="center" valign="top" bgcolor="#FFCC66"   >
               ...
               <td align="center" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>">
                ...
                $BoletaTotal = $InsBoleta->MtdObtenerBoletasValor("SUM","BolTotal",NULL,NULL,NULL,NULL,NULL,'BolId','Desc',NULL,$POST_Sucursal,"5",FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,$DatModalidadIngreso->MinId,NULL,NULL,NULL,$DatTecnico->PerId);
               //MtdObtenerFacturasValor($oFuncion="SUM",$oParametro="FacId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'FacId',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oSucursal=NULL,$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oTalonario=NULL,$oRegimen=NULL,$oCondicionPago=NULL,$oNotaCredito=NULL,$oMoneda=NULL,$oCliente=NULL,$oAlmacenMovimiento=NULL,$oClienteClasificacion=NULL,$oFichaIngresoMantenimientoKilometraje=NULL,$oModalidadIngreso=NULL,$oVehiculoMarca=NULL,$oVehiculoModelo=NULL,$oClienteTipo=NULL,$oTecnico=NULL,$oOrigen=NULL,$oVendedor=NULL)  
                $FacturaTotal = $InsFactura->MtdObtenerFacturasValor("SUM","FacTotal",NULL,NULL,NULL,NULL,NULL,'FacId','Desc',1,NULL,$POST_Sucursal,"5",FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,$DatModalidadIngreso->MinId,NULL,NULL,NULL,$DatTecnico->PerId);
...
<?php	
				$SumaFacturacionTotal += $Facturado;
				 ...
				 $InsFichaIngreso = new ClsFichaIngreso();
                 //MtdObtenerFichaIngresosValor($oFuncion="SUM",$oParametro="FinId",$oMes=NULL,$oAno=NULL, $oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FinId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oPrioridad=NULL,$oModalidadIngreso=NULL,$oVIN=NULL,$oCliente=NULL,$oPersonalId=NULL,$oTrabajoConcluido=0,$oCampana=NULL,$oClienteTipo=NULL,$oTipo=NULL,$oSalidaExterna=0,$oConCampana=NULL,$oVehiculoIngreso=NULL,$oConConcluido=0,$oVehiculoMarca=NULL,$oVehiculoModelo=NULL,$oFinMantenimientoKilometraje=NULL,$oTipoReparacion=NULL,$oPersonalIdAsesor=NULL,$oIgnorarPrimerMantenimiento=false,$oIgnorarReparacionesSinCosto=false,$oSucursal=NULL) {
                 $TotalPersonalModalidadFichaIngresoOtro = $InsFichaIngreso->MtdObtenerFichaIngresosValor("COUNT","fin.FinId",NULL,NULL,NULL,NULL,NULL,'fin.FinId','Desc',NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,$DatModalidadIngreso->MinId,NULL,NULL,$DatTecnico->PerId,0,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,false,false,$POST_Sucursal);
                    
				 $TotalPersonalModalidadFichaIngresoOtros += $TotalPersonalModalidadFichaIngresoOtro;
				
                 $TotalPersonalFichaIngreso += $TotalPersonalModalidadFichaIngresoOtro;
...
?> <td  align="center" valign="top" bgcolor="#FFCC66"   >
 <?php echo number_format($TotalPersonalModalidadFichaIngresoOtros,2);?>
           ...
           <?php echo number_format($FacturadoOtros,2);?>      
				</td>

             <td  align="right" valign="top" bgcolor="#FF9900"   ><?php echo number_format($TotalPersonalFichaIngreso,2);?></td>
             <td  align="right" valign="top"   ><?php
echo number_format($SumaFacturacionTotal,2);
?></td>
...
$InsPago = new ClsPago();
$ResPago = $InsPago->MtdObtenerPagos(NULL,NULL,NULL,'PagId','Desc',NULL,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"PagFecha",NULL,NULL,$POST_Sucursal,$oFichaIngresoId=NULL,$DatTecnico->PerId);
...
?>
  ...
  <?php
$SumaTotalAbonos = $TotalPago + $SumaFacturacionTotal;
?>
               
  <?php
echo number_format($SumaTotalAbonos,2);
?>
...
/*if(!empty($ArrTecnicos)){
	foreach($ArrTecnicos as $DatTecnico){
		...
		$InsFichaIngreso = new ClsFichaIngreso();
		$ResFichaIngreso = $InsFichaIngreso->MtdObtenerFichaIngresos(NULL,NULL,NULL,"FinFecha","ASC",NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,NULL,NULL,$DatTecnico->PerId,0,NULL,NULL,1,0,NULL,NULL,0,NULL,NULL,NULL,NULL,$POST_Sucursal);
