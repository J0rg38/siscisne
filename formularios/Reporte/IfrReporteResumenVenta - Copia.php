...
"RvrMargen"
                         --->
                            <tr>
                             ...
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrResumen;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrTipo;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrServicios;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrTipoDetalle;?></td>
                             ...
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrCostoTotal1;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrCostoIGVSoles;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrCostoTotal2;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrCostoGeneral;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrPrecioUs;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrPrecioS;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrPrecioUnitario;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrPrecioCliente;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrGanancia;?></td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatReporteResumenVenta->RvrMargen;?></td>
