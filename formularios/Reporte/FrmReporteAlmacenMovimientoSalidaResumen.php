...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">RESUMEN DE SALIDAS DE REPUESTOS</span></td>
...
<tr>
  <td colspan="2" align="center">
   <!--class="autoHeight"-->
  <!--<iframe class="autoHeight"  src="" target="IfrReporteAlmacenMovimientoSalidaResumen" id="IfrReporteAlmacenMovimientoSalidaResumen" name="IfrReporteAlmacenMovimientoSalidaResumen" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
  
   <div class="EstReporteCapaListado autoheight" id="CapReporteAlmacenMovimientoSalidaResumen"></div>
  </td>
