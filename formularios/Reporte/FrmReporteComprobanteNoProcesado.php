...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsReporteComprobanteNoProcesado.js"></script>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="98%" height="25">
          ...
          <span class="EstFormularioTitulo">REPORTE DE COMPROBANTES NO PROCESADOS</span>
        </td>
        <td width="2%"><a href="formularios/Reporte/inf/InfReporteComprobanteNoProcesado.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
      </tr>

      <tr>
        <td colspan="2" align="center">
          <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios(); ?>Reporte/IfrReporteComprobanteNoProcesado.php" target="IfrReporteComprobanteNoProcesado" method="GET" name="FrmReporteComprobanteNoProcesado" id="FrmReporteComprobanteNoProcesado" >
    -->
      ...
      <tr>
        <td colspan="2" align="center">
          ...
          <!--<iframe class="autoHeight" target="IfrReporteComprobanteNoProcesado" id="IfrReporteComprobanteNoProcesado" name="IfrReporteComprobanteNoProcesado" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->


          <div class="EstReporteCapaListado autoheight" id="CapReporteComprobanteNoProcesado"></div>
