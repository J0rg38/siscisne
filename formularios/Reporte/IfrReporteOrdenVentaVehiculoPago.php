...
$ResOrdenVentaVehiculo = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculos(NULL,NULL,NULL,$POST_ord,$POST_sen,$POST_pag,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),NULL,$POST_Moneda,$POST_Personal,$POST_ClienteId,NULL);
...
<?php }?>
        ...
        <tr>
          <th width="11%" align="center">SUCURSAL</th>
          ...
          <th width="6%" align="center">ULT. FECHA</th>
        ...
        ?>
               ...
               <!-- </a>-->
                ...
                <td align="right" valign="top"  ><?php echo ($DatOrdenVentaVehiculo->SucNombre);?></td>
...
//MtdObtenerPagos($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'PagId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oVentaDirecta=NULL,$oOrdenVentaVehiculo=NULL,$oCondicionPago=NULL,$oMoneda=NULL,$oFactura=NULL,$oFacturaTalonario=NULL,$oBoleta=NULL,$oBoletaTalonario=NULL,$oArea=NULL)
                    $ResPago = $InsPago->MtdObtenerPagos(NULL,NULL,NULL,'PagId','Desc',NULL,3,NULL,$DatOrdenVentaVehiculo->OvvId,NULL,NULL,NULL,NULL,NULL,NULL);
                    ...
                    ?>
                        ...
                        ?>                     
                            ...
                            <?php $FechaUltimoAbono = $DatPago->PagFecha;?>
                        <?php	
                        }
                        ?>
                        ...
                        ?>
							...
							<?php
							if($DatPago->MonId<>$DatOrdenVentaVehiculo->MonId){
