...
$ResFactura = $InsFactura->MtdObtenerFacturas(NULL,NULL,NULL,$POST_ord,$POST_sen,NULL,NULL,5,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,"NPA-10001",NULL,$POST_Moneda,$POST_ClienteId,NULL,NULL,NULL,NULL,NULL,$POST_Personal);
...
<?php }?>
        ...
        <tr   >
          ...
          <a target="_blank" href="../../principal.php?Mod=Factura&Form=Ver&Id=<?php echo $DatFactura->FacId;?>&Ta=<?php echo $DatFactura->FtaId;?>">
          ...
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" align="right" >
           ...
           <a target="_blank" href="../../principal.php?Mod=VentaConcretada&Form=Ver&Id=<?php echo $DatFactura->AmoId;?>">
...
?>
        ...
        ?>
          <tr>
            ...
            <td align="right">&nbsp;</td>
            <td align="right"><span class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>"><?php echo number_format($FacturaAmortizadoTotal,2);  ?></span></td>
            <td align="right"><span class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>"><?php echo number_format($FacturaSaldoTotal,2);  ?></span></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          </tbody>
