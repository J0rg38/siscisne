...
//$POST_ord = isset($_POST['Orden'])?$_POST['Orden']:"ProNombre";
...
$ResTallerPedidoDetalle = $InsReporteAlmacenMovimiento->MtdObtenerTallerPedidoDetalles(NULL,NULL,NULL,'AmdId','Desc',NULL,NULL,3,NULL,NULL,NULL,$oProductoTipo,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,$POST_Sucursal);
...
<?php }?>
      ...
      <table class="EstTablaReporte" width="100%" border="0" cellpadding="2" cellspacing="2">
       ...
       <tr>
         <td>&nbsp;</td>
         <td> <span class="EstTablaReporteTitulo">ORDENES DE VENTA(VENTAS X MOSTRADOR)</span></td>
         <td align="center">&nbsp;</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
