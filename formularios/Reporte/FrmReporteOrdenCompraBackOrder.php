...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteOrdenCompraBackOrder.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE BACK ORDER DE ORDENES DE COMPRA</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteOrdenCompraBackOrder.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteOrdenCompraBackOrder.php" target="IfrReporteOrdenCompraBackOrder" method="post" name="FrmReporteOrdenCompraBackOrder" id="FrmReporteOrdenCompraBackOrder">
    ...
    <td><table>
      <tr>
        ...
        <td><input name="CmpOrdenCompraId" id="CmpOrdenCompraId" type="hidden"    value="<?php  echo $InsPedidoCompra->OcoId;?>" size="20" maxlength="20" />
          <input name="CmpOrdenCompra" type="text" class="EstFormularioCaja" id="CmpOrdenCompra" size="10" maxlength="50" /></td>
    ...
    <td>&nbsp;</td>
          ...
          <td align="left" valign="top"><fieldset  class="EstFormularioContenedor">
            ...
            <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">  
              <tr>
                <td>Fecha Inicio: </td>
                <td><input class="EstFormularioCajaFecha" name="CmpFechaInicio" type="text"  id="CmpFechaInicio" value="<?php  echo date("d/m/Y");?>" size="8" maxlength="10"/>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteOrdenCompraBackOrderImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteOrdenCompraBackOrderGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteOrdenCompraBackOrder.php" target="IfrReporteOrdenCompraBackOrder" id="IfrReporteOrdenCompraBackOrder" name="IfrReporteOrdenCompraBackOrder" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
