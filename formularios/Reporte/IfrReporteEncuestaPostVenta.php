...
if($_GET['P']==2){
	...
	header("Content-Disposition:  filename=\"REPORTE_ENCUESTA_POSTVENTA_".date('d-m-Y').".xls\";");
}
?>
<html>
<head>
...
$ResEncuestaPreguntaSeccion = $InsEncuestaPreguntaSeccion->MtdObtenerEncuestaPreguntaSecciones(NULL,NULL,NULL,'EpsId','ASC',NULL,3,"POSTVENTA");
...
$TipoFecha = "EncFecha";
switch($POST_TipoFecha){
	
	case "CIERRE":
		$TipoFecha = "fin.FinFecha";
	break;
	
	case "ENCUESTA":
		$TipoFecha = "enc.EncFecha";
	break;
}
?>
<?php
...
<tr>
  ...
  <td width="54%" align="center" valign="top"><span class="EstReporteTitulo">REPORTE DE ENCUESTAS DE POST VENTA  DEL
      <?php
...
$ArrEncuestaPromotores = array();
$ArrEncuestaNeutros = array();
$ArrEncuestaDetractores = array();
?>
			...
			?>
				...
				?>
           		 ...
           		 <td width="80" align="center">
							...
							//MtdObtenerEncuestaDetallesValor($oFuncion="SUM",$oParametro="EprId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'EdeId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oEncuesta=NULL,$oEncuestaPregunta=NULL,$oEncuestaRespuesta=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oSucursal=NULL,$oTipoFecha="EncFecha") {
                            $EncuestaDetalleValor = $InsEncuestaDetalle->MtdObtenerEncuestaDetallesValor("COUNT","EprId",NULL,NULL,NULL,NULL,NULL,'EdeId','Desc','1',3,NULL,$DatEncuestaPregunta->EprId,$DatEncuestaPreguntaRespuesta->EpeValor,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_Sucursal,$TipoFecha);
	  			   ...
	  			   <?php echo $EncuestaDetalleValor;?>
							...
							?>
                                ...
                                if(in_array($DatEncuestaPreguntaRespuesta->EpeValor,$ArrPromotores)){
									...
									//$ArrEncuestaPromotores[] = $DatEncuestaPreguntaRespuesta->EncId;
									...
									//$ArrEncuestaNeutros[] = $DatEncuestaPreguntaRespuesta->EncId;
									
                                }else if(in_array($DatEncuestaPreguntaRespuesta->EpeValor,$ArrDetractores)){
									
                                  	$Detractores += $EncuestaDetalleValor ;
									
									//$ArrEncuestaDetractores[] = $DatEncuestaPreguntaRespuesta->EncId;
                           ...
                           <?php
							...
							<?php
							if($DatEncuestaPregunta->EprSubTipo == 2 
							|| $DatEncuestaPregunta->EprSubTipo == 3 
							|| $DatEncuestaPregunta->EprSubTipo == 4)
							{
							?>
...
$filename = "Encuesta3".FncCambiaFechaAMysql($POST_FechaInicio).FncCambiaFechaAMysql($POST_FechaFin).$DatEncuestaPregunta->EprId.".png";
...
?> 
     ...
     <img src="<?php  echo (($_GET['P']==1)?$InsProyecto->MtdRutGenerados():'generados/');?>reportes/<?php echo $filename;?>">   
...
-->
<hr>
<h1>CUADROS RESULTADOS GENERAL:</h1>
<hr>
...
//require_once 'phplot.php';
$dir = "../../generados/reportes/";
$filename = "Encuesta".FncCambiaFechaAMysql($POST_FechaInicio).FncCambiaFechaAMysql($POST_FechaFin).".png";
...
//                   |       |       |       |       |       |       |
$data = array(
    array('',  $PromotoresPorcentaje+1-1,   $NeutrosPorcentaje+1-1,$DetractoresPorcentaje+1-1)
);
...
//require_once 'phplot.php';
$dir = "../../generados/reportes/";
$filename = "Encuesta2".FncCambiaFechaAMysql($POST_FechaInicio).FncCambiaFechaAMysql($POST_FechaFin).".png";
...
$plot = new PHPlot(620, 250,$dir.$filename);
$plot->SetImageBorderType('plain'); // Improves presentation in the manual
$plot->SetTitle("Grado Satisfaccion \n N = ".$TotalColumnaB);
$plot->SetDataColors($colors);
...
<table border="0" cellpadding="2" cellspacing="2" class="EstTablaReporte">
        <thead class="EstTablaReporteHead">
        <tr>
          <th width="145" rowspan="2" align="center">Detalle</th>
...
//			                     $EncuestaDetalleValor = $InsEncuestaDetalle->MtdObtenerEncuestaDetallesValor("COUNT","EprId",NULL,NULL,NULL,NULL,NULL,'EdeId','Desc','1',3,NULL,$DatEncuestaPregunta->EprId,$DatEncuestaPreguntaRespuesta->EpeValor,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_Sucursal);
//
//                            	$InsEncuestaDetalle->MtdObtenerEncuestaDetalles(NULL,NULL,NULL,'EdeId','Desc','1',$oEstado=NULL,$oEncuesta=NULL,$DatEncuestaPregunta->EprId,$DatSucursal->);
//								
//									
//								if($DatEncuestaPregunta->EprSubTipo == 1){
//							
...
$ResReporteFichaIngreso = $InsReporteFichaIngreso->MtdObtenerReporteFichaIngresoSeguimientoLlamadas(NULL,NULL,NULL,"FinTiempoTrabajoTerminado","DESC",NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_ClienteId,$POST_FichaIngresoId,NULL,$DatSucursal->SucId,$POST_Modalidad,false,$POST_VehiculoMarca,NULL,"Igual","FinTiempoTrabajoTerminado");		
$ArrReporteFichaIngresos = $ResReporteFichaIngreso['Datos'];

$ATotalBase[$DatSucursal->SucId] = count($ArrReporteFichaIngresos);

                     
//MtdObtenerEncuestaDetalles($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'EdeId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oEncuesta=NULL,$oEncuestaPregunta=NULL,$oSucursal=NULL) 
//$InsEncuestaDetalle = new ClsEncuestaDetalle();
////MtdObtenerEncuestaDetallesValor($oFuncion="SUM",$oParametro="EprId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'EdeId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oEncuesta=NULL,$oEncuestaPregunta=NULL,$oEncuestaRespuesta=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oSucursal=NULL)
//$EncuestaDetalleValor = $InsEncuestaDetalle->MtdObtenerEncuestaDetallesValor("COUNT","EprId",NULL,NULL,NULL,NULL,NULL,'EdeId','Desc','1',3,NULL,NULL,NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$DatSucursal->SucId);
//
//$ATotalEncuestados[$DatSucursal->SucId] = $EncuestaDetalleValor;
//
...
$ResEncuesta = $InsEncuesta->MtdObtenerEncuestas(NULL,NULL,NULL,"EncId","DESC",$POST_pag,NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),"POSTVENTA",$DatSucursal->SucId,NULL,NULL,$TipoFecha);
$ArrEncuestas = $ResEncuesta['Datos'];

$ATotalEncuestados[$DatSucursal->SucId] = count($ArrEncuestas);

$SumaTotalBase += $ATotalBase[$DatSucursal->SucId];

if(!empty($ArrEncuestas)){
	foreach($ArrEncuestas as $DatEncuesta){
		
		
		//if(in_array($DatEncuesta->EncNivel,$ArrPromotores)){
//												
//			$ArrEncuestaPromotores[''] = $DatEncuesta->SucNombre;
//			
//		}else if(in_array($DatEncuesta->EncNivel,$ArrNeutros)){
//			
//			
//			$ArrEncuestaNeutros[] = $DatEncuestaPreguntaRespuesta->EncId;
//			
//		}else if(in_array($DatEncuesta->EncNivel,$ArrDetractores)){
//			
//			$Detractores += $EncuestaDetalleValor ;
//			
//			$ArrEncuestaDetractores[] = $DatEncuestaPreguntaRespuesta->EncId;
...
?>
            	...
            	<th colspan="2" align="center" valign="middle">Sucursal: <?php echo $DatSucursal->SucNombre;?></th>
            <?php
            }
            ?>
        ...
        <?php
            ...
            ?>
  <th width="157" align="center" valign="middle">Cantidad</th>
          <th width="157" align="center" valign="middle">Porcentaje</th>
            ...
            ?>
            		...
            		<th width="67" align="center">Cantidad</th>
            		<th width="68" align="center">Porcentaje</th>
   		  </tr>
        </thead>
        ...
        <tbody class="EstTablaReporteBody">
          <tr>
            <td align="center">Contactados</td>
            
             <?php
			 $SumaTotalContactados = 0;
			 
            foreach($ArrSucursales as $DatSucursal){
				
				
				if($ATotalBase[$DatSucursal->SucId]>0){
				
					$PorcentajeContactados[$DatSucursal->SucId] =($ATotalEncuestados[$DatSucursal->SucId] *100)/$ATotalBase[$DatSucursal->SucId];
		
			
				}else{
		
					$PorcentajeContactados[$DatSucursal->SucId] = 0;
            ...
            ?>
            <td align="center"><?php echo $ATotalEncuestados[$DatSucursal->SucId];?></td>
            <td align="center"><?php echo number_format($PorcentajeContactados[$DatSucursal->SucId],2);?>%</td>
            
            <?php
			
			$SumaTotalContactados += $ATotalEncuestados[$DatSucursal->SucId];
			
			}
			
			if($SumaTotalBase>0){
					
					$SumaPorcentajeContactados = ($SumaTotalContactados *100)/$SumaTotalBase;
		
				}else{
					
					$SumaPorcentajeContactados = 0;
		
				}
				
				
			?>
            <td align="center"><?php echo number_format($SumaTotalContactados,2);?></td>
            <td align="center"><?php echo number_format($SumaPorcentajeContactados,2);?>%</td>
          </tr>
          
          
          
          <tr>
            <td align="center">No Contactados</td>
            
            <?php
			$SumaTotalNoContactados = 0;
			
            foreach($ArrSucursales as $DatSucursal){
				
				$ATotalNoContactados[$DatSucursal->SucId] = $ATotalBase[$DatSucursal->SucId] - $ATotalEncuestados[$DatSucursal->SucId];
				
				if($ATotalBase[$DatSucursal->SucId]>0){
					
					$PorcentajeNoContactados[$DatSucursal->SucId] = ($ATotalNoContactados[$DatSucursal->SucId] *100)/$ATotalBase[$DatSucursal->SucId];
		
				}else{
					
					$PorcentajeNoContactados[$DatSucursal->SucId] = 0;
		
				}
			
		
            ?>
            <td align="center"><?php echo $ATotalNoContactados[$DatSucursal->SucId];?></td>
            <td align="center"><?php echo number_format($PorcentajeNoContactados[$DatSucursal->SucId],2);?>%</td>
             <?php
			 
			 	$SumaTotalNoContactados += $ATotalNoContactados[$DatSucursal->SucId];
			}
			
				if($SumaTotalBase>0){
					
					$SumaPorcentajeNoContactados = ($SumaTotalNoContactados *100)/$SumaTotalBase;
		
				}else{
					
					$SumaPorcentajeNoContactados = 0;
			...
			?>
            <td align="center"><?php echo number_format($SumaTotalNoContactados,2);?></td>
            <td align="center"><?php echo number_format($SumaPorcentajeNoContactados,2);?>%</td>
          </tr>
          ...
          <tr>
            ...
            foreach($ArrSucursales as $DatSucursal){
            ?>
            <td align="center"><?php echo $ATotalBase[$DatSucursal->SucId];?></td>
			...
			?>
            <td align="center"><?php echo number_format($SumaTotalBase,2);?></td>
            <td align="center">100.00%</td>
          </tr>
          </tbody>
		<tfoot class="EstTablaReporteFoot">
...
$InsEncuesta = new ClsEncuesta();
// MtdObtenerEncuestas($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'EncId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oTipo=NULL,$oSucursal=NULL,$oFichaIngreso=NULL,$oOrdenVentaVehiculo=NULL,$oTipoFecha="EncFecha") 
$ResEncuesta = $InsEncuesta->MtdObtenerEncuestas(NULL,NULL,NULL,"EncId","DESC",$POST_pag,NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),"POSTVENTA",$POST_Sucursal,NULL,NULL,NULL,$TipoFecha);
$ArrEncuestas = $ResEncuesta['Datos'];
...
<table border="0" cellpadding="2" cellspacing="2" class="EstTablaReporte">
        ...
        <tr>
          ...
          <th width="177" align="center">Sucursal</th>
          <th width="106" align="center">Cliente</th>
          
          
            		<th width="110" align="center" valign="middle">Fecha</th>
            		<th width="113" align="center">Comentario</th>
            		<th width="84" align="center">VIN</th>
            		<th width="84" align="center">Placa</th>
            		<th width="88" align="center">Asesor</th>
            
       
       
          
          
          <th width="97" align="center">Telefono</th>
          </tr>
        </thead>
    ...
    <!--  if(in_array($DatEncuesta->EncNivel,$ArrPromotores)){
        ...
        <tbody class="EstTablaReporteBody">
		  ...
		  foreach($ArrEncuestas as $DatEncuesta){
			...
			if(in_array($DatEncuesta->EncNivel,$ArrDetractores)){
...
?>
          ...
          <tr>
            ...
            <td align="center"><?php
            echo $DatEncuesta->SucNombre;
			?></td>
            <td align="center"><?php
            echo $DatEncuesta->CliNombre;
			?>
            
            
            <?php
            echo $DatEncuesta->CliApellidoPaterno;
			?>
            
            <?php
            echo $DatEncuesta->CliApellidoMaterno;
			?></td>
            ...
            <?php
            echo $DatEncuesta->EncFechaTermino;
			?>
                 
                 </td>
           		 <td align="center"><?php
            echo $DatEncuesta->EncObservacion;
			?></td>
           		 <td align="center"><?php
            echo $DatEncuesta->EinVIN;
			?></td>
           		 <td align="center"><?php
            echo $DatEncuesta->EinPlaca;
			?></td>
           		 <td align="center"><?php
            echo $DatEncuesta->PerNombre;
			?>
                   <?php
            echo $DatEncuesta->PerApellidoPaterno;
			?>
                 <?php
            echo $DatEncuesta->PerApellidoMaterno;
			?></td>
            
          
            
            <td align="center"><?php
            echo $DatEncuesta->CliTelefono;
			?>
            /<?php
            echo $DatEncuesta->CliCelular;
			?></td>
          </tr>
...
<table border="0" cellpadding="2" cellspacing="2" class="EstTablaReporte">
        ...
        <tbody class="EstTablaReporteBody">
		  ...
		  foreach($ArrEncuestas as $DatEncuesta){
			...
			if(in_array($DatEncuesta->EncNivel,$ArrNeutros)){
