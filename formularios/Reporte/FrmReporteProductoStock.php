...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE STOCK DE PRODUCTOS</span>  </td>
          ...
          <td align="left" valign="top">
            ...
            <fieldset  class="EstFormularioContenedor">
              ...
              <table border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                  <td>Fecha Fin:</td>
                  <td><input name="CmpFechaFin" type="text" class="EstFormularioCajaFecha"  id="CmpFechaFin" value="<?php  echo date("d/m/Y");?>" size="10" maxlength="10" readonly="readonly"/>
...
<tr>
  ...
  <!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteProductoStock.php" target="IfrReporteProductoStock" id="IfrReporteProductoStock" name="IfrReporteProductoStock" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
   <div id="CapReporteProductoStock"></div>
