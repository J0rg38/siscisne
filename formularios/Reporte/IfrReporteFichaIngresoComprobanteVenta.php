...
$ResReporteFichaIngreso = $InsReporteFichaIngreso->MtdObtenerReporteFichaIngresos(NULL,NULL,NULL ,$POST_ord ,$POST_sen,NULL,FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),$POST_Modalidad,NULL,NULL,NULL,false,$POST_VehiculoMarca,true,$POST_Sucursal,"FinFecha",NULL,NULL,NULL,$POST_VehiculoModelo);
...
<?php }?>
        ...
        <tr   >
          ...
          <td class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" align="right" ><?php echo $DatReporteFichaIngreso->CliTelefono;  ?></td>
