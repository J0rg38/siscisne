...
$ResReporteFichaIngreso = $InsReporteFichaIngreso->MtdObtenerReporteFichaIngresos(NULL,NULL,NULL ,$POST_ord ,$POST_sen,NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),"MIN-10001",NULL,0,$POST_ClienteId,false,NULL,false,$POST_Sucursal);
...
<?php }?>
        ...
        <tr>
          ...
          <th width="32%">NOMBRE/APELLIDO DEL CLIENTE</th>
          <th width="8%">TIPO CLIENTE</th>
          <th width="12%">DESCRIPCION DEL MODELO</th>
          <th width="4%">O.T.</th>
          <th width="7%">FECHA O.T.</th>
          <th width="5%">VIN</th>
          <th width="7%">MANT. KILOM.</th>
          <th width="2%">&nbsp;</th>
          <th width="8%">TOTAL</th>
          </tr>
        </thead>
        ...
        <tr   >
          ...
          <td align="right" valign="top" class="<?php echo ($c%2==0)?"EstTablaReporteActivo":"EstTablaReporteInactivo";?>" ><?php echo $DatReporteFichaIngreso->SucNombre;  ?></td>
