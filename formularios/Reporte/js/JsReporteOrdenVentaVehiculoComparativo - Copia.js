...
function FncReporteOrdenVentaVehiculoComparativoImprimir(){
	...
	if(FncReporteOrdenVentaVehiculoComparativoValidar()){
		...
		FncPopUp("formularios/Reporte/IfrReporteOrdenVentaVehiculoComparativo.php?FechaInicio="+FechaInicio+"&FechaFin="+FechaFin+"&Sucursal="+Sucursal+"&VehiculoMarca="+VehiculoMarca+"&P=1");
...
function FncReporteOrdenVentaVehiculoComparativoGenerarExcel(){
	...
	if(FncReporteOrdenVentaVehiculoComparativoValidar()){
		...
		FncPopUp("formularios/Reporte/XLSReporteOrdenVentaVehiculoComparativo.php?FechaInicio="+FechaInicio+"&FechaFin="+FechaFin+"&Sucursal="+Sucursal+"&VehiculoMarca="+VehiculoMarca+"&P=2");
