...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteGeneralMotorKPI.js"></script>
...
<tr>
  ...
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteGeneralMotorKPI.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
<!--    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteGeneralMotorKPI.php" target="IfrReporteGeneralMotorKPI" method="post" name="FrmReporteGeneralMotorKPI" id="FrmReporteGeneralMotorKPI">
      -->
     <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteGeneralMotorKPI.php" target="IfrReporteGeneralMotorKPI" method="post" name="FrmReporteGeneralMotorKPI" id="FrmReporteGeneralMotorKPI">
...
<fieldset  class="EstFormularioContenedor">
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteGeneralMotorKPIImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteGeneralMotorKPIGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  <td colspan="2" align="center">
	...
	<iframe class="autoHeight"   target="IfrReporteGeneralMotorKPI" id="IfrReporteGeneralMotorKPI" name="IfrReporteGeneralMotorKPI" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>

	<!--<iframe class="autoHeight"  src="" target="IfrReporteGeneralMotorKPI" id="IfrReporteGeneralMotorKPI" name="IfrReporteGeneralMotorKPI" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
...
<!--
<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/XlsReporteGeneralMotorKPI.php"  method="post" name="FrmReporteGeneralMotorKPI2" id="FrmReporteGeneralMotorKPI2" target="_blank">
</form>

<iframe target="IfrReporteGeneralMotorKPI2" id="IfrReporteGeneralMotorKPI2" name="IfrReporteGeneralMotorKPI2" scrolling="auto"  frameborder="0" height="1"  ></iframe>
