...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteEncuestaPostVenta.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE ENCUESTAS DE POST VENTA</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteEncuestaPostVenta.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteEncuestaPostVenta.php" target="IfrReporteEncuestaPostVenta" method="GET" name="FrmReporteEncuestaPostVenta" id="FrmReporteEncuestaPostVenta" >
    -->  
    ...
    ?>
              ...
              <tr>
                ...
                <select disabled="disabled" class="EstFormularioCombo" name="CmpTipoFecha" id="CmpTipoFecha">
                  <option value="">Escoja una opcion</option>
                  
                  <option value="CIERRE"  selected="selected"  >Fecha O.T.</option>
...
<tr>
  ...
  <!--<iframe class="autoHeight" target="IfrReporteEncuestaPostVenta" id="IfrReporteEncuestaPostVenta" name="IfrReporteEncuestaPostVenta" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
  
  <div id="CapReporteEncuestaPostVenta"></div>
