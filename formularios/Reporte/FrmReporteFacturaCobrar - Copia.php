...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteFacturaCobrar.js"></script>
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE FACTURAS POR COBRAR</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteFacturaCobrar.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFacturaCobrar.php" target="IfrReporteFacturaCobrar" method="post" name="FrmReporteFacturaCobrar" id="FrmReporteFacturaCobrar">
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      ...
                      <option value="FacFechaEmision" selected="selected">Fecha Comprob.</option>
<option value="CliNombre" >Cliente</option>
          ...
          <td align="left" valign="top">
            ...
            ?>	
                  <input name="BtnImprimir"   id="BtnImprimir" type="image" border="0" src="imagenes/reporte_iconos/imprimir.png" alt="[Imprimir]" title="Imprimir" onclick="FncReporteFacturaCobrarImprimir('');" />           
                  <?php	  
            }
            ?>                  </td>
                <td>
            ...
            ?>
                  <input name="BtnExcel"   id="BtnExcel" type="image" border="0" src="imagenes/reporte_iconos/excel.png" alt="[GExcel]" title="Generar Excel" onclick="FncReporteFacturaCobrarGenerarExcel('');" />           
                  <?php	  
            }
            ?>                  </td>
                </tr>
...
<tr>
  ...
  <iframe class="autoHeight" target="IfrReporteFacturaCobrar" id="IfrReporteFacturaCobrar" name="IfrReporteFacturaCobrar" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
