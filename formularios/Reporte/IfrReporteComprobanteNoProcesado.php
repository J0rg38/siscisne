...
<body>
  ...
  $ResFactura = $InsReporteComprobanteVenta->MtdObtenerFacturas(NULL, "", NULL, "Fac" . $POST_ord, $POST_sen, NULL, $POST_Sucursal, NULL, FncCambiaFechaAMysql($POST_finicio), FncCambiaFechaAMysql($POST_ffin), NULL, NULL, NULL, NULL, NULL, $POST_Moneda, $POST_ClienteId, NULL, NULL, NULL, NULL, NULL, $POST_Personal, NULL, $POST_Sucursal_ANULADO, true);
  ...
  $ResBoleta = $InsReporteComprobanteVenta->MtdObtenerBoletas(NULL, "", NULL, "Bol" . $POST_ord, $POST_sen, NULL, NULL, FncCambiaFechaAMysql($POST_finicio), FncCambiaFechaAMysql($POST_ffin), NULL, NULL, NULL, $POST_Moneda, NULL, $POST_ClienteId, NULL, NULL, NULL, $POST_Sucursal, true);
  ...
  $ResNotaCredito = $InsReporteComprobanteVenta->MtdObtenerNotaCreditos(NULL, "", NULL, "Ncr" . $POST_ord, $POST_sen, 1, NULL, $POST_Sucursal, NULL, FncCambiaFechaAMysql($POST_finicio), FncCambiaFechaAMysql($POST_ffin), NULL, $POST_Moneda, NULL, NULL, $POST_Sucursal_ANULADO, $POST_ClienteId,   true);
  ...
  $ResNotaDebito = $InsReporteComprobanteVenta->MtdObtenerNotaDebitos(NULL, "", NULL, "Ndb" . $POST_ord, $POST_sen, 1, NULL, $POST_Sucursal, NULL, FncCambiaFechaAMysql($POST_finicio), FncCambiaFechaAMysql($POST_ffin), NULL, $POST_Moneda, NULL, NULL, $POST_Sucursal_ANULADO, true);
    ...
    <tbody class="EstTablaReporteBody">
      ...
      ?>
        ...
        <tr>
          ...
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatFactura->FtaNumero;  ?>-<?php echo $DatFactura->FacId;  ?></td>
          ...
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php //echo $DatFactura->FacTipoCambio;  
                                                                                                                        ?><?php echo $TipoCambio; ?></td>

          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatFactura->FinId;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatFactura->AmoId;  ?></td>
          ...
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right">
            ...
            <?php echo number_format($DatFactura->FacImpuesto, 2); ?>
      ...
      ?>
        ...
        <tr>
          ...
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatBoleta->BtaNumero;  ?>-<?php echo $DatBoleta->BolId;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatBoleta->BolFechaEmision;  ?></td>

          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"> <?php echo $DatBoleta->CliApellidoPaterno;  ?> <?php echo $DatBoleta->CliApellidoMaterno;  ?> <?php echo $DatBoleta->CliNombre;  ?></td>
          ...
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatBoleta->AmoId;  ?></td>
      ...
      ?>
        ...
        <tr>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right" valign="middle"><?php echo $c; ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaCredito->SucNombre;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaCredito->NctNumero;  ?>-<?php echo $DatNotaCredito->NcrId;  ?></td>
          ...
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"> <?php echo $DatNotaCredito->CliApellidoPaterno;  ?> <?php echo $DatNotaCredito->CliApellidoMaterno;  ?> <?php echo $DatNotaCredito->CliNombre;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaCredito->MonSimbolo;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php //echo $DatFactura->FacTipoCambio;  
                                                                                                                        ?><?php echo $TipoCambio; ?></td>

          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaCredito->FinId;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaCredito->AmoId;  ?></td>
      ...
      ?>
        ...
        <tr>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right" valign="middle"><?php echo $c; ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaDebito->SucNombre;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaDebito->NdtNumero;  ?>-<?php echo $DatNotaDebito->NdbId;  ?></td>
          ...
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"> <?php echo $DatNotaDebito->CliApellidoPaterno;  ?> <?php echo $DatNotaDebito->CliApellidoMaterno;  ?> <?php echo $DatNotaDebito->CliNombre;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaDebito->MonSimbolo;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php //echo $DatFactura->FacTipoCambio;  
                                                                                                                        ?><?php echo $TipoCambio; ?></td>

          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaDebito->FinId;  ?></td>
          <td class="<?php echo ($c % 2 == 0) ? "EstTablaReporteActivo" : "EstTablaReporteInactivo"; ?>" align="right"><?php echo $DatNotaDebito->AmoId;  ?></td>
