...
//MtdObtenerCotizacionVehiculosValor($oFuncion="SUM",$oParametro="CveId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'CveId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oMoneda=NULL,$oPersonal=NULL,$oNivelInteres=NULL,$oVehiculoModelo=NULL,$oMarca=NULL,$oSucursal=NULL)
$CotizacionVehiculoPersonalTotal = $InsCotizacionVehiculo->MtdObtenerCotizacionVehiculosValor("COUNT","CveId",NULL,NULL,NULL,NULL,NULL,'CveId','Desc',NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),3,NULL,$DatPersonal->PerId,NULL,NULL,$POST_Marca,$POST_Sucursal);
?>
...
$OrdenVentaVehiculoPersonalTotal = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculosValor("COUNT","OvvId",NULL,NULL,NULL,NULL,NULL,'OvvId','Desc',NULL,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,$DatPersonal->PerId,NULL,$POST_Marca,$POST_Sucursal)    
?>
...
$chart = new VerticalBarChart(400, 370);
	...
	$chart->render("../../generados/Graficos/".FncCambiaFechaAMysql($POST_finicio)."-".FncCambiaFechaAMysql($POST_ffin)."EficienciaVentas.png");
    
?>

<img alt="EFICIENCIA DE VENTAS/COTIZACIONES"  src="../../generados/Graficos/<?php echo FncCambiaFechaAMysql($POST_finicio)."-".FncCambiaFechaAMysql($POST_ffin);?>EficienciaVentas.png" style="border: 1px solid gray;"/>
...
$chart = new VerticalBarChart(400, 370);
	...
	$chart->render("../../generados/Graficos/".FncCambiaFechaAMysql($POST_finicio)."-".FncCambiaFechaAMysql($POST_ffin)."CumplimientoMetas.png");
    
?>

<img alt="CUMPLIMIENTO DE METAS"  src="../../generados/Graficos/<?php echo FncCambiaFechaAMysql($POST_finicio)."-".FncCambiaFechaAMysql($POST_ffin);?>CumplimientoMetas.png" style="border: 1px solid gray;"/>
