...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteCotizacionesDiariasCIS.js"></script>
...
$ResPersonal = $InsPersonal->MtdObtenerPersonales(NULL,NULL,NULL,"PerNombre","ASC",NULL,NULL,1,NULL,NULL,NULL,1,NULL,$_SESSION['SesionSucursal']);
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE COTIZACIONES DE VEHICULOS DIARIOS</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteCotizacionesDiariasCIS.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <form enctype="application/x-www-form-urlencoded" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteCotizacionesDiariasCIS.php" target="IfrReporteCotizacionesDiariasCIS" method="GET" name="FrmReporteCotizacionesDiariasCIS" id="FrmReporteCotizacionesDiariasCIS">
                ...
                <tr>
                  ...
                  <td>
                    <select name="CmpOrden" id="CmpOrden" class="EstFormularioCombo">
                      <option value="CveId" >Ord. Ven.</option>
                      <option value="CveFecha" selected="selected" >Fecha</option>
...
<tr>
  <td colspan="2" align="center">
   <!--class="autoHeight"-->
  <iframe class="autoHeight"  src="" target="IfrReporteCotizacionesDiariasCIS" id="IfrReporteCotizacionesDiariasCIS" name="IfrReporteCotizacionesDiariasCIS" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe></td>
</tr>
</table>
</div>
