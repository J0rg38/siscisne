...
<?php }?>
        ...
        <tr>
          ...
          <th width="6%" align="center">MON.</th>
          <th width="9%" align="center">CANCELADO</th>
          <th width="9%" align="center">COSTO</th>
          <th width="9%" align="center">COSTO C/ IGV</th>
          </tr>
        </thead>
        ...
        ?>
                ...
                <td  align="right" valign="middle" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo $c;?></td>
                <td  align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"    ><?php echo ($DatReporteVehiculoMovimientoEntrada->VmvComprobanteFecha);?></td>
                <td  align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"   ><?php echo ($DatReporteVehiculoMovimientoEntrada->VmvComprobanteNumero);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo ($DatReporteVehiculoMovimientoEntrada->EinVIN);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo ($DatReporteVehiculoMovimientoEntrada->VmaNombre);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo ($DatReporteVehiculoMovimientoEntrada->VmoNombre);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo ($DatReporteVehiculoMovimientoEntrada->VveNombre);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo ($DatReporteVehiculoMovimientoEntrada->EinColor);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"   ><?php echo ($DatReporteVehiculoMovimientoEntrada->EinAnoFabricacion);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"   ><?php echo ($DatReporteVehiculoMovimientoEntrada->EinAnoModelo);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"   ><?php echo ($DatReporteVehiculoMovimientoEntrada->MonSimbolo);?></td>
  ...
  <?php	
				...
				?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo number_format($DatReporteVehiculoMovimientoEntrada->EinCostoIngresoReal,2);?></td>
                <td align="right" valign="top" class="<?php echo (($c%2==0)?'EstTablaReporteActivo':'EstTablaReporteInactivo');?>"  ><?php echo number_format($DatReporteVehiculoMovimientoEntrada->EinCostoIngresoImpuestoReal,2);?></td>
          </tr>
		<?php	
