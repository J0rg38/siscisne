...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsReporteEncuestaVentav2.js"></script>

<?php

$POST_Sucursal = $_SESSION['SesionSucursal'];
$POST_Sucursal = $_POST['SesionSucursal'];
$POST_Sucursal = $_SESSION['SesionSucursal'];
...
<tr>
  <td width="98%" height="25">
    ...
    <span class="EstFormularioTitulo">REPORTE DE ENCUESTAS DE  VENTA</span></td>
  <td width="2%"><a href="formularios/Reporte/inf/InfReporteEncuestaVenta.html?height=400&amp;width=850" class="thickbox" title=""><!-- <img src="imagenes/info.png" alt="[Info]" width="25" height="25" border="0" align="absmiddle" title="Mas Informacion" />--></a></td>
</tr>

<tr>
  <td colspan="2" align="center">
    <!--<form enctype="multipart/form-data" action="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteEncuestaVenta.php" target="IfrReporteEncuestaVenta" method="GET" name="FrmReporteEncuestaVenta" id="FrmReporteEncuestaVenta" >
    -->  
    ...
    ?>
              ...
              <tr>
                <td>Tipo Fecha:</td>
                <td><select disabled="disabled" class="EstFormularioCombo" name="CmpTipoFecha" id="CmpTipoFecha">
                  <option value="">Escoja una opcion</option>
                  <option value="ENTREGA"  selected="selected"  >Fecha de Entrega</option>
                  <option value="ENCUESTA">Fecha Encuesta</option>
                </select></td>
                </tr>
              </table>
          </fieldset>             </td>
  ...
  Asesor de Ventas: <select   class="EstFormularioCombo" name="CmpPersonal" id="CmpPersonal" >
                 <option value="">Escoja una opcion</option>
                 <?php
...
<tr>
  ...
  <!--<iframe class="autoHeight" target="IfrReporteEncuestaVenta" id="IfrReporteEncuestaVenta" name="IfrReporteEncuestaVenta" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
  
  <div id="CapReporteEncuestaVenta"></div>
