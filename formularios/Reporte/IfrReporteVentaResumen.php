...
<?php	
        ...
        ?></td>
  <td width="54%" rowspan="2" align="center" valign="top">REPORTE DE VENTA DETALLADA</td>
...
?>
                            ...
                            <tr>
                             ...
                             <td bgcolor="<?php echo $Color;?>">&nbsp;</td>
                             <td bgcolor="<?php echo $Color;?>">&nbsp;</td>
                             <td bgcolor="<?php echo $Color;?>"><?php echo $DatCajaDiaria->PerNombre;?> <?php echo $DatCajaDiaria->PerApellidoPaterno;?> <?php echo $DatCajaDiaria->PerApellidoMaterno;?> <?php echo $DatCajaDiaria->CliNombre;?> <?php echo $DatCajaDiaria->CliApellidoPaterno;?> <?php echo $DatCajaDiaria->CliApellidoMaterno;?> <?php echo $DatCajaDiaria->PrvNombre;?> <?php echo $DatCajaDiaria->PrvApellidoPaterno;?> <?php echo $DatCajaDiaria->PrvApellidoMaterno;?></td>
                             <td bgcolor="<?php echo $Color;?>">&nbsp;</td>
                             <td bgcolor="<?php echo $Color;?>">&nbsp;</td>
                             <td bgcolor="<?php echo $Color;?>">&nbsp;</td>
                              <td bgcolor="<?php echo $Color;?>">&nbsp;</td>
