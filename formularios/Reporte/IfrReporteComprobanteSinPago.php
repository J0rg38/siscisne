...
if($_GET['P']==2){
	...
	header("Content-Disposition:  filename=\"REPORTE_COMPROBANTE_SIN_PAGO_".date('d-m-Y').".xls\";");
}
?>
<html>
<head>
...
$ResFactura = $InsFactura->MtdObtenerFacturas(NULL,NULL,NULL,"Fac".$POST_ord,$POST_sen,NULL,NULL,5,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,NULL,"NPA-10000",NULL,$POST_Moneda,$POST_ClienteId,NULL,NULL,NULL,NULL,NULL,$POST_Personal,NULL,$POST_Sucursal,false,NULL,true);
...
$ResBoleta = $InsBoleta->MtdObtenerBoletas(NULL,NULL,NULL,"Bol".$POST_ord,$POST_sen,NULL,5,FncCambiaFechaAMysql($POST_finicio),FncCambiaFechaAMysql($POST_ffin),NULL,NULL,"NPA-10000",$POST_Moneda,NULL,$POST_ClienteId,NULL,NULL,$POST_Personal,$POST_Sucursal,false,NULL,true);
...
<tr>
  ...
  <td width="54%" align="center" valign="top"><span class="EstReporteTitulo">REPORTE DE COMPROBANTES SIN PAGO DEL
      <?php
...
?>
            <span class="EstImportante2"> CANCELADO </span>
            <?php	
}else{
	
	$TotalFacturaNoCancelada += $DatFactura->FacTotal;
?>
            <span class="EstImportante1"> SIN CANCELAR </span>
          <?php
}
?></td>
          </tr>
