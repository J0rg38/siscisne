...
<tr>
  ...
  <!--<iframe class="autoHeight"  src="<?php echo $InsProyecto->MtdRutFormularios();?>Reporte/IfrReporteFichaIngresoPendiente.php" target="IfrReporteFichaIngresoPendiente" id="IfrReporteFichaIngresoPendiente" name="IfrReporteFichaIngresoPendiente" scrolling="auto"  frameborder="0"  height="420" width="100%"></iframe>-->
  
  <div id="CapReporteFichaIngresoPendiente"></div>
