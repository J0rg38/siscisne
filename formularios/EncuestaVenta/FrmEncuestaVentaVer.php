...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    ?>
          ...
          <tr>
            ...
            <td colspan="3"><input name="CmpFecha" type="text" class="EstFormularioCajaFecha" id="CmpFecha" value="<?php  echo $InsEncuesta->EncFecha;?>" size="10" maxlength="10" readonly="readonly" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="3" align="left" valign="top"><table>
              <tr>
                <td><a href="javascript:FncOrdenVentaVehiculoNuevo();"></a></td>
                <td><input name="CmpOrdenVentaVehiculoId" id="CmpOrdenVentaVehiculoId" type="hidden"    value="<?php  echo $InsEncuesta->OvvId;?>" size="20" maxlength="20" />
                  <input name="CmpOrdenVentaVehiculo" type="text" class="EstFormularioCaja" id="CmpOrdenVentaVehiculo"  value="<?php  echo $InsEncuesta->OvvId;?>" size="25" maxlength="25" readonly="readonly" /></td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input name="CmpVehiculoIngresoPlaca" type="text" class="EstFormularioCaja" id="CmpVehiculoIngresoPlaca" value="<?php echo $InsEncuesta->EinPlaca;?>" size="25" maxlength="255"  readonly="readonly"/></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
