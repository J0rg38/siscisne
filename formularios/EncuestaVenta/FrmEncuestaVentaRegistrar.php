...
//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccEncuestaVentaRegistrar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    ?>
            ...
            <td colspan="3" align="left" valign="top"><table>
              <tr>
                ...
                <td>
                  ...
                  <input name="CmpOrdenVentaVehiculoId" id="CmpOrdenVentaVehiculoId" type="hidden"    value="<?php  echo $InsEncuesta->OvvId;?>" size="20" maxlength="20" />
                  <input name="CmpOrdenVentaVehiculo" type="text" class="EstFormularioCaja" id="CmpOrdenVentaVehiculo"  value="<?php  echo $InsEncuesta->OvvId;?>" size="25" maxlength="25" />
              ...
              <!--  <a id="BtnOrdenVentaVehiculoBuscarLista" href="javascript:FncOrdenVentaVehiculoBuscarLista();" title=""><img src="imagenes/acciones/buscador.png" alt="" width="25" height="25" border="0" align="absmiddle" /></a>
              -->  
          ...
          <tr>
            ...
            <td width="105" align="left" valign="top">Modelo:</td>
            <td width="146" align="left" valign="top"><input name="CmpVehiculoModelo" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoModelo" value="<?php echo $InsEncuesta->VmoNombre;?>" size="25" maxlength="255"  readonly="readonly"/></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="3">
              <select name="CmpVerbatin" id="CmpVerbatin" class="EstFormularioCombo">
                ...
                <option value="ACCESORIZACION">ACCESORIZACION</option>
