...
//	$objPHPExcel->setActiveSheetIndex(0)
//            ->setCellValue('I10', $InsPedidoCompra->OcoId);	
...
$fila = $fila + 3;
//
//$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C'.$fila, "OBSERVACIONES:");
//$objPHPExcel->getActiveSheet()->getStyle('C'.$fila)->getFont()->setBold(true);

//$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D'.$fila, $InsPedidoCompra->PcoObservacionImpresa);
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Ord. Comp.');
