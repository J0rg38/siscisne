...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER ESTADO DE ORDEN DE COMPRA (OTROS PROVEEDORES)</span></td>
      </tr>
      <tr>
        <td colspan="2">
...
?>
             ...
             <tr>
               ...
               <td align="left" valign="top">
                 ...
                 <!--<input type="hidden" name="CmpEstado" id="CmpEstado" value="<?php echo $InsPedidoCompra->PcoEstado;?>" />--></td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             ...
             <tr>
               ...
               <td align="left" valign="top"><textarea name="CmpObservacionImpresa" cols="45" rows="2" readonly="readonly" class="EstFormularioCaja" id="CmpObservacionImpresa"><?php echo $InsPedidoCompra->PcoObservacionImpresa;?></textarea></td>
               <td align="left" valign="top">&nbsp;</td>
             </tr>
             </table>
           </div></td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               <td>&nbsp;</td>
               <td><input type="hidden" name="CmpPedidoCompraDetalleAccion" id="CmpPedidoCompraDetalleAccion" value="AccPedidoCompraSimpleDetalleRegistrar.php" /></td>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
             </tr>
             <tr>
