...
function FncPedidoCompraDetalleNuevo(){
	...
	$('#CmpPedidoCompraDetalleAccion').val("AccPedidoCompraSimpleDetalleRegistrar.php");
...
function FncPedidoCompraDetalleGuardar(){
		...
		var Acc = $('#CmpPedidoCompraDetalleAccion').val();		
			...
			if(ProductoId == ""){
				...
				$.ajax({
				  type: 'POST',
				  url: 'formularios/PedidoCompraSimple/acc/'+Acc,
				  ...
				  '&PedidoCompraDetalleCodigo='+PedidoCompraDetalleCodigo+
				  '&Item='+Item,
				  success: function(){
...
function FncPedidoCompraDetalleListar(){
	...
	$.ajax({
		type: 'POST',
		url: 'formularios/PedidoCompraSimple/FrmPedidoCompraSimpleDetalleListado.php',
		data: 'Identificador='+Identificador+'&Editar='+PedidoCompraDetalleEditar+'&Eliminar='+PedidoCompraDetalleEliminar+'&VerEstado='+PedidoCompraDetalleVerEstado+'&PorcentajeImpuestoVenta='+PorcentajeImpuestoVenta+'&IncluyeImpuesto='+IncluyeImpuesto+'&OrdenCompraId='+OrdenCompraId+'&MonedaId='+MonedaId+'&TipoCambio='+TipoCambio,
...
function FncPedidoCompraDetalleEscoger(oItem){
	...
	$('#CmpPedidoCompraDetalleAccion').val("AccPedidoCompraSimpleDetalleEditar.php");
	
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: 'formularios/PedidoCompraSimple/acc/AccPedidoCompraSimpleDetalleEscoger.php',
...
function FncPedidoCompraDetalleEliminar(oItem){
	...
	if(confirm("¿Realmente desea eliminar el elemento?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/PedidoCompraSimple/acc/AccPedidoCompraSimpleDetalleEliminar.php',
			data: 'Identificador='+Identificador+'&Item='+oItem,
			success: function(){
...
function FncPedidoCompraDetalleEliminarTodo(){
	...
	if(confirm("¿Realmente desea eliminar todos los elementos?")){
		...
		$.ajax({
			type: 'POST',
			url: 'formularios/PedidoCompraSimple/acc/AccPedidoCompraSimpleDetalleEliminarTodo.php',
			data: 'Identificador='+Identificador,
			success: function(){
				$('#CapProductoAccion').html('Eliminado');	
				FncPedidoCompraDetalleListar();
