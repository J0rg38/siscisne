...
//					case "1":
	document.getElementById("FrmListado").action = "formularios/PedidoCompraSimple/acc/AccPedidoCompraSimpleGenerarExcel.php";
//					break;
//					
//					case "2":
//	document.getElementById("FrmListado").action = "formularios/PedidoCompraSimple/acc/AccPedidoCompraSimpleGenerarExcel2.php";
//					break;
//				
//				}
//				
...
function FncListadoImprimir(){
	...
	document.getElementById("FrmListado").action = "formularios/PedidoCompraSimple/FrmPedidoCompraSimpleListadoImprimir.php"
...
function FncPedidoCompraSimpleSolicitarAutorizacion(oId,oAprobado,oLineaCreditoActiva){
	
	if(oAprobado == "2"){
		
//		if(oLineaCreditoActiva == "1"){
			
			window.location = "principal.php?Mod=PedidoCompraSimple&Form=SolicitarAutorizacion&Id="+oId;	
