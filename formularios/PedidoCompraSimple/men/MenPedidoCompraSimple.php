<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"PedidoCompra","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"PedidoCompra","Listado") and empty($GET_dia)){
?>  
