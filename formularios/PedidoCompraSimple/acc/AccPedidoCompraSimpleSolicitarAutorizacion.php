...
//	}
	...
	if($Guardar){
		...
		$InsPedidoCompra->MtdEditarPedidoCompraDato("PcoObservacionCorreo",$InsPedidoCompra->PcoObservacionCorreo,$InsPedidoCompra->PcoId);
	
		$InsPedidoCompra->MtdEditarPedidoCompraDato("PcoObservacionImpresa",$InsPedidoCompra->PcoObservacionImpresa,$InsPedidoCompra->PcoId);
		...
		if(!empty($InsPedidoCompra->PcoDestinatarios)){
				...
				if($InsPedidoCompra->MtdGenerarExcelPedidoCompraAutorizacion($InsPedidoCompra->PcoId,'')){
					...
					//if($InsPedidoCompra->MtdEnviarCorreoSolicitarAutorizacionPedidoCompra($InsPedidoCompra->PcoId,$InsPedidoCompra->PcoDestinatarios,$_SESSION['SesionNombre'],array("generados/pedido_compra/".$InsPedidoCompra->PcoId.".xls"))){
						if($InsPedidoCompra->MtdEnviarCorreoSolicitarAutorizacionPedidoCompra($InsPedidoCompra->PcoId,$InsPedidoCompra->PcoDestinatarios,$_SESSION['SesionNombre'],NULL)){
