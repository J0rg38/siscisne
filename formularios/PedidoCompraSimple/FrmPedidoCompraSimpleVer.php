...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPedidoCompraSimpleEditar.php');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td width="1922" height="25" colspan="2"><span class="EstFormularioTitulo">VER ORDEN DE COMPRA (OTROS PROVEEDORES)</span></td>
      </tr>
      <tr>
        <td colspan="2">
           ...
           <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
             ...
             <tr>
               ...
               <td><span class="EstFormularioSubTitulo">
                 <input type="hidden" name="CmpClienteId2" id="CmpClienteId2"  value="<?php echo $InsPedidoCompra->CliId?>" />
               </span></td>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td align="center">&nbsp;</td>
             ...
             <tr>
               ...
               <td colspan="3" align="left" valign="top"><table>
                 <tr>
                   <td><select <?php if(!empty($InsPedidoCompra->PrvId)){ echo 'disabled="disabled"';} ?>  class="EstFormularioCombo" name="CmpProveedorTipoDocumento" id="CmpProveedorTipoDocumento">
			...
			?>
                   ...
                   <td><input name="CmpProveedorNumeroDocumento" type="text" class="EstFormularioCaja" id="CmpProveedorNumeroDocumento"  value="<?php echo $InsPedidoCompra->PrvNumeroDocumento;?>" size="15" maxlength="50" readonly="readonly" <?php if(!empty($InsPedidoCompra->PrvId)){ echo 'readonly="readonly"';} ?> /></td>
                   <td><a href="javascript:FncProveedorBuscar('NumeroDocumento');"></a></td>
                   <td><input name="CmpProveedorNombreCompleto" type="text" class="EstFormularioCaja" id="CmpProveedorNombreCompleto" value="<?php echo $InsPedidoCompra->PrvNombreCompleto;?>" size="45" maxlength="255" readonly="readonly" <?php if(!empty($InsPedidoCompra->PrvId)){ echo 'readonly="readonly"';} ?>  />                     <a href="comunes/Proveedor/FrmProveedorBuscar.php?height=440&amp;width=850" class="thickbox" title=""></a></td>
                   <td>&nbsp;</td>
                 </tr>
                 <tr> </tr>
               </table></td>
       ...
       <tr>
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               <td>&nbsp;</td>
               <td width="50%"><input type="hidden" name="CmpPedidoCompraDetalleAccion" id="CmpPedidoCompraDetalleAccion" value="AccPedidoCompraSimpleDetalleRegistrar.php" /></td>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
             </tr>
             <tr>
