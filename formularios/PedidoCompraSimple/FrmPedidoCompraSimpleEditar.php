...
//deb($InsPedidoCompra->PcoFactura);
...
<?php
//if($InsPedidoCompra->PcoFactura=="No"){
?>
...
<input type="hidden" name="CmpProveedorApellidoMaterno" id="CmpProveedorApellidoMaterno"  value="<?php echo $InsPedidoCompra->PrvApellidoMaterno;?>" />
			...
			?>
                     <option <?php echo ($DatTipoDocumento->TdoId==$InsPedidoCompra->TdoIdProveedor)?'selected="selected"':"";?> value="<?php echo $DatTipoDocumento->TdoId?>"><?php echo $DatTipoDocumento->TdoCodigo?> - <?php echo $DatTipoDocumento->TdoNombre?></option>
                     <?php
			}
			?>
                   </select></td>
             ...
             <tr>
			  ...
			  ?>
               ...
               <td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0">
                 <tr>
                   <td><input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncPedidoCompraDetalleListar();" value="<?php if (empty($InsPedidoCompra->PcoTipoCambio)){ echo "";}else{ echo $InsPedidoCompra->PcoTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
               ...
               <tr>
                 <td width="98%">
                   ...
                   <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                     <tr>
                       <td>&nbsp;</td>
                       <td colspan="17"><span class="EstFormularioSubTitulo">PRODUCTOS</span>
         ...
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               ...
               <td width="50%" align="right"><a href="javascript:FncPedidoCompraDetalleListar();">
