...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsPagoFactura.js"></script>
<?php
/* 
...
//MENSAJES
include($InsProyecto->MtdFormulariosMsj($GET_mod).'MsjPagoFactura.php');
//CLASES
...
$POST_Moneda = $InsFactura->MonId;

$InsPago->UsuId = $_SESSION['SesionId'];

//ACCIONES
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccPagoFactura.php');
//DATOS
...
$ResPago = $InsPago->MtdObtenerPagos("PagId,OvvId,FacId","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,NULL,NULL,$POST_CondicionPago,$POST_Moneda,$GET_FacId,$GET_FtaId);
...
<tr>
  <td height="25"><span class="EstFormularioTitulo">LISTADO DE ORDENES DE ABONOS DE  FACTURA: <?php echo $InsFactura->FtaNumero;?> - <?php echo $InsFactura->FacId;?> / <?php echo $InsFactura->VdiId;?> <?php echo $InsFactura->OvvId;?></span></td>
</tr>
...
<tr>
  ...
  <?php $InsFactura->FacTotal = (($EmpresaMonedaId==$InsFactura->MonId or empty($InsFactura->MonId))?$InsFactura->FacTotal:($InsFactura->FacTotal/$InsFactura->FacTipoCambio));?>
    <?php $InsFactura->FacSaldo = (($EmpresaMonedaId==$InsFactura->MonId or empty($InsFactura->MonId))?$InsFactura->FacSaldo:($InsFactura->FacSaldo/$InsFactura->FacTipoCambio));?>
    <!--<table width="100%" border="0" cellpadding="2" cellspacing="4" class="EstTablaTotales">
      <tr>
        <td align="right" class="EstTablaTotalesEtiqueta">TOTAL: <span class="EstMonedaSimbolo"> <?php echo $InsFactura->MonSimbolo;?></span></td>
        <td align="right" class="EstTablaTotalesContenido"><?php echo number_format($InsFactura->FacTotal,2);?></td>
        <td align="right" class="EstTablaTotalesEtiqueta">POR COBRAR: <span class="EstMonedaSimbolo"> <?php echo $InsFactura->MonSimbolo;?></span></td>
        <td align="right" class="EstTablaTotalesContenido"><div id="CapTotalOrdenCobros" ></div></td>
        <td align="right" class="EstTablaTotalesEtiqueta">ABONADO: <span class="EstMonedaSimbolo"> <?php echo $InsFactura->MonSimbolo;?></span></td>
        <td align="right" class="EstTablaTotalesContenido"><div id="CapTotalAbonos" ></div></td>
        <td align="right" class="EstTablaTotalesEtiqueta">SALDO: <span class="EstMonedaSimbolo"><?php echo $InsFactura->MonSimbolo;?></span></td>
        <td align="right" class="EstTablaTotalesContenido"><?php echo number_format($InsFactura->FacSaldo,2);?></td>
      </tr>
    </table>-->
  ...
  <tbody class="EstTablaListadoBody">
    ...
    <tr id="Fila_<?php echo $f;?>">
      ...
      <td align="right" valign="middle" width="7%"   >
        ...
        <?php echo $dat->FtaNumero;  ?>-<?php echo $dat->FacId;  ?></td>
      <td  width="10%" align="right" ><?php echo $dat->PagNumeroRecibo;  ?></td>
      <td  width="10%" align="right" ><?php echo $dat->PagFechaTransaccion;  ?></td>
...
?>
        ...
        <a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=PagoFactura&Form=Editar&Id=<?php echo $dat->PagId;?><?php echo (!empty($GET_dia)?'&Dia=1':'');?>&FacId=<?php echo $GET_FacId;?>&FtaId=<?php echo $GET_FtaId;?>"><img src="imagenes/acciones/acc_editar.png" width="19" height="19" border="0" title="Editar" alt="[Editar]"   /></a>
...
?>
        ...
        <a href="principal<?php echo (!empty($GET_dia)?'2':'');?>.php?Mod=PagoFactura&Form=Ver&Id=<?php echo $dat->PagId;?><?php echo (!empty($GET_dia)?'&Dia=1':'');?>&FacId=<?php echo $GET_FacId;?>&FtaId=<?php echo $GET_FtaId;?>"><img src="imagenes/acciones/acc_ver.png" width="19" height="19" border="0" title="Ver" alt="[Ver]"   /></a>
...
<tr>
  <td align="center"><span class="EstFormularioTitulo">OTROS ABONOS RELACIONADOS</span></td>
</tr>
<tr>
  <td>&nbsp;</td>
</tr>
...
<table class="EstTablaListado" width="100%" cellspacing="0" cellpadding="0" border="0" >
            ...
            <thead class="EstTablaListadoHead">
              ...
              <tr>
                ...
                <th width="13%" >FECHA TRANSAC.</th>
                <th width="16%" >NUM. TRANSAC.</th>
                <th width="10%" >FECHA</th>
                <th width="11%" >MONEDA</th>
                <th width="5%" >T.C.</th>
                <th width="9%" >MONTO</th>
                <th width="7%" >COMPRBOB.</th>
                <th width="7%" >ESTADO</th>
                <th width="5%" >Doc. Scan.</th>
              </tr>
            </thead>
...
<tbody class="EstTablaListadoBody">
            <?php
              ...
              <tr id="Fila_<?php echo $f;?>">
                ...
                <td  width="10%" align="right" ><?php echo $dat->PagNumeroRecibo;  ?></td>
                <td  width="13%" align="right" ><?php echo $dat->PagFechaTransaccion;  ?></td>
                <td  width="16%" align="right" ><?php echo $dat->PagNumeroTransaccion;  ?></td>
                <td  width="10%" align="right" ><?php echo $dat->PagFecha; ?></td>
                <td align="right" ><?php echo ($dat->MonNombre);?></td>
                <td align="right" ><?php echo ($dat->PagTipoCambio);?></td>
                <td  width="9%" align="right" >
  ...
  <?php $dat->PagMonto = (($EmpresaMonedaId==$POST_Moneda or empty($POST_Moneda))?$dat->PagMonto:($dat->PagMonto/$dat->PagTipoCambio));?>
                ...
                <td  width="7%" align="right" ><?php echo $dat->PagComprobanteVenta;  ?></td>
...
}else if($InsFactura->VdiId){


	$InsVentaDirecta = new ClsVentaDirecta();
	$InsVentaDirecta->VdiId = $InsFactura->VdiId;
...
// MtdObtenerPagos($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'PagId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oVentaDirecta=NULL,$oOrdenVentaVehiculo=NULL,$oCondicionPago=NULL,$oMoneda=NULL,$oFactura=NULL,$oFacturaTalonario=NULL,$oBoleta=NULL,$oBoletaTalonario=NULL,$oArea=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oFecha="PagFecha")
	$ResPago = $InsPago->MtdObtenerPagos("PagId,OvvId,OvvId","contiene",$POST_fil,$POST_ord,$POST_sen,$POST_pag,NULL,$InsVentaDirecta->VdiId,NULL,$POST_CondicionPago,$POST_Moneda);
