...
<?php
						...
						for( $columna=0; $columna < $num_cols; $columna++ ) {
							...
							if($columna == 2){
								...
								$PagoFechaDia = substr ($PagoFecha,6,2);
								$PagoFechaMes = substr ($PagoFecha,4,2);
								$PagoFechaAno = substr ($PagoFecha,0,4);
...
<b>Fecha de Pago:</b> <?php echo $PagoFecha;?><br />
</span>

<br />
<br />
        
<?php						if($InsPago->MtdRegistrarPago()){
