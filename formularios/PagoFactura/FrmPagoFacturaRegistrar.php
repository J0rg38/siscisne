...
?>
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccPagoFacturaRegistrar.php');
  ...
  //$ResTarjeta = $InsTarjeta->MtdObtenerTarjetas(NULL,NULL,'TarId','Desc',NULL,NULL,$InsFactura->MonId);
