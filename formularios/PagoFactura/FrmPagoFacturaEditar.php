...
?>
  ...
  <script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod); ?>JsPagoFacturaFunciones.js"></script>
  ...
  include($InsProyecto->MtdFormulariosAcc($GET_mod) . 'AccPagoFacturaEditar.php');
              ...
              <div id="tab1" class="tab_content">
                ...
                <div class="EstFormularioArea">
                  ...
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td align="left" valign="top">Factura:
                        ...
                        <input name="CmpFacturaTalonarioNumero" type="hidden" id="CmpFacturaTalonarioNumero" value="<?php echo $FacturaTalonarioNumero; ?>" />
                      </td>
                      ...
                      <td align="left" valign="top">Total de la Factura:</td>
                      <td align="left" valign="top"><input class="EstFormularioCajaDeshabilitada" name="CmpFacturaTotal" type="text" id="CmpFacturaTotal" value="<?php echo number_format($InsPago->FacTotal, 2); ?>" size="10" maxlength="10" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><span id="sprytextfield">
                          ...
                          <span class="textfieldInvalidFormatMsg"><img src="imagenes/advertencia.png" alt="" border="0" align="absmiddle" title="Formato no valido" /></span></span> <img src="imagenes/acciones/calendario.png" alt="[Calendario]" id="BtnFechaTransaccion" name="BtnFechaTransaccion" width="25" height="25" align="absmiddle" style="cursor:pointer;" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
