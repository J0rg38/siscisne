...
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoSalidaSimpleFunciones.js" ></script>
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoSalidaSimpleDetalleFunciones.js" ></script>
<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoSalidaSimpleAutocompletar.js" ></script>

<script type="text/javascript" src="<?php echo $InsProyecto->MtdFormulariosJs($GET_mod);?>JsVehiculoMovimientoSalidaSimpleFotoFunciones.js" ></script>


<style type="text/css">
@import url('<?php echo $InsProyecto->MtdFormulariosCss($GET_mod);?>CssVehiculoMovimientoSalidaSimple.css');
</style>
...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoMovimientoSalidaSimpleRegistrar.php');
...
*/
//var MonedaFuncion = "FncVehiculoMovimientoSalidaSimpleDetalleListar";

var VehiculoMovimientoSalidaDetalleEditar = 1;
var VehiculoMovimientoSalidaDetalleEliminar = 1;

var VehiculoMovimientoSalidaSimpleFotoEditar = 1;
var VehiculoMovimientoSalidaSimpleFotoEliminar = 1;
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <div class="EstFormularioArea">
                  <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="4">
                        <span class="EstFormularioSubTitulo">Datos de la Salida de Unidad Vehicular
                          <input type="hidden" name="Guardar" id="Guardar"   />
                          <input type="hidden" name="Identificador" id="Identificador"  value="<?php echo $Identificador; ?>" />
                          <input type="hidden" name="CmpTiempoRegistroInicio" id="CmpTiempoRegistroInicio"  value="<?php echo $InsVehiculoMovimientoSalida->VmvTiempoRegistroInicio; ?>" />
			...
			?>
                          ...
                          <td><input class="EstFormularioCaja" name="CmpClienteNombreCompleto" type="text" id="CmpClienteNombreCompleto" value="<?php echo $InsVehiculoMovimientoSalida->CliNombreCompleto;?>" size="45" maxlength="255"  />
                            ...
                            <input name="CmpClienteApellidoMaterno" type="hidden" id="CmpClienteApellidoMaterno" value="<?php echo $InsVehiculoMovimientoSalida->CliApellidoMaterno;?>" size="3" />
                            <a href="formularios/VehiculoMovimientoSalidaSimple/FrmClienteBuscar.php?height=440&amp;width=850" class="thickbox" title=""> <img src="imagenes/acciones/buscador.png" alt="" width="25" height="25" border="0" align="absmiddle" /></a></td>
                          </tr>
                      </table></td>
                      <td>&nbsp;</td>
                    </tr>
			...
			?>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td align="left" valign="top">Numero Doc. Salida:</td>
                      ...
                      <td align="left" valign="top">Fecha Doc Salida: <br />
			  ...
			  ?>
                      ...
                      <td align="left" valign="top"><table>
                        <tr>
                          <td><input name="CmpTipoCambio" type="text"  class="EstFormularioCajaDeshabilitada" id="CmpTipoCambio" onchange="FncVehiculoMovimientoSalidaSimpleDetalleListar();" value="<?php if (empty($InsVehiculoMovimientoSalida->VmvTipoCambio)){ echo "";}else{ echo $InsVehiculoMovimientoSalida->VmvTipoCambio; } ?>" size="10" maxlength="10" />
                    ...
                    <tr>
                      ...
                      <td colspan="3" align="left" valign="top"><div class="EstFormularioArea" >
                        <table border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                          <tr>
                            <td width="1%">&nbsp;</td>
                            <td width="48%"><a href="javascript:FncVehiculoMovimientoSalidaSimpleFotoListar();"><img src="imagenes/acciones/listado_recargar.png" width="25" height="25" border="0" title="Recargar" alt="[Recargar]" align="absmiddle" /> Recargar</a> <a href="javascript:FncVehiculoMovimientoSalidaSimpleFotoEliminarTodo();"></a></td>
                            <td width="50%" align="right"><div class="EstFormularioAccion" id="CapVehiculoMovimientoSalidaSimpleFotosAccion">Listo
                          ...
                          <tr>
                            ...
                            <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" class="EstFormulario">
                              <tr>
                                <td width="275" colspan="2" align="left" valign="top"><div id="fileUploadVehiculoMovimientoSalidaSimpleFoto">Escoger Archivo</div>
                                  <script type="text/javascript">
									
									$(document).ready(function(){
						
											$("#fileUploadVehiculoMovimientoSalidaSimpleFoto").uploadFile({
												
											allowedTypes:"png,gif,jpg,jpeg,pdf",
											url:"formularios/VehiculoMovimientoSalidaSimple/acc/AccVehiculoMovimientoSalidaSimpleFotoSubir.php",
                              ...
                              <tr>
                                <td colspan="2" align="left" valign="top"><div class="EstCapVehiculoMovimientoSalidaSimpleFotos" id="CapVehiculoMovimientoSalidaSimpleFotos"></div></td>
                                <td align="left" valign="top">&nbsp;</td>
                              </tr>
                            </table></td>
                            <td><div id="CapVehiculoMovimientoSalidaSimpleFotosResultado"> </div></td>
                          </tr>
                        </table>
                      </div></td>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top"><textarea name="CmpObservacion" cols="45" rows="2" class="EstFormularioCaja" id="CmpObservacion"><?php echo $InsVehiculoMovimientoSalida->VmvObservacion;?></textarea></td>
    ...
    ?>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td valign="top"><input <?php echo (!empty($InsVehiculoMovimientoSalida->OcoId)?'checked="checked"':'');?>  type="checkbox" name="CmpNotificar" id="CmpNotificar" value="1"  />
                    ...
                    <tr>
                      <td width="98%">
                        ...
                        <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="20"><span class="EstFormularioSubTitulo">VEHICULOS</span>
...
<input name="CmpVehiculoIngresoCostoIngreso"  type="hidden" class="EstFormularioCaja" id="CmpVehiculoIngresoCostoIngreso" size="3" maxlength="20"  />
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td valign="middle"><a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
                            ...
                            <td valign="middle"><select disabled="disabled" class="EstFormularioCombo" name="CmpVehiculoMovimientoSalidaSimpleDetalleUnidadMedida" id="CmpVehiculoMovimientoSalidaSimpleDetalleUnidadMedida">
                              <option value="">Escoja una opcion</option>
                              <?php
			...
			?>
                            ...
                            <td valign="middle">
                              ...
                              <input name="CmpVehiculoMovimientoSalidaDetalleCantidad" type="text" class="EstFormularioCajaDeshabilitada" id="CmpVehiculoMovimientoSalidaDetalleCantidad" value="1" size="8" maxlength="10" readonly="readonly" />                            </td>
                            ...
                            <td valign="middle">
                              ...
                              <input name="CmpVehiculoMovimientoSalidaDetalleImporte" type="text" class="EstFormularioCaja" id="CmpVehiculoMovimientoSalidaDetalleImporte" size="8" maxlength="10" />                            </td>
                            ...
                            <td valign="middle"><a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
                            <td valign="middle">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
                  <tr>
                    ...
                    <td width="49%"><div class="EstFormularioAccion" id="CapVehiculoAccion">Listo
                      para registrar elementos</div></td>
                    <td width="49%" align="right"><a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleListar();">
                      <input type="hidden" name="CmpVehiculoMovimientoSalidaDetalleAccion" id="CmpVehiculoMovimientoSalidaDetalleAccion" value="AccVehiculoMovimientoSalidaSimpleDetalleRegistrar.php" />
                    ...
                    <!--<a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>--></td>
