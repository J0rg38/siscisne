...
if(isset($_POST['BtnGuardar_x']) or $_POST['Guardar']=="1"){	
	...
	$InsVehiculoMovimientoSalida->VmvSubTipo = 2	;
	...
	$ResVehiculoMovimientoSalidaDetalle = $_SESSION['InsVehiculoMovimientoSalidaDetalle'.$Identificador]->MtdObtenerSesionObjetos(false);
...
$InsVehiculoMovimientoSalida->VmvSubTotal = $InsVehiculoMovimientoSalida->VmvTotalBruto;
	...
	if($Guardar){
		...
		if($InsVehiculoMovimientoSalida->MtdEditarVehiculoMovimientoSalida()){		
...
function FncCargarDatos(){
	...
	$_SESSION['SesVmvFoto'.$Identificador] =	$InsVehiculoMovimientoSalida->VmvFoto;
	$_SESSION['SesVmvGuiaRemisionFoto'.$Identificador] = $InsVehiculoMovimientoSalida->VmvGuiaRemisionFoto;


	if($InsVehiculoMovimientoSalida->MonId<>$EmpresaMonedaId and (!empty($InsVehiculoMovimientoSalida->VmvTipoCambio) )){
		$InsVehiculoMovimientoSalida->VmvValorTotal = round($InsVehiculoMovimientoSalida->VmvValorTotal / $InsVehiculoMovimientoSalida->VmvTipoCambio,3);
	}
			
	//deb($InsVehiculoMovimientoSalida->VehiculoMovimientoSalidaDetalle);
