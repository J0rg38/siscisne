...
function FncNuevo(){
	...
	$InsVehiculoMovimientoSalida->CliId = $ClienteId;
	$InsVehiculoMovimientoSalida->CliNumeroDocumento = $ClienteNumeroDocumento;
	$InsVehiculoMovimientoSalida->CliNombre = $ClienteNombre;
	$InsVehiculoMovimientoSalida->CliApellidoPaterno = $ClienteApellidoPaterno;
	$InsVehiculoMovimientoSalida->CliApellidoMaterno = $ClienteApellidoMaterno;
	$InsVehiculoMovimientoSalida->TdoId = $TipoDocumentoId;
	$InsVehiculoMovimientoSalida->CliNombreCompleto = $ClienteNombreCompleto;
