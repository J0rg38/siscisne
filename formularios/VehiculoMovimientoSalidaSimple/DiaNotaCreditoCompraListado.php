...
// MtdObtenerNotaCreditoCompras($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'NccId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oMoneda=NULL,$oVehiculoMovimientoSalida=NULL,$oCliente=NULL)
$ResNotaCreditoCompra = $InsNotaCreditoCompra->MtdObtenerNotaCreditoCompras(NULL,NULL,NULL,"NNccFechaEmision","ASC",NULL,"3",NULL,NULL,NULL,$GET_CveId,NULL);
...
?>
      ...
      <tr>
        ...
        <th width="48%" align="center">Cliente</th>
...
?>
    ...
    <tr>
        ...
        <td align="left"><?php echo $DatNotaCreditoCompra->CliNombre;?>
          <?php echo $DatNotaCreditoCompra->CliApellidoPaterno;?>
          <?php echo $DatNotaCreditoCompra->CliApellidoMaterno;?>
        </td>
