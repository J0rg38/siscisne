...
?>
       ...
       <!--     
 <a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleReemplazorCargar('<?php echo  $Identificador;?>','<?php echo trim($DatSesionObjeto->Item);?>');"><?php echo $DatSesionObjeto->Parametro17;?></a>-->
...
-->
  ...
  <?php	
            ...
            <a class="EstSesionObjetosItem" href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleEscoger('<?php echo $DatSesionObjeto->Item;?>');"><img border="0"  align="absmiddle" src="imagenes/acciones/listado_editar.png" alt="[Editar]" title="Editar" width="25" height="25"  /></a>
            ...
            if($_POST['Eliminar']==1){
            ?>
            <a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleEliminar('<?php echo $DatSesionObjeto->Item;?>');" >
