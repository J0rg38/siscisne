...
include($InsProyecto->MtdFormulariosAcc($GET_mod).'AccVehiculoMovimientoSalidaSimpleEditar.php');
         ...
         <td valign="top">
           <div class="EstFormularioArea">
               ...
               <tr>
                 <td width="98%">
                   ...
                   <table class="EstFormulario" border="0" cellpadding="2" cellspacing="2">
                     ...
                     <tr>
                       <td>&nbsp;</td>
                       <td><a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleNuevo();"><img src="imagenes/acciones/limpiar.png" width="25" height="25" border="0" title="Limpiar/Nuevo" alt="[Nuevo]" align="absmiddle" /></a></td>
			...
			?>
                       ...
                       <td><a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleGuardar();"><img src="imagenes/acciones/guardar.png" width="25" height="25" border="0" title="Guardar" alt="[Guardar]" align="absmiddle" /></a></td>
         ...
         <td valign="top"><div class="EstFormularioArea" >
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             <tr>
               ...
               <!--<a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleEliminarTodo();"><img  src="imagenes/acciones/listado_eliminar_todo.png"  width="25" height="25"  border="0" title="Eliminar Todo"   alt="[Eli. Todo.]" align="absmiddle"/> Eliminar Todo</a>-->
