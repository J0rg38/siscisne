...
var VehiculoMovimientoSalidaSimpleFotoEditar = 2;
var VehiculoMovimientoSalidaSimpleFotoEliminar = 2;
			...
			?>
             ...
             <tr>
               ...
               <td align="left" valign="top">Moneda:
                 <input name="CmpTipoCambio" type="hidden"  class="EstFormularioCaja" id="CmpTipoCambio" onchange="FncVehiculoMovimientoSalidaSimpleDetalleListar();" value="<?php if (empty($InsVehiculoMovimientoSalida->VmvTipoCambio)){ echo "";}else{ echo $InsVehiculoMovimientoSalida->VmvTipoCambio; } ?>" size="10" maxlength="10" readonly="readonly" /></td>
           ...
           <table width="100%" border="0" cellpadding="2" cellspacing="2" class="EstFormulario">
             ...
             <tr>
               ...
               <td><div class="EstFormularioAccion" id="CapVehiculoAccion">Listo
                 para registrar elementos</div></td>
               <td align="right"><a href="javascript:FncVehiculoMovimientoSalidaSimpleDetalleListar();">
