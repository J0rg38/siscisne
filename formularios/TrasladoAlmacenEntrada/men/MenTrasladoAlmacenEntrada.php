...
<?php
/*if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"TrasladoAlmacenEntrada","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"TrasladoAlmacenEntrada","Listado") and empty($GET_dia)){
?>  
...
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"TrasladoAlmacenEntrada","Listado") and empty($GET_dia)){
?>  
<div class="EstSubMenuBoton"><a href="principal.php?Mod=<?php echo $GET_mod;?>&Form=Monitoreo"><img src="imagenes/iconos/monitoreo.png" alt="[Monitoreo de Transferencias]"  title="Ir a Monitoreo de Transferencias" /> Recepcion</a></div>
<?php
}
?>
