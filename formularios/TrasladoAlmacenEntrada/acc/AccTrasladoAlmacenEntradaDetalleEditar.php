...
//Parametro26 = AmdUbicacion
	...
	$InsTrasladoAlmacenEntradaDetalle1 = array();
	$InsTrasladoAlmacenEntradaDetalle1 = $_SESSION['InsTrasladoAlmacenEntradaDetalle'.$Identificador]->MtdObtenerSesionObjeto($_POST['Item']);
	
	$Cantidad = round($_POST['ProductoCantidad'],3);
	$CantidadReal = round($Cantidad * $InsUnidadMedidaConversion->UmcEquivalente,3);


	$_SESSION['InsTrasladoAlmacenEntradaDetalle'.$Identificador]->MtdEditarSesionObjeto($_POST['Item'],1,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro1,
	$InsProducto->ProId,
	$InsProducto->ProNombre,
	0,
	$Cantidad,
	0,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro7,
	date("d/m/Y H:i:s"),
	$InsUnidadMedida->UmeNombre,
	$InsUnidadMedida->UmeId,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro11,
	$CantidadReal,
	0,
	0,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro15,
	NULL,
	$InsProducto->ProCodigoOriginal,
	$InsProducto->ProCodigoAlternativo,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro19,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro20,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro21,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro22,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro23,
	$InsTrasladoAlmacenEntradaDetalle1->Parametro24,
	$_POST['TrasladoAlmacenEntradaDetalleEstado'],
	$_POST['TrasladoAlmacenEntradaDetalleUbicacion']
	);
