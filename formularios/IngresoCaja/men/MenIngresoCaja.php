...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"IngresoCaja","Registrar") and empty($GET_dia)){
?>
...
<?php
if($InsACL->MtdVerificarACL($_SESSION['SesionRol'],"IngresoCaja","Listado") and empty($GET_dia)){
?>  
