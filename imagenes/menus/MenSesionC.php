...
<table width="100%" border="0" cellpadding="0" cellspacing="2" class="EstTablaSesion" >

<tr>
  <td width="2%" align="left" valign="top"><?php            
...
?>
    <a href="principal.php?Mod=Usuario&amp;Form=Editar&amp;Id=<?php echo $_SESSION['SesionId'];?>" > <img  src="subidos/usuario_fotos/<?php echo $nombre_base."_thumb2.".$extension;?>" width="30" height="30" border="0"  /></a>
    <?php	
}
?></td>
<td width="98%" align="left" valign="top">
  <span class="EstTablaSesionEtiqueta">Usuario: </span> 
    ...
    <span class="EstTablaSesionEtiqueta">Ultima Sesion:</span> <?php echo $_SESSION['SesionUltimaSesion'];?>   <br />
