...
//}
if(empty($GET_VehiculoMarca) or empty($GET_Sucursal)){
	die("No se ha especificado la marca o sucursal.");
}
...
//MtdObtenerSucursalDatoReportes($oCampo=NULL,$oFiltro=NULL,$oOrden = 'SdrId',$oSentido = 'Desc',$oPaginacion = '0,10',$oSucursal=NULL,$oVehiculoMarca=NULL)
		...
		$PersonalAsesorRepuestos = 0;
		$PersonalAsistenteAlmacen = 0;		
		...
		if(!empty($ArrSucursalDatoReportes)){
			foreach($ArrSucursalDatoReportes as $DatSucursalDatoReporte){
				...
				$PersonalAsesorRepuestos = $DatSucursalDatoReporte->SdrPersonalAsesorRepuestos;
				$PersonalAsistenteAlmacen = $DatSucursalDatoReporte->SdrPersonalAsistenteAlmacen;
		...
		*/					
		...
		$FacturacionTallerFacturas = $InsReporteFacturacion->MtdObtenerFacturacionTallerFacturas("SUM","FdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10000",NULL,"fde.FdeId","DESC",NULL,$GET_Sucursal,NULL,NULL,NULL) ;
		$FacturacionTallerBoletas = $InsReporteFacturacion->MtdObtenerFacturacionTallerBoletas("SUM","BdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10000",NULL,"bde.BdeId","DESC",NULL,$GET_Sucursal,NULL,NULL,NULL) ;
		$RcrVentaTallerMarca = $FacturacionTallerFacturas + $FacturacionTallerBoletas;
		$RcrVentaTallerMarca = $RcrVentaTallerMarca/$TipoCambioPromedioMensual;
		$RcrVentaTallerMarca = (empty($RcrVentaTallerMarca)?0:$RcrVentaTallerMarca);
		...
		//MtdObtenerBolturacionMostradorBoletas($oFuncion="SUM",$oParametro="BolTotal",$oAno=NULL,$oMes=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oOrden=NULL,$oSentido=NULL,$oPaginacion=NULL,$oSucursal=NULL) {
		$FacturacionMostradorFacturas = $InsReporteFacturacion->MtdObtenerFacturacionMostradorFacturas("SUM","FdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10000","fde.FdeId","DESC",NULL,$GET_Sucursal) ;
		$FacturacionMostradorBoletas = $InsReporteFacturacion->MtdObtenerFacturacionMostradorBoletas("SUM","BdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10000","bde.BdeId","DESC",NULL,$GET_Sucursal) ;
		$RcrVentaMesonMarca = $RcrVentaMesonMarca/$TipoCambioPromedioMensual;
		$RcrVentaMesonMarca = (empty($RcrVentaMesonMarca)?0:$RcrVentaMesonMarca);
		
		//RcrVentaRatailMarca
		//$RcrVentaRatailMarca = 0;
		$RcrVentaRatailMarca =  $RcrVentaTallerMarca + $RcrVentaPPMarca + $RcrVentaMesonMarca;
		...
		$FacturacionTallerFacturasLubricantes = $InsReporteFacturacion->MtdObtenerFacturacionTallerFacturas("SUM","FdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10001",NULL,"fde.FdeId","DESC",NULL,$GET_Sucursal,NULL,NULL,NULL) ;
		$FacturacionTallerBoletasLubricantes = $InsReporteFacturacion->MtdObtenerFacturacionTallerBoletas("SUM","BdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10001",NULL,"bde.BdeId","DESC",NULL,$GET_Sucursal,NULL,NULL,NULL) ;
		
		$FacturacionMostradorFacturasLubricantes = $InsReporteFacturacion->MtdObtenerFacturacionMostradorFacturas("SUM","FdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10001","fde.FdeId","DESC",NULL,$GET_Sucursal) ;
		$FacturacionMostradorBoletasLubricantes = $InsReporteFacturacion->MtdObtenerFacturacionMostradorBoletas("SUM","BdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10001","bde.BdeId","DESC",NULL,$GET_Sucursal) ;

		$RcrVentaRetailLubricantes = $FacturacionTallerFacturasLubricantes + $FacturacionTallerBoletasLubricantes + $FacturacionMostradorFacturasLubricantes + $FacturacionMostradorBoletasLubricantes;
		$RcrVentaRetailLubricantes = $RcrVentaRetailLubricantes/$TipoCambioPromedioMensual;
		$RcrVentaRetailLubricantes = (empty($RcrVentaRetailLubricantes)?0:$RcrVentaRetailLubricantes);
		
		
		//RcrTotalVentasRetail //Facturacion Repuestos
		$RcrTotalVentasRetail = $RcrVentaRatailMarca + $RcrVentaRetailLubricantes;
		$RcrTotalVentasRetail = (empty($RcrTotalVentasRetail)?0:$RcrTotalVentasRetail);
		
		
		//RcrMargenAporte
		//$RcrMargenAporte = 35;
		$RcrMargenAporte = ($RcrVentaRatailMarca - $RcrTotalVentasRetail)/$RcrVentaRatailMarca;
		$RcrMargenAporte = (empty($RcrMargenAporte)?0:$RcrMargenAporte);
		$RcrMargenAporte = round($RcrMargenAporte,2);
		...
		/*
		* CONTROL DE INVENTARIO Y ROTACION
		*/			
		...
		$MARCASalidas = 		$InsReporteAlmacenMovimiento->MtdObtenerTallerPedidoDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,'amd.AmdId','Desc',NULL,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000","A,B,C,D",$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),$GET_Sucursal);
		...
		$InsReporteAlmacenMovimiento = new ClsReporteAlmacenMovimiento();
		//MtdObtenerAlmacenMovimientoEntradaDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oAlmacenMovimientoEntrada=NULL,$oEstado=NULL,$oProducto=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oCliente=NULL,$oConOrdenCompra=0,$oOrdenCompra=NULL,$oPedidoCompraDetalleId=NULL,$oVentaDirectaDetalleId=NULL,$oAlmacenMovimientoEntradaEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oDiasInactivoInicio=NULL,$oDiasInactivoFin=NULL,$oProducto=NULL,$oProductoABCInterno=NULL,$oSucursal=NULL)
		$LUBRICANTESEntradaCostos = $InsReporteAlmacenMovimiento->MtdObtenerAlmacenMovimientoEntradaDetallesValor("AVG","AmdCosto",NULL,NULL,NULL,NULL,NULL,'amd.AmdId','Desc',1,NULL,NULL,NULL,NULL,$GET_Ano."-".$GET_Mes."-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),NULL,0,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10001",NULL,NULL,NULL,NULL,$GET_Sucursal);  
		$LUBRICANTESEntradas = 		$InsReporteAlmacenMovimiento->MtdObtenerAlmacenMovimientoEntradaDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,NULL,'amd.AmdId','Desc',1,NULL,NULL,NULL,NULL,$GET_Ano."-".$GET_Mes."-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),NULL,0,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10001",NULL,NULL,NULL,NULL,$GET_Sucursal);  
		...
		$LUBRICANTESSalidas = 		$InsReporteAlmacenMovimiento->MtdObtenerVentaConcretadaDetallesValor("SUM","AmdCantidadReal",$GET_Mes,$GET_Ano,NULL,NULL,'amd.AmdId','Desc',NULL,NULL,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10001",$GET_Sucursal);
		...
		//MtdObtenerAlmacenMovimientoEntradaDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oAlmacenMovimientoEntrada=NULL,$oEstado=NULL,$oProducto=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oCliente=NULL,$oConOrdenCompra=0,$oOrdenCompra=NULL,$oPedidoCompraDetalleId=NULL,$oVentaDirectaDetalleId=NULL,$oAlmacenMovimientoEntradaEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oDiasInactivoInicio=NULL,$oDiasInactivoFin=NULL,$oProducto=NULL,$oProductoABCInterno=NULL,$oSucursal=NULL)
		$MARCAEntradasA = 			$InsReporteAlmacenMovimiento->MtdObtenerAlmacenMovimientoEntradaDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,NULL,'amd.AmdId','Desc',1,NULL,NULL,NULL,NULL,$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),NULL,0,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000",NULL,NULL,NULL,"A",$GET_Sucursal);  
		//MtdObtenerTallerPedidoDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oPaginacion = '0,10',$oTallerPedido=NULL,$oEstado=NULL,$oProducto=NULL,$oTallerPedidoEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oProductoABCInterno=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oSucursal=NULL)
		$MARCASalidasA = 			$InsReporteAlmacenMovimiento->MtdObtenerTallerPedidoDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,'amd.AmdId','Desc',NULL,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000","A",$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),$GET_Sucursal);
		...
		//MtdObtenerAlmacenMovimientoEntradaDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oAlmacenMovimientoEntrada=NULL,$oEstado=NULL,$oProducto=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oCliente=NULL,$oConOrdenCompra=0,$oOrdenCompra=NULL,$oPedidoCompraDetalleId=NULL,$oVentaDirectaDetalleId=NULL,$oAlmacenMovimientoEntradaEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oDiasInactivoInicio=NULL,$oDiasInactivoFin=NULL,$oProducto=NULL,$oProductoABCInterno=NULL,$oSucursal=NULL)
		$MARCAEntradasB = 			$InsReporteAlmacenMovimiento->MtdObtenerAlmacenMovimientoEntradaDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,NULL,'amd.AmdId','Desc',1,NULL,NULL,NULL,NULL,$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),NULL,0,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000",NULL,NULL,NULL,"B",$GET_Sucursal);  
		//MtdObtenerTallerPedidoDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oPaginacion = '0,10',$oTallerPedido=NULL,$oEstado=NULL,$oProducto=NULL,$oTallerPedidoEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oProductoABCInterno=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oSucursal=NULL)
		$MARCASalidasB = 			$InsReporteAlmacenMovimiento->MtdObtenerTallerPedidoDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,'amd.AmdId','Desc',NULL,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000","B",$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),$GET_Sucursal);
		...
		//MtdObtenerAlmacenMovimientoEntradaDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oAlmacenMovimientoEntrada=NULL,$oEstado=NULL,$oProducto=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oCliente=NULL,$oConOrdenCompra=0,$oOrdenCompra=NULL,$oPedidoCompraDetalleId=NULL,$oVentaDirectaDetalleId=NULL,$oAlmacenMovimientoEntradaEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oDiasInactivoInicio=NULL,$oDiasInactivoFin=NULL,$oProducto=NULL,$oProductoABCInterno=NULL,$oSucursal=NULL)
		$MARCAEntradasC = $InsReporteAlmacenMovimiento->MtdObtenerAlmacenMovimientoEntradaDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,NULL,'amd.AmdId','Desc',1,NULL,NULL,NULL,NULL,$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),NULL,0,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000",NULL,NULL,NULL,"C",$GET_Sucursal);  
		//MtdObtenerTallerPedidoDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oPaginacion = '0,10',$oTallerPedido=NULL,$oEstado=NULL,$oProducto=NULL,$oTallerPedidoEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oProductoABCInterno=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oSucursal=NULL)
		$MARCASalidasC = $InsReporteAlmacenMovimiento->MtdObtenerTallerPedidoDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,'amd.AmdId','Desc',NULL,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000","C",$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),$GET_Sucursal);
		...
		//MtdObtenerAlmacenMovimientoEntradaDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oEliminado=1,$oPaginacion = '0,10',$oAlmacenMovimientoEntrada=NULL,$oEstado=NULL,$oProducto=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oCliente=NULL,$oConOrdenCompra=0,$oOrdenCompra=NULL,$oPedidoCompraDetalleId=NULL,$oVentaDirectaDetalleId=NULL,$oAlmacenMovimientoEntradaEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oDiasInactivoInicio=NULL,$oDiasInactivoFin=NULL,$oProducto=NULL,$oProductoABCInterno=NULL,$oSucursal=NULL)
		$MARCAEntradasD = $InsReporteAlmacenMovimiento->MtdObtenerAlmacenMovimientoEntradaDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,NULL,'amd.AmdId','Desc',1,NULL,NULL,NULL,NULL,$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),NULL,0,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000",NULL,NULL,NULL,"D",$GET_Sucursal);  
		//MtdObtenerTallerPedidoDetallesValor($oFuncion="SUM",$oParametro="AmoTotal",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oFiltro=NULL,$oOrden = 'AmdId',$oSentido = 'Desc',$oPaginacion = '0,10',$oTallerPedido=NULL,$oEstado=NULL,$oProducto=NULL,$oTallerPedidoEstado=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oProductoABCInterno=NULL,$oFechaInicio=NULL,$oFechaFin=NULL,$oSucursal=NULL)
		$MARCASalidasD = $InsReporteAlmacenMovimiento->MtdObtenerTallerPedidoDetallesValor("SUM","AmdCantidadReal",NULL,NULL,NULL,NULL,'amd.AmdId','Desc',NULL,NULL,NULL,NULL,3,$GET_VehiculoMarca,"RTI-10000","D",$GET_Ano."-01-01",$GET_Ano."-".$GET_Mes."-".FncCantidadDiaMes($GET_Ano,$GET_Mes),$GET_Sucursal);
		...
		/*
		*  CONTROL DE ATENCION DE REPUESTOS
		*/
		
		//RcrPedidosYSTK
		$InsOrdenCompra = new ClsOrdenCompra();
		//MtdObtenerOrdenComprasValor($oFuncion="SUM",$oParametro="OcoId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'OcoId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oTipo=NULL,$oConSaldo=0,$oProveedor=NULL,$oMoneda=NULL,$oVehiculoMarca=NULL,$oSucursal=NULL) {
		$RcrPedidosYSTK = $InsOrdenCompra->MtdObtenerOrdenComprasValor("COUNT","OcoId",$GET_Mes,$GET_Ano,NULL,NULL,NULL, 'OcoId','Desc',NULL,NULL,NULL,NULL,"STK",0,$InsProveedor->PrvId,NULL,$GET_VehiculoMarca,$GET_Sucursal) ;
		$RcrPedidosYSTK = (empty($RcrPedidosYSTK)?0:$RcrPedidosYSTK);

		//RcrPedidosYRUSH
		$InsOrdenCompra = new ClsOrdenCompra();
		$RcrPedidosYRUSH = $InsOrdenCompra->MtdObtenerOrdenComprasValor("COUNT","OcoId",$GET_Mes,$GET_Ano,NULL,NULL,NULL, 'OcoId','Desc',NULL,NULL,NULL,NULL,"YRUSH",0,$InsProveedor->PrvId,NULL,$GET_VehiculoMarca,$GET_Sucursal) ;
		$RcrPedidosYRUSH = (empty($RcrPedidosYRUSH)?0:$RcrPedidosYRUSH);
		
		//RcrPedidosZVOR
		$InsOrdenCompra = new ClsOrdenCompra();
		$RcrPedidosZVOR= $InsOrdenCompra->MtdObtenerOrdenComprasValor("COUNT","OcoId",$GET_Mes,$GET_Ano,NULL,NULL,NULL, 'OcoId','Desc',NULL,NULL,NULL,NULL,"ZVOR",0,$InsProveedor->PrvId,NULL,$GET_VehiculoMarca,$GET_Sucursal) ;
		$RcrPedidosZVOR = (empty($RcrPedidosZVOR)?0:$RcrPedidosZVOR);
		
		//RcrPedidosZGAR
		$InsOrdenCompra = new ClsOrdenCompra();
		$RcrPedidosZGAR= $InsOrdenCompra->MtdObtenerOrdenComprasValor("COUNT","OcoId",$GET_Mes,$GET_Ano,NULL,NULL,NULL, 'OcoId','Desc',NULL,NULL,NULL,NULL,"ZGAR",0,$InsProveedor->PrvId,NULL,$GET_VehiculoMarca,$GET_Sucursal) ;
		...
		/*
		* UTILIZACION DEL RECURSO HUMANO
		*/

		//RcrPersonalAsesorRepuestos
		$RcrPersonalAsesorRepuestos = $PersonalAsesorRepuestos;
		
		//RcrPersonalAsistenteAlmacen
		$RcrPersonalAsistenteAlmacen = $PersonalAsistenteAlmacen;
