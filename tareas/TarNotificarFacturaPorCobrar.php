...
if(!empty($POST_Sucursal)){
	...
	$Destinatarios = $CorreosNotificacionComprobantesVencidoSucursal;

}else{

	$Destinatarios = $CorreosNotificacionComprobantesVencidoGeneral;
...
$mensaje .= "<b>NOTIFICACION DE COMPROBANTES X COBRAR (VENCIDOS)</b>";	
$mensaje .= "<br>";	
$mensaje .= "<br>";	
...
$mensaje .= "<b>Descripcion:</b> Comprobantes de pago al CREDITO vencidos en los ultimos 30 dias";
$mensaje .= "<br>";	
...
if(!empty($ArrSucursales)){
	foreach($ArrSucursales as $DatSucursal){
		...
		$ResBoleta = $InsBoleta->MtdObtenerBoletas(NULL,NULL,NULL,"BolFechaEmision","DESC","500","5",FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),NULL,NULL,"NPA-10001",NULL,NULL,NULL,NULL,NULL,NULL,$DatSucursal->SucId,false,NULL,false,0,true,2);
		...
		$ResFactura = $InsFactura->MtdObtenerFacturas(NULL,NULL,NULL,"FacFechaEmision","DESC","500",NULL,"5",FncCambiaFechaAMysql($POST_FechaInicio),FncCambiaFechaAMysql($POST_FechaFin),NULL,NULL,NULL,"NPA-10001",NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,$DatSucursal->SucId,false,NULL,false,0,true,2);
		...
		//			$DatBoleta->BolMontoAmortizado = ($DatBoleta->BolMontoAmortizado / $DatBoleta->BolTipoCambio);
			...
			//	if($DatBoleta->BolTotal > $Amortizado){
...
if($Enviar){
	...
	//if($POST_Enviar<>"2"){
		...
		$InsCorreo->MtdEnviarCorreo($Destinatarios,$SistemaCorreoUsuario,$SistemaCorreoRemitente,"NOTIFICACION: FACTURAS X COBRAR ".$Titulo,$mensaje);
	//}
