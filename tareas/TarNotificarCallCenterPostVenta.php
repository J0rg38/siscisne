...
$Destinatarios = $TarNotificarCallCenterPostVenta;
...
$POST_Dias = ((empty($_GET['Dias'])?3:$_GET['Dias']));
$POST_Nota = $_GET['Nota'];
...
$mensaje .= "<br>";
$mensaje .= "<b>Descripcion:</b> Ordenes de trabajo con ".$POST_Dias." dias de haberse culminado";
$mensaje .= "<br>";	
  ...
  foreach($ArrReporteFichaIngresos as $DatReporteFichaIngreso){
			  ...
			  $mensaje .= "<tr>";
				...
				//  $mensaje .= "</td>";
				  ...
				  $mensaje .= "<td>";
				  $mensaje .= $DatReporteFichaIngreso->FinDiaTranscurridoTerminado." dia(s)";
				  $mensaje .= "</td>";
