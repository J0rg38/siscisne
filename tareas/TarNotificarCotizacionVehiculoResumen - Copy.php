...
$Destinatarios = "d.flores@cisne.com.pe,j.blanco@cisne.com.pe";
...
$mensaje .= "<tr>";
$mensaje .= "<th width='250'>";
$mensaje .= "SUCURSAL";
$mensaje .= "</th>";

$mensaje .= "<th width='150'>";
...
if(!empty($ArrSucursales)){
 ...
 $Enviar = true;
  ...
  if($Enviar){
	  ...
	  $InsCorreo->MtdEnviarCorreo($Destinatarios,$SistemaCorreoUsuario,$SistemaCorreoRemitente,"NOTIFICACION: RESUMEN DE COTIZACIONES DE VEHICULOS DIARIO",$mensaje);
