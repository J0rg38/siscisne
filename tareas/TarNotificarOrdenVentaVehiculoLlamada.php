...
if(!empty($ArrPersonales)){
	foreach($ArrPersonales as $DatPersonal){
		...
		$ResOrdenVentaVehiculo = $InsOrdenVentaVehiculo->MtdObtenerOrdenVentaVehiculos(NULL,NULL,NULL,"OvvFecha","ASC",NULL,FncCambiaFechaAMysql($FechaInicio),FncCambiaFechaAMysql($FechaFin),NULL,$POST_Moneda,$DatPersonal->PerId,NULL,0,NULL,NULL,NULL,$POST_Sucursal,1,NULL,NULL,2,true);
		$ArrOrdenVentaVehiculos = $ResOrdenVentaVehiculo['Datos'];
			...
			if(!empty($ArrOrdenVentaVehiculos)){
				...
				$mensaje .= "<br>";	
				$mensaje .= "<b>Asesor de Ventas:</b> ".$DatPersonal->PerNombre." ".$DatPersonal->PerApellidoPaterno." ".$DatPersonal->PerApellidoMaterno;	
				$mensaje .= "<br>";	
				$mensaje .= "<b>Email:</b> ".$DatPersonal->PerEmail;	
				$mensaje .= "<br>";	
