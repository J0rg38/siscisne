...
////MtdObtenerFichaIngresosTotal($oFuncion="SUM",$oParametro="FacId",$oMes=NULL,$oAno=NULL,$oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'FinId',$oSentido = 'Desc',$oPaginacion = '0,10',$oFechaInicio=NULL,$oFechaFin=NULL,$oEstado=NULL,$oPrioridad=NULL,$oModalidadIngreso=NULL,$oVIN=NULL,$oClienteId=NULL,$oPersonalId=NULL,$oTrabajoConcluido=0,$oCampana=NULL,$oClienteTipo=NULL,$oVehiculoMarca=NULL,$oTipo=NULL,$oVehiculoTipo=NULL,$oVehiculoModelo=NULL,$oIgnorarReparacionesSinCosto=false,$oSucursal=NULL,$oDia=NULL)
		...
		*/
		...
		$RcoCitasEfectivas = $InsFichaIngreso->MtdObtenerFichaIngresosTotal("COUNT","fin.FinId",$GET_Mes,$GET_Ano,NULL,NULL,NULL,'fin.FinId','ASC',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,$GET_VehiculoMarca,1,NULL,NULL,false,$DatSucursal->SucId,NULL,true) ;
		$RcoCitasEfectivas = (empty($RcoCitasEfectivas)?0:$RcoCitasEfectivas);
		...
		*/
		...
		$RcoHoraMOVendidas = $RcoHoraMOVendidas;	
//		$RcoHoraMOVendidas = $RcoHoraMOVendidas / $RcoDiasLaborados;
		...
		$RcoVentaManoObra = $RcoVentaManoObra/$TipoCambioPromedioMensual;
		...
		$Facturas = $InsReporteFacturacion->MtdObtenerFacturacionTallerFacturas("SUM","FdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10000","MIN-10001,MIN-10003,MIN-10007","fde.FdeId","DESC",NULL,$DatSucursal->SucId) ;
		$Boletas = $InsReporteFacturacion->MtdObtenerFacturacionTallerBoletas("SUM","BdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,"RTI-10000","MIN-10001,MIN-10003,MIN-10007","bde.BdeId","DESC",NULL,$DatSucursal->SucId) ;

		$RcoVentaRepuestos = $Facturas + $Boletas;
		$RcoVentaRepuestos = $RcoVentaRepuestos/$TipoCambioPromedioMensual;
		...
		//MtdObtenerFacturacionTaller($oFuncion="SUM",$oParametro="FacTotal",$oAno=NULL,$oMes=NULL,$oVehiculoMarca=NULL,$oProductoTipo=NULL,$oFichaIngresoModalidadIngreso=NULL,$oOrden=NULL,$oSentido=NULL,$oPaginacion=NULL,$oSucursal=NULL)
		$Facturas = $InsReporteFacturacion->MtdObtenerFacturacionTallerFacturas("SUM","FdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,NULL,"MIN-10001,MIN-10003,MIN-10007","fde.FdeId","DESC",NULL,$DatSucursal->SucId) ;
		$Boletas = $InsReporteFacturacion->MtdObtenerFacturacionTallerBoletas("SUM","BdeImporte",$GET_Ano,$GET_Mes,$GET_VehiculoMarca,NULL,"MIN-10001,MIN-10003,MIN-10007","bde.BdeId","DESC",NULL,$DatSucursal->SucId) ;

		$RcoVentaMecanica = $Facturas + $Boletas;
		$RcoVentaMecanica = $RcoVentaMecanica/$TipoCambioPromedioMensual;
		$RcoVentaMecanica = (empty($RcoVentaMecanica)?0:$RcoVentaMecanica);
		...
		*/
		...
		echo "RcoIngresoPrimeraRevision: ".$RcoIngresoPrimeraRevision ;
		echo "<br>";			
			
		echo "RcoIngresoServicio1000: ".$RcoIngresoServicio1000 ;
		echo "<br>";	
			
		echo "RcoIngresoServicio1500: ".$RcoIngresoServicio1500 ;
		echo "<br>";	
			
		echo "RcoIngresoServicio5000: ".$RcoIngresoServicio5000 ;
		echo "<br>";	
		
			
		echo "RcoIngresoServicio10000: ".$RcoIngresoServicio10000 ;
		echo "<br>";	
		...
		echo "RcoIngresoServicio15000: ".$RcoIngresoServicio15000 ;
		echo "<br>";	
		
				
		echo "RcoIngresoServicio20000: ".$RcoIngresoServicio20000 ;
		echo "<br>";	
		
				
		echo "RcoIngresoServicio25000: ".$RcoIngresoServicio25000 ;
		echo "<br>";	
		
				
		echo "RcoIngresoServicio30000: ".$RcoIngresoServicio30000 ;
		echo "<br>";	
		
				
		echo "RcoIngresoServicio35000: ".$RcoIngresoServicio35000 ;
		echo "<br>";	
		
				
		echo "RcoIngresoServicio40000: ".$RcoIngresoServicio40000 ;
		echo "<br>";	
				
		echo "RcoIngresoServicio45000: ".$RcoIngresoServicio45000 ;
		echo "<br>";
				
		echo "RcoIngresoServicio50000: ".$RcoIngresoServicio50000 ;
		echo "<br>";
		
	
		echo "RcoIngresoServicio50000Mas: ".$RcoIngresoServicio50000Mas ;
		echo "<br>";
		...
		echo "RcoIngresoServicioReparaciones: ".$RcoIngresoServicioReparaciones ;
		echo "<br>";
		echo "RcoIngresoServicioPlanchadoPintado: ".$RcoIngresoServicioPlanchadoPintado ;
		echo "<br>";
		echo "RcoIngresoServicioTrabajoInterno: ".$RcoIngresoServicioTrabajoInterno ;
		echo "<br>";
		echo "RcoIngreseServicioGarantias: ".$RcoIngreseServicioGarantias ;
		echo "<br>";
		echo "RcoIngresoServicioInstalacionAccesorios: ".$RcoIngresoServicioInstalacionAccesorios ;
		echo "<br>";
		echo "RcoIngresoServicioReingresos: ".$RcoIngresoServicioReingresos ;
		echo "<br>";
		echo "RcoIngresoServicioInstalacionGLP: ".$RcoIngresoServicioInstalacionGLP ;
		echo "<br>";
	echo "RcoIngresoServicioSuperCambio99: ".$RcoIngresoServicioSuperCambio99 ;
		echo "<br>";
		...
		echo "RcoIngresoNLR3TON: ".$RcoIngresoNLR3TON ;
		echo "<br>";	
		
		echo "RcoIngresoREWARD400DT: ".$RcoIngresoREWARD400DT ;
		echo "<br>";	
		
		echo "RcoIngresoREWARD400NMR: ".$RcoIngresoREWARD400NMR ;
		echo "<br>";	
		
		echo "RcoIngresoNPR4TON: ".$RcoIngresoNPR4TON ;
		echo "<br>";	
		
		echo "RcoIngresoREWARD500: ".$RcoIngresoREWARD500 ;
		echo "<br>";	
		
		echo "RcoIngresoFTR10TON: ".$RcoIngresoFTR10TON ;
		echo "<br>";	
		
		echo "RcoIngresoFORWARD800: ".$RcoIngresoFORWARD800 ;
		echo "<br>";	
		
		echo "RcoIngresoFORWARD1300: ".$RcoIngresoFORWARD1300 ;
		echo "<br>";	
		
		echo "RcoIngresoFORWARD2000: ".$RcoIngresoFORWARD2000 ;
		echo "<br>";	
		...
		echo "TotalIngresoTipoMensualModelo: ".$TotalIngresoTipoMensualModelo ;
		echo "<br>";	
		
		
		echo "RcoIngresoOtrasUnidades: ".$RcoIngresoOtrasUnidades ;
		echo "<br>";	
		
		echo "FichaIngresoMantenimientoMensualTotalModelo: ".$FichaIngresoMantenimientoMensualTotalModelo ;
		echo "<br>";	
		
		echo "RcoTotalIngresosUnidades: ".$RcoTotalIngresosUnidades ;
		echo "<br>";	
		...
		echo "TipoCambioPromedioMensual: ".$TipoCambioPromedioMensual;
		echo "<br>";	
