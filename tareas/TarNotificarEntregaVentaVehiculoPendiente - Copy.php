...
$mensaje .= "<b><u>ENTREGA DE VEHICULOS PENDIENTES</u></b>";
$mensaje .= "<br>";	
$mensaje .= "<br>";	
...
$mensaje .= "<br>";
  ...
  foreach($ArrEntregaVentaVehiculos as $DatEntregaVentaVehiculo){
			  ...
			  $mensaje .= "<tr>";
				  ...
				  $mensaje .= "<td>";
				  $mensaje .= $DatEntregaVentaVehiculo->EvvDuracion." hrs";
				  $mensaje .= "</td>";
  ...
  if($Enviar){
	  ...
	  $InsCorreo->MtdEnviarCorreo("j.blanco@cisne.com.pe",$SistemaCorreoUsuario,$SistemaCorreoRemitente,"AVISO: ENTREGAS DE VEHICULOS PENDIENTES",$mensaje);
