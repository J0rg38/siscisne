...
//		contentDiv.onmouseout = 'ajax_hideTooltip()';
		...
		buttonDiv.style.cssText = 'position:absolute;left:50%;bottom:10px;text-align:center;background-color:#FFF;font-size:0.8em;height:10px;z-index:10000000;text-align:center;width:180px;';
		buttonDiv.innerHTML = '<a class="EstBtnCerrar" href="#" onclick="ajax_hideTooltip();return false">[Cerrar]</a>';
