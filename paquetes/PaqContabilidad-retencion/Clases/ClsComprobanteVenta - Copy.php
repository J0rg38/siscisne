...
ROUND(IFNULL(
	...
	//	$gfactura = '';
		 ...
		 $sql = 'SELECT
				...
				WHERE  fin.FinMigrado IS NULL '.$filtrar.$fimodalidad.$fecha.$sucursal.$estado.$festado.$pfacturar.$pgarantia.$mingreso.$facturable.$gfactura.$itvacio."  ".$orden.$paginacion;
