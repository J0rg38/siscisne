	...
	public function MtdRegistrarCotizacionVehiculo()
	{
		...
		if (!$error) {
			...
			if (!empty($this->CotizacionVehiculoObsequio)) {
				...
				$validar = 0;
				$InsCotizacionVehiculoObsequio = new ClsCotizacionVehiculoObsequio($this->InsMysql);
		...
		if (!$error) {
			...
			if (!empty($this->CotizacionVehiculoCondicionVenta)) {
				...
				$validar = 0;
				$InsCotizacionVehiculoCondicionVenta = new ClsCotizacionVehiculoCondicionVenta($this->InsMysql);
		...
		if (!$error) {
			...
			if (!empty($this->CotizacionVehiculoFoto)) {
				...
				foreach ($this->CotizacionVehiculoFoto as $DatCotizacionVehiculoFoto) {
					...
					$InsCotizacionVehiculoFoto = new ClsCotizacionVehiculoFoto($this->InsMysql);
	...
	public function MtdSeguimientoClienteCotizacionVehiculo($oTransaccion = true)
	{
		...
		if (!$error) {
			...
			if (!empty($this->CotizacionVehiculoLlamada)) {
				...
				$InsCotizacionVehiculoLlamada = new ClsCotizacionVehiculoLlamada($this->InsMysql);
