				...
				if(!empty($elemento)){
					...
					if(!$error) {		
						...
						if(!$resultado) {						
							...
							$this->MtdAuditarAlmacenMovimientoEntrada(3,"Se elimino el Movimiento de Almacen",$aux);		
						}
					}
			...
			foreach($elementos as $elemento){
				...
				//$aux = explode("%",$elemento);	
					...
					if(!$resultado) {						
						...
						$this->MtdAuditarAlmacenMovimientoEntrada(2,"Se actualizo el Estado del Movimiento de Almacen",$elemento);
...
//			}
			...
			if($error) {	
				...
				$this->MtdAuditarAlmacenMovimientoEntrada(1,"Se registro el Movimiento de Almacen",$this);			
				return true;
			}			
...
//			}	
			...
			if($error) {		
				...
				$this->MtdAuditarAlmacenMovimientoEntrada(2,"Se edito el Movimiento de Almacen",$this);		
				return true;
			}	
...
//		
		...
		private function MtdAuditarAlmacenMovimientoEntrada($oAccion,$oDescripcion,$oDatos,$oCodigo=NULL,$oUsuario=NULL,$oPersonal=NULL){
