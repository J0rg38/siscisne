...
class ClsListaPrecio {
    ...
    public function MtdObtenerListaPrecios($oCampo=NULL,$oCondicion=NULL,$oFiltro=NULL,$oOrden = 'LprId',$oSentido = 'Desc',$oPaginacion = '0,10',$oProducto=NULL,$oClienteTipo=NULL,$oUnidadMedida=NULL) {
...
//		}
		...
		$sql = 'SELECT
				...
				WHERE  1 = 1 '.$filtrar.$producto.$ctipo.$umedida.$orden.$paginacion;
