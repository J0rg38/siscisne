...
class ClsAlmacenProducto {
	...
	public function MtdVerificarExisteAlmacenProducto($oProducto,$oAlmacen,$oAno){
		
		$AlmacenProductoId = "";
		
		$ResAlmacenProducto = $this->MtdObtenerAlmacenProductos(NULL,NULL,"AprId","ASC","1",NULL,$oAlmacen,$oProducto,$oAno);
	...
	public function MtdObtenerAlmacenProductoStockActual($oProducto,$oAlmacen=NULL,$oAno=NULL){
		
		$Stock = 0;
		$ResAlmacenProducto = $this->MtdObtenerAlmacenProductos(NULL,NULL,"AprId","ASC",NULL,NULL,$oAlmacen,$oProducto,$oAno);
		$ArrAlmacenProductos = $ResAlmacenProducto['Datos'];
    ...
    public function MtdObtenerAlmacenProductos($oCampo=NULL,$oFiltro=NULL,$oOrden = 'AprId',$oSentido = 'Desc',$oPaginacion = '0,10',$oEstado=NULL,$oAlmacen=NULL,$oProducto=NULL,$oAno=NULL) {
		...
		if(!empty($oAno)){
			...
			$sql = 'SELECT
				...
				WHERE  1 = 1 '.$filtrar.$vmarca.$producto.$almacen.$ano.$estado.$orden.$paginacion;
