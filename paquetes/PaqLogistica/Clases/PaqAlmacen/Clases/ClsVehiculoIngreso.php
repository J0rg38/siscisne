...
//	public $VehColor;
    ...
    public function MtdObtenerVehiculoIngreso($oCompleto=true){
        ...
        while ($fila = $this->InsMysql->MtdObtenerDatos($resultado))
        {
			...
			$this->EinColorInterior = $fila['EinColorInterior'];
...
ein.EinColorInterior,
		...
		ein.EinFotoCupon,
				...
				WHERE  1 = 1  '.$filtrar.$concesionario.$vtipo.$estado.$sucursal .$tipo.$cliente.$evehicular.$vmarca.$vmodelo.$vversion.$amodelo.$afabricacion.$color.$cproforma.$fecha.$orden.$paginacion;
            ...
            $InsVehiculoIngreso = get_class($this);
				...
				while( $fila = $this->InsMysql->MtdObtenerDatos($resultado)){
					...
					$VehiculoIngreso->EinColorInterior = $fila['EinColorInterior'];
					...
					$VehiculoIngreso->EinUbicacion = $fila['EinUbicacion'];	
...
//	
	...
	public function MtdEditarVehiculoIngreso() {
			...
			EinUbicacion = "'.($this->EinUbicacion).'",
