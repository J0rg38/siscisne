		...
		if(!empty($oSubTipo)){
			$stipo = ' AND vmv.VmvSubTipo = "'.$oSubTipo.'"';
			 ...
			 $sql = 'SELECT
				...
				WHERE 1 = 1 AND vmv.VmvTipo = 1 '.$filtrar.$fecha.$stipo.$estado.$origen.$moneda.$pcompra.$ocompra.$pcompradetalle.$cliente.$cocompra.$cancelado.$einveedor.$vdirecta.$cpago.$almacen.$orden.$paginacion;
...
$InsAuditoria->AudUsuario = $oUsuario;
		...
		public function MtdNotificarAlmacennMovimientoEntradaOrdenCompra($oVehiculoMovimientoEntrada,$oDestinatario,$oImportante=false){
