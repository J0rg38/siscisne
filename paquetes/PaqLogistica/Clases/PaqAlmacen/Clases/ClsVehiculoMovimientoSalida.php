		...
		if(!empty($oOrdenVentaVehiculoId)){
			$ovvehiculo = ' AND vmv.OvvId = "'.$oOrdenVentaVehiculoId.'"';
			 ...
			 $sql = 'SELECT
				...
				WHERE 1 = 1 AND vmv.VmvTipo = 2 '.$filtrar.$fecha.$stipo.$estado.$origen.$moneda.$pcompra.$ocompra.$pcompradetalle.$cliente.$cocompra.$cancelado.$einveedor.$ovvehiculo.$vdirecta.$cpago.$almacen.$orden.$paginacion;
