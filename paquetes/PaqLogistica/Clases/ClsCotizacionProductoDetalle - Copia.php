...
class ClsCotizacionProductoDetalle {
	...
	private function MtdGenerarCotizacionProductoDetalleId() {
        ...
        $sql = 'SELECT 
			...
			crd.CrdMargenPorcentaje,
			crd.CrdMantenimientoPorcentaje,
			crd.CrdFletePorcentaje,
			crd.CrdDescuentoPorcentaje,
        ...
        while ($fila = $this->InsMysql->MtdObtenerDatos($resultado))
        {
			...
			$this->CrdMargenPorcentaje = $fila['CrdMargenPorcentaje']; 
			$this->CrdMantenimientoPorcentaje = $fila['CrdMantenimientoPorcentaje']; 
			$this->CrdFletePorcentaje = $fila['CrdFletePorcentaje']; 
			$this->CrdDescuentoPorcentaje = $fila['CrdDescuentoPorcentaje'];  
...
//		$InsCotizacionProductoDetalleOrigen = new ClsCotizacionProductoDetalleOrigen();
	...
	public function MtdRegistrarCotizacionProductoDetalle() {
			...
			CrdMargenPorcentaje,
			CrdMantenimientoPorcentaje,
			CrdFletePorcentaje,
			CrdDescuentoPorcentaje,
			...
			'.($this->CrdMargenPorcentaje).', 
			'.($this->CrdMantenimientoPorcentaje).', 
			'.($this->CrdFletePorcentaje).', 
			'.($this->CrdDescuentoPorcentaje).', 
