...
//cli.LtiId = "'.($elemento).'"
		...
		if(!empty($oAno)){
			$ano = ' AND YEAR(fin.FinFecha) ="'.($oAno).'"';
				...
				WHERE 1 = 1 '.$ano.$mes.$filtrar.$sincosto .$sucursal.$fecha.$estado.$excluir.$prioridad.$mingreso.$vin.$cliente.$personal.$tconcluido.$campana.$cltipo.$tipo.$sexterna.$ccampana.$eingreso.$vmarca.$vmodelo.$mmkilometraje.$pasesor.$treparacion.$orden.$paginacion;
...
//		}		
		...
		if(!empty($oSucursal)){
			...
			//echo "<br>";echo "<br>";
				...
				WHERE 1 = 1 '.$ano.$mes.$dia.$filtrar.$fecha.$vtipo.$sucursal.$dia.$estado.$prioridad.$sincosto.$mingreso.$vin.$cliente.$personal.$tconcluido.$campana.$cltipo.$vmarca.$vmodelo.$tipo.$orden.$paginacion;
