...
class ClsReporteResumenVenta {
    ...
    public function MtdObtenerReporteResumenVentas($oCampo=NULL,$oCondicion="contiene",$oFiltro=NULL,$oOrden = 'RveId',$oSentido = 'Desc',$oPaginacion = '0,10',$oAno=NULL,$oMes=NULL,$oSucursal=NULL,$oFechaInicio=NULL,$oFechaFin=NULL) {
...
( (fde.FdeDescuento/fde.FdeCantidad)* ((fac.FacPorcentajeImpuestoVenta/100)+1) ) 


((IF(bol.MonId="MON-10000",bde.BdeDescuento,0))) AS "RvrDescuentoSFinal",
...
((IF(bol.MonId="MON-10001",bde.BdeDescuento/bol.BolTipoCambio,0))) AS "RvrDescuentoUSFinal",
