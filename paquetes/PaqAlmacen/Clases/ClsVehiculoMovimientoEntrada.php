	...
	public function MtdRegistrarVehiculoMovimientoEntrada()
	{
		...
		if (!$error) {
			...
			if (!empty($this->VehiculoMovimientoEntradaDetalle)) {
				...
				$validar = 0;
				$InsVehiculoMovimientoEntradaDetalle = new ClsVehiculoMovimientoEntradaDetalle($this->InsMysql);
	...
	public function MtdEditarVehiculoMovimientoEntrada()
	{
		...
		if (!$error) {
			...
			if (!empty($this->VehiculoMovimientoEntradaDetalle)) {
				...
				$validar = 0;
				$InsVehiculoMovimientoEntradaDetalle = new ClsVehiculoMovimientoEntradaDetalle($this);
