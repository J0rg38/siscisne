...
class ClsVehiculoIngreso
{
	...
	public $EinFotoVIN;
	public $EinFotoFrontal;
	public $EinFotoCupon;
	public $EinFotoMantenimiento;
	public $EinNotaPedido;

	// Propiedades adicionales para evitar warnings
	public $EinCaracteristica1;
	public $EinCaracteristica2;
	public $EinCaracteristica3;
	public $EinCaracteristica4;
	public $EinCaracteristica5;
	public $EinCaracteristica6;
	public $EinCaracteristica7;
	public $EinCaracteristica8;
	public $EinCaracteristica9;
	public $EinCaracteristica10;
	public $EinCaracteristica11;
	public $EinCaracteristica12;
	public $EinCaracteristica13;
	public $EinCaracteristica14;
	public $EinCaracteristica15;
	public $EinCaracteristica16;
	public $EinCaracteristica17;
	public $EinCaracteristica18;
	public $EinCaracteristica19;
	public $EinCaracteristica20;
	public $EinRecepcionZonaComprometida;
	public $EinRecepcionRepuestoDetalle;
	public $EinRecepcionSolucion;
	public $EinRecepcionObservacion;
	public $EinComprobanteCompraNumero;
	public $EinComprobanteCompraNumeroSerie;
	public $EinComprobanteCompraNumeroNumero;
	...
	public $EinCostoIngreso;
	public $MonIdIngreso;
	public $EinTipoCambioIngreso;
	public $EinObservado;
	public $EinObservadoMotivo;
	public $EinControlGuiaRemisionFecha;
	public $EinControlGuiaRemisionNumero;
	public $EinControlEmpresaTransporte;
	public $EinControlFechaRecepcion;
	public $EinControlGuiaRemisionFechaOtro;
	public $EinControlGuiaRemisionNumeroOtro;
	public $EinPredictivoObservacion;
	public $EinPredictivoFecha;
	public $EinCancelado;
...
(
		...
		if ($this->InsMysql->MtdObtenerDatosTotal($resultado) > 0) {
			...
			while ($fila = $this->InsMysql->MtdObtenerDatos($resultado)) {
				...
				$ArrComprobanteCompraNumero = explode("-", $this->EinComprobanteCompraNumero);

				if (count($ArrComprobanteCompraNumero) == 2) {
					$this->EinComprobanteCompraNumeroSerie = $ArrComprobanteCompraNumero[0];
					$this->EinComprobanteCompraNumeroNumero = $ArrComprobanteCompraNumero[1];
				}
	...
	public function MtdObtenerVehiculoIngresos($oCampo = NULL, $oCondicion = NULL, $oFiltro = NULL, $oOrden = 'EinId', $oSentido = 'Desc', $oPaginacion = '0,10', $oEstado = NULL, $oTipo = NULL, $oCliente = NULL, $oEstadoVehicular = NULL, $oVehiculoMarca = NULL, $oVehiculoModelo = NULL, $oVehiculoVersion = NULL, $oAnoModelo = NULL, $oAnoFabricacion = NULL, $oColor = NULL, $oConProforma = NULL, $oFecha = "EinFechaRecepcion", $oFechaInicio = NULL, $oFechaFin = NULL, $oSucursal = NULL, $oConcesionario = NULL, $oOrdenAno = NULL, $oOrdenMes = NULL, $oObservado = NULL, $oFacturaAno = NULL, $oFacturaMes = NULL)
	{
		...
		// Variables adicionales para evitar warnings
		$vtipo = '';
		$oano = '';
		$omes = '';
		$fano = '';
...
WHERE 1 = 1
	...
	{
		// Obtener el ID del usuario de la sesión si no se proporciona uno
		$usuId = $oUsuario ?: ($this->UsuId ?: (isset($_SESSION['SesionId']) ? $_SESSION['SesionId'] : NULL));

		$InsAuditoria = new ClsAuditoria($this->InsMysql);
		$InsAuditoria->AudCodigo = $this->EinId;
		$InsAuditoria->AudCodigoExtra = NULL;
		$InsAuditoria->UsuId = $usuId;
