...
DATE_FORMAT(pro.ProFechaUltimaSalida, "%d/%m/%Y") AS "NProFechaUltimaSalida",
				...
				WHERE  1 = 1  '.$filtrar.$categoria.$reemplazo.$vmarcasolo.$tcoriginal .$cprecio.$referencia.$estado.$tipo.$vstock.$vmarca.$vmodelo.$vversion.$vano.$tingreso.$tstock.$pcategoria.$orden.$paginacion;
