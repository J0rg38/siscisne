	 	...
	 	if(!empty($oSucursal)){
			...
			$sql = 'SELECT
				...
				WHEN EXISTS (
					...
					WHERE pac.VdiId = vdi.VdiId LIMIT 1
...
*/
	...
	public function MtdConfirmarVentaDirecta() {
		...
		private function MtdAuditarVentaDirecta($oAccion,$oDescripcion,$oDatos){
