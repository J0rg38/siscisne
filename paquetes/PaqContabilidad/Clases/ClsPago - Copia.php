        ...
        while ($fila = $this->InsMysql->MtdObtenerDatos($resultado))
        {
			...
			if($oCompleto){
				...
				switch($this->PagEstado){
					case 1:
						$this->PagEstadoDescripcion = "Orden Cobro";
					break;
										
					case 3:
						$this->PagEstadoDescripcion = "Abono";
					break;
...
pag.PagObservacionCaja,
				...
				WHERE 1 = 1 '.$filtrar.$tipo.$estado.$sucursal.$vdirecta.$ovvehiculo.$cpago.$moneda.$factura.$boleta.$area.$fecha.$origen.$fpago.$orden.$paginacion;
...
//deb($error);
	...
	public function MtdEditarPago() {
		...
		private function MtdAuditarPago($oAccion,$oDescripcion,$oDatos){
