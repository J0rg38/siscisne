...
/*
				...
				(
						...
						AND (
							fin.FinEstado = 75 OR fin.FinEstado = 9
						) 
...
*/
			...
			-- OR 
				...
				/*	(
							...
							AND IFNULL(fcc.FccManoObra,0)  > 0
		 ...
		 $sql = 'SELECT
            ...
            $InsComprobanteVenta = get_class($this);
				...
				while( $fila = $this->InsMysql->MtdObtenerDatos($resultado)){
					...
					$ComprobanteVenta->CprId = $fila['CprId']; 
...
AND ncr.NcrMotivoCodigo<> "07"
		...
		ORDER BY pag.PagId ASC LIMIT 1
				...
				WHERE 1 = 1 '.$filtrar.$fecha.$tipo.$stipo.$estado.$moneda.$personal.$cliente.$cvehiculo.$ccotizacion.$vingreso.$estado.$facturable.$orden.$paginacion;
